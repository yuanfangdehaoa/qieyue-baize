...
%% message types
-type m_soul_list_tos() :: #m_soul_list_tos{}.

-type m_soul_list_toc() :: #m_soul_list_toc{}.

-type m_soul_puton_tos() :: #m_soul_puton_tos{}.

-type m_soul_puton_toc() :: #m_soul_puton_toc{}.

-type m_soul_putoff_tos() :: #m_soul_putoff_tos{}.

-type m_soul_putoff_toc() :: #m_soul_putoff_toc{}.

-type m_soul_uplevel_tos() :: #m_soul_uplevel_tos{}.

-type m_soul_uplevel_toc() :: #m_soul_uplevel_toc{}.

-type m_soul_decompose_tos() :: #m_soul_decompose_tos{}.

-type m_soul_decompose_toc() :: #m_soul_decompose_toc{}.

-type m_soul_get_set_tos() :: #m_soul_get_set_tos{}.

-type m_soul_get_set_toc() :: #m_soul_get_set_toc{}.

-type m_soul_decompose_set_tos() :: #m_soul_decompose_set_tos{}.

-type m_soul_decompose_set_toc() :: #m_soul_decompose_set_toc{}.

-type m_soul_combine_tos() :: #m_soul_combine_tos{}.

-type m_soul_combine_toc() :: #m_soul_combine_toc{}.
...
-export_type(['m_soul_list_tos'/0, 'm_soul_list_toc'/0, 'm_soul_puton_tos'/0, 'm_soul_puton_toc'/0, 'm_soul_putoff_tos'/0, 'm_soul_putoff_toc'/0, 'm_soul_uplevel_tos'/0, 'm_soul_uplevel_toc'/0, 'm_soul_decompose_tos'/0, 'm_soul_decompose_toc'/0, 'm_soul_get_set_tos'/0, 'm_soul_get_set_toc'/0, 'm_soul_decompose_set_tos'/0, 'm_soul_decompose_set_toc'/0, 'm_soul_combine_tos'/0, 'm_soul_combine_toc'/0, 'p_role_base'/0, 'p_aspect'/0, 'p_attr'/0, 'p_item_base'/0, 'p_item'/0, 'p_equip'/0, 'p_pet'/0, 'p_marriage'/0, 'p_refine'/0, 'p_actor'/0, 'p_role'/0, 'p_creep'/0, 'p_npc'/0, 'p_drop'/0, 'p_buff'/0, 'p_coord'/0, 'p_icon'/0, 'p_ranking'/0, 'p_dropped'/0]).

-spec encode_msg(#m_soul_list_tos{} | #m_soul_list_toc{} | #m_soul_puton_tos{} | #m_soul_puton_toc{} | #m_soul_putoff_tos{} | #m_soul_putoff_toc{} | #m_soul_uplevel_tos{} | #m_soul_uplevel_toc{} | #m_soul_decompose_tos{} | #m_soul_decompose_toc{} | #m_soul_get_set_tos{} | #m_soul_get_set_toc{} | #m_soul_decompose_set_tos{} | #m_soul_decompose_set_toc{} | #m_soul_combine_tos{} | #m_soul_combine_toc{} | #p_role_base{} | #p_aspect{} | #p_attr{} | #p_item_base{} | #p_item{} | #p_equip{} | #p_pet{} | #p_marriage{} | #p_refine{} | #p_actor{} | #p_role{} | #p_creep{} | #p_npc{} | #p_drop{} | #p_buff{} | #p_coord{} | #p_icon{} | #p_ranking{} | #p_dropped{}) -> binary().
encode_msg(Msg) when tuple_size(Msg) >= 1 ->
    encode_msg(Msg, element(1, Msg), []).

-spec encode_msg(#m_soul_list_tos{} | #m_soul_list_toc{} | #m_soul_puton_tos{} | #m_soul_puton_toc{} | #m_soul_putoff_tos{} | #m_soul_putoff_toc{} | #m_soul_uplevel_tos{} | #m_soul_uplevel_toc{} | #m_soul_decompose_tos{} | #m_soul_decompose_toc{} | #m_soul_get_set_tos{} | #m_soul_get_set_toc{} | #m_soul_decompose_set_tos{} | #m_soul_decompose_set_toc{} | #m_soul_combine_tos{} | #m_soul_combine_toc{} | #p_role_base{} | #p_aspect{} | #p_attr{} | #p_item_base{} | #p_item{} | #p_equip{} | #p_pet{} | #p_marriage{} | #p_refine{} | #p_actor{} | #p_role{} | #p_creep{} | #p_npc{} | #p_drop{} | #p_buff{} | #p_coord{} | #p_icon{} | #p_ranking{} | #p_dropped{}, atom() | list()) -> binary().
...
encode_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
      m_soul_list_tos ->
	  encode_msg_m_soul_list_tos(id(Msg, TrUserData),
				     TrUserData);
      m_soul_list_toc ->
	  encode_msg_m_soul_list_toc(id(Msg, TrUserData),
				     TrUserData);
      m_soul_puton_tos ->
	  encode_msg_m_soul_puton_tos(id(Msg, TrUserData),
				      TrUserData);
      m_soul_puton_toc ->
	  encode_msg_m_soul_puton_toc(id(Msg, TrUserData),
				      TrUserData);
      m_soul_putoff_tos ->
	  encode_msg_m_soul_putoff_tos(id(Msg, TrUserData),
				       TrUserData);
      m_soul_putoff_toc ->
	  encode_msg_m_soul_putoff_toc(id(Msg, TrUserData),
				       TrUserData);
      m_soul_uplevel_tos ->
	  encode_msg_m_soul_uplevel_tos(id(Msg, TrUserData),
					TrUserData);
      m_soul_uplevel_toc ->
	  encode_msg_m_soul_uplevel_toc(id(Msg, TrUserData),
					TrUserData);
      m_soul_decompose_tos ->
	  encode_msg_m_soul_decompose_tos(id(Msg, TrUserData),
					  TrUserData);
      m_soul_decompose_toc ->
	  encode_msg_m_soul_decompose_toc(id(Msg, TrUserData),
					  TrUserData);
      m_soul_get_set_tos ->
	  encode_msg_m_soul_get_set_tos(id(Msg, TrUserData),
					TrUserData);
      m_soul_get_set_toc ->
	  encode_msg_m_soul_get_set_toc(id(Msg, TrUserData),
					TrUserData);
      m_soul_decompose_set_tos ->
	  encode_msg_m_soul_decompose_set_tos(id(Msg, TrUserData),
					      TrUserData);
      m_soul_decompose_set_toc ->
	  encode_msg_m_soul_decompose_set_toc(id(Msg, TrUserData),
					      TrUserData);
      m_soul_combine_tos ->
	  encode_msg_m_soul_combine_tos(id(Msg, TrUserData),
					TrUserData);
      m_soul_combine_toc ->
	  encode_msg_m_soul_combine_toc(id(Msg, TrUserData),
					TrUserData);
      p_role_base ->
...
encode_msg_m_soul_list_tos(_Msg, _TrUserData) -> <<>>.

encode_msg_m_soul_list_toc(Msg, TrUserData) ->
    encode_msg_m_soul_list_toc(Msg, <<>>, TrUserData).


encode_msg_m_soul_list_toc(#m_soul_list_toc{souls = F1},
			   Bin, TrUserData) ->
    begin
      TrF1 = 'tr_encode_m_soul_list_toc.souls'(F1,
					       TrUserData),
      if TrF1 == [] -> Bin;
	 true ->
	     e_field_m_soul_list_toc_souls(TrF1, Bin, TrUserData)
      end
    end.

encode_msg_m_soul_puton_tos(Msg, TrUserData) ->
    encode_msg_m_soul_puton_tos(Msg, <<>>, TrUserData).


encode_msg_m_soul_puton_tos(#m_soul_puton_tos{pos = F1,
					      uid = F2},
			    Bin, TrUserData) ->
    B1 = begin
...
encode_msg_m_soul_puton_toc(_Msg, _TrUserData) -> <<>>.

encode_msg_m_soul_putoff_tos(Msg, TrUserData) ->
    encode_msg_m_soul_putoff_tos(Msg, <<>>, TrUserData).


encode_msg_m_soul_putoff_tos(#m_soul_putoff_tos{pos =
						    F1},
			     Bin, TrUserData) ->
    begin
      TrF1 = id(F1, TrUserData),
...
encode_msg_m_soul_putoff_toc(Msg, TrUserData) ->
    encode_msg_m_soul_putoff_toc(Msg, <<>>, TrUserData).


encode_msg_m_soul_putoff_toc(#m_soul_putoff_toc{pos =
						    F1},
			     Bin, TrUserData) ->
    begin
      TrF1 = id(F1, TrUserData),
      if TrF1 == [] -> Bin;
	 true ->
	     e_field_m_soul_putoff_toc_pos(TrF1, Bin, TrUserData)
      end
    end.

encode_msg_m_soul_uplevel_tos(Msg, TrUserData) ->
    encode_msg_m_soul_uplevel_tos(Msg, <<>>, TrUserData).


encode_msg_m_soul_uplevel_tos(#m_soul_uplevel_tos{pos =
						      F1},
			      Bin, TrUserData) ->
    begin
      TrF1 = id(F1, TrUserData),
...
encode_msg_m_soul_uplevel_toc(Msg, TrUserData) ->
    encode_msg_m_soul_uplevel_toc(Msg, <<>>, TrUserData).


encode_msg_m_soul_uplevel_toc(#m_soul_uplevel_toc{pos =
						      F1},
			      Bin, TrUserData) ->
    begin
      TrF1 = id(F1, TrUserData),
...
encode_msg_m_soul_decompose_tos(Msg, TrUserData) ->
    encode_msg_m_soul_decompose_tos(Msg, <<>>, TrUserData).


encode_msg_m_soul_decompose_tos(#m_soul_decompose_tos{uid
							  = F1},
				Bin, TrUserData) ->
    begin
      TrF1 = id(F1, TrUserData),
      if TrF1 == [] -> Bin;
	 true ->
	     e_field_m_soul_decompose_tos_uid(TrF1, Bin, TrUserData)
      end
    end.

encode_msg_m_soul_decompose_toc(_Msg, _TrUserData) ->
    <<>>.

encode_msg_m_soul_get_set_tos(_Msg, _TrUserData) ->
    <<>>.

encode_msg_m_soul_get_set_toc(Msg, TrUserData) ->
    encode_msg_m_soul_get_set_toc(Msg, <<>>, TrUserData).


encode_msg_m_soul_get_set_toc(#m_soul_get_set_toc{auto =
						      F1,
						  color = F2},
			      Bin, TrUserData) ->
...
encode_msg_m_soul_decompose_set_tos(Msg, TrUserData) ->
    encode_msg_m_soul_decompose_set_tos(Msg, <<>>,
					TrUserData).


encode_msg_m_soul_decompose_set_tos(#m_soul_decompose_set_tos{auto
								  = F1,
							      color = F2},
				    Bin, TrUserData) ->
    B1 = if F1 == undefined -> Bin;
...
encode_msg_m_soul_decompose_set_toc(_Msg,
				    _TrUserData) ->
    <<>>.

encode_msg_m_soul_combine_tos(Msg, TrUserData) ->
    encode_msg_m_soul_combine_tos(Msg, <<>>, TrUserData).


encode_msg_m_soul_combine_tos(#m_soul_combine_tos{r_item_id
						      = F1},
			      Bin, TrUserData) ->
    begin
      TrF1 = id(F1, TrUserData),
...
encode_msg_m_soul_combine_toc(_Msg, _TrUserData) ->
    <<>>.
...
e_mfield_m_soul_list_toc_souls(Msg, Bin, TrUserData) ->
    SubBin = 'encode_msg_map<int32,p_item>'(Msg, <<>>,
					    TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

e_field_m_soul_list_toc_souls([Elem | Rest], Bin,
			      TrUserData) ->
    Bin2 = <<Bin/binary, 10>>,
    Bin3 =
	e_mfield_m_soul_list_toc_souls('tr_encode_m_soul_list_toc.souls[x]'(Elem,
									    TrUserData),
				       Bin2, TrUserData),
    e_field_m_soul_list_toc_souls(Rest, Bin3, TrUserData);
e_field_m_soul_list_toc_souls([], Bin, _TrUserData) ->
    Bin.

e_field_m_soul_putoff_toc_pos([Elem | Rest], Bin,
			      TrUserData) ->
    Bin2 = <<Bin/binary, 8>>,
    Bin3 = e_type_int32(id(Elem, TrUserData), Bin2,
			TrUserData),
    e_field_m_soul_putoff_toc_pos(Rest, Bin3, TrUserData);
e_field_m_soul_putoff_toc_pos([], Bin, _TrUserData) ->
    Bin.

e_field_m_soul_decompose_tos_uid([Elem | Rest], Bin,
				 TrUserData) ->
    Bin2 = <<Bin/binary, 8>>,
    Bin3 = e_type_int32(id(Elem, TrUserData), Bin2,
			TrUserData),
    e_field_m_soul_decompose_tos_uid(Rest, Bin3,
				     TrUserData);
e_field_m_soul_decompose_tos_uid([], Bin,
				 _TrUserData) ->
    Bin.
...
decode_msg_2_doit(m_soul_list_tos, Bin, TrUserData) ->
    id(decode_msg_m_soul_list_tos(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_soul_list_toc, Bin, TrUserData) ->
    id(decode_msg_m_soul_list_toc(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_soul_puton_tos, Bin, TrUserData) ->
    id(decode_msg_m_soul_puton_tos(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_soul_puton_toc, Bin, TrUserData) ->
    id(decode_msg_m_soul_puton_toc(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_soul_putoff_tos, Bin, TrUserData) ->
    id(decode_msg_m_soul_putoff_tos(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_soul_putoff_toc, Bin, TrUserData) ->
    id(decode_msg_m_soul_putoff_toc(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_soul_uplevel_tos, Bin,
		  TrUserData) ->
    id(decode_msg_m_soul_uplevel_tos(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_soul_uplevel_toc, Bin,
		  TrUserData) ->
    id(decode_msg_m_soul_uplevel_toc(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_soul_decompose_tos, Bin,
		  TrUserData) ->
    id(decode_msg_m_soul_decompose_tos(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_soul_decompose_toc, Bin,
		  TrUserData) ->
    id(decode_msg_m_soul_decompose_toc(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_soul_get_set_tos, Bin,
		  TrUserData) ->
    id(decode_msg_m_soul_get_set_tos(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_soul_get_set_toc, Bin,
		  TrUserData) ->
    id(decode_msg_m_soul_get_set_toc(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_soul_decompose_set_tos, Bin,
		  TrUserData) ->
    id(decode_msg_m_soul_decompose_set_tos(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_soul_decompose_set_toc, Bin,
		  TrUserData) ->
    id(decode_msg_m_soul_decompose_set_toc(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_soul_combine_tos, Bin,
		  TrUserData) ->
    id(decode_msg_m_soul_combine_tos(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_soul_combine_toc, Bin,
		  TrUserData) ->
    id(decode_msg_m_soul_combine_toc(Bin, TrUserData),
       TrUserData);
...
decode_msg_m_soul_list_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_soul_list_tos(Bin, 0, 0,
				       TrUserData).

dfp_read_field_def_m_soul_list_tos(<<>>, 0, 0, _) ->
    #m_soul_list_tos{};
dfp_read_field_def_m_soul_list_tos(Other, Z1, Z2,
				   TrUserData) ->
    dg_read_field_def_m_soul_list_tos(Other, Z1, Z2,
				      TrUserData).

dg_read_field_def_m_soul_list_tos(<<1:1, X:7,
				    Rest/binary>>,
				  N, Acc, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_soul_list_tos(Rest, N + 7,
				      X bsl N + Acc, TrUserData);
dg_read_field_def_m_soul_list_tos(<<0:1, X:7,
				    Rest/binary>>,
				  N, Acc, TrUserData) ->
    Key = X bsl N + Acc,
    case Key band 7 of
      0 ->
	  skip_varint_m_soul_list_tos(Rest, 0, 0, TrUserData);
      1 -> skip_64_m_soul_list_tos(Rest, 0, 0, TrUserData);
      2 ->
	  skip_length_delimited_m_soul_list_tos(Rest, 0, 0,
						TrUserData);
      3 ->
	  skip_group_m_soul_list_tos(Rest, Key bsr 3, 0,
				     TrUserData);
      5 -> skip_32_m_soul_list_tos(Rest, 0, 0, TrUserData)
    end;
dg_read_field_def_m_soul_list_tos(<<>>, 0, 0, _) ->
    #m_soul_list_tos{}.

skip_varint_m_soul_list_tos(<<1:1, _:7, Rest/binary>>,
			    Z1, Z2, TrUserData) ->
    skip_varint_m_soul_list_tos(Rest, Z1, Z2, TrUserData);
skip_varint_m_soul_list_tos(<<0:1, _:7, Rest/binary>>,
			    Z1, Z2, TrUserData) ->
    dfp_read_field_def_m_soul_list_tos(Rest, Z1, Z2,
				       TrUserData).

skip_length_delimited_m_soul_list_tos(<<1:1, X:7,
					Rest/binary>>,
				      N, Acc, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_soul_list_tos(Rest, N + 7,
					  X bsl N + Acc, TrUserData);
skip_length_delimited_m_soul_list_tos(<<0:1, X:7,
					Rest/binary>>,
				      N, Acc, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_soul_list_tos(Rest2, 0, 0,
				       TrUserData).

skip_group_m_soul_list_tos(Bin, FNum, Z2, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_soul_list_tos(Rest, 0, Z2,
				       TrUserData).

skip_32_m_soul_list_tos(<<_:32, Rest/binary>>, Z1, Z2,
			TrUserData) ->
    dfp_read_field_def_m_soul_list_tos(Rest, Z1, Z2,
				       TrUserData).

skip_64_m_soul_list_tos(<<_:64, Rest/binary>>, Z1, Z2,
			TrUserData) ->
    dfp_read_field_def_m_soul_list_tos(Rest, Z1, Z2,
				       TrUserData).

decode_msg_m_soul_list_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_soul_list_toc(Bin, 0, 0,
				       'tr_decode_init_default_m_soul_list_toc.souls'([],
										      TrUserData),
				       TrUserData).

dfp_read_field_def_m_soul_list_toc(<<10, Rest/binary>>,
				   Z1, Z2, F@_1, TrUserData) ->
    d_field_m_soul_list_toc_souls(Rest, Z1, Z2, F@_1,
				  TrUserData);
dfp_read_field_def_m_soul_list_toc(<<>>, 0, 0, R1,
				   TrUserData) ->
    #m_soul_list_toc{souls =
			 'tr_decode_repeated_finalize_m_soul_list_toc.souls'(R1,
									     TrUserData)};
dfp_read_field_def_m_soul_list_toc(Other, Z1, Z2, F@_1,
				   TrUserData) ->
    dg_read_field_def_m_soul_list_toc(Other, Z1, Z2, F@_1,
				      TrUserData).

dg_read_field_def_m_soul_list_toc(<<1:1, X:7,
				    Rest/binary>>,
				  N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_soul_list_toc(Rest, N + 7,
				      X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_m_soul_list_toc(<<0:1, X:7,
				    Rest/binary>>,
				  N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      10 ->
	  d_field_m_soul_list_toc_souls(Rest, 0, 0, F@_1,
					TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_soul_list_toc(Rest, 0, 0, F@_1,
					    TrUserData);
	    1 ->
		skip_64_m_soul_list_toc(Rest, 0, 0, F@_1, TrUserData);
	    2 ->
		skip_length_delimited_m_soul_list_toc(Rest, 0, 0, F@_1,
						      TrUserData);
	    3 ->
		skip_group_m_soul_list_toc(Rest, Key bsr 3, 0, F@_1,
					   TrUserData);
	    5 ->
		skip_32_m_soul_list_toc(Rest, 0, 0, F@_1, TrUserData)
	  end
    end;
dg_read_field_def_m_soul_list_toc(<<>>, 0, 0, R1,
				  TrUserData) ->
    #m_soul_list_toc{souls =
			 'tr_decode_repeated_finalize_m_soul_list_toc.souls'(R1,
									     TrUserData)}.

d_field_m_soul_list_toc_souls(<<1:1, X:7, Rest/binary>>,
			      N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_m_soul_list_toc_souls(Rest, N + 7,
				  X bsl N + Acc, F@_1, TrUserData);
d_field_m_soul_list_toc_souls(<<0:1, X:7, Rest/binary>>,
    ...
    dfp_read_field_def_m_soul_list_toc(RestF, 0, 0,
				       'tr_decode_repeated_add_elem_m_soul_list_toc.souls'(NewFValue,
											   Prev,
											   TrUserData),
				       TrUserData).

skip_varint_m_soul_list_toc(<<1:1, _:7, Rest/binary>>,
			    Z1, Z2, F@_1, TrUserData) ->
    skip_varint_m_soul_list_toc(Rest, Z1, Z2, F@_1,
				TrUserData);
skip_varint_m_soul_list_toc(<<0:1, _:7, Rest/binary>>,
			    Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_soul_list_toc(Rest, Z1, Z2, F@_1,
				       TrUserData).

skip_length_delimited_m_soul_list_toc(<<1:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_soul_list_toc(Rest, N + 7,
					  X bsl N + Acc, F@_1, TrUserData);
skip_length_delimited_m_soul_list_toc(<<0:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_soul_list_toc(Rest2, 0, 0, F@_1,
				       TrUserData).

skip_group_m_soul_list_toc(Bin, FNum, Z2, F@_1,
			   TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_soul_list_toc(Rest, 0, Z2, F@_1,
				       TrUserData).

skip_32_m_soul_list_toc(<<_:32, Rest/binary>>, Z1, Z2,
			F@_1, TrUserData) ->
    dfp_read_field_def_m_soul_list_toc(Rest, Z1, Z2, F@_1,
				       TrUserData).

skip_64_m_soul_list_toc(<<_:64, Rest/binary>>, Z1, Z2,
			F@_1, TrUserData) ->
    dfp_read_field_def_m_soul_list_toc(Rest, Z1, Z2, F@_1,
				       TrUserData).

decode_msg_m_soul_puton_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_soul_puton_tos(Bin, 0, 0,
					id(undefined, TrUserData),
					id(undefined, TrUserData), TrUserData).

dfp_read_field_def_m_soul_puton_tos(<<8, Rest/binary>>,
				    Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_soul_puton_tos_pos(Rest, Z1, Z2, F@_1, F@_2,
				 TrUserData);
dfp_read_field_def_m_soul_puton_tos(<<16, Rest/binary>>,
				    Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_soul_puton_tos_uid(Rest, Z1, Z2, F@_1, F@_2,
				 TrUserData);
dfp_read_field_def_m_soul_puton_tos(<<>>, 0, 0, F@_1,
				    F@_2, _) ->
    #m_soul_puton_tos{pos = F@_1, uid = F@_2};
dfp_read_field_def_m_soul_puton_tos(Other, Z1, Z2, F@_1,
				    F@_2, TrUserData) ->
    dg_read_field_def_m_soul_puton_tos(Other, Z1, Z2, F@_1,
				       F@_2, TrUserData).

dg_read_field_def_m_soul_puton_tos(<<1:1, X:7,
				     Rest/binary>>,
				   N, Acc, F@_1, F@_2, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_soul_puton_tos(Rest, N + 7,
				       X bsl N + Acc, F@_1, F@_2, TrUserData);
dg_read_field_def_m_soul_puton_tos(<<0:1, X:7,
				     Rest/binary>>,
				   N, Acc, F@_1, F@_2, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_soul_puton_tos_pos(Rest, 0, 0, F@_1, F@_2,
				       TrUserData);
      16 ->
	  d_field_m_soul_puton_tos_uid(Rest, 0, 0, F@_1, F@_2,
				       TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_soul_puton_tos(Rest, 0, 0, F@_1, F@_2,
					     TrUserData);
	    1 ->
		skip_64_m_soul_puton_tos(Rest, 0, 0, F@_1, F@_2,
					 TrUserData);
	    2 ->
		skip_length_delimited_m_soul_puton_tos(Rest, 0, 0, F@_1,
						       F@_2, TrUserData);
	    3 ->
		skip_group_m_soul_puton_tos(Rest, Key bsr 3, 0, F@_1,
					    F@_2, TrUserData);
	    5 ->
		skip_32_m_soul_puton_tos(Rest, 0, 0, F@_1, F@_2,
					 TrUserData)
	  end
    end;
dg_read_field_def_m_soul_puton_tos(<<>>, 0, 0, F@_1,
				   F@_2, _) ->
    #m_soul_puton_tos{pos = F@_1, uid = F@_2}.

d_field_m_soul_puton_tos_pos(<<1:1, X:7, Rest/binary>>,
			     N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_soul_puton_tos_pos(Rest, N + 7, X bsl N + Acc,
				 F@_1, F@_2, TrUserData);
d_field_m_soul_puton_tos_pos(<<0:1, X:7, Rest/binary>>,
    ...
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    dfp_read_field_def_m_soul_puton_tos(RestF, 0, 0,
					NewFValue, F@_2, TrUserData).

d_field_m_soul_puton_tos_uid(<<1:1, X:7, Rest/binary>>,
			     N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_soul_puton_tos_uid(Rest, N + 7, X bsl N + Acc,
				 F@_1, F@_2, TrUserData);
d_field_m_soul_puton_tos_uid(<<0:1, X:7, Rest/binary>>,
    ...
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    dfp_read_field_def_m_soul_puton_tos(RestF, 0, 0, F@_1,
					NewFValue, TrUserData).

skip_varint_m_soul_puton_tos(<<1:1, _:7, Rest/binary>>,
			     Z1, Z2, F@_1, F@_2, TrUserData) ->
    skip_varint_m_soul_puton_tos(Rest, Z1, Z2, F@_1, F@_2,
				 TrUserData);
skip_varint_m_soul_puton_tos(<<0:1, _:7, Rest/binary>>,
			     Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_soul_puton_tos(Rest, Z1, Z2, F@_1,
					F@_2, TrUserData).

skip_length_delimited_m_soul_puton_tos(<<1:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_soul_puton_tos(Rest, N + 7,
					   X bsl N + Acc, F@_1, F@_2,
					   TrUserData);
skip_length_delimited_m_soul_puton_tos(<<0:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, F@_2, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_soul_puton_tos(Rest2, 0, 0, F@_1,
					F@_2, TrUserData).

skip_group_m_soul_puton_tos(Bin, FNum, Z2, F@_1, F@_2,
			    TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_soul_puton_tos(Rest, 0, Z2, F@_1,
					F@_2, TrUserData).

skip_32_m_soul_puton_tos(<<_:32, Rest/binary>>, Z1, Z2,
			 F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_soul_puton_tos(Rest, Z1, Z2, F@_1,
					F@_2, TrUserData).

skip_64_m_soul_puton_tos(<<_:64, Rest/binary>>, Z1, Z2,
			 F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_soul_puton_tos(Rest, Z1, Z2, F@_1,
					F@_2, TrUserData).

decode_msg_m_soul_puton_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_soul_puton_toc(Bin, 0, 0,
					TrUserData).

dfp_read_field_def_m_soul_puton_toc(<<>>, 0, 0, _) ->
    #m_soul_puton_toc{};
dfp_read_field_def_m_soul_puton_toc(Other, Z1, Z2,
				    TrUserData) ->
    dg_read_field_def_m_soul_puton_toc(Other, Z1, Z2,
				       TrUserData).

dg_read_field_def_m_soul_puton_toc(<<1:1, X:7,
				     Rest/binary>>,
				   N, Acc, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_soul_puton_toc(Rest, N + 7,
				       X bsl N + Acc, TrUserData);
dg_read_field_def_m_soul_puton_toc(<<0:1, X:7,
				     Rest/binary>>,
				   N, Acc, TrUserData) ->
    Key = X bsl N + Acc,
    case Key band 7 of
      0 ->
	  skip_varint_m_soul_puton_toc(Rest, 0, 0, TrUserData);
      1 -> skip_64_m_soul_puton_toc(Rest, 0, 0, TrUserData);
      2 ->
	  skip_length_delimited_m_soul_puton_toc(Rest, 0, 0,
						 TrUserData);
      3 ->
	  skip_group_m_soul_puton_toc(Rest, Key bsr 3, 0,
				      TrUserData);
      5 -> skip_32_m_soul_puton_toc(Rest, 0, 0, TrUserData)
    end;
dg_read_field_def_m_soul_puton_toc(<<>>, 0, 0, _) ->
    #m_soul_puton_toc{}.

skip_varint_m_soul_puton_toc(<<1:1, _:7, Rest/binary>>,
			     Z1, Z2, TrUserData) ->
    skip_varint_m_soul_puton_toc(Rest, Z1, Z2, TrUserData);
skip_varint_m_soul_puton_toc(<<0:1, _:7, Rest/binary>>,
			     Z1, Z2, TrUserData) ->
    dfp_read_field_def_m_soul_puton_toc(Rest, Z1, Z2,
					TrUserData).

skip_length_delimited_m_soul_puton_toc(<<1:1, X:7,
					 Rest/binary>>,
				       N, Acc, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_soul_puton_toc(Rest, N + 7,
					   X bsl N + Acc, TrUserData);
skip_length_delimited_m_soul_puton_toc(<<0:1, X:7,
					 Rest/binary>>,
				       N, Acc, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_soul_puton_toc(Rest2, 0, 0,
					TrUserData).

skip_group_m_soul_puton_toc(Bin, FNum, Z2,
			    TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_soul_puton_toc(Rest, 0, Z2,
					TrUserData).

skip_32_m_soul_puton_toc(<<_:32, Rest/binary>>, Z1, Z2,
			 TrUserData) ->
    dfp_read_field_def_m_soul_puton_toc(Rest, Z1, Z2,
					TrUserData).

skip_64_m_soul_puton_toc(<<_:64, Rest/binary>>, Z1, Z2,
			 TrUserData) ->
    dfp_read_field_def_m_soul_puton_toc(Rest, Z1, Z2,
					TrUserData).

decode_msg_m_soul_putoff_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_soul_putoff_tos(Bin, 0, 0,
					 id(undefined, TrUserData), TrUserData).

dfp_read_field_def_m_soul_putoff_tos(<<8, Rest/binary>>,
				     Z1, Z2, F@_1, TrUserData) ->
    d_field_m_soul_putoff_tos_pos(Rest, Z1, Z2, F@_1,
				  TrUserData);
dfp_read_field_def_m_soul_putoff_tos(<<>>, 0, 0, F@_1,
				     _) ->
    #m_soul_putoff_tos{pos = F@_1};
dfp_read_field_def_m_soul_putoff_tos(Other, Z1, Z2,
				     F@_1, TrUserData) ->
    dg_read_field_def_m_soul_putoff_tos(Other, Z1, Z2, F@_1,
					TrUserData).

dg_read_field_def_m_soul_putoff_tos(<<1:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_soul_putoff_tos(Rest, N + 7,
					X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_m_soul_putoff_tos(<<0:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_soul_putoff_tos_pos(Rest, 0, 0, F@_1,
					TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_soul_putoff_tos(Rest, 0, 0, F@_1,
					      TrUserData);
	    1 ->
		skip_64_m_soul_putoff_tos(Rest, 0, 0, F@_1, TrUserData);
	    2 ->
		skip_length_delimited_m_soul_putoff_tos(Rest, 0, 0,
							F@_1, TrUserData);
	    3 ->
		skip_group_m_soul_putoff_tos(Rest, Key bsr 3, 0, F@_1,
					     TrUserData);
	    5 ->
		skip_32_m_soul_putoff_tos(Rest, 0, 0, F@_1, TrUserData)
	  end
    end;
dg_read_field_def_m_soul_putoff_tos(<<>>, 0, 0, F@_1,
				    _) ->
    #m_soul_putoff_tos{pos = F@_1}.

d_field_m_soul_putoff_tos_pos(<<1:1, X:7, Rest/binary>>,
			      N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_m_soul_putoff_tos_pos(Rest, N + 7,
				  X bsl N + Acc, F@_1, TrUserData);
d_field_m_soul_putoff_tos_pos(<<0:1, X:7, Rest/binary>>,
			      N, Acc, _, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
							    Acc):32/unsigned-native>>,
			  ...
			  Rest},
    dfp_read_field_def_m_soul_putoff_tos(RestF, 0, 0,
					 NewFValue, TrUserData).

skip_varint_m_soul_putoff_tos(<<1:1, _:7, Rest/binary>>,
			      Z1, Z2, F@_1, TrUserData) ->
    skip_varint_m_soul_putoff_tos(Rest, Z1, Z2, F@_1,
				  TrUserData);
skip_varint_m_soul_putoff_tos(<<0:1, _:7, Rest/binary>>,
			      Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_soul_putoff_tos(Rest, Z1, Z2, F@_1,
					 TrUserData).

skip_length_delimited_m_soul_putoff_tos(<<1:1, X:7,
					  Rest/binary>>,
					N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_soul_putoff_tos(Rest, N + 7,
					    X bsl N + Acc, F@_1, TrUserData);
skip_length_delimited_m_soul_putoff_tos(<<0:1, X:7,
					  Rest/binary>>,
					N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_soul_putoff_tos(Rest2, 0, 0, F@_1,
					 TrUserData).

skip_group_m_soul_putoff_tos(Bin, FNum, Z2, F@_1,
			     TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_soul_putoff_tos(Rest, 0, Z2, F@_1,
					 TrUserData).

skip_32_m_soul_putoff_tos(<<_:32, Rest/binary>>, Z1, Z2,
			  F@_1, TrUserData) ->
    dfp_read_field_def_m_soul_putoff_tos(Rest, Z1, Z2, F@_1,
					 TrUserData).

skip_64_m_soul_putoff_tos(<<_:64, Rest/binary>>, Z1, Z2,
			  F@_1, TrUserData) ->
    dfp_read_field_def_m_soul_putoff_tos(Rest, Z1, Z2, F@_1,
					 TrUserData).

decode_msg_m_soul_putoff_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_soul_putoff_toc(Bin, 0, 0,
					 id([], TrUserData), TrUserData).

dfp_read_field_def_m_soul_putoff_toc(<<10,
				       Rest/binary>>,
				     Z1, Z2, F@_1, TrUserData) ->
    d_pfield_m_soul_putoff_toc_pos(Rest, Z1, Z2, F@_1,
				   TrUserData);
dfp_read_field_def_m_soul_putoff_toc(<<8, Rest/binary>>,
				     Z1, Z2, F@_1, TrUserData) ->
    d_field_m_soul_putoff_toc_pos(Rest, Z1, Z2, F@_1,
				  TrUserData);
dfp_read_field_def_m_soul_putoff_toc(<<>>, 0, 0, R1,
				     TrUserData) ->
    #m_soul_putoff_toc{pos = lists_reverse(R1, TrUserData)};
dfp_read_field_def_m_soul_putoff_toc(Other, Z1, Z2,
				     F@_1, TrUserData) ->
    dg_read_field_def_m_soul_putoff_toc(Other, Z1, Z2, F@_1,
					TrUserData).

dg_read_field_def_m_soul_putoff_toc(<<1:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_soul_putoff_toc(Rest, N + 7,
					X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_m_soul_putoff_toc(<<0:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      10 ->
	  d_pfield_m_soul_putoff_toc_pos(Rest, 0, 0, F@_1,
					 TrUserData);
      8 ->
	  d_field_m_soul_putoff_toc_pos(Rest, 0, 0, F@_1,
					TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_soul_putoff_toc(Rest, 0, 0, F@_1,
					      TrUserData);
	    1 ->
		skip_64_m_soul_putoff_toc(Rest, 0, 0, F@_1, TrUserData);
	    2 ->
		skip_length_delimited_m_soul_putoff_toc(Rest, 0, 0,
							F@_1, TrUserData);
	    3 ->
		skip_group_m_soul_putoff_toc(Rest, Key bsr 3, 0, F@_1,
					     TrUserData);
	    5 ->
		skip_32_m_soul_putoff_toc(Rest, 0, 0, F@_1, TrUserData)
	  end
    end;
dg_read_field_def_m_soul_putoff_toc(<<>>, 0, 0, R1,
				    TrUserData) ->
    #m_soul_putoff_toc{pos = lists_reverse(R1, TrUserData)}.

d_field_m_soul_putoff_toc_pos(<<1:1, X:7, Rest/binary>>,
			      N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_m_soul_putoff_toc_pos(Rest, N + 7,
				  X bsl N + Acc, F@_1, TrUserData);
d_field_m_soul_putoff_toc_pos(<<0:1, X:7, Rest/binary>>,
			      N, Acc, Prev, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
							    Acc):32/unsigned-native>>,
			  ...
			  Rest},
    dfp_read_field_def_m_soul_putoff_toc(RestF, 0, 0,
					 cons(NewFValue, Prev, TrUserData),
					 TrUserData).

d_pfield_m_soul_putoff_toc_pos(<<1:1, X:7,
				 Rest/binary>>,
			       N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_pfield_m_soul_putoff_toc_pos(Rest, N + 7,
				   X bsl N + Acc, F@_1, TrUserData);
d_pfield_m_soul_putoff_toc_pos(<<0:1, X:7,
				 Rest/binary>>,
			       N, Acc, E, TrUserData) ->
    Len = X bsl N + Acc,
    <<PackedBytes:Len/binary, Rest2/binary>> = Rest,
    NewSeq =
	d_packed_field_m_soul_putoff_toc_pos(PackedBytes, 0, 0,
					     E, TrUserData),
    dfp_read_field_def_m_soul_putoff_toc(Rest2, 0, 0,
					 NewSeq, TrUserData).

d_packed_field_m_soul_putoff_toc_pos(<<1:1, X:7,
				       Rest/binary>>,
				     N, Acc, AccSeq, TrUserData)
    when N < 57 ->
    d_packed_field_m_soul_putoff_toc_pos(Rest, N + 7,
					 X bsl N + Acc, AccSeq, TrUserData);
d_packed_field_m_soul_putoff_toc_pos(<<0:1, X:7,
				       Rest/binary>>,
				     N, Acc, AccSeq, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    d_packed_field_m_soul_putoff_toc_pos(RestF, 0, 0,
					 [NewFValue | AccSeq], TrUserData);
d_packed_field_m_soul_putoff_toc_pos(<<>>, 0, 0, AccSeq,
				     _) ->
    AccSeq.

skip_varint_m_soul_putoff_toc(<<1:1, _:7, Rest/binary>>,
			      Z1, Z2, F@_1, TrUserData) ->
    skip_varint_m_soul_putoff_toc(Rest, Z1, Z2, F@_1,
				  TrUserData);
skip_varint_m_soul_putoff_toc(<<0:1, _:7, Rest/binary>>,
			      Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_soul_putoff_toc(Rest, Z1, Z2, F@_1,
					 TrUserData).

skip_length_delimited_m_soul_putoff_toc(<<1:1, X:7,
					  Rest/binary>>,
					N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_soul_putoff_toc(Rest, N + 7,
					    X bsl N + Acc, F@_1, TrUserData);
skip_length_delimited_m_soul_putoff_toc(<<0:1, X:7,
					  Rest/binary>>,
					N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_soul_putoff_toc(Rest2, 0, 0, F@_1,
					 TrUserData).

skip_group_m_soul_putoff_toc(Bin, FNum, Z2, F@_1,
			     TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_soul_putoff_toc(Rest, 0, Z2, F@_1,
					 TrUserData).

skip_32_m_soul_putoff_toc(<<_:32, Rest/binary>>, Z1, Z2,
			  F@_1, TrUserData) ->
    dfp_read_field_def_m_soul_putoff_toc(Rest, Z1, Z2, F@_1,
					 TrUserData).

skip_64_m_soul_putoff_toc(<<_:64, Rest/binary>>, Z1, Z2,
			  F@_1, TrUserData) ->
    dfp_read_field_def_m_soul_putoff_toc(Rest, Z1, Z2, F@_1,
					 TrUserData).

decode_msg_m_soul_uplevel_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_soul_uplevel_tos(Bin, 0, 0,
					  id(undefined, TrUserData),
					  TrUserData).

dfp_read_field_def_m_soul_uplevel_tos(<<8,
					Rest/binary>>,
				      Z1, Z2, F@_1, TrUserData) ->
    d_field_m_soul_uplevel_tos_pos(Rest, Z1, Z2, F@_1,
				   TrUserData);
dfp_read_field_def_m_soul_uplevel_tos(<<>>, 0, 0, F@_1,
				      _) ->
    #m_soul_uplevel_tos{pos = F@_1};
dfp_read_field_def_m_soul_uplevel_tos(Other, Z1, Z2,
				      F@_1, TrUserData) ->
    dg_read_field_def_m_soul_uplevel_tos(Other, Z1, Z2,
					 F@_1, TrUserData).

dg_read_field_def_m_soul_uplevel_tos(<<1:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_soul_uplevel_tos(Rest, N + 7,
					 X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_m_soul_uplevel_tos(<<0:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_soul_uplevel_tos_pos(Rest, 0, 0, F@_1,
					 TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_soul_uplevel_tos(Rest, 0, 0, F@_1,
					       TrUserData);
	    1 ->
		skip_64_m_soul_uplevel_tos(Rest, 0, 0, F@_1,
					   TrUserData);
	    2 ->
		skip_length_delimited_m_soul_uplevel_tos(Rest, 0, 0,
							 F@_1, TrUserData);
	    3 ->
		skip_group_m_soul_uplevel_tos(Rest, Key bsr 3, 0, F@_1,
					      TrUserData);
	    5 ->
		skip_32_m_soul_uplevel_tos(Rest, 0, 0, F@_1, TrUserData)
	  end
    end;
dg_read_field_def_m_soul_uplevel_tos(<<>>, 0, 0, F@_1,
				     _) ->
    #m_soul_uplevel_tos{pos = F@_1}.

d_field_m_soul_uplevel_tos_pos(<<1:1, X:7,
				 Rest/binary>>,
			       N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_m_soul_uplevel_tos_pos(Rest, N + 7,
				   X bsl N + Acc, F@_1, TrUserData);
d_field_m_soul_uplevel_tos_pos(<<0:1, X:7,
				 Rest/binary>>,
			       N, Acc, _, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    dfp_read_field_def_m_soul_uplevel_tos(RestF, 0, 0,
					  NewFValue, TrUserData).

skip_varint_m_soul_uplevel_tos(<<1:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, F@_1, TrUserData) ->
    skip_varint_m_soul_uplevel_tos(Rest, Z1, Z2, F@_1,
				   TrUserData);
skip_varint_m_soul_uplevel_tos(<<0:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_soul_uplevel_tos(Rest, Z1, Z2,
					  F@_1, TrUserData).

skip_length_delimited_m_soul_uplevel_tos(<<1:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_soul_uplevel_tos(Rest, N + 7,
					     X bsl N + Acc, F@_1, TrUserData);
skip_length_delimited_m_soul_uplevel_tos(<<0:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_soul_uplevel_tos(Rest2, 0, 0, F@_1,
					  TrUserData).

skip_group_m_soul_uplevel_tos(Bin, FNum, Z2, F@_1,
			      TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_soul_uplevel_tos(Rest, 0, Z2, F@_1,
					  TrUserData).

skip_32_m_soul_uplevel_tos(<<_:32, Rest/binary>>, Z1,
			   Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_soul_uplevel_tos(Rest, Z1, Z2,
					  F@_1, TrUserData).

skip_64_m_soul_uplevel_tos(<<_:64, Rest/binary>>, Z1,
			   Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_soul_uplevel_tos(Rest, Z1, Z2,
					  F@_1, TrUserData).

decode_msg_m_soul_uplevel_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_soul_uplevel_toc(Bin, 0, 0,
					  id(undefined, TrUserData),
					  TrUserData).

dfp_read_field_def_m_soul_uplevel_toc(<<8,
					Rest/binary>>,
				      Z1, Z2, F@_1, TrUserData) ->
    d_field_m_soul_uplevel_toc_pos(Rest, Z1, Z2, F@_1,
				   TrUserData);
dfp_read_field_def_m_soul_uplevel_toc(<<>>, 0, 0, F@_1,
				      _) ->
    #m_soul_uplevel_toc{pos = F@_1};
dfp_read_field_def_m_soul_uplevel_toc(Other, Z1, Z2,
				      F@_1, TrUserData) ->
    dg_read_field_def_m_soul_uplevel_toc(Other, Z1, Z2,
					 F@_1, TrUserData).

dg_read_field_def_m_soul_uplevel_toc(<<1:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_soul_uplevel_toc(Rest, N + 7,
					 X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_m_soul_uplevel_toc(<<0:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_soul_uplevel_toc_pos(Rest, 0, 0, F@_1,
					 TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_soul_uplevel_toc(Rest, 0, 0, F@_1,
					       TrUserData);
	    1 ->
		skip_64_m_soul_uplevel_toc(Rest, 0, 0, F@_1,
					   TrUserData);
	    2 ->
		skip_length_delimited_m_soul_uplevel_toc(Rest, 0, 0,
							 F@_1, TrUserData);
	    3 ->
		skip_group_m_soul_uplevel_toc(Rest, Key bsr 3, 0, F@_1,
					      TrUserData);
	    5 ->
		skip_32_m_soul_uplevel_toc(Rest, 0, 0, F@_1, TrUserData)
	  end
    end;
dg_read_field_def_m_soul_uplevel_toc(<<>>, 0, 0, F@_1,
				     _) ->
    #m_soul_uplevel_toc{pos = F@_1}.

d_field_m_soul_uplevel_toc_pos(<<1:1, X:7,
				 Rest/binary>>,
			       N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_m_soul_uplevel_toc_pos(Rest, N + 7,
				   X bsl N + Acc, F@_1, TrUserData);
d_field_m_soul_uplevel_toc_pos(<<0:1, X:7,
				 Rest/binary>>,
			       N, Acc, _, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    dfp_read_field_def_m_soul_uplevel_toc(RestF, 0, 0,
					  NewFValue, TrUserData).

skip_varint_m_soul_uplevel_toc(<<1:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, F@_1, TrUserData) ->
    skip_varint_m_soul_uplevel_toc(Rest, Z1, Z2, F@_1,
				   TrUserData);
skip_varint_m_soul_uplevel_toc(<<0:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_soul_uplevel_toc(Rest, Z1, Z2,
					  F@_1, TrUserData).

skip_length_delimited_m_soul_uplevel_toc(<<1:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_soul_uplevel_toc(Rest, N + 7,
					     X bsl N + Acc, F@_1, TrUserData);
skip_length_delimited_m_soul_uplevel_toc(<<0:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_soul_uplevel_toc(Rest2, 0, 0, F@_1,
					  TrUserData).

skip_group_m_soul_uplevel_toc(Bin, FNum, Z2, F@_1,
			      TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_soul_uplevel_toc(Rest, 0, Z2, F@_1,
					  TrUserData).

skip_32_m_soul_uplevel_toc(<<_:32, Rest/binary>>, Z1,
			   Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_soul_uplevel_toc(Rest, Z1, Z2,
					  F@_1, TrUserData).

skip_64_m_soul_uplevel_toc(<<_:64, Rest/binary>>, Z1,
			   Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_soul_uplevel_toc(Rest, Z1, Z2,
					  F@_1, TrUserData).

decode_msg_m_soul_decompose_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_soul_decompose_tos(Bin, 0, 0,
					    id([], TrUserData), TrUserData).

dfp_read_field_def_m_soul_decompose_tos(<<10,
					  Rest/binary>>,
					Z1, Z2, F@_1, TrUserData) ->
    d_pfield_m_soul_decompose_tos_uid(Rest, Z1, Z2, F@_1,
				      TrUserData);
dfp_read_field_def_m_soul_decompose_tos(<<8,
					  Rest/binary>>,
					Z1, Z2, F@_1, TrUserData) ->
    d_field_m_soul_decompose_tos_uid(Rest, Z1, Z2, F@_1,
				     TrUserData);
dfp_read_field_def_m_soul_decompose_tos(<<>>, 0, 0, R1,
					TrUserData) ->
    #m_soul_decompose_tos{uid =
			      lists_reverse(R1, TrUserData)};
dfp_read_field_def_m_soul_decompose_tos(Other, Z1, Z2,
					F@_1, TrUserData) ->
    dg_read_field_def_m_soul_decompose_tos(Other, Z1, Z2,
					   F@_1, TrUserData).

dg_read_field_def_m_soul_decompose_tos(<<1:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_soul_decompose_tos(Rest, N + 7,
					   X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_m_soul_decompose_tos(<<0:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      10 ->
	  d_pfield_m_soul_decompose_tos_uid(Rest, 0, 0, F@_1,
					    TrUserData);
      8 ->
	  d_field_m_soul_decompose_tos_uid(Rest, 0, 0, F@_1,
					   TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_soul_decompose_tos(Rest, 0, 0, F@_1,
						 TrUserData);
	    1 ->
		skip_64_m_soul_decompose_tos(Rest, 0, 0, F@_1,
					     TrUserData);
	    2 ->
		skip_length_delimited_m_soul_decompose_tos(Rest, 0, 0,
							   F@_1, TrUserData);
	    3 ->
		skip_group_m_soul_decompose_tos(Rest, Key bsr 3, 0,
						F@_1, TrUserData);
	    5 ->
		skip_32_m_soul_decompose_tos(Rest, 0, 0, F@_1,
					     TrUserData)
	  end
    end;
dg_read_field_def_m_soul_decompose_tos(<<>>, 0, 0, R1,
				       TrUserData) ->
    #m_soul_decompose_tos{uid =
			      lists_reverse(R1, TrUserData)}.

d_field_m_soul_decompose_tos_uid(<<1:1, X:7,
				   Rest/binary>>,
				 N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_m_soul_decompose_tos_uid(Rest, N + 7,
				     X bsl N + Acc, F@_1, TrUserData);
d_field_m_soul_decompose_tos_uid(<<0:1, X:7,
				   Rest/binary>>,
				 N, Acc, Prev, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    dfp_read_field_def_m_soul_decompose_tos(RestF, 0, 0,
					    cons(NewFValue, Prev, TrUserData),
					    TrUserData).

d_pfield_m_soul_decompose_tos_uid(<<1:1, X:7,
				    Rest/binary>>,
				  N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_pfield_m_soul_decompose_tos_uid(Rest, N + 7,
				      X bsl N + Acc, F@_1, TrUserData);
d_pfield_m_soul_decompose_tos_uid(<<0:1, X:7,
				    Rest/binary>>,
				  N, Acc, E, TrUserData) ->
    Len = X bsl N + Acc,
    <<PackedBytes:Len/binary, Rest2/binary>> = Rest,
    NewSeq =
	d_packed_field_m_soul_decompose_tos_uid(PackedBytes, 0,
						0, E, TrUserData),
    dfp_read_field_def_m_soul_decompose_tos(Rest2, 0, 0,
					    NewSeq, TrUserData).

d_packed_field_m_soul_decompose_tos_uid(<<1:1, X:7,
					  Rest/binary>>,
					N, Acc, AccSeq, TrUserData)
    when N < 57 ->
    d_packed_field_m_soul_decompose_tos_uid(Rest, N + 7,
					    X bsl N + Acc, AccSeq, TrUserData);
d_packed_field_m_soul_decompose_tos_uid(<<0:1, X:7,
					  Rest/binary>>,
					N, Acc, AccSeq, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    d_packed_field_m_soul_decompose_tos_uid(RestF, 0, 0,
					    [NewFValue | AccSeq], TrUserData);
d_packed_field_m_soul_decompose_tos_uid(<<>>, 0, 0,
					AccSeq, _) ->
    AccSeq.

skip_varint_m_soul_decompose_tos(<<1:1, _:7,
				   Rest/binary>>,
				 Z1, Z2, F@_1, TrUserData) ->
    skip_varint_m_soul_decompose_tos(Rest, Z1, Z2, F@_1,
				     TrUserData);
skip_varint_m_soul_decompose_tos(<<0:1, _:7,
				   Rest/binary>>,
				 Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_soul_decompose_tos(Rest, Z1, Z2,
					    F@_1, TrUserData).

skip_length_delimited_m_soul_decompose_tos(<<1:1, X:7,
					     Rest/binary>>,
					   N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_soul_decompose_tos(Rest, N + 7,
					       X bsl N + Acc, F@_1, TrUserData);
skip_length_delimited_m_soul_decompose_tos(<<0:1, X:7,
					     Rest/binary>>,
					   N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
...
skip_group_m_soul_decompose_tos(Bin, FNum, Z2, F@_1,
				TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_soul_decompose_tos(Rest, 0, Z2,
					    F@_1, TrUserData).

skip_32_m_soul_decompose_tos(<<_:32, Rest/binary>>, Z1,
			     Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_soul_decompose_tos(Rest, Z1, Z2,
					    F@_1, TrUserData).

skip_64_m_soul_decompose_tos(<<_:64, Rest/binary>>, Z1,
			     Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_soul_decompose_tos(Rest, Z1, Z2,
					    F@_1, TrUserData).

decode_msg_m_soul_decompose_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_soul_decompose_toc(Bin, 0, 0,
					    TrUserData).

dfp_read_field_def_m_soul_decompose_toc(<<>>, 0, 0,
					_) ->
    #m_soul_decompose_toc{};
dfp_read_field_def_m_soul_decompose_toc(Other, Z1, Z2,
					TrUserData) ->
    dg_read_field_def_m_soul_decompose_toc(Other, Z1, Z2,
					   TrUserData).

dg_read_field_def_m_soul_decompose_toc(<<1:1, X:7,
					 Rest/binary>>,
				       N, Acc, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_soul_decompose_toc(Rest, N + 7,
					   X bsl N + Acc, TrUserData);
dg_read_field_def_m_soul_decompose_toc(<<0:1, X:7,
					 Rest/binary>>,
				       N, Acc, TrUserData) ->
    Key = X bsl N + Acc,
    case Key band 7 of
      0 ->
	  skip_varint_m_soul_decompose_toc(Rest, 0, 0,
					   TrUserData);
      1 ->
	  skip_64_m_soul_decompose_toc(Rest, 0, 0, TrUserData);
      2 ->
	  skip_length_delimited_m_soul_decompose_toc(Rest, 0, 0,
						     TrUserData);
      3 ->
	  skip_group_m_soul_decompose_toc(Rest, Key bsr 3, 0,
					  TrUserData);
      5 ->
	  skip_32_m_soul_decompose_toc(Rest, 0, 0, TrUserData)
    end;
dg_read_field_def_m_soul_decompose_toc(<<>>, 0, 0, _) ->
    #m_soul_decompose_toc{}.

skip_varint_m_soul_decompose_toc(<<1:1, _:7,
				   Rest/binary>>,
				 Z1, Z2, TrUserData) ->
    skip_varint_m_soul_decompose_toc(Rest, Z1, Z2,
				     TrUserData);
skip_varint_m_soul_decompose_toc(<<0:1, _:7,
				   Rest/binary>>,
				 Z1, Z2, TrUserData) ->
    dfp_read_field_def_m_soul_decompose_toc(Rest, Z1, Z2,
					    TrUserData).

skip_length_delimited_m_soul_decompose_toc(<<1:1, X:7,
					     Rest/binary>>,
					   N, Acc, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_soul_decompose_toc(Rest, N + 7,
					       X bsl N + Acc, TrUserData);
skip_length_delimited_m_soul_decompose_toc(<<0:1, X:7,
					     Rest/binary>>,
					   N, Acc, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_soul_decompose_toc(Rest2, 0, 0,
					    TrUserData).

skip_group_m_soul_decompose_toc(Bin, FNum, Z2,
				TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_soul_decompose_toc(Rest, 0, Z2,
					    TrUserData).

skip_32_m_soul_decompose_toc(<<_:32, Rest/binary>>, Z1,
			     Z2, TrUserData) ->
    dfp_read_field_def_m_soul_decompose_toc(Rest, Z1, Z2,
					    TrUserData).

skip_64_m_soul_decompose_toc(<<_:64, Rest/binary>>, Z1,
			     Z2, TrUserData) ->
    dfp_read_field_def_m_soul_decompose_toc(Rest, Z1, Z2,
					    TrUserData).

decode_msg_m_soul_get_set_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_soul_get_set_tos(Bin, 0, 0,
					  TrUserData).

dfp_read_field_def_m_soul_get_set_tos(<<>>, 0, 0, _) ->
    #m_soul_get_set_tos{};
dfp_read_field_def_m_soul_get_set_tos(Other, Z1, Z2,
				      TrUserData) ->
    dg_read_field_def_m_soul_get_set_tos(Other, Z1, Z2,
					 TrUserData).

dg_read_field_def_m_soul_get_set_tos(<<1:1, X:7,
				       Rest/binary>>,
				     N, Acc, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_soul_get_set_tos(Rest, N + 7,
					 X bsl N + Acc, TrUserData);
dg_read_field_def_m_soul_get_set_tos(<<0:1, X:7,
				       Rest/binary>>,
				     N, Acc, TrUserData) ->
    Key = X bsl N + Acc,
    case Key band 7 of
      0 ->
	  skip_varint_m_soul_get_set_tos(Rest, 0, 0, TrUserData);
      1 -> skip_64_m_soul_get_set_tos(Rest, 0, 0, TrUserData);
      2 ->
	  skip_length_delimited_m_soul_get_set_tos(Rest, 0, 0,
						   TrUserData);
      3 ->
	  skip_group_m_soul_get_set_tos(Rest, Key bsr 3, 0,
					TrUserData);
      5 -> skip_32_m_soul_get_set_tos(Rest, 0, 0, TrUserData)
    end;
dg_read_field_def_m_soul_get_set_tos(<<>>, 0, 0, _) ->
    #m_soul_get_set_tos{}.

skip_varint_m_soul_get_set_tos(<<1:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, TrUserData) ->
    skip_varint_m_soul_get_set_tos(Rest, Z1, Z2,
				   TrUserData);
skip_varint_m_soul_get_set_tos(<<0:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, TrUserData) ->
    dfp_read_field_def_m_soul_get_set_tos(Rest, Z1, Z2,
					  TrUserData).

skip_length_delimited_m_soul_get_set_tos(<<1:1, X:7,
					   Rest/binary>>,
					 N, Acc, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_soul_get_set_tos(Rest, N + 7,
					     X bsl N + Acc, TrUserData);
skip_length_delimited_m_soul_get_set_tos(<<0:1, X:7,
					   Rest/binary>>,
					 N, Acc, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_soul_get_set_tos(Rest2, 0, 0,
					  TrUserData).

skip_group_m_soul_get_set_tos(Bin, FNum, Z2,
			      TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_soul_get_set_tos(Rest, 0, Z2,
					  TrUserData).

skip_32_m_soul_get_set_tos(<<_:32, Rest/binary>>, Z1,
			   Z2, TrUserData) ->
    dfp_read_field_def_m_soul_get_set_tos(Rest, Z1, Z2,
					  TrUserData).

skip_64_m_soul_get_set_tos(<<_:64, Rest/binary>>, Z1,
			   Z2, TrUserData) ->
    dfp_read_field_def_m_soul_get_set_tos(Rest, Z1, Z2,
					  TrUserData).

decode_msg_m_soul_get_set_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_soul_get_set_toc(Bin, 0, 0,
					  id(undefined, TrUserData),
					  id(undefined, TrUserData),
					  TrUserData).

dfp_read_field_def_m_soul_get_set_toc(<<8,
					Rest/binary>>,
				      Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_soul_get_set_toc_auto(Rest, Z1, Z2, F@_1,
				    F@_2, TrUserData);
dfp_read_field_def_m_soul_get_set_toc(<<16,
					Rest/binary>>,
				      Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_soul_get_set_toc_color(Rest, Z1, Z2, F@_1,
				     F@_2, TrUserData);
dfp_read_field_def_m_soul_get_set_toc(<<>>, 0, 0, F@_1,
				      F@_2, _) ->
    #m_soul_get_set_toc{auto = F@_1, color = F@_2};
dfp_read_field_def_m_soul_get_set_toc(Other, Z1, Z2,
				      F@_1, F@_2, TrUserData) ->
    dg_read_field_def_m_soul_get_set_toc(Other, Z1, Z2,
					 F@_1, F@_2, TrUserData).

dg_read_field_def_m_soul_get_set_toc(<<1:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, F@_2, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_soul_get_set_toc(Rest, N + 7,
					 X bsl N + Acc, F@_1, F@_2, TrUserData);
dg_read_field_def_m_soul_get_set_toc(<<0:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, F@_2, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_soul_get_set_toc_auto(Rest, 0, 0, F@_1, F@_2,
					  TrUserData);
      16 ->
	  d_field_m_soul_get_set_toc_color(Rest, 0, 0, F@_1, F@_2,
					   TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_soul_get_set_toc(Rest, 0, 0, F@_1, F@_2,
					       TrUserData);
	    1 ->
		skip_64_m_soul_get_set_toc(Rest, 0, 0, F@_1, F@_2,
					   TrUserData);
	    2 ->
		skip_length_delimited_m_soul_get_set_toc(Rest, 0, 0,
							 F@_1, F@_2,
							 TrUserData);
	    3 ->
		skip_group_m_soul_get_set_toc(Rest, Key bsr 3, 0, F@_1,
					      F@_2, TrUserData);
	    5 ->
		skip_32_m_soul_get_set_toc(Rest, 0, 0, F@_1, F@_2,
					   TrUserData)
	  end
    end;
dg_read_field_def_m_soul_get_set_toc(<<>>, 0, 0, F@_1,
				     F@_2, _) ->
    #m_soul_get_set_toc{auto = F@_1, color = F@_2}.

d_field_m_soul_get_set_toc_auto(<<1:1, X:7,
				  Rest/binary>>,
				N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_soul_get_set_toc_auto(Rest, N + 7,
				    X bsl N + Acc, F@_1, F@_2, TrUserData);
d_field_m_soul_get_set_toc_auto(<<0:1, X:7,
				  Rest/binary>>,
				N, Acc, _, F@_2, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    dfp_read_field_def_m_soul_get_set_toc(RestF, 0, 0,
					  NewFValue, F@_2, TrUserData).

d_field_m_soul_get_set_toc_color(<<1:1, X:7,
				   Rest/binary>>,
				 N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_soul_get_set_toc_color(Rest, N + 7,
				     X bsl N + Acc, F@_1, F@_2, TrUserData);
d_field_m_soul_get_set_toc_color(<<0:1, X:7,
				   Rest/binary>>,
				 N, Acc, F@_1, _, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    dfp_read_field_def_m_soul_get_set_toc(RestF, 0, 0, F@_1,
					  NewFValue, TrUserData).

skip_varint_m_soul_get_set_toc(<<1:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, F@_1, F@_2, TrUserData) ->
    skip_varint_m_soul_get_set_toc(Rest, Z1, Z2, F@_1, F@_2,
				   TrUserData);
skip_varint_m_soul_get_set_toc(<<0:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_soul_get_set_toc(Rest, Z1, Z2,
					  F@_1, F@_2, TrUserData).

skip_length_delimited_m_soul_get_set_toc(<<1:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_soul_get_set_toc(Rest, N + 7,
					     X bsl N + Acc, F@_1, F@_2,
					     TrUserData);
skip_length_delimited_m_soul_get_set_toc(<<0:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, F@_2, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_soul_get_set_toc(Rest2, 0, 0, F@_1,
					  F@_2, TrUserData).

skip_group_m_soul_get_set_toc(Bin, FNum, Z2, F@_1, F@_2,
			      TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_soul_get_set_toc(Rest, 0, Z2, F@_1,
					  F@_2, TrUserData).

skip_32_m_soul_get_set_toc(<<_:32, Rest/binary>>, Z1,
			   Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_soul_get_set_toc(Rest, Z1, Z2,
					  F@_1, F@_2, TrUserData).

skip_64_m_soul_get_set_toc(<<_:64, Rest/binary>>, Z1,
			   Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_soul_get_set_toc(Rest, Z1, Z2,
					  F@_1, F@_2, TrUserData).

decode_msg_m_soul_decompose_set_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_soul_decompose_set_tos(Bin, 0, 0,
						id(undefined, TrUserData),
						id(undefined, TrUserData),
						TrUserData).

dfp_read_field_def_m_soul_decompose_set_tos(<<8,
					      Rest/binary>>,
					    Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_soul_decompose_set_tos_auto(Rest, Z1, Z2,
					  F@_1, F@_2, TrUserData);
dfp_read_field_def_m_soul_decompose_set_tos(<<16,
					      Rest/binary>>,
					    Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_soul_decompose_set_tos_color(Rest, Z1, Z2,
					   F@_1, F@_2, TrUserData);
dfp_read_field_def_m_soul_decompose_set_tos(<<>>, 0, 0,
					    F@_1, F@_2, _) ->
    #m_soul_decompose_set_tos{auto = F@_1, color = F@_2};
dfp_read_field_def_m_soul_decompose_set_tos(Other, Z1,
					    Z2, F@_1, F@_2, TrUserData) ->
    dg_read_field_def_m_soul_decompose_set_tos(Other, Z1,
					       Z2, F@_1, F@_2, TrUserData).

dg_read_field_def_m_soul_decompose_set_tos(<<1:1, X:7,
					     Rest/binary>>,
					   N, Acc, F@_1, F@_2, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_soul_decompose_set_tos(Rest, N + 7,
					       X bsl N + Acc, F@_1, F@_2,
					       TrUserData);
dg_read_field_def_m_soul_decompose_set_tos(<<0:1, X:7,
					     Rest/binary>>,
					   N, Acc, F@_1, F@_2, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_soul_decompose_set_tos_auto(Rest, 0, 0, F@_1,
						F@_2, TrUserData);
      16 ->
	  d_field_m_soul_decompose_set_tos_color(Rest, 0, 0, F@_1,
						 F@_2, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_soul_decompose_set_tos(Rest, 0, 0, F@_1,
						     F@_2, TrUserData);
	    1 ->
		skip_64_m_soul_decompose_set_tos(Rest, 0, 0, F@_1, F@_2,
						 TrUserData);
	    2 ->
		skip_length_delimited_m_soul_decompose_set_tos(Rest, 0,
							       0, F@_1, F@_2,
							       TrUserData);
	    3 ->
		skip_group_m_soul_decompose_set_tos(Rest, Key bsr 3, 0,
						    F@_1, F@_2, TrUserData);
	    5 ->
		skip_32_m_soul_decompose_set_tos(Rest, 0, 0, F@_1, F@_2,
						 TrUserData)
	  end
    end;
dg_read_field_def_m_soul_decompose_set_tos(<<>>, 0, 0,
					   F@_1, F@_2, _) ->
    #m_soul_decompose_set_tos{auto = F@_1, color = F@_2}.

d_field_m_soul_decompose_set_tos_auto(<<1:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_soul_decompose_set_tos_auto(Rest, N + 7,
					  X bsl N + Acc, F@_1, F@_2,
					  TrUserData);
d_field_m_soul_decompose_set_tos_auto(<<0:1, X:7,
					Rest/binary>>,
				      N, Acc, _, F@_2, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    dfp_read_field_def_m_soul_decompose_set_tos(RestF, 0, 0,
						NewFValue, F@_2, TrUserData).

d_field_m_soul_decompose_set_tos_color(<<1:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_soul_decompose_set_tos_color(Rest, N + 7,
					   X bsl N + Acc, F@_1, F@_2,
					   TrUserData);
d_field_m_soul_decompose_set_tos_color(<<0:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, _, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
...
skip_varint_m_soul_decompose_set_tos(<<1:1, _:7,
				       Rest/binary>>,
				     Z1, Z2, F@_1, F@_2, TrUserData) ->
    skip_varint_m_soul_decompose_set_tos(Rest, Z1, Z2, F@_1,
					 F@_2, TrUserData);
skip_varint_m_soul_decompose_set_tos(<<0:1, _:7,
				       Rest/binary>>,
				     Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_soul_decompose_set_tos(Rest, Z1,
						Z2, F@_1, F@_2, TrUserData).

skip_length_delimited_m_soul_decompose_set_tos(<<1:1,
						 X:7, Rest/binary>>,
					       N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_soul_decompose_set_tos(Rest,
						   N + 7, X bsl N + Acc, F@_1,
						   F@_2, TrUserData);
skip_length_delimited_m_soul_decompose_set_tos(<<0:1,
						 X:7, Rest/binary>>,
					       N, Acc, F@_1, F@_2,
					       TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_soul_decompose_set_tos(Rest2, 0, 0,
						F@_1, F@_2, TrUserData).

skip_group_m_soul_decompose_set_tos(Bin, FNum, Z2, F@_1,
				    F@_2, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_soul_decompose_set_tos(Rest, 0, Z2,
						F@_1, F@_2, TrUserData).

skip_32_m_soul_decompose_set_tos(<<_:32, Rest/binary>>,
				 Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_soul_decompose_set_tos(Rest, Z1,
						Z2, F@_1, F@_2, TrUserData).

skip_64_m_soul_decompose_set_tos(<<_:64, Rest/binary>>,
				 Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_soul_decompose_set_tos(Rest, Z1,
						Z2, F@_1, F@_2, TrUserData).

decode_msg_m_soul_decompose_set_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_soul_decompose_set_toc(Bin, 0, 0,
						TrUserData).

dfp_read_field_def_m_soul_decompose_set_toc(<<>>, 0, 0,
					    _) ->
    #m_soul_decompose_set_toc{};
dfp_read_field_def_m_soul_decompose_set_toc(Other, Z1,
					    Z2, TrUserData) ->
    dg_read_field_def_m_soul_decompose_set_toc(Other, Z1,
					       Z2, TrUserData).

dg_read_field_def_m_soul_decompose_set_toc(<<1:1, X:7,
					     Rest/binary>>,
					   N, Acc, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_soul_decompose_set_toc(Rest, N + 7,
					       X bsl N + Acc, TrUserData);
dg_read_field_def_m_soul_decompose_set_toc(<<0:1, X:7,
					     Rest/binary>>,
					   N, Acc, TrUserData) ->
    Key = X bsl N + Acc,
    case Key band 7 of
      0 ->
	  skip_varint_m_soul_decompose_set_toc(Rest, 0, 0,
					       TrUserData);
      1 ->
	  skip_64_m_soul_decompose_set_toc(Rest, 0, 0,
					   TrUserData);
      2 ->
	  skip_length_delimited_m_soul_decompose_set_toc(Rest, 0,
							 0, TrUserData);
      3 ->
	  skip_group_m_soul_decompose_set_toc(Rest, Key bsr 3, 0,
					      TrUserData);
      5 ->
	  skip_32_m_soul_decompose_set_toc(Rest, 0, 0, TrUserData)
    end;
dg_read_field_def_m_soul_decompose_set_toc(<<>>, 0, 0,
					   _) ->
    #m_soul_decompose_set_toc{}.

skip_varint_m_soul_decompose_set_toc(<<1:1, _:7,
				       Rest/binary>>,
				     Z1, Z2, TrUserData) ->
    skip_varint_m_soul_decompose_set_toc(Rest, Z1, Z2,
					 TrUserData);
skip_varint_m_soul_decompose_set_toc(<<0:1, _:7,
				       Rest/binary>>,
				     Z1, Z2, TrUserData) ->
    dfp_read_field_def_m_soul_decompose_set_toc(Rest, Z1,
						Z2, TrUserData).

skip_length_delimited_m_soul_decompose_set_toc(<<1:1,
						 X:7, Rest/binary>>,
					       N, Acc, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_soul_decompose_set_toc(Rest,
						   N + 7, X bsl N + Acc,
						   TrUserData);
skip_length_delimited_m_soul_decompose_set_toc(<<0:1,
						 X:7, Rest/binary>>,
					       N, Acc, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_soul_decompose_set_toc(Rest2, 0, 0,
						TrUserData).

skip_group_m_soul_decompose_set_toc(Bin, FNum, Z2,
				    TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_soul_decompose_set_toc(Rest, 0, Z2,
						TrUserData).

skip_32_m_soul_decompose_set_toc(<<_:32, Rest/binary>>,
				 Z1, Z2, TrUserData) ->
    dfp_read_field_def_m_soul_decompose_set_toc(Rest, Z1,
						Z2, TrUserData).

skip_64_m_soul_decompose_set_toc(<<_:64, Rest/binary>>,
				 Z1, Z2, TrUserData) ->
    dfp_read_field_def_m_soul_decompose_set_toc(Rest, Z1,
						Z2, TrUserData).

decode_msg_m_soul_combine_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_soul_combine_tos(Bin, 0, 0,
					  id(undefined, TrUserData),
					  TrUserData).

dfp_read_field_def_m_soul_combine_tos(<<8,
					Rest/binary>>,
				      Z1, Z2, F@_1, TrUserData) ->
    d_field_m_soul_combine_tos_r_item_id(Rest, Z1, Z2, F@_1,
					 TrUserData);
dfp_read_field_def_m_soul_combine_tos(<<>>, 0, 0, F@_1,
				      _) ->
    #m_soul_combine_tos{r_item_id = F@_1};
dfp_read_field_def_m_soul_combine_tos(Other, Z1, Z2,
				      F@_1, TrUserData) ->
    dg_read_field_def_m_soul_combine_tos(Other, Z1, Z2,
					 F@_1, TrUserData).

dg_read_field_def_m_soul_combine_tos(<<1:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_soul_combine_tos(Rest, N + 7,
					 X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_m_soul_combine_tos(<<0:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_soul_combine_tos_r_item_id(Rest, 0, 0, F@_1,
					       TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_soul_combine_tos(Rest, 0, 0, F@_1,
					       TrUserData);
	    1 ->
		skip_64_m_soul_combine_tos(Rest, 0, 0, F@_1,
					   TrUserData);
	    2 ->
		skip_length_delimited_m_soul_combine_tos(Rest, 0, 0,
							 F@_1, TrUserData);
	    3 ->
		skip_group_m_soul_combine_tos(Rest, Key bsr 3, 0, F@_1,
					      TrUserData);
	    5 ->
		skip_32_m_soul_combine_tos(Rest, 0, 0, F@_1, TrUserData)
	  end
    end;
dg_read_field_def_m_soul_combine_tos(<<>>, 0, 0, F@_1,
				     _) ->
    #m_soul_combine_tos{r_item_id = F@_1}.

d_field_m_soul_combine_tos_r_item_id(<<1:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_m_soul_combine_tos_r_item_id(Rest, N + 7,
					 X bsl N + Acc, F@_1, TrUserData);
d_field_m_soul_combine_tos_r_item_id(<<0:1, X:7,
				       Rest/binary>>,
				     N, Acc, _, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    dfp_read_field_def_m_soul_combine_tos(RestF, 0, 0,
					  NewFValue, TrUserData).

skip_varint_m_soul_combine_tos(<<1:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, F@_1, TrUserData) ->
    skip_varint_m_soul_combine_tos(Rest, Z1, Z2, F@_1,
				   TrUserData);
skip_varint_m_soul_combine_tos(<<0:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_soul_combine_tos(Rest, Z1, Z2,
					  F@_1, TrUserData).

skip_length_delimited_m_soul_combine_tos(<<1:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_soul_combine_tos(Rest, N + 7,
					     X bsl N + Acc, F@_1, TrUserData);
skip_length_delimited_m_soul_combine_tos(<<0:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_soul_combine_tos(Rest2, 0, 0, F@_1,
					  TrUserData).

skip_group_m_soul_combine_tos(Bin, FNum, Z2, F@_1,
			      TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_soul_combine_tos(Rest, 0, Z2, F@_1,
					  TrUserData).

skip_32_m_soul_combine_tos(<<_:32, Rest/binary>>, Z1,
			   Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_soul_combine_tos(Rest, Z1, Z2,
					  F@_1, TrUserData).

skip_64_m_soul_combine_tos(<<_:64, Rest/binary>>, Z1,
			   Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_soul_combine_tos(Rest, Z1, Z2,
					  F@_1, TrUserData).

decode_msg_m_soul_combine_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_soul_combine_toc(Bin, 0, 0,
					  TrUserData).

dfp_read_field_def_m_soul_combine_toc(<<>>, 0, 0, _) ->
    #m_soul_combine_toc{};
dfp_read_field_def_m_soul_combine_toc(Other, Z1, Z2,
				      TrUserData) ->
    dg_read_field_def_m_soul_combine_toc(Other, Z1, Z2,
					 TrUserData).

dg_read_field_def_m_soul_combine_toc(<<1:1, X:7,
				       Rest/binary>>,
				     N, Acc, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_soul_combine_toc(Rest, N + 7,
					 X bsl N + Acc, TrUserData);
dg_read_field_def_m_soul_combine_toc(<<0:1, X:7,
				       Rest/binary>>,
				     N, Acc, TrUserData) ->
    Key = X bsl N + Acc,
    case Key band 7 of
      0 ->
	  skip_varint_m_soul_combine_toc(Rest, 0, 0, TrUserData);
      1 -> skip_64_m_soul_combine_toc(Rest, 0, 0, TrUserData);
      2 ->
	  skip_length_delimited_m_soul_combine_toc(Rest, 0, 0,
						   TrUserData);
      3 ->
	  skip_group_m_soul_combine_toc(Rest, Key bsr 3, 0,
					TrUserData);
      5 -> skip_32_m_soul_combine_toc(Rest, 0, 0, TrUserData)
    end;
dg_read_field_def_m_soul_combine_toc(<<>>, 0, 0, _) ->
    #m_soul_combine_toc{}.

skip_varint_m_soul_combine_toc(<<1:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, TrUserData) ->
    skip_varint_m_soul_combine_toc(Rest, Z1, Z2,
				   TrUserData);
skip_varint_m_soul_combine_toc(<<0:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, TrUserData) ->
    dfp_read_field_def_m_soul_combine_toc(Rest, Z1, Z2,
					  TrUserData).

skip_length_delimited_m_soul_combine_toc(<<1:1, X:7,
					   Rest/binary>>,
					 N, Acc, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_soul_combine_toc(Rest, N + 7,
					     X bsl N + Acc, TrUserData);
skip_length_delimited_m_soul_combine_toc(<<0:1, X:7,
					   Rest/binary>>,
					 N, Acc, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_soul_combine_toc(Rest2, 0, 0,
					  TrUserData).

skip_group_m_soul_combine_toc(Bin, FNum, Z2,
			      TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_soul_combine_toc(Rest, 0, Z2,
					  TrUserData).

skip_32_m_soul_combine_toc(<<_:32, Rest/binary>>, Z1,
			   Z2, TrUserData) ->
    dfp_read_field_def_m_soul_combine_toc(Rest, Z1, Z2,
					  TrUserData).

skip_64_m_soul_combine_toc(<<_:64, Rest/binary>>, Z1,
			   Z2, TrUserData) ->
    dfp_read_field_def_m_soul_combine_toc(Rest, Z1, Z2,
					  TrUserData).
...
merge_msgs(Prev, New, MsgName, Opts) ->
    ...
    case MsgName of
      m_soul_list_tos ->
	  merge_msg_m_soul_list_tos(Prev, New, TrUserData);
      m_soul_list_toc ->
	  merge_msg_m_soul_list_toc(Prev, New, TrUserData);
      m_soul_puton_tos ->
	  merge_msg_m_soul_puton_tos(Prev, New, TrUserData);
      m_soul_puton_toc ->
	  merge_msg_m_soul_puton_toc(Prev, New, TrUserData);
      m_soul_putoff_tos ->
	  merge_msg_m_soul_putoff_tos(Prev, New, TrUserData);
      m_soul_putoff_toc ->
	  merge_msg_m_soul_putoff_toc(Prev, New, TrUserData);
      m_soul_uplevel_tos ->
	  merge_msg_m_soul_uplevel_tos(Prev, New, TrUserData);
      m_soul_uplevel_toc ->
	  merge_msg_m_soul_uplevel_toc(Prev, New, TrUserData);
      m_soul_decompose_tos ->
	  merge_msg_m_soul_decompose_tos(Prev, New, TrUserData);
      m_soul_decompose_toc ->
	  merge_msg_m_soul_decompose_toc(Prev, New, TrUserData);
      m_soul_get_set_tos ->
	  merge_msg_m_soul_get_set_tos(Prev, New, TrUserData);
      m_soul_get_set_toc ->
	  merge_msg_m_soul_get_set_toc(Prev, New, TrUserData);
      m_soul_decompose_set_tos ->
	  merge_msg_m_soul_decompose_set_tos(Prev, New,
					     TrUserData);
      m_soul_decompose_set_toc ->
	  merge_msg_m_soul_decompose_set_toc(Prev, New,
					     TrUserData);
      m_soul_combine_tos ->
	  merge_msg_m_soul_combine_tos(Prev, New, TrUserData);
      m_soul_combine_toc ->
	  merge_msg_m_soul_combine_toc(Prev, New, TrUserData);
      p_role_base ->
...
-compile({nowarn_unused_function,merge_msg_m_soul_list_tos/3}).
merge_msg_m_soul_list_tos(_Prev, New, _TrUserData) ->
    New.

-compile({nowarn_unused_function,merge_msg_m_soul_list_toc/3}).
merge_msg_m_soul_list_toc(#m_soul_list_toc{souls =
					       PFsouls},
			  #m_soul_list_toc{souls = NFsouls}, TrUserData) ->
    #m_soul_list_toc{souls =
			 if PFsouls /= undefined, NFsouls /= undefined ->
				'tr_merge_m_soul_list_toc.souls'(PFsouls,
								 NFsouls,
								 TrUserData);
			    PFsouls == undefined -> NFsouls;
			    NFsouls == undefined -> PFsouls
			 end}.

-compile({nowarn_unused_function,merge_msg_m_soul_puton_tos/3}).
merge_msg_m_soul_puton_tos(#m_soul_puton_tos{},
			   #m_soul_puton_tos{pos = NFpos, uid = NFuid}, _) ->
    #m_soul_puton_tos{pos = NFpos, uid = NFuid}.

-compile({nowarn_unused_function,merge_msg_m_soul_puton_toc/3}).
merge_msg_m_soul_puton_toc(_Prev, New, _TrUserData) ->
    New.

-compile({nowarn_unused_function,merge_msg_m_soul_putoff_tos/3}).
merge_msg_m_soul_putoff_tos(#m_soul_putoff_tos{},
			    #m_soul_putoff_tos{pos = NFpos}, _) ->
    #m_soul_putoff_tos{pos = NFpos}.

-compile({nowarn_unused_function,merge_msg_m_soul_putoff_toc/3}).
merge_msg_m_soul_putoff_toc(#m_soul_putoff_toc{pos =
						   PFpos},
			    #m_soul_putoff_toc{pos = NFpos}, TrUserData) ->
    #m_soul_putoff_toc{pos =
...
-compile({nowarn_unused_function,merge_msg_m_soul_uplevel_tos/3}).
merge_msg_m_soul_uplevel_tos(#m_soul_uplevel_tos{},
			     #m_soul_uplevel_tos{pos = NFpos}, _) ->
    #m_soul_uplevel_tos{pos = NFpos}.

-compile({nowarn_unused_function,merge_msg_m_soul_uplevel_toc/3}).
merge_msg_m_soul_uplevel_toc(#m_soul_uplevel_toc{},
			     #m_soul_uplevel_toc{pos = NFpos}, _) ->
    #m_soul_uplevel_toc{pos = NFpos}.

-compile({nowarn_unused_function,merge_msg_m_soul_decompose_tos/3}).
merge_msg_m_soul_decompose_tos(#m_soul_decompose_tos{uid
							 = PFuid},
			       #m_soul_decompose_tos{uid = NFuid},
			       TrUserData) ->
    #m_soul_decompose_tos{uid =
			      if PFuid /= undefined, NFuid /= undefined ->
				     'erlang_++'(PFuid, NFuid, TrUserData);
				 PFuid == undefined -> NFuid;
				 NFuid == undefined -> PFuid
			      end}.

-compile({nowarn_unused_function,merge_msg_m_soul_decompose_toc/3}).
merge_msg_m_soul_decompose_toc(_Prev, New,
			       _TrUserData) ->
    New.

-compile({nowarn_unused_function,merge_msg_m_soul_get_set_tos/3}).
merge_msg_m_soul_get_set_tos(_Prev, New, _TrUserData) ->
    New.

-compile({nowarn_unused_function,merge_msg_m_soul_get_set_toc/3}).
merge_msg_m_soul_get_set_toc(#m_soul_get_set_toc{auto =
						     PFauto,
						 color = PFcolor},
			     #m_soul_get_set_toc{auto = NFauto,
						 color = NFcolor},
			     _) ->
    #m_soul_get_set_toc{auto =
...
-compile({nowarn_unused_function,merge_msg_m_soul_decompose_set_tos/3}).
merge_msg_m_soul_decompose_set_tos(#m_soul_decompose_set_tos{auto
								 = PFauto,
							     color = PFcolor},
				   #m_soul_decompose_set_tos{auto = NFauto,
							     color = NFcolor},
				   _) ->
    #m_soul_decompose_set_tos{auto =
				  if NFauto =:= undefined -> PFauto;
				     true -> NFauto
				  end,
			      color =
...
-compile({nowarn_unused_function,merge_msg_m_soul_decompose_set_toc/3}).
merge_msg_m_soul_decompose_set_toc(_Prev, New,
				   _TrUserData) ->
    New.

-compile({nowarn_unused_function,merge_msg_m_soul_combine_tos/3}).
merge_msg_m_soul_combine_tos(#m_soul_combine_tos{},
			     #m_soul_combine_tos{r_item_id = NFr_item_id}, _) ->
    #m_soul_combine_tos{r_item_id = NFr_item_id}.

-compile({nowarn_unused_function,merge_msg_m_soul_combine_toc/3}).
merge_msg_m_soul_combine_toc(_Prev, New, _TrUserData) ->
    New.
...
verify_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
      m_soul_list_tos ->
	  v_msg_m_soul_list_tos(Msg, [MsgName], TrUserData);
      m_soul_list_toc ->
	  v_msg_m_soul_list_toc(Msg, [MsgName], TrUserData);
      m_soul_puton_tos ->
	  v_msg_m_soul_puton_tos(Msg, [MsgName], TrUserData);
      m_soul_puton_toc ->
	  v_msg_m_soul_puton_toc(Msg, [MsgName], TrUserData);
      m_soul_putoff_tos ->
	  v_msg_m_soul_putoff_tos(Msg, [MsgName], TrUserData);
      m_soul_putoff_toc ->
	  v_msg_m_soul_putoff_toc(Msg, [MsgName], TrUserData);
      m_soul_uplevel_tos ->
	  v_msg_m_soul_uplevel_tos(Msg, [MsgName], TrUserData);
      m_soul_uplevel_toc ->
	  v_msg_m_soul_uplevel_toc(Msg, [MsgName], TrUserData);
      m_soul_decompose_tos ->
	  v_msg_m_soul_decompose_tos(Msg, [MsgName], TrUserData);
      m_soul_decompose_toc ->
	  v_msg_m_soul_decompose_toc(Msg, [MsgName], TrUserData);
      m_soul_get_set_tos ->
	  v_msg_m_soul_get_set_tos(Msg, [MsgName], TrUserData);
      m_soul_get_set_toc ->
	  v_msg_m_soul_get_set_toc(Msg, [MsgName], TrUserData);
      m_soul_decompose_set_tos ->
	  v_msg_m_soul_decompose_set_tos(Msg, [MsgName],
					 TrUserData);
      m_soul_decompose_set_toc ->
	  v_msg_m_soul_decompose_set_toc(Msg, [MsgName],
					 TrUserData);
      m_soul_combine_tos ->
	  v_msg_m_soul_combine_tos(Msg, [MsgName], TrUserData);
      m_soul_combine_toc ->
	  v_msg_m_soul_combine_toc(Msg, [MsgName], TrUserData);
      p_role_base ->
...
-compile({nowarn_unused_function,v_msg_m_soul_list_tos/3}).
-dialyzer({nowarn_function,v_msg_m_soul_list_tos/3}).
v_msg_m_soul_list_tos(#m_soul_list_tos{}, _Path, _) ->
    ok;
v_msg_m_soul_list_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_soul_list_tos}, X, Path).

-compile({nowarn_unused_function,v_msg_m_soul_list_toc/3}).
-dialyzer({nowarn_function,v_msg_m_soul_list_toc/3}).
v_msg_m_soul_list_toc(#m_soul_list_toc{souls = F1},
		      Path, TrUserData) ->
    'v_map<int32,p_item>'(F1, [souls | Path], TrUserData),
    ok;
v_msg_m_soul_list_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_soul_list_toc}, X, Path).

-compile({nowarn_unused_function,v_msg_m_soul_puton_tos/3}).
-dialyzer({nowarn_function,v_msg_m_soul_puton_tos/3}).
v_msg_m_soul_puton_tos(#m_soul_puton_tos{pos = F1,
					 uid = F2},
		       Path, TrUserData) ->
    v_type_int32(F1, [pos | Path], TrUserData),
    v_type_int32(F2, [uid | Path], TrUserData),
    ok;
v_msg_m_soul_puton_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_soul_puton_tos}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_soul_puton_toc/3}).
-dialyzer({nowarn_function,v_msg_m_soul_puton_toc/3}).
v_msg_m_soul_puton_toc(#m_soul_puton_toc{}, _Path, _) ->
    ok;
v_msg_m_soul_puton_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_soul_puton_toc}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_soul_putoff_tos/3}).
-dialyzer({nowarn_function,v_msg_m_soul_putoff_tos/3}).
v_msg_m_soul_putoff_tos(#m_soul_putoff_tos{pos = F1},
			Path, TrUserData) ->
    v_type_int32(F1, [pos | Path], TrUserData), ok;
v_msg_m_soul_putoff_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_soul_putoff_tos}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_soul_putoff_toc/3}).
-dialyzer({nowarn_function,v_msg_m_soul_putoff_toc/3}).
v_msg_m_soul_putoff_toc(#m_soul_putoff_toc{pos = F1},
			Path, TrUserData) ->
    if is_list(F1) ->
    ...
    ok;
v_msg_m_soul_putoff_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_soul_putoff_toc}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_soul_uplevel_tos/3}).
-dialyzer({nowarn_function,v_msg_m_soul_uplevel_tos/3}).
v_msg_m_soul_uplevel_tos(#m_soul_uplevel_tos{pos = F1},
			 Path, TrUserData) ->
    v_type_int32(F1, [pos | Path], TrUserData), ok;
v_msg_m_soul_uplevel_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_soul_uplevel_tos}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_soul_uplevel_toc/3}).
-dialyzer({nowarn_function,v_msg_m_soul_uplevel_toc/3}).
v_msg_m_soul_uplevel_toc(#m_soul_uplevel_toc{pos = F1},
			 Path, TrUserData) ->
    v_type_int32(F1, [pos | Path], TrUserData), ok;
v_msg_m_soul_uplevel_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_soul_uplevel_toc}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_soul_decompose_tos/3}).
-dialyzer({nowarn_function,v_msg_m_soul_decompose_tos/3}).
v_msg_m_soul_decompose_tos(#m_soul_decompose_tos{uid =
						     F1},
			   Path, TrUserData) ->
    if is_list(F1) ->
    ...
    ok;
v_msg_m_soul_decompose_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_soul_decompose_tos}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_soul_decompose_toc/3}).
-dialyzer({nowarn_function,v_msg_m_soul_decompose_toc/3}).
v_msg_m_soul_decompose_toc(#m_soul_decompose_toc{},
			   _Path, _) ->
    ok;
v_msg_m_soul_decompose_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_soul_decompose_toc}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_soul_get_set_tos/3}).
-dialyzer({nowarn_function,v_msg_m_soul_get_set_tos/3}).
v_msg_m_soul_get_set_tos(#m_soul_get_set_tos{}, _Path,
			 _) ->
    ok;
v_msg_m_soul_get_set_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_soul_get_set_tos}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_soul_get_set_toc/3}).
-dialyzer({nowarn_function,v_msg_m_soul_get_set_toc/3}).
v_msg_m_soul_get_set_toc(#m_soul_get_set_toc{auto = F1,
					     color = F2},
			 Path, TrUserData) ->
    if F1 == undefined -> ok;
    ...
    if F2 == undefined -> ok;
       true -> v_type_int32(F2, [color | Path], TrUserData)
    end,
    ok;
v_msg_m_soul_get_set_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_soul_get_set_toc}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_soul_decompose_set_tos/3}).
-dialyzer({nowarn_function,v_msg_m_soul_decompose_set_tos/3}).
v_msg_m_soul_decompose_set_tos(#m_soul_decompose_set_tos{auto
							     = F1,
							 color = F2},
			       Path, TrUserData) ->
    if F1 == undefined -> ok;
    ...
    ok;
v_msg_m_soul_decompose_set_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_soul_decompose_set_tos},
		  X, Path).

-compile({nowarn_unused_function,v_msg_m_soul_decompose_set_toc/3}).
-dialyzer({nowarn_function,v_msg_m_soul_decompose_set_toc/3}).
v_msg_m_soul_decompose_set_toc(#m_soul_decompose_set_toc{},
			       _Path, _) ->
    ok;
v_msg_m_soul_decompose_set_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_soul_decompose_set_toc},
		  X, Path).

-compile({nowarn_unused_function,v_msg_m_soul_combine_tos/3}).
-dialyzer({nowarn_function,v_msg_m_soul_combine_tos/3}).
v_msg_m_soul_combine_tos(#m_soul_combine_tos{r_item_id =
						 F1},
			 Path, TrUserData) ->
    v_type_int32(F1, [r_item_id | Path], TrUserData), ok;
v_msg_m_soul_combine_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_soul_combine_tos}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_soul_combine_toc/3}).
-dialyzer({nowarn_function,v_msg_m_soul_combine_toc/3}).
v_msg_m_soul_combine_toc(#m_soul_combine_toc{}, _Path,
			 _) ->
    ok;
v_msg_m_soul_combine_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_soul_combine_toc}, X,
		  Path).
...
-compile({inline,'tr_encode_m_soul_list_toc.souls[x]'/2}).
'tr_encode_m_soul_list_toc.souls[x]'(X, _) ->
...
-compile({inline,'tr_decode_init_default_m_soul_list_toc.souls'/2}).
'tr_decode_init_default_m_soul_list_toc.souls'(_, _) ->
    mt_empty_map_m().

-compile({inline,'tr_merge_m_soul_list_toc.souls'/3}).
'tr_merge_m_soul_list_toc.souls'(X1, X2, _) ->
    mt_merge_maps_m(X1, X2).

-compile({inline,'tr_decode_repeated_finalize_m_soul_list_toc.souls'/2}).
'tr_decode_repeated_finalize_m_soul_list_toc.souls'(L,
						    TrUserData) ->
    id(L, TrUserData).

-compile({inline,'tr_encode_m_soul_list_toc.souls'/2}).
'tr_encode_m_soul_list_toc.souls'(X, _) ->
    mt_map_to_list_m(X).

-compile({inline,'tr_decode_repeated_add_elem_m_soul_list_toc.souls'/3}).
'tr_decode_repeated_add_elem_m_soul_list_toc.souls'(Elem,
						    L, _) ->
...
get_msg_defs() ->
    [{{msg, m_soul_list_tos}, []},
     {{msg, m_soul_list_toc},
      [#field{name = souls, fnum = 1, rnum = 2,
	      type = {map, int32, {msg, p_item}},
	      occurrence = repeated, opts = []}]},
     {{msg, m_soul_puton_tos},
      [#field{name = pos, fnum = 1, rnum = 2, type = int32,
	      occurrence = required, opts = []},
       #field{name = uid, fnum = 2, rnum = 3, type = int32,
	      occurrence = required, opts = []}]},
     {{msg, m_soul_puton_toc}, []},
     {{msg, m_soul_putoff_tos},
      [#field{name = pos, fnum = 1, rnum = 2, type = int32,
	      occurrence = required, opts = []}]},
     {{msg, m_soul_putoff_toc},
      [#field{name = pos, fnum = 1, rnum = 2, type = int32,
	      occurrence = repeated, opts = []}]},
     {{msg, m_soul_uplevel_tos},
      [#field{name = pos, fnum = 1, rnum = 2, type = int32,
	      occurrence = required, opts = []}]},
     {{msg, m_soul_uplevel_toc},
      [#field{name = pos, fnum = 1, rnum = 2, type = int32,
	      occurrence = required, opts = []}]},
     {{msg, m_soul_decompose_tos},
      [#field{name = uid, fnum = 1, rnum = 2, type = int32,
	      occurrence = repeated, opts = []}]},
     {{msg, m_soul_decompose_toc}, []},
     {{msg, m_soul_get_set_tos}, []},
     {{msg, m_soul_get_set_toc},
      [#field{name = auto, fnum = 1, rnum = 2, type = int32,
	      occurrence = optional, opts = []},
       #field{name = color, fnum = 2, rnum = 3, type = int32,
	      occurrence = optional, opts = []}]},
     {{msg, m_soul_decompose_set_tos},
      [#field{name = auto, fnum = 1, rnum = 2, type = int32,
	      occurrence = optional, opts = []},
       #field{name = color, fnum = 2, rnum = 3, type = int32,
	      occurrence = optional, opts = []}]},
     {{msg, m_soul_decompose_set_toc}, []},
     {{msg, m_soul_combine_tos},
      [#field{name = r_item_id, fnum = 1, rnum = 2,
	      type = int32, occurrence = required, opts = []}]},
     {{msg, m_soul_combine_toc}, []},
     {{msg, p_role_base},
...
get_msg_names() ->
    [m_soul_list_tos, m_soul_list_toc, m_soul_puton_tos,
     m_soul_puton_toc, m_soul_putoff_tos, m_soul_putoff_toc,
     m_soul_uplevel_tos, m_soul_uplevel_toc,
     m_soul_decompose_tos, m_soul_decompose_toc,
     m_soul_get_set_tos, m_soul_get_set_toc,
     m_soul_decompose_set_tos, m_soul_decompose_set_toc,
     m_soul_combine_tos, m_soul_combine_toc, p_role_base,
...
find_msg_def(m_soul_list_tos) -> [];
find_msg_def(m_soul_list_toc) ->
    [#field{name = souls, fnum = 1, rnum = 2,
	    type = {map, int32, {msg, p_item}},
	    occurrence = repeated, opts = []}];
find_msg_def(m_soul_puton_tos) ->
    [#field{name = pos, fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []},
     #field{name = uid, fnum = 2, rnum = 3, type = int32,
	    occurrence = required, opts = []}];
find_msg_def(m_soul_puton_toc) -> [];
find_msg_def(m_soul_putoff_tos) ->
    [#field{name = pos, fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []}];
find_msg_def(m_soul_putoff_toc) ->
    [#field{name = pos, fnum = 1, rnum = 2, type = int32,
	    occurrence = repeated, opts = []}];
find_msg_def(m_soul_uplevel_tos) ->
    [#field{name = pos, fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []}];
find_msg_def(m_soul_uplevel_toc) ->
    [#field{name = pos, fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []}];
find_msg_def(m_soul_decompose_tos) ->
    [#field{name = uid, fnum = 1, rnum = 2, type = int32,
	    occurrence = repeated, opts = []}];
find_msg_def(m_soul_decompose_toc) -> [];
find_msg_def(m_soul_get_set_tos) -> [];
find_msg_def(m_soul_get_set_toc) ->
    [#field{name = auto, fnum = 1, rnum = 2, type = int32,
	    occurrence = optional, opts = []},
     #field{name = color, fnum = 2, rnum = 3, type = int32,
	    occurrence = optional, opts = []}];
find_msg_def(m_soul_decompose_set_tos) ->
    [#field{name = auto, fnum = 1, rnum = 2, type = int32,
	    occurrence = optional, opts = []},
     #field{name = color, fnum = 2, rnum = 3, type = int32,
	    occurrence = optional, opts = []}];
find_msg_def(m_soul_decompose_set_toc) -> [];
find_msg_def(m_soul_combine_tos) ->
    [#field{name = r_item_id, fnum = 1, rnum = 2,
	    type = int32, occurrence = required, opts = []}];
find_msg_def(m_soul_combine_toc) -> [];
