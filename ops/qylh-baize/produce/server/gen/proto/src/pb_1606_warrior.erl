...
%% message types
-type m_warrior_info_tos() :: #m_warrior_info_tos{}.

-type m_warrior_info_toc() :: #m_warrior_info_toc{}.

-type m_warrior_update_toc() :: #m_warrior_update_toc{}.

-type m_warrior_end_toc() :: #m_warrior_end_toc{}.

-type m_warrior_rank_tos() :: #m_warrior_rank_tos{}.

-type m_warrior_rank_toc() :: #m_warrior_rank_toc{}.

-type m_warrior_creep_toc() :: #m_warrior_creep_toc{}.
...
-export_type(['m_warrior_info_tos'/0, 'm_warrior_info_toc'/0, 'm_warrior_update_toc'/0, 'm_warrior_end_toc'/0, 'm_warrior_rank_tos'/0, 'm_warrior_rank_toc'/0, 'm_warrior_creep_toc'/0, 'p_role_base'/0, 'p_aspect'/0, 'p_attr'/0, 'p_item_base'/0, 'p_item'/0, 'p_equip'/0, 'p_pet'/0, 'p_marriage'/0, 'p_refine'/0, 'p_actor'/0, 'p_role'/0, 'p_creep'/0, 'p_npc'/0, 'p_drop'/0, 'p_buff'/0, 'p_coord'/0, 'p_icon'/0, 'p_ranking'/0, 'p_dropped'/0]).

-spec encode_msg(#m_warrior_info_tos{} | #m_warrior_info_toc{} | #m_warrior_update_toc{} | #m_warrior_end_toc{} | #m_warrior_rank_tos{} | #m_warrior_rank_toc{} | #m_warrior_creep_toc{} | #p_role_base{} | #p_aspect{} | #p_attr{} | #p_item_base{} | #p_item{} | #p_equip{} | #p_pet{} | #p_marriage{} | #p_refine{} | #p_actor{} | #p_role{} | #p_creep{} | #p_npc{} | #p_drop{} | #p_buff{} | #p_coord{} | #p_icon{} | #p_ranking{} | #p_dropped{}) -> binary().
encode_msg(Msg) when tuple_size(Msg) >= 1 ->
    encode_msg(Msg, element(1, Msg), []).

-spec encode_msg(#m_warrior_info_tos{} | #m_warrior_info_toc{} | #m_warrior_update_toc{} | #m_warrior_end_toc{} | #m_warrior_rank_tos{} | #m_warrior_rank_toc{} | #m_warrior_creep_toc{} | #p_role_base{} | #p_aspect{} | #p_attr{} | #p_item_base{} | #p_item{} | #p_equip{} | #p_pet{} | #p_marriage{} | #p_refine{} | #p_actor{} | #p_role{} | #p_creep{} | #p_npc{} | #p_drop{} | #p_buff{} | #p_coord{} | #p_icon{} | #p_ranking{} | #p_dropped{}, atom() | list()) -> binary().
...
encode_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
      m_warrior_info_tos ->
	  encode_msg_m_warrior_info_tos(id(Msg, TrUserData),
					TrUserData);
      m_warrior_info_toc ->
	  encode_msg_m_warrior_info_toc(id(Msg, TrUserData),
					TrUserData);
      m_warrior_update_toc ->
	  encode_msg_m_warrior_update_toc(id(Msg, TrUserData),
					  TrUserData);
      m_warrior_end_toc ->
	  encode_msg_m_warrior_end_toc(id(Msg, TrUserData),
				       TrUserData);
      m_warrior_rank_tos ->
	  encode_msg_m_warrior_rank_tos(id(Msg, TrUserData),
					TrUserData);
      m_warrior_rank_toc ->
	  encode_msg_m_warrior_rank_toc(id(Msg, TrUserData),
					TrUserData);
      m_warrior_creep_toc ->
	  encode_msg_m_warrior_creep_toc(id(Msg, TrUserData),
					 TrUserData);
      p_role_base ->
...
encode_msg_m_warrior_info_tos(_Msg, _TrUserData) ->
    <<>>.

encode_msg_m_warrior_info_toc(Msg, TrUserData) ->
    encode_msg_m_warrior_info_toc(Msg, <<>>, TrUserData).


encode_msg_m_warrior_info_toc(#m_warrior_info_toc{end_time
						      = F1},
			      Bin, TrUserData) ->
    begin
...
encode_msg_m_warrior_update_toc(Msg, TrUserData) ->
    encode_msg_m_warrior_update_toc(Msg, <<>>, TrUserData).


encode_msg_m_warrior_update_toc(#m_warrior_update_toc{floor
							  = F1,
						      score = F2, kill = F3},
				Bin, TrUserData) ->
    B1 = begin
...
encode_msg_m_warrior_end_toc(Msg, TrUserData) ->
    encode_msg_m_warrior_end_toc(Msg, <<>>, TrUserData).


encode_msg_m_warrior_end_toc(#m_warrior_end_toc{rank =
						    F1,
						score = F2, floor = F3,
						is_cross = F4},
			     Bin, TrUserData) ->
...
encode_msg_m_warrior_rank_tos(Msg, TrUserData) ->
    encode_msg_m_warrior_rank_tos(Msg, <<>>, TrUserData).


encode_msg_m_warrior_rank_tos(#m_warrior_rank_tos{num =
						      F1},
			      Bin, TrUserData) ->
    begin
      TrF1 = id(F1, TrUserData),
...
encode_msg_m_warrior_rank_toc(Msg, TrUserData) ->
    encode_msg_m_warrior_rank_toc(Msg, <<>>, TrUserData).


encode_msg_m_warrior_rank_toc(#m_warrior_rank_toc{list =
						      F1,
						  mine = F2},
			      Bin, TrUserData) ->
    B1 = begin
	   ...
	   if TrF1 == [] -> Bin;
	      true ->
		  e_field_m_warrior_rank_toc_list(TrF1, Bin, TrUserData)
	   end
	 end,
    begin
      TrF2 = id(F2, TrUserData),
      e_mfield_m_warrior_rank_toc_mine(TrF2,
				       <<B1/binary, 18>>, TrUserData)
    end.

encode_msg_m_warrior_creep_toc(Msg, TrUserData) ->
    encode_msg_m_warrior_creep_toc(Msg, <<>>, TrUserData).


encode_msg_m_warrior_creep_toc(#m_warrior_creep_toc{state
							= F1},
			       Bin, TrUserData) ->
    begin
      TrF1 = id(F1, TrUserData),
...
e_mfield_m_warrior_rank_toc_list(Msg, Bin,
				 TrUserData) ->
    SubBin = encode_msg_p_ranking(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

e_field_m_warrior_rank_toc_list([Elem | Rest], Bin,
				TrUserData) ->
    Bin2 = <<Bin/binary, 10>>,
    Bin3 = e_mfield_m_warrior_rank_toc_list(id(Elem,
					       TrUserData),
					    Bin2, TrUserData),
    e_field_m_warrior_rank_toc_list(Rest, Bin3, TrUserData);
e_field_m_warrior_rank_toc_list([], Bin, _TrUserData) ->
    Bin.

e_mfield_m_warrior_rank_toc_mine(Msg, Bin,
				 TrUserData) ->
    SubBin = encode_msg_p_ranking(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.
...
decode_msg_2_doit(m_warrior_info_tos, Bin,
		  TrUserData) ->
    id(decode_msg_m_warrior_info_tos(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_warrior_info_toc, Bin,
		  TrUserData) ->
    id(decode_msg_m_warrior_info_toc(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_warrior_update_toc, Bin,
		  TrUserData) ->
    id(decode_msg_m_warrior_update_toc(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_warrior_end_toc, Bin, TrUserData) ->
    id(decode_msg_m_warrior_end_toc(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_warrior_rank_tos, Bin,
		  TrUserData) ->
    id(decode_msg_m_warrior_rank_tos(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_warrior_rank_toc, Bin,
		  TrUserData) ->
    id(decode_msg_m_warrior_rank_toc(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_warrior_creep_toc, Bin,
		  TrUserData) ->
    id(decode_msg_m_warrior_creep_toc(Bin, TrUserData),
       TrUserData);
...
decode_msg_m_warrior_info_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_warrior_info_tos(Bin, 0, 0,
					  TrUserData).

dfp_read_field_def_m_warrior_info_tos(<<>>, 0, 0, _) ->
    #m_warrior_info_tos{};
dfp_read_field_def_m_warrior_info_tos(Other, Z1, Z2,
				      TrUserData) ->
    dg_read_field_def_m_warrior_info_tos(Other, Z1, Z2,
					 TrUserData).

dg_read_field_def_m_warrior_info_tos(<<1:1, X:7,
				       Rest/binary>>,
				     N, Acc, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_warrior_info_tos(Rest, N + 7,
					 X bsl N + Acc, TrUserData);
dg_read_field_def_m_warrior_info_tos(<<0:1, X:7,
				       Rest/binary>>,
				     N, Acc, TrUserData) ->
    Key = X bsl N + Acc,
    case Key band 7 of
      0 ->
	  skip_varint_m_warrior_info_tos(Rest, 0, 0, TrUserData);
      1 -> skip_64_m_warrior_info_tos(Rest, 0, 0, TrUserData);
      2 ->
	  skip_length_delimited_m_warrior_info_tos(Rest, 0, 0,
						   TrUserData);
      3 ->
	  skip_group_m_warrior_info_tos(Rest, Key bsr 3, 0,
					TrUserData);
      5 -> skip_32_m_warrior_info_tos(Rest, 0, 0, TrUserData)
    end;
dg_read_field_def_m_warrior_info_tos(<<>>, 0, 0, _) ->
    #m_warrior_info_tos{}.

skip_varint_m_warrior_info_tos(<<1:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, TrUserData) ->
    skip_varint_m_warrior_info_tos(Rest, Z1, Z2,
				   TrUserData);
skip_varint_m_warrior_info_tos(<<0:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, TrUserData) ->
    dfp_read_field_def_m_warrior_info_tos(Rest, Z1, Z2,
					  TrUserData).

skip_length_delimited_m_warrior_info_tos(<<1:1, X:7,
					   Rest/binary>>,
					 N, Acc, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_warrior_info_tos(Rest, N + 7,
					     X bsl N + Acc, TrUserData);
skip_length_delimited_m_warrior_info_tos(<<0:1, X:7,
					   Rest/binary>>,
					 N, Acc, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_warrior_info_tos(Rest2, 0, 0,
					  TrUserData).

skip_group_m_warrior_info_tos(Bin, FNum, Z2,
			      TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_warrior_info_tos(Rest, 0, Z2,
					  TrUserData).

skip_32_m_warrior_info_tos(<<_:32, Rest/binary>>, Z1,
			   Z2, TrUserData) ->
    dfp_read_field_def_m_warrior_info_tos(Rest, Z1, Z2,
					  TrUserData).

skip_64_m_warrior_info_tos(<<_:64, Rest/binary>>, Z1,
			   Z2, TrUserData) ->
    dfp_read_field_def_m_warrior_info_tos(Rest, Z1, Z2,
					  TrUserData).

decode_msg_m_warrior_info_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_warrior_info_toc(Bin, 0, 0,
					  id(undefined, TrUserData),
					  TrUserData).

dfp_read_field_def_m_warrior_info_toc(<<8,
					Rest/binary>>,
				      Z1, Z2, F@_1, TrUserData) ->
    d_field_m_warrior_info_toc_end_time(Rest, Z1, Z2, F@_1,
					TrUserData);
dfp_read_field_def_m_warrior_info_toc(<<>>, 0, 0, F@_1,
				      _) ->
    #m_warrior_info_toc{end_time = F@_1};
dfp_read_field_def_m_warrior_info_toc(Other, Z1, Z2,
				      F@_1, TrUserData) ->
    dg_read_field_def_m_warrior_info_toc(Other, Z1, Z2,
					 F@_1, TrUserData).

dg_read_field_def_m_warrior_info_toc(<<1:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_warrior_info_toc(Rest, N + 7,
					 X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_m_warrior_info_toc(<<0:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_warrior_info_toc_end_time(Rest, 0, 0, F@_1,
					      TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_warrior_info_toc(Rest, 0, 0, F@_1,
					       TrUserData);
	    1 ->
		skip_64_m_warrior_info_toc(Rest, 0, 0, F@_1,
					   TrUserData);
	    2 ->
		skip_length_delimited_m_warrior_info_toc(Rest, 0, 0,
							 F@_1, TrUserData);
	    3 ->
		skip_group_m_warrior_info_toc(Rest, Key bsr 3, 0, F@_1,
					      TrUserData);
	    5 ->
		skip_32_m_warrior_info_toc(Rest, 0, 0, F@_1, TrUserData)
	  end
    end;
dg_read_field_def_m_warrior_info_toc(<<>>, 0, 0, F@_1,
				     _) ->
    #m_warrior_info_toc{end_time = F@_1}.

d_field_m_warrior_info_toc_end_time(<<1:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_m_warrior_info_toc_end_time(Rest, N + 7,
					X bsl N + Acc, F@_1, TrUserData);
d_field_m_warrior_info_toc_end_time(<<0:1, X:7,
				      Rest/binary>>,
				    N, Acc, _, TrUserData) ->
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    dfp_read_field_def_m_warrior_info_toc(RestF, 0, 0,
					  NewFValue, TrUserData).

skip_varint_m_warrior_info_toc(<<1:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, F@_1, TrUserData) ->
    skip_varint_m_warrior_info_toc(Rest, Z1, Z2, F@_1,
				   TrUserData);
skip_varint_m_warrior_info_toc(<<0:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_warrior_info_toc(Rest, Z1, Z2,
					  F@_1, TrUserData).

skip_length_delimited_m_warrior_info_toc(<<1:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_warrior_info_toc(Rest, N + 7,
					     X bsl N + Acc, F@_1, TrUserData);
skip_length_delimited_m_warrior_info_toc(<<0:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_warrior_info_toc(Rest2, 0, 0, F@_1,
					  TrUserData).

skip_group_m_warrior_info_toc(Bin, FNum, Z2, F@_1,
			      TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_warrior_info_toc(Rest, 0, Z2, F@_1,
					  TrUserData).

skip_32_m_warrior_info_toc(<<_:32, Rest/binary>>, Z1,
			   Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_warrior_info_toc(Rest, Z1, Z2,
					  F@_1, TrUserData).

skip_64_m_warrior_info_toc(<<_:64, Rest/binary>>, Z1,
			   Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_warrior_info_toc(Rest, Z1, Z2,
					  F@_1, TrUserData).

decode_msg_m_warrior_update_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_warrior_update_toc(Bin, 0, 0,
					    id(undefined, TrUserData),
					    id(undefined, TrUserData),
					    id(undefined, TrUserData),
					    TrUserData).

dfp_read_field_def_m_warrior_update_toc(<<8,
					  Rest/binary>>,
					Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
    d_field_m_warrior_update_toc_floor(Rest, Z1, Z2, F@_1,
				       F@_2, F@_3, TrUserData);
dfp_read_field_def_m_warrior_update_toc(<<16,
					  Rest/binary>>,
					Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
    d_field_m_warrior_update_toc_score(Rest, Z1, Z2, F@_1,
				       F@_2, F@_3, TrUserData);
dfp_read_field_def_m_warrior_update_toc(<<24,
					  Rest/binary>>,
					Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
    d_field_m_warrior_update_toc_kill(Rest, Z1, Z2, F@_1,
				      F@_2, F@_3, TrUserData);
dfp_read_field_def_m_warrior_update_toc(<<>>, 0, 0,
					F@_1, F@_2, F@_3, _) ->
    #m_warrior_update_toc{floor = F@_1, score = F@_2,
			  kill = F@_3};
dfp_read_field_def_m_warrior_update_toc(Other, Z1, Z2,
					F@_1, F@_2, F@_3, TrUserData) ->
    dg_read_field_def_m_warrior_update_toc(Other, Z1, Z2,
					   F@_1, F@_2, F@_3, TrUserData).

dg_read_field_def_m_warrior_update_toc(<<1:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_warrior_update_toc(Rest, N + 7,
					   X bsl N + Acc, F@_1, F@_2, F@_3,
					   TrUserData);
dg_read_field_def_m_warrior_update_toc(<<0:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, F@_2, F@_3, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_warrior_update_toc_floor(Rest, 0, 0, F@_1,
					     F@_2, F@_3, TrUserData);
      16 ->
	  d_field_m_warrior_update_toc_score(Rest, 0, 0, F@_1,
					     F@_2, F@_3, TrUserData);
      24 ->
	  d_field_m_warrior_update_toc_kill(Rest, 0, 0, F@_1,
					    F@_2, F@_3, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_warrior_update_toc(Rest, 0, 0, F@_1, F@_2,
						 F@_3, TrUserData);
	    1 ->
		skip_64_m_warrior_update_toc(Rest, 0, 0, F@_1, F@_2,
					     F@_3, TrUserData);
	    2 ->
		skip_length_delimited_m_warrior_update_toc(Rest, 0, 0,
							   F@_1, F@_2, F@_3,
							   TrUserData);
	    3 ->
		skip_group_m_warrior_update_toc(Rest, Key bsr 3, 0,
						F@_1, F@_2, F@_3, TrUserData);
	    5 ->
		skip_32_m_warrior_update_toc(Rest, 0, 0, F@_1, F@_2,
					     F@_3, TrUserData)
	  end
    end;
dg_read_field_def_m_warrior_update_toc(<<>>, 0, 0, F@_1,
				       F@_2, F@_3, _) ->
    #m_warrior_update_toc{floor = F@_1, score = F@_2,
			  kill = F@_3}.

d_field_m_warrior_update_toc_floor(<<1:1, X:7,
				     Rest/binary>>,
				   N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    d_field_m_warrior_update_toc_floor(Rest, N + 7,
				       X bsl N + Acc, F@_1, F@_2, F@_3,
				       TrUserData);
d_field_m_warrior_update_toc_floor(<<0:1, X:7,
				     Rest/binary>>,
    ...
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    dfp_read_field_def_m_warrior_update_toc(RestF, 0, 0,
					    NewFValue, F@_2, F@_3, TrUserData).

d_field_m_warrior_update_toc_score(<<1:1, X:7,
				     Rest/binary>>,
				   N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    d_field_m_warrior_update_toc_score(Rest, N + 7,
				       X bsl N + Acc, F@_1, F@_2, F@_3,
				       TrUserData);
d_field_m_warrior_update_toc_score(<<0:1, X:7,
				     Rest/binary>>,
...
d_field_m_warrior_update_toc_kill(<<1:1, X:7,
				    Rest/binary>>,
				  N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    d_field_m_warrior_update_toc_kill(Rest, N + 7,
				      X bsl N + Acc, F@_1, F@_2, F@_3,
				      TrUserData);
d_field_m_warrior_update_toc_kill(<<0:1, X:7,
				    Rest/binary>>,
...
skip_varint_m_warrior_update_toc(<<1:1, _:7,
				   Rest/binary>>,
				 Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
    skip_varint_m_warrior_update_toc(Rest, Z1, Z2, F@_1,
				     F@_2, F@_3, TrUserData);
skip_varint_m_warrior_update_toc(<<0:1, _:7,
				   Rest/binary>>,
				 Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
    dfp_read_field_def_m_warrior_update_toc(Rest, Z1, Z2,
					    F@_1, F@_2, F@_3, TrUserData).

skip_length_delimited_m_warrior_update_toc(<<1:1, X:7,
					     Rest/binary>>,
					   N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_warrior_update_toc(Rest, N + 7,
					       X bsl N + Acc, F@_1, F@_2, F@_3,
					       TrUserData);
skip_length_delimited_m_warrior_update_toc(<<0:1, X:7,
					     Rest/binary>>,
					   N, Acc, F@_1, F@_2, F@_3,
					   TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_warrior_update_toc(Rest2, 0, 0,
					    F@_1, F@_2, F@_3, TrUserData).

skip_group_m_warrior_update_toc(Bin, FNum, Z2, F@_1,
				F@_2, F@_3, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_warrior_update_toc(Rest, 0, Z2,
					    F@_1, F@_2, F@_3, TrUserData).

skip_32_m_warrior_update_toc(<<_:32, Rest/binary>>, Z1,
			     Z2, F@_1, F@_2, F@_3, TrUserData) ->
    dfp_read_field_def_m_warrior_update_toc(Rest, Z1, Z2,
					    F@_1, F@_2, F@_3, TrUserData).

skip_64_m_warrior_update_toc(<<_:64, Rest/binary>>, Z1,
			     Z2, F@_1, F@_2, F@_3, TrUserData) ->
    dfp_read_field_def_m_warrior_update_toc(Rest, Z1, Z2,
					    F@_1, F@_2, F@_3, TrUserData).

decode_msg_m_warrior_end_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_warrior_end_toc(Bin, 0, 0,
					 id(undefined, TrUserData),
					 id(undefined, TrUserData),
					 id(undefined, TrUserData),
					 id(undefined, TrUserData), TrUserData).

dfp_read_field_def_m_warrior_end_toc(<<8, Rest/binary>>,
				     Z1, Z2, F@_1, F@_2, F@_3, F@_4,
				     TrUserData) ->
    d_field_m_warrior_end_toc_rank(Rest, Z1, Z2, F@_1, F@_2,
				   F@_3, F@_4, TrUserData);
dfp_read_field_def_m_warrior_end_toc(<<16,
				       Rest/binary>>,
				     Z1, Z2, F@_1, F@_2, F@_3, F@_4,
				     TrUserData) ->
    d_field_m_warrior_end_toc_score(Rest, Z1, Z2, F@_1,
				    F@_2, F@_3, F@_4, TrUserData);
dfp_read_field_def_m_warrior_end_toc(<<24,
				       Rest/binary>>,
				     Z1, Z2, F@_1, F@_2, F@_3, F@_4,
				     TrUserData) ->
    d_field_m_warrior_end_toc_floor(Rest, Z1, Z2, F@_1,
				    F@_2, F@_3, F@_4, TrUserData);
dfp_read_field_def_m_warrior_end_toc(<<32,
				       Rest/binary>>,
				     Z1, Z2, F@_1, F@_2, F@_3, F@_4,
				     TrUserData) ->
    d_field_m_warrior_end_toc_is_cross(Rest, Z1, Z2, F@_1,
				       F@_2, F@_3, F@_4, TrUserData);
dfp_read_field_def_m_warrior_end_toc(<<>>, 0, 0, F@_1,
				     F@_2, F@_3, F@_4, _) ->
    #m_warrior_end_toc{rank = F@_1, score = F@_2,
		       floor = F@_3, is_cross = F@_4};
dfp_read_field_def_m_warrior_end_toc(Other, Z1, Z2,
				     F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    dg_read_field_def_m_warrior_end_toc(Other, Z1, Z2, F@_1,
					F@_2, F@_3, F@_4, TrUserData).

dg_read_field_def_m_warrior_end_toc(<<1:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_warrior_end_toc(Rest, N + 7,
					X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
					TrUserData);
dg_read_field_def_m_warrior_end_toc(<<0:1, X:7,
				      Rest/binary>>,
    ...
    case Key of
      8 ->
	  d_field_m_warrior_end_toc_rank(Rest, 0, 0, F@_1, F@_2,
					 F@_3, F@_4, TrUserData);
      16 ->
	  d_field_m_warrior_end_toc_score(Rest, 0, 0, F@_1, F@_2,
					  F@_3, F@_4, TrUserData);
      24 ->
	  d_field_m_warrior_end_toc_floor(Rest, 0, 0, F@_1, F@_2,
					  F@_3, F@_4, TrUserData);
      32 ->
	  d_field_m_warrior_end_toc_is_cross(Rest, 0, 0, F@_1,
					     F@_2, F@_3, F@_4, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_warrior_end_toc(Rest, 0, 0, F@_1, F@_2,
					      F@_3, F@_4, TrUserData);
	    1 ->
		skip_64_m_warrior_end_toc(Rest, 0, 0, F@_1, F@_2, F@_3,
					  F@_4, TrUserData);
	    2 ->
		skip_length_delimited_m_warrior_end_toc(Rest, 0, 0,
							F@_1, F@_2, F@_3, F@_4,
							TrUserData);
	    3 ->
		skip_group_m_warrior_end_toc(Rest, Key bsr 3, 0, F@_1,
					     F@_2, F@_3, F@_4, TrUserData);
	    5 ->
		skip_32_m_warrior_end_toc(Rest, 0, 0, F@_1, F@_2, F@_3,
					  F@_4, TrUserData)
	  end
    end;
dg_read_field_def_m_warrior_end_toc(<<>>, 0, 0, F@_1,
				    F@_2, F@_3, F@_4, _) ->
    #m_warrior_end_toc{rank = F@_1, score = F@_2,
		       floor = F@_3, is_cross = F@_4}.

d_field_m_warrior_end_toc_rank(<<1:1, X:7,
				 Rest/binary>>,
			       N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData)
    when N < 57 ->
    d_field_m_warrior_end_toc_rank(Rest, N + 7,
				   X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
				   TrUserData);
d_field_m_warrior_end_toc_rank(<<0:1, X:7,
				 Rest/binary>>,
    ...
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    dfp_read_field_def_m_warrior_end_toc(RestF, 0, 0,
					 NewFValue, F@_2, F@_3, F@_4,
					 TrUserData).

d_field_m_warrior_end_toc_score(<<1:1, X:7,
				  Rest/binary>>,
				N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData)
    when N < 57 ->
    d_field_m_warrior_end_toc_score(Rest, N + 7,
				    X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
				    TrUserData);
d_field_m_warrior_end_toc_score(<<0:1, X:7,
				  Rest/binary>>,
    ...
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    dfp_read_field_def_m_warrior_end_toc(RestF, 0, 0, F@_1,
					 NewFValue, F@_3, F@_4, TrUserData).

d_field_m_warrior_end_toc_floor(<<1:1, X:7,
				  Rest/binary>>,
				N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData)
    when N < 57 ->
    d_field_m_warrior_end_toc_floor(Rest, N + 7,
				    X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
				    TrUserData);
d_field_m_warrior_end_toc_floor(<<0:1, X:7,
				  Rest/binary>>,
...
d_field_m_warrior_end_toc_is_cross(<<1:1, X:7,
				     Rest/binary>>,
				   N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData)
    when N < 57 ->
    d_field_m_warrior_end_toc_is_cross(Rest, N + 7,
				       X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
				       TrUserData);
d_field_m_warrior_end_toc_is_cross(<<0:1, X:7,
				     Rest/binary>>,
...
skip_varint_m_warrior_end_toc(<<1:1, _:7, Rest/binary>>,
			      Z1, Z2, F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    skip_varint_m_warrior_end_toc(Rest, Z1, Z2, F@_1, F@_2,
				  F@_3, F@_4, TrUserData);
skip_varint_m_warrior_end_toc(<<0:1, _:7, Rest/binary>>,
			      Z1, Z2, F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    dfp_read_field_def_m_warrior_end_toc(Rest, Z1, Z2, F@_1,
					 F@_2, F@_3, F@_4, TrUserData).

skip_length_delimited_m_warrior_end_toc(<<1:1, X:7,
					  Rest/binary>>,
					N, Acc, F@_1, F@_2, F@_3, F@_4,
					TrUserData)
    when N < 57 ->
    skip_length_delimited_m_warrior_end_toc(Rest, N + 7,
					    X bsl N + Acc, F@_1, F@_2, F@_3,
					    F@_4, TrUserData);
skip_length_delimited_m_warrior_end_toc(<<0:1, X:7,
					  Rest/binary>>,
					N, Acc, F@_1, F@_2, F@_3, F@_4,
					TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_warrior_end_toc(Rest2, 0, 0, F@_1,
					 F@_2, F@_3, F@_4, TrUserData).

skip_group_m_warrior_end_toc(Bin, FNum, Z2, F@_1, F@_2,
			     F@_3, F@_4, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_warrior_end_toc(Rest, 0, Z2, F@_1,
					 F@_2, F@_3, F@_4, TrUserData).

skip_32_m_warrior_end_toc(<<_:32, Rest/binary>>, Z1, Z2,
			  F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    dfp_read_field_def_m_warrior_end_toc(Rest, Z1, Z2, F@_1,
					 F@_2, F@_3, F@_4, TrUserData).

skip_64_m_warrior_end_toc(<<_:64, Rest/binary>>, Z1, Z2,
			  F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    dfp_read_field_def_m_warrior_end_toc(Rest, Z1, Z2, F@_1,
					 F@_2, F@_3, F@_4, TrUserData).

decode_msg_m_warrior_rank_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_warrior_rank_tos(Bin, 0, 0,
					  id(undefined, TrUserData),
					  TrUserData).

dfp_read_field_def_m_warrior_rank_tos(<<8,
					Rest/binary>>,
				      Z1, Z2, F@_1, TrUserData) ->
    d_field_m_warrior_rank_tos_num(Rest, Z1, Z2, F@_1,
				   TrUserData);
dfp_read_field_def_m_warrior_rank_tos(<<>>, 0, 0, F@_1,
				      _) ->
    #m_warrior_rank_tos{num = F@_1};
dfp_read_field_def_m_warrior_rank_tos(Other, Z1, Z2,
				      F@_1, TrUserData) ->
    dg_read_field_def_m_warrior_rank_tos(Other, Z1, Z2,
					 F@_1, TrUserData).

dg_read_field_def_m_warrior_rank_tos(<<1:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_warrior_rank_tos(Rest, N + 7,
					 X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_m_warrior_rank_tos(<<0:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_warrior_rank_tos_num(Rest, 0, 0, F@_1,
					 TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_warrior_rank_tos(Rest, 0, 0, F@_1,
					       TrUserData);
	    1 ->
		skip_64_m_warrior_rank_tos(Rest, 0, 0, F@_1,
					   TrUserData);
	    2 ->
		skip_length_delimited_m_warrior_rank_tos(Rest, 0, 0,
							 F@_1, TrUserData);
	    3 ->
		skip_group_m_warrior_rank_tos(Rest, Key bsr 3, 0, F@_1,
					      TrUserData);
	    5 ->
		skip_32_m_warrior_rank_tos(Rest, 0, 0, F@_1, TrUserData)
	  end
    end;
dg_read_field_def_m_warrior_rank_tos(<<>>, 0, 0, F@_1,
				     _) ->
    #m_warrior_rank_tos{num = F@_1}.

d_field_m_warrior_rank_tos_num(<<1:1, X:7,
				 Rest/binary>>,
			       N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_m_warrior_rank_tos_num(Rest, N + 7,
				   X bsl N + Acc, F@_1, TrUserData);
d_field_m_warrior_rank_tos_num(<<0:1, X:7,
				 Rest/binary>>,
			       N, Acc, _, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    dfp_read_field_def_m_warrior_rank_tos(RestF, 0, 0,
					  NewFValue, TrUserData).

skip_varint_m_warrior_rank_tos(<<1:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, F@_1, TrUserData) ->
    skip_varint_m_warrior_rank_tos(Rest, Z1, Z2, F@_1,
				   TrUserData);
skip_varint_m_warrior_rank_tos(<<0:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_warrior_rank_tos(Rest, Z1, Z2,
					  F@_1, TrUserData).

skip_length_delimited_m_warrior_rank_tos(<<1:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_warrior_rank_tos(Rest, N + 7,
					     X bsl N + Acc, F@_1, TrUserData);
skip_length_delimited_m_warrior_rank_tos(<<0:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_warrior_rank_tos(Rest2, 0, 0, F@_1,
					  TrUserData).

skip_group_m_warrior_rank_tos(Bin, FNum, Z2, F@_1,
			      TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_warrior_rank_tos(Rest, 0, Z2, F@_1,
					  TrUserData).

skip_32_m_warrior_rank_tos(<<_:32, Rest/binary>>, Z1,
			   Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_warrior_rank_tos(Rest, Z1, Z2,
					  F@_1, TrUserData).

skip_64_m_warrior_rank_tos(<<_:64, Rest/binary>>, Z1,
			   Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_warrior_rank_tos(Rest, Z1, Z2,
					  F@_1, TrUserData).

decode_msg_m_warrior_rank_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_warrior_rank_toc(Bin, 0, 0,
					  id([], TrUserData),
					  id(undefined, TrUserData),
					  TrUserData).

dfp_read_field_def_m_warrior_rank_toc(<<10,
					Rest/binary>>,
				      Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_warrior_rank_toc_list(Rest, Z1, Z2, F@_1,
				    F@_2, TrUserData);
dfp_read_field_def_m_warrior_rank_toc(<<18,
					Rest/binary>>,
				      Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_warrior_rank_toc_mine(Rest, Z1, Z2, F@_1,
				    F@_2, TrUserData);
dfp_read_field_def_m_warrior_rank_toc(<<>>, 0, 0, R1,
				      F@_2, TrUserData) ->
    #m_warrior_rank_toc{list =
			    lists_reverse(R1, TrUserData),
			mine = F@_2};
dfp_read_field_def_m_warrior_rank_toc(Other, Z1, Z2,
				      F@_1, F@_2, TrUserData) ->
    dg_read_field_def_m_warrior_rank_toc(Other, Z1, Z2,
					 F@_1, F@_2, TrUserData).

dg_read_field_def_m_warrior_rank_toc(<<1:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, F@_2, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_warrior_rank_toc(Rest, N + 7,
					 X bsl N + Acc, F@_1, F@_2, TrUserData);
dg_read_field_def_m_warrior_rank_toc(<<0:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, F@_2, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      10 ->
	  d_field_m_warrior_rank_toc_list(Rest, 0, 0, F@_1, F@_2,
					  TrUserData);
      18 ->
	  d_field_m_warrior_rank_toc_mine(Rest, 0, 0, F@_1, F@_2,
					  TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_warrior_rank_toc(Rest, 0, 0, F@_1, F@_2,
					       TrUserData);
	    1 ->
		skip_64_m_warrior_rank_toc(Rest, 0, 0, F@_1, F@_2,
					   TrUserData);
	    2 ->
		skip_length_delimited_m_warrior_rank_toc(Rest, 0, 0,
							 F@_1, F@_2,
							 TrUserData);
	    3 ->
		skip_group_m_warrior_rank_toc(Rest, Key bsr 3, 0, F@_1,
					      F@_2, TrUserData);
	    5 ->
		skip_32_m_warrior_rank_toc(Rest, 0, 0, F@_1, F@_2,
					   TrUserData)
	  end
    end;
dg_read_field_def_m_warrior_rank_toc(<<>>, 0, 0, R1,
				     F@_2, TrUserData) ->
    #m_warrior_rank_toc{list =
			    lists_reverse(R1, TrUserData),
			mine = F@_2}.

d_field_m_warrior_rank_toc_list(<<1:1, X:7,
				  Rest/binary>>,
				N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_warrior_rank_toc_list(Rest, N + 7,
				    X bsl N + Acc, F@_1, F@_2, TrUserData);
d_field_m_warrior_rank_toc_list(<<0:1, X:7,
				  Rest/binary>>,
				N, Acc, Prev, F@_2, TrUserData) ->
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
			   <<Bs:Len/binary, Rest2/binary>> = Rest,
			   {id(decode_msg_p_ranking(Bs, TrUserData),
			       TrUserData),
			    Rest2}
			 end,
    dfp_read_field_def_m_warrior_rank_toc(RestF, 0, 0,
					  cons(NewFValue, Prev, TrUserData),
					  F@_2, TrUserData).

d_field_m_warrior_rank_toc_mine(<<1:1, X:7,
				  Rest/binary>>,
				N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_warrior_rank_toc_mine(Rest, N + 7,
				    X bsl N + Acc, F@_1, F@_2, TrUserData);
d_field_m_warrior_rank_toc_mine(<<0:1, X:7,
				  Rest/binary>>,
    ...
    dfp_read_field_def_m_warrior_rank_toc(RestF, 0, 0, F@_1,
					  if Prev == undefined -> NewFValue;
					     true ->
						 merge_msg_p_ranking(Prev,
								     NewFValue,
								     TrUserData)
					  end,
					  TrUserData).

skip_varint_m_warrior_rank_toc(<<1:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, F@_1, F@_2, TrUserData) ->
    skip_varint_m_warrior_rank_toc(Rest, Z1, Z2, F@_1, F@_2,
				   TrUserData);
skip_varint_m_warrior_rank_toc(<<0:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_warrior_rank_toc(Rest, Z1, Z2,
					  F@_1, F@_2, TrUserData).

skip_length_delimited_m_warrior_rank_toc(<<1:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_warrior_rank_toc(Rest, N + 7,
					     X bsl N + Acc, F@_1, F@_2,
					     TrUserData);
skip_length_delimited_m_warrior_rank_toc(<<0:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, F@_2, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_warrior_rank_toc(Rest2, 0, 0, F@_1,
					  F@_2, TrUserData).

skip_group_m_warrior_rank_toc(Bin, FNum, Z2, F@_1, F@_2,
			      TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_warrior_rank_toc(Rest, 0, Z2, F@_1,
					  F@_2, TrUserData).

skip_32_m_warrior_rank_toc(<<_:32, Rest/binary>>, Z1,
			   Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_warrior_rank_toc(Rest, Z1, Z2,
					  F@_1, F@_2, TrUserData).

skip_64_m_warrior_rank_toc(<<_:64, Rest/binary>>, Z1,
			   Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_warrior_rank_toc(Rest, Z1, Z2,
					  F@_1, F@_2, TrUserData).

decode_msg_m_warrior_creep_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_warrior_creep_toc(Bin, 0, 0,
					   id(undefined, TrUserData),
					   TrUserData).

dfp_read_field_def_m_warrior_creep_toc(<<8,
					 Rest/binary>>,
				       Z1, Z2, F@_1, TrUserData) ->
    d_field_m_warrior_creep_toc_state(Rest, Z1, Z2, F@_1,
				      TrUserData);
dfp_read_field_def_m_warrior_creep_toc(<<>>, 0, 0, F@_1,
				       _) ->
    #m_warrior_creep_toc{state = F@_1};
dfp_read_field_def_m_warrior_creep_toc(Other, Z1, Z2,
				       F@_1, TrUserData) ->
    dg_read_field_def_m_warrior_creep_toc(Other, Z1, Z2,
					  F@_1, TrUserData).

dg_read_field_def_m_warrior_creep_toc(<<1:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_warrior_creep_toc(Rest, N + 7,
					  X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_m_warrior_creep_toc(<<0:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_warrior_creep_toc_state(Rest, 0, 0, F@_1,
					    TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_warrior_creep_toc(Rest, 0, 0, F@_1,
						TrUserData);
	    1 ->
		skip_64_m_warrior_creep_toc(Rest, 0, 0, F@_1,
					    TrUserData);
	    2 ->
		skip_length_delimited_m_warrior_creep_toc(Rest, 0, 0,
							  F@_1, TrUserData);
	    3 ->
		skip_group_m_warrior_creep_toc(Rest, Key bsr 3, 0, F@_1,
					       TrUserData);
	    5 ->
		skip_32_m_warrior_creep_toc(Rest, 0, 0, F@_1,
					    TrUserData)
	  end
    end;
dg_read_field_def_m_warrior_creep_toc(<<>>, 0, 0, F@_1,
				      _) ->
    #m_warrior_creep_toc{state = F@_1}.

d_field_m_warrior_creep_toc_state(<<1:1, X:7,
				    Rest/binary>>,
				  N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_m_warrior_creep_toc_state(Rest, N + 7,
				      X bsl N + Acc, F@_1, TrUserData);
d_field_m_warrior_creep_toc_state(<<0:1, X:7,
				    Rest/binary>>,
				  N, Acc, _, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    dfp_read_field_def_m_warrior_creep_toc(RestF, 0, 0,
					   NewFValue, TrUserData).

skip_varint_m_warrior_creep_toc(<<1:1, _:7,
				  Rest/binary>>,
				Z1, Z2, F@_1, TrUserData) ->
    skip_varint_m_warrior_creep_toc(Rest, Z1, Z2, F@_1,
				    TrUserData);
skip_varint_m_warrior_creep_toc(<<0:1, _:7,
				  Rest/binary>>,
				Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_warrior_creep_toc(Rest, Z1, Z2,
					   F@_1, TrUserData).

skip_length_delimited_m_warrior_creep_toc(<<1:1, X:7,
					    Rest/binary>>,
					  N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_warrior_creep_toc(Rest, N + 7,
					      X bsl N + Acc, F@_1, TrUserData);
skip_length_delimited_m_warrior_creep_toc(<<0:1, X:7,
					    Rest/binary>>,
					  N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_warrior_creep_toc(Rest2, 0, 0,
					   F@_1, TrUserData).

skip_group_m_warrior_creep_toc(Bin, FNum, Z2, F@_1,
			       TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_warrior_creep_toc(Rest, 0, Z2,
					   F@_1, TrUserData).

skip_32_m_warrior_creep_toc(<<_:32, Rest/binary>>, Z1,
			    Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_warrior_creep_toc(Rest, Z1, Z2,
					   F@_1, TrUserData).

skip_64_m_warrior_creep_toc(<<_:64, Rest/binary>>, Z1,
			    Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_warrior_creep_toc(Rest, Z1, Z2,
					   F@_1, TrUserData).
...
merge_msgs(Prev, New, MsgName, Opts) ->
    ...
    case MsgName of
      m_warrior_info_tos ->
	  merge_msg_m_warrior_info_tos(Prev, New, TrUserData);
      m_warrior_info_toc ->
	  merge_msg_m_warrior_info_toc(Prev, New, TrUserData);
      m_warrior_update_toc ->
	  merge_msg_m_warrior_update_toc(Prev, New, TrUserData);
      m_warrior_end_toc ->
	  merge_msg_m_warrior_end_toc(Prev, New, TrUserData);
      m_warrior_rank_tos ->
	  merge_msg_m_warrior_rank_tos(Prev, New, TrUserData);
      m_warrior_rank_toc ->
	  merge_msg_m_warrior_rank_toc(Prev, New, TrUserData);
      m_warrior_creep_toc ->
	  merge_msg_m_warrior_creep_toc(Prev, New, TrUserData);
      p_role_base ->
...
-compile({nowarn_unused_function,merge_msg_m_warrior_info_tos/3}).
merge_msg_m_warrior_info_tos(_Prev, New, _TrUserData) ->
    New.

-compile({nowarn_unused_function,merge_msg_m_warrior_info_toc/3}).
merge_msg_m_warrior_info_toc(#m_warrior_info_toc{},
			     #m_warrior_info_toc{end_time = NFend_time}, _) ->
    #m_warrior_info_toc{end_time = NFend_time}.

-compile({nowarn_unused_function,merge_msg_m_warrior_update_toc/3}).
merge_msg_m_warrior_update_toc(#m_warrior_update_toc{},
			       #m_warrior_update_toc{floor = NFfloor,
						     score = NFscore,
						     kill = NFkill},
			       _) ->
    #m_warrior_update_toc{floor = NFfloor, score = NFscore,
			  kill = NFkill}.

-compile({nowarn_unused_function,merge_msg_m_warrior_end_toc/3}).
merge_msg_m_warrior_end_toc(#m_warrior_end_toc{},
			    #m_warrior_end_toc{rank = NFrank, score = NFscore,
					       floor = NFfloor,
					       is_cross = NFis_cross},
			    _) ->
    #m_warrior_end_toc{rank = NFrank, score = NFscore,
		       floor = NFfloor, is_cross = NFis_cross}.

-compile({nowarn_unused_function,merge_msg_m_warrior_rank_tos/3}).
merge_msg_m_warrior_rank_tos(#m_warrior_rank_tos{},
			     #m_warrior_rank_tos{num = NFnum}, _) ->
    #m_warrior_rank_tos{num = NFnum}.

-compile({nowarn_unused_function,merge_msg_m_warrior_rank_toc/3}).
merge_msg_m_warrior_rank_toc(#m_warrior_rank_toc{list =
						     PFlist,
						 mine = PFmine},
			     #m_warrior_rank_toc{list = NFlist, mine = NFmine},
			     TrUserData) ->
    #m_warrior_rank_toc{list =
			...
			mine = merge_msg_p_ranking(PFmine, NFmine, TrUserData)}.

-compile({nowarn_unused_function,merge_msg_m_warrior_creep_toc/3}).
merge_msg_m_warrior_creep_toc(#m_warrior_creep_toc{},
			      #m_warrior_creep_toc{state = NFstate}, _) ->
    #m_warrior_creep_toc{state = NFstate}.
...
verify_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
      m_warrior_info_tos ->
	  v_msg_m_warrior_info_tos(Msg, [MsgName], TrUserData);
      m_warrior_info_toc ->
	  v_msg_m_warrior_info_toc(Msg, [MsgName], TrUserData);
      m_warrior_update_toc ->
	  v_msg_m_warrior_update_toc(Msg, [MsgName], TrUserData);
      m_warrior_end_toc ->
	  v_msg_m_warrior_end_toc(Msg, [MsgName], TrUserData);
      m_warrior_rank_tos ->
	  v_msg_m_warrior_rank_tos(Msg, [MsgName], TrUserData);
      m_warrior_rank_toc ->
	  v_msg_m_warrior_rank_toc(Msg, [MsgName], TrUserData);
      m_warrior_creep_toc ->
	  v_msg_m_warrior_creep_toc(Msg, [MsgName], TrUserData);
      p_role_base ->
...
-compile({nowarn_unused_function,v_msg_m_warrior_info_tos/3}).
-dialyzer({nowarn_function,v_msg_m_warrior_info_tos/3}).
v_msg_m_warrior_info_tos(#m_warrior_info_tos{}, _Path,
			 _) ->
    ok;
v_msg_m_warrior_info_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_warrior_info_tos}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_warrior_info_toc/3}).
-dialyzer({nowarn_function,v_msg_m_warrior_info_toc/3}).
v_msg_m_warrior_info_toc(#m_warrior_info_toc{end_time =
						 F1},
			 Path, TrUserData) ->
    v_type_int32(F1, [end_time | Path], TrUserData), ok;
v_msg_m_warrior_info_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_warrior_info_toc}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_warrior_update_toc/3}).
-dialyzer({nowarn_function,v_msg_m_warrior_update_toc/3}).
v_msg_m_warrior_update_toc(#m_warrior_update_toc{floor =
						     F1,
						 score = F2, kill = F3},
			   Path, TrUserData) ->
    v_type_int32(F1, [floor | Path], TrUserData),
    v_type_int32(F2, [score | Path], TrUserData),
    v_type_int32(F3, [kill | Path], TrUserData),
    ok;
v_msg_m_warrior_update_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_warrior_update_toc}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_warrior_end_toc/3}).
-dialyzer({nowarn_function,v_msg_m_warrior_end_toc/3}).
v_msg_m_warrior_end_toc(#m_warrior_end_toc{rank = F1,
					   score = F2, floor = F3,
					   is_cross = F4},
			Path, TrUserData) ->
    ...
    v_type_int32(F4, [is_cross | Path], TrUserData),
    ok;
v_msg_m_warrior_end_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_warrior_end_toc}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_warrior_rank_tos/3}).
-dialyzer({nowarn_function,v_msg_m_warrior_rank_tos/3}).
v_msg_m_warrior_rank_tos(#m_warrior_rank_tos{num = F1},
			 Path, TrUserData) ->
    v_type_int32(F1, [num | Path], TrUserData), ok;
v_msg_m_warrior_rank_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_warrior_rank_tos}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_warrior_rank_toc/3}).
-dialyzer({nowarn_function,v_msg_m_warrior_rank_toc/3}).
v_msg_m_warrior_rank_toc(#m_warrior_rank_toc{list = F1,
					     mine = F2},
			 Path, TrUserData) ->
    if is_list(F1) ->
	   _ = [v_msg_p_ranking(Elem, [list | Path], TrUserData)
		|| Elem <- F1],
	   ok;
       true ->
	   mk_type_error({invalid_list_of, {msg, p_ranking}}, F1,
			 [list | Path])
    end,
    v_msg_p_ranking(F2, [mine | Path], TrUserData),
    ok;
v_msg_m_warrior_rank_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_warrior_rank_toc}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_warrior_creep_toc/3}).
-dialyzer({nowarn_function,v_msg_m_warrior_creep_toc/3}).
v_msg_m_warrior_creep_toc(#m_warrior_creep_toc{state =
						   F1},
			  Path, TrUserData) ->
    v_type_int32(F1, [state | Path], TrUserData), ok;
v_msg_m_warrior_creep_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_warrior_creep_toc}, X,
		  Path).
...
get_msg_defs() ->
    [{{msg, m_warrior_info_tos}, []},
     {{msg, m_warrior_info_toc},
      [#field{name = end_time, fnum = 1, rnum = 2,
	      type = int32, occurrence = required, opts = []}]},
     {{msg, m_warrior_update_toc},
      [#field{name = floor, fnum = 1, rnum = 2, type = int32,
	      occurrence = required, opts = []},
       #field{name = score, fnum = 2, rnum = 3, type = int32,
	      occurrence = required, opts = []},
       #field{name = kill, fnum = 3, rnum = 4, type = int32,
	      occurrence = required, opts = []}]},
     {{msg, m_warrior_end_toc},
      [#field{name = rank, fnum = 1, rnum = 2, type = int32,
       ...
       #field{name = floor, fnum = 3, rnum = 4, type = int32,
	      occurrence = required, opts = []},
       #field{name = is_cross, fnum = 4, rnum = 5,
	      type = int32, occurrence = required, opts = []}]},
     {{msg, m_warrior_rank_tos},
      [#field{name = num, fnum = 1, rnum = 2, type = int32,
	      occurrence = required, opts = []}]},
     {{msg, m_warrior_rank_toc},
      [#field{name = list, fnum = 1, rnum = 2,
	      type = {msg, p_ranking}, occurrence = repeated,
	      opts = []},
       #field{name = mine, fnum = 2, rnum = 3,
	      type = {msg, p_ranking}, occurrence = required,
	      opts = []}]},
     {{msg, m_warrior_creep_toc},
      [#field{name = state, fnum = 1, rnum = 2, type = int32,
	      occurrence = required, opts = []}]},
     {{msg, p_role_base},
...
get_msg_names() ->
    [m_warrior_info_tos, m_warrior_info_toc,
     m_warrior_update_toc, m_warrior_end_toc,
     m_warrior_rank_tos, m_warrior_rank_toc,
     m_warrior_creep_toc, p_role_base, p_aspect, p_attr,
...
find_msg_def(m_warrior_info_tos) -> [];
find_msg_def(m_warrior_info_toc) ->
    [#field{name = end_time, fnum = 1, rnum = 2,
	    type = int32, occurrence = required, opts = []}];
find_msg_def(m_warrior_update_toc) ->
    [#field{name = floor, fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []},
     #field{name = score, fnum = 2, rnum = 3, type = int32,
	    occurrence = required, opts = []},
     #field{name = kill, fnum = 3, rnum = 4, type = int32,
	    occurrence = required, opts = []}];
find_msg_def(m_warrior_end_toc) ->
    [#field{name = rank, fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []},
     #field{name = score, fnum = 2, rnum = 3, type = int32,
	    occurrence = required, opts = []},
     ...
     #field{name = is_cross, fnum = 4, rnum = 5,
	    type = int32, occurrence = required, opts = []}];
find_msg_def(m_warrior_rank_tos) ->
    [#field{name = num, fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []}];
find_msg_def(m_warrior_rank_toc) ->
    [#field{name = list, fnum = 1, rnum = 2,
	    type = {msg, p_ranking}, occurrence = repeated,
	    opts = []},
     #field{name = mine, fnum = 2, rnum = 3,
	    type = {msg, p_ranking}, occurrence = required,
	    opts = []}];
find_msg_def(m_warrior_creep_toc) ->
    [#field{name = state, fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []}];
