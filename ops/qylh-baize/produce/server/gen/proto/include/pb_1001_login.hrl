...
-ifndef(pb_1001_login).
-define(pb_1001_login, true).

-define(pb_1001_login_gpb_version, "4.5.1").

-ifndef('M_LOGIN_VERIFY_TOS_PB_H').
-define('M_LOGIN_VERIFY_TOS_PB_H', true).
-record(m_login_verify_tos,
        {platform               :: iolist(),        % = 1
         gamechan               :: iolist(),        % = 2
         account                :: iolist(),        % = 3
         token                  :: iolist(),        % = 4
         args = #{}             :: #{iolist() := iolist()} | undefined % = 5
        }).
-endif.

-ifndef('M_LOGIN_VERIFY_TOC_PB_H').
-define('M_LOGIN_VERIFY_TOC_PB_H', true).
-record(m_login_verify_toc,
        {career                 :: integer(),       % = 1, 32 bits
         roles = []             :: [pb_1001_login:p_role_base()] | undefined % = 2
        }).
-endif.

-ifndef('M_LOGIN_CREATE_TOS_PB_H').
-define('M_LOGIN_CREATE_TOS_PB_H', true).
-record(m_login_create_tos,
        {career                 :: integer(),       % = 1, 32 bits
...
-ifndef('M_LOGIN_CREATE_TOC_PB_H').
-define('M_LOGIN_CREATE_TOC_PB_H', true).
-record(m_login_create_toc,
        {role_id                :: non_neg_integer() % = 1, 32 bits
        }).
-endif.

-ifndef('M_LOGIN_ENTER_TOS_PB_H').
-define('M_LOGIN_ENTER_TOS_PB_H', true).
-record(m_login_enter_tos,
        {role_id                :: non_neg_integer() % = 1, 32 bits
        }).
-endif.

-ifndef('M_LOGIN_ENTER_TOC_PB_H').
-define('M_LOGIN_ENTER_TOC_PB_H', true).
-record(m_login_enter_toc,
        {suids = []             :: [integer()] | undefined, % = 1, 32 bits
         open                   :: integer(),       % = 2, 32 bits
         merge                  :: integer(),       % = 3, 32 bits
         token                  :: iolist()         % = 4
        }).
-endif.

-ifndef('M_LOGIN_NAME_TOS_PB_H').
-define('M_LOGIN_NAME_TOS_PB_H', true).
-record(m_login_name_tos,
        {gender                 :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_LOGIN_NAME_TOC_PB_H').
-define('M_LOGIN_NAME_TOC_PB_H', true).
-record(m_login_name_toc,
        {name                   :: iolist()         % = 1
        }).
-endif.

-ifndef('M_LOGIN_RECONN_TOS_PB_H').
-define('M_LOGIN_RECONN_TOS_PB_H', true).
-record(m_login_reconn_tos,
        {role_id                :: non_neg_integer(), % = 1, 32 bits
         token                  :: iolist()         % = 2
        }).
-endif.

-ifndef('M_LOGIN_RECONN_TOC_PB_H').
-define('M_LOGIN_RECONN_TOC_PB_H', true).
-record(m_login_reconn_toc,
        {
        }).
-endif.

-ifndef('M_LOGIN_LEAVE_TOS_PB_H').
-define('M_LOGIN_LEAVE_TOS_PB_H', true).
-record(m_login_leave_tos,
        {
        }).
-endif.

-ifndef('M_LOGIN_LEAVE_TOC_PB_H').
-define('M_LOGIN_LEAVE_TOC_PB_H', true).
-record(m_login_leave_toc,
        {
        }).
-endif.
...
-record(p_role_base,
        {id                     :: non_neg_integer(), % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1001_login:p_aspect()} | undefined, % = 8
         ...
         icon                   :: pb_1001_login:p_icon() | undefined, % = 17
...
-record(p_item,
        {uid                    :: integer(),       % = 1, 32 bits
         ...
         gender                 :: integer(),       % = 7, 32 bits
         score                  :: integer() | undefined, % = 8, 32 bits
         equip                  :: pb_1001_login:p_equip() | undefined, % = 9
         pet                    :: pb_1001_login:p_pet() | undefined, % = 10
...
-record(p_equip,
        {base                   :: pb_1001_login:p_attr(), % = 1
         rare1                  :: pb_1001_login:p_attr() | undefined, % = 2
         rare2                  :: pb_1001_login:p_attr() | undefined, % = 3
         rare3                  :: pb_1001_login:p_attr() | undefined, % = 4
         marriage               :: pb_1001_login:p_marriage() | undefined, % = 5
         ...
         refine = []            :: [pb_1001_login:p_refine()] | undefined, % = 11
         suite = #{}            :: #{integer() := integer()} | undefined, % = 12
         combine = []           :: [pb_1001_login:p_item()] | undefined % = 13
        }).
-endif.
...
-record(p_marriage,
        {husband_id             :: non_neg_integer() | undefined, % = 1, 32 bits
         ...
         rare                   :: pb_1001_login:p_attr() | undefined % = 5
        }).
-endif.
...
-record(p_actor,
        {uid                    :: non_neg_integer(), % = 1, 32 bits
         ...
         coord                  :: pb_1001_login:p_coord(), % = 4
         state                  :: integer(),       % = 5, 32 bits
         stargs = #{}           :: #{integer() := iolist()} | undefined, % = 6
         role                   :: pb_1001_login:p_role() | undefined, % = 7
         creep                  :: pb_1001_login:p_creep() | undefined, % = 8
         drop                   :: pb_1001_login:p_drop() | undefined % = 9
        }).
-endif.
...
-record(p_role,
        {career                 :: integer(),       % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1001_login:p_aspect()} | undefined, % = 5
         ...
         icon                   :: pb_1001_login:p_icon() | undefined % = 25
        }).
-endif.
...
-record(p_creep,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         buffs = []             :: [pb_1001_login:p_buff()] | undefined, % = 6
         dir                    :: integer(),       % = 7, 32 bits
         dest                   :: pb_1001_login:p_coord(), % = 8
...
-record(p_drop,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         coord                  :: pb_1001_login:p_coord() | undefined, % = 5
...
-record(p_ranking,
        {base                   :: pb_1001_login:p_role_base() | undefined, % = 1
