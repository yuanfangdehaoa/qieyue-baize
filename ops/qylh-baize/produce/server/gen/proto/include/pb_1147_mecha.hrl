...
-ifndef(pb_1147_mecha).
-define(pb_1147_mecha, true).

-define(pb_1147_mecha_gpb_version, "4.5.1").

-ifndef('M_MECHA_LIST_TOS_PB_H').
-define('M_MECHA_LIST_TOS_PB_H', true).
-record(m_mecha_list_tos,
        {
        }).
-endif.

-ifndef('M_MECHA_LIST_TOC_PB_H').
-define('M_MECHA_LIST_TOC_PB_H', true).
-record(m_mecha_list_toc,
        {mechas = []            :: [pb_1147_mecha:p_mecha()] | undefined, % = 1
         use_id                 :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_MECHA_UPSTAR_TOS_PB_H').
-define('M_MECHA_UPSTAR_TOS_PB_H', true).
-record(m_mecha_upstar_tos,
        {id                     :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_MECHA_UPSTAR_TOC_PB_H').
-define('M_MECHA_UPSTAR_TOC_PB_H', true).
-record(m_mecha_upstar_toc,
        {mecha                  :: pb_1147_mecha:p_mecha() % = 1
        }).
-endif.

-ifndef('M_MECHA_UPGRADE_TOS_PB_H').
-define('M_MECHA_UPGRADE_TOS_PB_H', true).
-record(m_mecha_upgrade_tos,
        {id                     :: integer(),       % = 1, 32 bits
         item_id                :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_MECHA_UPGRADE_TOC_PB_H').
-define('M_MECHA_UPGRADE_TOC_PB_H', true).
-record(m_mecha_upgrade_toc,
        {mecha                  :: pb_1147_mecha:p_mecha() % = 1
        }).
-endif.

-ifndef('M_MECHA_SELECT_TOS_PB_H').
-define('M_MECHA_SELECT_TOS_PB_H', true).
-record(m_mecha_select_tos,
        {id                     :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_MECHA_SELECT_TOC_PB_H').
-define('M_MECHA_SELECT_TOC_PB_H', true).
-record(m_mecha_select_toc,
        {id                     :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_MECHA_EQUIP_TOS_PB_H').
-define('M_MECHA_EQUIP_TOS_PB_H', true).
-record(m_mecha_equip_tos,
        {id                     :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_MECHA_EQUIP_TOC_PB_H').
-define('M_MECHA_EQUIP_TOC_PB_H', true).
-record(m_mecha_equip_toc,
        {equips = []            :: [pb_1147_mecha:p_item()] | undefined, % = 1
         slots = #{}            :: #{integer() := integer()} | undefined, % = 2
         id                     :: integer()        % = 3, 32 bits
        }).
-endif.

-ifndef('M_MECHA_EQUIP_PUTON_TOS_PB_H').
-define('M_MECHA_EQUIP_PUTON_TOS_PB_H', true).
-record(m_mecha_equip_puton_tos,
        {id                     :: integer(),       % = 1, 32 bits
         uid                    :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_MECHA_EQUIP_PUTON_TOC_PB_H').
-define('M_MECHA_EQUIP_PUTON_TOC_PB_H', true).
-record(m_mecha_equip_puton_toc,
        {slot                   :: integer(),       % = 1, 32 bits
         id                     :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_MECHA_EQUIP_UPLEVEL_TOS_PB_H').
-define('M_MECHA_EQUIP_UPLEVEL_TOS_PB_H', true).
-record(m_mecha_equip_uplevel_tos,
        {slot                   :: integer(),       % = 1, 32 bits
         id                     :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_MECHA_EQUIP_UPLEVEL_TOC_PB_H').
-define('M_MECHA_EQUIP_UPLEVEL_TOC_PB_H', true).
-record(m_mecha_equip_uplevel_toc,
        {slot                   :: integer(),       % = 1, 32 bits
         id                     :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_MECHA_EQUIP_DECOMPOSE_TOS_PB_H').
-define('M_MECHA_EQUIP_DECOMPOSE_TOS_PB_H', true).
-record(m_mecha_equip_decompose_tos,
        {uid = []               :: [integer()] | undefined % = 1, 32 bits
        }).
-endif.

-ifndef('M_MECHA_EQUIP_DECOMPOSE_TOC_PB_H').
-define('M_MECHA_EQUIP_DECOMPOSE_TOC_PB_H', true).
-record(m_mecha_equip_decompose_toc,
        {
        }).
-endif.

-ifndef('P_MECHA_PB_H').
-define('P_MECHA_PB_H', true).
-record(p_mecha,
        {id                     :: integer(),       % = 1, 32 bits
...
-record(p_role_base,
        {id                     :: non_neg_integer(), % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1147_mecha:p_aspect()} | undefined, % = 8
         ...
         icon                   :: pb_1147_mecha:p_icon() | undefined, % = 17
...
-record(p_item,
        {uid                    :: integer(),       % = 1, 32 bits
         ...
         gender                 :: integer(),       % = 7, 32 bits
         score                  :: integer() | undefined, % = 8, 32 bits
         equip                  :: pb_1147_mecha:p_equip() | undefined, % = 9
         pet                    :: pb_1147_mecha:p_pet() | undefined, % = 10
...
-record(p_equip,
        {base                   :: pb_1147_mecha:p_attr(), % = 1
         rare1                  :: pb_1147_mecha:p_attr() | undefined, % = 2
         rare2                  :: pb_1147_mecha:p_attr() | undefined, % = 3
         rare3                  :: pb_1147_mecha:p_attr() | undefined, % = 4
         marriage               :: pb_1147_mecha:p_marriage() | undefined, % = 5
         ...
         refine = []            :: [pb_1147_mecha:p_refine()] | undefined, % = 11
         suite = #{}            :: #{integer() := integer()} | undefined, % = 12
         combine = []           :: [pb_1147_mecha:p_item()] | undefined % = 13
        }).
-endif.
...
-record(p_marriage,
        {husband_id             :: non_neg_integer() | undefined, % = 1, 32 bits
         ...
         rare                   :: pb_1147_mecha:p_attr() | undefined % = 5
        }).
-endif.
...
-record(p_actor,
        {uid                    :: non_neg_integer(), % = 1, 32 bits
         ...
         coord                  :: pb_1147_mecha:p_coord(), % = 4
         state                  :: integer(),       % = 5, 32 bits
         stargs = #{}           :: #{integer() := iolist()} | undefined, % = 6
         role                   :: pb_1147_mecha:p_role() | undefined, % = 7
         creep                  :: pb_1147_mecha:p_creep() | undefined, % = 8
         drop                   :: pb_1147_mecha:p_drop() | undefined % = 9
        }).
-endif.
...
-record(p_role,
        {career                 :: integer(),       % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1147_mecha:p_aspect()} | undefined, % = 5
         ...
         icon                   :: pb_1147_mecha:p_icon() | undefined % = 25
        }).
-endif.
...
-record(p_creep,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         buffs = []             :: [pb_1147_mecha:p_buff()] | undefined, % = 6
         dir                    :: integer(),       % = 7, 32 bits
         dest                   :: pb_1147_mecha:p_coord(), % = 8
...
-record(p_drop,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         coord                  :: pb_1147_mecha:p_coord() | undefined, % = 5
...
-record(p_ranking,
        {base                   :: pb_1147_mecha:p_role_base() | undefined, % = 1
