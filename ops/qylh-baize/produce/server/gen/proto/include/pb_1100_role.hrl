...
-ifndef(pb_1100_role).
-define(pb_1100_role, true).

-define(pb_1100_role_gpb_version, "4.5.1").

-ifndef('M_ROLE_DETAIL_TOS_PB_H').
-define('M_ROLE_DETAIL_TOS_PB_H', true).
-record(m_role_detail_tos,
        {
        }).
-endif.

-ifndef('M_ROLE_DETAIL_TOC_PB_H').
-define('M_ROLE_DETAIL_TOC_PB_H', true).
-record(m_role_detail_toc,
        {role                   :: pb_1100_role:p_role_info() % = 1
        }).
-endif.

-ifndef('M_ROLE_QUERY_TOS_PB_H').
-define('M_ROLE_QUERY_TOS_PB_H', true).
-record(m_role_query_tos,
        {role_id                :: non_neg_integer() % = 1, 32 bits
        }).
-endif.

-ifndef('M_ROLE_QUERY_TOC_PB_H').
-define('M_ROLE_QUERY_TOC_PB_H', true).
-record(m_role_query_toc,
        {role                   :: pb_1100_role:p_role_base(), % = 1
         equips = []            :: [pb_1100_role:p_item()] | undefined % = 2
        }).
-endif.

-ifndef('M_ROLE_RENAME_TOS_PB_H').
-define('M_ROLE_RENAME_TOS_PB_H', true).
-record(m_role_rename_tos,
        {name                   :: iolist()         % = 1
        }).
-endif.

-ifndef('M_ROLE_RENAME_TOC_PB_H').
-define('M_ROLE_RENAME_TOC_PB_H', true).
-record(m_role_rename_toc,
        {name                   :: iolist()         % = 1
        }).
-endif.

-ifndef('M_ROLE_UPDATE_TOC_PB_H').
-define('M_ROLE_UPDATE_TOC_PB_H', true).
-record(m_role_update_toc,
        {upint = #{}            :: #{iolist() := integer()} | undefined, % = 1
         upstr = #{}            :: #{iolist() := iolist()} | undefined, % = 2
         aspect = #{}           :: #{iolist() := pb_1100_role:p_aspect()} | undefined, % = 3
         money = #{}            :: #{integer() := integer()} | undefined, % = 4
         way                    :: integer() | undefined % = 5, 32 bits
        }).
-endif.

-ifndef('M_ROLE_UPATTR_TOC_PB_H').
-define('M_ROLE_UPATTR_TOC_PB_H', true).
-record(m_role_upattr_toc,
        {attr                   :: pb_1100_role:p_attr(), % = 1
         power                  :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_ROLE_REDOT_TOC_PB_H').
-define('M_ROLE_REDOT_TOC_PB_H', true).
-record(m_role_redot_toc,
        {redots = #{}           :: #{integer() := integer()} | undefined % = 1
        }).
-endif.
...
-record(p_role_info,
        {id                     :: non_neg_integer(), % = 1, 32 bits
         ...
         exp                    :: integer(),       % = 6, 32 bits
         power                  :: integer(),       % = 7, 32 bits
         figure = #{}           :: #{iolist() := pb_1100_role:p_aspect()} | undefined, % = 8
         viptype                :: integer(),       % = 9, 32 bits
         viplv                  :: integer(),       % = 10, 32 bits
         vipexp                 :: integer(),       % = 11, 32 bits
         vipend                 :: integer(),       % = 12, 32 bits
         gold                   :: integer(),       % = 13, 32 bits
         bgold                  :: integer(),       % = 14, 32 bits
         coin                   :: integer(),       % = 15, 32 bits
         bcoin                  :: integer(),       % = 16, 32 bits
         pkmode                 :: integer(),       % = 17, 32 bits
         attr                   :: pb_1100_role:p_attr(), % = 18
         buffs = []             :: [pb_1100_role:p_buff()] | undefined, % = 19
         guild                  :: non_neg_integer(), % = 20, 32 bits
         gname                  :: iolist(),        % = 21
         scene                  :: integer(),       % = 22, 32 bits
         suid                   :: integer(),       % = 23, 32 bits
         wake                   :: integer(),       % = 24, 32 bits
         ctime                  :: integer(),       % = 25, 32 bits
         marry                  :: integer(),       % = 26, 32 bits
         mname                  :: iolist(),        % = 27
         mtype                  :: integer(),       % = 28, 32 bits
         money = #{}            :: #{integer() := integer()} | undefined, % = 29
         icon                   :: pb_1100_role:p_icon() | undefined % = 30
        }).
-endif.
...
-record(p_role_base,
        {id                     :: non_neg_integer(), % = 1, 32 bits
         ...
         icon                   :: pb_1100_role:p_icon() | undefined, % = 17
...
-record(p_item,
        {uid                    :: integer(),       % = 1, 32 bits
         ...
         gender                 :: integer(),       % = 7, 32 bits
         score                  :: integer() | undefined, % = 8, 32 bits
         equip                  :: pb_1100_role:p_equip() | undefined, % = 9
         pet                    :: pb_1100_role:p_pet() | undefined, % = 10
...
-record(p_equip,
        {base                   :: pb_1100_role:p_attr(), % = 1
         rare1                  :: pb_1100_role:p_attr() | undefined, % = 2
         rare2                  :: pb_1100_role:p_attr() | undefined, % = 3
         rare3                  :: pb_1100_role:p_attr() | undefined, % = 4
         marriage               :: pb_1100_role:p_marriage() | undefined, % = 5
         ...
         refine = []            :: [pb_1100_role:p_refine()] | undefined, % = 11
         suite = #{}            :: #{integer() := integer()} | undefined, % = 12
         combine = []           :: [pb_1100_role:p_item()] | undefined % = 13
        }).
-endif.
...
-record(p_marriage,
        {husband_id             :: non_neg_integer() | undefined, % = 1, 32 bits
         ...
         rare                   :: pb_1100_role:p_attr() | undefined % = 5
        }).
-endif.
...
-record(p_actor,
        {uid                    :: non_neg_integer(), % = 1, 32 bits
         ...
         coord                  :: pb_1100_role:p_coord(), % = 4
         state                  :: integer(),       % = 5, 32 bits
         stargs = #{}           :: #{integer() := iolist()} | undefined, % = 6
         role                   :: pb_1100_role:p_role() | undefined, % = 7
         creep                  :: pb_1100_role:p_creep() | undefined, % = 8
         drop                   :: pb_1100_role:p_drop() | undefined % = 9
        }).
-endif.
...
-record(p_role,
        {career                 :: integer(),       % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1100_role:p_aspect()} | undefined, % = 5
         ...
         icon                   :: pb_1100_role:p_icon() | undefined % = 25
        }).
-endif.
...
-record(p_creep,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         buffs = []             :: [pb_1100_role:p_buff()] | undefined, % = 6
         dir                    :: integer(),       % = 7, 32 bits
         dest                   :: pb_1100_role:p_coord(), % = 8
...
-record(p_drop,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         coord                  :: pb_1100_role:p_coord() | undefined, % = 5
...
-record(p_ranking,
        {base                   :: pb_1100_role:p_role_base() | undefined, % = 1
