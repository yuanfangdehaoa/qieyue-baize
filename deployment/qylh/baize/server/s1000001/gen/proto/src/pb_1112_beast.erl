...
%% message types
-type m_beast_list_tos() :: #m_beast_list_tos{}.

-type m_beast_list_toc() :: #m_beast_list_toc{}.

-type m_beast_addsummon_tos() :: #m_beast_addsummon_tos{}.

-type m_beast_addsummon_toc() :: #m_beast_addsummon_toc{}.

-type m_beast_equip_load_tos() :: #m_beast_equip_load_tos{}.

-type m_beast_equip_load_toc() :: #m_beast_equip_load_toc{}.

-type m_beast_equip_unload_tos() :: #m_beast_equip_unload_tos{}.

-type m_beast_equip_unload_toc() :: #m_beast_equip_unload_toc{}.

-type m_beast_summon_tos() :: #m_beast_summon_tos{}.

-type m_beast_summon_toc() :: #m_beast_summon_toc{}.

-type m_beast_unsummon_tos() :: #m_beast_unsummon_tos{}.

-type m_beast_unsummon_toc() :: #m_beast_unsummon_toc{}.

-type m_beast_equip_reinforce_tos() :: #m_beast_equip_reinforce_tos{}.

-type m_beast_equip_reinforce_toc() :: #m_beast_equip_reinforce_toc{}.

-type p_beast() :: #p_beast{}.
...
-export_type(['m_beast_list_tos'/0, 'm_beast_list_toc'/0, 'm_beast_addsummon_tos'/0, 'm_beast_addsummon_toc'/0, 'm_beast_equip_load_tos'/0, 'm_beast_equip_load_toc'/0, 'm_beast_equip_unload_tos'/0, 'm_beast_equip_unload_toc'/0, 'm_beast_summon_tos'/0, 'm_beast_summon_toc'/0, 'm_beast_unsummon_tos'/0, 'm_beast_unsummon_toc'/0, 'm_beast_equip_reinforce_tos'/0, 'm_beast_equip_reinforce_toc'/0, 'p_beast'/0, 'p_role_base'/0, 'p_aspect'/0, 'p_attr'/0, 'p_item_base'/0, 'p_item'/0, 'p_equip'/0, 'p_pet'/0, 'p_marriage'/0, 'p_refine'/0, 'p_actor'/0, 'p_role'/0, 'p_creep'/0, 'p_npc'/0, 'p_drop'/0, 'p_buff'/0, 'p_coord'/0, 'p_icon'/0, 'p_ranking'/0, 'p_dropped'/0]).

-spec encode_msg(#m_beast_list_tos{} | #m_beast_list_toc{} | #m_beast_addsummon_tos{} | #m_beast_addsummon_toc{} | #m_beast_equip_load_tos{} | #m_beast_equip_load_toc{} | #m_beast_equip_unload_tos{} | #m_beast_equip_unload_toc{} | #m_beast_summon_tos{} | #m_beast_summon_toc{} | #m_beast_unsummon_tos{} | #m_beast_unsummon_toc{} | #m_beast_equip_reinforce_tos{} | #m_beast_equip_reinforce_toc{} | #p_beast{} | #p_role_base{} | #p_aspect{} | #p_attr{} | #p_item_base{} | #p_item{} | #p_equip{} | #p_pet{} | #p_marriage{} | #p_refine{} | #p_actor{} | #p_role{} | #p_creep{} | #p_npc{} | #p_drop{} | #p_buff{} | #p_coord{} | #p_icon{} | #p_ranking{} | #p_dropped{}) -> binary().
encode_msg(Msg) when tuple_size(Msg) >= 1 ->
    encode_msg(Msg, element(1, Msg), []).

-spec encode_msg(#m_beast_list_tos{} | #m_beast_list_toc{} | #m_beast_addsummon_tos{} | #m_beast_addsummon_toc{} | #m_beast_equip_load_tos{} | #m_beast_equip_load_toc{} | #m_beast_equip_unload_tos{} | #m_beast_equip_unload_toc{} | #m_beast_summon_tos{} | #m_beast_summon_toc{} | #m_beast_unsummon_tos{} | #m_beast_unsummon_toc{} | #m_beast_equip_reinforce_tos{} | #m_beast_equip_reinforce_toc{} | #p_beast{} | #p_role_base{} | #p_aspect{} | #p_attr{} | #p_item_base{} | #p_item{} | #p_equip{} | #p_pet{} | #p_marriage{} | #p_refine{} | #p_actor{} | #p_role{} | #p_creep{} | #p_npc{} | #p_drop{} | #p_buff{} | #p_coord{} | #p_icon{} | #p_ranking{} | #p_dropped{}, atom() | list()) -> binary().
...
encode_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
      m_beast_list_tos ->
	  encode_msg_m_beast_list_tos(id(Msg, TrUserData),
				      TrUserData);
      m_beast_list_toc ->
	  encode_msg_m_beast_list_toc(id(Msg, TrUserData),
				      TrUserData);
      m_beast_addsummon_tos ->
	  encode_msg_m_beast_addsummon_tos(id(Msg, TrUserData),
					   TrUserData);
      m_beast_addsummon_toc ->
	  encode_msg_m_beast_addsummon_toc(id(Msg, TrUserData),
					   TrUserData);
      m_beast_equip_load_tos ->
	  encode_msg_m_beast_equip_load_tos(id(Msg, TrUserData),
					    TrUserData);
      m_beast_equip_load_toc ->
	  encode_msg_m_beast_equip_load_toc(id(Msg, TrUserData),
					    TrUserData);
      m_beast_equip_unload_tos ->
	  encode_msg_m_beast_equip_unload_tos(id(Msg, TrUserData),
					      TrUserData);
      m_beast_equip_unload_toc ->
	  encode_msg_m_beast_equip_unload_toc(id(Msg, TrUserData),
					      TrUserData);
      m_beast_summon_tos ->
	  encode_msg_m_beast_summon_tos(id(Msg, TrUserData),
					TrUserData);
      m_beast_summon_toc ->
	  encode_msg_m_beast_summon_toc(id(Msg, TrUserData),
					TrUserData);
      m_beast_unsummon_tos ->
	  encode_msg_m_beast_unsummon_tos(id(Msg, TrUserData),
					  TrUserData);
      m_beast_unsummon_toc ->
	  encode_msg_m_beast_unsummon_toc(id(Msg, TrUserData),
					  TrUserData);
      m_beast_equip_reinforce_tos ->
	  encode_msg_m_beast_equip_reinforce_tos(id(Msg,
						    TrUserData),
						 TrUserData);
      m_beast_equip_reinforce_toc ->
	  encode_msg_m_beast_equip_reinforce_toc(id(Msg,
						    TrUserData),
						 TrUserData);
      p_beast ->
	  encode_msg_p_beast(id(Msg, TrUserData), TrUserData);
      p_role_base ->
...
encode_msg_m_beast_list_tos(_Msg, _TrUserData) -> <<>>.

encode_msg_m_beast_list_toc(Msg, TrUserData) ->
    encode_msg_m_beast_list_toc(Msg, <<>>, TrUserData).


encode_msg_m_beast_list_toc(#m_beast_list_toc{max_summon
						  = F1,
					      list = F2},
			    Bin, TrUserData) ->
    B1 = begin
    ...
    begin
      ...
      if TrF2 == [] -> B1;
	 true ->
	     e_field_m_beast_list_toc_list(TrF2, B1, TrUserData)
      end
    end.

encode_msg_m_beast_addsummon_tos(_Msg, _TrUserData) ->
    <<>>.

encode_msg_m_beast_addsummon_toc(Msg, TrUserData) ->
    encode_msg_m_beast_addsummon_toc(Msg, <<>>, TrUserData).


encode_msg_m_beast_addsummon_toc(#m_beast_addsummon_toc{max_summon
							    = F1},
				 Bin, TrUserData) ->
    begin
      TrF1 = id(F1, TrUserData),
...
encode_msg_m_beast_equip_load_tos(Msg, TrUserData) ->
    encode_msg_m_beast_equip_load_tos(Msg, <<>>,
				      TrUserData).


encode_msg_m_beast_equip_load_tos(#m_beast_equip_load_tos{id
							      = F1,
							  uid = F2},
				  Bin, TrUserData) ->
    B1 = begin
...
encode_msg_m_beast_equip_load_toc(Msg, TrUserData) ->
    encode_msg_m_beast_equip_load_toc(Msg, <<>>,
				      TrUserData).


encode_msg_m_beast_equip_load_toc(#m_beast_equip_load_toc{id
							      = F1,
							  equip = F2},
				  Bin, TrUserData) ->
    B1 = begin
    ...
    begin
      TrF2 = id(F2, TrUserData),
      e_mfield_m_beast_equip_load_toc_equip(TrF2,
					    <<B1/binary, 18>>, TrUserData)
    end.

encode_msg_m_beast_equip_unload_tos(Msg, TrUserData) ->
    encode_msg_m_beast_equip_unload_tos(Msg, <<>>,
					TrUserData).


encode_msg_m_beast_equip_unload_tos(#m_beast_equip_unload_tos{id
								  = F1,
							      slot = F2},
				    Bin, TrUserData) ->
    B1 = begin
...
encode_msg_m_beast_equip_unload_toc(Msg, TrUserData) ->
    encode_msg_m_beast_equip_unload_toc(Msg, <<>>,
					TrUserData).


encode_msg_m_beast_equip_unload_toc(#m_beast_equip_unload_toc{id
								  = F1,
							      slot = F2},
				    Bin, TrUserData) ->
    B1 = begin
...
encode_msg_m_beast_summon_tos(Msg, TrUserData) ->
    encode_msg_m_beast_summon_tos(Msg, <<>>, TrUserData).


encode_msg_m_beast_summon_tos(#m_beast_summon_tos{id =
						      F1},
			      Bin, TrUserData) ->
    begin
      TrF1 = id(F1, TrUserData),
...
encode_msg_m_beast_summon_toc(Msg, TrUserData) ->
    encode_msg_m_beast_summon_toc(Msg, <<>>, TrUserData).


encode_msg_m_beast_summon_toc(#m_beast_summon_toc{id =
						      F1},
			      Bin, TrUserData) ->
    begin
      TrF1 = id(F1, TrUserData),
...
encode_msg_m_beast_unsummon_tos(Msg, TrUserData) ->
    encode_msg_m_beast_unsummon_tos(Msg, <<>>, TrUserData).


encode_msg_m_beast_unsummon_tos(#m_beast_unsummon_tos{id
							  = F1},
				Bin, TrUserData) ->
    begin
      TrF1 = id(F1, TrUserData),
...
encode_msg_m_beast_unsummon_toc(Msg, TrUserData) ->
    encode_msg_m_beast_unsummon_toc(Msg, <<>>, TrUserData).


encode_msg_m_beast_unsummon_toc(#m_beast_unsummon_toc{id
							  = F1},
				Bin, TrUserData) ->
    begin
      TrF1 = id(F1, TrUserData),
...
encode_msg_m_beast_equip_reinforce_tos(Msg,
				       TrUserData) ->
    encode_msg_m_beast_equip_reinforce_tos(Msg, <<>>,
					   TrUserData).


encode_msg_m_beast_equip_reinforce_tos(#m_beast_equip_reinforce_tos{id
									= F1,
								    uid = F2,
								    cellids =
									F3,
    ...
    B3 = begin
	   ...
	   if TrF3 == [] -> B2;
	      true ->
		  e_field_m_beast_equip_reinforce_tos_cellids(TrF3, B2,
							      TrUserData)
	   end
	 end,
    begin
...
encode_msg_m_beast_equip_reinforce_toc(Msg,
				       TrUserData) ->
    encode_msg_m_beast_equip_reinforce_toc(Msg, <<>>,
					   TrUserData).


encode_msg_m_beast_equip_reinforce_toc(#m_beast_equip_reinforce_toc{id
									= F1,
								    equip = F2},
				       Bin, TrUserData) ->
    B1 = begin
    ...
    begin
      TrF2 = id(F2, TrUserData),
      e_mfield_m_beast_equip_reinforce_toc_equip(TrF2,
						 <<B1/binary, 18>>, TrUserData)
    end.

encode_msg_p_beast(Msg, TrUserData) ->
    encode_msg_p_beast(Msg, <<>>, TrUserData).


encode_msg_p_beast(#p_beast{id = F1, equips = F2,
			    summon = F3},
		   Bin, TrUserData) ->
    B1 = begin
	   TrF1 = id(F1, TrUserData),
    ...
    B2 = begin
	   TrF2 = id(F2, TrUserData),
	   if TrF2 == [] -> B1;
	      true -> e_field_p_beast_equips(TrF2, B1, TrUserData)
	   end
	 end,
    begin
      TrF3 = id(F3, TrUserData),
...
e_mfield_m_beast_list_toc_list(Msg, Bin, TrUserData) ->
    SubBin = encode_msg_p_beast(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

e_field_m_beast_list_toc_list([Elem | Rest], Bin,
			      TrUserData) ->
    Bin2 = <<Bin/binary, 18>>,
    Bin3 = e_mfield_m_beast_list_toc_list(id(Elem,
					     TrUserData),
					  Bin2, TrUserData),
    e_field_m_beast_list_toc_list(Rest, Bin3, TrUserData);
e_field_m_beast_list_toc_list([], Bin, _TrUserData) ->
    Bin.

e_mfield_m_beast_equip_load_toc_equip(Msg, Bin,
				      TrUserData) ->
    SubBin = encode_msg_p_item(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

e_field_m_beast_equip_reinforce_tos_cellids([Elem
					     | Rest],
					    Bin, TrUserData) ->
    Bin2 = <<Bin/binary, 24>>,
    Bin3 = e_type_int32(id(Elem, TrUserData), Bin2,
			TrUserData),
    e_field_m_beast_equip_reinforce_tos_cellids(Rest, Bin3,
						TrUserData);
e_field_m_beast_equip_reinforce_tos_cellids([], Bin,
					    _TrUserData) ->
    Bin.

e_mfield_m_beast_equip_reinforce_toc_equip(Msg, Bin,
					   TrUserData) ->
    SubBin = encode_msg_p_item(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

e_mfield_p_beast_equips(Msg, Bin, TrUserData) ->
    SubBin = encode_msg_p_item(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

e_field_p_beast_equips([Elem | Rest], Bin,
		       TrUserData) ->
    Bin2 = <<Bin/binary, 18>>,
    Bin3 = e_mfield_p_beast_equips(id(Elem, TrUserData),
				   Bin2, TrUserData),
    e_field_p_beast_equips(Rest, Bin3, TrUserData);
e_field_p_beast_equips([], Bin, _TrUserData) -> Bin.
...
decode_msg_2_doit(m_beast_list_tos, Bin, TrUserData) ->
    id(decode_msg_m_beast_list_tos(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_beast_list_toc, Bin, TrUserData) ->
    id(decode_msg_m_beast_list_toc(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_beast_addsummon_tos, Bin,
		  TrUserData) ->
    id(decode_msg_m_beast_addsummon_tos(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_beast_addsummon_toc, Bin,
		  TrUserData) ->
    id(decode_msg_m_beast_addsummon_toc(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_beast_equip_load_tos, Bin,
		  TrUserData) ->
    id(decode_msg_m_beast_equip_load_tos(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_beast_equip_load_toc, Bin,
		  TrUserData) ->
    id(decode_msg_m_beast_equip_load_toc(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_beast_equip_unload_tos, Bin,
		  TrUserData) ->
    id(decode_msg_m_beast_equip_unload_tos(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_beast_equip_unload_toc, Bin,
		  TrUserData) ->
    id(decode_msg_m_beast_equip_unload_toc(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_beast_summon_tos, Bin,
		  TrUserData) ->
    id(decode_msg_m_beast_summon_tos(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_beast_summon_toc, Bin,
		  TrUserData) ->
    id(decode_msg_m_beast_summon_toc(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_beast_unsummon_tos, Bin,
		  TrUserData) ->
    id(decode_msg_m_beast_unsummon_tos(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_beast_unsummon_toc, Bin,
		  TrUserData) ->
    id(decode_msg_m_beast_unsummon_toc(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_beast_equip_reinforce_tos, Bin,
		  TrUserData) ->
    id(decode_msg_m_beast_equip_reinforce_tos(Bin,
					      TrUserData),
       TrUserData);
decode_msg_2_doit(m_beast_equip_reinforce_toc, Bin,
		  TrUserData) ->
    id(decode_msg_m_beast_equip_reinforce_toc(Bin,
					      TrUserData),
       TrUserData);
decode_msg_2_doit(p_beast, Bin, TrUserData) ->
    id(decode_msg_p_beast(Bin, TrUserData), TrUserData);
...
decode_msg_m_beast_list_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_beast_list_tos(Bin, 0, 0,
					TrUserData).

dfp_read_field_def_m_beast_list_tos(<<>>, 0, 0, _) ->
    #m_beast_list_tos{};
dfp_read_field_def_m_beast_list_tos(Other, Z1, Z2,
				    TrUserData) ->
    dg_read_field_def_m_beast_list_tos(Other, Z1, Z2,
				       TrUserData).

dg_read_field_def_m_beast_list_tos(<<1:1, X:7,
				     Rest/binary>>,
				   N, Acc, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_beast_list_tos(Rest, N + 7,
				       X bsl N + Acc, TrUserData);
dg_read_field_def_m_beast_list_tos(<<0:1, X:7,
				     Rest/binary>>,
				   N, Acc, TrUserData) ->
    Key = X bsl N + Acc,
    case Key band 7 of
      0 ->
	  skip_varint_m_beast_list_tos(Rest, 0, 0, TrUserData);
      1 -> skip_64_m_beast_list_tos(Rest, 0, 0, TrUserData);
      2 ->
	  skip_length_delimited_m_beast_list_tos(Rest, 0, 0,
						 TrUserData);
      3 ->
	  skip_group_m_beast_list_tos(Rest, Key bsr 3, 0,
				      TrUserData);
      5 -> skip_32_m_beast_list_tos(Rest, 0, 0, TrUserData)
    end;
dg_read_field_def_m_beast_list_tos(<<>>, 0, 0, _) ->
    #m_beast_list_tos{}.

skip_varint_m_beast_list_tos(<<1:1, _:7, Rest/binary>>,
			     Z1, Z2, TrUserData) ->
    skip_varint_m_beast_list_tos(Rest, Z1, Z2, TrUserData);
skip_varint_m_beast_list_tos(<<0:1, _:7, Rest/binary>>,
			     Z1, Z2, TrUserData) ->
    dfp_read_field_def_m_beast_list_tos(Rest, Z1, Z2,
					TrUserData).

skip_length_delimited_m_beast_list_tos(<<1:1, X:7,
					 Rest/binary>>,
				       N, Acc, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_beast_list_tos(Rest, N + 7,
					   X bsl N + Acc, TrUserData);
skip_length_delimited_m_beast_list_tos(<<0:1, X:7,
					 Rest/binary>>,
				       N, Acc, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_beast_list_tos(Rest2, 0, 0,
					TrUserData).

skip_group_m_beast_list_tos(Bin, FNum, Z2,
			    TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_beast_list_tos(Rest, 0, Z2,
					TrUserData).

skip_32_m_beast_list_tos(<<_:32, Rest/binary>>, Z1, Z2,
			 TrUserData) ->
    dfp_read_field_def_m_beast_list_tos(Rest, Z1, Z2,
					TrUserData).

skip_64_m_beast_list_tos(<<_:64, Rest/binary>>, Z1, Z2,
			 TrUserData) ->
    dfp_read_field_def_m_beast_list_tos(Rest, Z1, Z2,
					TrUserData).

decode_msg_m_beast_list_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_beast_list_toc(Bin, 0, 0,
					id(undefined, TrUserData),
					id([], TrUserData), TrUserData).

dfp_read_field_def_m_beast_list_toc(<<8, Rest/binary>>,
				    Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_beast_list_toc_max_summon(Rest, Z1, Z2, F@_1,
					F@_2, TrUserData);
dfp_read_field_def_m_beast_list_toc(<<18, Rest/binary>>,
				    Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_beast_list_toc_list(Rest, Z1, Z2, F@_1, F@_2,
				  TrUserData);
dfp_read_field_def_m_beast_list_toc(<<>>, 0, 0, F@_1,
				    R1, TrUserData) ->
    #m_beast_list_toc{max_summon = F@_1,
		      list = lists_reverse(R1, TrUserData)};
dfp_read_field_def_m_beast_list_toc(Other, Z1, Z2, F@_1,
				    F@_2, TrUserData) ->
    dg_read_field_def_m_beast_list_toc(Other, Z1, Z2, F@_1,
				       F@_2, TrUserData).

dg_read_field_def_m_beast_list_toc(<<1:1, X:7,
				     Rest/binary>>,
				   N, Acc, F@_1, F@_2, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_beast_list_toc(Rest, N + 7,
				       X bsl N + Acc, F@_1, F@_2, TrUserData);
dg_read_field_def_m_beast_list_toc(<<0:1, X:7,
				     Rest/binary>>,
				   N, Acc, F@_1, F@_2, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_beast_list_toc_max_summon(Rest, 0, 0, F@_1,
					      F@_2, TrUserData);
      18 ->
	  d_field_m_beast_list_toc_list(Rest, 0, 0, F@_1, F@_2,
					TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_beast_list_toc(Rest, 0, 0, F@_1, F@_2,
					     TrUserData);
	    1 ->
		skip_64_m_beast_list_toc(Rest, 0, 0, F@_1, F@_2,
					 TrUserData);
	    2 ->
		skip_length_delimited_m_beast_list_toc(Rest, 0, 0, F@_1,
						       F@_2, TrUserData);
	    3 ->
		skip_group_m_beast_list_toc(Rest, Key bsr 3, 0, F@_1,
					    F@_2, TrUserData);
	    5 ->
		skip_32_m_beast_list_toc(Rest, 0, 0, F@_1, F@_2,
					 TrUserData)
	  end
    end;
dg_read_field_def_m_beast_list_toc(<<>>, 0, 0, F@_1, R1,
				   TrUserData) ->
    #m_beast_list_toc{max_summon = F@_1,
		      list = lists_reverse(R1, TrUserData)}.

d_field_m_beast_list_toc_max_summon(<<1:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_beast_list_toc_max_summon(Rest, N + 7,
					X bsl N + Acc, F@_1, F@_2, TrUserData);
d_field_m_beast_list_toc_max_summon(<<0:1, X:7,
				      Rest/binary>>,
    ...
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    dfp_read_field_def_m_beast_list_toc(RestF, 0, 0,
					NewFValue, F@_2, TrUserData).

d_field_m_beast_list_toc_list(<<1:1, X:7, Rest/binary>>,
			      N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_beast_list_toc_list(Rest, N + 7,
				  X bsl N + Acc, F@_1, F@_2, TrUserData);
d_field_m_beast_list_toc_list(<<0:1, X:7, Rest/binary>>,
			      N, Acc, F@_1, Prev, TrUserData) ->
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
			   <<Bs:Len/binary, Rest2/binary>> = Rest,
			   {id(decode_msg_p_beast(Bs, TrUserData), TrUserData),
			    Rest2}
			 end,
    dfp_read_field_def_m_beast_list_toc(RestF, 0, 0, F@_1,
					cons(NewFValue, Prev, TrUserData),
					TrUserData).

skip_varint_m_beast_list_toc(<<1:1, _:7, Rest/binary>>,
			     Z1, Z2, F@_1, F@_2, TrUserData) ->
    skip_varint_m_beast_list_toc(Rest, Z1, Z2, F@_1, F@_2,
				 TrUserData);
skip_varint_m_beast_list_toc(<<0:1, _:7, Rest/binary>>,
			     Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_beast_list_toc(Rest, Z1, Z2, F@_1,
					F@_2, TrUserData).

skip_length_delimited_m_beast_list_toc(<<1:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_beast_list_toc(Rest, N + 7,
					   X bsl N + Acc, F@_1, F@_2,
					   TrUserData);
skip_length_delimited_m_beast_list_toc(<<0:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, F@_2, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_beast_list_toc(Rest2, 0, 0, F@_1,
					F@_2, TrUserData).

skip_group_m_beast_list_toc(Bin, FNum, Z2, F@_1, F@_2,
			    TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_beast_list_toc(Rest, 0, Z2, F@_1,
					F@_2, TrUserData).

skip_32_m_beast_list_toc(<<_:32, Rest/binary>>, Z1, Z2,
			 F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_beast_list_toc(Rest, Z1, Z2, F@_1,
					F@_2, TrUserData).

skip_64_m_beast_list_toc(<<_:64, Rest/binary>>, Z1, Z2,
			 F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_beast_list_toc(Rest, Z1, Z2, F@_1,
					F@_2, TrUserData).

decode_msg_m_beast_addsummon_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_beast_addsummon_tos(Bin, 0, 0,
					     TrUserData).

dfp_read_field_def_m_beast_addsummon_tos(<<>>, 0, 0,
					 _) ->
    #m_beast_addsummon_tos{};
dfp_read_field_def_m_beast_addsummon_tos(Other, Z1, Z2,
					 TrUserData) ->
    dg_read_field_def_m_beast_addsummon_tos(Other, Z1, Z2,
					    TrUserData).

dg_read_field_def_m_beast_addsummon_tos(<<1:1, X:7,
					  Rest/binary>>,
					N, Acc, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_beast_addsummon_tos(Rest, N + 7,
					    X bsl N + Acc, TrUserData);
dg_read_field_def_m_beast_addsummon_tos(<<0:1, X:7,
					  Rest/binary>>,
					N, Acc, TrUserData) ->
    Key = X bsl N + Acc,
    case Key band 7 of
      0 ->
	  skip_varint_m_beast_addsummon_tos(Rest, 0, 0,
					    TrUserData);
      1 ->
	  skip_64_m_beast_addsummon_tos(Rest, 0, 0, TrUserData);
      2 ->
	  skip_length_delimited_m_beast_addsummon_tos(Rest, 0, 0,
						      TrUserData);
      3 ->
	  skip_group_m_beast_addsummon_tos(Rest, Key bsr 3, 0,
					   TrUserData);
      5 ->
	  skip_32_m_beast_addsummon_tos(Rest, 0, 0, TrUserData)
    end;
dg_read_field_def_m_beast_addsummon_tos(<<>>, 0, 0,
					_) ->
    #m_beast_addsummon_tos{}.

skip_varint_m_beast_addsummon_tos(<<1:1, _:7,
				    Rest/binary>>,
				  Z1, Z2, TrUserData) ->
    skip_varint_m_beast_addsummon_tos(Rest, Z1, Z2,
				      TrUserData);
skip_varint_m_beast_addsummon_tos(<<0:1, _:7,
				    Rest/binary>>,
				  Z1, Z2, TrUserData) ->
    dfp_read_field_def_m_beast_addsummon_tos(Rest, Z1, Z2,
					     TrUserData).

skip_length_delimited_m_beast_addsummon_tos(<<1:1, X:7,
					      Rest/binary>>,
					    N, Acc, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_beast_addsummon_tos(Rest, N + 7,
						X bsl N + Acc, TrUserData);
skip_length_delimited_m_beast_addsummon_tos(<<0:1, X:7,
					      Rest/binary>>,
					    N, Acc, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_beast_addsummon_tos(Rest2, 0, 0,
					     TrUserData).

skip_group_m_beast_addsummon_tos(Bin, FNum, Z2,
				 TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_beast_addsummon_tos(Rest, 0, Z2,
					     TrUserData).

skip_32_m_beast_addsummon_tos(<<_:32, Rest/binary>>, Z1,
			      Z2, TrUserData) ->
    dfp_read_field_def_m_beast_addsummon_tos(Rest, Z1, Z2,
					     TrUserData).

skip_64_m_beast_addsummon_tos(<<_:64, Rest/binary>>, Z1,
			      Z2, TrUserData) ->
    dfp_read_field_def_m_beast_addsummon_tos(Rest, Z1, Z2,
					     TrUserData).

decode_msg_m_beast_addsummon_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_beast_addsummon_toc(Bin, 0, 0,
					     id(undefined, TrUserData),
					     TrUserData).

dfp_read_field_def_m_beast_addsummon_toc(<<8,
					   Rest/binary>>,
					 Z1, Z2, F@_1, TrUserData) ->
    d_field_m_beast_addsummon_toc_max_summon(Rest, Z1, Z2,
					     F@_1, TrUserData);
dfp_read_field_def_m_beast_addsummon_toc(<<>>, 0, 0,
					 F@_1, _) ->
    #m_beast_addsummon_toc{max_summon = F@_1};
dfp_read_field_def_m_beast_addsummon_toc(Other, Z1, Z2,
					 F@_1, TrUserData) ->
    dg_read_field_def_m_beast_addsummon_toc(Other, Z1, Z2,
					    F@_1, TrUserData).

dg_read_field_def_m_beast_addsummon_toc(<<1:1, X:7,
					  Rest/binary>>,
					N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_beast_addsummon_toc(Rest, N + 7,
					    X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_m_beast_addsummon_toc(<<0:1, X:7,
					  Rest/binary>>,
					N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_beast_addsummon_toc_max_summon(Rest, 0, 0,
						   F@_1, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_beast_addsummon_toc(Rest, 0, 0, F@_1,
						  TrUserData);
	    1 ->
		skip_64_m_beast_addsummon_toc(Rest, 0, 0, F@_1,
					      TrUserData);
	    2 ->
		skip_length_delimited_m_beast_addsummon_toc(Rest, 0, 0,
							    F@_1, TrUserData);
	    3 ->
		skip_group_m_beast_addsummon_toc(Rest, Key bsr 3, 0,
						 F@_1, TrUserData);
	    5 ->
		skip_32_m_beast_addsummon_toc(Rest, 0, 0, F@_1,
					      TrUserData)
	  end
    end;
dg_read_field_def_m_beast_addsummon_toc(<<>>, 0, 0,
					F@_1, _) ->
    #m_beast_addsummon_toc{max_summon = F@_1}.

d_field_m_beast_addsummon_toc_max_summon(<<1:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_m_beast_addsummon_toc_max_summon(Rest, N + 7,
					     X bsl N + Acc, F@_1, TrUserData);
d_field_m_beast_addsummon_toc_max_summon(<<0:1, X:7,
					   Rest/binary>>,
					 N, Acc, _, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    dfp_read_field_def_m_beast_addsummon_toc(RestF, 0, 0,
					     NewFValue, TrUserData).

skip_varint_m_beast_addsummon_toc(<<1:1, _:7,
				    Rest/binary>>,
				  Z1, Z2, F@_1, TrUserData) ->
    skip_varint_m_beast_addsummon_toc(Rest, Z1, Z2, F@_1,
				      TrUserData);
skip_varint_m_beast_addsummon_toc(<<0:1, _:7,
				    Rest/binary>>,
				  Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_beast_addsummon_toc(Rest, Z1, Z2,
					     F@_1, TrUserData).

skip_length_delimited_m_beast_addsummon_toc(<<1:1, X:7,
					      Rest/binary>>,
					    N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_beast_addsummon_toc(Rest, N + 7,
						X bsl N + Acc, F@_1,
						TrUserData);
skip_length_delimited_m_beast_addsummon_toc(<<0:1, X:7,
					      Rest/binary>>,
					    N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_beast_addsummon_toc(Rest2, 0, 0,
					     F@_1, TrUserData).

skip_group_m_beast_addsummon_toc(Bin, FNum, Z2, F@_1,
				 TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_beast_addsummon_toc(Rest, 0, Z2,
					     F@_1, TrUserData).

skip_32_m_beast_addsummon_toc(<<_:32, Rest/binary>>, Z1,
			      Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_beast_addsummon_toc(Rest, Z1, Z2,
					     F@_1, TrUserData).

skip_64_m_beast_addsummon_toc(<<_:64, Rest/binary>>, Z1,
			      Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_beast_addsummon_toc(Rest, Z1, Z2,
					     F@_1, TrUserData).

decode_msg_m_beast_equip_load_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_beast_equip_load_tos(Bin, 0, 0,
					      id(undefined, TrUserData),
					      id(undefined, TrUserData),
					      TrUserData).

dfp_read_field_def_m_beast_equip_load_tos(<<8,
					    Rest/binary>>,
					  Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_beast_equip_load_tos_id(Rest, Z1, Z2, F@_1,
				      F@_2, TrUserData);
dfp_read_field_def_m_beast_equip_load_tos(<<16,
					    Rest/binary>>,
					  Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_beast_equip_load_tos_uid(Rest, Z1, Z2, F@_1,
				       F@_2, TrUserData);
dfp_read_field_def_m_beast_equip_load_tos(<<>>, 0, 0,
					  F@_1, F@_2, _) ->
    #m_beast_equip_load_tos{id = F@_1, uid = F@_2};
dfp_read_field_def_m_beast_equip_load_tos(Other, Z1, Z2,
					  F@_1, F@_2, TrUserData) ->
    dg_read_field_def_m_beast_equip_load_tos(Other, Z1, Z2,
					     F@_1, F@_2, TrUserData).

dg_read_field_def_m_beast_equip_load_tos(<<1:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, F@_2, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_beast_equip_load_tos(Rest, N + 7,
					     X bsl N + Acc, F@_1, F@_2,
					     TrUserData);
dg_read_field_def_m_beast_equip_load_tos(<<0:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, F@_2, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_beast_equip_load_tos_id(Rest, 0, 0, F@_1,
					    F@_2, TrUserData);
      16 ->
	  d_field_m_beast_equip_load_tos_uid(Rest, 0, 0, F@_1,
					     F@_2, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_beast_equip_load_tos(Rest, 0, 0, F@_1,
						   F@_2, TrUserData);
	    1 ->
		skip_64_m_beast_equip_load_tos(Rest, 0, 0, F@_1, F@_2,
					       TrUserData);
	    2 ->
		skip_length_delimited_m_beast_equip_load_tos(Rest, 0, 0,
							     F@_1, F@_2,
							     TrUserData);
	    3 ->
		skip_group_m_beast_equip_load_tos(Rest, Key bsr 3, 0,
						  F@_1, F@_2, TrUserData);
	    5 ->
		skip_32_m_beast_equip_load_tos(Rest, 0, 0, F@_1, F@_2,
					       TrUserData)
	  end
    end;
dg_read_field_def_m_beast_equip_load_tos(<<>>, 0, 0,
					 F@_1, F@_2, _) ->
    #m_beast_equip_load_tos{id = F@_1, uid = F@_2}.

d_field_m_beast_equip_load_tos_id(<<1:1, X:7,
				    Rest/binary>>,
				  N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_beast_equip_load_tos_id(Rest, N + 7,
				      X bsl N + Acc, F@_1, F@_2, TrUserData);
d_field_m_beast_equip_load_tos_id(<<0:1, X:7,
				    Rest/binary>>,
				  N, Acc, _, F@_2, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    dfp_read_field_def_m_beast_equip_load_tos(RestF, 0, 0,
					      NewFValue, F@_2, TrUserData).

d_field_m_beast_equip_load_tos_uid(<<1:1, X:7,
				     Rest/binary>>,
				   N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_beast_equip_load_tos_uid(Rest, N + 7,
				       X bsl N + Acc, F@_1, F@_2, TrUserData);
d_field_m_beast_equip_load_tos_uid(<<0:1, X:7,
				     Rest/binary>>,
...
skip_varint_m_beast_equip_load_tos(<<1:1, _:7,
				     Rest/binary>>,
				   Z1, Z2, F@_1, F@_2, TrUserData) ->
    skip_varint_m_beast_equip_load_tos(Rest, Z1, Z2, F@_1,
				       F@_2, TrUserData);
skip_varint_m_beast_equip_load_tos(<<0:1, _:7,
				     Rest/binary>>,
				   Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_beast_equip_load_tos(Rest, Z1, Z2,
					      F@_1, F@_2, TrUserData).

skip_length_delimited_m_beast_equip_load_tos(<<1:1, X:7,
					       Rest/binary>>,
					     N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_beast_equip_load_tos(Rest,
						 N + 7, X bsl N + Acc, F@_1,
						 F@_2, TrUserData);
skip_length_delimited_m_beast_equip_load_tos(<<0:1, X:7,
					       Rest/binary>>,
					     N, Acc, F@_1, F@_2, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_beast_equip_load_tos(Rest2, 0, 0,
					      F@_1, F@_2, TrUserData).

skip_group_m_beast_equip_load_tos(Bin, FNum, Z2, F@_1,
				  F@_2, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_beast_equip_load_tos(Rest, 0, Z2,
					      F@_1, F@_2, TrUserData).

skip_32_m_beast_equip_load_tos(<<_:32, Rest/binary>>,
			       Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_beast_equip_load_tos(Rest, Z1, Z2,
					      F@_1, F@_2, TrUserData).

skip_64_m_beast_equip_load_tos(<<_:64, Rest/binary>>,
			       Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_beast_equip_load_tos(Rest, Z1, Z2,
					      F@_1, F@_2, TrUserData).

decode_msg_m_beast_equip_load_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_beast_equip_load_toc(Bin, 0, 0,
					      id(undefined, TrUserData),
					      id(undefined, TrUserData),
					      TrUserData).

dfp_read_field_def_m_beast_equip_load_toc(<<8,
					    Rest/binary>>,
					  Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_beast_equip_load_toc_id(Rest, Z1, Z2, F@_1,
				      F@_2, TrUserData);
dfp_read_field_def_m_beast_equip_load_toc(<<18,
					    Rest/binary>>,
					  Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_beast_equip_load_toc_equip(Rest, Z1, Z2, F@_1,
					 F@_2, TrUserData);
dfp_read_field_def_m_beast_equip_load_toc(<<>>, 0, 0,
					  F@_1, F@_2, _) ->
    #m_beast_equip_load_toc{id = F@_1, equip = F@_2};
dfp_read_field_def_m_beast_equip_load_toc(Other, Z1, Z2,
					  F@_1, F@_2, TrUserData) ->
    dg_read_field_def_m_beast_equip_load_toc(Other, Z1, Z2,
					     F@_1, F@_2, TrUserData).

dg_read_field_def_m_beast_equip_load_toc(<<1:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, F@_2, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_beast_equip_load_toc(Rest, N + 7,
					     X bsl N + Acc, F@_1, F@_2,
					     TrUserData);
dg_read_field_def_m_beast_equip_load_toc(<<0:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, F@_2, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_beast_equip_load_toc_id(Rest, 0, 0, F@_1,
					    F@_2, TrUserData);
      18 ->
	  d_field_m_beast_equip_load_toc_equip(Rest, 0, 0, F@_1,
					       F@_2, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_beast_equip_load_toc(Rest, 0, 0, F@_1,
						   F@_2, TrUserData);
	    1 ->
		skip_64_m_beast_equip_load_toc(Rest, 0, 0, F@_1, F@_2,
					       TrUserData);
	    2 ->
		skip_length_delimited_m_beast_equip_load_toc(Rest, 0, 0,
							     F@_1, F@_2,
							     TrUserData);
	    3 ->
		skip_group_m_beast_equip_load_toc(Rest, Key bsr 3, 0,
						  F@_1, F@_2, TrUserData);
	    5 ->
		skip_32_m_beast_equip_load_toc(Rest, 0, 0, F@_1, F@_2,
					       TrUserData)
	  end
    end;
dg_read_field_def_m_beast_equip_load_toc(<<>>, 0, 0,
					 F@_1, F@_2, _) ->
    #m_beast_equip_load_toc{id = F@_1, equip = F@_2}.

d_field_m_beast_equip_load_toc_id(<<1:1, X:7,
				    Rest/binary>>,
				  N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_beast_equip_load_toc_id(Rest, N + 7,
				      X bsl N + Acc, F@_1, F@_2, TrUserData);
d_field_m_beast_equip_load_toc_id(<<0:1, X:7,
				    Rest/binary>>,
				  N, Acc, _, F@_2, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    dfp_read_field_def_m_beast_equip_load_toc(RestF, 0, 0,
					      NewFValue, F@_2, TrUserData).

d_field_m_beast_equip_load_toc_equip(<<1:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_beast_equip_load_toc_equip(Rest, N + 7,
					 X bsl N + Acc, F@_1, F@_2, TrUserData);
d_field_m_beast_equip_load_toc_equip(<<0:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, Prev, TrUserData) ->
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
...
skip_varint_m_beast_equip_load_toc(<<1:1, _:7,
				     Rest/binary>>,
				   Z1, Z2, F@_1, F@_2, TrUserData) ->
    skip_varint_m_beast_equip_load_toc(Rest, Z1, Z2, F@_1,
				       F@_2, TrUserData);
skip_varint_m_beast_equip_load_toc(<<0:1, _:7,
				     Rest/binary>>,
				   Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_beast_equip_load_toc(Rest, Z1, Z2,
					      F@_1, F@_2, TrUserData).

skip_length_delimited_m_beast_equip_load_toc(<<1:1, X:7,
					       Rest/binary>>,
					     N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_beast_equip_load_toc(Rest,
						 N + 7, X bsl N + Acc, F@_1,
						 F@_2, TrUserData);
skip_length_delimited_m_beast_equip_load_toc(<<0:1, X:7,
					       Rest/binary>>,
					     N, Acc, F@_1, F@_2, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_beast_equip_load_toc(Rest2, 0, 0,
					      F@_1, F@_2, TrUserData).

skip_group_m_beast_equip_load_toc(Bin, FNum, Z2, F@_1,
				  F@_2, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_beast_equip_load_toc(Rest, 0, Z2,
					      F@_1, F@_2, TrUserData).

skip_32_m_beast_equip_load_toc(<<_:32, Rest/binary>>,
			       Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_beast_equip_load_toc(Rest, Z1, Z2,
					      F@_1, F@_2, TrUserData).

skip_64_m_beast_equip_load_toc(<<_:64, Rest/binary>>,
			       Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_beast_equip_load_toc(Rest, Z1, Z2,
					      F@_1, F@_2, TrUserData).

decode_msg_m_beast_equip_unload_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_beast_equip_unload_tos(Bin, 0, 0,
						id(undefined, TrUserData),
						id(undefined, TrUserData),
						TrUserData).

dfp_read_field_def_m_beast_equip_unload_tos(<<8,
					      Rest/binary>>,
					    Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_beast_equip_unload_tos_id(Rest, Z1, Z2, F@_1,
					F@_2, TrUserData);
dfp_read_field_def_m_beast_equip_unload_tos(<<16,
					      Rest/binary>>,
					    Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_beast_equip_unload_tos_slot(Rest, Z1, Z2,
					  F@_1, F@_2, TrUserData);
dfp_read_field_def_m_beast_equip_unload_tos(<<>>, 0, 0,
					    F@_1, F@_2, _) ->
    #m_beast_equip_unload_tos{id = F@_1, slot = F@_2};
dfp_read_field_def_m_beast_equip_unload_tos(Other, Z1,
					    Z2, F@_1, F@_2, TrUserData) ->
    dg_read_field_def_m_beast_equip_unload_tos(Other, Z1,
					       Z2, F@_1, F@_2, TrUserData).

dg_read_field_def_m_beast_equip_unload_tos(<<1:1, X:7,
					     Rest/binary>>,
					   N, Acc, F@_1, F@_2, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_beast_equip_unload_tos(Rest, N + 7,
					       X bsl N + Acc, F@_1, F@_2,
					       TrUserData);
dg_read_field_def_m_beast_equip_unload_tos(<<0:1, X:7,
					     Rest/binary>>,
					   N, Acc, F@_1, F@_2, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_beast_equip_unload_tos_id(Rest, 0, 0, F@_1,
					      F@_2, TrUserData);
      16 ->
	  d_field_m_beast_equip_unload_tos_slot(Rest, 0, 0, F@_1,
						F@_2, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_beast_equip_unload_tos(Rest, 0, 0, F@_1,
						     F@_2, TrUserData);
	    1 ->
		skip_64_m_beast_equip_unload_tos(Rest, 0, 0, F@_1, F@_2,
						 TrUserData);
	    2 ->
		skip_length_delimited_m_beast_equip_unload_tos(Rest, 0,
							       0, F@_1, F@_2,
							       TrUserData);
	    3 ->
		skip_group_m_beast_equip_unload_tos(Rest, Key bsr 3, 0,
						    F@_1, F@_2, TrUserData);
	    5 ->
		skip_32_m_beast_equip_unload_tos(Rest, 0, 0, F@_1, F@_2,
						 TrUserData)
	  end
    end;
dg_read_field_def_m_beast_equip_unload_tos(<<>>, 0, 0,
					   F@_1, F@_2, _) ->
    #m_beast_equip_unload_tos{id = F@_1, slot = F@_2}.

d_field_m_beast_equip_unload_tos_id(<<1:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_beast_equip_unload_tos_id(Rest, N + 7,
					X bsl N + Acc, F@_1, F@_2, TrUserData);
d_field_m_beast_equip_unload_tos_id(<<0:1, X:7,
				      Rest/binary>>,
				    N, Acc, _, F@_2, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    dfp_read_field_def_m_beast_equip_unload_tos(RestF, 0, 0,
						NewFValue, F@_2, TrUserData).

d_field_m_beast_equip_unload_tos_slot(<<1:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_beast_equip_unload_tos_slot(Rest, N + 7,
					  X bsl N + Acc, F@_1, F@_2,
					  TrUserData);
d_field_m_beast_equip_unload_tos_slot(<<0:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, _, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
...
skip_varint_m_beast_equip_unload_tos(<<1:1, _:7,
				       Rest/binary>>,
				     Z1, Z2, F@_1, F@_2, TrUserData) ->
    skip_varint_m_beast_equip_unload_tos(Rest, Z1, Z2, F@_1,
					 F@_2, TrUserData);
skip_varint_m_beast_equip_unload_tos(<<0:1, _:7,
				       Rest/binary>>,
				     Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_beast_equip_unload_tos(Rest, Z1,
						Z2, F@_1, F@_2, TrUserData).

skip_length_delimited_m_beast_equip_unload_tos(<<1:1,
						 X:7, Rest/binary>>,
					       N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_beast_equip_unload_tos(Rest,
						   N + 7, X bsl N + Acc, F@_1,
						   F@_2, TrUserData);
skip_length_delimited_m_beast_equip_unload_tos(<<0:1,
						 X:7, Rest/binary>>,
					       N, Acc, F@_1, F@_2,
					       TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_beast_equip_unload_tos(Rest2, 0, 0,
						F@_1, F@_2, TrUserData).

skip_group_m_beast_equip_unload_tos(Bin, FNum, Z2, F@_1,
				    F@_2, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_beast_equip_unload_tos(Rest, 0, Z2,
						F@_1, F@_2, TrUserData).

skip_32_m_beast_equip_unload_tos(<<_:32, Rest/binary>>,
				 Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_beast_equip_unload_tos(Rest, Z1,
						Z2, F@_1, F@_2, TrUserData).

skip_64_m_beast_equip_unload_tos(<<_:64, Rest/binary>>,
				 Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_beast_equip_unload_tos(Rest, Z1,
						Z2, F@_1, F@_2, TrUserData).

decode_msg_m_beast_equip_unload_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_beast_equip_unload_toc(Bin, 0, 0,
						id(undefined, TrUserData),
						id(undefined, TrUserData),
						TrUserData).

dfp_read_field_def_m_beast_equip_unload_toc(<<8,
					      Rest/binary>>,
					    Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_beast_equip_unload_toc_id(Rest, Z1, Z2, F@_1,
					F@_2, TrUserData);
dfp_read_field_def_m_beast_equip_unload_toc(<<16,
					      Rest/binary>>,
					    Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_beast_equip_unload_toc_slot(Rest, Z1, Z2,
					  F@_1, F@_2, TrUserData);
dfp_read_field_def_m_beast_equip_unload_toc(<<>>, 0, 0,
					    F@_1, F@_2, _) ->
    #m_beast_equip_unload_toc{id = F@_1, slot = F@_2};
dfp_read_field_def_m_beast_equip_unload_toc(Other, Z1,
					    Z2, F@_1, F@_2, TrUserData) ->
    dg_read_field_def_m_beast_equip_unload_toc(Other, Z1,
					       Z2, F@_1, F@_2, TrUserData).

dg_read_field_def_m_beast_equip_unload_toc(<<1:1, X:7,
					     Rest/binary>>,
					   N, Acc, F@_1, F@_2, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_beast_equip_unload_toc(Rest, N + 7,
					       X bsl N + Acc, F@_1, F@_2,
					       TrUserData);
dg_read_field_def_m_beast_equip_unload_toc(<<0:1, X:7,
					     Rest/binary>>,
					   N, Acc, F@_1, F@_2, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_beast_equip_unload_toc_id(Rest, 0, 0, F@_1,
					      F@_2, TrUserData);
      16 ->
	  d_field_m_beast_equip_unload_toc_slot(Rest, 0, 0, F@_1,
						F@_2, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_beast_equip_unload_toc(Rest, 0, 0, F@_1,
						     F@_2, TrUserData);
	    1 ->
		skip_64_m_beast_equip_unload_toc(Rest, 0, 0, F@_1, F@_2,
						 TrUserData);
	    2 ->
		skip_length_delimited_m_beast_equip_unload_toc(Rest, 0,
							       0, F@_1, F@_2,
							       TrUserData);
	    3 ->
		skip_group_m_beast_equip_unload_toc(Rest, Key bsr 3, 0,
						    F@_1, F@_2, TrUserData);
	    5 ->
		skip_32_m_beast_equip_unload_toc(Rest, 0, 0, F@_1, F@_2,
						 TrUserData)
	  end
    end;
dg_read_field_def_m_beast_equip_unload_toc(<<>>, 0, 0,
					   F@_1, F@_2, _) ->
    #m_beast_equip_unload_toc{id = F@_1, slot = F@_2}.

d_field_m_beast_equip_unload_toc_id(<<1:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_beast_equip_unload_toc_id(Rest, N + 7,
					X bsl N + Acc, F@_1, F@_2, TrUserData);
d_field_m_beast_equip_unload_toc_id(<<0:1, X:7,
				      Rest/binary>>,
				    N, Acc, _, F@_2, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    dfp_read_field_def_m_beast_equip_unload_toc(RestF, 0, 0,
						NewFValue, F@_2, TrUserData).

d_field_m_beast_equip_unload_toc_slot(<<1:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_beast_equip_unload_toc_slot(Rest, N + 7,
					  X bsl N + Acc, F@_1, F@_2,
					  TrUserData);
d_field_m_beast_equip_unload_toc_slot(<<0:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, _, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
...
skip_varint_m_beast_equip_unload_toc(<<1:1, _:7,
				       Rest/binary>>,
				     Z1, Z2, F@_1, F@_2, TrUserData) ->
    skip_varint_m_beast_equip_unload_toc(Rest, Z1, Z2, F@_1,
					 F@_2, TrUserData);
skip_varint_m_beast_equip_unload_toc(<<0:1, _:7,
				       Rest/binary>>,
				     Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_beast_equip_unload_toc(Rest, Z1,
						Z2, F@_1, F@_2, TrUserData).

skip_length_delimited_m_beast_equip_unload_toc(<<1:1,
						 X:7, Rest/binary>>,
					       N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_beast_equip_unload_toc(Rest,
						   N + 7, X bsl N + Acc, F@_1,
						   F@_2, TrUserData);
skip_length_delimited_m_beast_equip_unload_toc(<<0:1,
						 X:7, Rest/binary>>,
					       N, Acc, F@_1, F@_2,
					       TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_beast_equip_unload_toc(Rest2, 0, 0,
						F@_1, F@_2, TrUserData).

skip_group_m_beast_equip_unload_toc(Bin, FNum, Z2, F@_1,
				    F@_2, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_beast_equip_unload_toc(Rest, 0, Z2,
						F@_1, F@_2, TrUserData).

skip_32_m_beast_equip_unload_toc(<<_:32, Rest/binary>>,
				 Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_beast_equip_unload_toc(Rest, Z1,
						Z2, F@_1, F@_2, TrUserData).

skip_64_m_beast_equip_unload_toc(<<_:64, Rest/binary>>,
				 Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_beast_equip_unload_toc(Rest, Z1,
						Z2, F@_1, F@_2, TrUserData).

decode_msg_m_beast_summon_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_beast_summon_tos(Bin, 0, 0,
					  id(undefined, TrUserData),
					  TrUserData).

dfp_read_field_def_m_beast_summon_tos(<<8,
					Rest/binary>>,
				      Z1, Z2, F@_1, TrUserData) ->
    d_field_m_beast_summon_tos_id(Rest, Z1, Z2, F@_1,
				  TrUserData);
dfp_read_field_def_m_beast_summon_tos(<<>>, 0, 0, F@_1,
				      _) ->
    #m_beast_summon_tos{id = F@_1};
dfp_read_field_def_m_beast_summon_tos(Other, Z1, Z2,
				      F@_1, TrUserData) ->
    dg_read_field_def_m_beast_summon_tos(Other, Z1, Z2,
					 F@_1, TrUserData).

dg_read_field_def_m_beast_summon_tos(<<1:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_beast_summon_tos(Rest, N + 7,
					 X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_m_beast_summon_tos(<<0:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_beast_summon_tos_id(Rest, 0, 0, F@_1,
					TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_beast_summon_tos(Rest, 0, 0, F@_1,
					       TrUserData);
	    1 ->
		skip_64_m_beast_summon_tos(Rest, 0, 0, F@_1,
					   TrUserData);
	    2 ->
		skip_length_delimited_m_beast_summon_tos(Rest, 0, 0,
							 F@_1, TrUserData);
	    3 ->
		skip_group_m_beast_summon_tos(Rest, Key bsr 3, 0, F@_1,
					      TrUserData);
	    5 ->
		skip_32_m_beast_summon_tos(Rest, 0, 0, F@_1, TrUserData)
	  end
    end;
dg_read_field_def_m_beast_summon_tos(<<>>, 0, 0, F@_1,
				     _) ->
    #m_beast_summon_tos{id = F@_1}.

d_field_m_beast_summon_tos_id(<<1:1, X:7, Rest/binary>>,
			      N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_m_beast_summon_tos_id(Rest, N + 7,
				  X bsl N + Acc, F@_1, TrUserData);
d_field_m_beast_summon_tos_id(<<0:1, X:7, Rest/binary>>,
			      N, Acc, _, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
							    Acc):32/unsigned-native>>,
			  ...
			  Rest},
    dfp_read_field_def_m_beast_summon_tos(RestF, 0, 0,
					  NewFValue, TrUserData).

skip_varint_m_beast_summon_tos(<<1:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, F@_1, TrUserData) ->
    skip_varint_m_beast_summon_tos(Rest, Z1, Z2, F@_1,
				   TrUserData);
skip_varint_m_beast_summon_tos(<<0:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_beast_summon_tos(Rest, Z1, Z2,
					  F@_1, TrUserData).

skip_length_delimited_m_beast_summon_tos(<<1:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_beast_summon_tos(Rest, N + 7,
					     X bsl N + Acc, F@_1, TrUserData);
skip_length_delimited_m_beast_summon_tos(<<0:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_beast_summon_tos(Rest2, 0, 0, F@_1,
					  TrUserData).

skip_group_m_beast_summon_tos(Bin, FNum, Z2, F@_1,
			      TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_beast_summon_tos(Rest, 0, Z2, F@_1,
					  TrUserData).

skip_32_m_beast_summon_tos(<<_:32, Rest/binary>>, Z1,
			   Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_beast_summon_tos(Rest, Z1, Z2,
					  F@_1, TrUserData).

skip_64_m_beast_summon_tos(<<_:64, Rest/binary>>, Z1,
			   Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_beast_summon_tos(Rest, Z1, Z2,
					  F@_1, TrUserData).

decode_msg_m_beast_summon_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_beast_summon_toc(Bin, 0, 0,
					  id(undefined, TrUserData),
					  TrUserData).

dfp_read_field_def_m_beast_summon_toc(<<8,
					Rest/binary>>,
				      Z1, Z2, F@_1, TrUserData) ->
    d_field_m_beast_summon_toc_id(Rest, Z1, Z2, F@_1,
				  TrUserData);
dfp_read_field_def_m_beast_summon_toc(<<>>, 0, 0, F@_1,
				      _) ->
    #m_beast_summon_toc{id = F@_1};
dfp_read_field_def_m_beast_summon_toc(Other, Z1, Z2,
				      F@_1, TrUserData) ->
    dg_read_field_def_m_beast_summon_toc(Other, Z1, Z2,
					 F@_1, TrUserData).

dg_read_field_def_m_beast_summon_toc(<<1:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_beast_summon_toc(Rest, N + 7,
					 X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_m_beast_summon_toc(<<0:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_beast_summon_toc_id(Rest, 0, 0, F@_1,
					TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_beast_summon_toc(Rest, 0, 0, F@_1,
					       TrUserData);
	    1 ->
		skip_64_m_beast_summon_toc(Rest, 0, 0, F@_1,
					   TrUserData);
	    2 ->
		skip_length_delimited_m_beast_summon_toc(Rest, 0, 0,
							 F@_1, TrUserData);
	    3 ->
		skip_group_m_beast_summon_toc(Rest, Key bsr 3, 0, F@_1,
					      TrUserData);
	    5 ->
		skip_32_m_beast_summon_toc(Rest, 0, 0, F@_1, TrUserData)
	  end
    end;
dg_read_field_def_m_beast_summon_toc(<<>>, 0, 0, F@_1,
				     _) ->
    #m_beast_summon_toc{id = F@_1}.

d_field_m_beast_summon_toc_id(<<1:1, X:7, Rest/binary>>,
			      N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_m_beast_summon_toc_id(Rest, N + 7,
				  X bsl N + Acc, F@_1, TrUserData);
d_field_m_beast_summon_toc_id(<<0:1, X:7, Rest/binary>>,
			      N, Acc, _, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
							    Acc):32/unsigned-native>>,
			  ...
			  Rest},
    dfp_read_field_def_m_beast_summon_toc(RestF, 0, 0,
					  NewFValue, TrUserData).

skip_varint_m_beast_summon_toc(<<1:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, F@_1, TrUserData) ->
    skip_varint_m_beast_summon_toc(Rest, Z1, Z2, F@_1,
				   TrUserData);
skip_varint_m_beast_summon_toc(<<0:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_beast_summon_toc(Rest, Z1, Z2,
					  F@_1, TrUserData).

skip_length_delimited_m_beast_summon_toc(<<1:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_beast_summon_toc(Rest, N + 7,
					     X bsl N + Acc, F@_1, TrUserData);
skip_length_delimited_m_beast_summon_toc(<<0:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_beast_summon_toc(Rest2, 0, 0, F@_1,
					  TrUserData).

skip_group_m_beast_summon_toc(Bin, FNum, Z2, F@_1,
			      TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_beast_summon_toc(Rest, 0, Z2, F@_1,
					  TrUserData).

skip_32_m_beast_summon_toc(<<_:32, Rest/binary>>, Z1,
			   Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_beast_summon_toc(Rest, Z1, Z2,
					  F@_1, TrUserData).

skip_64_m_beast_summon_toc(<<_:64, Rest/binary>>, Z1,
			   Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_beast_summon_toc(Rest, Z1, Z2,
					  F@_1, TrUserData).

decode_msg_m_beast_unsummon_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_beast_unsummon_tos(Bin, 0, 0,
					    id(undefined, TrUserData),
					    TrUserData).

dfp_read_field_def_m_beast_unsummon_tos(<<8,
					  Rest/binary>>,
					Z1, Z2, F@_1, TrUserData) ->
    d_field_m_beast_unsummon_tos_id(Rest, Z1, Z2, F@_1,
				    TrUserData);
dfp_read_field_def_m_beast_unsummon_tos(<<>>, 0, 0,
					F@_1, _) ->
    #m_beast_unsummon_tos{id = F@_1};
dfp_read_field_def_m_beast_unsummon_tos(Other, Z1, Z2,
					F@_1, TrUserData) ->
    dg_read_field_def_m_beast_unsummon_tos(Other, Z1, Z2,
					   F@_1, TrUserData).

dg_read_field_def_m_beast_unsummon_tos(<<1:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_beast_unsummon_tos(Rest, N + 7,
					   X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_m_beast_unsummon_tos(<<0:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_beast_unsummon_tos_id(Rest, 0, 0, F@_1,
					  TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_beast_unsummon_tos(Rest, 0, 0, F@_1,
						 TrUserData);
	    1 ->
		skip_64_m_beast_unsummon_tos(Rest, 0, 0, F@_1,
					     TrUserData);
	    2 ->
		skip_length_delimited_m_beast_unsummon_tos(Rest, 0, 0,
							   F@_1, TrUserData);
	    3 ->
		skip_group_m_beast_unsummon_tos(Rest, Key bsr 3, 0,
						F@_1, TrUserData);
	    5 ->
		skip_32_m_beast_unsummon_tos(Rest, 0, 0, F@_1,
					     TrUserData)
	  end
    end;
dg_read_field_def_m_beast_unsummon_tos(<<>>, 0, 0, F@_1,
				       _) ->
    #m_beast_unsummon_tos{id = F@_1}.

d_field_m_beast_unsummon_tos_id(<<1:1, X:7,
				  Rest/binary>>,
				N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_m_beast_unsummon_tos_id(Rest, N + 7,
				    X bsl N + Acc, F@_1, TrUserData);
d_field_m_beast_unsummon_tos_id(<<0:1, X:7,
				  Rest/binary>>,
				N, Acc, _, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    dfp_read_field_def_m_beast_unsummon_tos(RestF, 0, 0,
					    NewFValue, TrUserData).

skip_varint_m_beast_unsummon_tos(<<1:1, _:7,
				   Rest/binary>>,
				 Z1, Z2, F@_1, TrUserData) ->
    skip_varint_m_beast_unsummon_tos(Rest, Z1, Z2, F@_1,
				     TrUserData);
skip_varint_m_beast_unsummon_tos(<<0:1, _:7,
				   Rest/binary>>,
				 Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_beast_unsummon_tos(Rest, Z1, Z2,
					    F@_1, TrUserData).

skip_length_delimited_m_beast_unsummon_tos(<<1:1, X:7,
					     Rest/binary>>,
					   N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_beast_unsummon_tos(Rest, N + 7,
					       X bsl N + Acc, F@_1, TrUserData);
skip_length_delimited_m_beast_unsummon_tos(<<0:1, X:7,
					     Rest/binary>>,
					   N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_beast_unsummon_tos(Rest2, 0, 0,
					    F@_1, TrUserData).

skip_group_m_beast_unsummon_tos(Bin, FNum, Z2, F@_1,
				TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_beast_unsummon_tos(Rest, 0, Z2,
					    F@_1, TrUserData).

skip_32_m_beast_unsummon_tos(<<_:32, Rest/binary>>, Z1,
			     Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_beast_unsummon_tos(Rest, Z1, Z2,
					    F@_1, TrUserData).

skip_64_m_beast_unsummon_tos(<<_:64, Rest/binary>>, Z1,
			     Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_beast_unsummon_tos(Rest, Z1, Z2,
					    F@_1, TrUserData).

decode_msg_m_beast_unsummon_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_beast_unsummon_toc(Bin, 0, 0,
					    id(undefined, TrUserData),
					    TrUserData).

dfp_read_field_def_m_beast_unsummon_toc(<<8,
					  Rest/binary>>,
					Z1, Z2, F@_1, TrUserData) ->
    d_field_m_beast_unsummon_toc_id(Rest, Z1, Z2, F@_1,
				    TrUserData);
dfp_read_field_def_m_beast_unsummon_toc(<<>>, 0, 0,
					F@_1, _) ->
    #m_beast_unsummon_toc{id = F@_1};
dfp_read_field_def_m_beast_unsummon_toc(Other, Z1, Z2,
					F@_1, TrUserData) ->
    dg_read_field_def_m_beast_unsummon_toc(Other, Z1, Z2,
					   F@_1, TrUserData).

dg_read_field_def_m_beast_unsummon_toc(<<1:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_beast_unsummon_toc(Rest, N + 7,
					   X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_m_beast_unsummon_toc(<<0:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_beast_unsummon_toc_id(Rest, 0, 0, F@_1,
					  TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_beast_unsummon_toc(Rest, 0, 0, F@_1,
						 TrUserData);
	    1 ->
		skip_64_m_beast_unsummon_toc(Rest, 0, 0, F@_1,
					     TrUserData);
	    2 ->
		skip_length_delimited_m_beast_unsummon_toc(Rest, 0, 0,
							   F@_1, TrUserData);
	    3 ->
		skip_group_m_beast_unsummon_toc(Rest, Key bsr 3, 0,
						F@_1, TrUserData);
	    5 ->
		skip_32_m_beast_unsummon_toc(Rest, 0, 0, F@_1,
					     TrUserData)
	  end
    end;
dg_read_field_def_m_beast_unsummon_toc(<<>>, 0, 0, F@_1,
				       _) ->
    #m_beast_unsummon_toc{id = F@_1}.

d_field_m_beast_unsummon_toc_id(<<1:1, X:7,
				  Rest/binary>>,
				N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_m_beast_unsummon_toc_id(Rest, N + 7,
				    X bsl N + Acc, F@_1, TrUserData);
d_field_m_beast_unsummon_toc_id(<<0:1, X:7,
				  Rest/binary>>,
				N, Acc, _, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    dfp_read_field_def_m_beast_unsummon_toc(RestF, 0, 0,
					    NewFValue, TrUserData).

skip_varint_m_beast_unsummon_toc(<<1:1, _:7,
				   Rest/binary>>,
				 Z1, Z2, F@_1, TrUserData) ->
    skip_varint_m_beast_unsummon_toc(Rest, Z1, Z2, F@_1,
				     TrUserData);
skip_varint_m_beast_unsummon_toc(<<0:1, _:7,
				   Rest/binary>>,
				 Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_beast_unsummon_toc(Rest, Z1, Z2,
					    F@_1, TrUserData).

skip_length_delimited_m_beast_unsummon_toc(<<1:1, X:7,
					     Rest/binary>>,
					   N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_beast_unsummon_toc(Rest, N + 7,
					       X bsl N + Acc, F@_1, TrUserData);
skip_length_delimited_m_beast_unsummon_toc(<<0:1, X:7,
					     Rest/binary>>,
					   N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_beast_unsummon_toc(Rest2, 0, 0,
					    F@_1, TrUserData).

skip_group_m_beast_unsummon_toc(Bin, FNum, Z2, F@_1,
				TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_beast_unsummon_toc(Rest, 0, Z2,
					    F@_1, TrUserData).

skip_32_m_beast_unsummon_toc(<<_:32, Rest/binary>>, Z1,
			     Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_beast_unsummon_toc(Rest, Z1, Z2,
					    F@_1, TrUserData).

skip_64_m_beast_unsummon_toc(<<_:64, Rest/binary>>, Z1,
			     Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_beast_unsummon_toc(Rest, Z1, Z2,
					    F@_1, TrUserData).

decode_msg_m_beast_equip_reinforce_tos(Bin,
				       TrUserData) ->
    dfp_read_field_def_m_beast_equip_reinforce_tos(Bin, 0,
...
dfp_read_field_def_m_beast_equip_reinforce_tos(<<8,
						 Rest/binary>>,
					       Z1, Z2, F@_1, F@_2, F@_3, F@_4,
					       TrUserData) ->
    d_field_m_beast_equip_reinforce_tos_id(Rest, Z1, Z2,
					   F@_1, F@_2, F@_3, F@_4, TrUserData);
dfp_read_field_def_m_beast_equip_reinforce_tos(<<16,
						 Rest/binary>>,
					       Z1, Z2, F@_1, F@_2, F@_3, F@_4,
					       TrUserData) ->
    d_field_m_beast_equip_reinforce_tos_uid(Rest, Z1, Z2,
					    F@_1, F@_2, F@_3, F@_4, TrUserData);
dfp_read_field_def_m_beast_equip_reinforce_tos(<<26,
						 Rest/binary>>,
					       Z1, Z2, F@_1, F@_2, F@_3, F@_4,
					       TrUserData) ->
    d_pfield_m_beast_equip_reinforce_tos_cellids(Rest, Z1,
						 Z2, F@_1, F@_2, F@_3, F@_4,
						 TrUserData);
dfp_read_field_def_m_beast_equip_reinforce_tos(<<24,
						 Rest/binary>>,
					       Z1, Z2, F@_1, F@_2, F@_3, F@_4,
					       TrUserData) ->
    d_field_m_beast_equip_reinforce_tos_cellids(Rest, Z1,
						Z2, F@_1, F@_2, F@_3, F@_4,
						TrUserData);
dfp_read_field_def_m_beast_equip_reinforce_tos(<<32,
						 Rest/binary>>,
					       Z1, Z2, F@_1, F@_2, F@_3, F@_4,
					       TrUserData) ->
    d_field_m_beast_equip_reinforce_tos_use_gold(Rest, Z1,
						 Z2, F@_1, F@_2, F@_3, F@_4,
						 TrUserData);
dfp_read_field_def_m_beast_equip_reinforce_tos(<<>>, 0,
					       0, F@_1, F@_2, R1, F@_4,
					       TrUserData) ->
    #m_beast_equip_reinforce_tos{id = F@_1, uid = F@_2,
				 cellids = lists_reverse(R1, TrUserData),
				 use_gold = F@_4};
dfp_read_field_def_m_beast_equip_reinforce_tos(Other,
					       Z1, Z2, F@_1, F@_2, F@_3, F@_4,
					       TrUserData) ->
    dg_read_field_def_m_beast_equip_reinforce_tos(Other, Z1,
						  Z2, F@_1, F@_2, F@_3, F@_4,
						  TrUserData).

dg_read_field_def_m_beast_equip_reinforce_tos(<<1:1,
						X:7, Rest/binary>>,
					      N, Acc, F@_1, F@_2, F@_3, F@_4,
					      TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_beast_equip_reinforce_tos(Rest,
						  N + 7, X bsl N + Acc, F@_1,
						  F@_2, F@_3, F@_4, TrUserData);
dg_read_field_def_m_beast_equip_reinforce_tos(<<0:1,
						X:7, Rest/binary>>,
					      N, Acc, F@_1, F@_2, F@_3, F@_4,
					      TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_beast_equip_reinforce_tos_id(Rest, 0, 0, F@_1,
						 F@_2, F@_3, F@_4, TrUserData);
      16 ->
	  d_field_m_beast_equip_reinforce_tos_uid(Rest, 0, 0,
						  F@_1, F@_2, F@_3, F@_4,
						  TrUserData);
      26 ->
	  d_pfield_m_beast_equip_reinforce_tos_cellids(Rest, 0, 0,
						       F@_1, F@_2, F@_3, F@_4,
						       TrUserData);
      24 ->
	  d_field_m_beast_equip_reinforce_tos_cellids(Rest, 0, 0,
						      F@_1, F@_2, F@_3, F@_4,
						      TrUserData);
      32 ->
	  d_field_m_beast_equip_reinforce_tos_use_gold(Rest, 0, 0,
						       F@_1, F@_2, F@_3, F@_4,
						       TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_beast_equip_reinforce_tos(Rest, 0, 0,
							F@_1, F@_2, F@_3, F@_4,
							TrUserData);
	    1 ->
		skip_64_m_beast_equip_reinforce_tos(Rest, 0, 0, F@_1,
						    F@_2, F@_3, F@_4,
						    TrUserData);
	    2 ->
		skip_length_delimited_m_beast_equip_reinforce_tos(Rest,
								  0, 0, F@_1,
								  F@_2, F@_3,
								  F@_4,
								  TrUserData);
	    3 ->
		skip_group_m_beast_equip_reinforce_tos(Rest, Key bsr 3,
						       0, F@_1, F@_2, F@_3,
						       F@_4, TrUserData);
	    5 ->
		skip_32_m_beast_equip_reinforce_tos(Rest, 0, 0, F@_1,
						    F@_2, F@_3, F@_4,
						    TrUserData)
	  end
    end;
dg_read_field_def_m_beast_equip_reinforce_tos(<<>>, 0,
					      0, F@_1, F@_2, R1, F@_4,
					      TrUserData) ->
    #m_beast_equip_reinforce_tos{id = F@_1, uid = F@_2,
				 cellids = lists_reverse(R1, TrUserData),
...
d_field_m_beast_equip_reinforce_tos_id(<<1:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, F@_2, F@_3, F@_4,
				       TrUserData)
    when N < 57 ->
    d_field_m_beast_equip_reinforce_tos_id(Rest, N + 7,
					   X bsl N + Acc, F@_1, F@_2, F@_3,
					   F@_4, TrUserData);
d_field_m_beast_equip_reinforce_tos_id(<<0:1, X:7,
					 Rest/binary>>,
    ...
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    dfp_read_field_def_m_beast_equip_reinforce_tos(RestF, 0,
						   0, NewFValue, F@_2, F@_3,
						   F@_4, TrUserData).

d_field_m_beast_equip_reinforce_tos_uid(<<1:1, X:7,
					  Rest/binary>>,
					N, Acc, F@_1, F@_2, F@_3, F@_4,
					TrUserData)
    when N < 57 ->
    d_field_m_beast_equip_reinforce_tos_uid(Rest, N + 7,
					    X bsl N + Acc, F@_1, F@_2, F@_3,
					    F@_4, TrUserData);
d_field_m_beast_equip_reinforce_tos_uid(<<0:1, X:7,
					  Rest/binary>>,
...
d_field_m_beast_equip_reinforce_tos_cellids(<<1:1, X:7,
					      Rest/binary>>,
					    N, Acc, F@_1, F@_2, F@_3, F@_4,
					    TrUserData)
    when N < 57 ->
    d_field_m_beast_equip_reinforce_tos_cellids(Rest, N + 7,
						X bsl N + Acc, F@_1, F@_2, F@_3,
						F@_4, TrUserData);
d_field_m_beast_equip_reinforce_tos_cellids(<<0:1, X:7,
					      Rest/binary>>,
...
d_pfield_m_beast_equip_reinforce_tos_cellids(<<1:1, X:7,
					       Rest/binary>>,
					     N, Acc, F@_1, F@_2, F@_3, F@_4,
					     TrUserData)
    when N < 57 ->
    d_pfield_m_beast_equip_reinforce_tos_cellids(Rest,
						 N + 7, X bsl N + Acc, F@_1,
						 F@_2, F@_3, F@_4, TrUserData);
d_pfield_m_beast_equip_reinforce_tos_cellids(<<0:1, X:7,
					       Rest/binary>>,
    ...
    NewSeq =
	d_packed_field_m_beast_equip_reinforce_tos_cellids(PackedBytes,
							   0, 0, E, TrUserData),
    dfp_read_field_def_m_beast_equip_reinforce_tos(Rest2, 0,
						   0, F@_1, F@_2, NewSeq, F@_4,
						   TrUserData).

d_packed_field_m_beast_equip_reinforce_tos_cellids(<<1:1,
						     X:7, Rest/binary>>,
						   N, Acc, AccSeq, TrUserData)
    when N < 57 ->
    d_packed_field_m_beast_equip_reinforce_tos_cellids(Rest,
						       N + 7, X bsl N + Acc,
						       AccSeq, TrUserData);
d_packed_field_m_beast_equip_reinforce_tos_cellids(<<0:1,
						     X:7, Rest/binary>>,
						   N, Acc, AccSeq,
						   TrUserData) ->
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    d_packed_field_m_beast_equip_reinforce_tos_cellids(RestF,
						       0, 0,
						       [NewFValue | AccSeq],
						       TrUserData);
d_packed_field_m_beast_equip_reinforce_tos_cellids(<<>>,
						   0, 0, AccSeq, _) ->
    AccSeq.

d_field_m_beast_equip_reinforce_tos_use_gold(<<1:1, X:7,
					       Rest/binary>>,
					     N, Acc, F@_1, F@_2, F@_3, F@_4,
					     TrUserData)
    when N < 57 ->
    d_field_m_beast_equip_reinforce_tos_use_gold(Rest,
						 N + 7, X bsl N + Acc, F@_1,
						 F@_2, F@_3, F@_4, TrUserData);
d_field_m_beast_equip_reinforce_tos_use_gold(<<0:1, X:7,
					       Rest/binary>>,
...
skip_varint_m_beast_equip_reinforce_tos(<<1:1, _:7,
					  Rest/binary>>,
					Z1, Z2, F@_1, F@_2, F@_3, F@_4,
					TrUserData) ->
    skip_varint_m_beast_equip_reinforce_tos(Rest, Z1, Z2,
					    F@_1, F@_2, F@_3, F@_4, TrUserData);
skip_varint_m_beast_equip_reinforce_tos(<<0:1, _:7,
					  Rest/binary>>,
					Z1, Z2, F@_1, F@_2, F@_3, F@_4,
					TrUserData) ->
    dfp_read_field_def_m_beast_equip_reinforce_tos(Rest, Z1,
						   Z2, F@_1, F@_2, F@_3, F@_4,
						   TrUserData).

skip_length_delimited_m_beast_equip_reinforce_tos(<<1:1,
						    X:7, Rest/binary>>,
    ...
    skip_length_delimited_m_beast_equip_reinforce_tos(Rest,
						      ...
						      F@_1, F@_2, F@_3, F@_4,
						      TrUserData);
skip_length_delimited_m_beast_equip_reinforce_tos(<<0:1,
						    X:7, Rest/binary>>,
						  N, Acc, F@_1, F@_2, F@_3,
						  F@_4, TrUserData) ->
    Length = X bsl N + Acc,
...
skip_group_m_beast_equip_reinforce_tos(Bin, FNum, Z2,
				       F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_beast_equip_reinforce_tos(Rest, 0,
						   Z2, F@_1, F@_2, F@_3, F@_4,
						   TrUserData).

skip_32_m_beast_equip_reinforce_tos(<<_:32,
				      Rest/binary>>,
				    Z1, Z2, F@_1, F@_2, F@_3, F@_4,
				    TrUserData) ->
    dfp_read_field_def_m_beast_equip_reinforce_tos(Rest, Z1,
...
skip_64_m_beast_equip_reinforce_tos(<<_:64,
				      Rest/binary>>,
				    Z1, Z2, F@_1, F@_2, F@_3, F@_4,
				    TrUserData) ->
    dfp_read_field_def_m_beast_equip_reinforce_tos(Rest, Z1,
...
decode_msg_m_beast_equip_reinforce_toc(Bin,
				       TrUserData) ->
    dfp_read_field_def_m_beast_equip_reinforce_toc(Bin, 0,
						   0, id(undefined, TrUserData),
						   id(undefined, TrUserData),
						   TrUserData).

dfp_read_field_def_m_beast_equip_reinforce_toc(<<8,
						 Rest/binary>>,
					       Z1, Z2, F@_1, F@_2,
					       TrUserData) ->
    d_field_m_beast_equip_reinforce_toc_id(Rest, Z1, Z2,
					   F@_1, F@_2, TrUserData);
dfp_read_field_def_m_beast_equip_reinforce_toc(<<18,
						 Rest/binary>>,
					       Z1, Z2, F@_1, F@_2,
					       TrUserData) ->
    d_field_m_beast_equip_reinforce_toc_equip(Rest, Z1, Z2,
					      F@_1, F@_2, TrUserData);
dfp_read_field_def_m_beast_equip_reinforce_toc(<<>>, 0,
					       0, F@_1, F@_2, _) ->
    #m_beast_equip_reinforce_toc{id = F@_1, equip = F@_2};
dfp_read_field_def_m_beast_equip_reinforce_toc(Other,
					       Z1, Z2, F@_1, F@_2,
					       TrUserData) ->
    dg_read_field_def_m_beast_equip_reinforce_toc(Other, Z1,
						  Z2, F@_1, F@_2, TrUserData).

dg_read_field_def_m_beast_equip_reinforce_toc(<<1:1,
						X:7, Rest/binary>>,
					      N, Acc, F@_1, F@_2, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_beast_equip_reinforce_toc(Rest,
						  N + 7, X bsl N + Acc, F@_1,
						  F@_2, TrUserData);
dg_read_field_def_m_beast_equip_reinforce_toc(<<0:1,
						X:7, Rest/binary>>,
					      N, Acc, F@_1, F@_2, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_beast_equip_reinforce_toc_id(Rest, 0, 0, F@_1,
						 F@_2, TrUserData);
      18 ->
	  d_field_m_beast_equip_reinforce_toc_equip(Rest, 0, 0,
						    F@_1, F@_2, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_beast_equip_reinforce_toc(Rest, 0, 0,
							F@_1, F@_2, TrUserData);
	    1 ->
		skip_64_m_beast_equip_reinforce_toc(Rest, 0, 0, F@_1,
						    F@_2, TrUserData);
	    2 ->
		skip_length_delimited_m_beast_equip_reinforce_toc(Rest,
								  0, 0, F@_1,
								  F@_2,
								  TrUserData);
	    3 ->
		skip_group_m_beast_equip_reinforce_toc(Rest, Key bsr 3,
						       0, F@_1, F@_2,
						       TrUserData);
	    5 ->
		skip_32_m_beast_equip_reinforce_toc(Rest, 0, 0, F@_1,
						    F@_2, TrUserData)
	  end
    end;
dg_read_field_def_m_beast_equip_reinforce_toc(<<>>, 0,
					      0, F@_1, F@_2, _) ->
    #m_beast_equip_reinforce_toc{id = F@_1, equip = F@_2}.

d_field_m_beast_equip_reinforce_toc_id(<<1:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_beast_equip_reinforce_toc_id(Rest, N + 7,
					   X bsl N + Acc, F@_1, F@_2,
					   TrUserData);
d_field_m_beast_equip_reinforce_toc_id(<<0:1, X:7,
					 Rest/binary>>,
				       N, Acc, _, F@_2, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    dfp_read_field_def_m_beast_equip_reinforce_toc(RestF, 0,
						   0, NewFValue, F@_2,
						   TrUserData).

d_field_m_beast_equip_reinforce_toc_equip(<<1:1, X:7,
					    Rest/binary>>,
					  N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_beast_equip_reinforce_toc_equip(Rest, N + 7,
					      X bsl N + Acc, F@_1, F@_2,
					      TrUserData);
d_field_m_beast_equip_reinforce_toc_equip(<<0:1, X:7,
					    Rest/binary>>,
					  N, Acc, F@_1, Prev, TrUserData) ->
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
...
skip_varint_m_beast_equip_reinforce_toc(<<1:1, _:7,
					  Rest/binary>>,
					Z1, Z2, F@_1, F@_2, TrUserData) ->
    skip_varint_m_beast_equip_reinforce_toc(Rest, Z1, Z2,
					    F@_1, F@_2, TrUserData);
skip_varint_m_beast_equip_reinforce_toc(<<0:1, _:7,
					  Rest/binary>>,
					Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_beast_equip_reinforce_toc(Rest, Z1,
						   Z2, F@_1, F@_2, TrUserData).

skip_length_delimited_m_beast_equip_reinforce_toc(<<1:1,
						    X:7, Rest/binary>>,
						  N, Acc, F@_1, F@_2,
						  TrUserData)
    when N < 57 ->
    skip_length_delimited_m_beast_equip_reinforce_toc(Rest,
						      N + 7, X bsl N + Acc,
						      F@_1, F@_2, TrUserData);
skip_length_delimited_m_beast_equip_reinforce_toc(<<0:1,
						    X:7, Rest/binary>>,
						  N, Acc, F@_1, F@_2,
						  TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_beast_equip_reinforce_toc(Rest2, 0,
						   0, F@_1, F@_2, TrUserData).

skip_group_m_beast_equip_reinforce_toc(Bin, FNum, Z2,
				       F@_1, F@_2, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_beast_equip_reinforce_toc(Rest, 0,
						   Z2, F@_1, F@_2, TrUserData).

skip_32_m_beast_equip_reinforce_toc(<<_:32,
				      Rest/binary>>,
				    Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_beast_equip_reinforce_toc(Rest, Z1,
						   Z2, F@_1, F@_2, TrUserData).

skip_64_m_beast_equip_reinforce_toc(<<_:64,
				      Rest/binary>>,
				    Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_beast_equip_reinforce_toc(Rest, Z1,
						   Z2, F@_1, F@_2, TrUserData).

decode_msg_p_beast(Bin, TrUserData) ->
    dfp_read_field_def_p_beast(Bin, 0, 0,
			       id(undefined, TrUserData), id([], TrUserData),
			       id(undefined, TrUserData), TrUserData).

dfp_read_field_def_p_beast(<<8, Rest/binary>>, Z1, Z2,
			   F@_1, F@_2, F@_3, TrUserData) ->
    d_field_p_beast_id(Rest, Z1, Z2, F@_1, F@_2, F@_3,
		       TrUserData);
dfp_read_field_def_p_beast(<<18, Rest/binary>>, Z1, Z2,
			   F@_1, F@_2, F@_3, TrUserData) ->
    d_field_p_beast_equips(Rest, Z1, Z2, F@_1, F@_2, F@_3,
			   TrUserData);
dfp_read_field_def_p_beast(<<24, Rest/binary>>, Z1, Z2,
			   F@_1, F@_2, F@_3, TrUserData) ->
    d_field_p_beast_summon(Rest, Z1, Z2, F@_1, F@_2, F@_3,
			   TrUserData);
dfp_read_field_def_p_beast(<<>>, 0, 0, F@_1, R1, F@_3,
			   TrUserData) ->
    #p_beast{id = F@_1,
	     equips = lists_reverse(R1, TrUserData), summon = F@_3};
dfp_read_field_def_p_beast(Other, Z1, Z2, F@_1, F@_2,
			   F@_3, TrUserData) ->
    dg_read_field_def_p_beast(Other, Z1, Z2, F@_1, F@_2,
			      F@_3, TrUserData).

dg_read_field_def_p_beast(<<1:1, X:7, Rest/binary>>, N,
			  Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_p_beast(Rest, N + 7, X bsl N + Acc,
			      F@_1, F@_2, F@_3, TrUserData);
dg_read_field_def_p_beast(<<0:1, X:7, Rest/binary>>, N,
			  Acc, F@_1, F@_2, F@_3, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_p_beast_id(Rest, 0, 0, F@_1, F@_2, F@_3,
			     TrUserData);
      18 ->
	  d_field_p_beast_equips(Rest, 0, 0, F@_1, F@_2, F@_3,
				 TrUserData);
      24 ->
	  d_field_p_beast_summon(Rest, 0, 0, F@_1, F@_2, F@_3,
				 TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_p_beast(Rest, 0, 0, F@_1, F@_2, F@_3,
				    TrUserData);
	    1 ->
		skip_64_p_beast(Rest, 0, 0, F@_1, F@_2, F@_3,
				TrUserData);
	    2 ->
		skip_length_delimited_p_beast(Rest, 0, 0, F@_1, F@_2,
					      F@_3, TrUserData);
	    3 ->
		skip_group_p_beast(Rest, Key bsr 3, 0, F@_1, F@_2, F@_3,
				   TrUserData);
	    5 ->
		skip_32_p_beast(Rest, 0, 0, F@_1, F@_2, F@_3,
				TrUserData)
	  end
    end;
dg_read_field_def_p_beast(<<>>, 0, 0, F@_1, R1, F@_3,
			  TrUserData) ->
    #p_beast{id = F@_1,
	     equips = lists_reverse(R1, TrUserData), summon = F@_3}.

d_field_p_beast_id(<<1:1, X:7, Rest/binary>>, N, Acc,
		   F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    d_field_p_beast_id(Rest, N + 7, X bsl N + Acc, F@_1,
		       F@_2, F@_3, TrUserData);
d_field_p_beast_id(<<0:1, X:7, Rest/binary>>, N, Acc, _,
		   F@_2, F@_3, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
							    Acc):32/unsigned-native>>,
			  ...
			  Rest},
    dfp_read_field_def_p_beast(RestF, 0, 0, NewFValue, F@_2,
			       F@_3, TrUserData).

d_field_p_beast_equips(<<1:1, X:7, Rest/binary>>, N,
		       Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    d_field_p_beast_equips(Rest, N + 7, X bsl N + Acc, F@_1,
			   F@_2, F@_3, TrUserData);
d_field_p_beast_equips(<<0:1, X:7, Rest/binary>>, N,
    ...
    dfp_read_field_def_p_beast(RestF, 0, 0, F@_1,
			       cons(NewFValue, Prev, TrUserData), F@_3,
			       TrUserData).

d_field_p_beast_summon(<<1:1, X:7, Rest/binary>>, N,
		       Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    d_field_p_beast_summon(Rest, N + 7, X bsl N + Acc, F@_1,
			   F@_2, F@_3, TrUserData);
d_field_p_beast_summon(<<0:1, X:7, Rest/binary>>, N,
		       Acc, F@_1, F@_2, _, TrUserData) ->
    {NewFValue, RestF} = {id(X bsl N + Acc =/= 0,
			     TrUserData),
			  Rest},
    dfp_read_field_def_p_beast(RestF, 0, 0, F@_1, F@_2,
			       NewFValue, TrUserData).

skip_varint_p_beast(<<1:1, _:7, Rest/binary>>, Z1, Z2,
		    F@_1, F@_2, F@_3, TrUserData) ->
    skip_varint_p_beast(Rest, Z1, Z2, F@_1, F@_2, F@_3,
			TrUserData);
skip_varint_p_beast(<<0:1, _:7, Rest/binary>>, Z1, Z2,
		    F@_1, F@_2, F@_3, TrUserData) ->
    dfp_read_field_def_p_beast(Rest, Z1, Z2, F@_1, F@_2,
			       F@_3, TrUserData).

skip_length_delimited_p_beast(<<1:1, X:7, Rest/binary>>,
			      N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    skip_length_delimited_p_beast(Rest, N + 7,
				  X bsl N + Acc, F@_1, F@_2, F@_3, TrUserData);
skip_length_delimited_p_beast(<<0:1, X:7, Rest/binary>>,
			      N, Acc, F@_1, F@_2, F@_3, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_p_beast(Rest2, 0, 0, F@_1, F@_2,
			       F@_3, TrUserData).

skip_group_p_beast(Bin, FNum, Z2, F@_1, F@_2, F@_3,
		   TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_p_beast(Rest, 0, Z2, F@_1, F@_2,
			       F@_3, TrUserData).

skip_32_p_beast(<<_:32, Rest/binary>>, Z1, Z2, F@_1,
		F@_2, F@_3, TrUserData) ->
    dfp_read_field_def_p_beast(Rest, Z1, Z2, F@_1, F@_2,
			       F@_3, TrUserData).

skip_64_p_beast(<<_:64, Rest/binary>>, Z1, Z2, F@_1,
		F@_2, F@_3, TrUserData) ->
    dfp_read_field_def_p_beast(Rest, Z1, Z2, F@_1, F@_2,
			       F@_3, TrUserData).
...
merge_msgs(Prev, New, MsgName, Opts) ->
    ...
    case MsgName of
      m_beast_list_tos ->
	  merge_msg_m_beast_list_tos(Prev, New, TrUserData);
      m_beast_list_toc ->
	  merge_msg_m_beast_list_toc(Prev, New, TrUserData);
      m_beast_addsummon_tos ->
	  merge_msg_m_beast_addsummon_tos(Prev, New, TrUserData);
      m_beast_addsummon_toc ->
	  merge_msg_m_beast_addsummon_toc(Prev, New, TrUserData);
      m_beast_equip_load_tos ->
	  merge_msg_m_beast_equip_load_tos(Prev, New, TrUserData);
      m_beast_equip_load_toc ->
	  merge_msg_m_beast_equip_load_toc(Prev, New, TrUserData);
      m_beast_equip_unload_tos ->
	  merge_msg_m_beast_equip_unload_tos(Prev, New,
					     TrUserData);
      m_beast_equip_unload_toc ->
	  merge_msg_m_beast_equip_unload_toc(Prev, New,
					     TrUserData);
      m_beast_summon_tos ->
	  merge_msg_m_beast_summon_tos(Prev, New, TrUserData);
      m_beast_summon_toc ->
	  merge_msg_m_beast_summon_toc(Prev, New, TrUserData);
      m_beast_unsummon_tos ->
	  merge_msg_m_beast_unsummon_tos(Prev, New, TrUserData);
      m_beast_unsummon_toc ->
	  merge_msg_m_beast_unsummon_toc(Prev, New, TrUserData);
      m_beast_equip_reinforce_tos ->
	  merge_msg_m_beast_equip_reinforce_tos(Prev, New,
						TrUserData);
      m_beast_equip_reinforce_toc ->
	  merge_msg_m_beast_equip_reinforce_toc(Prev, New,
						TrUserData);
      p_beast -> merge_msg_p_beast(Prev, New, TrUserData);
      p_role_base ->
...
-compile({nowarn_unused_function,merge_msg_m_beast_list_tos/3}).
merge_msg_m_beast_list_tos(_Prev, New, _TrUserData) ->
    New.

-compile({nowarn_unused_function,merge_msg_m_beast_list_toc/3}).
merge_msg_m_beast_list_toc(#m_beast_list_toc{list =
						 PFlist},
			   #m_beast_list_toc{max_summon = NFmax_summon,
					     list = NFlist},
			   TrUserData) ->
    #m_beast_list_toc{max_summon = NFmax_summon,
		      list =
...
-compile({nowarn_unused_function,merge_msg_m_beast_addsummon_tos/3}).
merge_msg_m_beast_addsummon_tos(_Prev, New,
				_TrUserData) ->
    New.

-compile({nowarn_unused_function,merge_msg_m_beast_addsummon_toc/3}).
merge_msg_m_beast_addsummon_toc(#m_beast_addsummon_toc{},
				#m_beast_addsummon_toc{max_summon =
							   NFmax_summon},
				_) ->
    #m_beast_addsummon_toc{max_summon = NFmax_summon}.

-compile({nowarn_unused_function,merge_msg_m_beast_equip_load_tos/3}).
merge_msg_m_beast_equip_load_tos(#m_beast_equip_load_tos{},
				 #m_beast_equip_load_tos{id = NFid,
							 uid = NFuid},
				 _) ->
    #m_beast_equip_load_tos{id = NFid, uid = NFuid}.

-compile({nowarn_unused_function,merge_msg_m_beast_equip_load_toc/3}).
merge_msg_m_beast_equip_load_toc(#m_beast_equip_load_toc{equip
							     = PFequip},
				 #m_beast_equip_load_toc{id = NFid,
							 equip = NFequip},
				 TrUserData) ->
    #m_beast_equip_load_toc{id = NFid,
			    equip =
...
-compile({nowarn_unused_function,merge_msg_m_beast_equip_unload_tos/3}).
merge_msg_m_beast_equip_unload_tos(#m_beast_equip_unload_tos{},
				   #m_beast_equip_unload_tos{id = NFid,
							     slot = NFslot},
				   _) ->
    #m_beast_equip_unload_tos{id = NFid, slot = NFslot}.

-compile({nowarn_unused_function,merge_msg_m_beast_equip_unload_toc/3}).
merge_msg_m_beast_equip_unload_toc(#m_beast_equip_unload_toc{},
				   #m_beast_equip_unload_toc{id = NFid,
							     slot = NFslot},
				   _) ->
    #m_beast_equip_unload_toc{id = NFid, slot = NFslot}.

-compile({nowarn_unused_function,merge_msg_m_beast_summon_tos/3}).
merge_msg_m_beast_summon_tos(#m_beast_summon_tos{},
			     #m_beast_summon_tos{id = NFid}, _) ->
    #m_beast_summon_tos{id = NFid}.

-compile({nowarn_unused_function,merge_msg_m_beast_summon_toc/3}).
merge_msg_m_beast_summon_toc(#m_beast_summon_toc{},
			     #m_beast_summon_toc{id = NFid}, _) ->
    #m_beast_summon_toc{id = NFid}.

-compile({nowarn_unused_function,merge_msg_m_beast_unsummon_tos/3}).
merge_msg_m_beast_unsummon_tos(#m_beast_unsummon_tos{},
			       #m_beast_unsummon_tos{id = NFid}, _) ->
    #m_beast_unsummon_tos{id = NFid}.

-compile({nowarn_unused_function,merge_msg_m_beast_unsummon_toc/3}).
merge_msg_m_beast_unsummon_toc(#m_beast_unsummon_toc{},
			       #m_beast_unsummon_toc{id = NFid}, _) ->
    #m_beast_unsummon_toc{id = NFid}.

-compile({nowarn_unused_function,merge_msg_m_beast_equip_reinforce_tos/3}).
merge_msg_m_beast_equip_reinforce_tos(#m_beast_equip_reinforce_tos{cellids
								       =
								       PFcellids},
				      #m_beast_equip_reinforce_tos{id = NFid,
								   uid = NFuid,
								   cellids =
								       NFcellids,
								   use_gold =
								       NFuse_gold},
				      TrUserData) ->
    #m_beast_equip_reinforce_tos{id = NFid, uid = NFuid,
				 cellids =
...
-compile({nowarn_unused_function,merge_msg_m_beast_equip_reinforce_toc/3}).
merge_msg_m_beast_equip_reinforce_toc(#m_beast_equip_reinforce_toc{equip
								       =
								       PFequip},
				      #m_beast_equip_reinforce_toc{id = NFid,
								   equip =
								       NFequip},
				      TrUserData) ->
    #m_beast_equip_reinforce_toc{id = NFid,
...
-compile({nowarn_unused_function,merge_msg_p_beast/3}).
merge_msg_p_beast(#p_beast{equips = PFequips},
		  #p_beast{id = NFid, equips = NFequips,
			   summon = NFsummon},
		  TrUserData) ->
    #p_beast{id = NFid,
	     equips =
...
verify_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
      m_beast_list_tos ->
	  v_msg_m_beast_list_tos(Msg, [MsgName], TrUserData);
      m_beast_list_toc ->
	  v_msg_m_beast_list_toc(Msg, [MsgName], TrUserData);
      m_beast_addsummon_tos ->
	  v_msg_m_beast_addsummon_tos(Msg, [MsgName], TrUserData);
      m_beast_addsummon_toc ->
	  v_msg_m_beast_addsummon_toc(Msg, [MsgName], TrUserData);
      m_beast_equip_load_tos ->
	  v_msg_m_beast_equip_load_tos(Msg, [MsgName],
				       TrUserData);
      m_beast_equip_load_toc ->
	  v_msg_m_beast_equip_load_toc(Msg, [MsgName],
				       TrUserData);
      m_beast_equip_unload_tos ->
	  v_msg_m_beast_equip_unload_tos(Msg, [MsgName],
					 TrUserData);
      m_beast_equip_unload_toc ->
	  v_msg_m_beast_equip_unload_toc(Msg, [MsgName],
					 TrUserData);
      m_beast_summon_tos ->
	  v_msg_m_beast_summon_tos(Msg, [MsgName], TrUserData);
      m_beast_summon_toc ->
	  v_msg_m_beast_summon_toc(Msg, [MsgName], TrUserData);
      m_beast_unsummon_tos ->
	  v_msg_m_beast_unsummon_tos(Msg, [MsgName], TrUserData);
      m_beast_unsummon_toc ->
	  v_msg_m_beast_unsummon_toc(Msg, [MsgName], TrUserData);
      m_beast_equip_reinforce_tos ->
	  v_msg_m_beast_equip_reinforce_tos(Msg, [MsgName],
					    TrUserData);
      m_beast_equip_reinforce_toc ->
	  v_msg_m_beast_equip_reinforce_toc(Msg, [MsgName],
					    TrUserData);
      p_beast -> v_msg_p_beast(Msg, [MsgName], TrUserData);
      p_role_base ->
...
-compile({nowarn_unused_function,v_msg_m_beast_list_tos/3}).
-dialyzer({nowarn_function,v_msg_m_beast_list_tos/3}).
v_msg_m_beast_list_tos(#m_beast_list_tos{}, _Path, _) ->
    ok;
v_msg_m_beast_list_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_beast_list_tos}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_beast_list_toc/3}).
-dialyzer({nowarn_function,v_msg_m_beast_list_toc/3}).
v_msg_m_beast_list_toc(#m_beast_list_toc{max_summon =
					     F1,
					 list = F2},
		       Path, TrUserData) ->
    v_type_int32(F1, [max_summon | Path], TrUserData),
    if is_list(F2) ->
	   _ = [v_msg_p_beast(Elem, [list | Path], TrUserData)
		|| Elem <- F2],
	   ok;
       true ->
	   mk_type_error({invalid_list_of, {msg, p_beast}}, F2,
			 [list | Path])
    end,
    ok;
v_msg_m_beast_list_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_beast_list_toc}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_beast_addsummon_tos/3}).
-dialyzer({nowarn_function,v_msg_m_beast_addsummon_tos/3}).
v_msg_m_beast_addsummon_tos(#m_beast_addsummon_tos{},
			    _Path, _) ->
    ok;
v_msg_m_beast_addsummon_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_beast_addsummon_tos}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_beast_addsummon_toc/3}).
-dialyzer({nowarn_function,v_msg_m_beast_addsummon_toc/3}).
v_msg_m_beast_addsummon_toc(#m_beast_addsummon_toc{max_summon
						       = F1},
			    Path, TrUserData) ->
    v_type_int32(F1, [max_summon | Path], TrUserData), ok;
v_msg_m_beast_addsummon_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_beast_addsummon_toc}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_beast_equip_load_tos/3}).
-dialyzer({nowarn_function,v_msg_m_beast_equip_load_tos/3}).
v_msg_m_beast_equip_load_tos(#m_beast_equip_load_tos{id
							 = F1,
						     uid = F2},
			     Path, TrUserData) ->
    ...
    ok;
v_msg_m_beast_equip_load_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_beast_equip_load_tos}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_beast_equip_load_toc/3}).
-dialyzer({nowarn_function,v_msg_m_beast_equip_load_toc/3}).
v_msg_m_beast_equip_load_toc(#m_beast_equip_load_toc{id
							 = F1,
						     equip = F2},
			     Path, TrUserData) ->
    v_type_int32(F1, [id | Path], TrUserData),
    ...
    ok;
v_msg_m_beast_equip_load_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_beast_equip_load_toc}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_beast_equip_unload_tos/3}).
-dialyzer({nowarn_function,v_msg_m_beast_equip_unload_tos/3}).
v_msg_m_beast_equip_unload_tos(#m_beast_equip_unload_tos{id
							     = F1,
							 slot = F2},
			       Path, TrUserData) ->
    v_type_int32(F1, [id | Path], TrUserData),
    ...
    ok;
v_msg_m_beast_equip_unload_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_beast_equip_unload_tos},
		  X, Path).

-compile({nowarn_unused_function,v_msg_m_beast_equip_unload_toc/3}).
-dialyzer({nowarn_function,v_msg_m_beast_equip_unload_toc/3}).
v_msg_m_beast_equip_unload_toc(#m_beast_equip_unload_toc{id
							     = F1,
							 slot = F2},
			       Path, TrUserData) ->
    v_type_int32(F1, [id | Path], TrUserData),
    v_type_int32(F2, [slot | Path], TrUserData),
    ok;
v_msg_m_beast_equip_unload_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_beast_equip_unload_toc},
		  X, Path).

-compile({nowarn_unused_function,v_msg_m_beast_summon_tos/3}).
-dialyzer({nowarn_function,v_msg_m_beast_summon_tos/3}).
v_msg_m_beast_summon_tos(#m_beast_summon_tos{id = F1},
			 Path, TrUserData) ->
    v_type_int32(F1, [id | Path], TrUserData), ok;
v_msg_m_beast_summon_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_beast_summon_tos}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_beast_summon_toc/3}).
-dialyzer({nowarn_function,v_msg_m_beast_summon_toc/3}).
v_msg_m_beast_summon_toc(#m_beast_summon_toc{id = F1},
			 Path, TrUserData) ->
    v_type_int32(F1, [id | Path], TrUserData), ok;
v_msg_m_beast_summon_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_beast_summon_toc}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_beast_unsummon_tos/3}).
-dialyzer({nowarn_function,v_msg_m_beast_unsummon_tos/3}).
v_msg_m_beast_unsummon_tos(#m_beast_unsummon_tos{id =
						     F1},
			   Path, TrUserData) ->
    v_type_int32(F1, [id | Path], TrUserData), ok;
v_msg_m_beast_unsummon_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_beast_unsummon_tos}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_beast_unsummon_toc/3}).
-dialyzer({nowarn_function,v_msg_m_beast_unsummon_toc/3}).
v_msg_m_beast_unsummon_toc(#m_beast_unsummon_toc{id =
						     F1},
			   Path, TrUserData) ->
    v_type_int32(F1, [id | Path], TrUserData), ok;
v_msg_m_beast_unsummon_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_beast_unsummon_toc}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_beast_equip_reinforce_tos/3}).
-dialyzer({nowarn_function,v_msg_m_beast_equip_reinforce_tos/3}).
v_msg_m_beast_equip_reinforce_tos(#m_beast_equip_reinforce_tos{id
								   = F1,
							       uid = F2,
							       cellids = F3,
							       use_gold = F4},
    ...
    ok;
v_msg_m_beast_equip_reinforce_tos(X, Path,
				  _TrUserData) ->
    mk_type_error({expected_msg,
		   m_beast_equip_reinforce_tos},
		  X, Path).

-compile({nowarn_unused_function,v_msg_m_beast_equip_reinforce_toc/3}).
-dialyzer({nowarn_function,v_msg_m_beast_equip_reinforce_toc/3}).
v_msg_m_beast_equip_reinforce_toc(#m_beast_equip_reinforce_toc{id
								   = F1,
							       equip = F2},
				  Path, TrUserData) ->
    v_type_int32(F1, [id | Path], TrUserData),
    v_msg_p_item(F2, [equip | Path], TrUserData),
    ok;
v_msg_m_beast_equip_reinforce_toc(X, Path,
				  _TrUserData) ->
    mk_type_error({expected_msg,
		   m_beast_equip_reinforce_toc},
		  X, Path).

-compile({nowarn_unused_function,v_msg_p_beast/3}).
-dialyzer({nowarn_function,v_msg_p_beast/3}).
v_msg_p_beast(#p_beast{id = F1, equips = F2,
		       summon = F3},
	      Path, TrUserData) ->
    v_type_int32(F1, [id | Path], TrUserData),
    if is_list(F2) ->
    ...
    ok;
v_msg_p_beast(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, p_beast}, X, Path).
...
get_msg_defs() ->
    [{{msg, m_beast_list_tos}, []},
     {{msg, m_beast_list_toc},
      [#field{name = max_summon, fnum = 1, rnum = 2,
	      type = int32, occurrence = required, opts = []},
       #field{name = list, fnum = 2, rnum = 3,
	      type = {msg, p_beast}, occurrence = repeated,
	      opts = []}]},
     {{msg, m_beast_addsummon_tos}, []},
     {{msg, m_beast_addsummon_toc},
      [#field{name = max_summon, fnum = 1, rnum = 2,
	      type = int32, occurrence = required, opts = []}]},
     {{msg, m_beast_equip_load_tos},
      [#field{name = id, fnum = 1, rnum = 2, type = int32,
	      occurrence = required, opts = []},
       #field{name = uid, fnum = 2, rnum = 3, type = int32,
	      occurrence = required, opts = []}]},
     {{msg, m_beast_equip_load_toc},
      [#field{name = id, fnum = 1, rnum = 2, type = int32,
	      occurrence = required, opts = []},
       #field{name = equip, fnum = 2, rnum = 3,
	      type = {msg, p_item}, occurrence = required,
	      opts = []}]},
     {{msg, m_beast_equip_unload_tos},
      [#field{name = id, fnum = 1, rnum = 2, type = int32,
	      occurrence = required, opts = []},
       #field{name = slot, fnum = 2, rnum = 3, type = int32,
	      occurrence = required, opts = []}]},
     {{msg, m_beast_equip_unload_toc},
      [#field{name = id, fnum = 1, rnum = 2, type = int32,
	      occurrence = required, opts = []},
       #field{name = slot, fnum = 2, rnum = 3, type = int32,
	      occurrence = required, opts = []}]},
     {{msg, m_beast_summon_tos},
      [#field{name = id, fnum = 1, rnum = 2, type = int32,
	      occurrence = required, opts = []}]},
     {{msg, m_beast_summon_toc},
      [#field{name = id, fnum = 1, rnum = 2, type = int32,
	      occurrence = required, opts = []}]},
     {{msg, m_beast_unsummon_tos},
      [#field{name = id, fnum = 1, rnum = 2, type = int32,
	      occurrence = required, opts = []}]},
     {{msg, m_beast_unsummon_toc},
      [#field{name = id, fnum = 1, rnum = 2, type = int32,
	      occurrence = required, opts = []}]},
     {{msg, m_beast_equip_reinforce_tos},
      [#field{name = id, fnum = 1, rnum = 2, type = int32,
	      occurrence = required, opts = []},
       #field{name = uid, fnum = 2, rnum = 3, type = int32,
	      occurrence = required, opts = []},
       ...
       #field{name = use_gold, fnum = 4, rnum = 5, type = bool,
	      occurrence = required, opts = []}]},
     {{msg, m_beast_equip_reinforce_toc},
      [#field{name = id, fnum = 1, rnum = 2, type = int32,
	      occurrence = required, opts = []},
       #field{name = equip, fnum = 2, rnum = 3,
	      type = {msg, p_item}, occurrence = required,
...
get_msg_names() ->
    [m_beast_list_tos, m_beast_list_toc,
     m_beast_addsummon_tos, m_beast_addsummon_toc,
     m_beast_equip_load_tos, m_beast_equip_load_toc,
     m_beast_equip_unload_tos, m_beast_equip_unload_toc,
     m_beast_summon_tos, m_beast_summon_toc,
     m_beast_unsummon_tos, m_beast_unsummon_toc,
     m_beast_equip_reinforce_tos,
     m_beast_equip_reinforce_toc, p_beast, p_role_base,
...
find_msg_def(m_beast_list_tos) -> [];
find_msg_def(m_beast_list_toc) ->
    [#field{name = max_summon, fnum = 1, rnum = 2,
	    type = int32, occurrence = required, opts = []},
     #field{name = list, fnum = 2, rnum = 3,
	    type = {msg, p_beast}, occurrence = repeated,
	    opts = []}];
find_msg_def(m_beast_addsummon_tos) -> [];
find_msg_def(m_beast_addsummon_toc) ->
    [#field{name = max_summon, fnum = 1, rnum = 2,
	    type = int32, occurrence = required, opts = []}];
find_msg_def(m_beast_equip_load_tos) ->
    [#field{name = id, fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []},
     #field{name = uid, fnum = 2, rnum = 3, type = int32,
	    occurrence = required, opts = []}];
find_msg_def(m_beast_equip_load_toc) ->
    [#field{name = id, fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []},
     #field{name = equip, fnum = 2, rnum = 3,
	    type = {msg, p_item}, occurrence = required,
	    opts = []}];
find_msg_def(m_beast_equip_unload_tos) ->
    [#field{name = id, fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []},
     #field{name = slot, fnum = 2, rnum = 3, type = int32,
	    occurrence = required, opts = []}];
find_msg_def(m_beast_equip_unload_toc) ->
    [#field{name = id, fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []},
     #field{name = slot, fnum = 2, rnum = 3, type = int32,
	    occurrence = required, opts = []}];
find_msg_def(m_beast_summon_tos) ->
    [#field{name = id, fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []}];
find_msg_def(m_beast_summon_toc) ->
    [#field{name = id, fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []}];
find_msg_def(m_beast_unsummon_tos) ->
    [#field{name = id, fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []}];
find_msg_def(m_beast_unsummon_toc) ->
    [#field{name = id, fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []}];
find_msg_def(m_beast_equip_reinforce_tos) ->
    [#field{name = id, fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []},
     #field{name = uid, fnum = 2, rnum = 3, type = int32,
	    occurrence = required, opts = []},
     ...
     #field{name = use_gold, fnum = 4, rnum = 5, type = bool,
	    occurrence = required, opts = []}];
find_msg_def(m_beast_equip_reinforce_toc) ->
    [#field{name = id, fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []},
     #field{name = equip, fnum = 2, rnum = 3,
	    type = {msg, p_item}, occurrence = required,
	    opts = []}];
find_msg_def(p_beast) ->
    [#field{name = id, fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []},
     #field{name = equips, fnum = 2, rnum = 3,
	    type = {msg, p_item}, occurrence = repeated, opts = []},
