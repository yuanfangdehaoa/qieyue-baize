...
-ifndef(pb_1609_siegewar).
-define(pb_1609_siegewar, true).

-define(pb_1609_siegewar_gpb_version, "4.5.1").

-ifndef('M_SIEGEWAR_CITY_TOS_PB_H').
-define('M_SIEGEWAR_CITY_TOS_PB_H', true).
-record(m_siegewar_city_tos,
        {
        }).
-endif.

-ifndef('M_SIEGEWAR_CITY_TOC_PB_H').
-define('M_SIEGEWAR_CITY_TOC_PB_H', true).
-record(m_siegewar_city_toc,
        {cities = []            :: [pb_1609_siegewar:p_siegewar_city()] | undefined, % = 1
         medal                  :: integer(),       % = 2, 32 bits
         fetch = []             :: [integer()] | undefined, % = 3, 32 bits
         rule                   :: integer(),       % = 4, 32 bits
         link = []              :: [integer()] | undefined % = 5, 32 bits
        }).
-endif.

-ifndef('M_SIEGEWAR_BOSS_TOS_PB_H').
-define('M_SIEGEWAR_BOSS_TOS_PB_H', true).
-record(m_siegewar_boss_tos,
        {scene                  :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_SIEGEWAR_BOSS_TOC_PB_H').
-define('M_SIEGEWAR_BOSS_TOC_PB_H', true).
-record(m_siegewar_boss_toc,
        {scene                  :: integer(),       % = 1, 32 bits
         bosses = []            :: [pb_1609_siegewar:p_siegewar_boss()] | undefined, % = 2
         suid                   :: integer(),       % = 3, 32 bits
         score = []             :: [pb_1609_siegewar:p_siegewar_score()] | undefined, % = 4
         name                   :: iolist() | undefined % = 5
        }).
-endif.

-ifndef('M_SIEGEWAR_DAMAGE_TOS_PB_H').
-define('M_SIEGEWAR_DAMAGE_TOS_PB_H', true).
-record(m_siegewar_damage_tos,
        {boss                   :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_SIEGEWAR_DAMAGE_TOC_PB_H').
-define('M_SIEGEWAR_DAMAGE_TOC_PB_H', true).
-record(m_siegewar_damage_toc,
        {boss                   :: integer(),       % = 1, 32 bits
         ranking = []           :: [pb_1609_siegewar:p_siegewar_damage()] | undefined % = 2
        }).
-endif.

-ifndef('M_SIEGEWAR_DROPPED_TOS_PB_H').
-define('M_SIEGEWAR_DROPPED_TOS_PB_H', true).
-record(m_siegewar_dropped_tos,
        {
        }).
-endif.

-ifndef('M_SIEGEWAR_DROPPED_TOC_PB_H').
-define('M_SIEGEWAR_DROPPED_TOC_PB_H', true).
-record(m_siegewar_dropped_toc,
        {logs = []              :: [pb_1609_siegewar:p_dropped()] | undefined % = 1
        }).
-endif.

-ifndef('M_SIEGEWAR_MEDAL_FETCH_TOS_PB_H').
-define('M_SIEGEWAR_MEDAL_FETCH_TOS_PB_H', true).
-record(m_siegewar_medal_fetch_tos,
        {medal                  :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_SIEGEWAR_MEDAL_FETCH_TOC_PB_H').
-define('M_SIEGEWAR_MEDAL_FETCH_TOC_PB_H', true).
-record(m_siegewar_medal_fetch_toc,
        {medal                  :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_SIEGEWAR_MEDAL_BUY_TOS_PB_H').
-define('M_SIEGEWAR_MEDAL_BUY_TOS_PB_H', true).
-record(m_siegewar_medal_buy_tos,
        {
        }).
-endif.

-ifndef('M_SIEGEWAR_MEDAL_BUY_TOC_PB_H').
-define('M_SIEGEWAR_MEDAL_BUY_TOC_PB_H', true).
-record(m_siegewar_medal_buy_toc,
        {
        }).
-endif.

-ifndef('M_SIEGEWAR_BOSS_UPDATE_TOC_PB_H').
-define('M_SIEGEWAR_BOSS_UPDATE_TOC_PB_H', true).
-record(m_siegewar_boss_update_toc,
...
-ifndef('M_SIEGEWAR_BOXINFO_TOS_PB_H').
-define('M_SIEGEWAR_BOXINFO_TOS_PB_H', true).
-record(m_siegewar_boxinfo_tos,
        {box_uid                :: non_neg_integer() % = 1, 32 bits
        }).
-endif.

-ifndef('M_SIEGEWAR_BOXINFO_TOC_PB_H').
-define('M_SIEGEWAR_BOXINFO_TOC_PB_H', true).
-record(m_siegewar_boxinfo_toc,
        {box_uid                :: non_neg_integer(), % = 1, 32 bits
         summoner = []          :: [iolist()] | undefined, % = 2
         suids = []             :: [integer()] | undefined, % = 3, 32 bits
         can_open               :: boolean() | 0 | 1, % = 4
         remain                 :: integer(),       % = 5, 32 bits
         boss_id                :: integer()        % = 6, 32 bits
        }).
-endif.

-ifndef('M_SIEGEWAR_BOXOPEN_TOS_PB_H').
-define('M_SIEGEWAR_BOXOPEN_TOS_PB_H', true).
-record(m_siegewar_boxopen_tos,
...
-ifndef('M_SIEGEWAR_BOXOPEN_TOC_PB_H').
-define('M_SIEGEWAR_BOXOPEN_TOC_PB_H', true).
-record(m_siegewar_boxopen_toc,
        {type                   :: integer(),       % = 1, 32 bits
         reward = #{}           :: #{integer() := integer()} | undefined % = 2
        }).
-endif.

-ifndef('P_SIEGEWAR_CITY_PB_H').
-define('P_SIEGEWAR_CITY_PB_H', true).
-record(p_siegewar_city,
        {scene                  :: integer(),       % = 1, 32 bits
         suid                   :: integer(),       % = 2, 32 bits
         boss                   :: integer(),       % = 3, 32 bits
         score                  :: integer(),       % = 4, 32 bits
         level                  :: integer(),       % = 5, 32 bits
         temp                   :: boolean() | 0 | 1, % = 6
         name                   :: iolist() | undefined % = 7
        }).
-endif.

-ifndef('P_SIEGEWAR_BOSS_PB_H').
-define('P_SIEGEWAR_BOSS_PB_H', true).
-record(p_siegewar_boss,
        {id                     :: integer(),       % = 1, 32 bits
         born                   :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('P_SIEGEWAR_DAMAGE_PB_H').
-define('P_SIEGEWAR_DAMAGE_PB_H', true).
-record(p_siegewar_damage,
        {id                     :: integer(),       % = 1, 32 bits
...
-ifndef('P_SIEGEWAR_SCORE_PB_H').
-define('P_SIEGEWAR_SCORE_PB_H', true).
-record(p_siegewar_score,
        {id                     :: integer(),       % = 1, 32 bits
         name                   :: iolist(),        % = 2
...
-record(p_role_base,
        {id                     :: non_neg_integer(), % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1609_siegewar:p_aspect()} | undefined, % = 8
         ...
         icon                   :: pb_1609_siegewar:p_icon() | undefined, % = 17
...
-record(p_item,
        {uid                    :: integer(),       % = 1, 32 bits
         ...
         gender                 :: integer(),       % = 7, 32 bits
         score                  :: integer() | undefined, % = 8, 32 bits
         equip                  :: pb_1609_siegewar:p_equip() | undefined, % = 9
         pet                    :: pb_1609_siegewar:p_pet() | undefined, % = 10
...
-record(p_equip,
        {base                   :: pb_1609_siegewar:p_attr(), % = 1
         rare1                  :: pb_1609_siegewar:p_attr() | undefined, % = 2
         rare2                  :: pb_1609_siegewar:p_attr() | undefined, % = 3
         rare3                  :: pb_1609_siegewar:p_attr() | undefined, % = 4
         marriage               :: pb_1609_siegewar:p_marriage() | undefined, % = 5
         ...
         refine = []            :: [pb_1609_siegewar:p_refine()] | undefined, % = 11
         suite = #{}            :: #{integer() := integer()} | undefined, % = 12
         combine = []           :: [pb_1609_siegewar:p_item()] | undefined % = 13
        }).
-endif.
...
-record(p_marriage,
        {husband_id             :: non_neg_integer() | undefined, % = 1, 32 bits
         ...
         rare                   :: pb_1609_siegewar:p_attr() | undefined % = 5
        }).
-endif.
...
-record(p_actor,
        {uid                    :: non_neg_integer(), % = 1, 32 bits
         ...
         coord                  :: pb_1609_siegewar:p_coord(), % = 4
         state                  :: integer(),       % = 5, 32 bits
         stargs = #{}           :: #{integer() := iolist()} | undefined, % = 6
         role                   :: pb_1609_siegewar:p_role() | undefined, % = 7
         creep                  :: pb_1609_siegewar:p_creep() | undefined, % = 8
         drop                   :: pb_1609_siegewar:p_drop() | undefined % = 9
        }).
-endif.
...
-record(p_role,
        {career                 :: integer(),       % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1609_siegewar:p_aspect()} | undefined, % = 5
         ...
         icon                   :: pb_1609_siegewar:p_icon() | undefined % = 25
        }).
-endif.
...
-record(p_creep,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         buffs = []             :: [pb_1609_siegewar:p_buff()] | undefined, % = 6
         dir                    :: integer(),       % = 7, 32 bits
         dest                   :: pb_1609_siegewar:p_coord(), % = 8
...
-record(p_npc,
        {id                     :: integer(),       % = 1, 32 bits
         coord                  :: pb_1609_siegewar:p_coord() % = 2
        }).
-endif.
...
-record(p_drop,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         coord                  :: pb_1609_siegewar:p_coord() | undefined, % = 5
...
-record(p_ranking,
        {base                   :: pb_1609_siegewar:p_role_base() | undefined, % = 1
