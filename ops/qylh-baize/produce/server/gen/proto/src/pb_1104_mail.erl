...
%% message types
-type m_mail_info_tos() :: #m_mail_info_tos{}.

-type m_mail_info_toc() :: #m_mail_info_toc{}.

-type m_mail_list_tos() :: #m_mail_list_tos{}.

-type m_mail_list_toc() :: #m_mail_list_toc{}.

-type m_mail_recv_toc() :: #m_mail_recv_toc{}.

-type m_mail_read_tos() :: #m_mail_read_tos{}.

-type m_mail_read_toc() :: #m_mail_read_toc{}.

-type m_mail_fetch_tos() :: #m_mail_fetch_tos{}.

-type m_mail_fetch_toc() :: #m_mail_fetch_toc{}.

-type m_mail_delete_tos() :: #m_mail_delete_tos{}.

-type m_mail_delete_toc() :: #m_mail_delete_toc{}.
...
-export_type(['m_mail_info_tos'/0, 'm_mail_info_toc'/0, 'm_mail_list_tos'/0, 'm_mail_list_toc'/0, 'm_mail_recv_toc'/0, 'm_mail_read_tos'/0, 'm_mail_read_toc'/0, 'm_mail_fetch_tos'/0, 'm_mail_fetch_toc'/0, 'm_mail_delete_tos'/0, 'm_mail_delete_toc'/0, 'p_mail'/0, 'p_role_base'/0, 'p_aspect'/0, 'p_attr'/0, 'p_item_base'/0, 'p_item'/0, 'p_equip'/0, 'p_pet'/0, 'p_marriage'/0, 'p_refine'/0, 'p_actor'/0, 'p_role'/0, 'p_creep'/0, 'p_npc'/0, 'p_drop'/0, 'p_buff'/0, 'p_coord'/0, 'p_icon'/0, 'p_ranking'/0, 'p_dropped'/0]).

-spec encode_msg(#m_mail_info_tos{} | #m_mail_info_toc{} | #m_mail_list_tos{} | #m_mail_list_toc{} | #m_mail_recv_toc{} | #m_mail_read_tos{} | #m_mail_read_toc{} | #m_mail_fetch_tos{} | #m_mail_fetch_toc{} | #m_mail_delete_tos{} | #m_mail_delete_toc{} | #p_mail{} | #p_role_base{} | #p_aspect{} | #p_attr{} | #p_item_base{} | #p_item{} | #p_equip{} | #p_pet{} | #p_marriage{} | #p_refine{} | #p_actor{} | #p_role{} | #p_creep{} | #p_npc{} | #p_drop{} | #p_buff{} | #p_coord{} | #p_icon{} | #p_ranking{} | #p_dropped{}) -> binary().
encode_msg(Msg) when tuple_size(Msg) >= 1 ->
    encode_msg(Msg, element(1, Msg), []).

-spec encode_msg(#m_mail_info_tos{} | #m_mail_info_toc{} | #m_mail_list_tos{} | #m_mail_list_toc{} | #m_mail_recv_toc{} | #m_mail_read_tos{} | #m_mail_read_toc{} | #m_mail_fetch_tos{} | #m_mail_fetch_toc{} | #m_mail_delete_tos{} | #m_mail_delete_toc{} | #p_mail{} | #p_role_base{} | #p_aspect{} | #p_attr{} | #p_item_base{} | #p_item{} | #p_equip{} | #p_pet{} | #p_marriage{} | #p_refine{} | #p_actor{} | #p_role{} | #p_creep{} | #p_npc{} | #p_drop{} | #p_buff{} | #p_coord{} | #p_icon{} | #p_ranking{} | #p_dropped{}, atom() | list()) -> binary().
...
encode_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
      m_mail_info_tos ->
	  encode_msg_m_mail_info_tos(id(Msg, TrUserData),
				     TrUserData);
      m_mail_info_toc ->
	  encode_msg_m_mail_info_toc(id(Msg, TrUserData),
				     TrUserData);
      m_mail_list_tos ->
	  encode_msg_m_mail_list_tos(id(Msg, TrUserData),
				     TrUserData);
      m_mail_list_toc ->
	  encode_msg_m_mail_list_toc(id(Msg, TrUserData),
				     TrUserData);
      m_mail_recv_toc ->
	  encode_msg_m_mail_recv_toc(id(Msg, TrUserData),
				     TrUserData);
      m_mail_read_tos ->
	  encode_msg_m_mail_read_tos(id(Msg, TrUserData),
				     TrUserData);
      m_mail_read_toc ->
	  encode_msg_m_mail_read_toc(id(Msg, TrUserData),
				     TrUserData);
      m_mail_fetch_tos ->
	  encode_msg_m_mail_fetch_tos(id(Msg, TrUserData),
				      TrUserData);
      m_mail_fetch_toc ->
	  encode_msg_m_mail_fetch_toc(id(Msg, TrUserData),
				      TrUserData);
      m_mail_delete_tos ->
	  encode_msg_m_mail_delete_tos(id(Msg, TrUserData),
				       TrUserData);
      m_mail_delete_toc ->
	  encode_msg_m_mail_delete_toc(id(Msg, TrUserData),
				       TrUserData);
      p_mail ->
	  encode_msg_p_mail(id(Msg, TrUserData), TrUserData);
      p_role_base ->
...
encode_msg_m_mail_info_tos(_Msg, _TrUserData) -> <<>>.

encode_msg_m_mail_info_toc(Msg, TrUserData) ->
    encode_msg_m_mail_info_toc(Msg, <<>>, TrUserData).


encode_msg_m_mail_info_toc(#m_mail_info_toc{unread =
						F1},
			   Bin, TrUserData) ->
    begin
...
encode_msg_m_mail_list_tos(_Msg, _TrUserData) -> <<>>.

encode_msg_m_mail_list_toc(Msg, TrUserData) ->
    encode_msg_m_mail_list_toc(Msg, <<>>, TrUserData).


encode_msg_m_mail_list_toc(#m_mail_list_toc{mails = F1},
			   Bin, TrUserData) ->
    begin
      TrF1 = id(F1, TrUserData),
      if TrF1 == [] -> Bin;
	 true ->
	     e_field_m_mail_list_toc_mails(TrF1, Bin, TrUserData)
      end
    end.

encode_msg_m_mail_recv_toc(Msg, TrUserData) ->
    encode_msg_m_mail_recv_toc(Msg, <<>>, TrUserData).


encode_msg_m_mail_recv_toc(#m_mail_recv_toc{mail = F1},
			   Bin, TrUserData) ->
    begin
      TrF1 = id(F1, TrUserData),
      e_mfield_m_mail_recv_toc_mail(TrF1, <<Bin/binary, 10>>,
				    TrUserData)
    end.

encode_msg_m_mail_read_tos(Msg, TrUserData) ->
    encode_msg_m_mail_read_tos(Msg, <<>>, TrUserData).


encode_msg_m_mail_read_tos(#m_mail_read_tos{mail_id =
						F1},
			   Bin, TrUserData) ->
    begin
      TrF1 = id(F1, TrUserData),
...
encode_msg_m_mail_read_toc(Msg, TrUserData) ->
    encode_msg_m_mail_read_toc(Msg, <<>>, TrUserData).


encode_msg_m_mail_read_toc(#m_mail_read_toc{mail_id =
						F1,
					    text = F2, items = F3, money = F4},
			   Bin, TrUserData) ->
    B1 = begin
	   TrF1 = id(F1, TrUserData),
	   e_type_int32(TrF1, <<Bin/binary, 8>>, TrUserData)
    ...
    B3 = begin
	   ...
	   if TrF3 == [] -> B2;
	      true ->
		  e_field_m_mail_read_toc_items(TrF3, B2, TrUserData)
	   end
	 end,
    begin
      TrF4 = 'tr_encode_m_mail_read_toc.money'(F4,
					       TrUserData),
      if TrF4 == [] -> B3;
	 true ->
	     e_field_m_mail_read_toc_money(TrF4, B3, TrUserData)
      end
    end.

encode_msg_m_mail_fetch_tos(Msg, TrUserData) ->
    encode_msg_m_mail_fetch_tos(Msg, <<>>, TrUserData).


encode_msg_m_mail_fetch_tos(#m_mail_fetch_tos{mail_id =
						  F1},
			    Bin, TrUserData) ->
    begin
      TrF1 = id(F1, TrUserData),
...
encode_msg_m_mail_fetch_toc(Msg, TrUserData) ->
    encode_msg_m_mail_fetch_toc(Msg, <<>>, TrUserData).


encode_msg_m_mail_fetch_toc(#m_mail_fetch_toc{mail_id =
						  F1},
			    Bin, TrUserData) ->
    begin
      TrF1 = id(F1, TrUserData),
      if TrF1 == [] -> Bin;
	 true ->
	     e_field_m_mail_fetch_toc_mail_id(TrF1, Bin, TrUserData)
      end
    end.

encode_msg_m_mail_delete_tos(Msg, TrUserData) ->
    encode_msg_m_mail_delete_tos(Msg, <<>>, TrUserData).


encode_msg_m_mail_delete_tos(#m_mail_delete_tos{mail_ids
						    = F1},
			     Bin, TrUserData) ->
    begin
      TrF1 = id(F1, TrUserData),
      if TrF1 == [] -> Bin;
	 true ->
	     e_field_m_mail_delete_tos_mail_ids(TrF1, Bin,
						TrUserData)
      end
    end.

encode_msg_m_mail_delete_toc(Msg, TrUserData) ->
    encode_msg_m_mail_delete_toc(Msg, <<>>, TrUserData).


encode_msg_m_mail_delete_toc(#m_mail_delete_toc{mail_ids
						    = F1},
			     Bin, TrUserData) ->
    begin
      TrF1 = id(F1, TrUserData),
      if TrF1 == [] -> Bin;
	 true ->
	     e_field_m_mail_delete_toc_mail_ids(TrF1, Bin,
						TrUserData)
      end
    end.

encode_msg_p_mail(Msg, TrUserData) ->
    encode_msg_p_mail(Msg, <<>>, TrUserData).


encode_msg_p_mail(#p_mail{id = F1, type = F2,
			  title = F3, from = F4, send = F5, expire = F6,
			  read = F7, attach = F8, fetch = F9},
		  Bin, TrUserData) ->
    B1 = begin
	   TrF1 = id(F1, TrUserData),
	   e_type_int32(TrF1, <<Bin/binary, 8>>, TrUserData)
...
e_mfield_m_mail_list_toc_mails(Msg, Bin, TrUserData) ->
    SubBin = encode_msg_p_mail(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

e_field_m_mail_list_toc_mails([Elem | Rest], Bin,
			      TrUserData) ->
    Bin2 = <<Bin/binary, 10>>,
    Bin3 = e_mfield_m_mail_list_toc_mails(id(Elem,
					     TrUserData),
					  Bin2, TrUserData),
    e_field_m_mail_list_toc_mails(Rest, Bin3, TrUserData);
e_field_m_mail_list_toc_mails([], Bin, _TrUserData) ->
    Bin.

e_mfield_m_mail_recv_toc_mail(Msg, Bin, TrUserData) ->
    SubBin = encode_msg_p_mail(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

e_mfield_m_mail_read_toc_items(Msg, Bin, TrUserData) ->
    SubBin = encode_msg_p_item(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

e_field_m_mail_read_toc_items([Elem | Rest], Bin,
			      TrUserData) ->
    Bin2 = <<Bin/binary, 26>>,
    Bin3 = e_mfield_m_mail_read_toc_items(id(Elem,
					     TrUserData),
					  Bin2, TrUserData),
    e_field_m_mail_read_toc_items(Rest, Bin3, TrUserData);
e_field_m_mail_read_toc_items([], Bin, _TrUserData) ->
    Bin.

e_mfield_m_mail_read_toc_money(Msg, Bin, TrUserData) ->
    SubBin = 'encode_msg_map<int32,int64>'(Msg, <<>>,
					   TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

e_field_m_mail_read_toc_money([Elem | Rest], Bin,
			      TrUserData) ->
    Bin2 = <<Bin/binary, 34>>,
    Bin3 =
	e_mfield_m_mail_read_toc_money('tr_encode_m_mail_read_toc.money[x]'(Elem,
									    TrUserData),
				       Bin2, TrUserData),
    e_field_m_mail_read_toc_money(Rest, Bin3, TrUserData);
e_field_m_mail_read_toc_money([], Bin, _TrUserData) ->
    Bin.

e_field_m_mail_fetch_toc_mail_id([Elem | Rest], Bin,
				 TrUserData) ->
    Bin2 = <<Bin/binary, 8>>,
    Bin3 = e_type_int32(id(Elem, TrUserData), Bin2,
			TrUserData),
    e_field_m_mail_fetch_toc_mail_id(Rest, Bin3,
				     TrUserData);
e_field_m_mail_fetch_toc_mail_id([], Bin,
				 _TrUserData) ->
    Bin.

e_field_m_mail_delete_tos_mail_ids([Elem | Rest], Bin,
				   TrUserData) ->
    Bin2 = <<Bin/binary, 8>>,
    Bin3 = e_type_int32(id(Elem, TrUserData), Bin2,
			TrUserData),
    e_field_m_mail_delete_tos_mail_ids(Rest, Bin3,
				       TrUserData);
e_field_m_mail_delete_tos_mail_ids([], Bin,
				   _TrUserData) ->
    Bin.

e_field_m_mail_delete_toc_mail_ids([Elem | Rest], Bin,
				   TrUserData) ->
    Bin2 = <<Bin/binary, 8>>,
    Bin3 = e_type_int32(id(Elem, TrUserData), Bin2,
			TrUserData),
    e_field_m_mail_delete_toc_mail_ids(Rest, Bin3,
				       TrUserData);
e_field_m_mail_delete_toc_mail_ids([], Bin,
				   _TrUserData) ->
    Bin.
...
'encode_msg_map<int32,int64>'(#{key := F1, value := F2},
			      Bin, TrUserData) ->
    B1 = begin
	   TrF1 = id(F1, TrUserData),
	   e_type_int32(TrF1, <<Bin/binary, 8>>, TrUserData)
...
decode_msg_2_doit(m_mail_info_tos, Bin, TrUserData) ->
    id(decode_msg_m_mail_info_tos(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_mail_info_toc, Bin, TrUserData) ->
    id(decode_msg_m_mail_info_toc(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_mail_list_tos, Bin, TrUserData) ->
    id(decode_msg_m_mail_list_tos(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_mail_list_toc, Bin, TrUserData) ->
    id(decode_msg_m_mail_list_toc(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_mail_recv_toc, Bin, TrUserData) ->
    id(decode_msg_m_mail_recv_toc(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_mail_read_tos, Bin, TrUserData) ->
    id(decode_msg_m_mail_read_tos(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_mail_read_toc, Bin, TrUserData) ->
    id(decode_msg_m_mail_read_toc(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_mail_fetch_tos, Bin, TrUserData) ->
    id(decode_msg_m_mail_fetch_tos(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_mail_fetch_toc, Bin, TrUserData) ->
    id(decode_msg_m_mail_fetch_toc(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_mail_delete_tos, Bin, TrUserData) ->
    id(decode_msg_m_mail_delete_tos(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_mail_delete_toc, Bin, TrUserData) ->
    id(decode_msg_m_mail_delete_toc(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(p_mail, Bin, TrUserData) ->
    id(decode_msg_p_mail(Bin, TrUserData), TrUserData);
...
decode_msg_m_mail_info_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_mail_info_tos(Bin, 0, 0,
				       TrUserData).

dfp_read_field_def_m_mail_info_tos(<<>>, 0, 0, _) ->
    #m_mail_info_tos{};
dfp_read_field_def_m_mail_info_tos(Other, Z1, Z2,
				   TrUserData) ->
    dg_read_field_def_m_mail_info_tos(Other, Z1, Z2,
				      TrUserData).

dg_read_field_def_m_mail_info_tos(<<1:1, X:7,
				    Rest/binary>>,
				  N, Acc, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_mail_info_tos(Rest, N + 7,
				      X bsl N + Acc, TrUserData);
dg_read_field_def_m_mail_info_tos(<<0:1, X:7,
				    Rest/binary>>,
				  N, Acc, TrUserData) ->
    Key = X bsl N + Acc,
    case Key band 7 of
      0 ->
	  skip_varint_m_mail_info_tos(Rest, 0, 0, TrUserData);
      1 -> skip_64_m_mail_info_tos(Rest, 0, 0, TrUserData);
      2 ->
	  skip_length_delimited_m_mail_info_tos(Rest, 0, 0,
						TrUserData);
      3 ->
	  skip_group_m_mail_info_tos(Rest, Key bsr 3, 0,
				     TrUserData);
      5 -> skip_32_m_mail_info_tos(Rest, 0, 0, TrUserData)
    end;
dg_read_field_def_m_mail_info_tos(<<>>, 0, 0, _) ->
    #m_mail_info_tos{}.

skip_varint_m_mail_info_tos(<<1:1, _:7, Rest/binary>>,
			    Z1, Z2, TrUserData) ->
    skip_varint_m_mail_info_tos(Rest, Z1, Z2, TrUserData);
skip_varint_m_mail_info_tos(<<0:1, _:7, Rest/binary>>,
			    Z1, Z2, TrUserData) ->
    dfp_read_field_def_m_mail_info_tos(Rest, Z1, Z2,
				       TrUserData).

skip_length_delimited_m_mail_info_tos(<<1:1, X:7,
					Rest/binary>>,
				      N, Acc, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_mail_info_tos(Rest, N + 7,
					  X bsl N + Acc, TrUserData);
skip_length_delimited_m_mail_info_tos(<<0:1, X:7,
					Rest/binary>>,
				      N, Acc, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_mail_info_tos(Rest2, 0, 0,
				       TrUserData).

skip_group_m_mail_info_tos(Bin, FNum, Z2, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_mail_info_tos(Rest, 0, Z2,
				       TrUserData).

skip_32_m_mail_info_tos(<<_:32, Rest/binary>>, Z1, Z2,
			TrUserData) ->
    dfp_read_field_def_m_mail_info_tos(Rest, Z1, Z2,
				       TrUserData).

skip_64_m_mail_info_tos(<<_:64, Rest/binary>>, Z1, Z2,
			TrUserData) ->
    dfp_read_field_def_m_mail_info_tos(Rest, Z1, Z2,
				       TrUserData).

decode_msg_m_mail_info_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_mail_info_toc(Bin, 0, 0,
				       id(undefined, TrUserData), TrUserData).

dfp_read_field_def_m_mail_info_toc(<<8, Rest/binary>>,
				   Z1, Z2, F@_1, TrUserData) ->
    d_field_m_mail_info_toc_unread(Rest, Z1, Z2, F@_1,
				   TrUserData);
dfp_read_field_def_m_mail_info_toc(<<>>, 0, 0, F@_1,
				   _) ->
    #m_mail_info_toc{unread = F@_1};
dfp_read_field_def_m_mail_info_toc(Other, Z1, Z2, F@_1,
				   TrUserData) ->
    dg_read_field_def_m_mail_info_toc(Other, Z1, Z2, F@_1,
				      TrUserData).

dg_read_field_def_m_mail_info_toc(<<1:1, X:7,
				    Rest/binary>>,
				  N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_mail_info_toc(Rest, N + 7,
				      X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_m_mail_info_toc(<<0:1, X:7,
				    Rest/binary>>,
				  N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_mail_info_toc_unread(Rest, 0, 0, F@_1,
					 TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_mail_info_toc(Rest, 0, 0, F@_1,
					    TrUserData);
	    1 ->
		skip_64_m_mail_info_toc(Rest, 0, 0, F@_1, TrUserData);
	    2 ->
		skip_length_delimited_m_mail_info_toc(Rest, 0, 0, F@_1,
						      TrUserData);
	    3 ->
		skip_group_m_mail_info_toc(Rest, Key bsr 3, 0, F@_1,
					   TrUserData);
	    5 ->
		skip_32_m_mail_info_toc(Rest, 0, 0, F@_1, TrUserData)
	  end
    end;
dg_read_field_def_m_mail_info_toc(<<>>, 0, 0, F@_1,
				  _) ->
    #m_mail_info_toc{unread = F@_1}.

d_field_m_mail_info_toc_unread(<<1:1, X:7,
				 Rest/binary>>,
			       N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_m_mail_info_toc_unread(Rest, N + 7,
				   X bsl N + Acc, F@_1, TrUserData);
d_field_m_mail_info_toc_unread(<<0:1, X:7,
				 Rest/binary>>,
			       N, Acc, _, TrUserData) ->
    {NewFValue, RestF} = {id(X bsl N + Acc =/= 0,
			     TrUserData),
			  Rest},
    dfp_read_field_def_m_mail_info_toc(RestF, 0, 0,
				       NewFValue, TrUserData).

skip_varint_m_mail_info_toc(<<1:1, _:7, Rest/binary>>,
			    Z1, Z2, F@_1, TrUserData) ->
    skip_varint_m_mail_info_toc(Rest, Z1, Z2, F@_1,
				TrUserData);
skip_varint_m_mail_info_toc(<<0:1, _:7, Rest/binary>>,
			    Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_mail_info_toc(Rest, Z1, Z2, F@_1,
				       TrUserData).

skip_length_delimited_m_mail_info_toc(<<1:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_mail_info_toc(Rest, N + 7,
					  X bsl N + Acc, F@_1, TrUserData);
skip_length_delimited_m_mail_info_toc(<<0:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_mail_info_toc(Rest2, 0, 0, F@_1,
				       TrUserData).

skip_group_m_mail_info_toc(Bin, FNum, Z2, F@_1,
			   TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_mail_info_toc(Rest, 0, Z2, F@_1,
				       TrUserData).

skip_32_m_mail_info_toc(<<_:32, Rest/binary>>, Z1, Z2,
			F@_1, TrUserData) ->
    dfp_read_field_def_m_mail_info_toc(Rest, Z1, Z2, F@_1,
				       TrUserData).

skip_64_m_mail_info_toc(<<_:64, Rest/binary>>, Z1, Z2,
			F@_1, TrUserData) ->
    dfp_read_field_def_m_mail_info_toc(Rest, Z1, Z2, F@_1,
				       TrUserData).

decode_msg_m_mail_list_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_mail_list_tos(Bin, 0, 0,
				       TrUserData).

dfp_read_field_def_m_mail_list_tos(<<>>, 0, 0, _) ->
    #m_mail_list_tos{};
dfp_read_field_def_m_mail_list_tos(Other, Z1, Z2,
				   TrUserData) ->
    dg_read_field_def_m_mail_list_tos(Other, Z1, Z2,
				      TrUserData).

dg_read_field_def_m_mail_list_tos(<<1:1, X:7,
				    Rest/binary>>,
				  N, Acc, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_mail_list_tos(Rest, N + 7,
				      X bsl N + Acc, TrUserData);
dg_read_field_def_m_mail_list_tos(<<0:1, X:7,
				    Rest/binary>>,
				  N, Acc, TrUserData) ->
    Key = X bsl N + Acc,
    case Key band 7 of
      0 ->
	  skip_varint_m_mail_list_tos(Rest, 0, 0, TrUserData);
      1 -> skip_64_m_mail_list_tos(Rest, 0, 0, TrUserData);
      2 ->
	  skip_length_delimited_m_mail_list_tos(Rest, 0, 0,
						TrUserData);
      3 ->
	  skip_group_m_mail_list_tos(Rest, Key bsr 3, 0,
				     TrUserData);
      5 -> skip_32_m_mail_list_tos(Rest, 0, 0, TrUserData)
    end;
dg_read_field_def_m_mail_list_tos(<<>>, 0, 0, _) ->
    #m_mail_list_tos{}.

skip_varint_m_mail_list_tos(<<1:1, _:7, Rest/binary>>,
			    Z1, Z2, TrUserData) ->
    skip_varint_m_mail_list_tos(Rest, Z1, Z2, TrUserData);
skip_varint_m_mail_list_tos(<<0:1, _:7, Rest/binary>>,
			    Z1, Z2, TrUserData) ->
    dfp_read_field_def_m_mail_list_tos(Rest, Z1, Z2,
				       TrUserData).

skip_length_delimited_m_mail_list_tos(<<1:1, X:7,
					Rest/binary>>,
				      N, Acc, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_mail_list_tos(Rest, N + 7,
					  X bsl N + Acc, TrUserData);
skip_length_delimited_m_mail_list_tos(<<0:1, X:7,
					Rest/binary>>,
				      N, Acc, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_mail_list_tos(Rest2, 0, 0,
				       TrUserData).

skip_group_m_mail_list_tos(Bin, FNum, Z2, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_mail_list_tos(Rest, 0, Z2,
				       TrUserData).

skip_32_m_mail_list_tos(<<_:32, Rest/binary>>, Z1, Z2,
			TrUserData) ->
    dfp_read_field_def_m_mail_list_tos(Rest, Z1, Z2,
				       TrUserData).

skip_64_m_mail_list_tos(<<_:64, Rest/binary>>, Z1, Z2,
			TrUserData) ->
    dfp_read_field_def_m_mail_list_tos(Rest, Z1, Z2,
				       TrUserData).

decode_msg_m_mail_list_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_mail_list_toc(Bin, 0, 0,
				       id([], TrUserData), TrUserData).

dfp_read_field_def_m_mail_list_toc(<<10, Rest/binary>>,
				   Z1, Z2, F@_1, TrUserData) ->
    d_field_m_mail_list_toc_mails(Rest, Z1, Z2, F@_1,
				  TrUserData);
dfp_read_field_def_m_mail_list_toc(<<>>, 0, 0, R1,
				   TrUserData) ->
    #m_mail_list_toc{mails = lists_reverse(R1, TrUserData)};
dfp_read_field_def_m_mail_list_toc(Other, Z1, Z2, F@_1,
				   TrUserData) ->
    dg_read_field_def_m_mail_list_toc(Other, Z1, Z2, F@_1,
				      TrUserData).

dg_read_field_def_m_mail_list_toc(<<1:1, X:7,
				    Rest/binary>>,
				  N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_mail_list_toc(Rest, N + 7,
				      X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_m_mail_list_toc(<<0:1, X:7,
				    Rest/binary>>,
				  N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      10 ->
	  d_field_m_mail_list_toc_mails(Rest, 0, 0, F@_1,
					TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_mail_list_toc(Rest, 0, 0, F@_1,
					    TrUserData);
	    1 ->
		skip_64_m_mail_list_toc(Rest, 0, 0, F@_1, TrUserData);
	    2 ->
		skip_length_delimited_m_mail_list_toc(Rest, 0, 0, F@_1,
						      TrUserData);
	    3 ->
		skip_group_m_mail_list_toc(Rest, Key bsr 3, 0, F@_1,
					   TrUserData);
	    5 ->
		skip_32_m_mail_list_toc(Rest, 0, 0, F@_1, TrUserData)
	  end
    end;
dg_read_field_def_m_mail_list_toc(<<>>, 0, 0, R1,
				  TrUserData) ->
    #m_mail_list_toc{mails = lists_reverse(R1, TrUserData)}.

d_field_m_mail_list_toc_mails(<<1:1, X:7, Rest/binary>>,
			      N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_m_mail_list_toc_mails(Rest, N + 7,
				  X bsl N + Acc, F@_1, TrUserData);
d_field_m_mail_list_toc_mails(<<0:1, X:7, Rest/binary>>,
			      N, Acc, Prev, TrUserData) ->
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
			   <<Bs:Len/binary, Rest2/binary>> = Rest,
			   {id(decode_msg_p_mail(Bs, TrUserData), TrUserData),
			    Rest2}
			 end,
    dfp_read_field_def_m_mail_list_toc(RestF, 0, 0,
				       cons(NewFValue, Prev, TrUserData),
				       TrUserData).

skip_varint_m_mail_list_toc(<<1:1, _:7, Rest/binary>>,
			    Z1, Z2, F@_1, TrUserData) ->
    skip_varint_m_mail_list_toc(Rest, Z1, Z2, F@_1,
				TrUserData);
skip_varint_m_mail_list_toc(<<0:1, _:7, Rest/binary>>,
			    Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_mail_list_toc(Rest, Z1, Z2, F@_1,
				       TrUserData).

skip_length_delimited_m_mail_list_toc(<<1:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_mail_list_toc(Rest, N + 7,
					  X bsl N + Acc, F@_1, TrUserData);
skip_length_delimited_m_mail_list_toc(<<0:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_mail_list_toc(Rest2, 0, 0, F@_1,
				       TrUserData).

skip_group_m_mail_list_toc(Bin, FNum, Z2, F@_1,
			   TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_mail_list_toc(Rest, 0, Z2, F@_1,
				       TrUserData).

skip_32_m_mail_list_toc(<<_:32, Rest/binary>>, Z1, Z2,
			F@_1, TrUserData) ->
    dfp_read_field_def_m_mail_list_toc(Rest, Z1, Z2, F@_1,
				       TrUserData).

skip_64_m_mail_list_toc(<<_:64, Rest/binary>>, Z1, Z2,
			F@_1, TrUserData) ->
    dfp_read_field_def_m_mail_list_toc(Rest, Z1, Z2, F@_1,
				       TrUserData).

decode_msg_m_mail_recv_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_mail_recv_toc(Bin, 0, 0,
				       id(undefined, TrUserData), TrUserData).

dfp_read_field_def_m_mail_recv_toc(<<10, Rest/binary>>,
				   Z1, Z2, F@_1, TrUserData) ->
    d_field_m_mail_recv_toc_mail(Rest, Z1, Z2, F@_1,
				 TrUserData);
dfp_read_field_def_m_mail_recv_toc(<<>>, 0, 0, F@_1,
				   _) ->
    #m_mail_recv_toc{mail = F@_1};
dfp_read_field_def_m_mail_recv_toc(Other, Z1, Z2, F@_1,
				   TrUserData) ->
    dg_read_field_def_m_mail_recv_toc(Other, Z1, Z2, F@_1,
				      TrUserData).

dg_read_field_def_m_mail_recv_toc(<<1:1, X:7,
				    Rest/binary>>,
				  N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_mail_recv_toc(Rest, N + 7,
				      X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_m_mail_recv_toc(<<0:1, X:7,
				    Rest/binary>>,
				  N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      10 ->
	  d_field_m_mail_recv_toc_mail(Rest, 0, 0, F@_1,
				       TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_mail_recv_toc(Rest, 0, 0, F@_1,
					    TrUserData);
	    1 ->
		skip_64_m_mail_recv_toc(Rest, 0, 0, F@_1, TrUserData);
	    2 ->
		skip_length_delimited_m_mail_recv_toc(Rest, 0, 0, F@_1,
						      TrUserData);
	    3 ->
		skip_group_m_mail_recv_toc(Rest, Key bsr 3, 0, F@_1,
					   TrUserData);
	    5 ->
		skip_32_m_mail_recv_toc(Rest, 0, 0, F@_1, TrUserData)
	  end
    end;
dg_read_field_def_m_mail_recv_toc(<<>>, 0, 0, F@_1,
				  _) ->
    #m_mail_recv_toc{mail = F@_1}.

d_field_m_mail_recv_toc_mail(<<1:1, X:7, Rest/binary>>,
			     N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_m_mail_recv_toc_mail(Rest, N + 7, X bsl N + Acc,
				 F@_1, TrUserData);
d_field_m_mail_recv_toc_mail(<<0:1, X:7, Rest/binary>>,
			     N, Acc, Prev, TrUserData) ->
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
			   <<Bs:Len/binary, Rest2/binary>> = Rest,
    ...
    dfp_read_field_def_m_mail_recv_toc(RestF, 0, 0,
				       if Prev == undefined -> NewFValue;
					  true ->
					      merge_msg_p_mail(Prev, NewFValue,
							       TrUserData)
				       end,
				       TrUserData).

skip_varint_m_mail_recv_toc(<<1:1, _:7, Rest/binary>>,
			    Z1, Z2, F@_1, TrUserData) ->
    skip_varint_m_mail_recv_toc(Rest, Z1, Z2, F@_1,
				TrUserData);
skip_varint_m_mail_recv_toc(<<0:1, _:7, Rest/binary>>,
			    Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_mail_recv_toc(Rest, Z1, Z2, F@_1,
				       TrUserData).

skip_length_delimited_m_mail_recv_toc(<<1:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_mail_recv_toc(Rest, N + 7,
					  X bsl N + Acc, F@_1, TrUserData);
skip_length_delimited_m_mail_recv_toc(<<0:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_mail_recv_toc(Rest2, 0, 0, F@_1,
				       TrUserData).

skip_group_m_mail_recv_toc(Bin, FNum, Z2, F@_1,
			   TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_mail_recv_toc(Rest, 0, Z2, F@_1,
				       TrUserData).

skip_32_m_mail_recv_toc(<<_:32, Rest/binary>>, Z1, Z2,
			F@_1, TrUserData) ->
    dfp_read_field_def_m_mail_recv_toc(Rest, Z1, Z2, F@_1,
				       TrUserData).

skip_64_m_mail_recv_toc(<<_:64, Rest/binary>>, Z1, Z2,
			F@_1, TrUserData) ->
    dfp_read_field_def_m_mail_recv_toc(Rest, Z1, Z2, F@_1,
				       TrUserData).

decode_msg_m_mail_read_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_mail_read_tos(Bin, 0, 0,
				       id(undefined, TrUserData), TrUserData).

dfp_read_field_def_m_mail_read_tos(<<8, Rest/binary>>,
				   Z1, Z2, F@_1, TrUserData) ->
    d_field_m_mail_read_tos_mail_id(Rest, Z1, Z2, F@_1,
				    TrUserData);
dfp_read_field_def_m_mail_read_tos(<<>>, 0, 0, F@_1,
				   _) ->
    #m_mail_read_tos{mail_id = F@_1};
dfp_read_field_def_m_mail_read_tos(Other, Z1, Z2, F@_1,
				   TrUserData) ->
    dg_read_field_def_m_mail_read_tos(Other, Z1, Z2, F@_1,
				      TrUserData).

dg_read_field_def_m_mail_read_tos(<<1:1, X:7,
				    Rest/binary>>,
				  N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_mail_read_tos(Rest, N + 7,
				      X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_m_mail_read_tos(<<0:1, X:7,
				    Rest/binary>>,
				  N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_mail_read_tos_mail_id(Rest, 0, 0, F@_1,
					  TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_mail_read_tos(Rest, 0, 0, F@_1,
					    TrUserData);
	    1 ->
		skip_64_m_mail_read_tos(Rest, 0, 0, F@_1, TrUserData);
	    2 ->
		skip_length_delimited_m_mail_read_tos(Rest, 0, 0, F@_1,
						      TrUserData);
	    3 ->
		skip_group_m_mail_read_tos(Rest, Key bsr 3, 0, F@_1,
					   TrUserData);
	    5 ->
		skip_32_m_mail_read_tos(Rest, 0, 0, F@_1, TrUserData)
	  end
    end;
dg_read_field_def_m_mail_read_tos(<<>>, 0, 0, F@_1,
				  _) ->
    #m_mail_read_tos{mail_id = F@_1}.

d_field_m_mail_read_tos_mail_id(<<1:1, X:7,
				  Rest/binary>>,
				N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_m_mail_read_tos_mail_id(Rest, N + 7,
				    X bsl N + Acc, F@_1, TrUserData);
d_field_m_mail_read_tos_mail_id(<<0:1, X:7,
				  Rest/binary>>,
				N, Acc, _, TrUserData) ->
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    dfp_read_field_def_m_mail_read_tos(RestF, 0, 0,
				       NewFValue, TrUserData).

skip_varint_m_mail_read_tos(<<1:1, _:7, Rest/binary>>,
			    Z1, Z2, F@_1, TrUserData) ->
    skip_varint_m_mail_read_tos(Rest, Z1, Z2, F@_1,
				TrUserData);
skip_varint_m_mail_read_tos(<<0:1, _:7, Rest/binary>>,
			    Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_mail_read_tos(Rest, Z1, Z2, F@_1,
				       TrUserData).

skip_length_delimited_m_mail_read_tos(<<1:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_mail_read_tos(Rest, N + 7,
					  X bsl N + Acc, F@_1, TrUserData);
skip_length_delimited_m_mail_read_tos(<<0:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_mail_read_tos(Rest2, 0, 0, F@_1,
				       TrUserData).

skip_group_m_mail_read_tos(Bin, FNum, Z2, F@_1,
			   TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_mail_read_tos(Rest, 0, Z2, F@_1,
				       TrUserData).

skip_32_m_mail_read_tos(<<_:32, Rest/binary>>, Z1, Z2,
			F@_1, TrUserData) ->
    dfp_read_field_def_m_mail_read_tos(Rest, Z1, Z2, F@_1,
				       TrUserData).

skip_64_m_mail_read_tos(<<_:64, Rest/binary>>, Z1, Z2,
			F@_1, TrUserData) ->
    dfp_read_field_def_m_mail_read_tos(Rest, Z1, Z2, F@_1,
				       TrUserData).

decode_msg_m_mail_read_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_mail_read_toc(Bin, 0, 0,
				       id(undefined, TrUserData),
				       id(undefined, TrUserData),
				       id([], TrUserData),
				       'tr_decode_init_default_m_mail_read_toc.money'([],
										      TrUserData),
				       TrUserData).

dfp_read_field_def_m_mail_read_toc(<<8, Rest/binary>>,
				   Z1, Z2, F@_1, F@_2, F@_3, F@_4,
				   TrUserData) ->
    d_field_m_mail_read_toc_mail_id(Rest, Z1, Z2, F@_1,
				    F@_2, F@_3, F@_4, TrUserData);
dfp_read_field_def_m_mail_read_toc(<<18, Rest/binary>>,
				   Z1, Z2, F@_1, F@_2, F@_3, F@_4,
				   TrUserData) ->
    d_field_m_mail_read_toc_text(Rest, Z1, Z2, F@_1, F@_2,
				 F@_3, F@_4, TrUserData);
dfp_read_field_def_m_mail_read_toc(<<26, Rest/binary>>,
				   Z1, Z2, F@_1, F@_2, F@_3, F@_4,
				   TrUserData) ->
    d_field_m_mail_read_toc_items(Rest, Z1, Z2, F@_1, F@_2,
				  F@_3, F@_4, TrUserData);
dfp_read_field_def_m_mail_read_toc(<<34, Rest/binary>>,
				   Z1, Z2, F@_1, F@_2, F@_3, F@_4,
				   TrUserData) ->
    d_field_m_mail_read_toc_money(Rest, Z1, Z2, F@_1, F@_2,
				  F@_3, F@_4, TrUserData);
dfp_read_field_def_m_mail_read_toc(<<>>, 0, 0, F@_1,
				   F@_2, R1, R2, TrUserData) ->
    #m_mail_read_toc{mail_id = F@_1, text = F@_2,
		     items = lists_reverse(R1, TrUserData),
		     money =
			 'tr_decode_repeated_finalize_m_mail_read_toc.money'(R2,
									     TrUserData)};
dfp_read_field_def_m_mail_read_toc(Other, Z1, Z2, F@_1,
				   F@_2, F@_3, F@_4, TrUserData) ->
    dg_read_field_def_m_mail_read_toc(Other, Z1, Z2, F@_1,
				      F@_2, F@_3, F@_4, TrUserData).

dg_read_field_def_m_mail_read_toc(<<1:1, X:7,
				    Rest/binary>>,
				  N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_mail_read_toc(Rest, N + 7,
				      X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
				      TrUserData);
dg_read_field_def_m_mail_read_toc(<<0:1, X:7,
				    Rest/binary>>,
				  N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_mail_read_toc_mail_id(Rest, 0, 0, F@_1, F@_2,
					  F@_3, F@_4, TrUserData);
      18 ->
	  d_field_m_mail_read_toc_text(Rest, 0, 0, F@_1, F@_2,
				       F@_3, F@_4, TrUserData);
      26 ->
	  d_field_m_mail_read_toc_items(Rest, 0, 0, F@_1, F@_2,
					F@_3, F@_4, TrUserData);
      34 ->
	  d_field_m_mail_read_toc_money(Rest, 0, 0, F@_1, F@_2,
					F@_3, F@_4, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_mail_read_toc(Rest, 0, 0, F@_1, F@_2,
					    F@_3, F@_4, TrUserData);
	    1 ->
		skip_64_m_mail_read_toc(Rest, 0, 0, F@_1, F@_2, F@_3,
					F@_4, TrUserData);
	    2 ->
		skip_length_delimited_m_mail_read_toc(Rest, 0, 0, F@_1,
						      F@_2, F@_3, F@_4,
						      TrUserData);
	    3 ->
		skip_group_m_mail_read_toc(Rest, Key bsr 3, 0, F@_1,
					   F@_2, F@_3, F@_4, TrUserData);
	    5 ->
		skip_32_m_mail_read_toc(Rest, 0, 0, F@_1, F@_2, F@_3,
					F@_4, TrUserData)
	  end
    end;
dg_read_field_def_m_mail_read_toc(<<>>, 0, 0, F@_1,
				  F@_2, R1, R2, TrUserData) ->
    #m_mail_read_toc{mail_id = F@_1, text = F@_2,
		     items = lists_reverse(R1, TrUserData),
		     money =
...
d_field_m_mail_read_toc_mail_id(<<1:1, X:7,
				  Rest/binary>>,
				N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData)
    when N < 57 ->
    d_field_m_mail_read_toc_mail_id(Rest, N + 7,
				    X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
				    TrUserData);
d_field_m_mail_read_toc_mail_id(<<0:1, X:7,
				  Rest/binary>>,
    ...
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    dfp_read_field_def_m_mail_read_toc(RestF, 0, 0,
				       NewFValue, F@_2, F@_3, F@_4, TrUserData).

d_field_m_mail_read_toc_text(<<1:1, X:7, Rest/binary>>,
			     N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData)
    when N < 57 ->
    d_field_m_mail_read_toc_text(Rest, N + 7, X bsl N + Acc,
				 F@_1, F@_2, F@_3, F@_4, TrUserData);
d_field_m_mail_read_toc_text(<<0:1, X:7, Rest/binary>>,
    ...
    dfp_read_field_def_m_mail_read_toc(RestF, 0, 0, F@_1,
				       NewFValue, F@_3, F@_4, TrUserData).

d_field_m_mail_read_toc_items(<<1:1, X:7, Rest/binary>>,
			      N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData)
    when N < 57 ->
    d_field_m_mail_read_toc_items(Rest, N + 7,
				  X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
				  TrUserData);
d_field_m_mail_read_toc_items(<<0:1, X:7, Rest/binary>>,
...
d_field_m_mail_read_toc_money(<<1:1, X:7, Rest/binary>>,
			      N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData)
    when N < 57 ->
    d_field_m_mail_read_toc_money(Rest, N + 7,
				  X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
				  TrUserData);
d_field_m_mail_read_toc_money(<<0:1, X:7, Rest/binary>>,
			      N, Acc, F@_1, F@_2, F@_3, Prev, TrUserData) ->
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
			   <<Bs:Len/binary, Rest2/binary>> = Rest,
			   {id('decode_msg_map<int32,int64>'(Bs, TrUserData),
			       TrUserData),
			    Rest2}
			 end,
    dfp_read_field_def_m_mail_read_toc(RestF, 0, 0, F@_1,
				       F@_2, F@_3,
				       'tr_decode_repeated_add_elem_m_mail_read_toc.money'(NewFValue,
											   Prev,
											   TrUserData),
				       TrUserData).

skip_varint_m_mail_read_toc(<<1:1, _:7, Rest/binary>>,
			    Z1, Z2, F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    skip_varint_m_mail_read_toc(Rest, Z1, Z2, F@_1, F@_2,
				F@_3, F@_4, TrUserData);
skip_varint_m_mail_read_toc(<<0:1, _:7, Rest/binary>>,
			    Z1, Z2, F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    dfp_read_field_def_m_mail_read_toc(Rest, Z1, Z2, F@_1,
				       F@_2, F@_3, F@_4, TrUserData).

skip_length_delimited_m_mail_read_toc(<<1:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, F@_2, F@_3, F@_4,
				      TrUserData)
    when N < 57 ->
    skip_length_delimited_m_mail_read_toc(Rest, N + 7,
					  X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
					  TrUserData);
skip_length_delimited_m_mail_read_toc(<<0:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, F@_2, F@_3, F@_4,
				      TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_mail_read_toc(Rest2, 0, 0, F@_1,
				       F@_2, F@_3, F@_4, TrUserData).

skip_group_m_mail_read_toc(Bin, FNum, Z2, F@_1, F@_2,
			   F@_3, F@_4, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_mail_read_toc(Rest, 0, Z2, F@_1,
				       F@_2, F@_3, F@_4, TrUserData).

skip_32_m_mail_read_toc(<<_:32, Rest/binary>>, Z1, Z2,
			F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    dfp_read_field_def_m_mail_read_toc(Rest, Z1, Z2, F@_1,
				       F@_2, F@_3, F@_4, TrUserData).

skip_64_m_mail_read_toc(<<_:64, Rest/binary>>, Z1, Z2,
			F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    dfp_read_field_def_m_mail_read_toc(Rest, Z1, Z2, F@_1,
				       F@_2, F@_3, F@_4, TrUserData).

decode_msg_m_mail_fetch_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_mail_fetch_tos(Bin, 0, 0,
					id(undefined, TrUserData), TrUserData).

dfp_read_field_def_m_mail_fetch_tos(<<8, Rest/binary>>,
				    Z1, Z2, F@_1, TrUserData) ->
    d_field_m_mail_fetch_tos_mail_id(Rest, Z1, Z2, F@_1,
				     TrUserData);
dfp_read_field_def_m_mail_fetch_tos(<<>>, 0, 0, F@_1,
				    _) ->
    #m_mail_fetch_tos{mail_id = F@_1};
dfp_read_field_def_m_mail_fetch_tos(Other, Z1, Z2, F@_1,
				    TrUserData) ->
    dg_read_field_def_m_mail_fetch_tos(Other, Z1, Z2, F@_1,
				       TrUserData).

dg_read_field_def_m_mail_fetch_tos(<<1:1, X:7,
				     Rest/binary>>,
				   N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_mail_fetch_tos(Rest, N + 7,
				       X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_m_mail_fetch_tos(<<0:1, X:7,
				     Rest/binary>>,
				   N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_mail_fetch_tos_mail_id(Rest, 0, 0, F@_1,
					   TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_mail_fetch_tos(Rest, 0, 0, F@_1,
					     TrUserData);
	    1 ->
		skip_64_m_mail_fetch_tos(Rest, 0, 0, F@_1, TrUserData);
	    2 ->
		skip_length_delimited_m_mail_fetch_tos(Rest, 0, 0, F@_1,
						       TrUserData);
	    3 ->
		skip_group_m_mail_fetch_tos(Rest, Key bsr 3, 0, F@_1,
					    TrUserData);
	    5 ->
		skip_32_m_mail_fetch_tos(Rest, 0, 0, F@_1, TrUserData)
	  end
    end;
dg_read_field_def_m_mail_fetch_tos(<<>>, 0, 0, F@_1,
				   _) ->
    #m_mail_fetch_tos{mail_id = F@_1}.

d_field_m_mail_fetch_tos_mail_id(<<1:1, X:7,
				   Rest/binary>>,
				 N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_m_mail_fetch_tos_mail_id(Rest, N + 7,
				     X bsl N + Acc, F@_1, TrUserData);
d_field_m_mail_fetch_tos_mail_id(<<0:1, X:7,
				   Rest/binary>>,
				 N, Acc, _, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    dfp_read_field_def_m_mail_fetch_tos(RestF, 0, 0,
					NewFValue, TrUserData).

skip_varint_m_mail_fetch_tos(<<1:1, _:7, Rest/binary>>,
			     Z1, Z2, F@_1, TrUserData) ->
    skip_varint_m_mail_fetch_tos(Rest, Z1, Z2, F@_1,
				 TrUserData);
skip_varint_m_mail_fetch_tos(<<0:1, _:7, Rest/binary>>,
			     Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_mail_fetch_tos(Rest, Z1, Z2, F@_1,
					TrUserData).

skip_length_delimited_m_mail_fetch_tos(<<1:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_mail_fetch_tos(Rest, N + 7,
					   X bsl N + Acc, F@_1, TrUserData);
skip_length_delimited_m_mail_fetch_tos(<<0:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_mail_fetch_tos(Rest2, 0, 0, F@_1,
					TrUserData).

skip_group_m_mail_fetch_tos(Bin, FNum, Z2, F@_1,
			    TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_mail_fetch_tos(Rest, 0, Z2, F@_1,
					TrUserData).

skip_32_m_mail_fetch_tos(<<_:32, Rest/binary>>, Z1, Z2,
			 F@_1, TrUserData) ->
    dfp_read_field_def_m_mail_fetch_tos(Rest, Z1, Z2, F@_1,
					TrUserData).

skip_64_m_mail_fetch_tos(<<_:64, Rest/binary>>, Z1, Z2,
			 F@_1, TrUserData) ->
    dfp_read_field_def_m_mail_fetch_tos(Rest, Z1, Z2, F@_1,
					TrUserData).

decode_msg_m_mail_fetch_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_mail_fetch_toc(Bin, 0, 0,
					id([], TrUserData), TrUserData).

dfp_read_field_def_m_mail_fetch_toc(<<10, Rest/binary>>,
				    Z1, Z2, F@_1, TrUserData) ->
    d_pfield_m_mail_fetch_toc_mail_id(Rest, Z1, Z2, F@_1,
				      TrUserData);
dfp_read_field_def_m_mail_fetch_toc(<<8, Rest/binary>>,
				    Z1, Z2, F@_1, TrUserData) ->
    d_field_m_mail_fetch_toc_mail_id(Rest, Z1, Z2, F@_1,
				     TrUserData);
dfp_read_field_def_m_mail_fetch_toc(<<>>, 0, 0, R1,
				    TrUserData) ->
    #m_mail_fetch_toc{mail_id =
			  lists_reverse(R1, TrUserData)};
dfp_read_field_def_m_mail_fetch_toc(Other, Z1, Z2, F@_1,
				    TrUserData) ->
    dg_read_field_def_m_mail_fetch_toc(Other, Z1, Z2, F@_1,
				       TrUserData).

dg_read_field_def_m_mail_fetch_toc(<<1:1, X:7,
				     Rest/binary>>,
				   N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_mail_fetch_toc(Rest, N + 7,
				       X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_m_mail_fetch_toc(<<0:1, X:7,
				     Rest/binary>>,
				   N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      10 ->
	  d_pfield_m_mail_fetch_toc_mail_id(Rest, 0, 0, F@_1,
					    TrUserData);
      8 ->
	  d_field_m_mail_fetch_toc_mail_id(Rest, 0, 0, F@_1,
					   TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_mail_fetch_toc(Rest, 0, 0, F@_1,
					     TrUserData);
	    1 ->
		skip_64_m_mail_fetch_toc(Rest, 0, 0, F@_1, TrUserData);
	    2 ->
		skip_length_delimited_m_mail_fetch_toc(Rest, 0, 0, F@_1,
						       TrUserData);
	    3 ->
		skip_group_m_mail_fetch_toc(Rest, Key bsr 3, 0, F@_1,
					    TrUserData);
	    5 ->
		skip_32_m_mail_fetch_toc(Rest, 0, 0, F@_1, TrUserData)
	  end
    end;
dg_read_field_def_m_mail_fetch_toc(<<>>, 0, 0, R1,
				   TrUserData) ->
    #m_mail_fetch_toc{mail_id =
			  lists_reverse(R1, TrUserData)}.

d_field_m_mail_fetch_toc_mail_id(<<1:1, X:7,
				   Rest/binary>>,
				 N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_m_mail_fetch_toc_mail_id(Rest, N + 7,
				     X bsl N + Acc, F@_1, TrUserData);
d_field_m_mail_fetch_toc_mail_id(<<0:1, X:7,
				   Rest/binary>>,
				 N, Acc, Prev, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    dfp_read_field_def_m_mail_fetch_toc(RestF, 0, 0,
					cons(NewFValue, Prev, TrUserData),
					TrUserData).

d_pfield_m_mail_fetch_toc_mail_id(<<1:1, X:7,
				    Rest/binary>>,
				  N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_pfield_m_mail_fetch_toc_mail_id(Rest, N + 7,
				      X bsl N + Acc, F@_1, TrUserData);
d_pfield_m_mail_fetch_toc_mail_id(<<0:1, X:7,
				    Rest/binary>>,
				  N, Acc, E, TrUserData) ->
    Len = X bsl N + Acc,
    <<PackedBytes:Len/binary, Rest2/binary>> = Rest,
    NewSeq =
	d_packed_field_m_mail_fetch_toc_mail_id(PackedBytes, 0,
						0, E, TrUserData),
    dfp_read_field_def_m_mail_fetch_toc(Rest2, 0, 0, NewSeq,
					TrUserData).

d_packed_field_m_mail_fetch_toc_mail_id(<<1:1, X:7,
					  Rest/binary>>,
					N, Acc, AccSeq, TrUserData)
    when N < 57 ->
    d_packed_field_m_mail_fetch_toc_mail_id(Rest, N + 7,
					    X bsl N + Acc, AccSeq, TrUserData);
d_packed_field_m_mail_fetch_toc_mail_id(<<0:1, X:7,
					  Rest/binary>>,
					N, Acc, AccSeq, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    d_packed_field_m_mail_fetch_toc_mail_id(RestF, 0, 0,
					    [NewFValue | AccSeq], TrUserData);
d_packed_field_m_mail_fetch_toc_mail_id(<<>>, 0, 0,
					AccSeq, _) ->
    AccSeq.

skip_varint_m_mail_fetch_toc(<<1:1, _:7, Rest/binary>>,
			     Z1, Z2, F@_1, TrUserData) ->
    skip_varint_m_mail_fetch_toc(Rest, Z1, Z2, F@_1,
				 TrUserData);
skip_varint_m_mail_fetch_toc(<<0:1, _:7, Rest/binary>>,
			     Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_mail_fetch_toc(Rest, Z1, Z2, F@_1,
					TrUserData).

skip_length_delimited_m_mail_fetch_toc(<<1:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_mail_fetch_toc(Rest, N + 7,
					   X bsl N + Acc, F@_1, TrUserData);
skip_length_delimited_m_mail_fetch_toc(<<0:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_mail_fetch_toc(Rest2, 0, 0, F@_1,
					TrUserData).

skip_group_m_mail_fetch_toc(Bin, FNum, Z2, F@_1,
			    TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_mail_fetch_toc(Rest, 0, Z2, F@_1,
					TrUserData).

skip_32_m_mail_fetch_toc(<<_:32, Rest/binary>>, Z1, Z2,
			 F@_1, TrUserData) ->
    dfp_read_field_def_m_mail_fetch_toc(Rest, Z1, Z2, F@_1,
					TrUserData).

skip_64_m_mail_fetch_toc(<<_:64, Rest/binary>>, Z1, Z2,
			 F@_1, TrUserData) ->
    dfp_read_field_def_m_mail_fetch_toc(Rest, Z1, Z2, F@_1,
					TrUserData).

decode_msg_m_mail_delete_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_mail_delete_tos(Bin, 0, 0,
					 id([], TrUserData), TrUserData).

dfp_read_field_def_m_mail_delete_tos(<<10,
				       Rest/binary>>,
				     Z1, Z2, F@_1, TrUserData) ->
    d_pfield_m_mail_delete_tos_mail_ids(Rest, Z1, Z2, F@_1,
					TrUserData);
dfp_read_field_def_m_mail_delete_tos(<<8, Rest/binary>>,
				     Z1, Z2, F@_1, TrUserData) ->
    d_field_m_mail_delete_tos_mail_ids(Rest, Z1, Z2, F@_1,
				       TrUserData);
dfp_read_field_def_m_mail_delete_tos(<<>>, 0, 0, R1,
				     TrUserData) ->
    #m_mail_delete_tos{mail_ids =
			   lists_reverse(R1, TrUserData)};
dfp_read_field_def_m_mail_delete_tos(Other, Z1, Z2,
				     F@_1, TrUserData) ->
    dg_read_field_def_m_mail_delete_tos(Other, Z1, Z2, F@_1,
					TrUserData).

dg_read_field_def_m_mail_delete_tos(<<1:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_mail_delete_tos(Rest, N + 7,
					X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_m_mail_delete_tos(<<0:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      10 ->
	  d_pfield_m_mail_delete_tos_mail_ids(Rest, 0, 0, F@_1,
					      TrUserData);
      8 ->
	  d_field_m_mail_delete_tos_mail_ids(Rest, 0, 0, F@_1,
					     TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_mail_delete_tos(Rest, 0, 0, F@_1,
					      TrUserData);
	    1 ->
		skip_64_m_mail_delete_tos(Rest, 0, 0, F@_1, TrUserData);
	    2 ->
		skip_length_delimited_m_mail_delete_tos(Rest, 0, 0,
							F@_1, TrUserData);
	    3 ->
		skip_group_m_mail_delete_tos(Rest, Key bsr 3, 0, F@_1,
					     TrUserData);
	    5 ->
		skip_32_m_mail_delete_tos(Rest, 0, 0, F@_1, TrUserData)
	  end
    end;
dg_read_field_def_m_mail_delete_tos(<<>>, 0, 0, R1,
				    TrUserData) ->
    #m_mail_delete_tos{mail_ids =
			   lists_reverse(R1, TrUserData)}.

d_field_m_mail_delete_tos_mail_ids(<<1:1, X:7,
				     Rest/binary>>,
				   N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_m_mail_delete_tos_mail_ids(Rest, N + 7,
				       X bsl N + Acc, F@_1, TrUserData);
d_field_m_mail_delete_tos_mail_ids(<<0:1, X:7,
				     Rest/binary>>,
				   N, Acc, Prev, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    dfp_read_field_def_m_mail_delete_tos(RestF, 0, 0,
					 cons(NewFValue, Prev, TrUserData),
					 TrUserData).

d_pfield_m_mail_delete_tos_mail_ids(<<1:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_pfield_m_mail_delete_tos_mail_ids(Rest, N + 7,
					X bsl N + Acc, F@_1, TrUserData);
d_pfield_m_mail_delete_tos_mail_ids(<<0:1, X:7,
				      Rest/binary>>,
				    N, Acc, E, TrUserData) ->
    Len = X bsl N + Acc,
    <<PackedBytes:Len/binary, Rest2/binary>> = Rest,
    NewSeq =
	d_packed_field_m_mail_delete_tos_mail_ids(PackedBytes,
						  0, 0, E, TrUserData),
    dfp_read_field_def_m_mail_delete_tos(Rest2, 0, 0,
					 NewSeq, TrUserData).

d_packed_field_m_mail_delete_tos_mail_ids(<<1:1, X:7,
					    Rest/binary>>,
					  N, Acc, AccSeq, TrUserData)
    when N < 57 ->
    d_packed_field_m_mail_delete_tos_mail_ids(Rest, N + 7,
					      X bsl N + Acc, AccSeq,
					      TrUserData);
d_packed_field_m_mail_delete_tos_mail_ids(<<0:1, X:7,
					    Rest/binary>>,
					  N, Acc, AccSeq, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    d_packed_field_m_mail_delete_tos_mail_ids(RestF, 0, 0,
					      [NewFValue | AccSeq], TrUserData);
d_packed_field_m_mail_delete_tos_mail_ids(<<>>, 0, 0,
					  AccSeq, _) ->
    AccSeq.

skip_varint_m_mail_delete_tos(<<1:1, _:7, Rest/binary>>,
			      Z1, Z2, F@_1, TrUserData) ->
    skip_varint_m_mail_delete_tos(Rest, Z1, Z2, F@_1,
				  TrUserData);
skip_varint_m_mail_delete_tos(<<0:1, _:7, Rest/binary>>,
			      Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_mail_delete_tos(Rest, Z1, Z2, F@_1,
					 TrUserData).

skip_length_delimited_m_mail_delete_tos(<<1:1, X:7,
					  Rest/binary>>,
					N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_mail_delete_tos(Rest, N + 7,
					    X bsl N + Acc, F@_1, TrUserData);
skip_length_delimited_m_mail_delete_tos(<<0:1, X:7,
					  Rest/binary>>,
					N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_mail_delete_tos(Rest2, 0, 0, F@_1,
					 TrUserData).

skip_group_m_mail_delete_tos(Bin, FNum, Z2, F@_1,
			     TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_mail_delete_tos(Rest, 0, Z2, F@_1,
					 TrUserData).

skip_32_m_mail_delete_tos(<<_:32, Rest/binary>>, Z1, Z2,
			  F@_1, TrUserData) ->
    dfp_read_field_def_m_mail_delete_tos(Rest, Z1, Z2, F@_1,
					 TrUserData).

skip_64_m_mail_delete_tos(<<_:64, Rest/binary>>, Z1, Z2,
			  F@_1, TrUserData) ->
    dfp_read_field_def_m_mail_delete_tos(Rest, Z1, Z2, F@_1,
					 TrUserData).

decode_msg_m_mail_delete_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_mail_delete_toc(Bin, 0, 0,
					 id([], TrUserData), TrUserData).

dfp_read_field_def_m_mail_delete_toc(<<10,
				       Rest/binary>>,
				     Z1, Z2, F@_1, TrUserData) ->
    d_pfield_m_mail_delete_toc_mail_ids(Rest, Z1, Z2, F@_1,
					TrUserData);
dfp_read_field_def_m_mail_delete_toc(<<8, Rest/binary>>,
				     Z1, Z2, F@_1, TrUserData) ->
    d_field_m_mail_delete_toc_mail_ids(Rest, Z1, Z2, F@_1,
				       TrUserData);
dfp_read_field_def_m_mail_delete_toc(<<>>, 0, 0, R1,
				     TrUserData) ->
    #m_mail_delete_toc{mail_ids =
			   lists_reverse(R1, TrUserData)};
dfp_read_field_def_m_mail_delete_toc(Other, Z1, Z2,
				     F@_1, TrUserData) ->
    dg_read_field_def_m_mail_delete_toc(Other, Z1, Z2, F@_1,
					TrUserData).

dg_read_field_def_m_mail_delete_toc(<<1:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_mail_delete_toc(Rest, N + 7,
					X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_m_mail_delete_toc(<<0:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      10 ->
	  d_pfield_m_mail_delete_toc_mail_ids(Rest, 0, 0, F@_1,
					      TrUserData);
      8 ->
	  d_field_m_mail_delete_toc_mail_ids(Rest, 0, 0, F@_1,
					     TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_mail_delete_toc(Rest, 0, 0, F@_1,
					      TrUserData);
	    1 ->
		skip_64_m_mail_delete_toc(Rest, 0, 0, F@_1, TrUserData);
	    2 ->
		skip_length_delimited_m_mail_delete_toc(Rest, 0, 0,
							F@_1, TrUserData);
	    3 ->
		skip_group_m_mail_delete_toc(Rest, Key bsr 3, 0, F@_1,
					     TrUserData);
	    5 ->
		skip_32_m_mail_delete_toc(Rest, 0, 0, F@_1, TrUserData)
	  end
    end;
dg_read_field_def_m_mail_delete_toc(<<>>, 0, 0, R1,
				    TrUserData) ->
    #m_mail_delete_toc{mail_ids =
			   lists_reverse(R1, TrUserData)}.

d_field_m_mail_delete_toc_mail_ids(<<1:1, X:7,
				     Rest/binary>>,
				   N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_m_mail_delete_toc_mail_ids(Rest, N + 7,
				       X bsl N + Acc, F@_1, TrUserData);
d_field_m_mail_delete_toc_mail_ids(<<0:1, X:7,
				     Rest/binary>>,
				   N, Acc, Prev, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    dfp_read_field_def_m_mail_delete_toc(RestF, 0, 0,
					 cons(NewFValue, Prev, TrUserData),
					 TrUserData).

d_pfield_m_mail_delete_toc_mail_ids(<<1:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_pfield_m_mail_delete_toc_mail_ids(Rest, N + 7,
					X bsl N + Acc, F@_1, TrUserData);
d_pfield_m_mail_delete_toc_mail_ids(<<0:1, X:7,
				      Rest/binary>>,
				    N, Acc, E, TrUserData) ->
    Len = X bsl N + Acc,
    <<PackedBytes:Len/binary, Rest2/binary>> = Rest,
    NewSeq =
	d_packed_field_m_mail_delete_toc_mail_ids(PackedBytes,
						  0, 0, E, TrUserData),
    dfp_read_field_def_m_mail_delete_toc(Rest2, 0, 0,
					 NewSeq, TrUserData).

d_packed_field_m_mail_delete_toc_mail_ids(<<1:1, X:7,
					    Rest/binary>>,
					  N, Acc, AccSeq, TrUserData)
    when N < 57 ->
    d_packed_field_m_mail_delete_toc_mail_ids(Rest, N + 7,
					      X bsl N + Acc, AccSeq,
					      TrUserData);
d_packed_field_m_mail_delete_toc_mail_ids(<<0:1, X:7,
					    Rest/binary>>,
					  N, Acc, AccSeq, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    d_packed_field_m_mail_delete_toc_mail_ids(RestF, 0, 0,
					      [NewFValue | AccSeq], TrUserData);
d_packed_field_m_mail_delete_toc_mail_ids(<<>>, 0, 0,
					  AccSeq, _) ->
    AccSeq.

skip_varint_m_mail_delete_toc(<<1:1, _:7, Rest/binary>>,
			      Z1, Z2, F@_1, TrUserData) ->
    skip_varint_m_mail_delete_toc(Rest, Z1, Z2, F@_1,
				  TrUserData);
skip_varint_m_mail_delete_toc(<<0:1, _:7, Rest/binary>>,
			      Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_mail_delete_toc(Rest, Z1, Z2, F@_1,
					 TrUserData).

skip_length_delimited_m_mail_delete_toc(<<1:1, X:7,
					  Rest/binary>>,
					N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_mail_delete_toc(Rest, N + 7,
					    X bsl N + Acc, F@_1, TrUserData);
skip_length_delimited_m_mail_delete_toc(<<0:1, X:7,
					  Rest/binary>>,
					N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_mail_delete_toc(Rest2, 0, 0, F@_1,
					 TrUserData).

skip_group_m_mail_delete_toc(Bin, FNum, Z2, F@_1,
			     TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_mail_delete_toc(Rest, 0, Z2, F@_1,
					 TrUserData).

skip_32_m_mail_delete_toc(<<_:32, Rest/binary>>, Z1, Z2,
			  F@_1, TrUserData) ->
    dfp_read_field_def_m_mail_delete_toc(Rest, Z1, Z2, F@_1,
					 TrUserData).

skip_64_m_mail_delete_toc(<<_:64, Rest/binary>>, Z1, Z2,
			  F@_1, TrUserData) ->
    dfp_read_field_def_m_mail_delete_toc(Rest, Z1, Z2, F@_1,
					 TrUserData).

decode_msg_p_mail(Bin, TrUserData) ->
    dfp_read_field_def_p_mail(Bin, 0, 0,
			      id(undefined, TrUserData),
			      id(undefined, TrUserData),
			      id(undefined, TrUserData),
			      id(undefined, TrUserData),
...
dfp_read_field_def_p_mail(<<8, Rest/binary>>, Z1, Z2,
			  F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
			  TrUserData) ->
    d_field_p_mail_id(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4,
		      F@_5, F@_6, F@_7, F@_8, F@_9, TrUserData);
dfp_read_field_def_p_mail(<<16, Rest/binary>>, Z1, Z2,
			  F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
			  TrUserData) ->
    d_field_p_mail_type(Rest, Z1, Z2, F@_1, F@_2, F@_3,
			F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, TrUserData);
dfp_read_field_def_p_mail(<<26, Rest/binary>>, Z1, Z2,
			  F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
			  TrUserData) ->
    d_field_p_mail_title(Rest, Z1, Z2, F@_1, F@_2, F@_3,
			 F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, TrUserData);
dfp_read_field_def_p_mail(<<34, Rest/binary>>, Z1, Z2,
			  F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
			  TrUserData) ->
    d_field_p_mail_from(Rest, Z1, Z2, F@_1, F@_2, F@_3,
			F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, TrUserData);
dfp_read_field_def_p_mail(<<40, Rest/binary>>, Z1, Z2,
			  F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
			  TrUserData) ->
    d_field_p_mail_send(Rest, Z1, Z2, F@_1, F@_2, F@_3,
			F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, TrUserData);
dfp_read_field_def_p_mail(<<48, Rest/binary>>, Z1, Z2,
			  F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
			  TrUserData) ->
    d_field_p_mail_expire(Rest, Z1, Z2, F@_1, F@_2, F@_3,
			  F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, TrUserData);
dfp_read_field_def_p_mail(<<56, Rest/binary>>, Z1, Z2,
			  F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
			  TrUserData) ->
    d_field_p_mail_read(Rest, Z1, Z2, F@_1, F@_2, F@_3,
			F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, TrUserData);
dfp_read_field_def_p_mail(<<64, Rest/binary>>, Z1, Z2,
			  F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
			  TrUserData) ->
    d_field_p_mail_attach(Rest, Z1, Z2, F@_1, F@_2, F@_3,
			  F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, TrUserData);
dfp_read_field_def_p_mail(<<72, Rest/binary>>, Z1, Z2,
			  F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
			  TrUserData) ->
    d_field_p_mail_fetch(Rest, Z1, Z2, F@_1, F@_2, F@_3,
			 F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, TrUserData);
dfp_read_field_def_p_mail(<<>>, 0, 0, F@_1, F@_2, F@_3,
			  F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, _) ->
    #p_mail{id = F@_1, type = F@_2, title = F@_3,
	    from = F@_4, send = F@_5, expire = F@_6, read = F@_7,
	    attach = F@_8, fetch = F@_9};
dfp_read_field_def_p_mail(Other, Z1, Z2, F@_1, F@_2,
			  F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
			  TrUserData) ->
    dg_read_field_def_p_mail(Other, Z1, Z2, F@_1, F@_2,
			     F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
			     TrUserData).

dg_read_field_def_p_mail(<<1:1, X:7, Rest/binary>>, N,
			 Acc, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8,
			 F@_9, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_p_mail(Rest, N + 7, X bsl N + Acc,
			     F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8,
			     F@_9, TrUserData);
dg_read_field_def_p_mail(<<0:1, X:7, Rest/binary>>, N,
			 Acc, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8,
			 F@_9, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_p_mail_id(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4,
			    F@_5, F@_6, F@_7, F@_8, F@_9, TrUserData);
      16 ->
	  d_field_p_mail_type(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4,
			      F@_5, F@_6, F@_7, F@_8, F@_9, TrUserData);
      26 ->
	  d_field_p_mail_title(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4,
			       F@_5, F@_6, F@_7, F@_8, F@_9, TrUserData);
      34 ->
	  d_field_p_mail_from(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4,
			      F@_5, F@_6, F@_7, F@_8, F@_9, TrUserData);
      40 ->
	  d_field_p_mail_send(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4,
			      F@_5, F@_6, F@_7, F@_8, F@_9, TrUserData);
      48 ->
	  d_field_p_mail_expire(Rest, 0, 0, F@_1, F@_2, F@_3,
				F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, TrUserData);
      56 ->
	  d_field_p_mail_read(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4,
			      F@_5, F@_6, F@_7, F@_8, F@_9, TrUserData);
      64 ->
	  d_field_p_mail_attach(Rest, 0, 0, F@_1, F@_2, F@_3,
				F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, TrUserData);
      72 ->
	  d_field_p_mail_fetch(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4,
			       F@_5, F@_6, F@_7, F@_8, F@_9, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_p_mail(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4,
				   F@_5, F@_6, F@_7, F@_8, F@_9, TrUserData);
	    1 ->
		skip_64_p_mail(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4, F@_5,
			       F@_6, F@_7, F@_8, F@_9, TrUserData);
	    2 ->
		skip_length_delimited_p_mail(Rest, 0, 0, F@_1, F@_2,
					     F@_3, F@_4, F@_5, F@_6, F@_7, F@_8,
					     F@_9, TrUserData);
	    3 ->
		skip_group_p_mail(Rest, Key bsr 3, 0, F@_1, F@_2, F@_3,
				  F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
				  TrUserData);
	    5 ->
		skip_32_p_mail(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4, F@_5,
			       F@_6, F@_7, F@_8, F@_9, TrUserData)
	  end
    end;
dg_read_field_def_p_mail(<<>>, 0, 0, F@_1, F@_2, F@_3,
			 F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, _) ->
    #p_mail{id = F@_1, type = F@_2, title = F@_3,
	    from = F@_4, send = F@_5, expire = F@_6, read = F@_7,
	    attach = F@_8, fetch = F@_9}.

d_field_p_mail_id(<<1:1, X:7, Rest/binary>>, N, Acc,
		  F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
		  TrUserData)
    when N < 57 ->
    d_field_p_mail_id(Rest, N + 7, X bsl N + Acc, F@_1,
		      F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
		      TrUserData);
d_field_p_mail_id(<<0:1, X:7, Rest/binary>>, N, Acc, _,
		  F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
		  TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    dfp_read_field_def_p_mail(RestF, 0, 0, NewFValue, F@_2,
			      F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
			      TrUserData).

d_field_p_mail_type(<<1:1, X:7, Rest/binary>>, N, Acc,
		    F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
		    TrUserData)
    when N < 57 ->
    d_field_p_mail_type(Rest, N + 7, X bsl N + Acc, F@_1,
			F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
			TrUserData);
d_field_p_mail_type(<<0:1, X:7, Rest/binary>>, N, Acc,
    ...
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    dfp_read_field_def_p_mail(RestF, 0, 0, F@_1, NewFValue,
			      F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
			      TrUserData).

d_field_p_mail_title(<<1:1, X:7, Rest/binary>>, N, Acc,
		     F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
		     TrUserData)
    when N < 57 ->
    d_field_p_mail_title(Rest, N + 7, X bsl N + Acc, F@_1,
			 F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
			 TrUserData);
d_field_p_mail_title(<<0:1, X:7, Rest/binary>>, N, Acc,
    ...
    dfp_read_field_def_p_mail(RestF, 0, 0, F@_1, F@_2,
			      NewFValue, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
			      TrUserData).

d_field_p_mail_from(<<1:1, X:7, Rest/binary>>, N, Acc,
		    F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
		    TrUserData)
    when N < 57 ->
    d_field_p_mail_from(Rest, N + 7, X bsl N + Acc, F@_1,
			F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
			TrUserData);
d_field_p_mail_from(<<0:1, X:7, Rest/binary>>, N, Acc,
    ...
    dfp_read_field_def_p_mail(RestF, 0, 0, F@_1, F@_2, F@_3,
			      NewFValue, F@_5, F@_6, F@_7, F@_8, F@_9,
			      TrUserData).

d_field_p_mail_send(<<1:1, X:7, Rest/binary>>, N, Acc,
		    F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
		    TrUserData)
    when N < 57 ->
    d_field_p_mail_send(Rest, N + 7, X bsl N + Acc, F@_1,
			F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
			TrUserData);
d_field_p_mail_send(<<0:1, X:7, Rest/binary>>, N, Acc,
    ...
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    dfp_read_field_def_p_mail(RestF, 0, 0, F@_1, F@_2, F@_3,
			      F@_4, NewFValue, F@_6, F@_7, F@_8, F@_9,
			      TrUserData).

d_field_p_mail_expire(<<1:1, X:7, Rest/binary>>, N, Acc,
		      F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
		      TrUserData)
    when N < 57 ->
    d_field_p_mail_expire(Rest, N + 7, X bsl N + Acc, F@_1,
			  F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
			  TrUserData);
d_field_p_mail_expire(<<0:1, X:7, Rest/binary>>, N, Acc,
...
d_field_p_mail_read(<<1:1, X:7, Rest/binary>>, N, Acc,
		    F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
		    TrUserData)
    when N < 57 ->
    d_field_p_mail_read(Rest, N + 7, X bsl N + Acc, F@_1,
			F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
			TrUserData);
d_field_p_mail_read(<<0:1, X:7, Rest/binary>>, N, Acc,
...
d_field_p_mail_attach(<<1:1, X:7, Rest/binary>>, N, Acc,
		      F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
		      TrUserData)
    when N < 57 ->
    d_field_p_mail_attach(Rest, N + 7, X bsl N + Acc, F@_1,
			  F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
			  TrUserData);
d_field_p_mail_attach(<<0:1, X:7, Rest/binary>>, N, Acc,
...
d_field_p_mail_fetch(<<1:1, X:7, Rest/binary>>, N, Acc,
		     F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
		     TrUserData)
    when N < 57 ->
    d_field_p_mail_fetch(Rest, N + 7, X bsl N + Acc, F@_1,
			 F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
			 TrUserData);
d_field_p_mail_fetch(<<0:1, X:7, Rest/binary>>, N, Acc,
...
skip_varint_p_mail(<<1:1, _:7, Rest/binary>>, Z1, Z2,
		   F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
		   TrUserData) ->
    skip_varint_p_mail(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4,
		       F@_5, F@_6, F@_7, F@_8, F@_9, TrUserData);
skip_varint_p_mail(<<0:1, _:7, Rest/binary>>, Z1, Z2,
		   F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
		   TrUserData) ->
    dfp_read_field_def_p_mail(Rest, Z1, Z2, F@_1, F@_2,
			      F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
			      TrUserData).

skip_length_delimited_p_mail(<<1:1, X:7, Rest/binary>>,
			     N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7,
			     F@_8, F@_9, TrUserData)
    when N < 57 ->
    skip_length_delimited_p_mail(Rest, N + 7, X bsl N + Acc,
				 F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8,
				 F@_9, TrUserData);
skip_length_delimited_p_mail(<<0:1, X:7, Rest/binary>>,
			     N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7,
			     F@_8, F@_9, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_p_mail(Rest2, 0, 0, F@_1, F@_2, F@_3,
			      F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, TrUserData).

skip_group_p_mail(Bin, FNum, Z2, F@_1, F@_2, F@_3, F@_4,
		  F@_5, F@_6, F@_7, F@_8, F@_9, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_p_mail(Rest, 0, Z2, F@_1, F@_2, F@_3,
			      F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, TrUserData).

skip_32_p_mail(<<_:32, Rest/binary>>, Z1, Z2, F@_1,
	       F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
	       TrUserData) ->
    dfp_read_field_def_p_mail(Rest, Z1, Z2, F@_1, F@_2,
			      F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
...
skip_64_p_mail(<<_:64, Rest/binary>>, Z1, Z2, F@_1,
	       F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
	       TrUserData) ->
    dfp_read_field_def_p_mail(Rest, Z1, Z2, F@_1, F@_2,
			      F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
...
'decode_msg_map<int32,int64>'(Bin, TrUserData) ->
    'dfp_read_field_def_map<int32,int64>'(Bin, 0, 0,
					  id(0, TrUserData), id(0, TrUserData),
					  TrUserData).

'dfp_read_field_def_map<int32,int64>'(<<8,
					Rest/binary>>,
				      Z1, Z2, F@_1, F@_2, TrUserData) ->
    'd_field_map<int32,int64>_key'(Rest, Z1, Z2, F@_1, F@_2,
				   TrUserData);
'dfp_read_field_def_map<int32,int64>'(<<16,
					Rest/binary>>,
				      Z1, Z2, F@_1, F@_2, TrUserData) ->
    'd_field_map<int32,int64>_value'(Rest, Z1, Z2, F@_1,
				     F@_2, TrUserData);
'dfp_read_field_def_map<int32,int64>'(<<>>, 0, 0, F@_1,
				      F@_2, _) ->
    #{key => F@_1, value => F@_2};
'dfp_read_field_def_map<int32,int64>'(Other, Z1, Z2,
				      F@_1, F@_2, TrUserData) ->
    'dg_read_field_def_map<int32,int64>'(Other, Z1, Z2,
					 F@_1, F@_2, TrUserData).

'dg_read_field_def_map<int32,int64>'(<<1:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, F@_2, TrUserData)
    when N < 32 - 7 ->
    'dg_read_field_def_map<int32,int64>'(Rest, N + 7,
					 X bsl N + Acc, F@_1, F@_2, TrUserData);
'dg_read_field_def_map<int32,int64>'(<<0:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, F@_2, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  'd_field_map<int32,int64>_key'(Rest, 0, 0, F@_1, F@_2,
					 TrUserData);
      16 ->
	  'd_field_map<int32,int64>_value'(Rest, 0, 0, F@_1, F@_2,
					   TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		'skip_varint_map<int32,int64>'(Rest, 0, 0, F@_1, F@_2,
					       TrUserData);
	    1 ->
		'skip_64_map<int32,int64>'(Rest, 0, 0, F@_1, F@_2,
					   TrUserData);
	    2 ->
		'skip_length_delimited_map<int32,int64>'(Rest, 0, 0,
							 F@_1, F@_2,
							 TrUserData);
	    3 ->
		'skip_group_map<int32,int64>'(Rest, Key bsr 3, 0, F@_1,
					      F@_2, TrUserData);
	    5 ->
		'skip_32_map<int32,int64>'(Rest, 0, 0, F@_1, F@_2,
					   TrUserData)
	  end
    end;
'dg_read_field_def_map<int32,int64>'(<<>>, 0, 0, F@_1,
				     F@_2, _) ->
    #{key => F@_1, value => F@_2}.

'd_field_map<int32,int64>_key'(<<1:1, X:7,
				 Rest/binary>>,
			       N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    'd_field_map<int32,int64>_key'(Rest, N + 7,
				   X bsl N + Acc, F@_1, F@_2, TrUserData);
'd_field_map<int32,int64>_key'(<<0:1, X:7,
				 Rest/binary>>,
    ...
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    'dfp_read_field_def_map<int32,int64>'(RestF, 0, 0,
					  NewFValue, F@_2, TrUserData).

'd_field_map<int32,int64>_value'(<<1:1, X:7,
				   Rest/binary>>,
				 N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    'd_field_map<int32,int64>_value'(Rest, N + 7,
				     X bsl N + Acc, F@_1, F@_2, TrUserData);
'd_field_map<int32,int64>_value'(<<0:1, X:7,
				   Rest/binary>>,
    ...
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    'dfp_read_field_def_map<int32,int64>'(RestF, 0, 0, F@_1,
					  NewFValue, TrUserData).

'skip_varint_map<int32,int64>'(<<1:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, F@_1, F@_2, TrUserData) ->
    'skip_varint_map<int32,int64>'(Rest, Z1, Z2, F@_1, F@_2,
				   TrUserData);
'skip_varint_map<int32,int64>'(<<0:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, F@_1, F@_2, TrUserData) ->
    'dfp_read_field_def_map<int32,int64>'(Rest, Z1, Z2,
					  F@_1, F@_2, TrUserData).

'skip_length_delimited_map<int32,int64>'(<<1:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    'skip_length_delimited_map<int32,int64>'(Rest, N + 7,
					     X bsl N + Acc, F@_1, F@_2,
					     TrUserData);
'skip_length_delimited_map<int32,int64>'(<<0:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, F@_2, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    'dfp_read_field_def_map<int32,int64>'(Rest2, 0, 0, F@_1,
					  F@_2, TrUserData).

'skip_group_map<int32,int64>'(Bin, FNum, Z2, F@_1, F@_2,
			      TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    'dfp_read_field_def_map<int32,int64>'(Rest, 0, Z2, F@_1,
					  F@_2, TrUserData).

'skip_32_map<int32,int64>'(<<_:32, Rest/binary>>, Z1,
			   Z2, F@_1, F@_2, TrUserData) ->
    'dfp_read_field_def_map<int32,int64>'(Rest, Z1, Z2,
					  F@_1, F@_2, TrUserData).

'skip_64_map<int32,int64>'(<<_:64, Rest/binary>>, Z1,
			   Z2, F@_1, F@_2, TrUserData) ->
    'dfp_read_field_def_map<int32,int64>'(Rest, Z1, Z2,
					  F@_1, F@_2, TrUserData).
...
merge_msgs(Prev, New, MsgName, Opts) ->
    ...
    case MsgName of
      m_mail_info_tos ->
	  merge_msg_m_mail_info_tos(Prev, New, TrUserData);
      m_mail_info_toc ->
	  merge_msg_m_mail_info_toc(Prev, New, TrUserData);
      m_mail_list_tos ->
	  merge_msg_m_mail_list_tos(Prev, New, TrUserData);
      m_mail_list_toc ->
	  merge_msg_m_mail_list_toc(Prev, New, TrUserData);
      m_mail_recv_toc ->
	  merge_msg_m_mail_recv_toc(Prev, New, TrUserData);
      m_mail_read_tos ->
	  merge_msg_m_mail_read_tos(Prev, New, TrUserData);
      m_mail_read_toc ->
	  merge_msg_m_mail_read_toc(Prev, New, TrUserData);
      m_mail_fetch_tos ->
	  merge_msg_m_mail_fetch_tos(Prev, New, TrUserData);
      m_mail_fetch_toc ->
	  merge_msg_m_mail_fetch_toc(Prev, New, TrUserData);
      m_mail_delete_tos ->
	  merge_msg_m_mail_delete_tos(Prev, New, TrUserData);
      m_mail_delete_toc ->
	  merge_msg_m_mail_delete_toc(Prev, New, TrUserData);
      p_mail -> merge_msg_p_mail(Prev, New, TrUserData);
      p_role_base ->
...
-compile({nowarn_unused_function,merge_msg_m_mail_info_tos/3}).
merge_msg_m_mail_info_tos(_Prev, New, _TrUserData) ->
    New.

-compile({nowarn_unused_function,merge_msg_m_mail_info_toc/3}).
merge_msg_m_mail_info_toc(#m_mail_info_toc{},
			  #m_mail_info_toc{unread = NFunread}, _) ->
    #m_mail_info_toc{unread = NFunread}.

-compile({nowarn_unused_function,merge_msg_m_mail_list_tos/3}).
merge_msg_m_mail_list_tos(_Prev, New, _TrUserData) ->
    New.

-compile({nowarn_unused_function,merge_msg_m_mail_list_toc/3}).
merge_msg_m_mail_list_toc(#m_mail_list_toc{mails =
					       PFmails},
			  #m_mail_list_toc{mails = NFmails}, TrUserData) ->
    #m_mail_list_toc{mails =
			 if PFmails /= undefined, NFmails /= undefined ->
				'erlang_++'(PFmails, NFmails, TrUserData);
			    PFmails == undefined -> NFmails;
			    NFmails == undefined -> PFmails
			 end}.

-compile({nowarn_unused_function,merge_msg_m_mail_recv_toc/3}).
merge_msg_m_mail_recv_toc(#m_mail_recv_toc{mail =
					       PFmail},
			  #m_mail_recv_toc{mail = NFmail}, TrUserData) ->
    #m_mail_recv_toc{mail =
			 merge_msg_p_mail(PFmail, NFmail, TrUserData)}.

-compile({nowarn_unused_function,merge_msg_m_mail_read_tos/3}).
merge_msg_m_mail_read_tos(#m_mail_read_tos{},
			  #m_mail_read_tos{mail_id = NFmail_id}, _) ->
    #m_mail_read_tos{mail_id = NFmail_id}.

-compile({nowarn_unused_function,merge_msg_m_mail_read_toc/3}).
merge_msg_m_mail_read_toc(#m_mail_read_toc{items =
					       PFitems,
					   money = PFmoney},
			  #m_mail_read_toc{mail_id = NFmail_id, text = NFtext,
					   items = NFitems, money = NFmoney},
			  TrUserData) ->
    #m_mail_read_toc{mail_id = NFmail_id, text = NFtext,
		     items =
			 ...
			 if PFmoney /= undefined, NFmoney /= undefined ->
				'tr_merge_m_mail_read_toc.money'(PFmoney,
								 NFmoney,
								 TrUserData);
...
-compile({nowarn_unused_function,merge_msg_m_mail_fetch_tos/3}).
merge_msg_m_mail_fetch_tos(#m_mail_fetch_tos{},
			   #m_mail_fetch_tos{mail_id = NFmail_id}, _) ->
    #m_mail_fetch_tos{mail_id = NFmail_id}.

-compile({nowarn_unused_function,merge_msg_m_mail_fetch_toc/3}).
merge_msg_m_mail_fetch_toc(#m_mail_fetch_toc{mail_id =
						 PFmail_id},
			   #m_mail_fetch_toc{mail_id = NFmail_id},
			   TrUserData) ->
    #m_mail_fetch_toc{mail_id =
			  if PFmail_id /= undefined, NFmail_id /= undefined ->
				 'erlang_++'(PFmail_id, NFmail_id, TrUserData);
			     PFmail_id == undefined -> NFmail_id;
			     NFmail_id == undefined -> PFmail_id
			  end}.

-compile({nowarn_unused_function,merge_msg_m_mail_delete_tos/3}).
merge_msg_m_mail_delete_tos(#m_mail_delete_tos{mail_ids
						   = PFmail_ids},
			    #m_mail_delete_tos{mail_ids = NFmail_ids},
			    TrUserData) ->
    #m_mail_delete_tos{mail_ids =
			   if PFmail_ids /= undefined,
			      NFmail_ids /= undefined ->
				  'erlang_++'(PFmail_ids, NFmail_ids,
					      TrUserData);
			      PFmail_ids == undefined -> NFmail_ids;
			      NFmail_ids == undefined -> PFmail_ids
			   end}.

-compile({nowarn_unused_function,merge_msg_m_mail_delete_toc/3}).
merge_msg_m_mail_delete_toc(#m_mail_delete_toc{mail_ids
						   = PFmail_ids},
			    #m_mail_delete_toc{mail_ids = NFmail_ids},
			    TrUserData) ->
    #m_mail_delete_toc{mail_ids =
			   if PFmail_ids /= undefined,
			      NFmail_ids /= undefined ->
...
-compile({nowarn_unused_function,merge_msg_p_mail/3}).
merge_msg_p_mail(#p_mail{},
		 #p_mail{id = NFid, type = NFtype, title = NFtitle,
			 from = NFfrom, send = NFsend, expire = NFexpire,
			 read = NFread, attach = NFattach, fetch = NFfetch},
		 _) ->
    #p_mail{id = NFid, type = NFtype, title = NFtitle,
	    from = NFfrom, send = NFsend, expire = NFexpire,
	    read = NFread, attach = NFattach, fetch = NFfetch}.
...
verify_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
      m_mail_info_tos ->
	  v_msg_m_mail_info_tos(Msg, [MsgName], TrUserData);
      m_mail_info_toc ->
	  v_msg_m_mail_info_toc(Msg, [MsgName], TrUserData);
      m_mail_list_tos ->
	  v_msg_m_mail_list_tos(Msg, [MsgName], TrUserData);
      m_mail_list_toc ->
	  v_msg_m_mail_list_toc(Msg, [MsgName], TrUserData);
      m_mail_recv_toc ->
	  v_msg_m_mail_recv_toc(Msg, [MsgName], TrUserData);
      m_mail_read_tos ->
	  v_msg_m_mail_read_tos(Msg, [MsgName], TrUserData);
      m_mail_read_toc ->
	  v_msg_m_mail_read_toc(Msg, [MsgName], TrUserData);
      m_mail_fetch_tos ->
	  v_msg_m_mail_fetch_tos(Msg, [MsgName], TrUserData);
      m_mail_fetch_toc ->
	  v_msg_m_mail_fetch_toc(Msg, [MsgName], TrUserData);
      m_mail_delete_tos ->
	  v_msg_m_mail_delete_tos(Msg, [MsgName], TrUserData);
      m_mail_delete_toc ->
	  v_msg_m_mail_delete_toc(Msg, [MsgName], TrUserData);
      p_mail -> v_msg_p_mail(Msg, [MsgName], TrUserData);
      p_role_base ->
...
-compile({nowarn_unused_function,v_msg_m_mail_info_tos/3}).
-dialyzer({nowarn_function,v_msg_m_mail_info_tos/3}).
v_msg_m_mail_info_tos(#m_mail_info_tos{}, _Path, _) ->
    ok;
v_msg_m_mail_info_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_mail_info_tos}, X, Path).

-compile({nowarn_unused_function,v_msg_m_mail_info_toc/3}).
-dialyzer({nowarn_function,v_msg_m_mail_info_toc/3}).
v_msg_m_mail_info_toc(#m_mail_info_toc{unread = F1},
		      Path, TrUserData) ->
    v_type_bool(F1, [unread | Path], TrUserData), ok;
v_msg_m_mail_info_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_mail_info_toc}, X, Path).

-compile({nowarn_unused_function,v_msg_m_mail_list_tos/3}).
-dialyzer({nowarn_function,v_msg_m_mail_list_tos/3}).
v_msg_m_mail_list_tos(#m_mail_list_tos{}, _Path, _) ->
    ok;
v_msg_m_mail_list_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_mail_list_tos}, X, Path).

-compile({nowarn_unused_function,v_msg_m_mail_list_toc/3}).
-dialyzer({nowarn_function,v_msg_m_mail_list_toc/3}).
v_msg_m_mail_list_toc(#m_mail_list_toc{mails = F1},
		      Path, TrUserData) ->
    if is_list(F1) ->
	   _ = [v_msg_p_mail(Elem, [mails | Path], TrUserData)
		|| Elem <- F1],
	   ok;
       true ->
	   mk_type_error({invalid_list_of, {msg, p_mail}}, F1,
			 [mails | Path])
    end,
    ok;
v_msg_m_mail_list_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_mail_list_toc}, X, Path).

-compile({nowarn_unused_function,v_msg_m_mail_recv_toc/3}).
-dialyzer({nowarn_function,v_msg_m_mail_recv_toc/3}).
v_msg_m_mail_recv_toc(#m_mail_recv_toc{mail = F1}, Path,
		      TrUserData) ->
    v_msg_p_mail(F1, [mail | Path], TrUserData), ok;
v_msg_m_mail_recv_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_mail_recv_toc}, X, Path).

-compile({nowarn_unused_function,v_msg_m_mail_read_tos/3}).
-dialyzer({nowarn_function,v_msg_m_mail_read_tos/3}).
v_msg_m_mail_read_tos(#m_mail_read_tos{mail_id = F1},
		      Path, TrUserData) ->
    v_type_int32(F1, [mail_id | Path], TrUserData), ok;
v_msg_m_mail_read_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_mail_read_tos}, X, Path).

-compile({nowarn_unused_function,v_msg_m_mail_read_toc/3}).
-dialyzer({nowarn_function,v_msg_m_mail_read_toc/3}).
v_msg_m_mail_read_toc(#m_mail_read_toc{mail_id = F1,
				       text = F2, items = F3, money = F4},
		      Path, TrUserData) ->
    v_type_int32(F1, [mail_id | Path], TrUserData),
    v_type_string(F2, [text | Path], TrUserData),
    if is_list(F3) ->
	   _ = [v_msg_p_item(Elem, [items | Path], TrUserData)
		|| Elem <- F3],
	   ok;
       true ->
	   mk_type_error({invalid_list_of, {msg, p_item}}, F3,
			 [items | Path])
    end,
    'v_map<int32,int64>'(F4, [money | Path], TrUserData),
    ok;
v_msg_m_mail_read_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_mail_read_toc}, X, Path).

-compile({nowarn_unused_function,v_msg_m_mail_fetch_tos/3}).
-dialyzer({nowarn_function,v_msg_m_mail_fetch_tos/3}).
v_msg_m_mail_fetch_tos(#m_mail_fetch_tos{mail_id = F1},
		       Path, TrUserData) ->
    v_type_int32(F1, [mail_id | Path], TrUserData), ok;
v_msg_m_mail_fetch_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_mail_fetch_tos}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_mail_fetch_toc/3}).
-dialyzer({nowarn_function,v_msg_m_mail_fetch_toc/3}).
v_msg_m_mail_fetch_toc(#m_mail_fetch_toc{mail_id = F1},
		       Path, TrUserData) ->
    if is_list(F1) ->
	   _ = [v_type_int32(Elem, [mail_id | Path], TrUserData)
		|| Elem <- F1],
	   ok;
       true ->
    ...
    ok;
v_msg_m_mail_fetch_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_mail_fetch_toc}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_mail_delete_tos/3}).
-dialyzer({nowarn_function,v_msg_m_mail_delete_tos/3}).
v_msg_m_mail_delete_tos(#m_mail_delete_tos{mail_ids =
					       F1},
			Path, TrUserData) ->
    if is_list(F1) ->
	   _ = [v_type_int32(Elem, [mail_ids | Path], TrUserData)
		|| Elem <- F1],
	   ok;
       true ->
	   mk_type_error({invalid_list_of, int32}, F1,
    ...
    ok;
v_msg_m_mail_delete_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_mail_delete_tos}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_mail_delete_toc/3}).
-dialyzer({nowarn_function,v_msg_m_mail_delete_toc/3}).
v_msg_m_mail_delete_toc(#m_mail_delete_toc{mail_ids =
					       F1},
			Path, TrUserData) ->
    if is_list(F1) ->
	   _ = [v_type_int32(Elem, [mail_ids | Path], TrUserData)
    ...
    ok;
v_msg_m_mail_delete_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_mail_delete_toc}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_p_mail/3}).
-dialyzer({nowarn_function,v_msg_p_mail/3}).
v_msg_p_mail(#p_mail{id = F1, type = F2, title = F3,
		     from = F4, send = F5, expire = F6, read = F7,
		     attach = F8, fetch = F9},
	     Path, TrUserData) ->
    ...
    v_type_int32(F5, [send | Path], TrUserData),
    v_type_int32(F6, [expire | Path], TrUserData),
    v_type_bool(F7, [read | Path], TrUserData),
    v_type_bool(F8, [attach | Path], TrUserData),
    v_type_bool(F9, [fetch | Path], TrUserData),
    ok;
v_msg_p_mail(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, p_mail}, X, Path).
...
-compile({nowarn_unused_function,'v_map<int32,int64>'/3}).
-dialyzer({nowarn_function,'v_map<int32,int64>'/3}).
'v_map<int32,int64>'(M, Path, TrUserData)
    when is_map(M) ->
    [begin
       v_type_int32(Key, [key | Path], TrUserData),
       v_type_int64(Value, [value | Path], TrUserData)
     end
     || {Key, Value} <- maps:to_list(M)],
    ok;
'v_map<int32,int64>'(X, Path, _TrUserData) ->
...
-compile({inline,'tr_decode_init_default_m_mail_read_toc.money'/2}).
'tr_decode_init_default_m_mail_read_toc.money'(_, _) ->
    mt_empty_map_m().

-compile({inline,'tr_merge_m_mail_read_toc.money'/3}).
'tr_merge_m_mail_read_toc.money'(X1, X2, _) ->
    mt_merge_maps_m(X1, X2).

-compile({inline,'tr_decode_repeated_finalize_m_mail_read_toc.money'/2}).
'tr_decode_repeated_finalize_m_mail_read_toc.money'(L,
						    TrUserData) ->
    id(L, TrUserData).

-compile({inline,'tr_encode_m_mail_read_toc.money'/2}).
'tr_encode_m_mail_read_toc.money'(X, _) ->
    mt_map_to_list_m(X).

-compile({inline,'tr_decode_repeated_add_elem_m_mail_read_toc.money'/3}).
'tr_decode_repeated_add_elem_m_mail_read_toc.money'(Elem,
						    L, _) ->
    mt_add_item_m(Elem, L).
...
-compile({inline,'tr_encode_m_mail_read_toc.money[x]'/2}).
'tr_encode_m_mail_read_toc.money[x]'(X, _) ->
    mt_maptuple_to_pseudomsg_m(X).
...
get_msg_defs() ->
    [{{msg, m_mail_info_tos}, []},
     {{msg, m_mail_info_toc},
      [#field{name = unread, fnum = 1, rnum = 2, type = bool,
	      occurrence = required, opts = []}]},
     {{msg, m_mail_list_tos}, []},
     {{msg, m_mail_list_toc},
      [#field{name = mails, fnum = 1, rnum = 2,
	      type = {msg, p_mail}, occurrence = repeated,
	      opts = []}]},
     {{msg, m_mail_recv_toc},
      [#field{name = mail, fnum = 1, rnum = 2,
	      type = {msg, p_mail}, occurrence = required,
	      opts = []}]},
     {{msg, m_mail_read_tos},
      [#field{name = mail_id, fnum = 1, rnum = 2,
     ...
     {{msg, m_mail_read_toc},
      [#field{name = mail_id, fnum = 1, rnum = 2,
       ...
       #field{name = text, fnum = 2, rnum = 3, type = string,
	      occurrence = required, opts = []},
       #field{name = items, fnum = 3, rnum = 4,
	      type = {msg, p_item}, occurrence = repeated, opts = []},
       #field{name = money, fnum = 4, rnum = 5,
	      type = {map, int32, int64}, occurrence = repeated,
	      opts = []}]},
     {{msg, m_mail_fetch_tos},
      [#field{name = mail_id, fnum = 1, rnum = 2,
	      type = int32, occurrence = required, opts = []}]},
     {{msg, m_mail_fetch_toc},
      [#field{name = mail_id, fnum = 1, rnum = 2,
	      type = int32, occurrence = repeated, opts = []}]},
     {{msg, m_mail_delete_tos},
      [#field{name = mail_ids, fnum = 1, rnum = 2,
	      type = int32, occurrence = repeated, opts = []}]},
     {{msg, m_mail_delete_toc},
      [#field{name = mail_ids, fnum = 1, rnum = 2,
	      type = int32, occurrence = repeated, opts = []}]},
     {{msg, p_mail},
      [#field{name = id, fnum = 1, rnum = 2, type = int32,
       ...
       #field{name = type, fnum = 2, rnum = 3, type = int32,
	      occurrence = required, opts = []},
       #field{name = title, fnum = 3, rnum = 4, type = string,
	      occurrence = required, opts = []},
       #field{name = from, fnum = 4, rnum = 5, type = string,
	      occurrence = required, opts = []},
       #field{name = send, fnum = 5, rnum = 6, type = int32,
	      occurrence = required, opts = []},
       #field{name = expire, fnum = 6, rnum = 7, type = int32,
	      occurrence = required, opts = []},
       #field{name = read, fnum = 7, rnum = 8, type = bool,
	      occurrence = required, opts = []},
       #field{name = attach, fnum = 8, rnum = 9, type = bool,
	      occurrence = required, opts = []},
       #field{name = fetch, fnum = 9, rnum = 10, type = bool,
	      occurrence = required, opts = []}]},
     {{msg, p_role_base},
...
get_msg_names() ->
    [m_mail_info_tos, m_mail_info_toc, m_mail_list_tos,
     m_mail_list_toc, m_mail_recv_toc, m_mail_read_tos,
     m_mail_read_toc, m_mail_fetch_tos, m_mail_fetch_toc,
     m_mail_delete_tos, m_mail_delete_toc, p_mail,
...
find_msg_def(m_mail_info_tos) -> [];
find_msg_def(m_mail_info_toc) ->
    [#field{name = unread, fnum = 1, rnum = 2, type = bool,
	    occurrence = required, opts = []}];
find_msg_def(m_mail_list_tos) -> [];
find_msg_def(m_mail_list_toc) ->
    [#field{name = mails, fnum = 1, rnum = 2,
	    type = {msg, p_mail}, occurrence = repeated,
	    opts = []}];
find_msg_def(m_mail_recv_toc) ->
    [#field{name = mail, fnum = 1, rnum = 2,
	    type = {msg, p_mail}, occurrence = required,
	    opts = []}];
find_msg_def(m_mail_read_tos) ->
    [#field{name = mail_id, fnum = 1, rnum = 2,
	    type = int32, occurrence = required, opts = []}];
find_msg_def(m_mail_read_toc) ->
    [#field{name = mail_id, fnum = 1, rnum = 2,
	    type = int32, occurrence = required, opts = []},
     #field{name = text, fnum = 2, rnum = 3, type = string,
	    occurrence = required, opts = []},
     ...
     #field{name = money, fnum = 4, rnum = 5,
	    type = {map, int32, int64}, occurrence = repeated,
	    opts = []}];
find_msg_def(m_mail_fetch_tos) ->
    [#field{name = mail_id, fnum = 1, rnum = 2,
	    type = int32, occurrence = required, opts = []}];
find_msg_def(m_mail_fetch_toc) ->
    [#field{name = mail_id, fnum = 1, rnum = 2,
	    type = int32, occurrence = repeated, opts = []}];
find_msg_def(m_mail_delete_tos) ->
    [#field{name = mail_ids, fnum = 1, rnum = 2,
	    type = int32, occurrence = repeated, opts = []}];
find_msg_def(m_mail_delete_toc) ->
    [#field{name = mail_ids, fnum = 1, rnum = 2,
	    type = int32, occurrence = repeated, opts = []}];
find_msg_def(p_mail) ->
    [#field{name = id, fnum = 1, rnum = 2, type = int32,
