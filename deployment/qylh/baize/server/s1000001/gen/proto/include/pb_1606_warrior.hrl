...
-ifndef(pb_1606_warrior).
-define(pb_1606_warrior, true).

-define(pb_1606_warrior_gpb_version, "4.5.1").

-ifndef('M_WARRIOR_INFO_TOS_PB_H').
-define('M_WARRIOR_INFO_TOS_PB_H', true).
-record(m_warrior_info_tos,
        {
        }).
-endif.

-ifndef('M_WARRIOR_INFO_TOC_PB_H').
-define('M_WARRIOR_INFO_TOC_PB_H', true).
-record(m_warrior_info_toc,
        {end_time               :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_WARRIOR_UPDATE_TOC_PB_H').
-define('M_WARRIOR_UPDATE_TOC_PB_H', true).
-record(m_warrior_update_toc,
        {floor                  :: integer(),       % = 1, 32 bits
         score                  :: integer(),       % = 2, 32 bits
         kill                   :: integer()        % = 3, 32 bits
        }).
-endif.

-ifndef('M_WARRIOR_END_TOC_PB_H').
-define('M_WARRIOR_END_TOC_PB_H', true).
-record(m_warrior_end_toc,
        {rank                   :: integer(),       % = 1, 32 bits
         score                  :: integer(),       % = 2, 32 bits
         floor                  :: integer(),       % = 3, 32 bits
         is_cross               :: integer()        % = 4, 32 bits
        }).
-endif.

-ifndef('M_WARRIOR_RANK_TOS_PB_H').
-define('M_WARRIOR_RANK_TOS_PB_H', true).
-record(m_warrior_rank_tos,
        {num                    :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_WARRIOR_RANK_TOC_PB_H').
-define('M_WARRIOR_RANK_TOC_PB_H', true).
-record(m_warrior_rank_toc,
        {list = []              :: [pb_1606_warrior:p_ranking()] | undefined, % = 1
         mine                   :: pb_1606_warrior:p_ranking() % = 2
        }).
-endif.

-ifndef('M_WARRIOR_CREEP_TOC_PB_H').
-define('M_WARRIOR_CREEP_TOC_PB_H', true).
-record(m_warrior_creep_toc,
...
-record(p_role_base,
        {id                     :: non_neg_integer(), % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1606_warrior:p_aspect()} | undefined, % = 8
         ...
         icon                   :: pb_1606_warrior:p_icon() | undefined, % = 17
...
-record(p_item,
        {uid                    :: integer(),       % = 1, 32 bits
         ...
         gender                 :: integer(),       % = 7, 32 bits
         score                  :: integer() | undefined, % = 8, 32 bits
         equip                  :: pb_1606_warrior:p_equip() | undefined, % = 9
         pet                    :: pb_1606_warrior:p_pet() | undefined, % = 10
...
-record(p_equip,
        {base                   :: pb_1606_warrior:p_attr(), % = 1
         rare1                  :: pb_1606_warrior:p_attr() | undefined, % = 2
         rare2                  :: pb_1606_warrior:p_attr() | undefined, % = 3
         rare3                  :: pb_1606_warrior:p_attr() | undefined, % = 4
         marriage               :: pb_1606_warrior:p_marriage() | undefined, % = 5
         ...
         refine = []            :: [pb_1606_warrior:p_refine()] | undefined, % = 11
         suite = #{}            :: #{integer() := integer()} | undefined, % = 12
         combine = []           :: [pb_1606_warrior:p_item()] | undefined % = 13
        }).
-endif.
...
-record(p_marriage,
        {husband_id             :: non_neg_integer() | undefined, % = 1, 32 bits
         ...
         rare                   :: pb_1606_warrior:p_attr() | undefined % = 5
        }).
-endif.
...
-record(p_actor,
        {uid                    :: non_neg_integer(), % = 1, 32 bits
         ...
         coord                  :: pb_1606_warrior:p_coord(), % = 4
         state                  :: integer(),       % = 5, 32 bits
         stargs = #{}           :: #{integer() := iolist()} | undefined, % = 6
         role                   :: pb_1606_warrior:p_role() | undefined, % = 7
         creep                  :: pb_1606_warrior:p_creep() | undefined, % = 8
         drop                   :: pb_1606_warrior:p_drop() | undefined % = 9
        }).
-endif.
...
-record(p_role,
        {career                 :: integer(),       % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1606_warrior:p_aspect()} | undefined, % = 5
         ...
         icon                   :: pb_1606_warrior:p_icon() | undefined % = 25
        }).
-endif.
...
-record(p_creep,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         buffs = []             :: [pb_1606_warrior:p_buff()] | undefined, % = 6
         dir                    :: integer(),       % = 7, 32 bits
         dest                   :: pb_1606_warrior:p_coord(), % = 8
...
-record(p_npc,
        {id                     :: integer(),       % = 1, 32 bits
         coord                  :: pb_1606_warrior:p_coord() % = 2
        }).
-endif.
...
-record(p_drop,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         coord                  :: pb_1606_warrior:p_coord() | undefined, % = 5
...
-record(p_ranking,
        {base                   :: pb_1606_warrior:p_role_base() | undefined, % = 1
