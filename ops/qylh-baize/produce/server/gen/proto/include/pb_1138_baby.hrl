...
-ifndef(pb_1138_baby).
-define(pb_1138_baby, true).

-define(pb_1138_baby_gpb_version, "4.5.1").

-ifndef('M_BABY_INFO_TOS_PB_H').
-define('M_BABY_INFO_TOS_PB_H', true).
-record(m_baby_info_tos,
        {
        }).
-endif.

-ifndef('M_BABY_INFO_TOC_PB_H').
-define('M_BABY_INFO_TOC_PB_H', true).
-record(m_baby_info_toc,
        {is_hide                :: boolean() | 0 | 1 | undefined, % = 1
         babies = []            :: [pb_1138_baby:p_baby()] | undefined, % = 2
         progress = #{}         :: #{integer() := integer()} | undefined % = 3
        }).
-endif.

-ifndef('M_BABY_UPLEVEL_TOS_PB_H').
-define('M_BABY_UPLEVEL_TOS_PB_H', true).
-record(m_baby_uplevel_tos,
        {gender                 :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_BABY_UPLEVEL_TOC_PB_H').
-define('M_BABY_UPLEVEL_TOC_PB_H', true).
-record(m_baby_uplevel_toc,
        {
        }).
-endif.

-ifndef('M_BABY_PLAY_TOS_PB_H').
-define('M_BABY_PLAY_TOS_PB_H', true).
-record(m_baby_play_tos,
        {gender                 :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_BABY_PLAY_TOC_PB_H').
-define('M_BABY_PLAY_TOC_PB_H', true).
-record(m_baby_play_toc,
        {
        }).
-endif.

-ifndef('M_BABY_ORDER_INFO_TOS_PB_H').
-define('M_BABY_ORDER_INFO_TOS_PB_H', true).
-record(m_baby_order_info_tos,
        {
        }).
-endif.

-ifndef('M_BABY_ORDER_INFO_TOC_PB_H').
-define('M_BABY_ORDER_INFO_TOC_PB_H', true).
-record(m_baby_order_info_toc,
        {babies = []            :: [pb_1138_baby:p_baby_order()] | undefined, % = 1
         figure                 :: integer() | undefined % = 2, 32 bits
        }).
-endif.

-ifndef('M_BABY_UP_ORDER_TOS_PB_H').
-define('M_BABY_UP_ORDER_TOS_PB_H', true).
-record(m_baby_up_order_tos,
        {id                     :: integer(),       % = 1, 32 bits
         item_id                :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_BABY_UP_ORDER_TOC_PB_H').
-define('M_BABY_UP_ORDER_TOC_PB_H', true).
-record(m_baby_up_order_toc,
        {
        }).
-endif.

-ifndef('M_BABY_ACTIVE_TOS_PB_H').
-define('M_BABY_ACTIVE_TOS_PB_H', true).
-record(m_baby_active_tos,
        {id                     :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_BABY_ACTIVE_TOC_PB_H').
-define('M_BABY_ACTIVE_TOC_PB_H', true).
-record(m_baby_active_toc,
        {
        }).
-endif.

-ifndef('M_BABY_FIGURE_TOS_PB_H').
-define('M_BABY_FIGURE_TOS_PB_H', true).
-record(m_baby_figure_tos,
        {id                     :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_BABY_FIGURE_TOC_PB_H').
-define('M_BABY_FIGURE_TOC_PB_H', true).
-record(m_baby_figure_toc,
        {
        }).
-endif.

-ifndef('M_BABY_HIDE_TOS_PB_H').
-define('M_BABY_HIDE_TOS_PB_H', true).
-record(m_baby_hide_tos,
        {hide                   :: boolean() | 0 | 1 % = 1
        }).
-endif.

-ifndef('M_BABY_HIDE_TOC_PB_H').
-define('M_BABY_HIDE_TOC_PB_H', true).
-record(m_baby_hide_toc,
        {
        }).
-endif.

-ifndef('M_BABY_LIKE_TOS_PB_H').
-define('M_BABY_LIKE_TOS_PB_H', true).
-record(m_baby_like_tos,
        {role_id                :: non_neg_integer() % = 1, 32 bits
        }).
-endif.

-ifndef('M_BABY_LIKE_TOC_PB_H').
-define('M_BABY_LIKE_TOC_PB_H', true).
-record(m_baby_like_toc,
        {role_id                :: non_neg_integer(), % = 1, 32 bits
         add_count              :: boolean() | 0 | 1 % = 2
        }).
-endif.

-ifndef('M_BABY_LIKE_RECORDS_TOS_PB_H').
-define('M_BABY_LIKE_RECORDS_TOS_PB_H', true).
-record(m_baby_like_records_tos,
        {
        }).
-endif.

-ifndef('M_BABY_LIKE_RECORDS_TOC_PB_H').
-define('M_BABY_LIKE_RECORDS_TOC_PB_H', true).
-record(m_baby_like_records_toc,
        {records = []           :: [pb_1138_baby:p_baby_like()] | undefined % = 1
        }).
-endif.

-ifndef('M_BABY_EQUIPS_TOS_PB_H').
-define('M_BABY_EQUIPS_TOS_PB_H', true).
-record(m_baby_equips_tos,
        {
        }).
-endif.

-ifndef('M_BABY_EQUIPS_TOC_PB_H').
-define('M_BABY_EQUIPS_TOC_PB_H', true).
-record(m_baby_equips_toc,
        {equips = []            :: [pb_1138_baby:p_item()] | undefined % = 1
        }).
-endif.

-ifndef('M_BABY_EQUIP_PUTON_TOS_PB_H').
-define('M_BABY_EQUIP_PUTON_TOS_PB_H', true).
-record(m_baby_equip_puton_tos,
        {uid                    :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_BABY_EQUIP_PUTON_TOC_PB_H').
-define('M_BABY_EQUIP_PUTON_TOC_PB_H', true).
-record(m_baby_equip_puton_toc,
        {slot                   :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_BABY_EQUIP_UPLEVEL_TOS_PB_H').
-define('M_BABY_EQUIP_UPLEVEL_TOS_PB_H', true).
-record(m_baby_equip_uplevel_tos,
        {slot                   :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_BABY_EQUIP_UPLEVEL_TOC_PB_H').
-define('M_BABY_EQUIP_UPLEVEL_TOC_PB_H', true).
-record(m_baby_equip_uplevel_toc,
        {slot                   :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_BABY_EQUIP_DECOMPOSE_TOS_PB_H').
-define('M_BABY_EQUIP_DECOMPOSE_TOS_PB_H', true).
-record(m_baby_equip_decompose_tos,
        {uid = []               :: [integer()] | undefined % = 1, 32 bits
        }).
-endif.

-ifndef('M_BABY_EQUIP_DECOMPOSE_TOC_PB_H').
-define('M_BABY_EQUIP_DECOMPOSE_TOC_PB_H', true).
-record(m_baby_equip_decompose_toc,
        {
        }).
-endif.

-ifndef('M_BABY_LIKE_INFO_TOS_PB_H').
-define('M_BABY_LIKE_INFO_TOS_PB_H', true).
-record(m_baby_like_info_tos,
        {role_id                :: non_neg_integer() % = 1, 32 bits
        }).
-endif.

-ifndef('M_BABY_LIKE_INFO_TOC_PB_H').
-define('M_BABY_LIKE_INFO_TOC_PB_H', true).
-record(m_baby_like_info_toc,
        {count                  :: integer(),       % = 1, 32 bits
         baby                   :: pb_1138_baby:p_baby_order(), % = 2
         role_id                :: non_neg_integer(), % = 3, 32 bits
         role_name              :: iolist(),        % = 4
         wing_id                :: integer()        % = 5, 32 bits
        }).
-endif.

-ifndef('M_BABY_LIKE_RECORD_TOC_PB_H').
-define('M_BABY_LIKE_RECORD_TOC_PB_H', true).
-record(m_baby_like_record_toc,
        {record                 :: pb_1138_baby:p_baby_like() % = 1
        }).
-endif.

-ifndef('M_BABY_WING_TOS_PB_H').
-define('M_BABY_WING_TOS_PB_H', true).
-record(m_baby_wing_tos,
        {
        }).
-endif.

-ifndef('M_BABY_WING_TOC_PB_H').
-define('M_BABY_WING_TOC_PB_H', true).
-record(m_baby_wing_toc,
        {ids = #{}              :: #{integer() := integer()} | undefined, % = 1
         show_id                :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_BABY_WING_UPLEVEL_TOS_PB_H').
-define('M_BABY_WING_UPLEVEL_TOS_PB_H', true).
-record(m_baby_wing_uplevel_tos,
        {id                     :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_BABY_WING_UPLEVEL_TOC_PB_H').
-define('M_BABY_WING_UPLEVEL_TOC_PB_H', true).
-record(m_baby_wing_uplevel_toc,
        {id                     :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_BABY_WING_SHOW_TOS_PB_H').
-define('M_BABY_WING_SHOW_TOS_PB_H', true).
-record(m_baby_wing_show_tos,
        {id                     :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_BABY_WING_SHOW_TOC_PB_H').
-define('M_BABY_WING_SHOW_TOC_PB_H', true).
-record(m_baby_wing_show_toc,
        {id                     :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('P_BABY_PB_H').
-define('P_BABY_PB_H', true).
-record(p_baby,
        {gender                 :: integer(),       % = 1, 32 bits
         level                  :: integer() | undefined, % = 2, 32 bits
         play                   :: integer() | undefined, % = 3, 32 bits
         exp                    :: integer() | undefined % = 4, 32 bits
        }).
-endif.

-ifndef('P_BABY_ORDER_PB_H').
-define('P_BABY_ORDER_PB_H', true).
-record(p_baby_order,
        {id                     :: integer(),       % = 1, 32 bits
         order                  :: integer(),       % = 2, 32 bits
         exp                    :: integer(),       % = 3, 32 bits
         blood_type             :: integer(),       % = 4, 32 bits
         constellation          :: integer()        % = 5, 32 bits
        }).
-endif.

-ifndef('P_BABY_LIKE_PB_H').
-define('P_BABY_LIKE_PB_H', true).
-record(p_baby_like,
        {role_id                :: non_neg_integer(), % = 1, 32 bits
         role_name              :: iolist(),        % = 2
...
-record(p_role_base,
        {id                     :: non_neg_integer(), % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1138_baby:p_aspect()} | undefined, % = 8
         ...
         icon                   :: pb_1138_baby:p_icon() | undefined, % = 17
...
-record(p_item,
        {uid                    :: integer(),       % = 1, 32 bits
         ...
         gender                 :: integer(),       % = 7, 32 bits
         score                  :: integer() | undefined, % = 8, 32 bits
         equip                  :: pb_1138_baby:p_equip() | undefined, % = 9
         pet                    :: pb_1138_baby:p_pet() | undefined, % = 10
...
-record(p_equip,
        {base                   :: pb_1138_baby:p_attr(), % = 1
         rare1                  :: pb_1138_baby:p_attr() | undefined, % = 2
         rare2                  :: pb_1138_baby:p_attr() | undefined, % = 3
         rare3                  :: pb_1138_baby:p_attr() | undefined, % = 4
         marriage               :: pb_1138_baby:p_marriage() | undefined, % = 5
         ...
         refine = []            :: [pb_1138_baby:p_refine()] | undefined, % = 11
         suite = #{}            :: #{integer() := integer()} | undefined, % = 12
         combine = []           :: [pb_1138_baby:p_item()] | undefined % = 13
        }).
-endif.
...
-record(p_marriage,
        {husband_id             :: non_neg_integer() | undefined, % = 1, 32 bits
         ...
         rare                   :: pb_1138_baby:p_attr() | undefined % = 5
        }).
-endif.
...
-record(p_actor,
        {uid                    :: non_neg_integer(), % = 1, 32 bits
         ...
         coord                  :: pb_1138_baby:p_coord(), % = 4
         state                  :: integer(),       % = 5, 32 bits
         stargs = #{}           :: #{integer() := iolist()} | undefined, % = 6
         role                   :: pb_1138_baby:p_role() | undefined, % = 7
         creep                  :: pb_1138_baby:p_creep() | undefined, % = 8
         drop                   :: pb_1138_baby:p_drop() | undefined % = 9
        }).
-endif.
...
-record(p_role,
        {career                 :: integer(),       % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1138_baby:p_aspect()} | undefined, % = 5
         ...
         icon                   :: pb_1138_baby:p_icon() | undefined % = 25
        }).
-endif.
...
-record(p_creep,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         buffs = []             :: [pb_1138_baby:p_buff()] | undefined, % = 6
         dir                    :: integer(),       % = 7, 32 bits
         dest                   :: pb_1138_baby:p_coord(), % = 8
...
-record(p_drop,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         coord                  :: pb_1138_baby:p_coord() | undefined, % = 5
...
-record(p_ranking,
        {base                   :: pb_1138_baby:p_role_base() | undefined, % = 1
