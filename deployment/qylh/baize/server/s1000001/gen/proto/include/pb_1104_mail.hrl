...
-ifndef(pb_1104_mail).
-define(pb_1104_mail, true).

-define(pb_1104_mail_gpb_version, "4.5.1").

-ifndef('M_MAIL_INFO_TOS_PB_H').
-define('M_MAIL_INFO_TOS_PB_H', true).
-record(m_mail_info_tos,
        {
        }).
-endif.

-ifndef('M_MAIL_INFO_TOC_PB_H').
-define('M_MAIL_INFO_TOC_PB_H', true).
-record(m_mail_info_toc,
        {unread                 :: boolean() | 0 | 1 % = 1
        }).
-endif.

-ifndef('M_MAIL_LIST_TOS_PB_H').
-define('M_MAIL_LIST_TOS_PB_H', true).
-record(m_mail_list_tos,
        {
        }).
-endif.

-ifndef('M_MAIL_LIST_TOC_PB_H').
-define('M_MAIL_LIST_TOC_PB_H', true).
-record(m_mail_list_toc,
        {mails = []             :: [pb_1104_mail:p_mail()] | undefined % = 1
        }).
-endif.

-ifndef('M_MAIL_RECV_TOC_PB_H').
-define('M_MAIL_RECV_TOC_PB_H', true).
-record(m_mail_recv_toc,
        {mail                   :: pb_1104_mail:p_mail() % = 1
        }).
-endif.

-ifndef('M_MAIL_READ_TOS_PB_H').
-define('M_MAIL_READ_TOS_PB_H', true).
-record(m_mail_read_tos,
        {mail_id                :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_MAIL_READ_TOC_PB_H').
-define('M_MAIL_READ_TOC_PB_H', true).
-record(m_mail_read_toc,
        {mail_id                :: integer(),       % = 1, 32 bits
         text                   :: iolist(),        % = 2
         items = []             :: [pb_1104_mail:p_item()] | undefined, % = 3
         money = #{}            :: #{integer() := integer()} | undefined % = 4
        }).
-endif.

-ifndef('M_MAIL_FETCH_TOS_PB_H').
-define('M_MAIL_FETCH_TOS_PB_H', true).
-record(m_mail_fetch_tos,
        {mail_id                :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_MAIL_FETCH_TOC_PB_H').
-define('M_MAIL_FETCH_TOC_PB_H', true).
-record(m_mail_fetch_toc,
        {mail_id = []           :: [integer()] | undefined % = 1, 32 bits
        }).
-endif.

-ifndef('M_MAIL_DELETE_TOS_PB_H').
-define('M_MAIL_DELETE_TOS_PB_H', true).
-record(m_mail_delete_tos,
        {mail_ids = []          :: [integer()] | undefined % = 1, 32 bits
        }).
-endif.

-ifndef('M_MAIL_DELETE_TOC_PB_H').
-define('M_MAIL_DELETE_TOC_PB_H', true).
-record(m_mail_delete_toc,
        {mail_ids = []          :: [integer()] | undefined % = 1, 32 bits
        }).
-endif.
...
-record(p_mail,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         title                  :: iolist(),        % = 3
         from                   :: iolist(),        % = 4
         send                   :: integer(),       % = 5, 32 bits
         expire                 :: integer(),       % = 6, 32 bits
         read                   :: boolean() | 0 | 1, % = 7
         attach                 :: boolean() | 0 | 1, % = 8
         fetch                  :: boolean() | 0 | 1 % = 9
        }).
-endif.
...
-record(p_role_base,
        {id                     :: non_neg_integer(), % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1104_mail:p_aspect()} | undefined, % = 8
         ...
         icon                   :: pb_1104_mail:p_icon() | undefined, % = 17
...
-record(p_item,
        {uid                    :: integer(),       % = 1, 32 bits
         ...
         gender                 :: integer(),       % = 7, 32 bits
         score                  :: integer() | undefined, % = 8, 32 bits
         equip                  :: pb_1104_mail:p_equip() | undefined, % = 9
         pet                    :: pb_1104_mail:p_pet() | undefined, % = 10
...
-record(p_equip,
        {base                   :: pb_1104_mail:p_attr(), % = 1
         rare1                  :: pb_1104_mail:p_attr() | undefined, % = 2
         rare2                  :: pb_1104_mail:p_attr() | undefined, % = 3
         rare3                  :: pb_1104_mail:p_attr() | undefined, % = 4
         marriage               :: pb_1104_mail:p_marriage() | undefined, % = 5
         ...
         refine = []            :: [pb_1104_mail:p_refine()] | undefined, % = 11
         suite = #{}            :: #{integer() := integer()} | undefined, % = 12
         combine = []           :: [pb_1104_mail:p_item()] | undefined % = 13
        }).
-endif.
...
-record(p_marriage,
        {husband_id             :: non_neg_integer() | undefined, % = 1, 32 bits
         ...
         rare                   :: pb_1104_mail:p_attr() | undefined % = 5
        }).
-endif.
...
-record(p_actor,
        {uid                    :: non_neg_integer(), % = 1, 32 bits
         ...
         coord                  :: pb_1104_mail:p_coord(), % = 4
         state                  :: integer(),       % = 5, 32 bits
         stargs = #{}           :: #{integer() := iolist()} | undefined, % = 6
         role                   :: pb_1104_mail:p_role() | undefined, % = 7
         creep                  :: pb_1104_mail:p_creep() | undefined, % = 8
         drop                   :: pb_1104_mail:p_drop() | undefined % = 9
        }).
-endif.
...
-record(p_role,
        {career                 :: integer(),       % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1104_mail:p_aspect()} | undefined, % = 5
         ...
         icon                   :: pb_1104_mail:p_icon() | undefined % = 25
        }).
-endif.
...
-record(p_creep,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         buffs = []             :: [pb_1104_mail:p_buff()] | undefined, % = 6
         dir                    :: integer(),       % = 7, 32 bits
         dest                   :: pb_1104_mail:p_coord(), % = 8
...
-record(p_drop,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         coord                  :: pb_1104_mail:p_coord() | undefined, % = 5
...
-record(p_ranking,
        {base                   :: pb_1104_mail:p_role_base() | undefined, % = 1
