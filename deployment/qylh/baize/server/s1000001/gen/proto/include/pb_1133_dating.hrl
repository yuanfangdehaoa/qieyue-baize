...
-ifndef(pb_1133_dating).
-define(pb_1133_dating, true).

-define(pb_1133_dating_gpb_version, "4.5.1").

-ifndef('M_DATING_HALL_TOS_PB_H').
-define('M_DATING_HALL_TOS_PB_H', true).
-record(m_dating_hall_tos,
        {page                   :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_DATING_HALL_TOC_PB_H').
-define('M_DATING_HALL_TOC_PB_H', true).
-record(m_dating_hall_toc,
        {mine                   :: pb_1133_dating:p_dating(), % = 1
         list = []              :: [pb_1133_dating:p_dating()] | undefined, % = 2
         page                   :: integer()        % = 3, 32 bits
        }).
-endif.

-ifndef('M_DATING_TAG_TOS_PB_H').
-define('M_DATING_TAG_TOS_PB_H', true).
-record(m_dating_tag_tos,
        {tags = []              :: [integer()] | undefined % = 1, 32 bits
        }).
-endif.

-ifndef('M_DATING_TAG_TOC_PB_H').
-define('M_DATING_TAG_TOC_PB_H', true).
-record(m_dating_tag_toc,
        {tags = []              :: [integer()] | undefined % = 1, 32 bits
        }).
-endif.

-ifndef('M_DATING_FLIRT_TOS_PB_H').
-define('M_DATING_FLIRT_TOS_PB_H', true).
-record(m_dating_flirt_tos,
        {role_id                :: non_neg_integer() % = 1, 32 bits
        }).
-endif.

-ifndef('M_DATING_FLIRT_TOC_PB_H').
-define('M_DATING_FLIRT_TOC_PB_H', true).
-record(m_dating_flirt_toc,
        {
        }).
-endif.

-ifndef('M_DATING_MATCH_TOS_PB_H').
-define('M_DATING_MATCH_TOS_PB_H', true).
-record(m_dating_match_tos,
        {
        }).
-endif.

-ifndef('M_DATING_MATCH_TOC_PB_H').
-define('M_DATING_MATCH_TOC_PB_H', true).
-record(m_dating_match_toc,
        {role                   :: pb_1133_dating:p_role_base() % = 1
        }).
-endif.

-ifndef('P_DATING_PB_H').
-define('P_DATING_PB_H', true).
-record(p_dating,
        {base                   :: pb_1133_dating:p_role_base(), % = 1
         tags = []              :: [integer()] | undefined, % = 2, 32 bits
         flirted                :: integer(),       % = 3, 32 bits
         flowers = #{}          :: #{integer() := integer()} | undefined % = 4
        }).
-endif.
...
-record(p_role_base,
        {id                     :: non_neg_integer(), % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1133_dating:p_aspect()} | undefined, % = 8
         ...
         icon                   :: pb_1133_dating:p_icon() | undefined, % = 17
...
-record(p_item,
        {uid                    :: integer(),       % = 1, 32 bits
         ...
         gender                 :: integer(),       % = 7, 32 bits
         score                  :: integer() | undefined, % = 8, 32 bits
         equip                  :: pb_1133_dating:p_equip() | undefined, % = 9
         pet                    :: pb_1133_dating:p_pet() | undefined, % = 10
...
-record(p_equip,
        {base                   :: pb_1133_dating:p_attr(), % = 1
         rare1                  :: pb_1133_dating:p_attr() | undefined, % = 2
         rare2                  :: pb_1133_dating:p_attr() | undefined, % = 3
         rare3                  :: pb_1133_dating:p_attr() | undefined, % = 4
         marriage               :: pb_1133_dating:p_marriage() | undefined, % = 5
         ...
         refine = []            :: [pb_1133_dating:p_refine()] | undefined, % = 11
         suite = #{}            :: #{integer() := integer()} | undefined, % = 12
         combine = []           :: [pb_1133_dating:p_item()] | undefined % = 13
        }).
-endif.
...
-record(p_marriage,
        {husband_id             :: non_neg_integer() | undefined, % = 1, 32 bits
         ...
         rare                   :: pb_1133_dating:p_attr() | undefined % = 5
        }).
-endif.
...
-record(p_actor,
        {uid                    :: non_neg_integer(), % = 1, 32 bits
         ...
         coord                  :: pb_1133_dating:p_coord(), % = 4
         state                  :: integer(),       % = 5, 32 bits
         stargs = #{}           :: #{integer() := iolist()} | undefined, % = 6
         role                   :: pb_1133_dating:p_role() | undefined, % = 7
         creep                  :: pb_1133_dating:p_creep() | undefined, % = 8
         drop                   :: pb_1133_dating:p_drop() | undefined % = 9
        }).
-endif.
...
-record(p_role,
        {career                 :: integer(),       % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1133_dating:p_aspect()} | undefined, % = 5
         ...
         icon                   :: pb_1133_dating:p_icon() | undefined % = 25
        }).
-endif.
...
-record(p_creep,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         buffs = []             :: [pb_1133_dating:p_buff()] | undefined, % = 6
         dir                    :: integer(),       % = 7, 32 bits
         dest                   :: pb_1133_dating:p_coord(), % = 8
...
-record(p_npc,
        {id                     :: integer(),       % = 1, 32 bits
         coord                  :: pb_1133_dating:p_coord() % = 2
        }).
-endif.
...
-record(p_drop,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         coord                  :: pb_1133_dating:p_coord() | undefined, % = 5
...
-record(p_ranking,
        {base                   :: pb_1133_dating:p_role_base() | undefined, % = 1
