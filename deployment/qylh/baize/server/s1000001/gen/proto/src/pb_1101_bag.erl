...
%% message types
-type m_bag_info_tos() :: #m_bag_info_tos{}.

-type m_bag_info_toc() :: #m_bag_info_toc{}.

-type m_bag_open_tos() :: #m_bag_open_tos{}.

-type m_bag_open_toc() :: #m_bag_open_toc{}.

-type m_bag_update_toc() :: #m_bag_update_toc{}.
...
-export_type(['m_bag_info_tos'/0, 'm_bag_info_toc'/0, 'm_bag_open_tos'/0, 'm_bag_open_toc'/0, 'm_bag_update_toc'/0, 'p_role_base'/0, 'p_aspect'/0, 'p_attr'/0, 'p_item_base'/0, 'p_item'/0, 'p_equip'/0, 'p_pet'/0, 'p_marriage'/0, 'p_refine'/0, 'p_actor'/0, 'p_role'/0, 'p_creep'/0, 'p_npc'/0, 'p_drop'/0, 'p_buff'/0, 'p_coord'/0, 'p_icon'/0, 'p_ranking'/0, 'p_dropped'/0]).

-spec encode_msg(#m_bag_info_tos{} | #m_bag_info_toc{} | #m_bag_open_tos{} | #m_bag_open_toc{} | #m_bag_update_toc{} | #p_role_base{} | #p_aspect{} | #p_attr{} | #p_item_base{} | #p_item{} | #p_equip{} | #p_pet{} | #p_marriage{} | #p_refine{} | #p_actor{} | #p_role{} | #p_creep{} | #p_npc{} | #p_drop{} | #p_buff{} | #p_coord{} | #p_icon{} | #p_ranking{} | #p_dropped{}) -> binary().
encode_msg(Msg) when tuple_size(Msg) >= 1 ->
    encode_msg(Msg, element(1, Msg), []).

-spec encode_msg(#m_bag_info_tos{} | #m_bag_info_toc{} | #m_bag_open_tos{} | #m_bag_open_toc{} | #m_bag_update_toc{} | #p_role_base{} | #p_aspect{} | #p_attr{} | #p_item_base{} | #p_item{} | #p_equip{} | #p_pet{} | #p_marriage{} | #p_refine{} | #p_actor{} | #p_role{} | #p_creep{} | #p_npc{} | #p_drop{} | #p_buff{} | #p_coord{} | #p_icon{} | #p_ranking{} | #p_dropped{}, atom() | list()) -> binary().
...
encode_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
      m_bag_info_tos ->
	  encode_msg_m_bag_info_tos(id(Msg, TrUserData),
				    TrUserData);
      m_bag_info_toc ->
	  encode_msg_m_bag_info_toc(id(Msg, TrUserData),
				    TrUserData);
      m_bag_open_tos ->
	  encode_msg_m_bag_open_tos(id(Msg, TrUserData),
				    TrUserData);
      m_bag_open_toc ->
	  encode_msg_m_bag_open_toc(id(Msg, TrUserData),
				    TrUserData);
      m_bag_update_toc ->
	  encode_msg_m_bag_update_toc(id(Msg, TrUserData),
				      TrUserData);
      p_role_base ->
...
encode_msg_m_bag_info_tos(Msg, TrUserData) ->
    encode_msg_m_bag_info_tos(Msg, <<>>, TrUserData).


encode_msg_m_bag_info_tos(#m_bag_info_tos{bag_id = F1},
			  Bin, TrUserData) ->
    begin
...
encode_msg_m_bag_info_toc(Msg, TrUserData) ->
    encode_msg_m_bag_info_toc(Msg, <<>>, TrUserData).


encode_msg_m_bag_info_toc(#m_bag_info_toc{bag_id = F1,
					  opened = F2, items = F3},
			  Bin, TrUserData) ->
    B1 = begin
	   TrF1 = id(F1, TrUserData),
    ...
    begin
      ...
      if TrF3 == [] -> B2;
	 true ->
	     e_field_m_bag_info_toc_items(TrF3, B2, TrUserData)
      end
    end.

encode_msg_m_bag_open_tos(Msg, TrUserData) ->
    encode_msg_m_bag_open_tos(Msg, <<>>, TrUserData).


encode_msg_m_bag_open_tos(#m_bag_open_tos{bag_id = F1,
					  num = F2},
			  Bin, TrUserData) ->
    B1 = begin
	   TrF1 = id(F1, TrUserData),
...
encode_msg_m_bag_open_toc(Msg, TrUserData) ->
    encode_msg_m_bag_open_toc(Msg, <<>>, TrUserData).


encode_msg_m_bag_open_toc(#m_bag_open_toc{bag_id = F1,
					  num = F2},
			  Bin, TrUserData) ->
    B1 = begin
	   TrF1 = id(F1, TrUserData),
...
encode_msg_m_bag_update_toc(Msg, TrUserData) ->
    encode_msg_m_bag_update_toc(Msg, <<>>, TrUserData).


encode_msg_m_bag_update_toc(#m_bag_update_toc{add = F1,
					      del = F2, chg = F3, way = F4},
			    Bin, TrUserData) ->
    B1 = begin
	   TrF1 = id(F1, TrUserData),
	   if TrF1 == [] -> Bin;
	      true ->
		  e_field_m_bag_update_toc_add(TrF1, Bin, TrUserData)
	   end
	 end,
    B2 = begin
	   TrF2 = id(F2, TrUserData),
	   if TrF2 == [] -> B1;
	      true ->
		  e_field_m_bag_update_toc_del(TrF2, B1, TrUserData)
	   end
	 end,
    B3 = begin
	   TrF3 = 'tr_encode_m_bag_update_toc.chg'(F3, TrUserData),
	   if TrF3 == [] -> B2;
	      true ->
		  e_field_m_bag_update_toc_chg(TrF3, B2, TrUserData)
	   end
	 end,
    begin
...
e_mfield_m_bag_info_toc_items(Msg, Bin, TrUserData) ->
    SubBin = encode_msg_p_item_base(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

e_field_m_bag_info_toc_items([Elem | Rest], Bin,
			     TrUserData) ->
    Bin2 = <<Bin/binary, 26>>,
    Bin3 = e_mfield_m_bag_info_toc_items(id(Elem,
					    TrUserData),
					 Bin2, TrUserData),
    e_field_m_bag_info_toc_items(Rest, Bin3, TrUserData);
e_field_m_bag_info_toc_items([], Bin, _TrUserData) ->
    Bin.

e_mfield_m_bag_update_toc_add(Msg, Bin, TrUserData) ->
    SubBin = encode_msg_p_item_base(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

e_field_m_bag_update_toc_add([Elem | Rest], Bin,
			     TrUserData) ->
    Bin2 = <<Bin/binary, 10>>,
    Bin3 = e_mfield_m_bag_update_toc_add(id(Elem,
					    TrUserData),
					 Bin2, TrUserData),
    e_field_m_bag_update_toc_add(Rest, Bin3, TrUserData);
e_field_m_bag_update_toc_add([], Bin, _TrUserData) ->
    Bin.

e_field_m_bag_update_toc_del([Elem | Rest], Bin,
			     TrUserData) ->
    Bin2 = <<Bin/binary, 16>>,
    Bin3 = e_type_int32(id(Elem, TrUserData), Bin2,
			TrUserData),
    e_field_m_bag_update_toc_del(Rest, Bin3, TrUserData);
e_field_m_bag_update_toc_del([], Bin, _TrUserData) ->
    Bin.

e_mfield_m_bag_update_toc_chg(Msg, Bin, TrUserData) ->
    SubBin = 'encode_msg_map<int32,int32>'(Msg, <<>>,
					   TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

e_field_m_bag_update_toc_chg([Elem | Rest], Bin,
			     TrUserData) ->
    Bin2 = <<Bin/binary, 26>>,
    Bin3 =
	e_mfield_m_bag_update_toc_chg('tr_encode_m_bag_update_toc.chg[x]'(Elem,
									  TrUserData),
				      Bin2, TrUserData),
    e_field_m_bag_update_toc_chg(Rest, Bin3, TrUserData);
e_field_m_bag_update_toc_chg([], Bin, _TrUserData) ->
    Bin.
...
decode_msg_2_doit(m_bag_info_tos, Bin, TrUserData) ->
    id(decode_msg_m_bag_info_tos(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_bag_info_toc, Bin, TrUserData) ->
    id(decode_msg_m_bag_info_toc(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_bag_open_tos, Bin, TrUserData) ->
    id(decode_msg_m_bag_open_tos(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_bag_open_toc, Bin, TrUserData) ->
    id(decode_msg_m_bag_open_toc(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_bag_update_toc, Bin, TrUserData) ->
    id(decode_msg_m_bag_update_toc(Bin, TrUserData),
       TrUserData);
...
decode_msg_m_bag_info_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_bag_info_tos(Bin, 0, 0,
				      id(undefined, TrUserData), TrUserData).

dfp_read_field_def_m_bag_info_tos(<<8, Rest/binary>>,
				  Z1, Z2, F@_1, TrUserData) ->
    d_field_m_bag_info_tos_bag_id(Rest, Z1, Z2, F@_1,
				  TrUserData);
dfp_read_field_def_m_bag_info_tos(<<>>, 0, 0, F@_1,
				  _) ->
    #m_bag_info_tos{bag_id = F@_1};
dfp_read_field_def_m_bag_info_tos(Other, Z1, Z2, F@_1,
				  TrUserData) ->
    dg_read_field_def_m_bag_info_tos(Other, Z1, Z2, F@_1,
				     TrUserData).

dg_read_field_def_m_bag_info_tos(<<1:1, X:7,
				   Rest/binary>>,
				 N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_bag_info_tos(Rest, N + 7,
				     X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_m_bag_info_tos(<<0:1, X:7,
				   Rest/binary>>,
				 N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_bag_info_tos_bag_id(Rest, 0, 0, F@_1,
					TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_bag_info_tos(Rest, 0, 0, F@_1,
					   TrUserData);
	    1 ->
		skip_64_m_bag_info_tos(Rest, 0, 0, F@_1, TrUserData);
	    2 ->
		skip_length_delimited_m_bag_info_tos(Rest, 0, 0, F@_1,
						     TrUserData);
	    3 ->
		skip_group_m_bag_info_tos(Rest, Key bsr 3, 0, F@_1,
					  TrUserData);
	    5 ->
		skip_32_m_bag_info_tos(Rest, 0, 0, F@_1, TrUserData)
	  end
    end;
dg_read_field_def_m_bag_info_tos(<<>>, 0, 0, F@_1, _) ->
    #m_bag_info_tos{bag_id = F@_1}.

d_field_m_bag_info_tos_bag_id(<<1:1, X:7, Rest/binary>>,
			      N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_m_bag_info_tos_bag_id(Rest, N + 7,
				  X bsl N + Acc, F@_1, TrUserData);
d_field_m_bag_info_tos_bag_id(<<0:1, X:7, Rest/binary>>,
			      N, Acc, _, TrUserData) ->
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    dfp_read_field_def_m_bag_info_tos(RestF, 0, 0,
				      NewFValue, TrUserData).

skip_varint_m_bag_info_tos(<<1:1, _:7, Rest/binary>>,
			   Z1, Z2, F@_1, TrUserData) ->
    skip_varint_m_bag_info_tos(Rest, Z1, Z2, F@_1,
			       TrUserData);
skip_varint_m_bag_info_tos(<<0:1, _:7, Rest/binary>>,
			   Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_bag_info_tos(Rest, Z1, Z2, F@_1,
				      TrUserData).

skip_length_delimited_m_bag_info_tos(<<1:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_bag_info_tos(Rest, N + 7,
					 X bsl N + Acc, F@_1, TrUserData);
skip_length_delimited_m_bag_info_tos(<<0:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_bag_info_tos(Rest2, 0, 0, F@_1,
				      TrUserData).

skip_group_m_bag_info_tos(Bin, FNum, Z2, F@_1,
			  TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_bag_info_tos(Rest, 0, Z2, F@_1,
				      TrUserData).

skip_32_m_bag_info_tos(<<_:32, Rest/binary>>, Z1, Z2,
		       F@_1, TrUserData) ->
    dfp_read_field_def_m_bag_info_tos(Rest, Z1, Z2, F@_1,
				      TrUserData).

skip_64_m_bag_info_tos(<<_:64, Rest/binary>>, Z1, Z2,
		       F@_1, TrUserData) ->
    dfp_read_field_def_m_bag_info_tos(Rest, Z1, Z2, F@_1,
				      TrUserData).

decode_msg_m_bag_info_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_bag_info_toc(Bin, 0, 0,
				      id(undefined, TrUserData),
				      id(undefined, TrUserData),
				      id([], TrUserData), TrUserData).

dfp_read_field_def_m_bag_info_toc(<<8, Rest/binary>>,
				  Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
    d_field_m_bag_info_toc_bag_id(Rest, Z1, Z2, F@_1, F@_2,
				  F@_3, TrUserData);
dfp_read_field_def_m_bag_info_toc(<<16, Rest/binary>>,
				  Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
    d_field_m_bag_info_toc_opened(Rest, Z1, Z2, F@_1, F@_2,
				  F@_3, TrUserData);
dfp_read_field_def_m_bag_info_toc(<<26, Rest/binary>>,
				  Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
    d_field_m_bag_info_toc_items(Rest, Z1, Z2, F@_1, F@_2,
				 F@_3, TrUserData);
dfp_read_field_def_m_bag_info_toc(<<>>, 0, 0, F@_1,
				  F@_2, R1, TrUserData) ->
    #m_bag_info_toc{bag_id = F@_1, opened = F@_2,
		    items = lists_reverse(R1, TrUserData)};
dfp_read_field_def_m_bag_info_toc(Other, Z1, Z2, F@_1,
				  F@_2, F@_3, TrUserData) ->
    dg_read_field_def_m_bag_info_toc(Other, Z1, Z2, F@_1,
				     F@_2, F@_3, TrUserData).

dg_read_field_def_m_bag_info_toc(<<1:1, X:7,
				   Rest/binary>>,
				 N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_bag_info_toc(Rest, N + 7,
				     X bsl N + Acc, F@_1, F@_2, F@_3,
				     TrUserData);
dg_read_field_def_m_bag_info_toc(<<0:1, X:7,
				   Rest/binary>>,
				 N, Acc, F@_1, F@_2, F@_3, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_bag_info_toc_bag_id(Rest, 0, 0, F@_1, F@_2,
					F@_3, TrUserData);
      16 ->
	  d_field_m_bag_info_toc_opened(Rest, 0, 0, F@_1, F@_2,
					F@_3, TrUserData);
      26 ->
	  d_field_m_bag_info_toc_items(Rest, 0, 0, F@_1, F@_2,
				       F@_3, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_bag_info_toc(Rest, 0, 0, F@_1, F@_2, F@_3,
					   TrUserData);
	    1 ->
		skip_64_m_bag_info_toc(Rest, 0, 0, F@_1, F@_2, F@_3,
				       TrUserData);
	    2 ->
		skip_length_delimited_m_bag_info_toc(Rest, 0, 0, F@_1,
						     F@_2, F@_3, TrUserData);
	    3 ->
		skip_group_m_bag_info_toc(Rest, Key bsr 3, 0, F@_1,
					  F@_2, F@_3, TrUserData);
	    5 ->
		skip_32_m_bag_info_toc(Rest, 0, 0, F@_1, F@_2, F@_3,
				       TrUserData)
	  end
    end;
dg_read_field_def_m_bag_info_toc(<<>>, 0, 0, F@_1, F@_2,
				 R1, TrUserData) ->
    #m_bag_info_toc{bag_id = F@_1, opened = F@_2,
		    items = lists_reverse(R1, TrUserData)}.

d_field_m_bag_info_toc_bag_id(<<1:1, X:7, Rest/binary>>,
			      N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    d_field_m_bag_info_toc_bag_id(Rest, N + 7,
				  X bsl N + Acc, F@_1, F@_2, F@_3, TrUserData);
d_field_m_bag_info_toc_bag_id(<<0:1, X:7, Rest/binary>>,
    ...
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    dfp_read_field_def_m_bag_info_toc(RestF, 0, 0,
				      NewFValue, F@_2, F@_3, TrUserData).

d_field_m_bag_info_toc_opened(<<1:1, X:7, Rest/binary>>,
			      N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    d_field_m_bag_info_toc_opened(Rest, N + 7,
				  X bsl N + Acc, F@_1, F@_2, F@_3, TrUserData);
d_field_m_bag_info_toc_opened(<<0:1, X:7, Rest/binary>>,
    ...
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    dfp_read_field_def_m_bag_info_toc(RestF, 0, 0, F@_1,
				      NewFValue, F@_3, TrUserData).

d_field_m_bag_info_toc_items(<<1:1, X:7, Rest/binary>>,
			     N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    d_field_m_bag_info_toc_items(Rest, N + 7, X bsl N + Acc,
				 F@_1, F@_2, F@_3, TrUserData);
d_field_m_bag_info_toc_items(<<0:1, X:7, Rest/binary>>,
...
skip_varint_m_bag_info_toc(<<1:1, _:7, Rest/binary>>,
			   Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
    skip_varint_m_bag_info_toc(Rest, Z1, Z2, F@_1, F@_2,
			       F@_3, TrUserData);
skip_varint_m_bag_info_toc(<<0:1, _:7, Rest/binary>>,
			   Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
    dfp_read_field_def_m_bag_info_toc(Rest, Z1, Z2, F@_1,
				      F@_2, F@_3, TrUserData).

skip_length_delimited_m_bag_info_toc(<<1:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_bag_info_toc(Rest, N + 7,
					 X bsl N + Acc, F@_1, F@_2, F@_3,
					 TrUserData);
skip_length_delimited_m_bag_info_toc(<<0:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, F@_2, F@_3, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_bag_info_toc(Rest2, 0, 0, F@_1,
				      F@_2, F@_3, TrUserData).

skip_group_m_bag_info_toc(Bin, FNum, Z2, F@_1, F@_2,
			  F@_3, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_bag_info_toc(Rest, 0, Z2, F@_1,
				      F@_2, F@_3, TrUserData).

skip_32_m_bag_info_toc(<<_:32, Rest/binary>>, Z1, Z2,
		       F@_1, F@_2, F@_3, TrUserData) ->
    dfp_read_field_def_m_bag_info_toc(Rest, Z1, Z2, F@_1,
				      F@_2, F@_3, TrUserData).

skip_64_m_bag_info_toc(<<_:64, Rest/binary>>, Z1, Z2,
		       F@_1, F@_2, F@_3, TrUserData) ->
    dfp_read_field_def_m_bag_info_toc(Rest, Z1, Z2, F@_1,
				      F@_2, F@_3, TrUserData).

decode_msg_m_bag_open_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_bag_open_tos(Bin, 0, 0,
				      id(undefined, TrUserData),
				      id(undefined, TrUserData), TrUserData).

dfp_read_field_def_m_bag_open_tos(<<8, Rest/binary>>,
				  Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_bag_open_tos_bag_id(Rest, Z1, Z2, F@_1, F@_2,
				  TrUserData);
dfp_read_field_def_m_bag_open_tos(<<16, Rest/binary>>,
				  Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_bag_open_tos_num(Rest, Z1, Z2, F@_1, F@_2,
			       TrUserData);
dfp_read_field_def_m_bag_open_tos(<<>>, 0, 0, F@_1,
				  F@_2, _) ->
    #m_bag_open_tos{bag_id = F@_1, num = F@_2};
dfp_read_field_def_m_bag_open_tos(Other, Z1, Z2, F@_1,
				  F@_2, TrUserData) ->
    dg_read_field_def_m_bag_open_tos(Other, Z1, Z2, F@_1,
				     F@_2, TrUserData).

dg_read_field_def_m_bag_open_tos(<<1:1, X:7,
				   Rest/binary>>,
				 N, Acc, F@_1, F@_2, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_bag_open_tos(Rest, N + 7,
				     X bsl N + Acc, F@_1, F@_2, TrUserData);
dg_read_field_def_m_bag_open_tos(<<0:1, X:7,
				   Rest/binary>>,
				 N, Acc, F@_1, F@_2, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_bag_open_tos_bag_id(Rest, 0, 0, F@_1, F@_2,
					TrUserData);
      16 ->
	  d_field_m_bag_open_tos_num(Rest, 0, 0, F@_1, F@_2,
				     TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_bag_open_tos(Rest, 0, 0, F@_1, F@_2,
					   TrUserData);
	    1 ->
		skip_64_m_bag_open_tos(Rest, 0, 0, F@_1, F@_2,
				       TrUserData);
	    2 ->
		skip_length_delimited_m_bag_open_tos(Rest, 0, 0, F@_1,
						     F@_2, TrUserData);
	    3 ->
		skip_group_m_bag_open_tos(Rest, Key bsr 3, 0, F@_1,
					  F@_2, TrUserData);
	    5 ->
		skip_32_m_bag_open_tos(Rest, 0, 0, F@_1, F@_2,
				       TrUserData)
	  end
    end;
dg_read_field_def_m_bag_open_tos(<<>>, 0, 0, F@_1, F@_2,
				 _) ->
    #m_bag_open_tos{bag_id = F@_1, num = F@_2}.

d_field_m_bag_open_tos_bag_id(<<1:1, X:7, Rest/binary>>,
			      N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_bag_open_tos_bag_id(Rest, N + 7,
				  X bsl N + Acc, F@_1, F@_2, TrUserData);
d_field_m_bag_open_tos_bag_id(<<0:1, X:7, Rest/binary>>,
    ...
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    dfp_read_field_def_m_bag_open_tos(RestF, 0, 0,
				      NewFValue, F@_2, TrUserData).

d_field_m_bag_open_tos_num(<<1:1, X:7, Rest/binary>>, N,
			   Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_bag_open_tos_num(Rest, N + 7, X bsl N + Acc,
			       F@_1, F@_2, TrUserData);
d_field_m_bag_open_tos_num(<<0:1, X:7, Rest/binary>>, N,
    ...
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    dfp_read_field_def_m_bag_open_tos(RestF, 0, 0, F@_1,
				      NewFValue, TrUserData).

skip_varint_m_bag_open_tos(<<1:1, _:7, Rest/binary>>,
			   Z1, Z2, F@_1, F@_2, TrUserData) ->
    skip_varint_m_bag_open_tos(Rest, Z1, Z2, F@_1, F@_2,
			       TrUserData);
skip_varint_m_bag_open_tos(<<0:1, _:7, Rest/binary>>,
			   Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_bag_open_tos(Rest, Z1, Z2, F@_1,
				      F@_2, TrUserData).

skip_length_delimited_m_bag_open_tos(<<1:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_bag_open_tos(Rest, N + 7,
					 X bsl N + Acc, F@_1, F@_2, TrUserData);
skip_length_delimited_m_bag_open_tos(<<0:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, F@_2, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_bag_open_tos(Rest2, 0, 0, F@_1,
				      F@_2, TrUserData).

skip_group_m_bag_open_tos(Bin, FNum, Z2, F@_1, F@_2,
			  TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_bag_open_tos(Rest, 0, Z2, F@_1,
				      F@_2, TrUserData).

skip_32_m_bag_open_tos(<<_:32, Rest/binary>>, Z1, Z2,
		       F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_bag_open_tos(Rest, Z1, Z2, F@_1,
				      F@_2, TrUserData).

skip_64_m_bag_open_tos(<<_:64, Rest/binary>>, Z1, Z2,
		       F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_bag_open_tos(Rest, Z1, Z2, F@_1,
				      F@_2, TrUserData).

decode_msg_m_bag_open_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_bag_open_toc(Bin, 0, 0,
				      id(undefined, TrUserData),
				      id(undefined, TrUserData), TrUserData).

dfp_read_field_def_m_bag_open_toc(<<8, Rest/binary>>,
				  Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_bag_open_toc_bag_id(Rest, Z1, Z2, F@_1, F@_2,
				  TrUserData);
dfp_read_field_def_m_bag_open_toc(<<16, Rest/binary>>,
				  Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_bag_open_toc_num(Rest, Z1, Z2, F@_1, F@_2,
			       TrUserData);
dfp_read_field_def_m_bag_open_toc(<<>>, 0, 0, F@_1,
				  F@_2, _) ->
    #m_bag_open_toc{bag_id = F@_1, num = F@_2};
dfp_read_field_def_m_bag_open_toc(Other, Z1, Z2, F@_1,
				  F@_2, TrUserData) ->
    dg_read_field_def_m_bag_open_toc(Other, Z1, Z2, F@_1,
				     F@_2, TrUserData).

dg_read_field_def_m_bag_open_toc(<<1:1, X:7,
				   Rest/binary>>,
				 N, Acc, F@_1, F@_2, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_bag_open_toc(Rest, N + 7,
				     X bsl N + Acc, F@_1, F@_2, TrUserData);
dg_read_field_def_m_bag_open_toc(<<0:1, X:7,
				   Rest/binary>>,
				 N, Acc, F@_1, F@_2, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_bag_open_toc_bag_id(Rest, 0, 0, F@_1, F@_2,
					TrUserData);
      16 ->
	  d_field_m_bag_open_toc_num(Rest, 0, 0, F@_1, F@_2,
				     TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_bag_open_toc(Rest, 0, 0, F@_1, F@_2,
					   TrUserData);
	    1 ->
		skip_64_m_bag_open_toc(Rest, 0, 0, F@_1, F@_2,
				       TrUserData);
	    2 ->
		skip_length_delimited_m_bag_open_toc(Rest, 0, 0, F@_1,
						     F@_2, TrUserData);
	    3 ->
		skip_group_m_bag_open_toc(Rest, Key bsr 3, 0, F@_1,
					  F@_2, TrUserData);
	    5 ->
		skip_32_m_bag_open_toc(Rest, 0, 0, F@_1, F@_2,
				       TrUserData)
	  end
    end;
dg_read_field_def_m_bag_open_toc(<<>>, 0, 0, F@_1, F@_2,
				 _) ->
    #m_bag_open_toc{bag_id = F@_1, num = F@_2}.

d_field_m_bag_open_toc_bag_id(<<1:1, X:7, Rest/binary>>,
			      N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_bag_open_toc_bag_id(Rest, N + 7,
				  X bsl N + Acc, F@_1, F@_2, TrUserData);
d_field_m_bag_open_toc_bag_id(<<0:1, X:7, Rest/binary>>,
			      N, Acc, _, F@_2, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
							    Acc):32/unsigned-native>>,
			  ...
			  Rest},
    dfp_read_field_def_m_bag_open_toc(RestF, 0, 0,
				      NewFValue, F@_2, TrUserData).

d_field_m_bag_open_toc_num(<<1:1, X:7, Rest/binary>>, N,
			   Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_bag_open_toc_num(Rest, N + 7, X bsl N + Acc,
			       F@_1, F@_2, TrUserData);
d_field_m_bag_open_toc_num(<<0:1, X:7, Rest/binary>>, N,
			   Acc, F@_1, _, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
							    Acc):32/unsigned-native>>,
			  ...
			  Rest},
    dfp_read_field_def_m_bag_open_toc(RestF, 0, 0, F@_1,
				      NewFValue, TrUserData).

skip_varint_m_bag_open_toc(<<1:1, _:7, Rest/binary>>,
			   Z1, Z2, F@_1, F@_2, TrUserData) ->
    skip_varint_m_bag_open_toc(Rest, Z1, Z2, F@_1, F@_2,
			       TrUserData);
skip_varint_m_bag_open_toc(<<0:1, _:7, Rest/binary>>,
			   Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_bag_open_toc(Rest, Z1, Z2, F@_1,
				      F@_2, TrUserData).

skip_length_delimited_m_bag_open_toc(<<1:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_bag_open_toc(Rest, N + 7,
					 X bsl N + Acc, F@_1, F@_2, TrUserData);
skip_length_delimited_m_bag_open_toc(<<0:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, F@_2, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_bag_open_toc(Rest2, 0, 0, F@_1,
				      F@_2, TrUserData).

skip_group_m_bag_open_toc(Bin, FNum, Z2, F@_1, F@_2,
			  TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_bag_open_toc(Rest, 0, Z2, F@_1,
				      F@_2, TrUserData).

skip_32_m_bag_open_toc(<<_:32, Rest/binary>>, Z1, Z2,
		       F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_bag_open_toc(Rest, Z1, Z2, F@_1,
				      F@_2, TrUserData).

skip_64_m_bag_open_toc(<<_:64, Rest/binary>>, Z1, Z2,
		       F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_bag_open_toc(Rest, Z1, Z2, F@_1,
				      F@_2, TrUserData).

decode_msg_m_bag_update_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_bag_update_toc(Bin, 0, 0,
					id([], TrUserData), id([], TrUserData),
					'tr_decode_init_default_m_bag_update_toc.chg'([],
										      TrUserData),
					id(undefined, TrUserData), TrUserData).

dfp_read_field_def_m_bag_update_toc(<<10, Rest/binary>>,
				    Z1, Z2, F@_1, F@_2, F@_3, F@_4,
				    TrUserData) ->
    d_field_m_bag_update_toc_add(Rest, Z1, Z2, F@_1, F@_2,
				 F@_3, F@_4, TrUserData);
dfp_read_field_def_m_bag_update_toc(<<18, Rest/binary>>,
				    Z1, Z2, F@_1, F@_2, F@_3, F@_4,
				    TrUserData) ->
    d_pfield_m_bag_update_toc_del(Rest, Z1, Z2, F@_1, F@_2,
				  F@_3, F@_4, TrUserData);
dfp_read_field_def_m_bag_update_toc(<<16, Rest/binary>>,
				    Z1, Z2, F@_1, F@_2, F@_3, F@_4,
				    TrUserData) ->
    d_field_m_bag_update_toc_del(Rest, Z1, Z2, F@_1, F@_2,
				 F@_3, F@_4, TrUserData);
dfp_read_field_def_m_bag_update_toc(<<26, Rest/binary>>,
				    Z1, Z2, F@_1, F@_2, F@_3, F@_4,
				    TrUserData) ->
    d_field_m_bag_update_toc_chg(Rest, Z1, Z2, F@_1, F@_2,
				 F@_3, F@_4, TrUserData);
dfp_read_field_def_m_bag_update_toc(<<32, Rest/binary>>,
				    Z1, Z2, F@_1, F@_2, F@_3, F@_4,
				    TrUserData) ->
    d_field_m_bag_update_toc_way(Rest, Z1, Z2, F@_1, F@_2,
				 F@_3, F@_4, TrUserData);
dfp_read_field_def_m_bag_update_toc(<<>>, 0, 0, R1, R2,
				    R3, F@_4, TrUserData) ->
    #m_bag_update_toc{add = lists_reverse(R1, TrUserData),
		      del = lists_reverse(R2, TrUserData),
		      chg =
			  'tr_decode_repeated_finalize_m_bag_update_toc.chg'(R3,
									     TrUserData),
		      way = F@_4};
dfp_read_field_def_m_bag_update_toc(Other, Z1, Z2, F@_1,
				    F@_2, F@_3, F@_4, TrUserData) ->
    dg_read_field_def_m_bag_update_toc(Other, Z1, Z2, F@_1,
				       F@_2, F@_3, F@_4, TrUserData).

dg_read_field_def_m_bag_update_toc(<<1:1, X:7,
				     Rest/binary>>,
				   N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_bag_update_toc(Rest, N + 7,
				       X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
				       TrUserData);
dg_read_field_def_m_bag_update_toc(<<0:1, X:7,
				     Rest/binary>>,
    ...
    case Key of
      10 ->
	  d_field_m_bag_update_toc_add(Rest, 0, 0, F@_1, F@_2,
				       F@_3, F@_4, TrUserData);
      18 ->
	  d_pfield_m_bag_update_toc_del(Rest, 0, 0, F@_1, F@_2,
					F@_3, F@_4, TrUserData);
      16 ->
	  d_field_m_bag_update_toc_del(Rest, 0, 0, F@_1, F@_2,
				       F@_3, F@_4, TrUserData);
      26 ->
	  d_field_m_bag_update_toc_chg(Rest, 0, 0, F@_1, F@_2,
				       F@_3, F@_4, TrUserData);
      32 ->
	  d_field_m_bag_update_toc_way(Rest, 0, 0, F@_1, F@_2,
				       F@_3, F@_4, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_bag_update_toc(Rest, 0, 0, F@_1, F@_2,
					     F@_3, F@_4, TrUserData);
	    1 ->
		skip_64_m_bag_update_toc(Rest, 0, 0, F@_1, F@_2, F@_3,
					 F@_4, TrUserData);
	    2 ->
		skip_length_delimited_m_bag_update_toc(Rest, 0, 0, F@_1,
						       F@_2, F@_3, F@_4,
						       TrUserData);
	    3 ->
		skip_group_m_bag_update_toc(Rest, Key bsr 3, 0, F@_1,
					    F@_2, F@_3, F@_4, TrUserData);
	    5 ->
		skip_32_m_bag_update_toc(Rest, 0, 0, F@_1, F@_2, F@_3,
					 F@_4, TrUserData)
	  end
    end;
dg_read_field_def_m_bag_update_toc(<<>>, 0, 0, R1, R2,
				   R3, F@_4, TrUserData) ->
    #m_bag_update_toc{add = lists_reverse(R1, TrUserData),
		      del = lists_reverse(R2, TrUserData),
		      chg =
...
d_field_m_bag_update_toc_add(<<1:1, X:7, Rest/binary>>,
			     N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData)
    when N < 57 ->
    d_field_m_bag_update_toc_add(Rest, N + 7, X bsl N + Acc,
				 F@_1, F@_2, F@_3, F@_4, TrUserData);
d_field_m_bag_update_toc_add(<<0:1, X:7, Rest/binary>>,
    ...
    dfp_read_field_def_m_bag_update_toc(RestF, 0, 0,
					cons(NewFValue, Prev, TrUserData), F@_2,
					F@_3, F@_4, TrUserData).

d_field_m_bag_update_toc_del(<<1:1, X:7, Rest/binary>>,
			     N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData)
    when N < 57 ->
    d_field_m_bag_update_toc_del(Rest, N + 7, X bsl N + Acc,
				 F@_1, F@_2, F@_3, F@_4, TrUserData);
d_field_m_bag_update_toc_del(<<0:1, X:7, Rest/binary>>,
    ...
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    dfp_read_field_def_m_bag_update_toc(RestF, 0, 0, F@_1,
					cons(NewFValue, Prev, TrUserData), F@_3,
					F@_4, TrUserData).

d_pfield_m_bag_update_toc_del(<<1:1, X:7, Rest/binary>>,
			      N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData)
    when N < 57 ->
    d_pfield_m_bag_update_toc_del(Rest, N + 7,
				  X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
				  TrUserData);
d_pfield_m_bag_update_toc_del(<<0:1, X:7, Rest/binary>>,
			      N, Acc, F@_1, E, F@_3, F@_4, TrUserData) ->
    Len = X bsl N + Acc,
    <<PackedBytes:Len/binary, Rest2/binary>> = Rest,
    NewSeq =
	d_packed_field_m_bag_update_toc_del(PackedBytes, 0, 0,
					    E, TrUserData),
    dfp_read_field_def_m_bag_update_toc(Rest2, 0, 0, F@_1,
					NewSeq, F@_3, F@_4, TrUserData).

d_packed_field_m_bag_update_toc_del(<<1:1, X:7,
				      Rest/binary>>,
				    N, Acc, AccSeq, TrUserData)
    when N < 57 ->
    d_packed_field_m_bag_update_toc_del(Rest, N + 7,
					X bsl N + Acc, AccSeq, TrUserData);
d_packed_field_m_bag_update_toc_del(<<0:1, X:7,
				      Rest/binary>>,
				    N, Acc, AccSeq, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    d_packed_field_m_bag_update_toc_del(RestF, 0, 0,
					[NewFValue | AccSeq], TrUserData);
d_packed_field_m_bag_update_toc_del(<<>>, 0, 0, AccSeq,
				    _) ->
    AccSeq.

d_field_m_bag_update_toc_chg(<<1:1, X:7, Rest/binary>>,
			     N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData)
    when N < 57 ->
    d_field_m_bag_update_toc_chg(Rest, N + 7, X bsl N + Acc,
				 F@_1, F@_2, F@_3, F@_4, TrUserData);
d_field_m_bag_update_toc_chg(<<0:1, X:7, Rest/binary>>,
    ...
    dfp_read_field_def_m_bag_update_toc(RestF, 0, 0, F@_1,
					F@_2,
					'tr_decode_repeated_add_elem_m_bag_update_toc.chg'(NewFValue,
											   Prev,
											   TrUserData),
					F@_4, TrUserData).

d_field_m_bag_update_toc_way(<<1:1, X:7, Rest/binary>>,
			     N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData)
    when N < 57 ->
    d_field_m_bag_update_toc_way(Rest, N + 7, X bsl N + Acc,
				 F@_1, F@_2, F@_3, F@_4, TrUserData);
d_field_m_bag_update_toc_way(<<0:1, X:7, Rest/binary>>,
...
skip_varint_m_bag_update_toc(<<1:1, _:7, Rest/binary>>,
			     Z1, Z2, F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    skip_varint_m_bag_update_toc(Rest, Z1, Z2, F@_1, F@_2,
				 F@_3, F@_4, TrUserData);
skip_varint_m_bag_update_toc(<<0:1, _:7, Rest/binary>>,
			     Z1, Z2, F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    dfp_read_field_def_m_bag_update_toc(Rest, Z1, Z2, F@_1,
					F@_2, F@_3, F@_4, TrUserData).

skip_length_delimited_m_bag_update_toc(<<1:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, F@_2, F@_3, F@_4,
				       TrUserData)
    when N < 57 ->
    skip_length_delimited_m_bag_update_toc(Rest, N + 7,
					   X bsl N + Acc, F@_1, F@_2, F@_3,
					   F@_4, TrUserData);
skip_length_delimited_m_bag_update_toc(<<0:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, F@_2, F@_3, F@_4,
				       TrUserData) ->
    Length = X bsl N + Acc,
...
skip_group_m_bag_update_toc(Bin, FNum, Z2, F@_1, F@_2,
			    F@_3, F@_4, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_bag_update_toc(Rest, 0, Z2, F@_1,
					F@_2, F@_3, F@_4, TrUserData).

skip_32_m_bag_update_toc(<<_:32, Rest/binary>>, Z1, Z2,
			 F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    dfp_read_field_def_m_bag_update_toc(Rest, Z1, Z2, F@_1,
					F@_2, F@_3, F@_4, TrUserData).

skip_64_m_bag_update_toc(<<_:64, Rest/binary>>, Z1, Z2,
			 F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    dfp_read_field_def_m_bag_update_toc(Rest, Z1, Z2, F@_1,
					F@_2, F@_3, F@_4, TrUserData).
...
merge_msgs(Prev, New, MsgName, Opts) ->
    ...
    case MsgName of
      m_bag_info_tos ->
	  merge_msg_m_bag_info_tos(Prev, New, TrUserData);
      m_bag_info_toc ->
	  merge_msg_m_bag_info_toc(Prev, New, TrUserData);
      m_bag_open_tos ->
	  merge_msg_m_bag_open_tos(Prev, New, TrUserData);
      m_bag_open_toc ->
	  merge_msg_m_bag_open_toc(Prev, New, TrUserData);
      m_bag_update_toc ->
	  merge_msg_m_bag_update_toc(Prev, New, TrUserData);
      p_role_base ->
...
-compile({nowarn_unused_function,merge_msg_m_bag_info_tos/3}).
merge_msg_m_bag_info_tos(#m_bag_info_tos{},
			 #m_bag_info_tos{bag_id = NFbag_id}, _) ->
    #m_bag_info_tos{bag_id = NFbag_id}.

-compile({nowarn_unused_function,merge_msg_m_bag_info_toc/3}).
merge_msg_m_bag_info_toc(#m_bag_info_toc{items =
					     PFitems},
			 #m_bag_info_toc{bag_id = NFbag_id, opened = NFopened,
					 items = NFitems},
			 TrUserData) ->
    #m_bag_info_toc{bag_id = NFbag_id, opened = NFopened,
		    items =
...
-compile({nowarn_unused_function,merge_msg_m_bag_open_tos/3}).
merge_msg_m_bag_open_tos(#m_bag_open_tos{},
			 #m_bag_open_tos{bag_id = NFbag_id, num = NFnum}, _) ->
    #m_bag_open_tos{bag_id = NFbag_id, num = NFnum}.

-compile({nowarn_unused_function,merge_msg_m_bag_open_toc/3}).
merge_msg_m_bag_open_toc(#m_bag_open_toc{},
			 #m_bag_open_toc{bag_id = NFbag_id, num = NFnum}, _) ->
    #m_bag_open_toc{bag_id = NFbag_id, num = NFnum}.

-compile({nowarn_unused_function,merge_msg_m_bag_update_toc/3}).
merge_msg_m_bag_update_toc(#m_bag_update_toc{add =
						 PFadd,
					     del = PFdel, chg = PFchg},
			   #m_bag_update_toc{add = NFadd, del = NFdel,
					     chg = NFchg, way = NFway},
			   TrUserData) ->
    #m_bag_update_toc{add =
			  ...
			  if PFchg /= undefined, NFchg /= undefined ->
				 'tr_merge_m_bag_update_toc.chg'(PFchg, NFchg,
								 TrUserData);
...
verify_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
      m_bag_info_tos ->
	  v_msg_m_bag_info_tos(Msg, [MsgName], TrUserData);
      m_bag_info_toc ->
	  v_msg_m_bag_info_toc(Msg, [MsgName], TrUserData);
      m_bag_open_tos ->
	  v_msg_m_bag_open_tos(Msg, [MsgName], TrUserData);
      m_bag_open_toc ->
	  v_msg_m_bag_open_toc(Msg, [MsgName], TrUserData);
      m_bag_update_toc ->
	  v_msg_m_bag_update_toc(Msg, [MsgName], TrUserData);
      p_role_base ->
...
-compile({nowarn_unused_function,v_msg_m_bag_info_tos/3}).
-dialyzer({nowarn_function,v_msg_m_bag_info_tos/3}).
v_msg_m_bag_info_tos(#m_bag_info_tos{bag_id = F1}, Path,
		     TrUserData) ->
    v_type_int32(F1, [bag_id | Path], TrUserData), ok;
v_msg_m_bag_info_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_bag_info_tos}, X, Path).

-compile({nowarn_unused_function,v_msg_m_bag_info_toc/3}).
-dialyzer({nowarn_function,v_msg_m_bag_info_toc/3}).
v_msg_m_bag_info_toc(#m_bag_info_toc{bag_id = F1,
				     opened = F2, items = F3},
		     Path, TrUserData) ->
    v_type_int32(F1, [bag_id | Path], TrUserData),
    v_type_int32(F2, [opened | Path], TrUserData),
    if is_list(F3) ->
	   _ = [v_msg_p_item_base(Elem, [items | Path], TrUserData)
		|| Elem <- F3],
	   ok;
       true ->
	   mk_type_error({invalid_list_of, {msg, p_item_base}}, F3,
			 [items | Path])
    end,
    ok;
v_msg_m_bag_info_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_bag_info_toc}, X, Path).

-compile({nowarn_unused_function,v_msg_m_bag_open_tos/3}).
-dialyzer({nowarn_function,v_msg_m_bag_open_tos/3}).
v_msg_m_bag_open_tos(#m_bag_open_tos{bag_id = F1,
				     num = F2},
		     Path, TrUserData) ->
    v_type_int32(F1, [bag_id | Path], TrUserData),
    v_type_int32(F2, [num | Path], TrUserData),
    ok;
v_msg_m_bag_open_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_bag_open_tos}, X, Path).

-compile({nowarn_unused_function,v_msg_m_bag_open_toc/3}).
-dialyzer({nowarn_function,v_msg_m_bag_open_toc/3}).
v_msg_m_bag_open_toc(#m_bag_open_toc{bag_id = F1,
				     num = F2},
		     Path, TrUserData) ->
    v_type_int32(F1, [bag_id | Path], TrUserData),
    v_type_int32(F2, [num | Path], TrUserData),
    ok;
v_msg_m_bag_open_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_bag_open_toc}, X, Path).

-compile({nowarn_unused_function,v_msg_m_bag_update_toc/3}).
-dialyzer({nowarn_function,v_msg_m_bag_update_toc/3}).
v_msg_m_bag_update_toc(#m_bag_update_toc{add = F1,
					 del = F2, chg = F3, way = F4},
		       Path, TrUserData) ->
    if is_list(F1) ->
	   _ = [v_msg_p_item_base(Elem, [add | Path], TrUserData)
		|| Elem <- F1],
	   ok;
       true ->
	   mk_type_error({invalid_list_of, {msg, p_item_base}}, F1,
			 [add | Path])
    end,
    if is_list(F2) ->
    ...
    'v_map<int32,int32>'(F3, [chg | Path], TrUserData),
    v_type_int32(F4, [way | Path], TrUserData),
    ok;
v_msg_m_bag_update_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_bag_update_toc}, X,
		  Path).
...
-compile({inline,'tr_decode_init_default_m_bag_update_toc.chg'/2}).
'tr_decode_init_default_m_bag_update_toc.chg'(_, _) ->
    mt_empty_map_m().

-compile({inline,'tr_merge_m_bag_update_toc.chg'/3}).
'tr_merge_m_bag_update_toc.chg'(X1, X2, _) ->
    mt_merge_maps_m(X1, X2).

-compile({inline,'tr_decode_repeated_finalize_m_bag_update_toc.chg'/2}).
'tr_decode_repeated_finalize_m_bag_update_toc.chg'(L,
						   TrUserData) ->
    id(L, TrUserData).

-compile({inline,'tr_encode_m_bag_update_toc.chg'/2}).
'tr_encode_m_bag_update_toc.chg'(X, _) ->
    mt_map_to_list_m(X).

-compile({inline,'tr_decode_repeated_add_elem_m_bag_update_toc.chg'/3}).
'tr_decode_repeated_add_elem_m_bag_update_toc.chg'(Elem,
						   L, _) ->
    mt_add_item_m(Elem, L).
...
-compile({inline,'tr_encode_m_bag_update_toc.chg[x]'/2}).
'tr_encode_m_bag_update_toc.chg[x]'(X, _) ->
    mt_maptuple_to_pseudomsg_m(X).
...
get_msg_defs() ->
    [{{msg, m_bag_info_tos},
      [#field{name = bag_id, fnum = 1, rnum = 2, type = int32,
	      occurrence = required, opts = []}]},
     {{msg, m_bag_info_toc},
      [#field{name = bag_id, fnum = 1, rnum = 2, type = int32,
	      occurrence = required, opts = []},
       #field{name = opened, fnum = 2, rnum = 3, type = int32,
	      occurrence = required, opts = []},
...
get_msg_names() ->
    [m_bag_info_tos, m_bag_info_toc, m_bag_open_tos,
     m_bag_open_toc, m_bag_update_toc, p_role_base, p_aspect,
...
find_msg_def(m_bag_info_tos) ->
    [#field{name = bag_id, fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []}];
find_msg_def(m_bag_info_toc) ->
    [#field{name = bag_id, fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []},
     #field{name = opened, fnum = 2, rnum = 3, type = int32,
	    occurrence = required, opts = []},
     #field{name = items, fnum = 3, rnum = 4,
	    type = {msg, p_item_base}, occurrence = repeated,
	    opts = []}];
find_msg_def(m_bag_open_tos) ->
    [#field{name = bag_id, fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []},
     #field{name = num, fnum = 2, rnum = 3, type = int32,
	    occurrence = required, opts = []}];
find_msg_def(m_bag_open_toc) ->
    [#field{name = bag_id, fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []},
     #field{name = num, fnum = 2, rnum = 3, type = int32,
	    occurrence = required, opts = []}];
find_msg_def(m_bag_update_toc) ->
    [#field{name = add, fnum = 1, rnum = 2,
	    type = {msg, p_item_base}, occurrence = repeated,
	    opts = []},
     #field{name = del, fnum = 2, rnum = 3, type = int32,
