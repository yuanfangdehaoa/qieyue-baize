...
-ifndef(pb_1003_rank).
-define(pb_1003_rank, true).

-define(pb_1003_rank_gpb_version, "4.5.1").

-ifndef('M_RANK_LIST_TOS_PB_H').
-define('M_RANK_LIST_TOS_PB_H', true).
-record(m_rank_list_tos,
        {id                     :: integer(),       % = 1, 32 bits
         page                   :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_RANK_LIST_TOC_PB_H').
-define('M_RANK_LIST_TOC_PB_H', true).
-record(m_rank_list_toc,
        {id                     :: integer(),       % = 1, 32 bits
         total                  :: integer(),       % = 2, 32 bits
         page                   :: integer(),       % = 3, 32 bits
         list = []              :: [pb_1003_rank:p_ranking()] | undefined, % = 4
         mine                   :: pb_1003_rank:p_ranking() % = 5
        }).
-endif.
...
-record(p_role_base,
        {id                     :: non_neg_integer(), % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1003_rank:p_aspect()} | undefined, % = 8
         ...
         icon                   :: pb_1003_rank:p_icon() | undefined, % = 17
...
-record(p_item,
        {uid                    :: integer(),       % = 1, 32 bits
         ...
         gender                 :: integer(),       % = 7, 32 bits
         score                  :: integer() | undefined, % = 8, 32 bits
         equip                  :: pb_1003_rank:p_equip() | undefined, % = 9
         pet                    :: pb_1003_rank:p_pet() | undefined, % = 10
...
-record(p_equip,
        {base                   :: pb_1003_rank:p_attr(), % = 1
         rare1                  :: pb_1003_rank:p_attr() | undefined, % = 2
         rare2                  :: pb_1003_rank:p_attr() | undefined, % = 3
         rare3                  :: pb_1003_rank:p_attr() | undefined, % = 4
         marriage               :: pb_1003_rank:p_marriage() | undefined, % = 5
         ...
         refine = []            :: [pb_1003_rank:p_refine()] | undefined, % = 11
         suite = #{}            :: #{integer() := integer()} | undefined, % = 12
         combine = []           :: [pb_1003_rank:p_item()] | undefined % = 13
        }).
-endif.
...
-record(p_marriage,
        {husband_id             :: non_neg_integer() | undefined, % = 1, 32 bits
         ...
         rare                   :: pb_1003_rank:p_attr() | undefined % = 5
        }).
-endif.
...
-record(p_actor,
        {uid                    :: non_neg_integer(), % = 1, 32 bits
         ...
         coord                  :: pb_1003_rank:p_coord(), % = 4
         state                  :: integer(),       % = 5, 32 bits
         stargs = #{}           :: #{integer() := iolist()} | undefined, % = 6
         role                   :: pb_1003_rank:p_role() | undefined, % = 7
         creep                  :: pb_1003_rank:p_creep() | undefined, % = 8
         drop                   :: pb_1003_rank:p_drop() | undefined % = 9
        }).
-endif.
...
-record(p_role,
        {career                 :: integer(),       % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1003_rank:p_aspect()} | undefined, % = 5
         ...
         icon                   :: pb_1003_rank:p_icon() | undefined % = 25
        }).
-endif.
...
-record(p_creep,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         buffs = []             :: [pb_1003_rank:p_buff()] | undefined, % = 6
         dir                    :: integer(),       % = 7, 32 bits
         dest                   :: pb_1003_rank:p_coord(), % = 8
...
-record(p_drop,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         coord                  :: pb_1003_rank:p_coord() | undefined, % = 5
...
-record(p_ranking,
        {base                   :: pb_1003_rank:p_role_base() | undefined, % = 1
