...
-ifndef(pb_1149_artifact).
-define(pb_1149_artifact, true).

-define(pb_1149_artifact_gpb_version, "4.5.1").

-ifndef('M_ARTIFACT_LIST_TOS_PB_H').
-define('M_ARTIFACT_LIST_TOS_PB_H', true).
-record(m_artifact_list_tos,
        {
        }).
-endif.

-ifndef('M_ARTIFACT_LIST_TOC_PB_H').
-define('M_ARTIFACT_LIST_TOC_PB_H', true).
-record(m_artifact_list_toc,
        {artis = []             :: [pb_1149_artifact:p_artifact()] | undefined % = 1
        }).
-endif.

-ifndef('M_ARTIELEM_LIST_TOS_PB_H').
-define('M_ARTIELEM_LIST_TOS_PB_H', true).
-record(m_artielem_list_tos,
        {type                   :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_ARTIELEM_LIST_TOC_PB_H').
-define('M_ARTIELEM_LIST_TOC_PB_H', true).
-record(m_artielem_list_toc,
        {type                   :: integer(),       % = 1, 32 bits
         elems = []             :: [pb_1149_artifact:p_artielem()] | undefined % = 2
        }).
-endif.

-ifndef('M_ARTIELEM_UPGRADE_TOS_PB_H').
-define('M_ARTIELEM_UPGRADE_TOS_PB_H', true).
-record(m_artielem_upgrade_tos,
        {arti_type              :: integer(),       % = 1, 32 bits
         elem_id                :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_ARTIELEM_UPGRADE_TOC_PB_H').
-define('M_ARTIELEM_UPGRADE_TOC_PB_H', true).
-record(m_artielem_upgrade_toc,
        {arti_type              :: integer(),       % = 1, 32 bits
         elem_id                :: integer(),       % = 2, 32 bits
         is_unlock              :: boolean() | 0 | 1 % = 3
        }).
-endif.

-ifndef('M_ARTIFACT_REINF_TOS_PB_H').
-define('M_ARTIFACT_REINF_TOS_PB_H', true).
-record(m_artifact_reinf_tos,
        {arti_id                :: integer(),       % = 1, 32 bits
         materials = []         :: [integer()] | undefined % = 2, 32 bits
        }).
-endif.

-ifndef('M_ARTIFACT_REINF_TOC_PB_H').
-define('M_ARTIFACT_REINF_TOC_PB_H', true).
-record(m_artifact_reinf_toc,
        {arti_id                :: integer(),       % = 1, 32 bits
         reinf_lv               :: integer(),       % = 2, 32 bits
         reinf_exp              :: integer()        % = 3, 32 bits
        }).
-endif.

-ifndef('M_ARTIFACT_PUTON_TOS_PB_H').
-define('M_ARTIFACT_PUTON_TOS_PB_H', true).
-record(m_artifact_puton_tos,
        {arti_id                :: integer(),       % = 1, 32 bits
         item_uid               :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_ARTIFACT_PUTON_TOC_PB_H').
-define('M_ARTIFACT_PUTON_TOC_PB_H', true).
-record(m_artifact_puton_toc,
        {arti_id                :: integer(),       % = 1, 32 bits
         slot_id                :: integer(),       % = 2, 32 bits
         is_unlock              :: boolean() | 0 | 1 % = 3
        }).
-endif.

-ifndef('M_ARTIFACT_PUTOFF_TOS_PB_H').
-define('M_ARTIFACT_PUTOFF_TOS_PB_H', true).
-record(m_artifact_putoff_tos,
        {arti_id                :: integer(),       % = 1, 32 bits
         slot_id                :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_ARTIFACT_PUTOFF_TOC_PB_H').
-define('M_ARTIFACT_PUTOFF_TOC_PB_H', true).
-record(m_artifact_putoff_toc,
        {arti_id                :: integer(),       % = 1, 32 bits
         slot_id                :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_ARTIFACT_ENCHANT_TOS_PB_H').
-define('M_ARTIFACT_ENCHANT_TOS_PB_H', true).
-record(m_artifact_enchant_tos,
        {arti_id                :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_ARTIFACT_ENCHANT_TOC_PB_H').
-define('M_ARTIFACT_ENCHANT_TOC_PB_H', true).
-record(m_artifact_enchant_toc,
        {arti_id                :: integer(),       % = 1, 32 bits
         enchant = #{}          :: #{integer() := integer()} | undefined % = 2
        }).
-endif.

-ifndef('P_ARTIFACT_PB_H').
-define('P_ARTIFACT_PB_H', true).
-record(p_artifact,
        {id                     :: integer(),       % = 1, 32 bits
         reinf_lv               :: integer(),       % = 2, 32 bits
         reinf_exp              :: integer(),       % = 3, 32 bits
         equips = #{}           :: #{integer() := pb_1149_artifact:p_item()} | undefined, % = 4
         enchant = #{}          :: #{integer() := integer()} | undefined % = 5
        }).
-endif.

-ifndef('P_ARTIELEM_PB_H').
-define('P_ARTIELEM_PB_H', true).
-record(p_artielem,
        {id                     :: integer(),       % = 1, 32 bits
...
-record(p_role_base,
        {id                     :: non_neg_integer(), % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1149_artifact:p_aspect()} | undefined, % = 8
         ...
         icon                   :: pb_1149_artifact:p_icon() | undefined, % = 17
...
-record(p_item,
        {uid                    :: integer(),       % = 1, 32 bits
         ...
         gender                 :: integer(),       % = 7, 32 bits
         score                  :: integer() | undefined, % = 8, 32 bits
         equip                  :: pb_1149_artifact:p_equip() | undefined, % = 9
         pet                    :: pb_1149_artifact:p_pet() | undefined, % = 10
...
-record(p_equip,
        {base                   :: pb_1149_artifact:p_attr(), % = 1
         rare1                  :: pb_1149_artifact:p_attr() | undefined, % = 2
         rare2                  :: pb_1149_artifact:p_attr() | undefined, % = 3
         rare3                  :: pb_1149_artifact:p_attr() | undefined, % = 4
         marriage               :: pb_1149_artifact:p_marriage() | undefined, % = 5
         ...
         refine = []            :: [pb_1149_artifact:p_refine()] | undefined, % = 11
         suite = #{}            :: #{integer() := integer()} | undefined, % = 12
         combine = []           :: [pb_1149_artifact:p_item()] | undefined % = 13
        }).
-endif.
...
-record(p_marriage,
        {husband_id             :: non_neg_integer() | undefined, % = 1, 32 bits
         ...
         rare                   :: pb_1149_artifact:p_attr() | undefined % = 5
        }).
-endif.
...
-record(p_actor,
        {uid                    :: non_neg_integer(), % = 1, 32 bits
         ...
         coord                  :: pb_1149_artifact:p_coord(), % = 4
         state                  :: integer(),       % = 5, 32 bits
         stargs = #{}           :: #{integer() := iolist()} | undefined, % = 6
         role                   :: pb_1149_artifact:p_role() | undefined, % = 7
         creep                  :: pb_1149_artifact:p_creep() | undefined, % = 8
         drop                   :: pb_1149_artifact:p_drop() | undefined % = 9
        }).
-endif.
...
-record(p_role,
        {career                 :: integer(),       % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1149_artifact:p_aspect()} | undefined, % = 5
         ...
         icon                   :: pb_1149_artifact:p_icon() | undefined % = 25
        }).
-endif.
...
-record(p_creep,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         buffs = []             :: [pb_1149_artifact:p_buff()] | undefined, % = 6
         dir                    :: integer(),       % = 7, 32 bits
         dest                   :: pb_1149_artifact:p_coord(), % = 8
...
-record(p_npc,
        {id                     :: integer(),       % = 1, 32 bits
         coord                  :: pb_1149_artifact:p_coord() % = 2
        }).
-endif.
...
-record(p_drop,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         coord                  :: pb_1149_artifact:p_coord() | undefined, % = 5
...
-record(p_ranking,
        {base                   :: pb_1149_artifact:p_role_base() | undefined, % = 1
