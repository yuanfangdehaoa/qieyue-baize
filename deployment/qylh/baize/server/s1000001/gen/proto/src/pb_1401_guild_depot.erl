...
%% message types
-type m_guild_depot_info_tos() :: #m_guild_depot_info_tos{}.

-type m_guild_depot_info_toc() :: #m_guild_depot_info_toc{}.

-type m_guild_depot_detail_tos() :: #m_guild_depot_detail_tos{}.

-type m_guild_depot_detail_toc() :: #m_guild_depot_detail_toc{}.

-type m_guild_depot_donate_tos() :: #m_guild_depot_donate_tos{}.

-type m_guild_depot_donate_toc() :: #m_guild_depot_donate_toc{}.

-type m_guild_depot_exch_tos() :: #m_guild_depot_exch_tos{}.

-type m_guild_depot_exch_toc() :: #m_guild_depot_exch_toc{}.

-type m_guild_depot_buy_tos() :: #m_guild_depot_buy_tos{}.

-type m_guild_depot_buy_toc() :: #m_guild_depot_buy_toc{}.

-type m_guild_depot_destroy_tos() :: #m_guild_depot_destroy_tos{}.

-type m_guild_depot_destroy_toc() :: #m_guild_depot_destroy_toc{}.

-type p_donate_log() :: #p_donate_log{}.
...
-export_type(['m_guild_depot_info_tos'/0, 'm_guild_depot_info_toc'/0, 'm_guild_depot_detail_tos'/0, 'm_guild_depot_detail_toc'/0, 'm_guild_depot_donate_tos'/0, 'm_guild_depot_donate_toc'/0, 'm_guild_depot_exch_tos'/0, 'm_guild_depot_exch_toc'/0, 'm_guild_depot_buy_tos'/0, 'm_guild_depot_buy_toc'/0, 'm_guild_depot_destroy_tos'/0, 'm_guild_depot_destroy_toc'/0, 'p_donate_log'/0, 'p_role_base'/0, 'p_aspect'/0, 'p_attr'/0, 'p_item_base'/0, 'p_item'/0, 'p_equip'/0, 'p_pet'/0, 'p_marriage'/0, 'p_refine'/0, 'p_actor'/0, 'p_role'/0, 'p_creep'/0, 'p_npc'/0, 'p_drop'/0, 'p_buff'/0, 'p_coord'/0, 'p_icon'/0, 'p_ranking'/0, 'p_dropped'/0]).

-spec encode_msg(#m_guild_depot_info_tos{} | #m_guild_depot_info_toc{} | #m_guild_depot_detail_tos{} | #m_guild_depot_detail_toc{} | #m_guild_depot_donate_tos{} | #m_guild_depot_donate_toc{} | #m_guild_depot_exch_tos{} | #m_guild_depot_exch_toc{} | #m_guild_depot_buy_tos{} | #m_guild_depot_buy_toc{} | #m_guild_depot_destroy_tos{} | #m_guild_depot_destroy_toc{} | #p_donate_log{} | #p_role_base{} | #p_aspect{} | #p_attr{} | #p_item_base{} | #p_item{} | #p_equip{} | #p_pet{} | #p_marriage{} | #p_refine{} | #p_actor{} | #p_role{} | #p_creep{} | #p_npc{} | #p_drop{} | #p_buff{} | #p_coord{} | #p_icon{} | #p_ranking{} | #p_dropped{}) -> binary().
...
encode_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
      m_guild_depot_info_tos ->
	  encode_msg_m_guild_depot_info_tos(id(Msg, TrUserData),
					    TrUserData);
      m_guild_depot_info_toc ->
	  encode_msg_m_guild_depot_info_toc(id(Msg, TrUserData),
					    TrUserData);
      m_guild_depot_detail_tos ->
	  encode_msg_m_guild_depot_detail_tos(id(Msg, TrUserData),
					      TrUserData);
      m_guild_depot_detail_toc ->
	  encode_msg_m_guild_depot_detail_toc(id(Msg, TrUserData),
					      TrUserData);
      m_guild_depot_donate_tos ->
	  encode_msg_m_guild_depot_donate_tos(id(Msg, TrUserData),
					      TrUserData);
      m_guild_depot_donate_toc ->
	  encode_msg_m_guild_depot_donate_toc(id(Msg, TrUserData),
					      TrUserData);
      m_guild_depot_exch_tos ->
	  encode_msg_m_guild_depot_exch_tos(id(Msg, TrUserData),
					    TrUserData);
      m_guild_depot_exch_toc ->
	  encode_msg_m_guild_depot_exch_toc(id(Msg, TrUserData),
					    TrUserData);
      m_guild_depot_buy_tos ->
	  encode_msg_m_guild_depot_buy_tos(id(Msg, TrUserData),
					   TrUserData);
      m_guild_depot_buy_toc ->
	  encode_msg_m_guild_depot_buy_toc(id(Msg, TrUserData),
					   TrUserData);
      m_guild_depot_destroy_tos ->
	  encode_msg_m_guild_depot_destroy_tos(id(Msg,
						  TrUserData),
					       TrUserData);
      m_guild_depot_destroy_toc ->
	  encode_msg_m_guild_depot_destroy_toc(id(Msg,
						  TrUserData),
					       TrUserData);
      p_donate_log ->
	  encode_msg_p_donate_log(id(Msg, TrUserData),
				  TrUserData);
      p_role_base ->
...
encode_msg_m_guild_depot_info_tos(_Msg, _TrUserData) ->
    <<>>.

encode_msg_m_guild_depot_info_toc(Msg, TrUserData) ->
    encode_msg_m_guild_depot_info_toc(Msg, <<>>,
				      TrUserData).


encode_msg_m_guild_depot_info_toc(#m_guild_depot_info_toc{score
							      = F1,
							  items = F2,
							  logs = F3},
				  Bin, TrUserData) ->
    ...
    B2 = begin
	   ...
	   if TrF2 == [] -> B1;
	      true ->
		  e_field_m_guild_depot_info_toc_items(TrF2, B1,
						       TrUserData)
	   end
	 end,
    begin
      ...
      if TrF3 == [] -> B2;
	 true ->
	     e_field_m_guild_depot_info_toc_logs(TrF3, B2,
						 TrUserData)
      end
    end.

encode_msg_m_guild_depot_detail_tos(Msg, TrUserData) ->
    encode_msg_m_guild_depot_detail_tos(Msg, <<>>,
					TrUserData).


encode_msg_m_guild_depot_detail_tos(#m_guild_depot_detail_tos{uid
								  = F1},
				    Bin, TrUserData) ->
    begin
      TrF1 = id(F1, TrUserData),
...
encode_msg_m_guild_depot_detail_toc(Msg, TrUserData) ->
    encode_msg_m_guild_depot_detail_toc(Msg, <<>>,
					TrUserData).


encode_msg_m_guild_depot_detail_toc(#m_guild_depot_detail_toc{item
								  = F1},
				    Bin, TrUserData) ->
    begin
      TrF1 = id(F1, TrUserData),
      e_mfield_m_guild_depot_detail_toc_item(TrF1,
					     <<Bin/binary, 10>>, TrUserData)
    end.

encode_msg_m_guild_depot_donate_tos(Msg, TrUserData) ->
    encode_msg_m_guild_depot_donate_tos(Msg, <<>>,
					TrUserData).


encode_msg_m_guild_depot_donate_tos(#m_guild_depot_donate_tos{uid
								  = F1},
				    Bin, TrUserData) ->
    begin
      TrF1 = id(F1, TrUserData),
...
encode_msg_m_guild_depot_donate_toc(Msg, TrUserData) ->
    encode_msg_m_guild_depot_donate_toc(Msg, <<>>,
					TrUserData).


encode_msg_m_guild_depot_donate_toc(#m_guild_depot_donate_toc{role_id
								  = F1,
							      role_name = F2,
							      item = F3,
							      score = F4,
    ...
    B3 = begin
	   TrF3 = id(F3, TrUserData),
	   e_mfield_m_guild_depot_donate_toc_item(TrF3,
...
encode_msg_m_guild_depot_exch_tos(Msg, TrUserData) ->
    encode_msg_m_guild_depot_exch_tos(Msg, <<>>,
				      TrUserData).


encode_msg_m_guild_depot_exch_tos(#m_guild_depot_exch_tos{uid
							      = F1},
				  Bin, TrUserData) ->
    begin
      TrF1 = id(F1, TrUserData),
...
encode_msg_m_guild_depot_exch_toc(Msg, TrUserData) ->
    encode_msg_m_guild_depot_exch_toc(Msg, <<>>,
				      TrUserData).


encode_msg_m_guild_depot_exch_toc(#m_guild_depot_exch_toc{role_id
							      = F1,
							  role_name = F2,
							  item = F3, score = F4,
							  time = F5},
    ...
    B3 = begin
	   TrF3 = id(F3, TrUserData),
	   e_mfield_m_guild_depot_exch_toc_item(TrF3,
						<<B2/binary, 26>>, TrUserData)
	 end,
    B4 = begin
	   TrF4 = id(F4, TrUserData),
...
encode_msg_m_guild_depot_buy_tos(Msg, TrUserData) ->
    encode_msg_m_guild_depot_buy_tos(Msg, <<>>, TrUserData).


encode_msg_m_guild_depot_buy_tos(#m_guild_depot_buy_tos{item_id
							    = F1,
							num = F2},
				 Bin, TrUserData) ->
    B1 = begin
...
encode_msg_m_guild_depot_buy_toc(Msg, TrUserData) ->
    encode_msg_m_guild_depot_buy_toc(Msg, <<>>, TrUserData).


encode_msg_m_guild_depot_buy_toc(#m_guild_depot_buy_toc{role_id
							    = F1,
							role_name = F2,
							item = F3, score = F4,
							time = F5},
    ...
    B3 = begin
	   TrF3 = id(F3, TrUserData),
	   e_mfield_m_guild_depot_buy_toc_item(TrF3,
					       <<B2/binary, 26>>, TrUserData)
	 end,
    B4 = begin
	   TrF4 = id(F4, TrUserData),
...
encode_msg_m_guild_depot_destroy_tos(Msg, TrUserData) ->
    encode_msg_m_guild_depot_destroy_tos(Msg, <<>>,
					 TrUserData).


encode_msg_m_guild_depot_destroy_tos(#m_guild_depot_destroy_tos{uids
								    = F1},
				     Bin, TrUserData) ->
    begin
      TrF1 = id(F1, TrUserData),
      if TrF1 == [] -> Bin;
	 true ->
	     e_field_m_guild_depot_destroy_tos_uids(TrF1, Bin,
						    TrUserData)
      end
    end.

encode_msg_m_guild_depot_destroy_toc(Msg, TrUserData) ->
    encode_msg_m_guild_depot_destroy_toc(Msg, <<>>,
					 TrUserData).


encode_msg_m_guild_depot_destroy_toc(#m_guild_depot_destroy_toc{uids
								    = F1},
				     Bin, TrUserData) ->
    begin
      TrF1 = id(F1, TrUserData),
      if TrF1 == [] -> Bin;
	 true ->
	     e_field_m_guild_depot_destroy_toc_uids(TrF1, Bin,
						    TrUserData)
      end
    end.

encode_msg_p_donate_log(Msg, TrUserData) ->
    encode_msg_p_donate_log(Msg, <<>>, TrUserData).


encode_msg_p_donate_log(#p_donate_log{type = F1,
				      role_id = F2, role_name = F3, item = F4,
				      score = F5, time = F6},
			Bin, TrUserData) ->
    B1 = begin
	   TrF1 = id(F1, TrUserData),
    ...
    B4 = begin
	   TrF4 = id(F4, TrUserData),
	   e_mfield_p_donate_log_item(TrF4, <<B3/binary, 34>>,
				      TrUserData)
	 end,
    B5 = begin
	   TrF5 = id(F5, TrUserData),
...
e_mfield_m_guild_depot_info_toc_items(Msg, Bin,
				      TrUserData) ->
    SubBin = encode_msg_p_item_base(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

e_field_m_guild_depot_info_toc_items([Elem | Rest], Bin,
				     TrUserData) ->
    Bin2 = <<Bin/binary, 18>>,
    Bin3 = e_mfield_m_guild_depot_info_toc_items(id(Elem,
						    TrUserData),
						 Bin2, TrUserData),
    e_field_m_guild_depot_info_toc_items(Rest, Bin3,
					 TrUserData);
e_field_m_guild_depot_info_toc_items([], Bin,
				     _TrUserData) ->
    Bin.

e_mfield_m_guild_depot_info_toc_logs(Msg, Bin,
				     TrUserData) ->
    SubBin = encode_msg_p_donate_log(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

e_field_m_guild_depot_info_toc_logs([Elem | Rest], Bin,
				    TrUserData) ->
    Bin2 = <<Bin/binary, 26>>,
    Bin3 = e_mfield_m_guild_depot_info_toc_logs(id(Elem,
						   TrUserData),
						Bin2, TrUserData),
    e_field_m_guild_depot_info_toc_logs(Rest, Bin3,
					TrUserData);
e_field_m_guild_depot_info_toc_logs([], Bin,
				    _TrUserData) ->
    Bin.

e_mfield_m_guild_depot_detail_toc_item(Msg, Bin,
				       TrUserData) ->
    SubBin = encode_msg_p_item(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

e_mfield_m_guild_depot_donate_toc_item(Msg, Bin,
				       TrUserData) ->
    SubBin = encode_msg_p_item(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

e_mfield_m_guild_depot_exch_toc_item(Msg, Bin,
				     TrUserData) ->
    SubBin = encode_msg_p_item(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

e_mfield_m_guild_depot_buy_toc_item(Msg, Bin,
				    TrUserData) ->
    SubBin = encode_msg_p_item(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

e_field_m_guild_depot_destroy_tos_uids([Elem | Rest],
				       Bin, TrUserData) ->
    Bin2 = <<Bin/binary, 8>>,
    Bin3 = e_type_int32(id(Elem, TrUserData), Bin2,
			TrUserData),
    e_field_m_guild_depot_destroy_tos_uids(Rest, Bin3,
					   TrUserData);
e_field_m_guild_depot_destroy_tos_uids([], Bin,
				       _TrUserData) ->
    Bin.

e_field_m_guild_depot_destroy_toc_uids([Elem | Rest],
				       Bin, TrUserData) ->
    Bin2 = <<Bin/binary, 8>>,
    Bin3 = e_type_int32(id(Elem, TrUserData), Bin2,
			TrUserData),
    e_field_m_guild_depot_destroy_toc_uids(Rest, Bin3,
					   TrUserData);
e_field_m_guild_depot_destroy_toc_uids([], Bin,
				       _TrUserData) ->
    Bin.

e_mfield_p_donate_log_item(Msg, Bin, TrUserData) ->
    SubBin = encode_msg_p_item(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.
...
decode_msg_2_doit(m_guild_depot_info_tos, Bin,
		  TrUserData) ->
    id(decode_msg_m_guild_depot_info_tos(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_guild_depot_info_toc, Bin,
		  TrUserData) ->
    id(decode_msg_m_guild_depot_info_toc(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_guild_depot_detail_tos, Bin,
		  TrUserData) ->
    id(decode_msg_m_guild_depot_detail_tos(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_guild_depot_detail_toc, Bin,
		  TrUserData) ->
    id(decode_msg_m_guild_depot_detail_toc(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_guild_depot_donate_tos, Bin,
		  TrUserData) ->
    id(decode_msg_m_guild_depot_donate_tos(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_guild_depot_donate_toc, Bin,
		  TrUserData) ->
    id(decode_msg_m_guild_depot_donate_toc(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_guild_depot_exch_tos, Bin,
		  TrUserData) ->
    id(decode_msg_m_guild_depot_exch_tos(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_guild_depot_exch_toc, Bin,
		  TrUserData) ->
    id(decode_msg_m_guild_depot_exch_toc(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_guild_depot_buy_tos, Bin,
		  TrUserData) ->
    id(decode_msg_m_guild_depot_buy_tos(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_guild_depot_buy_toc, Bin,
		  TrUserData) ->
    id(decode_msg_m_guild_depot_buy_toc(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_guild_depot_destroy_tos, Bin,
		  TrUserData) ->
    id(decode_msg_m_guild_depot_destroy_tos(Bin,
					    TrUserData),
       TrUserData);
decode_msg_2_doit(m_guild_depot_destroy_toc, Bin,
		  TrUserData) ->
    id(decode_msg_m_guild_depot_destroy_toc(Bin,
					    TrUserData),
       TrUserData);
decode_msg_2_doit(p_donate_log, Bin, TrUserData) ->
    id(decode_msg_p_donate_log(Bin, TrUserData),
       TrUserData);
...
decode_msg_m_guild_depot_info_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_guild_depot_info_tos(Bin, 0, 0,
					      TrUserData).

dfp_read_field_def_m_guild_depot_info_tos(<<>>, 0, 0,
					  _) ->
    #m_guild_depot_info_tos{};
dfp_read_field_def_m_guild_depot_info_tos(Other, Z1, Z2,
					  TrUserData) ->
    dg_read_field_def_m_guild_depot_info_tos(Other, Z1, Z2,
					     TrUserData).

dg_read_field_def_m_guild_depot_info_tos(<<1:1, X:7,
					   Rest/binary>>,
					 N, Acc, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_guild_depot_info_tos(Rest, N + 7,
					     X bsl N + Acc, TrUserData);
dg_read_field_def_m_guild_depot_info_tos(<<0:1, X:7,
					   Rest/binary>>,
					 N, Acc, TrUserData) ->
    Key = X bsl N + Acc,
    case Key band 7 of
      0 ->
	  skip_varint_m_guild_depot_info_tos(Rest, 0, 0,
					     TrUserData);
      1 ->
	  skip_64_m_guild_depot_info_tos(Rest, 0, 0, TrUserData);
      2 ->
	  skip_length_delimited_m_guild_depot_info_tos(Rest, 0, 0,
						       TrUserData);
      3 ->
	  skip_group_m_guild_depot_info_tos(Rest, Key bsr 3, 0,
					    TrUserData);
      5 ->
	  skip_32_m_guild_depot_info_tos(Rest, 0, 0, TrUserData)
    end;
dg_read_field_def_m_guild_depot_info_tos(<<>>, 0, 0,
					 _) ->
    #m_guild_depot_info_tos{}.

skip_varint_m_guild_depot_info_tos(<<1:1, _:7,
				     Rest/binary>>,
				   Z1, Z2, TrUserData) ->
    skip_varint_m_guild_depot_info_tos(Rest, Z1, Z2,
				       TrUserData);
skip_varint_m_guild_depot_info_tos(<<0:1, _:7,
				     Rest/binary>>,
				   Z1, Z2, TrUserData) ->
    dfp_read_field_def_m_guild_depot_info_tos(Rest, Z1, Z2,
					      TrUserData).

skip_length_delimited_m_guild_depot_info_tos(<<1:1, X:7,
					       Rest/binary>>,
					     N, Acc, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_guild_depot_info_tos(Rest,
						 N + 7, X bsl N + Acc,
						 TrUserData);
skip_length_delimited_m_guild_depot_info_tos(<<0:1, X:7,
					       Rest/binary>>,
					     N, Acc, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_guild_depot_info_tos(Rest2, 0, 0,
					      TrUserData).

skip_group_m_guild_depot_info_tos(Bin, FNum, Z2,
				  TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_guild_depot_info_tos(Rest, 0, Z2,
					      TrUserData).

skip_32_m_guild_depot_info_tos(<<_:32, Rest/binary>>,
			       Z1, Z2, TrUserData) ->
    dfp_read_field_def_m_guild_depot_info_tos(Rest, Z1, Z2,
					      TrUserData).

skip_64_m_guild_depot_info_tos(<<_:64, Rest/binary>>,
			       Z1, Z2, TrUserData) ->
    dfp_read_field_def_m_guild_depot_info_tos(Rest, Z1, Z2,
					      TrUserData).

decode_msg_m_guild_depot_info_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_guild_depot_info_toc(Bin, 0, 0,
					      id(undefined, TrUserData),
					      id([], TrUserData),
					      id([], TrUserData), TrUserData).

dfp_read_field_def_m_guild_depot_info_toc(<<8,
					    Rest/binary>>,
					  Z1, Z2, F@_1, F@_2, F@_3,
					  TrUserData) ->
    d_field_m_guild_depot_info_toc_score(Rest, Z1, Z2, F@_1,
					 F@_2, F@_3, TrUserData);
dfp_read_field_def_m_guild_depot_info_toc(<<18,
					    Rest/binary>>,
					  Z1, Z2, F@_1, F@_2, F@_3,
					  TrUserData) ->
    d_field_m_guild_depot_info_toc_items(Rest, Z1, Z2, F@_1,
					 F@_2, F@_3, TrUserData);
dfp_read_field_def_m_guild_depot_info_toc(<<26,
					    Rest/binary>>,
					  Z1, Z2, F@_1, F@_2, F@_3,
					  TrUserData) ->
    d_field_m_guild_depot_info_toc_logs(Rest, Z1, Z2, F@_1,
					F@_2, F@_3, TrUserData);
dfp_read_field_def_m_guild_depot_info_toc(<<>>, 0, 0,
					  F@_1, R1, R2, TrUserData) ->
    #m_guild_depot_info_toc{score = F@_1,
			    items = lists_reverse(R1, TrUserData),
			    logs = lists_reverse(R2, TrUserData)};
dfp_read_field_def_m_guild_depot_info_toc(Other, Z1, Z2,
					  F@_1, F@_2, F@_3, TrUserData) ->
    dg_read_field_def_m_guild_depot_info_toc(Other, Z1, Z2,
					     F@_1, F@_2, F@_3, TrUserData).

dg_read_field_def_m_guild_depot_info_toc(<<1:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_guild_depot_info_toc(Rest, N + 7,
					     X bsl N + Acc, F@_1, F@_2, F@_3,
					     TrUserData);
dg_read_field_def_m_guild_depot_info_toc(<<0:1, X:7,
					   Rest/binary>>,
    ...
    case Key of
      8 ->
	  d_field_m_guild_depot_info_toc_score(Rest, 0, 0, F@_1,
					       F@_2, F@_3, TrUserData);
      18 ->
	  d_field_m_guild_depot_info_toc_items(Rest, 0, 0, F@_1,
					       F@_2, F@_3, TrUserData);
      26 ->
	  d_field_m_guild_depot_info_toc_logs(Rest, 0, 0, F@_1,
					      F@_2, F@_3, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_guild_depot_info_toc(Rest, 0, 0, F@_1,
						   F@_2, F@_3, TrUserData);
	    1 ->
		skip_64_m_guild_depot_info_toc(Rest, 0, 0, F@_1, F@_2,
					       F@_3, TrUserData);
	    2 ->
		skip_length_delimited_m_guild_depot_info_toc(Rest, 0, 0,
							     F@_1, F@_2, F@_3,
							     TrUserData);
	    3 ->
		skip_group_m_guild_depot_info_toc(Rest, Key bsr 3, 0,
						  F@_1, F@_2, F@_3, TrUserData);
	    5 ->
		skip_32_m_guild_depot_info_toc(Rest, 0, 0, F@_1, F@_2,
					       F@_3, TrUserData)
	  end
    end;
dg_read_field_def_m_guild_depot_info_toc(<<>>, 0, 0,
					 F@_1, R1, R2, TrUserData) ->
    #m_guild_depot_info_toc{score = F@_1,
			    items = lists_reverse(R1, TrUserData),
			    logs = lists_reverse(R2, TrUserData)}.

d_field_m_guild_depot_info_toc_score(<<1:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    d_field_m_guild_depot_info_toc_score(Rest, N + 7,
					 X bsl N + Acc, F@_1, F@_2, F@_3,
					 TrUserData);
d_field_m_guild_depot_info_toc_score(<<0:1, X:7,
				       Rest/binary>>,
    ...
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    dfp_read_field_def_m_guild_depot_info_toc(RestF, 0, 0,
					      NewFValue, F@_2, F@_3,
					      TrUserData).

d_field_m_guild_depot_info_toc_items(<<1:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    d_field_m_guild_depot_info_toc_items(Rest, N + 7,
					 X bsl N + Acc, F@_1, F@_2, F@_3,
					 TrUserData);
d_field_m_guild_depot_info_toc_items(<<0:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, Prev, F@_3, TrUserData) ->
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
			   <<Bs:Len/binary, Rest2/binary>> = Rest,
			   {id(decode_msg_p_item_base(Bs, TrUserData),
			       TrUserData),
			    Rest2}
			 end,
    dfp_read_field_def_m_guild_depot_info_toc(RestF, 0, 0,
...
d_field_m_guild_depot_info_toc_logs(<<1:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    d_field_m_guild_depot_info_toc_logs(Rest, N + 7,
					X bsl N + Acc, F@_1, F@_2, F@_3,
					TrUserData);
d_field_m_guild_depot_info_toc_logs(<<0:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, F@_2, Prev, TrUserData) ->
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
			   <<Bs:Len/binary, Rest2/binary>> = Rest,
			   {id(decode_msg_p_donate_log(Bs, TrUserData),
			       TrUserData),
			    Rest2}
			 end,
    dfp_read_field_def_m_guild_depot_info_toc(RestF, 0, 0,
...
skip_varint_m_guild_depot_info_toc(<<1:1, _:7,
				     Rest/binary>>,
				   Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
    skip_varint_m_guild_depot_info_toc(Rest, Z1, Z2, F@_1,
				       F@_2, F@_3, TrUserData);
skip_varint_m_guild_depot_info_toc(<<0:1, _:7,
				     Rest/binary>>,
				   Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
    dfp_read_field_def_m_guild_depot_info_toc(Rest, Z1, Z2,
					      F@_1, F@_2, F@_3, TrUserData).

skip_length_delimited_m_guild_depot_info_toc(<<1:1, X:7,
					       Rest/binary>>,
					     N, Acc, F@_1, F@_2, F@_3,
					     TrUserData)
    when N < 57 ->
    skip_length_delimited_m_guild_depot_info_toc(Rest,
						 N + 7, X bsl N + Acc, F@_1,
						 F@_2, F@_3, TrUserData);
skip_length_delimited_m_guild_depot_info_toc(<<0:1, X:7,
					       Rest/binary>>,
					     N, Acc, F@_1, F@_2, F@_3,
					     TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_guild_depot_info_toc(Rest2, 0, 0,
					      F@_1, F@_2, F@_3, TrUserData).

skip_group_m_guild_depot_info_toc(Bin, FNum, Z2, F@_1,
				  F@_2, F@_3, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_guild_depot_info_toc(Rest, 0, Z2,
					      F@_1, F@_2, F@_3, TrUserData).

skip_32_m_guild_depot_info_toc(<<_:32, Rest/binary>>,
			       Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
    dfp_read_field_def_m_guild_depot_info_toc(Rest, Z1, Z2,
					      F@_1, F@_2, F@_3, TrUserData).

skip_64_m_guild_depot_info_toc(<<_:64, Rest/binary>>,
			       Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
    dfp_read_field_def_m_guild_depot_info_toc(Rest, Z1, Z2,
					      F@_1, F@_2, F@_3, TrUserData).

decode_msg_m_guild_depot_detail_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_guild_depot_detail_tos(Bin, 0, 0,
						id(undefined, TrUserData),
						TrUserData).

dfp_read_field_def_m_guild_depot_detail_tos(<<8,
					      Rest/binary>>,
					    Z1, Z2, F@_1, TrUserData) ->
    d_field_m_guild_depot_detail_tos_uid(Rest, Z1, Z2, F@_1,
					 TrUserData);
dfp_read_field_def_m_guild_depot_detail_tos(<<>>, 0, 0,
					    F@_1, _) ->
    #m_guild_depot_detail_tos{uid = F@_1};
dfp_read_field_def_m_guild_depot_detail_tos(Other, Z1,
					    Z2, F@_1, TrUserData) ->
    dg_read_field_def_m_guild_depot_detail_tos(Other, Z1,
					       Z2, F@_1, TrUserData).

dg_read_field_def_m_guild_depot_detail_tos(<<1:1, X:7,
					     Rest/binary>>,
					   N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_guild_depot_detail_tos(Rest, N + 7,
					       X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_m_guild_depot_detail_tos(<<0:1, X:7,
					     Rest/binary>>,
					   N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_guild_depot_detail_tos_uid(Rest, 0, 0, F@_1,
					       TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_guild_depot_detail_tos(Rest, 0, 0, F@_1,
						     TrUserData);
	    1 ->
		skip_64_m_guild_depot_detail_tos(Rest, 0, 0, F@_1,
						 TrUserData);
	    2 ->
		skip_length_delimited_m_guild_depot_detail_tos(Rest, 0,
							       0, F@_1,
							       TrUserData);
	    3 ->
		skip_group_m_guild_depot_detail_tos(Rest, Key bsr 3, 0,
						    F@_1, TrUserData);
	    5 ->
		skip_32_m_guild_depot_detail_tos(Rest, 0, 0, F@_1,
						 TrUserData)
	  end
    end;
dg_read_field_def_m_guild_depot_detail_tos(<<>>, 0, 0,
					   F@_1, _) ->
    #m_guild_depot_detail_tos{uid = F@_1}.

d_field_m_guild_depot_detail_tos_uid(<<1:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_m_guild_depot_detail_tos_uid(Rest, N + 7,
					 X bsl N + Acc, F@_1, TrUserData);
d_field_m_guild_depot_detail_tos_uid(<<0:1, X:7,
				       Rest/binary>>,
				     N, Acc, _, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    dfp_read_field_def_m_guild_depot_detail_tos(RestF, 0, 0,
						NewFValue, TrUserData).

skip_varint_m_guild_depot_detail_tos(<<1:1, _:7,
				       Rest/binary>>,
				     Z1, Z2, F@_1, TrUserData) ->
    skip_varint_m_guild_depot_detail_tos(Rest, Z1, Z2, F@_1,
					 TrUserData);
skip_varint_m_guild_depot_detail_tos(<<0:1, _:7,
				       Rest/binary>>,
				     Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_guild_depot_detail_tos(Rest, Z1,
						Z2, F@_1, TrUserData).

skip_length_delimited_m_guild_depot_detail_tos(<<1:1,
						 X:7, Rest/binary>>,
					       N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_guild_depot_detail_tos(Rest,
						   N + 7, X bsl N + Acc, F@_1,
						   TrUserData);
skip_length_delimited_m_guild_depot_detail_tos(<<0:1,
						 X:7, Rest/binary>>,
					       N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_guild_depot_detail_tos(Rest2, 0, 0,
						F@_1, TrUserData).

skip_group_m_guild_depot_detail_tos(Bin, FNum, Z2, F@_1,
				    TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_guild_depot_detail_tos(Rest, 0, Z2,
						F@_1, TrUserData).

skip_32_m_guild_depot_detail_tos(<<_:32, Rest/binary>>,
				 Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_guild_depot_detail_tos(Rest, Z1,
						Z2, F@_1, TrUserData).

skip_64_m_guild_depot_detail_tos(<<_:64, Rest/binary>>,
				 Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_guild_depot_detail_tos(Rest, Z1,
						Z2, F@_1, TrUserData).

decode_msg_m_guild_depot_detail_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_guild_depot_detail_toc(Bin, 0, 0,
						id(undefined, TrUserData),
						TrUserData).

dfp_read_field_def_m_guild_depot_detail_toc(<<10,
					      Rest/binary>>,
					    Z1, Z2, F@_1, TrUserData) ->
    d_field_m_guild_depot_detail_toc_item(Rest, Z1, Z2,
					  F@_1, TrUserData);
dfp_read_field_def_m_guild_depot_detail_toc(<<>>, 0, 0,
					    F@_1, _) ->
    #m_guild_depot_detail_toc{item = F@_1};
dfp_read_field_def_m_guild_depot_detail_toc(Other, Z1,
					    Z2, F@_1, TrUserData) ->
    dg_read_field_def_m_guild_depot_detail_toc(Other, Z1,
					       Z2, F@_1, TrUserData).

dg_read_field_def_m_guild_depot_detail_toc(<<1:1, X:7,
					     Rest/binary>>,
					   N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_guild_depot_detail_toc(Rest, N + 7,
					       X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_m_guild_depot_detail_toc(<<0:1, X:7,
					     Rest/binary>>,
					   N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      10 ->
	  d_field_m_guild_depot_detail_toc_item(Rest, 0, 0, F@_1,
						TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_guild_depot_detail_toc(Rest, 0, 0, F@_1,
						     TrUserData);
	    1 ->
		skip_64_m_guild_depot_detail_toc(Rest, 0, 0, F@_1,
						 TrUserData);
	    2 ->
		skip_length_delimited_m_guild_depot_detail_toc(Rest, 0,
							       0, F@_1,
							       TrUserData);
	    3 ->
		skip_group_m_guild_depot_detail_toc(Rest, Key bsr 3, 0,
						    F@_1, TrUserData);
	    5 ->
		skip_32_m_guild_depot_detail_toc(Rest, 0, 0, F@_1,
						 TrUserData)
	  end
    end;
dg_read_field_def_m_guild_depot_detail_toc(<<>>, 0, 0,
					   F@_1, _) ->
    #m_guild_depot_detail_toc{item = F@_1}.

d_field_m_guild_depot_detail_toc_item(<<1:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_m_guild_depot_detail_toc_item(Rest, N + 7,
					  X bsl N + Acc, F@_1, TrUserData);
d_field_m_guild_depot_detail_toc_item(<<0:1, X:7,
					Rest/binary>>,
    ...
    dfp_read_field_def_m_guild_depot_detail_toc(RestF, 0, 0,
						if Prev == undefined ->
						       NewFValue;
						   true ->
...
skip_varint_m_guild_depot_detail_toc(<<1:1, _:7,
				       Rest/binary>>,
				     Z1, Z2, F@_1, TrUserData) ->
    skip_varint_m_guild_depot_detail_toc(Rest, Z1, Z2, F@_1,
					 TrUserData);
skip_varint_m_guild_depot_detail_toc(<<0:1, _:7,
				       Rest/binary>>,
				     Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_guild_depot_detail_toc(Rest, Z1,
						Z2, F@_1, TrUserData).

skip_length_delimited_m_guild_depot_detail_toc(<<1:1,
						 X:7, Rest/binary>>,
					       N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_guild_depot_detail_toc(Rest,
						   N + 7, X bsl N + Acc, F@_1,
						   TrUserData);
skip_length_delimited_m_guild_depot_detail_toc(<<0:1,
						 X:7, Rest/binary>>,
					       N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_guild_depot_detail_toc(Rest2, 0, 0,
						F@_1, TrUserData).

skip_group_m_guild_depot_detail_toc(Bin, FNum, Z2, F@_1,
				    TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_guild_depot_detail_toc(Rest, 0, Z2,
						F@_1, TrUserData).

skip_32_m_guild_depot_detail_toc(<<_:32, Rest/binary>>,
				 Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_guild_depot_detail_toc(Rest, Z1,
						Z2, F@_1, TrUserData).

skip_64_m_guild_depot_detail_toc(<<_:64, Rest/binary>>,
				 Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_guild_depot_detail_toc(Rest, Z1,
						Z2, F@_1, TrUserData).

decode_msg_m_guild_depot_donate_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_guild_depot_donate_tos(Bin, 0, 0,
						id(undefined, TrUserData),
						TrUserData).

dfp_read_field_def_m_guild_depot_donate_tos(<<8,
					      Rest/binary>>,
					    Z1, Z2, F@_1, TrUserData) ->
    d_field_m_guild_depot_donate_tos_uid(Rest, Z1, Z2, F@_1,
					 TrUserData);
dfp_read_field_def_m_guild_depot_donate_tos(<<>>, 0, 0,
					    F@_1, _) ->
    #m_guild_depot_donate_tos{uid = F@_1};
dfp_read_field_def_m_guild_depot_donate_tos(Other, Z1,
					    Z2, F@_1, TrUserData) ->
    dg_read_field_def_m_guild_depot_donate_tos(Other, Z1,
					       Z2, F@_1, TrUserData).

dg_read_field_def_m_guild_depot_donate_tos(<<1:1, X:7,
					     Rest/binary>>,
					   N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_guild_depot_donate_tos(Rest, N + 7,
					       X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_m_guild_depot_donate_tos(<<0:1, X:7,
					     Rest/binary>>,
					   N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_guild_depot_donate_tos_uid(Rest, 0, 0, F@_1,
					       TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_guild_depot_donate_tos(Rest, 0, 0, F@_1,
						     TrUserData);
	    1 ->
		skip_64_m_guild_depot_donate_tos(Rest, 0, 0, F@_1,
						 TrUserData);
	    2 ->
		skip_length_delimited_m_guild_depot_donate_tos(Rest, 0,
							       0, F@_1,
							       TrUserData);
	    3 ->
		skip_group_m_guild_depot_donate_tos(Rest, Key bsr 3, 0,
						    F@_1, TrUserData);
	    5 ->
		skip_32_m_guild_depot_donate_tos(Rest, 0, 0, F@_1,
						 TrUserData)
	  end
    end;
dg_read_field_def_m_guild_depot_donate_tos(<<>>, 0, 0,
					   F@_1, _) ->
    #m_guild_depot_donate_tos{uid = F@_1}.

d_field_m_guild_depot_donate_tos_uid(<<1:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_m_guild_depot_donate_tos_uid(Rest, N + 7,
					 X bsl N + Acc, F@_1, TrUserData);
d_field_m_guild_depot_donate_tos_uid(<<0:1, X:7,
				       Rest/binary>>,
				     N, Acc, _, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    dfp_read_field_def_m_guild_depot_donate_tos(RestF, 0, 0,
						NewFValue, TrUserData).

skip_varint_m_guild_depot_donate_tos(<<1:1, _:7,
				       Rest/binary>>,
				     Z1, Z2, F@_1, TrUserData) ->
    skip_varint_m_guild_depot_donate_tos(Rest, Z1, Z2, F@_1,
					 TrUserData);
skip_varint_m_guild_depot_donate_tos(<<0:1, _:7,
				       Rest/binary>>,
				     Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_guild_depot_donate_tos(Rest, Z1,
						Z2, F@_1, TrUserData).

skip_length_delimited_m_guild_depot_donate_tos(<<1:1,
						 X:7, Rest/binary>>,
					       N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_guild_depot_donate_tos(Rest,
						   N + 7, X bsl N + Acc, F@_1,
						   TrUserData);
skip_length_delimited_m_guild_depot_donate_tos(<<0:1,
						 X:7, Rest/binary>>,
					       N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_guild_depot_donate_tos(Rest2, 0, 0,
						F@_1, TrUserData).

skip_group_m_guild_depot_donate_tos(Bin, FNum, Z2, F@_1,
				    TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_guild_depot_donate_tos(Rest, 0, Z2,
						F@_1, TrUserData).

skip_32_m_guild_depot_donate_tos(<<_:32, Rest/binary>>,
				 Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_guild_depot_donate_tos(Rest, Z1,
						Z2, F@_1, TrUserData).

skip_64_m_guild_depot_donate_tos(<<_:64, Rest/binary>>,
				 Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_guild_depot_donate_tos(Rest, Z1,
						Z2, F@_1, TrUserData).

decode_msg_m_guild_depot_donate_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_guild_depot_donate_toc(Bin, 0, 0,
						id(undefined, TrUserData),
						id(undefined, TrUserData),
						id(undefined, TrUserData),
						id(undefined, TrUserData),
...
dfp_read_field_def_m_guild_depot_donate_toc(<<9,
					      Rest/binary>>,
					    Z1, Z2, F@_1, F@_2, F@_3, F@_4,
					    F@_5, TrUserData) ->
    d_field_m_guild_depot_donate_toc_role_id(Rest, Z1, Z2,
					     F@_1, F@_2, F@_3, F@_4, F@_5,
					     TrUserData);
dfp_read_field_def_m_guild_depot_donate_toc(<<18,
					      Rest/binary>>,
					    Z1, Z2, F@_1, F@_2, F@_3, F@_4,
					    F@_5, TrUserData) ->
    d_field_m_guild_depot_donate_toc_role_name(Rest, Z1, Z2,
					       F@_1, F@_2, F@_3, F@_4, F@_5,
					       TrUserData);
dfp_read_field_def_m_guild_depot_donate_toc(<<26,
					      Rest/binary>>,
					    Z1, Z2, F@_1, F@_2, F@_3, F@_4,
					    F@_5, TrUserData) ->
    d_field_m_guild_depot_donate_toc_item(Rest, Z1, Z2,
					  F@_1, F@_2, F@_3, F@_4, F@_5,
					  TrUserData);
dfp_read_field_def_m_guild_depot_donate_toc(<<32,
					      Rest/binary>>,
					    Z1, Z2, F@_1, F@_2, F@_3, F@_4,
					    F@_5, TrUserData) ->
    d_field_m_guild_depot_donate_toc_score(Rest, Z1, Z2,
					   F@_1, F@_2, F@_3, F@_4, F@_5,
					   TrUserData);
dfp_read_field_def_m_guild_depot_donate_toc(<<40,
					      Rest/binary>>,
					    Z1, Z2, F@_1, F@_2, F@_3, F@_4,
					    F@_5, TrUserData) ->
    d_field_m_guild_depot_donate_toc_time(Rest, Z1, Z2,
					  F@_1, F@_2, F@_3, F@_4, F@_5,
					  TrUserData);
dfp_read_field_def_m_guild_depot_donate_toc(<<>>, 0, 0,
					    F@_1, F@_2, F@_3, F@_4, F@_5, _) ->
    #m_guild_depot_donate_toc{role_id = F@_1,
			      role_name = F@_2, item = F@_3, score = F@_4,
			      time = F@_5};
dfp_read_field_def_m_guild_depot_donate_toc(Other, Z1,
					    Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
					    TrUserData) ->
    dg_read_field_def_m_guild_depot_donate_toc(Other, Z1,
					       Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
					       TrUserData).

dg_read_field_def_m_guild_depot_donate_toc(<<1:1, X:7,
					     Rest/binary>>,
					   N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
					   TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_guild_depot_donate_toc(Rest, N + 7,
					       X bsl N + Acc, F@_1, F@_2, F@_3,
					       F@_4, F@_5, TrUserData);
dg_read_field_def_m_guild_depot_donate_toc(<<0:1, X:7,
					     Rest/binary>>,
					   N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
					   TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      9 ->
	  d_field_m_guild_depot_donate_toc_role_id(Rest, 0, 0,
						   F@_1, F@_2, F@_3, F@_4, F@_5,
						   TrUserData);
      18 ->
	  d_field_m_guild_depot_donate_toc_role_name(Rest, 0, 0,
						     F@_1, F@_2, F@_3, F@_4,
						     F@_5, TrUserData);
      26 ->
	  d_field_m_guild_depot_donate_toc_item(Rest, 0, 0, F@_1,
						F@_2, F@_3, F@_4, F@_5,
						TrUserData);
      32 ->
	  d_field_m_guild_depot_donate_toc_score(Rest, 0, 0, F@_1,
						 F@_2, F@_3, F@_4, F@_5,
						 TrUserData);
      40 ->
	  d_field_m_guild_depot_donate_toc_time(Rest, 0, 0, F@_1,
						F@_2, F@_3, F@_4, F@_5,
						TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_guild_depot_donate_toc(Rest, 0, 0, F@_1,
						     F@_2, F@_3, F@_4, F@_5,
						     TrUserData);
	    1 ->
		skip_64_m_guild_depot_donate_toc(Rest, 0, 0, F@_1, F@_2,
						 F@_3, F@_4, F@_5, TrUserData);
	    2 ->
		skip_length_delimited_m_guild_depot_donate_toc(Rest, 0,
							       0, F@_1, F@_2,
							       F@_3, F@_4, F@_5,
							       TrUserData);
	    3 ->
		skip_group_m_guild_depot_donate_toc(Rest, Key bsr 3, 0,
						    F@_1, F@_2, F@_3, F@_4,
						    F@_5, TrUserData);
	    5 ->
		skip_32_m_guild_depot_donate_toc(Rest, 0, 0, F@_1, F@_2,
						 F@_3, F@_4, F@_5, TrUserData)
	  end
    end;
dg_read_field_def_m_guild_depot_donate_toc(<<>>, 0, 0,
					   F@_1, F@_2, F@_3, F@_4, F@_5, _) ->
    #m_guild_depot_donate_toc{role_id = F@_1,
			      role_name = F@_2, item = F@_3, score = F@_4,
			      time = F@_5}.

d_field_m_guild_depot_donate_toc_role_id(<<Value:64/little,
					   Rest/binary>>,
					 Z1, Z2, _, F@_2, F@_3, F@_4, F@_5,
					 TrUserData) ->
    dfp_read_field_def_m_guild_depot_donate_toc(Rest, Z1,
						Z2, id(Value, TrUserData), F@_2,
						F@_3, F@_4, F@_5, TrUserData).

d_field_m_guild_depot_donate_toc_role_name(<<1:1, X:7,
					     Rest/binary>>,
					   N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
					   TrUserData)
    when N < 57 ->
    d_field_m_guild_depot_donate_toc_role_name(Rest, N + 7,
					       X bsl N + Acc, F@_1, F@_2, F@_3,
					       F@_4, F@_5, TrUserData);
d_field_m_guild_depot_donate_toc_role_name(<<0:1, X:7,
					     Rest/binary>>,
    ...
    dfp_read_field_def_m_guild_depot_donate_toc(RestF, 0, 0,
						F@_1, NewFValue, F@_3, F@_4,
						F@_5, TrUserData).

d_field_m_guild_depot_donate_toc_item(<<1:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
				      TrUserData)
    when N < 57 ->
    d_field_m_guild_depot_donate_toc_item(Rest, N + 7,
					  X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
					  F@_5, TrUserData);
d_field_m_guild_depot_donate_toc_item(<<0:1, X:7,
					Rest/binary>>,
...
d_field_m_guild_depot_donate_toc_score(<<1:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
				       TrUserData)
    when N < 57 ->
    d_field_m_guild_depot_donate_toc_score(Rest, N + 7,
					   X bsl N + Acc, F@_1, F@_2, F@_3,
					   F@_4, F@_5, TrUserData);
d_field_m_guild_depot_donate_toc_score(<<0:1, X:7,
					 Rest/binary>>,
...
d_field_m_guild_depot_donate_toc_time(<<1:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
				      TrUserData)
    when N < 57 ->
    d_field_m_guild_depot_donate_toc_time(Rest, N + 7,
					  X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
					  F@_5, TrUserData);
d_field_m_guild_depot_donate_toc_time(<<0:1, X:7,
					Rest/binary>>,
...
skip_varint_m_guild_depot_donate_toc(<<1:1, _:7,
				       Rest/binary>>,
				     Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
				     TrUserData) ->
    skip_varint_m_guild_depot_donate_toc(Rest, Z1, Z2, F@_1,
					 F@_2, F@_3, F@_4, F@_5, TrUserData);
skip_varint_m_guild_depot_donate_toc(<<0:1, _:7,
				       Rest/binary>>,
				     Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
				     TrUserData) ->
    dfp_read_field_def_m_guild_depot_donate_toc(Rest, Z1,
...
skip_length_delimited_m_guild_depot_donate_toc(<<1:1,
						 X:7, Rest/binary>>,
					       N, Acc, F@_1, F@_2, F@_3, F@_4,
					       F@_5, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_guild_depot_donate_toc(Rest,
						   N + 7, X bsl N + Acc, F@_1,
						   F@_2, F@_3, F@_4, F@_5,
						   TrUserData);
skip_length_delimited_m_guild_depot_donate_toc(<<0:1,
						 X:7, Rest/binary>>,
					       N, Acc, F@_1, F@_2, F@_3, F@_4,
					       F@_5, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_guild_depot_donate_toc(Rest2, 0, 0,
						F@_1, F@_2, F@_3, F@_4, F@_5,
						TrUserData).

skip_group_m_guild_depot_donate_toc(Bin, FNum, Z2, F@_1,
				    F@_2, F@_3, F@_4, F@_5, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_guild_depot_donate_toc(Rest, 0, Z2,
						F@_1, F@_2, F@_3, F@_4, F@_5,
						TrUserData).

skip_32_m_guild_depot_donate_toc(<<_:32, Rest/binary>>,
				 Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
				 TrUserData) ->
    dfp_read_field_def_m_guild_depot_donate_toc(Rest, Z1,
						Z2, F@_1, F@_2, F@_3, F@_4,
...
skip_64_m_guild_depot_donate_toc(<<_:64, Rest/binary>>,
				 Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
				 TrUserData) ->
    dfp_read_field_def_m_guild_depot_donate_toc(Rest, Z1,
						Z2, F@_1, F@_2, F@_3, F@_4,
...
decode_msg_m_guild_depot_exch_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_guild_depot_exch_tos(Bin, 0, 0,
					      id(undefined, TrUserData),
					      TrUserData).

dfp_read_field_def_m_guild_depot_exch_tos(<<8,
					    Rest/binary>>,
					  Z1, Z2, F@_1, TrUserData) ->
    d_field_m_guild_depot_exch_tos_uid(Rest, Z1, Z2, F@_1,
				       TrUserData);
dfp_read_field_def_m_guild_depot_exch_tos(<<>>, 0, 0,
					  F@_1, _) ->
    #m_guild_depot_exch_tos{uid = F@_1};
dfp_read_field_def_m_guild_depot_exch_tos(Other, Z1, Z2,
					  F@_1, TrUserData) ->
    dg_read_field_def_m_guild_depot_exch_tos(Other, Z1, Z2,
					     F@_1, TrUserData).

dg_read_field_def_m_guild_depot_exch_tos(<<1:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_guild_depot_exch_tos(Rest, N + 7,
					     X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_m_guild_depot_exch_tos(<<0:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_guild_depot_exch_tos_uid(Rest, 0, 0, F@_1,
					     TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_guild_depot_exch_tos(Rest, 0, 0, F@_1,
						   TrUserData);
	    1 ->
		skip_64_m_guild_depot_exch_tos(Rest, 0, 0, F@_1,
					       TrUserData);
	    2 ->
		skip_length_delimited_m_guild_depot_exch_tos(Rest, 0, 0,
							     F@_1, TrUserData);
	    3 ->
		skip_group_m_guild_depot_exch_tos(Rest, Key bsr 3, 0,
						  F@_1, TrUserData);
	    5 ->
		skip_32_m_guild_depot_exch_tos(Rest, 0, 0, F@_1,
					       TrUserData)
	  end
    end;
dg_read_field_def_m_guild_depot_exch_tos(<<>>, 0, 0,
					 F@_1, _) ->
    #m_guild_depot_exch_tos{uid = F@_1}.

d_field_m_guild_depot_exch_tos_uid(<<1:1, X:7,
				     Rest/binary>>,
				   N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_m_guild_depot_exch_tos_uid(Rest, N + 7,
				       X bsl N + Acc, F@_1, TrUserData);
d_field_m_guild_depot_exch_tos_uid(<<0:1, X:7,
				     Rest/binary>>,
				   N, Acc, _, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    dfp_read_field_def_m_guild_depot_exch_tos(RestF, 0, 0,
					      NewFValue, TrUserData).

skip_varint_m_guild_depot_exch_tos(<<1:1, _:7,
				     Rest/binary>>,
				   Z1, Z2, F@_1, TrUserData) ->
    skip_varint_m_guild_depot_exch_tos(Rest, Z1, Z2, F@_1,
				       TrUserData);
skip_varint_m_guild_depot_exch_tos(<<0:1, _:7,
				     Rest/binary>>,
				   Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_guild_depot_exch_tos(Rest, Z1, Z2,
					      F@_1, TrUserData).

skip_length_delimited_m_guild_depot_exch_tos(<<1:1, X:7,
					       Rest/binary>>,
					     N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_guild_depot_exch_tos(Rest,
						 N + 7, X bsl N + Acc, F@_1,
						 TrUserData);
skip_length_delimited_m_guild_depot_exch_tos(<<0:1, X:7,
					       Rest/binary>>,
					     N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_guild_depot_exch_tos(Rest2, 0, 0,
					      F@_1, TrUserData).

skip_group_m_guild_depot_exch_tos(Bin, FNum, Z2, F@_1,
				  TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_guild_depot_exch_tos(Rest, 0, Z2,
					      F@_1, TrUserData).

skip_32_m_guild_depot_exch_tos(<<_:32, Rest/binary>>,
			       Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_guild_depot_exch_tos(Rest, Z1, Z2,
					      F@_1, TrUserData).

skip_64_m_guild_depot_exch_tos(<<_:64, Rest/binary>>,
			       Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_guild_depot_exch_tos(Rest, Z1, Z2,
					      F@_1, TrUserData).

decode_msg_m_guild_depot_exch_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_guild_depot_exch_toc(Bin, 0, 0,
					      id(undefined, TrUserData),
					      id(undefined, TrUserData),
					      id(undefined, TrUserData),
					      id(undefined, TrUserData),
...
dfp_read_field_def_m_guild_depot_exch_toc(<<9,
					    Rest/binary>>,
					  Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
					  TrUserData) ->
    d_field_m_guild_depot_exch_toc_role_id(Rest, Z1, Z2,
					   F@_1, F@_2, F@_3, F@_4, F@_5,
					   TrUserData);
dfp_read_field_def_m_guild_depot_exch_toc(<<18,
					    Rest/binary>>,
					  Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
					  TrUserData) ->
    d_field_m_guild_depot_exch_toc_role_name(Rest, Z1, Z2,
					     F@_1, F@_2, F@_3, F@_4, F@_5,
					     TrUserData);
dfp_read_field_def_m_guild_depot_exch_toc(<<26,
					    Rest/binary>>,
					  Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
					  TrUserData) ->
    d_field_m_guild_depot_exch_toc_item(Rest, Z1, Z2, F@_1,
					F@_2, F@_3, F@_4, F@_5, TrUserData);
dfp_read_field_def_m_guild_depot_exch_toc(<<32,
					    Rest/binary>>,
					  Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
					  TrUserData) ->
    d_field_m_guild_depot_exch_toc_score(Rest, Z1, Z2, F@_1,
					 F@_2, F@_3, F@_4, F@_5, TrUserData);
dfp_read_field_def_m_guild_depot_exch_toc(<<40,
					    Rest/binary>>,
					  Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
					  TrUserData) ->
    d_field_m_guild_depot_exch_toc_time(Rest, Z1, Z2, F@_1,
					F@_2, F@_3, F@_4, F@_5, TrUserData);
dfp_read_field_def_m_guild_depot_exch_toc(<<>>, 0, 0,
					  F@_1, F@_2, F@_3, F@_4, F@_5, _) ->
    #m_guild_depot_exch_toc{role_id = F@_1,
			    role_name = F@_2, item = F@_3, score = F@_4,
			    time = F@_5};
dfp_read_field_def_m_guild_depot_exch_toc(Other, Z1, Z2,
					  F@_1, F@_2, F@_3, F@_4, F@_5,
					  TrUserData) ->
    dg_read_field_def_m_guild_depot_exch_toc(Other, Z1, Z2,
					     F@_1, F@_2, F@_3, F@_4, F@_5,
					     TrUserData).

dg_read_field_def_m_guild_depot_exch_toc(<<1:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
					 TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_guild_depot_exch_toc(Rest, N + 7,
					     X bsl N + Acc, F@_1, F@_2, F@_3,
					     F@_4, F@_5, TrUserData);
dg_read_field_def_m_guild_depot_exch_toc(<<0:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
					 TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      9 ->
	  d_field_m_guild_depot_exch_toc_role_id(Rest, 0, 0, F@_1,
						 F@_2, F@_3, F@_4, F@_5,
						 TrUserData);
      18 ->
	  d_field_m_guild_depot_exch_toc_role_name(Rest, 0, 0,
						   F@_1, F@_2, F@_3, F@_4, F@_5,
						   TrUserData);
      26 ->
	  d_field_m_guild_depot_exch_toc_item(Rest, 0, 0, F@_1,
					      F@_2, F@_3, F@_4, F@_5,
					      TrUserData);
      32 ->
	  d_field_m_guild_depot_exch_toc_score(Rest, 0, 0, F@_1,
					       F@_2, F@_3, F@_4, F@_5,
					       TrUserData);
      40 ->
	  d_field_m_guild_depot_exch_toc_time(Rest, 0, 0, F@_1,
					      F@_2, F@_3, F@_4, F@_5,
					      TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_guild_depot_exch_toc(Rest, 0, 0, F@_1,
						   F@_2, F@_3, F@_4, F@_5,
						   TrUserData);
	    1 ->
		skip_64_m_guild_depot_exch_toc(Rest, 0, 0, F@_1, F@_2,
					       F@_3, F@_4, F@_5, TrUserData);
	    2 ->
		skip_length_delimited_m_guild_depot_exch_toc(Rest, 0, 0,
							     F@_1, F@_2, F@_3,
							     F@_4, F@_5,
							     TrUserData);
	    3 ->
		skip_group_m_guild_depot_exch_toc(Rest, Key bsr 3, 0,
						  F@_1, F@_2, F@_3, F@_4, F@_5,
						  TrUserData);
	    5 ->
		skip_32_m_guild_depot_exch_toc(Rest, 0, 0, F@_1, F@_2,
					       F@_3, F@_4, F@_5, TrUserData)
	  end
    end;
dg_read_field_def_m_guild_depot_exch_toc(<<>>, 0, 0,
					 F@_1, F@_2, F@_3, F@_4, F@_5, _) ->
    #m_guild_depot_exch_toc{role_id = F@_1,
			    role_name = F@_2, item = F@_3, score = F@_4,
			    time = F@_5}.

d_field_m_guild_depot_exch_toc_role_id(<<Value:64/little,
					 Rest/binary>>,
				       Z1, Z2, _, F@_2, F@_3, F@_4, F@_5,
				       TrUserData) ->
    dfp_read_field_def_m_guild_depot_exch_toc(Rest, Z1, Z2,
					      id(Value, TrUserData), F@_2, F@_3,
					      F@_4, F@_5, TrUserData).

d_field_m_guild_depot_exch_toc_role_name(<<1:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
					 TrUserData)
    when N < 57 ->
    d_field_m_guild_depot_exch_toc_role_name(Rest, N + 7,
					     X bsl N + Acc, F@_1, F@_2, F@_3,
					     F@_4, F@_5, TrUserData);
d_field_m_guild_depot_exch_toc_role_name(<<0:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, _, F@_3, F@_4, F@_5,
					 TrUserData) ->
    {NewFValue, RestF} = begin
    ...
    dfp_read_field_def_m_guild_depot_exch_toc(RestF, 0, 0,
					      F@_1, NewFValue, F@_3, F@_4, F@_5,
					      TrUserData).

d_field_m_guild_depot_exch_toc_item(<<1:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
				    TrUserData)
    when N < 57 ->
    d_field_m_guild_depot_exch_toc_item(Rest, N + 7,
					X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
					F@_5, TrUserData);
d_field_m_guild_depot_exch_toc_item(<<0:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, F@_2, Prev, F@_4, F@_5,
				    TrUserData) ->
    {NewFValue, RestF} = begin
...
d_field_m_guild_depot_exch_toc_score(<<1:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
				     TrUserData)
    when N < 57 ->
    d_field_m_guild_depot_exch_toc_score(Rest, N + 7,
					 X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
					 F@_5, TrUserData);
d_field_m_guild_depot_exch_toc_score(<<0:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, F@_2, F@_3, _, F@_5,
				     TrUserData) ->
    {NewFValue, RestF} = {begin
...
d_field_m_guild_depot_exch_toc_time(<<1:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
				    TrUserData)
    when N < 57 ->
    d_field_m_guild_depot_exch_toc_time(Rest, N + 7,
					X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
					F@_5, TrUserData);
d_field_m_guild_depot_exch_toc_time(<<0:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, F@_2, F@_3, F@_4, _,
				    TrUserData) ->
    {NewFValue, RestF} = {begin
...
skip_varint_m_guild_depot_exch_toc(<<1:1, _:7,
				     Rest/binary>>,
				   Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
				   TrUserData) ->
    skip_varint_m_guild_depot_exch_toc(Rest, Z1, Z2, F@_1,
				       F@_2, F@_3, F@_4, F@_5, TrUserData);
skip_varint_m_guild_depot_exch_toc(<<0:1, _:7,
				     Rest/binary>>,
				   Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
				   TrUserData) ->
    dfp_read_field_def_m_guild_depot_exch_toc(Rest, Z1, Z2,
...
skip_length_delimited_m_guild_depot_exch_toc(<<1:1, X:7,
					       Rest/binary>>,
					     N, Acc, F@_1, F@_2, F@_3, F@_4,
					     F@_5, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_guild_depot_exch_toc(Rest,
						 N + 7, X bsl N + Acc, F@_1,
						 F@_2, F@_3, F@_4, F@_5,
						 TrUserData);
skip_length_delimited_m_guild_depot_exch_toc(<<0:1, X:7,
					       Rest/binary>>,
					     N, Acc, F@_1, F@_2, F@_3, F@_4,
					     F@_5, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_guild_depot_exch_toc(Rest2, 0, 0,
					      F@_1, F@_2, F@_3, F@_4, F@_5,
					      TrUserData).

skip_group_m_guild_depot_exch_toc(Bin, FNum, Z2, F@_1,
				  F@_2, F@_3, F@_4, F@_5, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_guild_depot_exch_toc(Rest, 0, Z2,
					      F@_1, F@_2, F@_3, F@_4, F@_5,
					      TrUserData).

skip_32_m_guild_depot_exch_toc(<<_:32, Rest/binary>>,
			       Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
			       TrUserData) ->
    dfp_read_field_def_m_guild_depot_exch_toc(Rest, Z1, Z2,
					      F@_1, F@_2, F@_3, F@_4, F@_5,
...
skip_64_m_guild_depot_exch_toc(<<_:64, Rest/binary>>,
			       Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
			       TrUserData) ->
    dfp_read_field_def_m_guild_depot_exch_toc(Rest, Z1, Z2,
					      F@_1, F@_2, F@_3, F@_4, F@_5,
...
decode_msg_m_guild_depot_buy_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_guild_depot_buy_tos(Bin, 0, 0,
					     id(undefined, TrUserData),
					     id(undefined, TrUserData),
					     TrUserData).

dfp_read_field_def_m_guild_depot_buy_tos(<<8,
					   Rest/binary>>,
					 Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_guild_depot_buy_tos_item_id(Rest, Z1, Z2,
					  F@_1, F@_2, TrUserData);
dfp_read_field_def_m_guild_depot_buy_tos(<<16,
					   Rest/binary>>,
					 Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_guild_depot_buy_tos_num(Rest, Z1, Z2, F@_1,
				      F@_2, TrUserData);
dfp_read_field_def_m_guild_depot_buy_tos(<<>>, 0, 0,
					 F@_1, F@_2, _) ->
    #m_guild_depot_buy_tos{item_id = F@_1, num = F@_2};
dfp_read_field_def_m_guild_depot_buy_tos(Other, Z1, Z2,
					 F@_1, F@_2, TrUserData) ->
    dg_read_field_def_m_guild_depot_buy_tos(Other, Z1, Z2,
					    F@_1, F@_2, TrUserData).

dg_read_field_def_m_guild_depot_buy_tos(<<1:1, X:7,
					  Rest/binary>>,
					N, Acc, F@_1, F@_2, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_guild_depot_buy_tos(Rest, N + 7,
					    X bsl N + Acc, F@_1, F@_2,
					    TrUserData);
dg_read_field_def_m_guild_depot_buy_tos(<<0:1, X:7,
					  Rest/binary>>,
					N, Acc, F@_1, F@_2, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_guild_depot_buy_tos_item_id(Rest, 0, 0, F@_1,
						F@_2, TrUserData);
      16 ->
	  d_field_m_guild_depot_buy_tos_num(Rest, 0, 0, F@_1,
					    F@_2, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_guild_depot_buy_tos(Rest, 0, 0, F@_1,
						  F@_2, TrUserData);
	    1 ->
		skip_64_m_guild_depot_buy_tos(Rest, 0, 0, F@_1, F@_2,
					      TrUserData);
	    2 ->
		skip_length_delimited_m_guild_depot_buy_tos(Rest, 0, 0,
							    F@_1, F@_2,
							    TrUserData);
	    3 ->
		skip_group_m_guild_depot_buy_tos(Rest, Key bsr 3, 0,
						 F@_1, F@_2, TrUserData);
	    5 ->
		skip_32_m_guild_depot_buy_tos(Rest, 0, 0, F@_1, F@_2,
					      TrUserData)
	  end
    end;
dg_read_field_def_m_guild_depot_buy_tos(<<>>, 0, 0,
					F@_1, F@_2, _) ->
    #m_guild_depot_buy_tos{item_id = F@_1, num = F@_2}.

d_field_m_guild_depot_buy_tos_item_id(<<1:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_guild_depot_buy_tos_item_id(Rest, N + 7,
					  X bsl N + Acc, F@_1, F@_2,
					  TrUserData);
d_field_m_guild_depot_buy_tos_item_id(<<0:1, X:7,
					Rest/binary>>,
    ...
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    dfp_read_field_def_m_guild_depot_buy_tos(RestF, 0, 0,
					     NewFValue, F@_2, TrUserData).

d_field_m_guild_depot_buy_tos_num(<<1:1, X:7,
				    Rest/binary>>,
				  N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_guild_depot_buy_tos_num(Rest, N + 7,
				      X bsl N + Acc, F@_1, F@_2, TrUserData);
d_field_m_guild_depot_buy_tos_num(<<0:1, X:7,
				    Rest/binary>>,
...
skip_varint_m_guild_depot_buy_tos(<<1:1, _:7,
				    Rest/binary>>,
				  Z1, Z2, F@_1, F@_2, TrUserData) ->
    skip_varint_m_guild_depot_buy_tos(Rest, Z1, Z2, F@_1,
				      F@_2, TrUserData);
skip_varint_m_guild_depot_buy_tos(<<0:1, _:7,
				    Rest/binary>>,
				  Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_guild_depot_buy_tos(Rest, Z1, Z2,
					     F@_1, F@_2, TrUserData).

skip_length_delimited_m_guild_depot_buy_tos(<<1:1, X:7,
					      Rest/binary>>,
					    N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_guild_depot_buy_tos(Rest, N + 7,
						X bsl N + Acc, F@_1, F@_2,
						TrUserData);
skip_length_delimited_m_guild_depot_buy_tos(<<0:1, X:7,
					      Rest/binary>>,
					    N, Acc, F@_1, F@_2, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_guild_depot_buy_tos(Rest2, 0, 0,
					     F@_1, F@_2, TrUserData).

skip_group_m_guild_depot_buy_tos(Bin, FNum, Z2, F@_1,
				 F@_2, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_guild_depot_buy_tos(Rest, 0, Z2,
					     F@_1, F@_2, TrUserData).

skip_32_m_guild_depot_buy_tos(<<_:32, Rest/binary>>, Z1,
			      Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_guild_depot_buy_tos(Rest, Z1, Z2,
					     F@_1, F@_2, TrUserData).

skip_64_m_guild_depot_buy_tos(<<_:64, Rest/binary>>, Z1,
			      Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_guild_depot_buy_tos(Rest, Z1, Z2,
					     F@_1, F@_2, TrUserData).

decode_msg_m_guild_depot_buy_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_guild_depot_buy_toc(Bin, 0, 0,
					     id(undefined, TrUserData),
					     id(undefined, TrUserData),
					     id(undefined, TrUserData),
					     id(undefined, TrUserData),
...
dfp_read_field_def_m_guild_depot_buy_toc(<<9,
					   Rest/binary>>,
					 Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
					 TrUserData) ->
    d_field_m_guild_depot_buy_toc_role_id(Rest, Z1, Z2,
					  F@_1, F@_2, F@_3, F@_4, F@_5,
					  TrUserData);
dfp_read_field_def_m_guild_depot_buy_toc(<<18,
					   Rest/binary>>,
					 Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
					 TrUserData) ->
    d_field_m_guild_depot_buy_toc_role_name(Rest, Z1, Z2,
					    F@_1, F@_2, F@_3, F@_4, F@_5,
					    TrUserData);
dfp_read_field_def_m_guild_depot_buy_toc(<<26,
					   Rest/binary>>,
					 Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
					 TrUserData) ->
    d_field_m_guild_depot_buy_toc_item(Rest, Z1, Z2, F@_1,
				       F@_2, F@_3, F@_4, F@_5, TrUserData);
dfp_read_field_def_m_guild_depot_buy_toc(<<32,
					   Rest/binary>>,
					 Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
					 TrUserData) ->
    d_field_m_guild_depot_buy_toc_score(Rest, Z1, Z2, F@_1,
					F@_2, F@_3, F@_4, F@_5, TrUserData);
dfp_read_field_def_m_guild_depot_buy_toc(<<40,
					   Rest/binary>>,
					 Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
					 TrUserData) ->
    d_field_m_guild_depot_buy_toc_time(Rest, Z1, Z2, F@_1,
				       F@_2, F@_3, F@_4, F@_5, TrUserData);
dfp_read_field_def_m_guild_depot_buy_toc(<<>>, 0, 0,
					 F@_1, F@_2, F@_3, F@_4, F@_5, _) ->
    #m_guild_depot_buy_toc{role_id = F@_1, role_name = F@_2,
			   item = F@_3, score = F@_4, time = F@_5};
dfp_read_field_def_m_guild_depot_buy_toc(Other, Z1, Z2,
					 F@_1, F@_2, F@_3, F@_4, F@_5,
					 TrUserData) ->
    dg_read_field_def_m_guild_depot_buy_toc(Other, Z1, Z2,
					    F@_1, F@_2, F@_3, F@_4, F@_5,
					    TrUserData).

dg_read_field_def_m_guild_depot_buy_toc(<<1:1, X:7,
					  Rest/binary>>,
					N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
					TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_guild_depot_buy_toc(Rest, N + 7,
					    X bsl N + Acc, F@_1, F@_2, F@_3,
					    F@_4, F@_5, TrUserData);
dg_read_field_def_m_guild_depot_buy_toc(<<0:1, X:7,
					  Rest/binary>>,
					N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
					TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      9 ->
	  d_field_m_guild_depot_buy_toc_role_id(Rest, 0, 0, F@_1,
						F@_2, F@_3, F@_4, F@_5,
						TrUserData);
      18 ->
	  d_field_m_guild_depot_buy_toc_role_name(Rest, 0, 0,
						  F@_1, F@_2, F@_3, F@_4, F@_5,
						  TrUserData);
      26 ->
	  d_field_m_guild_depot_buy_toc_item(Rest, 0, 0, F@_1,
					     F@_2, F@_3, F@_4, F@_5,
					     TrUserData);
      32 ->
	  d_field_m_guild_depot_buy_toc_score(Rest, 0, 0, F@_1,
					      F@_2, F@_3, F@_4, F@_5,
					      TrUserData);
      40 ->
	  d_field_m_guild_depot_buy_toc_time(Rest, 0, 0, F@_1,
					     F@_2, F@_3, F@_4, F@_5,
					     TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_guild_depot_buy_toc(Rest, 0, 0, F@_1,
						  F@_2, F@_3, F@_4, F@_5,
						  TrUserData);
	    1 ->
		skip_64_m_guild_depot_buy_toc(Rest, 0, 0, F@_1, F@_2,
					      F@_3, F@_4, F@_5, TrUserData);
	    2 ->
		skip_length_delimited_m_guild_depot_buy_toc(Rest, 0, 0,
							    F@_1, F@_2, F@_3,
							    F@_4, F@_5,
							    TrUserData);
	    3 ->
		skip_group_m_guild_depot_buy_toc(Rest, Key bsr 3, 0,
						 F@_1, F@_2, F@_3, F@_4, F@_5,
						 TrUserData);
	    5 ->
		skip_32_m_guild_depot_buy_toc(Rest, 0, 0, F@_1, F@_2,
					      F@_3, F@_4, F@_5, TrUserData)
	  end
    end;
dg_read_field_def_m_guild_depot_buy_toc(<<>>, 0, 0,
					F@_1, F@_2, F@_3, F@_4, F@_5, _) ->
    #m_guild_depot_buy_toc{role_id = F@_1, role_name = F@_2,
			   item = F@_3, score = F@_4, time = F@_5}.

d_field_m_guild_depot_buy_toc_role_id(<<Value:64/little,
					Rest/binary>>,
				      Z1, Z2, _, F@_2, F@_3, F@_4, F@_5,
				      TrUserData) ->
    dfp_read_field_def_m_guild_depot_buy_toc(Rest, Z1, Z2,
					     id(Value, TrUserData), F@_2, F@_3,
					     F@_4, F@_5, TrUserData).

d_field_m_guild_depot_buy_toc_role_name(<<1:1, X:7,
					  Rest/binary>>,
					N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
					TrUserData)
    when N < 57 ->
    d_field_m_guild_depot_buy_toc_role_name(Rest, N + 7,
					    X bsl N + Acc, F@_1, F@_2, F@_3,
					    F@_4, F@_5, TrUserData);
d_field_m_guild_depot_buy_toc_role_name(<<0:1, X:7,
					  Rest/binary>>,
					N, Acc, F@_1, _, F@_3, F@_4, F@_5,
					TrUserData) ->
    {NewFValue, RestF} = begin
    ...
    dfp_read_field_def_m_guild_depot_buy_toc(RestF, 0, 0,
					     F@_1, NewFValue, F@_3, F@_4, F@_5,
					     TrUserData).

d_field_m_guild_depot_buy_toc_item(<<1:1, X:7,
				     Rest/binary>>,
				   N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
				   TrUserData)
    when N < 57 ->
    d_field_m_guild_depot_buy_toc_item(Rest, N + 7,
				       X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
				       F@_5, TrUserData);
d_field_m_guild_depot_buy_toc_item(<<0:1, X:7,
				     Rest/binary>>,
				   N, Acc, F@_1, F@_2, Prev, F@_4, F@_5,
				   TrUserData) ->
    {NewFValue, RestF} = begin
...
d_field_m_guild_depot_buy_toc_score(<<1:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
				    TrUserData)
    when N < 57 ->
    d_field_m_guild_depot_buy_toc_score(Rest, N + 7,
					X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
					F@_5, TrUserData);
d_field_m_guild_depot_buy_toc_score(<<0:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, F@_2, F@_3, _, F@_5,
				    TrUserData) ->
    {NewFValue, RestF} = {begin
...
d_field_m_guild_depot_buy_toc_time(<<1:1, X:7,
				     Rest/binary>>,
				   N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
				   TrUserData)
    when N < 57 ->
    d_field_m_guild_depot_buy_toc_time(Rest, N + 7,
				       X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
				       F@_5, TrUserData);
d_field_m_guild_depot_buy_toc_time(<<0:1, X:7,
				     Rest/binary>>,
				   N, Acc, F@_1, F@_2, F@_3, F@_4, _,
				   TrUserData) ->
    {NewFValue, RestF} = {begin
...
skip_varint_m_guild_depot_buy_toc(<<1:1, _:7,
				    Rest/binary>>,
				  Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
				  TrUserData) ->
    skip_varint_m_guild_depot_buy_toc(Rest, Z1, Z2, F@_1,
				      F@_2, F@_3, F@_4, F@_5, TrUserData);
skip_varint_m_guild_depot_buy_toc(<<0:1, _:7,
				    Rest/binary>>,
				  Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
				  TrUserData) ->
    dfp_read_field_def_m_guild_depot_buy_toc(Rest, Z1, Z2,
...
skip_length_delimited_m_guild_depot_buy_toc(<<1:1, X:7,
					      Rest/binary>>,
					    N, Acc, F@_1, F@_2, F@_3, F@_4,
					    F@_5, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_guild_depot_buy_toc(Rest, N + 7,
						X bsl N + Acc, F@_1, F@_2, F@_3,
						F@_4, F@_5, TrUserData);
skip_length_delimited_m_guild_depot_buy_toc(<<0:1, X:7,
					      Rest/binary>>,
					    N, Acc, F@_1, F@_2, F@_3, F@_4,
					    F@_5, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_guild_depot_buy_toc(Rest2, 0, 0,
					     F@_1, F@_2, F@_3, F@_4, F@_5,
					     TrUserData).

skip_group_m_guild_depot_buy_toc(Bin, FNum, Z2, F@_1,
				 F@_2, F@_3, F@_4, F@_5, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_guild_depot_buy_toc(Rest, 0, Z2,
					     F@_1, F@_2, F@_3, F@_4, F@_5,
					     TrUserData).

skip_32_m_guild_depot_buy_toc(<<_:32, Rest/binary>>, Z1,
			      Z2, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) ->
    dfp_read_field_def_m_guild_depot_buy_toc(Rest, Z1, Z2,
					     F@_1, F@_2, F@_3, F@_4, F@_5,
					     TrUserData).

skip_64_m_guild_depot_buy_toc(<<_:64, Rest/binary>>, Z1,
			      Z2, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) ->
    dfp_read_field_def_m_guild_depot_buy_toc(Rest, Z1, Z2,
					     F@_1, F@_2, F@_3, F@_4, F@_5,
					     TrUserData).

decode_msg_m_guild_depot_destroy_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_guild_depot_destroy_tos(Bin, 0, 0,
						 id([], TrUserData),
						 TrUserData).

dfp_read_field_def_m_guild_depot_destroy_tos(<<10,
					       Rest/binary>>,
					     Z1, Z2, F@_1, TrUserData) ->
    d_pfield_m_guild_depot_destroy_tos_uids(Rest, Z1, Z2,
					    F@_1, TrUserData);
dfp_read_field_def_m_guild_depot_destroy_tos(<<8,
					       Rest/binary>>,
					     Z1, Z2, F@_1, TrUserData) ->
    d_field_m_guild_depot_destroy_tos_uids(Rest, Z1, Z2,
					   F@_1, TrUserData);
dfp_read_field_def_m_guild_depot_destroy_tos(<<>>, 0, 0,
					     R1, TrUserData) ->
    #m_guild_depot_destroy_tos{uids =
				   lists_reverse(R1, TrUserData)};
dfp_read_field_def_m_guild_depot_destroy_tos(Other, Z1,
					     Z2, F@_1, TrUserData) ->
    dg_read_field_def_m_guild_depot_destroy_tos(Other, Z1,
						Z2, F@_1, TrUserData).

dg_read_field_def_m_guild_depot_destroy_tos(<<1:1, X:7,
					      Rest/binary>>,
					    N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_guild_depot_destroy_tos(Rest, N + 7,
						X bsl N + Acc, F@_1,
						TrUserData);
dg_read_field_def_m_guild_depot_destroy_tos(<<0:1, X:7,
					      Rest/binary>>,
					    N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      10 ->
	  d_pfield_m_guild_depot_destroy_tos_uids(Rest, 0, 0,
						  F@_1, TrUserData);
      8 ->
	  d_field_m_guild_depot_destroy_tos_uids(Rest, 0, 0, F@_1,
						 TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_guild_depot_destroy_tos(Rest, 0, 0, F@_1,
						      TrUserData);
	    1 ->
		skip_64_m_guild_depot_destroy_tos(Rest, 0, 0, F@_1,
						  TrUserData);
	    2 ->
		skip_length_delimited_m_guild_depot_destroy_tos(Rest, 0,
								0, F@_1,
								TrUserData);
	    3 ->
		skip_group_m_guild_depot_destroy_tos(Rest, Key bsr 3, 0,
						     F@_1, TrUserData);
	    5 ->
		skip_32_m_guild_depot_destroy_tos(Rest, 0, 0, F@_1,
						  TrUserData)
	  end
    end;
dg_read_field_def_m_guild_depot_destroy_tos(<<>>, 0, 0,
					    R1, TrUserData) ->
    #m_guild_depot_destroy_tos{uids =
				   lists_reverse(R1, TrUserData)}.

d_field_m_guild_depot_destroy_tos_uids(<<1:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_m_guild_depot_destroy_tos_uids(Rest, N + 7,
					   X bsl N + Acc, F@_1, TrUserData);
d_field_m_guild_depot_destroy_tos_uids(<<0:1, X:7,
					 Rest/binary>>,
				       N, Acc, Prev, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    dfp_read_field_def_m_guild_depot_destroy_tos(RestF, 0,
						 0,
						 cons(NewFValue, Prev,
						      TrUserData),
						 TrUserData).

d_pfield_m_guild_depot_destroy_tos_uids(<<1:1, X:7,
					  Rest/binary>>,
					N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_pfield_m_guild_depot_destroy_tos_uids(Rest, N + 7,
					    X bsl N + Acc, F@_1, TrUserData);
d_pfield_m_guild_depot_destroy_tos_uids(<<0:1, X:7,
					  Rest/binary>>,
					N, Acc, E, TrUserData) ->
    Len = X bsl N + Acc,
    <<PackedBytes:Len/binary, Rest2/binary>> = Rest,
    NewSeq =
	d_packed_field_m_guild_depot_destroy_tos_uids(PackedBytes,
						      0, 0, E, TrUserData),
    dfp_read_field_def_m_guild_depot_destroy_tos(Rest2, 0,
						 0, NewSeq, TrUserData).

d_packed_field_m_guild_depot_destroy_tos_uids(<<1:1,
						X:7, Rest/binary>>,
					      N, Acc, AccSeq, TrUserData)
    when N < 57 ->
    d_packed_field_m_guild_depot_destroy_tos_uids(Rest,
						  N + 7, X bsl N + Acc, AccSeq,
						  TrUserData);
d_packed_field_m_guild_depot_destroy_tos_uids(<<0:1,
						X:7, Rest/binary>>,
					      N, Acc, AccSeq, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    d_packed_field_m_guild_depot_destroy_tos_uids(RestF, 0,
						  0, [NewFValue | AccSeq],
						  TrUserData);
d_packed_field_m_guild_depot_destroy_tos_uids(<<>>, 0,
					      0, AccSeq, _) ->
    AccSeq.

skip_varint_m_guild_depot_destroy_tos(<<1:1, _:7,
					Rest/binary>>,
				      Z1, Z2, F@_1, TrUserData) ->
    skip_varint_m_guild_depot_destroy_tos(Rest, Z1, Z2,
					  F@_1, TrUserData);
skip_varint_m_guild_depot_destroy_tos(<<0:1, _:7,
					Rest/binary>>,
				      Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_guild_depot_destroy_tos(Rest, Z1,
						 Z2, F@_1, TrUserData).

skip_length_delimited_m_guild_depot_destroy_tos(<<1:1,
						  X:7, Rest/binary>>,
						N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_guild_depot_destroy_tos(Rest,
						    N + 7, X bsl N + Acc, F@_1,
						    TrUserData);
skip_length_delimited_m_guild_depot_destroy_tos(<<0:1,
						  X:7, Rest/binary>>,
						N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
...
skip_group_m_guild_depot_destroy_tos(Bin, FNum, Z2,
				     F@_1, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_guild_depot_destroy_tos(Rest, 0,
						 Z2, F@_1, TrUserData).

skip_32_m_guild_depot_destroy_tos(<<_:32, Rest/binary>>,
				  Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_guild_depot_destroy_tos(Rest, Z1,
						 Z2, F@_1, TrUserData).

skip_64_m_guild_depot_destroy_tos(<<_:64, Rest/binary>>,
				  Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_guild_depot_destroy_tos(Rest, Z1,
						 Z2, F@_1, TrUserData).

decode_msg_m_guild_depot_destroy_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_guild_depot_destroy_toc(Bin, 0, 0,
						 id([], TrUserData),
						 TrUserData).

dfp_read_field_def_m_guild_depot_destroy_toc(<<10,
					       Rest/binary>>,
					     Z1, Z2, F@_1, TrUserData) ->
    d_pfield_m_guild_depot_destroy_toc_uids(Rest, Z1, Z2,
					    F@_1, TrUserData);
dfp_read_field_def_m_guild_depot_destroy_toc(<<8,
					       Rest/binary>>,
					     Z1, Z2, F@_1, TrUserData) ->
    d_field_m_guild_depot_destroy_toc_uids(Rest, Z1, Z2,
					   F@_1, TrUserData);
dfp_read_field_def_m_guild_depot_destroy_toc(<<>>, 0, 0,
					     R1, TrUserData) ->
    #m_guild_depot_destroy_toc{uids =
				   lists_reverse(R1, TrUserData)};
dfp_read_field_def_m_guild_depot_destroy_toc(Other, Z1,
					     Z2, F@_1, TrUserData) ->
    dg_read_field_def_m_guild_depot_destroy_toc(Other, Z1,
						Z2, F@_1, TrUserData).

dg_read_field_def_m_guild_depot_destroy_toc(<<1:1, X:7,
					      Rest/binary>>,
					    N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_guild_depot_destroy_toc(Rest, N + 7,
						X bsl N + Acc, F@_1,
						TrUserData);
dg_read_field_def_m_guild_depot_destroy_toc(<<0:1, X:7,
					      Rest/binary>>,
					    N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      10 ->
	  d_pfield_m_guild_depot_destroy_toc_uids(Rest, 0, 0,
						  F@_1, TrUserData);
      8 ->
	  d_field_m_guild_depot_destroy_toc_uids(Rest, 0, 0, F@_1,
						 TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_guild_depot_destroy_toc(Rest, 0, 0, F@_1,
						      TrUserData);
	    1 ->
		skip_64_m_guild_depot_destroy_toc(Rest, 0, 0, F@_1,
						  TrUserData);
	    2 ->
		skip_length_delimited_m_guild_depot_destroy_toc(Rest, 0,
								0, F@_1,
								TrUserData);
	    3 ->
		skip_group_m_guild_depot_destroy_toc(Rest, Key bsr 3, 0,
						     F@_1, TrUserData);
	    5 ->
		skip_32_m_guild_depot_destroy_toc(Rest, 0, 0, F@_1,
						  TrUserData)
	  end
    end;
dg_read_field_def_m_guild_depot_destroy_toc(<<>>, 0, 0,
					    R1, TrUserData) ->
    #m_guild_depot_destroy_toc{uids =
				   lists_reverse(R1, TrUserData)}.

d_field_m_guild_depot_destroy_toc_uids(<<1:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_m_guild_depot_destroy_toc_uids(Rest, N + 7,
					   X bsl N + Acc, F@_1, TrUserData);
d_field_m_guild_depot_destroy_toc_uids(<<0:1, X:7,
					 Rest/binary>>,
				       N, Acc, Prev, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    dfp_read_field_def_m_guild_depot_destroy_toc(RestF, 0,
						 0,
						 cons(NewFValue, Prev,
						      TrUserData),
						 TrUserData).

d_pfield_m_guild_depot_destroy_toc_uids(<<1:1, X:7,
					  Rest/binary>>,
					N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_pfield_m_guild_depot_destroy_toc_uids(Rest, N + 7,
					    X bsl N + Acc, F@_1, TrUserData);
d_pfield_m_guild_depot_destroy_toc_uids(<<0:1, X:7,
					  Rest/binary>>,
					N, Acc, E, TrUserData) ->
    Len = X bsl N + Acc,
    <<PackedBytes:Len/binary, Rest2/binary>> = Rest,
    NewSeq =
	d_packed_field_m_guild_depot_destroy_toc_uids(PackedBytes,
						      0, 0, E, TrUserData),
    dfp_read_field_def_m_guild_depot_destroy_toc(Rest2, 0,
						 0, NewSeq, TrUserData).

d_packed_field_m_guild_depot_destroy_toc_uids(<<1:1,
						X:7, Rest/binary>>,
					      N, Acc, AccSeq, TrUserData)
    when N < 57 ->
    d_packed_field_m_guild_depot_destroy_toc_uids(Rest,
						  N + 7, X bsl N + Acc, AccSeq,
						  TrUserData);
d_packed_field_m_guild_depot_destroy_toc_uids(<<0:1,
						X:7, Rest/binary>>,
					      N, Acc, AccSeq, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    d_packed_field_m_guild_depot_destroy_toc_uids(RestF, 0,
						  0, [NewFValue | AccSeq],
						  TrUserData);
d_packed_field_m_guild_depot_destroy_toc_uids(<<>>, 0,
					      0, AccSeq, _) ->
    AccSeq.

skip_varint_m_guild_depot_destroy_toc(<<1:1, _:7,
					Rest/binary>>,
				      Z1, Z2, F@_1, TrUserData) ->
    skip_varint_m_guild_depot_destroy_toc(Rest, Z1, Z2,
					  F@_1, TrUserData);
skip_varint_m_guild_depot_destroy_toc(<<0:1, _:7,
					Rest/binary>>,
				      Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_guild_depot_destroy_toc(Rest, Z1,
						 Z2, F@_1, TrUserData).

skip_length_delimited_m_guild_depot_destroy_toc(<<1:1,
						  X:7, Rest/binary>>,
						N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_guild_depot_destroy_toc(Rest,
						    N + 7, X bsl N + Acc, F@_1,
						    TrUserData);
skip_length_delimited_m_guild_depot_destroy_toc(<<0:1,
						  X:7, Rest/binary>>,
						N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
...
skip_group_m_guild_depot_destroy_toc(Bin, FNum, Z2,
				     F@_1, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_guild_depot_destroy_toc(Rest, 0,
						 Z2, F@_1, TrUserData).

skip_32_m_guild_depot_destroy_toc(<<_:32, Rest/binary>>,
				  Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_guild_depot_destroy_toc(Rest, Z1,
						 Z2, F@_1, TrUserData).

skip_64_m_guild_depot_destroy_toc(<<_:64, Rest/binary>>,
				  Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_guild_depot_destroy_toc(Rest, Z1,
						 Z2, F@_1, TrUserData).

decode_msg_p_donate_log(Bin, TrUserData) ->
    dfp_read_field_def_p_donate_log(Bin, 0, 0,
				    id(undefined, TrUserData),
				    id(undefined, TrUserData),
				    id(undefined, TrUserData),
				    id(undefined, TrUserData),
...
dfp_read_field_def_p_donate_log(<<8, Rest/binary>>, Z1,
				Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
				TrUserData) ->
    d_field_p_donate_log_type(Rest, Z1, Z2, F@_1, F@_2,
			      F@_3, F@_4, F@_5, F@_6, TrUserData);
dfp_read_field_def_p_donate_log(<<17, Rest/binary>>, Z1,
				Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
				TrUserData) ->
    d_field_p_donate_log_role_id(Rest, Z1, Z2, F@_1, F@_2,
				 F@_3, F@_4, F@_5, F@_6, TrUserData);
dfp_read_field_def_p_donate_log(<<26, Rest/binary>>, Z1,
				Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
				TrUserData) ->
    d_field_p_donate_log_role_name(Rest, Z1, Z2, F@_1, F@_2,
				   F@_3, F@_4, F@_5, F@_6, TrUserData);
dfp_read_field_def_p_donate_log(<<34, Rest/binary>>, Z1,
				Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
				TrUserData) ->
    d_field_p_donate_log_item(Rest, Z1, Z2, F@_1, F@_2,
			      F@_3, F@_4, F@_5, F@_6, TrUserData);
dfp_read_field_def_p_donate_log(<<40, Rest/binary>>, Z1,
				Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
				TrUserData) ->
    d_field_p_donate_log_score(Rest, Z1, Z2, F@_1, F@_2,
			       F@_3, F@_4, F@_5, F@_6, TrUserData);
dfp_read_field_def_p_donate_log(<<48, Rest/binary>>, Z1,
				Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
				TrUserData) ->
    d_field_p_donate_log_time(Rest, Z1, Z2, F@_1, F@_2,
			      F@_3, F@_4, F@_5, F@_6, TrUserData);
dfp_read_field_def_p_donate_log(<<>>, 0, 0, F@_1, F@_2,
				F@_3, F@_4, F@_5, F@_6, _) ->
    #p_donate_log{type = F@_1, role_id = F@_2,
		  role_name = F@_3, item = F@_4, score = F@_5,
		  time = F@_6};
dfp_read_field_def_p_donate_log(Other, Z1, Z2, F@_1,
				F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) ->
    dg_read_field_def_p_donate_log(Other, Z1, Z2, F@_1,
				   F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData).

dg_read_field_def_p_donate_log(<<1:1, X:7,
				 Rest/binary>>,
			       N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
			       TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_p_donate_log(Rest, N + 7,
				   X bsl N + Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
				   F@_6, TrUserData);
dg_read_field_def_p_donate_log(<<0:1, X:7,
				 Rest/binary>>,
			       N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
			       TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_p_donate_log_type(Rest, 0, 0, F@_1, F@_2, F@_3,
				    F@_4, F@_5, F@_6, TrUserData);
      17 ->
	  d_field_p_donate_log_role_id(Rest, 0, 0, F@_1, F@_2,
				       F@_3, F@_4, F@_5, F@_6, TrUserData);
      26 ->
	  d_field_p_donate_log_role_name(Rest, 0, 0, F@_1, F@_2,
					 F@_3, F@_4, F@_5, F@_6, TrUserData);
      34 ->
	  d_field_p_donate_log_item(Rest, 0, 0, F@_1, F@_2, F@_3,
				    F@_4, F@_5, F@_6, TrUserData);
      40 ->
	  d_field_p_donate_log_score(Rest, 0, 0, F@_1, F@_2, F@_3,
				     F@_4, F@_5, F@_6, TrUserData);
      48 ->
	  d_field_p_donate_log_time(Rest, 0, 0, F@_1, F@_2, F@_3,
				    F@_4, F@_5, F@_6, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_p_donate_log(Rest, 0, 0, F@_1, F@_2, F@_3,
					 F@_4, F@_5, F@_6, TrUserData);
	    1 ->
		skip_64_p_donate_log(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4,
				     F@_5, F@_6, TrUserData);
	    2 ->
		skip_length_delimited_p_donate_log(Rest, 0, 0, F@_1,
						   F@_2, F@_3, F@_4, F@_5, F@_6,
						   TrUserData);
	    3 ->
		skip_group_p_donate_log(Rest, Key bsr 3, 0, F@_1, F@_2,
					F@_3, F@_4, F@_5, F@_6, TrUserData);
	    5 ->
		skip_32_p_donate_log(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4,
				     F@_5, F@_6, TrUserData)
	  end
    end;
dg_read_field_def_p_donate_log(<<>>, 0, 0, F@_1, F@_2,
			       F@_3, F@_4, F@_5, F@_6, _) ->
    #p_donate_log{type = F@_1, role_id = F@_2,
		  role_name = F@_3, item = F@_4, score = F@_5,
		  time = F@_6}.

d_field_p_donate_log_type(<<1:1, X:7, Rest/binary>>, N,
			  Acc, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData)
    when N < 57 ->
    d_field_p_donate_log_type(Rest, N + 7, X bsl N + Acc,
			      F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
d_field_p_donate_log_type(<<0:1, X:7, Rest/binary>>, N,
    ...
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    dfp_read_field_def_p_donate_log(RestF, 0, 0, NewFValue,
				    F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData).

d_field_p_donate_log_role_id(<<Value:64/little,
			       Rest/binary>>,
			     Z1, Z2, F@_1, _, F@_3, F@_4, F@_5, F@_6,
			     TrUserData) ->
    dfp_read_field_def_p_donate_log(Rest, Z1, Z2, F@_1,
				    id(Value, TrUserData), F@_3, F@_4, F@_5,
				    F@_6, TrUserData).

d_field_p_donate_log_role_name(<<1:1, X:7,
				 Rest/binary>>,
			       N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
			       TrUserData)
    when N < 57 ->
    d_field_p_donate_log_role_name(Rest, N + 7,
				   X bsl N + Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
				   F@_6, TrUserData);
d_field_p_donate_log_role_name(<<0:1, X:7,
				 Rest/binary>>,
    ...
    dfp_read_field_def_p_donate_log(RestF, 0, 0, F@_1, F@_2,
				    NewFValue, F@_4, F@_5, F@_6, TrUserData).

d_field_p_donate_log_item(<<1:1, X:7, Rest/binary>>, N,
			  Acc, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData)
    when N < 57 ->
    d_field_p_donate_log_item(Rest, N + 7, X bsl N + Acc,
			      F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
d_field_p_donate_log_item(<<0:1, X:7, Rest/binary>>, N,
			  Acc, F@_1, F@_2, F@_3, Prev, F@_5, F@_6,
			  TrUserData) ->
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
			   <<Bs:Len/binary, Rest2/binary>> = Rest,
...
d_field_p_donate_log_score(<<1:1, X:7, Rest/binary>>, N,
			   Acc, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData)
    when N < 57 ->
    d_field_p_donate_log_score(Rest, N + 7, X bsl N + Acc,
			       F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
d_field_p_donate_log_score(<<0:1, X:7, Rest/binary>>, N,
...
d_field_p_donate_log_time(<<1:1, X:7, Rest/binary>>, N,
			  Acc, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData)
    when N < 57 ->
    d_field_p_donate_log_time(Rest, N + 7, X bsl N + Acc,
			      F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
d_field_p_donate_log_time(<<0:1, X:7, Rest/binary>>, N,
...
skip_varint_p_donate_log(<<1:1, _:7, Rest/binary>>, Z1,
			 Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) ->
    skip_varint_p_donate_log(Rest, Z1, Z2, F@_1, F@_2, F@_3,
			     F@_4, F@_5, F@_6, TrUserData);
skip_varint_p_donate_log(<<0:1, _:7, Rest/binary>>, Z1,
			 Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) ->
    dfp_read_field_def_p_donate_log(Rest, Z1, Z2, F@_1,
				    F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData).

skip_length_delimited_p_donate_log(<<1:1, X:7,
				     Rest/binary>>,
				   N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
				   TrUserData)
    when N < 57 ->
    skip_length_delimited_p_donate_log(Rest, N + 7,
				       X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
				       F@_5, F@_6, TrUserData);
skip_length_delimited_p_donate_log(<<0:1, X:7,
				     Rest/binary>>,
				   N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
				   TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_p_donate_log(Rest2, 0, 0, F@_1, F@_2,
				    F@_3, F@_4, F@_5, F@_6, TrUserData).

skip_group_p_donate_log(Bin, FNum, Z2, F@_1, F@_2, F@_3,
			F@_4, F@_5, F@_6, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_p_donate_log(Rest, 0, Z2, F@_1, F@_2,
				    F@_3, F@_4, F@_5, F@_6, TrUserData).

skip_32_p_donate_log(<<_:32, Rest/binary>>, Z1, Z2,
		     F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) ->
    dfp_read_field_def_p_donate_log(Rest, Z1, Z2, F@_1,
				    F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData).

skip_64_p_donate_log(<<_:64, Rest/binary>>, Z1, Z2,
		     F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) ->
    dfp_read_field_def_p_donate_log(Rest, Z1, Z2, F@_1,
				    F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData).
...
merge_msgs(Prev, New, MsgName, Opts) ->
    ...
    case MsgName of
      m_guild_depot_info_tos ->
	  merge_msg_m_guild_depot_info_tos(Prev, New, TrUserData);
      m_guild_depot_info_toc ->
	  merge_msg_m_guild_depot_info_toc(Prev, New, TrUserData);
      m_guild_depot_detail_tos ->
	  merge_msg_m_guild_depot_detail_tos(Prev, New,
					     TrUserData);
      m_guild_depot_detail_toc ->
	  merge_msg_m_guild_depot_detail_toc(Prev, New,
					     TrUserData);
      m_guild_depot_donate_tos ->
	  merge_msg_m_guild_depot_donate_tos(Prev, New,
					     TrUserData);
      m_guild_depot_donate_toc ->
	  merge_msg_m_guild_depot_donate_toc(Prev, New,
					     TrUserData);
      m_guild_depot_exch_tos ->
	  merge_msg_m_guild_depot_exch_tos(Prev, New, TrUserData);
      m_guild_depot_exch_toc ->
	  merge_msg_m_guild_depot_exch_toc(Prev, New, TrUserData);
      m_guild_depot_buy_tos ->
	  merge_msg_m_guild_depot_buy_tos(Prev, New, TrUserData);
      m_guild_depot_buy_toc ->
	  merge_msg_m_guild_depot_buy_toc(Prev, New, TrUserData);
      m_guild_depot_destroy_tos ->
	  merge_msg_m_guild_depot_destroy_tos(Prev, New,
					      TrUserData);
      m_guild_depot_destroy_toc ->
	  merge_msg_m_guild_depot_destroy_toc(Prev, New,
					      TrUserData);
      p_donate_log ->
	  merge_msg_p_donate_log(Prev, New, TrUserData);
      p_role_base ->
...
-compile({nowarn_unused_function,merge_msg_m_guild_depot_info_tos/3}).
merge_msg_m_guild_depot_info_tos(_Prev, New,
				 _TrUserData) ->
    New.

-compile({nowarn_unused_function,merge_msg_m_guild_depot_info_toc/3}).
merge_msg_m_guild_depot_info_toc(#m_guild_depot_info_toc{items
							     = PFitems,
							 logs = PFlogs},
				 #m_guild_depot_info_toc{score = NFscore,
							 items = NFitems,
							 logs = NFlogs},
				 TrUserData) ->
    #m_guild_depot_info_toc{score = NFscore,
...
-compile({nowarn_unused_function,merge_msg_m_guild_depot_detail_tos/3}).
merge_msg_m_guild_depot_detail_tos(#m_guild_depot_detail_tos{},
				   #m_guild_depot_detail_tos{uid = NFuid}, _) ->
    #m_guild_depot_detail_tos{uid = NFuid}.

-compile({nowarn_unused_function,merge_msg_m_guild_depot_detail_toc/3}).
merge_msg_m_guild_depot_detail_toc(#m_guild_depot_detail_toc{item
								 = PFitem},
				   #m_guild_depot_detail_toc{item = NFitem},
				   TrUserData) ->
    #m_guild_depot_detail_toc{item =
				  merge_msg_p_item(PFitem, NFitem, TrUserData)}.

-compile({nowarn_unused_function,merge_msg_m_guild_depot_donate_tos/3}).
merge_msg_m_guild_depot_donate_tos(#m_guild_depot_donate_tos{},
				   #m_guild_depot_donate_tos{uid = NFuid}, _) ->
    #m_guild_depot_donate_tos{uid = NFuid}.

-compile({nowarn_unused_function,merge_msg_m_guild_depot_donate_toc/3}).
merge_msg_m_guild_depot_donate_toc(#m_guild_depot_donate_toc{item
								 = PFitem},
				   #m_guild_depot_donate_toc{role_id =
								 NFrole_id,
							     role_name =
								 NFrole_name,
							     item = NFitem,
							     ...
							     time = NFtime},
				   TrUserData) ->
    #m_guild_depot_donate_toc{role_id = NFrole_id,
			      role_name = NFrole_name,
			      item =
				  merge_msg_p_item(PFitem, NFitem, TrUserData),
			      score = NFscore, time = NFtime}.

-compile({nowarn_unused_function,merge_msg_m_guild_depot_exch_tos/3}).
merge_msg_m_guild_depot_exch_tos(#m_guild_depot_exch_tos{},
				 #m_guild_depot_exch_tos{uid = NFuid}, _) ->
    #m_guild_depot_exch_tos{uid = NFuid}.

-compile({nowarn_unused_function,merge_msg_m_guild_depot_exch_toc/3}).
merge_msg_m_guild_depot_exch_toc(#m_guild_depot_exch_toc{item
							     = PFitem},
				 #m_guild_depot_exch_toc{role_id = NFrole_id,
							 role_name =
							     NFrole_name,
							 item = NFitem,
							 score = NFscore,
    ...
    #m_guild_depot_exch_toc{role_id = NFrole_id,
			    role_name = NFrole_name,
			    item = merge_msg_p_item(PFitem, NFitem, TrUserData),
			    score = NFscore, time = NFtime}.

-compile({nowarn_unused_function,merge_msg_m_guild_depot_buy_tos/3}).
merge_msg_m_guild_depot_buy_tos(#m_guild_depot_buy_tos{},
				#m_guild_depot_buy_tos{item_id = NFitem_id,
						       num = NFnum},
				_) ->
    #m_guild_depot_buy_tos{item_id = NFitem_id,
			   num = NFnum}.

-compile({nowarn_unused_function,merge_msg_m_guild_depot_buy_toc/3}).
merge_msg_m_guild_depot_buy_toc(#m_guild_depot_buy_toc{item
							   = PFitem},
				#m_guild_depot_buy_toc{role_id = NFrole_id,
						       role_name = NFrole_name,
						       item = NFitem,
						       score = NFscore,
						       time = NFtime},
...
-compile({nowarn_unused_function,merge_msg_m_guild_depot_destroy_tos/3}).
merge_msg_m_guild_depot_destroy_tos(#m_guild_depot_destroy_tos{uids
								   = PFuids},
				    #m_guild_depot_destroy_tos{uids = NFuids},
				    TrUserData) ->
    #m_guild_depot_destroy_tos{uids =
				   if PFuids /= undefined,
				      NFuids /= undefined ->
					  'erlang_++'(PFuids, NFuids,
						      TrUserData);
				      PFuids == undefined -> NFuids;
				      NFuids == undefined -> PFuids
				   end}.

-compile({nowarn_unused_function,merge_msg_m_guild_depot_destroy_toc/3}).
merge_msg_m_guild_depot_destroy_toc(#m_guild_depot_destroy_toc{uids
								   = PFuids},
				    #m_guild_depot_destroy_toc{uids = NFuids},
				    TrUserData) ->
    #m_guild_depot_destroy_toc{uids =
				   if PFuids /= undefined,
				      NFuids /= undefined ->
...
-compile({nowarn_unused_function,merge_msg_p_donate_log/3}).
merge_msg_p_donate_log(#p_donate_log{item = PFitem},
		       #p_donate_log{type = NFtype, role_id = NFrole_id,
				     role_name = NFrole_name, item = NFitem,
				     score = NFscore, time = NFtime},
		       TrUserData) ->
    #p_donate_log{type = NFtype, role_id = NFrole_id,
		  role_name = NFrole_name,
...
verify_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
      m_guild_depot_info_tos ->
	  v_msg_m_guild_depot_info_tos(Msg, [MsgName],
				       TrUserData);
      m_guild_depot_info_toc ->
	  v_msg_m_guild_depot_info_toc(Msg, [MsgName],
				       TrUserData);
      m_guild_depot_detail_tos ->
	  v_msg_m_guild_depot_detail_tos(Msg, [MsgName],
					 TrUserData);
      m_guild_depot_detail_toc ->
	  v_msg_m_guild_depot_detail_toc(Msg, [MsgName],
					 TrUserData);
      m_guild_depot_donate_tos ->
	  v_msg_m_guild_depot_donate_tos(Msg, [MsgName],
					 TrUserData);
      m_guild_depot_donate_toc ->
	  v_msg_m_guild_depot_donate_toc(Msg, [MsgName],
					 TrUserData);
      m_guild_depot_exch_tos ->
	  v_msg_m_guild_depot_exch_tos(Msg, [MsgName],
				       TrUserData);
      m_guild_depot_exch_toc ->
	  v_msg_m_guild_depot_exch_toc(Msg, [MsgName],
				       TrUserData);
      m_guild_depot_buy_tos ->
	  v_msg_m_guild_depot_buy_tos(Msg, [MsgName], TrUserData);
      m_guild_depot_buy_toc ->
	  v_msg_m_guild_depot_buy_toc(Msg, [MsgName], TrUserData);
      m_guild_depot_destroy_tos ->
	  v_msg_m_guild_depot_destroy_tos(Msg, [MsgName],
					  TrUserData);
      m_guild_depot_destroy_toc ->
	  v_msg_m_guild_depot_destroy_toc(Msg, [MsgName],
					  TrUserData);
      p_donate_log ->
	  v_msg_p_donate_log(Msg, [MsgName], TrUserData);
      p_role_base ->
...
-compile({nowarn_unused_function,v_msg_m_guild_depot_info_tos/3}).
-dialyzer({nowarn_function,v_msg_m_guild_depot_info_tos/3}).
v_msg_m_guild_depot_info_tos(#m_guild_depot_info_tos{},
			     _Path, _) ->
    ok;
v_msg_m_guild_depot_info_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_guild_depot_info_tos}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_guild_depot_info_toc/3}).
-dialyzer({nowarn_function,v_msg_m_guild_depot_info_toc/3}).
v_msg_m_guild_depot_info_toc(#m_guild_depot_info_toc{score
							 = F1,
						     items = F2, logs = F3},
			     Path, TrUserData) ->
    v_type_int32(F1, [score | Path], TrUserData),
    if is_list(F2) ->
	   _ = [v_msg_p_item_base(Elem, [items | Path], TrUserData)
		|| Elem <- F2],
	   ok;
       true ->
	   mk_type_error({invalid_list_of, {msg, p_item_base}}, F2,
			 [items | Path])
    end,
    if is_list(F3) ->
	   _ = [v_msg_p_donate_log(Elem, [logs | Path], TrUserData)
		|| Elem <- F3],
	   ok;
       true ->
	   mk_type_error({invalid_list_of, {msg, p_donate_log}},
			 F3, [logs | Path])
    end,
    ok;
v_msg_m_guild_depot_info_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_guild_depot_info_toc}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_guild_depot_detail_tos/3}).
-dialyzer({nowarn_function,v_msg_m_guild_depot_detail_tos/3}).
v_msg_m_guild_depot_detail_tos(#m_guild_depot_detail_tos{uid
							     = F1},
			       Path, TrUserData) ->
    v_type_int32(F1, [uid | Path], TrUserData), ok;
v_msg_m_guild_depot_detail_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_guild_depot_detail_tos},
		  X, Path).

-compile({nowarn_unused_function,v_msg_m_guild_depot_detail_toc/3}).
-dialyzer({nowarn_function,v_msg_m_guild_depot_detail_toc/3}).
v_msg_m_guild_depot_detail_toc(#m_guild_depot_detail_toc{item
							     = F1},
			       Path, TrUserData) ->
    v_msg_p_item(F1, [item | Path], TrUserData), ok;
v_msg_m_guild_depot_detail_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_guild_depot_detail_toc},
		  X, Path).

-compile({nowarn_unused_function,v_msg_m_guild_depot_donate_tos/3}).
-dialyzer({nowarn_function,v_msg_m_guild_depot_donate_tos/3}).
v_msg_m_guild_depot_donate_tos(#m_guild_depot_donate_tos{uid
							     = F1},
			       Path, TrUserData) ->
    v_type_int32(F1, [uid | Path], TrUserData), ok;
v_msg_m_guild_depot_donate_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_guild_depot_donate_tos},
		  X, Path).

-compile({nowarn_unused_function,v_msg_m_guild_depot_donate_toc/3}).
-dialyzer({nowarn_function,v_msg_m_guild_depot_donate_toc/3}).
v_msg_m_guild_depot_donate_toc(#m_guild_depot_donate_toc{role_id
							     = F1,
							 role_name = F2,
							 item = F3, score = F4,
							 time = F5},
    ...
    v_msg_p_item(F3, [item | Path], TrUserData),
    v_type_int32(F4, [score | Path], TrUserData),
    v_type_int32(F5, [time | Path], TrUserData),
    ok;
v_msg_m_guild_depot_donate_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_guild_depot_donate_toc},
		  X, Path).

-compile({nowarn_unused_function,v_msg_m_guild_depot_exch_tos/3}).
-dialyzer({nowarn_function,v_msg_m_guild_depot_exch_tos/3}).
v_msg_m_guild_depot_exch_tos(#m_guild_depot_exch_tos{uid
							 = F1},
			     Path, TrUserData) ->
    v_type_int32(F1, [uid | Path], TrUserData), ok;
v_msg_m_guild_depot_exch_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_guild_depot_exch_tos}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_guild_depot_exch_toc/3}).
-dialyzer({nowarn_function,v_msg_m_guild_depot_exch_toc/3}).
v_msg_m_guild_depot_exch_toc(#m_guild_depot_exch_toc{role_id
							 = F1,
						     role_name = F2, item = F3,
						     score = F4, time = F5},
			     Path, TrUserData) ->
    v_type_fixed64(F1, [role_id | Path], TrUserData),
    v_type_string(F2, [role_name | Path], TrUserData),
    ...
    v_type_int32(F5, [time | Path], TrUserData),
    ok;
v_msg_m_guild_depot_exch_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_guild_depot_exch_toc}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_guild_depot_buy_tos/3}).
-dialyzer({nowarn_function,v_msg_m_guild_depot_buy_tos/3}).
v_msg_m_guild_depot_buy_tos(#m_guild_depot_buy_tos{item_id
						       = F1,
						   num = F2},
			    Path, TrUserData) ->
    v_type_int32(F1, [item_id | Path], TrUserData),
    v_type_int32(F2, [num | Path], TrUserData),
    ok;
v_msg_m_guild_depot_buy_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_guild_depot_buy_tos}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_guild_depot_buy_toc/3}).
-dialyzer({nowarn_function,v_msg_m_guild_depot_buy_toc/3}).
v_msg_m_guild_depot_buy_toc(#m_guild_depot_buy_toc{role_id
						       = F1,
						   role_name = F2, item = F3,
						   score = F4, time = F5},
			    Path, TrUserData) ->
    ...
    v_type_int32(F5, [time | Path], TrUserData),
    ok;
v_msg_m_guild_depot_buy_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_guild_depot_buy_toc}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_guild_depot_destroy_tos/3}).
-dialyzer({nowarn_function,v_msg_m_guild_depot_destroy_tos/3}).
v_msg_m_guild_depot_destroy_tos(#m_guild_depot_destroy_tos{uids
							       = F1},
				Path, TrUserData) ->
    if is_list(F1) ->
	   _ = [v_type_int32(Elem, [uids | Path], TrUserData)
		|| Elem <- F1],
	   ok;
       true ->
    ...
    ok;
v_msg_m_guild_depot_destroy_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_guild_depot_destroy_tos},
		  X, Path).

-compile({nowarn_unused_function,v_msg_m_guild_depot_destroy_toc/3}).
-dialyzer({nowarn_function,v_msg_m_guild_depot_destroy_toc/3}).
v_msg_m_guild_depot_destroy_toc(#m_guild_depot_destroy_toc{uids
							       = F1},
				Path, TrUserData) ->
    if is_list(F1) ->
	   _ = [v_type_int32(Elem, [uids | Path], TrUserData)
    ...
    ok;
v_msg_m_guild_depot_destroy_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_guild_depot_destroy_toc},
		  X, Path).

-compile({nowarn_unused_function,v_msg_p_donate_log/3}).
-dialyzer({nowarn_function,v_msg_p_donate_log/3}).
v_msg_p_donate_log(#p_donate_log{type = F1,
				 role_id = F2, role_name = F3, item = F4,
				 score = F5, time = F6},
		   Path, TrUserData) ->
    ...
    v_msg_p_item(F4, [item | Path], TrUserData),
    v_type_int32(F5, [score | Path], TrUserData),
    v_type_int32(F6, [time | Path], TrUserData),
    ok;
v_msg_p_donate_log(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, p_donate_log}, X, Path).
    ...
    [{{msg, m_guild_depot_info_tos}, []},
     ...
     {{msg, m_guild_depot_exch_toc},
      [#field{name = role_id, fnum = 1, rnum = 2,
       ...
       #field{name = time, fnum = 5, rnum = 6, type = int32,
	      occurrence = required, opts = []}]},
     {{msg, m_guild_depot_buy_tos},
      [#field{name = item_id, fnum = 1, rnum = 2,
	      type = int32, occurrence = required, opts = []},
       #field{name = num, fnum = 2, rnum = 3, type = int32,
	      occurrence = required, opts = []}]},
     {{msg, m_guild_depot_buy_toc},
      [#field{name = role_id, fnum = 1, rnum = 2,
	      type = fixed64, occurrence = required, opts = []},
       #field{name = role_name, fnum = 2, rnum = 3,
	      type = string, occurrence = required, opts = []},
       ...
       #field{name = time, fnum = 5, rnum = 6, type = int32,
	      occurrence = required, opts = []}]},
     {{msg, m_guild_depot_destroy_tos},
      [#field{name = uids, fnum = 1, rnum = 2, type = int32,
	      occurrence = repeated, opts = []}]},
     {{msg, m_guild_depot_destroy_toc},
      [#field{name = uids, fnum = 1, rnum = 2, type = int32,
	      occurrence = repeated, opts = []}]},
     {{msg, p_donate_log},
      [#field{name = type, fnum = 1, rnum = 2, type = int32,
       ...
       #field{name = role_name, fnum = 3, rnum = 4,
	      type = string, occurrence = required, opts = []},
       #field{name = item, fnum = 4, rnum = 5,
	      type = {msg, p_item}, occurrence = required, opts = []},
       #field{name = score, fnum = 5, rnum = 6, type = int32,
	      occurrence = required, opts = []},
       #field{name = time, fnum = 6, rnum = 7, type = int32,
	      occurrence = required, opts = []}]},
     {{msg, p_role_base},
...
get_msg_names() ->
    [m_guild_depot_info_tos, m_guild_depot_info_toc,
     m_guild_depot_detail_tos, m_guild_depot_detail_toc,
     m_guild_depot_donate_tos, m_guild_depot_donate_toc,
     m_guild_depot_exch_tos, m_guild_depot_exch_toc,
     m_guild_depot_buy_tos, m_guild_depot_buy_toc,
     m_guild_depot_destroy_tos, m_guild_depot_destroy_toc,
     p_donate_log, p_role_base, p_aspect, p_attr,
...
find_msg_def(m_guild_depot_info_tos) -> [];
find_msg_def(m_guild_depot_info_toc) ->
    [#field{name = score, fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []},
     #field{name = items, fnum = 2, rnum = 3,
	    type = {msg, p_item_base}, occurrence = repeated,
     ...
     #field{name = logs, fnum = 3, rnum = 4,
	    type = {msg, p_donate_log}, occurrence = repeated,
	    opts = []}];
find_msg_def(m_guild_depot_detail_tos) ->
    [#field{name = uid, fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []}];
find_msg_def(m_guild_depot_detail_toc) ->
    [#field{name = item, fnum = 1, rnum = 2,
	    type = {msg, p_item}, occurrence = required,
	    opts = []}];
find_msg_def(m_guild_depot_donate_tos) ->
    [#field{name = uid, fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []}];
find_msg_def(m_guild_depot_donate_toc) ->
    [#field{name = role_id, fnum = 1, rnum = 2,
	    type = fixed64, occurrence = required, opts = []},
     #field{name = role_name, fnum = 2, rnum = 3,
	    type = string, occurrence = required, opts = []},
     ...
     #field{name = time, fnum = 5, rnum = 6, type = int32,
	    occurrence = required, opts = []}];
find_msg_def(m_guild_depot_exch_tos) ->
    [#field{name = uid, fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []}];
find_msg_def(m_guild_depot_exch_toc) ->
    [#field{name = role_id, fnum = 1, rnum = 2,
	    type = fixed64, occurrence = required, opts = []},
     #field{name = role_name, fnum = 2, rnum = 3,
	    type = string, occurrence = required, opts = []},
     ...
     #field{name = time, fnum = 5, rnum = 6, type = int32,
	    occurrence = required, opts = []}];
find_msg_def(m_guild_depot_buy_tos) ->
    [#field{name = item_id, fnum = 1, rnum = 2,
	    type = int32, occurrence = required, opts = []},
     #field{name = num, fnum = 2, rnum = 3, type = int32,
	    occurrence = required, opts = []}];
find_msg_def(m_guild_depot_buy_toc) ->
    [#field{name = role_id, fnum = 1, rnum = 2,
	    type = fixed64, occurrence = required, opts = []},
     #field{name = role_name, fnum = 2, rnum = 3,
	    type = string, occurrence = required, opts = []},
     ...
     #field{name = time, fnum = 5, rnum = 6, type = int32,
	    occurrence = required, opts = []}];
find_msg_def(m_guild_depot_destroy_tos) ->
    [#field{name = uids, fnum = 1, rnum = 2, type = int32,
	    occurrence = repeated, opts = []}];
find_msg_def(m_guild_depot_destroy_toc) ->
    [#field{name = uids, fnum = 1, rnum = 2, type = int32,
	    occurrence = repeated, opts = []}];
find_msg_def(p_donate_log) ->
    [#field{name = type, fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []},
     #field{name = role_id, fnum = 2, rnum = 3,
	    type = fixed64, occurrence = required, opts = []},
