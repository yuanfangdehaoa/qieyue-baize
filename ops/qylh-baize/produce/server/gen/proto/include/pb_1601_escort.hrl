...
-ifndef(pb_1601_escort).
-define(pb_1601_escort, true).

-define(pb_1601_escort_gpb_version, "4.5.1").

-ifndef('M_ESCORT_REFRESH_TOS_PB_H').
-define('M_ESCORT_REFRESH_TOS_PB_H', true).
-record(m_escort_refresh_tos,
        {
        }).
-endif.

-ifndef('M_ESCORT_REFRESH_TOC_PB_H').
-define('M_ESCORT_REFRESH_TOC_PB_H', true).
-record(m_escort_refresh_toc,
        {quality                :: integer(),       % = 1, 32 bits
         escort_count           :: integer() | undefined, % = 2, 32 bits
         rob_count              :: integer() | undefined, % = 3, 32 bits
         refresh_count          :: integer() | undefined % = 4, 32 bits
        }).
-endif.

-ifndef('M_ESCORT_START_TOS_PB_H').
-define('M_ESCORT_START_TOS_PB_H', true).
-record(m_escort_start_tos,
        {
        }).
-endif.

-ifndef('M_ESCORT_START_TOC_PB_H').
-define('M_ESCORT_START_TOC_PB_H', true).
-record(m_escort_start_toc,
        {
        }).
-endif.

-ifndef('M_ESCORT_INFO_TOS_PB_H').
-define('M_ESCORT_INFO_TOS_PB_H', true).
-record(m_escort_info_tos,
        {
        }).
-endif.

-ifndef('M_ESCORT_INFO_TOC_PB_H').
-define('M_ESCORT_INFO_TOC_PB_H', true).
-record(m_escort_info_toc,
        {quality                :: integer() | undefined, % = 1, 32 bits
         supporter              :: pb_1601_escort:p_role_base() | undefined, % = 2
         progress               :: integer() | undefined, % = 3, 32 bits
         end_time               :: integer() | undefined, % = 4, 32 bits
         level                  :: integer() | undefined, % = 5, 32 bits
         is_double              :: integer() | undefined, % = 6, 32 bits
         escort_count           :: integer() | undefined, % = 7, 32 bits
         refresh_count          :: integer() | undefined % = 8, 32 bits
        }).
-endif.

-ifndef('M_ESCORT_FINISH_TOS_PB_H').
-define('M_ESCORT_FINISH_TOS_PB_H', true).
-record(m_escort_finish_tos,
        {progress               :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_ESCORT_FINISH_TOC_PB_H').
-define('M_ESCORT_FINISH_TOC_PB_H', true).
-record(m_escort_finish_toc,
        {result                 :: integer(),       % = 1, 32 bits
         progress               :: integer() | undefined, % = 2, 32 bits
         rewards = #{}          :: #{integer() := integer()} | undefined % = 3
        }).
-endif.

-ifndef('M_ESCORT_COUNT_TOC_PB_H').
-define('M_ESCORT_COUNT_TOC_PB_H', true).
-record(m_escort_count_toc,
        {escort_count           :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('P_ESCORT_PB_H').
-define('P_ESCORT_PB_H', true).
-record(p_escort,
        {role                   :: pb_1601_escort:p_role_base(), % = 1
         quality                :: integer(),       % = 2, 32 bits
         level                  :: integer()        % = 3, 32 bits
        }).
-endif.

-ifndef('P_ESCORT_RECORD_PB_H').
-define('P_ESCORT_RECORD_PB_H', true).
-record(p_escort_record,
        {role                   :: pb_1601_escort:p_role_base(), % = 1
         quality                :: integer(),       % = 2, 32 bits
         level                  :: integer(),       % = 3, 32 bits
         rob_count              :: integer(),       % = 4, 32 bits
         is_success             :: integer()        % = 5, 32 bits
        }).
-endif.

-ifndef('M_ESCORT_SUPPORT_TOS_PB_H').
-define('M_ESCORT_SUPPORT_TOS_PB_H', true).
-record(m_escort_support_tos,
        {role_id                :: non_neg_integer() % = 1, 32 bits
        }).
-endif.

-ifndef('M_ESCORT_SUPPORT_TOC_PB_H').
-define('M_ESCORT_SUPPORT_TOC_PB_H', true).
-record(m_escort_support_toc,
        {role_id                :: non_neg_integer() % = 1, 32 bits
        }).
-endif.

-ifndef('M_ESCORT_REQUEST_SUPPORT_TOC_PB_H').
-define('M_ESCORT_REQUEST_SUPPORT_TOC_PB_H', true).
-record(m_escort_request_support_toc,
        {sender                 :: pb_1601_escort:p_role_base(), % = 1
         quality                :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_ESCORT_HANDLE_REQUEST_TOS_PB_H').
-define('M_ESCORT_HANDLE_REQUEST_TOS_PB_H', true).
-record(m_escort_handle_request_tos,
        {role_id                :: non_neg_integer(), % = 1, 32 bits
         is_accept              :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_ESCORT_HANDLE_REQUEST_TOC_PB_H').
-define('M_ESCORT_HANDLE_REQUEST_TOC_PB_H', true).
-record(m_escort_handle_request_toc,
        {role_id                :: non_neg_integer(), % = 1, 32 bits
         is_accept              :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_ESCORT_LIST_TOS_PB_H').
-define('M_ESCORT_LIST_TOS_PB_H', true).
-record(m_escort_list_tos,
        {
        }).
-endif.

-ifndef('M_ESCORT_LIST_TOC_PB_H').
-define('M_ESCORT_LIST_TOC_PB_H', true).
-record(m_escort_list_toc,
        {escorts = []           :: [pb_1601_escort:p_escort()] | undefined % = 1
        }).
-endif.

-ifndef('M_ESCORT_ROB_TOS_PB_H').
-define('M_ESCORT_ROB_TOS_PB_H', true).
-record(m_escort_rob_tos,
        {role_id                :: non_neg_integer() % = 1, 32 bits
        }).
-endif.

-ifndef('M_ESCORT_ROB_TOC_PB_H').
-define('M_ESCORT_ROB_TOC_PB_H', true).
-record(m_escort_rob_toc,
        {
        }).
-endif.

-ifndef('M_ESCORT_ROBBED_RECORD_TOS_PB_H').
-define('M_ESCORT_ROBBED_RECORD_TOS_PB_H', true).
-record(m_escort_robbed_record_tos,
        {
        }).
-endif.

-ifndef('M_ESCORT_ROBBED_RECORD_TOC_PB_H').
-define('M_ESCORT_ROBBED_RECORD_TOC_PB_H', true).
-record(m_escort_robbed_record_toc,
        {records = []           :: [pb_1601_escort:p_escort_record()] | undefined % = 1
        }).
-endif.

-ifndef('M_ESCORT_ROB_RECORD_TOS_PB_H').
-define('M_ESCORT_ROB_RECORD_TOS_PB_H', true).
-record(m_escort_rob_record_tos,
        {
        }).
-endif.

-ifndef('M_ESCORT_ROB_RECORD_TOC_PB_H').
-define('M_ESCORT_ROB_RECORD_TOC_PB_H', true).
-record(m_escort_rob_record_toc,
        {records = []           :: [pb_1601_escort:p_escort_record()] | undefined % = 1
        }).
-endif.

-ifndef('M_ESCORT_GET_POS_TOS_PB_H').
-define('M_ESCORT_GET_POS_TOS_PB_H', true).
-record(m_escort_get_pos_tos,
        {role_id                :: non_neg_integer() % = 1, 32 bits
        }).
-endif.

-ifndef('M_ESCORT_GET_POS_TOC_PB_H').
-define('M_ESCORT_GET_POS_TOC_PB_H', true).
-record(m_escort_get_pos_toc,
        {role_id                :: non_neg_integer(), % = 1, 32 bits
...
-record(p_role_base,
        {id                     :: non_neg_integer(), % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1601_escort:p_aspect()} | undefined, % = 8
         ...
         icon                   :: pb_1601_escort:p_icon() | undefined, % = 17
...
-record(p_item,
        {uid                    :: integer(),       % = 1, 32 bits
         ...
         gender                 :: integer(),       % = 7, 32 bits
         score                  :: integer() | undefined, % = 8, 32 bits
         equip                  :: pb_1601_escort:p_equip() | undefined, % = 9
         pet                    :: pb_1601_escort:p_pet() | undefined, % = 10
...
-record(p_equip,
        {base                   :: pb_1601_escort:p_attr(), % = 1
         rare1                  :: pb_1601_escort:p_attr() | undefined, % = 2
         rare2                  :: pb_1601_escort:p_attr() | undefined, % = 3
         rare3                  :: pb_1601_escort:p_attr() | undefined, % = 4
         marriage               :: pb_1601_escort:p_marriage() | undefined, % = 5
         ...
         refine = []            :: [pb_1601_escort:p_refine()] | undefined, % = 11
         suite = #{}            :: #{integer() := integer()} | undefined, % = 12
         combine = []           :: [pb_1601_escort:p_item()] | undefined % = 13
        }).
-endif.
...
-record(p_marriage,
        {husband_id             :: non_neg_integer() | undefined, % = 1, 32 bits
         ...
         rare                   :: pb_1601_escort:p_attr() | undefined % = 5
        }).
-endif.
...
-record(p_actor,
        {uid                    :: non_neg_integer(), % = 1, 32 bits
         ...
         coord                  :: pb_1601_escort:p_coord(), % = 4
         state                  :: integer(),       % = 5, 32 bits
         stargs = #{}           :: #{integer() := iolist()} | undefined, % = 6
         role                   :: pb_1601_escort:p_role() | undefined, % = 7
         creep                  :: pb_1601_escort:p_creep() | undefined, % = 8
         drop                   :: pb_1601_escort:p_drop() | undefined % = 9
        }).
-endif.
...
-record(p_role,
        {career                 :: integer(),       % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1601_escort:p_aspect()} | undefined, % = 5
         ...
         icon                   :: pb_1601_escort:p_icon() | undefined % = 25
        }).
-endif.
...
-record(p_creep,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         buffs = []             :: [pb_1601_escort:p_buff()] | undefined, % = 6
         dir                    :: integer(),       % = 7, 32 bits
         dest                   :: pb_1601_escort:p_coord(), % = 8
...
-record(p_npc,
        {id                     :: integer(),       % = 1, 32 bits
         coord                  :: pb_1601_escort:p_coord() % = 2
        }).
-endif.
...
-record(p_drop,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         coord                  :: pb_1601_escort:p_coord() | undefined, % = 5
...
-record(p_ranking,
        {base                   :: pb_1601_escort:p_role_base() | undefined, % = 1
