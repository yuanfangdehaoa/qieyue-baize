...
-ifndef(pb_1129_pet).
-define(pb_1129_pet, true).

-define(pb_1129_pet_gpb_version, "4.5.1").

-ifndef('P_EGG_RECORD_PB_H').
-define('P_EGG_RECORD_PB_H', true).
-record(p_egg_record,
        {role_id                :: non_neg_integer(), % = 1, 32 bits
         role_name              :: iolist(),        % = 2
         item_id                :: integer(),       % = 3, 32 bits
         pets = #{}             :: #{integer() := iolist()} | undefined, % = 4
         time                   :: integer()        % = 5, 32 bits
        }).
-endif.

-ifndef('M_PET_INFO_TOS_PB_H').
-define('M_PET_INFO_TOS_PB_H', true).
-record(m_pet_info_tos,
        {
        }).
-endif.

-ifndef('M_PET_INFO_TOC_PB_H').
-define('M_PET_INFO_TOC_PB_H', true).
-record(m_pet_info_toc,
        {pets = []              :: [pb_1129_pet:p_item()] | undefined, % = 1
         fight_order            :: integer() | undefined % = 2, 32 bits
        }).
-endif.

-ifndef('M_PET_SET_TOS_PB_H').
-define('M_PET_SET_TOS_PB_H', true).
-record(m_pet_set_tos,
        {uid                    :: integer(),       % = 1, 32 bits
         is_fight               :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_PET_SET_TOC_PB_H').
-define('M_PET_SET_TOC_PB_H', true).
-record(m_pet_set_toc,
        {order                  :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_PET_STRONG_TOS_PB_H').
-define('M_PET_STRONG_TOS_PB_H', true).
-record(m_pet_strong_tos,
        {order                  :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_PET_STRONG_TOC_PB_H').
-define('M_PET_STRONG_TOC_PB_H', true).
-record(m_pet_strong_toc,
        {order                  :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_PET_CROSS_TOS_PB_H').
-define('M_PET_CROSS_TOS_PB_H', true).
-record(m_pet_cross_tos,
        {order                  :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_PET_CROSS_TOC_PB_H').
-define('M_PET_CROSS_TOC_PB_H', true).
-record(m_pet_cross_toc,
        {order                  :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_PET_EVOLVE_TOS_PB_H').
-define('M_PET_EVOLVE_TOS_PB_H', true).
-record(m_pet_evolve_tos,
        {order                  :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_PET_EVOLVE_TOC_PB_H').
-define('M_PET_EVOLVE_TOC_PB_H', true).
-record(m_pet_evolve_toc,
        {order                  :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_PET_BACK_TOS_PB_H').
-define('M_PET_BACK_TOS_PB_H', true).
-record(m_pet_back_tos,
        {order                  :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_PET_BACK_TOC_PB_H').
-define('M_PET_BACK_TOC_PB_H', true).
-record(m_pet_back_toc,
        {order                  :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_PET_COMPOSE_TOS_PB_H').
-define('M_PET_COMPOSE_TOS_PB_H', true).
-record(m_pet_compose_tos,
        {id                     :: integer(),       % = 1, 32 bits
         uids = []              :: [integer()] | undefined % = 2, 32 bits
        }).
-endif.

-ifndef('M_PET_COMPOSE_TOC_PB_H').
-define('M_PET_COMPOSE_TOC_PB_H', true).
-record(m_pet_compose_toc,
        {id                     :: integer(),       % = 1, 32 bits
         success                :: boolean() | 0 | 1 % = 2
        }).
-endif.

-ifndef('M_PET_DECOMPOSE_TOS_PB_H').
-define('M_PET_DECOMPOSE_TOS_PB_H', true).
-record(m_pet_decompose_tos,
        {uids = []              :: [integer()] | undefined % = 1, 32 bits
        }).
-endif.

-ifndef('M_PET_DECOMPOSE_TOC_PB_H').
-define('M_PET_DECOMPOSE_TOC_PB_H', true).
-record(m_pet_decompose_toc,
        {
        }).
-endif.

-ifndef('M_PET_EGG_RECORDS_TOS_PB_H').
-define('M_PET_EGG_RECORDS_TOS_PB_H', true).
-record(m_pet_egg_records_tos,
        {
        }).
-endif.

-ifndef('M_PET_EGG_RECORDS_TOC_PB_H').
-define('M_PET_EGG_RECORDS_TOC_PB_H', true).
-record(m_pet_egg_records_toc,
        {records = []           :: [pb_1129_pet:p_egg_record()] | undefined % = 1
        }).
-endif.

-ifndef('M_PET_SHOW_TOC_PB_H').
-define('M_PET_SHOW_TOC_PB_H', true).
-record(m_pet_show_toc,
        {pet                    :: pb_1129_pet:p_item() % = 1
        }).
-endif.

-ifndef('M_PET_EQUIPS_TOS_PB_H').
-define('M_PET_EQUIPS_TOS_PB_H', true).
-record(m_pet_equips_tos,
        {pet_id                 :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_PET_EQUIPS_TOC_PB_H').
-define('M_PET_EQUIPS_TOC_PB_H', true).
-record(m_pet_equips_toc,
        {pet_id                 :: integer(),       % = 1, 32 bits
         equips = []            :: [pb_1129_pet:p_item()] | undefined % = 2
        }).
-endif.

-ifndef('M_PET_EQUIP_PUTON_TOS_PB_H').
-define('M_PET_EQUIP_PUTON_TOS_PB_H', true).
-record(m_pet_equip_puton_tos,
        {pet_id                 :: integer(),       % = 1, 32 bits
         equip_id               :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_PET_EQUIP_PUTON_TOC_PB_H').
-define('M_PET_EQUIP_PUTON_TOC_PB_H', true).
-record(m_pet_equip_puton_toc,
        {pet_id                 :: integer(),       % = 1, 32 bits
         slot                   :: integer(),       % = 2, 32 bits
         equip                  :: pb_1129_pet:p_item() % = 3
        }).
-endif.

-ifndef('M_PET_EQUIP_PUTOFF_TOS_PB_H').
-define('M_PET_EQUIP_PUTOFF_TOS_PB_H', true).
-record(m_pet_equip_putoff_tos,
        {pet_id                 :: integer(),       % = 1, 32 bits
         slot                   :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_PET_EQUIP_PUTOFF_TOC_PB_H').
-define('M_PET_EQUIP_PUTOFF_TOC_PB_H', true).
-record(m_pet_equip_putoff_toc,
        {pet_id                 :: integer(),       % = 1, 32 bits
         slot                   :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_PET_EQUIP_REINF_TOS_PB_H').
-define('M_PET_EQUIP_REINF_TOS_PB_H', true).
-record(m_pet_equip_reinf_tos,
        {pet_id                 :: integer(),       % = 1, 32 bits
         slot                   :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_PET_EQUIP_REINF_TOC_PB_H').
-define('M_PET_EQUIP_REINF_TOC_PB_H', true).
-record(m_pet_equip_reinf_toc,
        {pet_id                 :: integer(),       % = 1, 32 bits
         slot                   :: integer(),       % = 2, 32 bits
         equip                  :: pb_1129_pet:p_item() % = 3
        }).
...
-ifndef('M_PET_EQUIP_UPORDER_TOS_PB_H').
-define('M_PET_EQUIP_UPORDER_TOS_PB_H', true).
-record(m_pet_equip_uporder_tos,
        {pet_id                 :: integer(),       % = 1, 32 bits
         slot                   :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_PET_EQUIP_UPORDER_TOC_PB_H').
-define('M_PET_EQUIP_UPORDER_TOC_PB_H', true).
-record(m_pet_equip_uporder_toc,
        {pet_id                 :: integer(),       % = 1, 32 bits
         slot                   :: integer(),       % = 2, 32 bits
         equip                  :: pb_1129_pet:p_item() % = 3
        }).
...
-ifndef('M_PET_EQUIP_SMELT_TOS_PB_H').
-define('M_PET_EQUIP_SMELT_TOS_PB_H', true).
-record(m_pet_equip_smelt_tos,
        {item_uid = []          :: [integer()] | undefined % = 1, 32 bits
        }).
-endif.

-ifndef('M_PET_EQUIP_SMELT_TOC_PB_H').
-define('M_PET_EQUIP_SMELT_TOC_PB_H', true).
-record(m_pet_equip_smelt_toc,
        {refund = #{}           :: #{integer() := integer()} | undefined % = 1
        }).
-endif.

-ifndef('M_PET_EQUIP_SPLIT_TOS_PB_H').
-define('M_PET_EQUIP_SPLIT_TOS_PB_H', true).
-record(m_pet_equip_split_tos,
        {item_uid               :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_PET_EQUIP_SPLIT_TOC_PB_H').
-define('M_PET_EQUIP_SPLIT_TOC_PB_H', true).
-record(m_pet_equip_split_toc,
        {equip                  :: pb_1129_pet:p_item(), % = 1
         refund = #{}           :: #{integer() := integer()} | undefined % = 2
        }).
-endif.

-ifndef('M_PET_EQUIP_INHERIT_TOS_PB_H').
-define('M_PET_EQUIP_INHERIT_TOS_PB_H', true).
-record(m_pet_equip_inherit_tos,
        {src_item_uid           :: integer(),       % = 1, 32 bits
         dst_item_uid           :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_PET_EQUIP_INHERIT_TOC_PB_H').
-define('M_PET_EQUIP_INHERIT_TOC_PB_H', true).
-record(m_pet_equip_inherit_toc,
        {src_item               :: pb_1129_pet:p_item(), % = 1
         dst_item               :: pb_1129_pet:p_item() % = 2
        }).
-endif.
...
-record(p_role_base,
        {id                     :: non_neg_integer(), % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1129_pet:p_aspect()} | undefined, % = 8
         ...
         icon                   :: pb_1129_pet:p_icon() | undefined, % = 17
...
-record(p_item,
        {uid                    :: integer(),       % = 1, 32 bits
         ...
         gender                 :: integer(),       % = 7, 32 bits
         score                  :: integer() | undefined, % = 8, 32 bits
         equip                  :: pb_1129_pet:p_equip() | undefined, % = 9
         pet                    :: pb_1129_pet:p_pet() | undefined, % = 10
...
-record(p_equip,
        {base                   :: pb_1129_pet:p_attr(), % = 1
         rare1                  :: pb_1129_pet:p_attr() | undefined, % = 2
         rare2                  :: pb_1129_pet:p_attr() | undefined, % = 3
         rare3                  :: pb_1129_pet:p_attr() | undefined, % = 4
         marriage               :: pb_1129_pet:p_marriage() | undefined, % = 5
         ...
         refine = []            :: [pb_1129_pet:p_refine()] | undefined, % = 11
         suite = #{}            :: #{integer() := integer()} | undefined, % = 12
         combine = []           :: [pb_1129_pet:p_item()] | undefined % = 13
        }).
-endif.
...
-record(p_marriage,
        {husband_id             :: non_neg_integer() | undefined, % = 1, 32 bits
         ...
         rare                   :: pb_1129_pet:p_attr() | undefined % = 5
        }).
-endif.
...
-record(p_actor,
        {uid                    :: non_neg_integer(), % = 1, 32 bits
         ...
         coord                  :: pb_1129_pet:p_coord(), % = 4
         state                  :: integer(),       % = 5, 32 bits
         stargs = #{}           :: #{integer() := iolist()} | undefined, % = 6
         role                   :: pb_1129_pet:p_role() | undefined, % = 7
         creep                  :: pb_1129_pet:p_creep() | undefined, % = 8
         drop                   :: pb_1129_pet:p_drop() | undefined % = 9
        }).
-endif.
...
-record(p_role,
        {career                 :: integer(),       % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1129_pet:p_aspect()} | undefined, % = 5
         ...
         icon                   :: pb_1129_pet:p_icon() | undefined % = 25
        }).
-endif.
...
-record(p_creep,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         buffs = []             :: [pb_1129_pet:p_buff()] | undefined, % = 6
         dir                    :: integer(),       % = 7, 32 bits
         dest                   :: pb_1129_pet:p_coord(), % = 8
...
-record(p_drop,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         coord                  :: pb_1129_pet:p_coord() | undefined, % = 5
...
-record(p_ranking,
        {base                   :: pb_1129_pet:p_role_base() | undefined, % = 1
