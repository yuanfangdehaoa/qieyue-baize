...
-ifndef(pb_1132_arena).
-define(pb_1132_arena, true).

-define(pb_1132_arena_gpb_version, "4.5.1").

-ifndef('M_ARENA_INFO_TOS_PB_H').
-define('M_ARENA_INFO_TOS_PB_H', true).
-record(m_arena_info_tos,
        {
        }).
-endif.

-ifndef('M_ARENA_INFO_TOC_PB_H').
-define('M_ARENA_INFO_TOC_PB_H', true).
-record(m_arena_info_toc,
        {rank                   :: integer(),       % = 1, 32 bits
         challenge              :: integer(),       % = 2, 32 bits
         sti_times              :: integer(),       % = 3, 32 bits
         buy_times              :: integer(),       % = 4, 32 bits
         list = []              :: [pb_1132_arena:p_arena()] | undefined % = 5
        }).
-endif.

-ifndef('M_ARENA_REFRESH_TOS_PB_H').
-define('M_ARENA_REFRESH_TOS_PB_H', true).
-record(m_arena_refresh_tos,
        {
        }).
-endif.

-ifndef('M_ARENA_REFRESH_TOC_PB_H').
-define('M_ARENA_REFRESH_TOC_PB_H', true).
-record(m_arena_refresh_toc,
        {list = []              :: [pb_1132_arena:p_arena()] | undefined % = 1
        }).
-endif.

-ifndef('M_ARENA_ADD_CHALLENGE_TOS_PB_H').
-define('M_ARENA_ADD_CHALLENGE_TOS_PB_H', true).
-record(m_arena_add_challenge_tos,
        {num                    :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_ARENA_ADD_CHALLENGE_TOC_PB_H').
-define('M_ARENA_ADD_CHALLENGE_TOC_PB_H', true).
-record(m_arena_add_challenge_toc,
        {challenge              :: integer(),       % = 1, 32 bits
         buy_times              :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_ARENA_START_TOS_PB_H').
-define('M_ARENA_START_TOS_PB_H', true).
-record(m_arena_start_tos,
        {rank                   :: integer(),       % = 1, 32 bits
         role_id                :: non_neg_integer(), % = 2, 32 bits
         is_merge               :: boolean() | 0 | 1, % = 3
         is_top                 :: boolean() | 0 | 1, % = 4
         is_skip                :: boolean() | 0 | 1 % = 5
        }).
-endif.

-ifndef('M_ARENA_BATTLE_TOS_PB_H').
-define('M_ARENA_BATTLE_TOS_PB_H', true).
-record(m_arena_battle_tos,
        {
        }).
-endif.

-ifndef('M_ARENA_BATTLE_TOC_PB_H').
-define('M_ARENA_BATTLE_TOC_PB_H', true).
-record(m_arena_battle_toc,
        {ptime                  :: integer() | undefined, % = 1, 32 bits
         etime                  :: integer() | undefined % = 2, 32 bits
        }).
-endif.

-ifndef('M_ARENA_END_TOC_PB_H').
-define('M_ARENA_END_TOC_PB_H', true).
-record(m_arena_end_toc,
        {is_win                 :: boolean() | 0 | 1, % = 1
         old_rank               :: integer(),       % = 2, 32 bits
         new_rank               :: integer(),       % = 3, 32 bits
         challenge              :: integer()        % = 4, 32 bits
        }).
-endif.

-ifndef('M_ARENA_SKIP_TOS_PB_H').
-define('M_ARENA_SKIP_TOS_PB_H', true).
-record(m_arena_skip_tos,
        {
        }).
-endif.

-ifndef('M_ARENA_TOP_TOS_PB_H').
-define('M_ARENA_TOP_TOS_PB_H', true).
-record(m_arena_top_tos,
        {
        }).
-endif.

-ifndef('M_ARENA_TOP_TOC_PB_H').
-define('M_ARENA_TOP_TOC_PB_H', true).
-record(m_arena_top_toc,
        {list = []              :: [pb_1132_arena:p_arena()] | undefined, % = 1
         challenge              :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_ARENA_STIMULATE_TOS_PB_H').
-define('M_ARENA_STIMULATE_TOS_PB_H', true).
-record(m_arena_stimulate_tos,
        {
        }).
-endif.

-ifndef('M_ARENA_STIMULATE_TOC_PB_H').
-define('M_ARENA_STIMULATE_TOC_PB_H', true).
-record(m_arena_stimulate_toc,
        {sti_times              :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_ARENA_HIGHEST_RANK_TOS_PB_H').
-define('M_ARENA_HIGHEST_RANK_TOS_PB_H', true).
-record(m_arena_highest_rank_tos,
        {
        }).
-endif.

-ifndef('M_ARENA_HIGHEST_RANK_TOC_PB_H').
-define('M_ARENA_HIGHEST_RANK_TOC_PB_H', true).
-record(m_arena_highest_rank_toc,
        {rank                   :: integer(),       % = 1, 32 bits
         fetch = []             :: [integer()] | undefined % = 2, 32 bits
        }).
-endif.

-ifndef('M_ARENA_HIGHEST_RANK_FETCH_TOS_PB_H').
-define('M_ARENA_HIGHEST_RANK_FETCH_TOS_PB_H', true).
-record(m_arena_highest_rank_fetch_tos,
        {id                     :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_ARENA_HIGHEST_RANK_FETCH_TOC_PB_H').
-define('M_ARENA_HIGHEST_RANK_FETCH_TOC_PB_H', true).
-record(m_arena_highest_rank_fetch_toc,
        {id                     :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_ARENA_RANK_TOS_PB_H').
-define('M_ARENA_RANK_TOS_PB_H', true).
-record(m_arena_rank_tos,
        {
        }).
-endif.

-ifndef('M_ARENA_RANK_TOC_PB_H').
-define('M_ARENA_RANK_TOC_PB_H', true).
-record(m_arena_rank_toc,
        {is_fetch               :: boolean() | 0 | 1 % = 1
        }).
-endif.

-ifndef('M_ARENA_RANK_FETCH_TOS_PB_H').
-define('M_ARENA_RANK_FETCH_TOS_PB_H', true).
-record(m_arena_rank_fetch_tos,
        {
        }).
-endif.

-ifndef('M_ARENA_RANK_FETCH_TOC_PB_H').
-define('M_ARENA_RANK_FETCH_TOC_PB_H', true).
-record(m_arena_rank_fetch_toc,
        {is_fetch               :: boolean() | 0 | 1 % = 1
        }).
-endif.

-ifndef('M_ARENA_TOP_RANK_TOS_PB_H').
-define('M_ARENA_TOP_RANK_TOS_PB_H', true).
-record(m_arena_top_rank_tos,
        {
        }).
-endif.

-ifndef('M_ARENA_TOP_RANK_TOC_PB_H').
-define('M_ARENA_TOP_RANK_TOC_PB_H', true).
-record(m_arena_top_rank_toc,
        {is_fetch               :: boolean() | 0 | 1 % = 1
        }).
-endif.

-ifndef('M_ARENA_TOP_RANK_FETCH_TOS_PB_H').
-define('M_ARENA_TOP_RANK_FETCH_TOS_PB_H', true).
-record(m_arena_top_rank_fetch_tos,
        {
        }).
-endif.

-ifndef('M_ARENA_TOP_RANK_FETCH_TOC_PB_H').
-define('M_ARENA_TOP_RANK_FETCH_TOC_PB_H', true).
-record(m_arena_top_rank_fetch_toc,
        {is_fetch               :: boolean() | 0 | 1 % = 1
        }).
-endif.

-ifndef('M_ARENA_NOTICE_TOS_PB_H').
-define('M_ARENA_NOTICE_TOS_PB_H', true).
-record(m_arena_notice_tos,
        {
        }).
-endif.

-ifndef('M_ARENA_NOTICE_TOC_PB_H').
-define('M_ARENA_NOTICE_TOC_PB_H', true).
-record(m_arena_notice_toc,
        {cur_rank               :: integer(),       % = 1, 32 bits
         challenge              :: boolean() | 0 | 1, % = 2
         top_challenge          :: boolean() | 0 | 1, % = 3
         high_rank              :: boolean() | 0 | 1, % = 4
         rank                   :: boolean() | 0 | 1, % = 5
         top_rank               :: boolean() | 0 | 1 % = 6
        }).
-endif.

-ifndef('P_ARENA_PB_H').
-define('P_ARENA_PB_H', true).
-record(p_arena,
        {id                     :: non_neg_integer(), % = 1, 32 bits
         creep                  :: integer(),       % = 2, 32 bits
         rank                   :: integer(),       % = 3, 32 bits
         name                   :: iolist(),        % = 4
         career                 :: integer(),       % = 5, 32 bits
         gender                 :: integer(),       % = 6, 32 bits
         level                  :: integer(),       % = 7, 32 bits
         power                  :: integer(),       % = 8, 32 bits
         figure = #{}           :: #{iolist() := pb_1132_arena:p_aspect()} | undefined, % = 9
         sti_times              :: integer()        % = 10, 32 bits
        }).
-endif.
...
-record(p_role_base,
        {id                     :: non_neg_integer(), % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1132_arena:p_aspect()} | undefined, % = 8
         ...
         icon                   :: pb_1132_arena:p_icon() | undefined, % = 17
...
-record(p_item,
        {uid                    :: integer(),       % = 1, 32 bits
         ...
         gender                 :: integer(),       % = 7, 32 bits
         score                  :: integer() | undefined, % = 8, 32 bits
         equip                  :: pb_1132_arena:p_equip() | undefined, % = 9
         pet                    :: pb_1132_arena:p_pet() | undefined, % = 10
...
-record(p_equip,
        {base                   :: pb_1132_arena:p_attr(), % = 1
         rare1                  :: pb_1132_arena:p_attr() | undefined, % = 2
         rare2                  :: pb_1132_arena:p_attr() | undefined, % = 3
         rare3                  :: pb_1132_arena:p_attr() | undefined, % = 4
         marriage               :: pb_1132_arena:p_marriage() | undefined, % = 5
         ...
         refine = []            :: [pb_1132_arena:p_refine()] | undefined, % = 11
         suite = #{}            :: #{integer() := integer()} | undefined, % = 12
         combine = []           :: [pb_1132_arena:p_item()] | undefined % = 13
        }).
-endif.
...
-record(p_marriage,
        {husband_id             :: non_neg_integer() | undefined, % = 1, 32 bits
         ...
         rare                   :: pb_1132_arena:p_attr() | undefined % = 5
        }).
-endif.
...
-record(p_actor,
        {uid                    :: non_neg_integer(), % = 1, 32 bits
         ...
         coord                  :: pb_1132_arena:p_coord(), % = 4
         state                  :: integer(),       % = 5, 32 bits
         stargs = #{}           :: #{integer() := iolist()} | undefined, % = 6
         role                   :: pb_1132_arena:p_role() | undefined, % = 7
         creep                  :: pb_1132_arena:p_creep() | undefined, % = 8
         drop                   :: pb_1132_arena:p_drop() | undefined % = 9
        }).
-endif.
...
-record(p_role,
        {career                 :: integer(),       % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1132_arena:p_aspect()} | undefined, % = 5
         ...
         icon                   :: pb_1132_arena:p_icon() | undefined % = 25
        }).
-endif.
...
-record(p_creep,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         buffs = []             :: [pb_1132_arena:p_buff()] | undefined, % = 6
         dir                    :: integer(),       % = 7, 32 bits
         dest                   :: pb_1132_arena:p_coord(), % = 8
...
-record(p_drop,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         coord                  :: pb_1132_arena:p_coord() | undefined, % = 5
...
-record(p_ranking,
        {base                   :: pb_1132_arena:p_role_base() | undefined, % = 1
