...
-ifndef(pb_1134_marriage).
-define(pb_1134_marriage, true).

-define(pb_1134_marriage_gpb_version, "4.5.1").

-ifndef('M_MARRIAGE_STEP_TOS_PB_H').
-define('M_MARRIAGE_STEP_TOS_PB_H', true).
-record(m_marriage_step_tos,
        {
        }).
-endif.

-ifndef('M_MARRIAGE_STEP_TOC_PB_H').
-define('M_MARRIAGE_STEP_TOC_PB_H', true).
-record(m_marriage_step_toc,
        {steps = []             :: [pb_1134_marriage:p_marriage_step()] | undefined % = 1
        }).
-endif.

-ifndef('M_MARRIAGE_STEP_REWARD_TOS_PB_H').
-define('M_MARRIAGE_STEP_REWARD_TOS_PB_H', true).
-record(m_marriage_step_reward_tos,
        {id                     :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('P_MARRIAGE_STEP_PB_H').
-define('P_MARRIAGE_STEP_PB_H', true).
-record(p_marriage_step,
        {id                     :: integer(),       % = 1, 32 bits
         state                  :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_MARRIAGE_PROPOSAL_PANEL_TOS_PB_H').
-define('M_MARRIAGE_PROPOSAL_PANEL_TOS_PB_H', true).
-record(m_marriage_proposal_panel_tos,
        {target                 :: non_neg_integer() % = 1, 32 bits
        }).
-endif.

-ifndef('M_MARRIAGE_PROPOSAL_PANEL_TOC_PB_H').
-define('M_MARRIAGE_PROPOSAL_PANEL_TOC_PB_H', true).
-record(m_marriage_proposal_panel_toc,
        {types = #{}            :: #{integer() := integer()} | undefined % = 1
        }).
-endif.

-ifndef('M_MARRIAGE_PROPOSAL_TOS_PB_H').
-define('M_MARRIAGE_PROPOSAL_TOS_PB_H', true).
-record(m_marriage_proposal_tos,
        {target                 :: non_neg_integer(), % = 1, 32 bits
...
-ifndef('M_MARRIAGE_PROPOSAL_TOC_PB_H').
-define('M_MARRIAGE_PROPOSAL_TOC_PB_H', true).
-record(m_marriage_proposal_toc,
        {
        }).
-endif.

-ifndef('M_MARRIAGE_PROPOSAL_REQUEST_TOS_PB_H').
-define('M_MARRIAGE_PROPOSAL_REQUEST_TOS_PB_H', true).
-record(m_marriage_proposal_request_tos,
        {
        }).
-endif.

-ifndef('M_MARRIAGE_PROPOSAL_REQUEST_TOC_PB_H').
-define('M_MARRIAGE_PROPOSAL_REQUEST_TOC_PB_H', true).
-record(m_marriage_proposal_request_toc,
        {role                   :: pb_1134_marriage:p_role_base() | undefined, % = 1
         type                   :: integer() | undefined, % = 2, 32 bits
         is_aa                  :: boolean() | 0 | 1 | undefined, % = 3
         endtime                :: integer() | undefined % = 4, 32 bits
        }).
-endif.

-ifndef('M_MARRIAGE_PROPOSAL_ACCEPT_TOS_PB_H').
-define('M_MARRIAGE_PROPOSAL_ACCEPT_TOS_PB_H', true).
-record(m_marriage_proposal_accept_tos,
        {target                 :: non_neg_integer() % = 1, 32 bits
        }).
-endif.

-ifndef('M_MARRIAGE_PROPOSAL_ACCEPT_TOC_PB_H').
-define('M_MARRIAGE_PROPOSAL_ACCEPT_TOC_PB_H', true).
-record(m_marriage_proposal_accept_toc,
        {
        }).
-endif.

-ifndef('M_MARRIAGE_PROPOSAL_REFUSE_TOS_PB_H').
-define('M_MARRIAGE_PROPOSAL_REFUSE_TOS_PB_H', true).
-record(m_marriage_proposal_refuse_tos,
        {target                 :: non_neg_integer() % = 1, 32 bits
        }).
-endif.

-ifndef('M_MARRIAGE_PROPOSAL_REFUSE_TOC_PB_H').
-define('M_MARRIAGE_PROPOSAL_REFUSE_TOC_PB_H', true).
-record(m_marriage_proposal_refuse_toc,
        {
        }).
-endif.

-ifndef('M_MARRIAGE_PROPOSAL_SUCC_TOC_PB_H').
-define('M_MARRIAGE_PROPOSAL_SUCC_TOC_PB_H', true).
-record(m_marriage_proposal_succ_toc,
        {proposer               :: pb_1134_marriage:p_role_base(), % = 1
         accepter               :: pb_1134_marriage:p_role_base(), % = 2
         type                   :: integer(),       % = 3, 32 bits
         wedding_times          :: integer()        % = 4, 32 bits
        }).
-endif.

-ifndef('M_MARRIAGE_DIVORCE_TOS_PB_H').
-define('M_MARRIAGE_DIVORCE_TOS_PB_H', true).
-record(m_marriage_divorce_tos,
        {
        }).
-endif.

-ifndef('M_MARRIAGE_DIVORCE_TOC_PB_H').
-define('M_MARRIAGE_DIVORCE_TOC_PB_H', true).
-record(m_marriage_divorce_toc,
        {
        }).
-endif.

-ifndef('M_MARRIAGE_INFO_TOS_PB_H').
-define('M_MARRIAGE_INFO_TOS_PB_H', true).
-record(m_marriage_info_tos,
        {
        }).
-endif.

-ifndef('M_MARRIAGE_INFO_TOC_PB_H').
-define('M_MARRIAGE_INFO_TOC_PB_H', true).
-record(m_marriage_info_toc,
        {marry_with             :: pb_1134_marriage:p_role_base() | undefined, % = 1
         day                    :: integer(),       % = 2, 32 bits
         intimacy               :: integer(),       % = 3, 32 bits
         has_marry              :: boolean() | 0 | 1, % = 4
         wedding_times          :: integer()        % = 5, 32 bits
        }).
-endif.

-ifndef('M_MARRIAGE_RING_UPGRADE_TOS_PB_H').
-define('M_MARRIAGE_RING_UPGRADE_TOS_PB_H', true).
-record(m_marriage_ring_upgrade_tos,
        {
        }).
-endif.

-ifndef('M_MARRIAGE_RING_UPGRADE_TOC_PB_H').
-define('M_MARRIAGE_RING_UPGRADE_TOC_PB_H', true).
-record(m_marriage_ring_upgrade_toc,
        {ring                   :: pb_1134_marriage:p_marriage_ring() % = 1
        }).
-endif.

-ifndef('M_MARRIAGE_RING_INFO_TOS_PB_H').
-define('M_MARRIAGE_RING_INFO_TOS_PB_H', true).
-record(m_marriage_ring_info_tos,
        {
        }).
-endif.

-ifndef('M_MARRIAGE_RING_INFO_TOC_PB_H').
-define('M_MARRIAGE_RING_INFO_TOC_PB_H', true).
-record(m_marriage_ring_info_toc,
        {ring                   :: pb_1134_marriage:p_marriage_ring() % = 1
        }).
-endif.

-ifndef('P_MARRIAGE_RING_PB_H').
-define('P_MARRIAGE_RING_PB_H', true).
-record(p_marriage_ring,
...
-record(p_role_base,
        {id                     :: non_neg_integer(), % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1134_marriage:p_aspect()} | undefined, % = 8
         ...
         icon                   :: pb_1134_marriage:p_icon() | undefined, % = 17
...
-record(p_item,
        {uid                    :: integer(),       % = 1, 32 bits
         ...
         gender                 :: integer(),       % = 7, 32 bits
         score                  :: integer() | undefined, % = 8, 32 bits
         equip                  :: pb_1134_marriage:p_equip() | undefined, % = 9
         pet                    :: pb_1134_marriage:p_pet() | undefined, % = 10
...
-record(p_equip,
        {base                   :: pb_1134_marriage:p_attr(), % = 1
         rare1                  :: pb_1134_marriage:p_attr() | undefined, % = 2
         rare2                  :: pb_1134_marriage:p_attr() | undefined, % = 3
         rare3                  :: pb_1134_marriage:p_attr() | undefined, % = 4
         marriage               :: pb_1134_marriage:p_marriage() | undefined, % = 5
         ...
         refine = []            :: [pb_1134_marriage:p_refine()] | undefined, % = 11
         suite = #{}            :: #{integer() := integer()} | undefined, % = 12
         combine = []           :: [pb_1134_marriage:p_item()] | undefined % = 13
        }).
-endif.
...
-record(p_marriage,
        {husband_id             :: non_neg_integer() | undefined, % = 1, 32 bits
         ...
         rare                   :: pb_1134_marriage:p_attr() | undefined % = 5
        }).
-endif.
...
-record(p_actor,
        {uid                    :: non_neg_integer(), % = 1, 32 bits
         name                   :: iolist(),        % = 2
         type                   :: integer(),       % = 3, 32 bits
         coord                  :: pb_1134_marriage:p_coord(), % = 4
         state                  :: integer(),       % = 5, 32 bits
         stargs = #{}           :: #{integer() := iolist()} | undefined, % = 6
         role                   :: pb_1134_marriage:p_role() | undefined, % = 7
         creep                  :: pb_1134_marriage:p_creep() | undefined, % = 8
         drop                   :: pb_1134_marriage:p_drop() | undefined % = 9
        }).
-endif.
...
-record(p_role,
        {career                 :: integer(),       % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1134_marriage:p_aspect()} | undefined, % = 5
         ...
         icon                   :: pb_1134_marriage:p_icon() | undefined % = 25
        }).
-endif.
...
-record(p_creep,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         buffs = []             :: [pb_1134_marriage:p_buff()] | undefined, % = 6
         dir                    :: integer(),       % = 7, 32 bits
         dest                   :: pb_1134_marriage:p_coord(), % = 8
...
-record(p_npc,
        {id                     :: integer(),       % = 1, 32 bits
         coord                  :: pb_1134_marriage:p_coord() % = 2
        }).
-endif.
...
-record(p_drop,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         coord                  :: pb_1134_marriage:p_coord() | undefined, % = 5
...
-record(p_ranking,
        {base                   :: pb_1134_marriage:p_role_base() | undefined, % = 1
