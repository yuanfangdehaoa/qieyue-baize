...
-ifndef(pb_1126_friend).
-define(pb_1126_friend, true).

-define(pb_1126_friend_gpb_version, "4.5.1").

-ifndef('M_FRIEND_CONTACT_TOS_PB_H').
-define('M_FRIEND_CONTACT_TOS_PB_H', true).
-record(m_friend_contact_tos,
        {
        }).
-endif.

-ifndef('M_FRIEND_CONTACT_TOC_PB_H').
-define('M_FRIEND_CONTACT_TOC_PB_H', true).
-record(m_friend_contact_toc,
        {friends = []           :: [pb_1126_friend:p_friend()] | undefined % = 1
        }).
-endif.

-ifndef('M_FRIEND_CONTACT_UPDATE_TOS_PB_H').
-define('M_FRIEND_CONTACT_UPDATE_TOS_PB_H', true).
-record(m_friend_contact_update_tos,
        {role_id                :: non_neg_integer() % = 1, 32 bits
        }).
-endif.

-ifndef('M_FRIEND_CONTACT_UPDATE_TOC_PB_H').
-define('M_FRIEND_CONTACT_UPDATE_TOC_PB_H', true).
-record(m_friend_contact_update_toc,
        {add                    :: pb_1126_friend:p_friend() % = 1
        }).
-endif.

-ifndef('M_FRIEND_LIST_TOS_PB_H').
-define('M_FRIEND_LIST_TOS_PB_H', true).
-record(m_friend_list_tos,
        {
        }).
-endif.

-ifndef('M_FRIEND_LIST_TOC_PB_H').
-define('M_FRIEND_LIST_TOC_PB_H', true).
-record(m_friend_list_toc,
        {friends = []           :: [pb_1126_friend:p_friend()] | undefined % = 1
        }).
-endif.

-ifndef('M_FRIEND_REQUEST_TOS_PB_H').
-define('M_FRIEND_REQUEST_TOS_PB_H', true).
-record(m_friend_request_tos,
        {role_id                :: non_neg_integer() % = 1, 32 bits
        }).
-endif.

-ifndef('M_FRIEND_REQUEST_TOC_PB_H').
-define('M_FRIEND_REQUEST_TOC_PB_H', true).
-record(m_friend_request_toc,
        {
        }).
-endif.

-ifndef('M_FRIEND_REQUEST_LIST_TOS_PB_H').
-define('M_FRIEND_REQUEST_LIST_TOS_PB_H', true).
-record(m_friend_request_list_tos,
        {
        }).
-endif.

-ifndef('M_FRIEND_REQUEST_LIST_TOC_PB_H').
-define('M_FRIEND_REQUEST_LIST_TOC_PB_H', true).
-record(m_friend_request_list_toc,
        {lists = []             :: [pb_1126_friend:p_role_base()] | undefined % = 1
        }).
-endif.

-ifndef('M_FRIEND_ACCEPT_TOS_PB_H').
-define('M_FRIEND_ACCEPT_TOS_PB_H', true).
-record(m_friend_accept_tos,
        {role_id                :: non_neg_integer() % = 1, 32 bits
        }).
-endif.

-ifndef('M_FRIEND_ACCEPT_TOC_PB_H').
-define('M_FRIEND_ACCEPT_TOC_PB_H', true).
-record(m_friend_accept_toc,
        {role_ids = []          :: [non_neg_integer()] | undefined, % = 1, 32 bits
         fail_ids = []          :: [non_neg_integer()] | undefined % = 2, 32 bits
        }).
-endif.

-ifndef('M_FRIEND_REFUSE_TOS_PB_H').
-define('M_FRIEND_REFUSE_TOS_PB_H', true).
-record(m_friend_refuse_tos,
        {role_id                :: non_neg_integer() % = 1, 32 bits
        }).
-endif.

-ifndef('M_FRIEND_REFUSE_TOC_PB_H').
-define('M_FRIEND_REFUSE_TOC_PB_H', true).
-record(m_friend_refuse_toc,
        {role_ids = []          :: [non_neg_integer()] | undefined % = 1, 32 bits
        }).
-endif.

-ifndef('M_FRIEND_DELETE_TOS_PB_H').
-define('M_FRIEND_DELETE_TOS_PB_H', true).
-record(m_friend_delete_tos,
        {role_ids = []          :: [non_neg_integer()] | undefined % = 1, 32 bits
        }).
-endif.

-ifndef('M_FRIEND_DELETE_TOC_PB_H').
-define('M_FRIEND_DELETE_TOC_PB_H', true).
-record(m_friend_delete_toc,
        {role_ids = []          :: [non_neg_integer()] | undefined % = 1, 32 bits
        }).
-endif.

-ifndef('M_FRIEND_ADDBLACK_TOS_PB_H').
-define('M_FRIEND_ADDBLACK_TOS_PB_H', true).
-record(m_friend_addblack_tos,
        {role_id                :: non_neg_integer() % = 1, 32 bits
        }).
-endif.

-ifndef('M_FRIEND_ADDBLACK_TOC_PB_H').
-define('M_FRIEND_ADDBLACK_TOC_PB_H', true).
-record(m_friend_addblack_toc,
        {role_id                :: non_neg_integer() % = 1, 32 bits
        }).
-endif.

-ifndef('M_FRIEND_DELBLACK_TOS_PB_H').
-define('M_FRIEND_DELBLACK_TOS_PB_H', true).
-record(m_friend_delblack_tos,
        {role_id                :: non_neg_integer() % = 1, 32 bits
        }).
-endif.

-ifndef('M_FRIEND_DELBLACK_TOC_PB_H').
-define('M_FRIEND_DELBLACK_TOC_PB_H', true).
-record(m_friend_delblack_toc,
        {role_id                :: non_neg_integer() % = 1, 32 bits
        }).
-endif.

-ifndef('M_FRIEND_DELENEMY_TOS_PB_H').
-define('M_FRIEND_DELENEMY_TOS_PB_H', true).
-record(m_friend_delenemy_tos,
        {role_id                :: non_neg_integer() % = 1, 32 bits
        }).
-endif.

-ifndef('M_FRIEND_DELENEMY_TOC_PB_H').
-define('M_FRIEND_DELENEMY_TOC_PB_H', true).
-record(m_friend_delenemy_toc,
        {role_id                :: non_neg_integer() % = 1, 32 bits
        }).
-endif.

-ifndef('M_FRIEND_RECOMMEND_TOS_PB_H').
-define('M_FRIEND_RECOMMEND_TOS_PB_H', true).
-record(m_friend_recommend_tos,
        {
        }).
-endif.

-ifndef('M_FRIEND_RECOMMEND_TOC_PB_H').
-define('M_FRIEND_RECOMMEND_TOC_PB_H', true).
-record(m_friend_recommend_toc,
        {roles = []             :: [pb_1126_friend:p_role_base()] | undefined % = 1
        }).
-endif.

-ifndef('M_FRIEND_SEARCH_TOS_PB_H').
-define('M_FRIEND_SEARCH_TOS_PB_H', true).
-record(m_friend_search_tos,
        {name                   :: iolist()         % = 1
        }).
-endif.

-ifndef('M_FRIEND_SEARCH_TOC_PB_H').
-define('M_FRIEND_SEARCH_TOC_PB_H', true).
-record(m_friend_search_toc,
        {base                   :: pb_1126_friend:p_role_base() % = 1
        }).
-endif.

-ifndef('M_FRIEND_UPDATE_TOC_PB_H').
-define('M_FRIEND_UPDATE_TOC_PB_H', true).
-record(m_friend_update_toc,
        {add = []               :: [pb_1126_friend:p_friend()] | undefined, % = 1
         del = []               :: [non_neg_integer()] | undefined % = 2, 32 bits
        }).
-endif.

-ifndef('M_FRIEND_RECEIVE_FLOWER_TOC_PB_H').
-define('M_FRIEND_RECEIVE_FLOWER_TOC_PB_H', true).
-record(m_friend_receive_flower_toc,
        {sender                 :: pb_1126_friend:p_role_base(), % = 1
         flower                 :: integer()        % = 3, 32 bits
        }).
-endif.

-ifndef('M_FRIEND_FEEDBACK_TOS_PB_H').
-define('M_FRIEND_FEEDBACK_TOS_PB_H', true).
-record(m_friend_feedback_tos,
        {role_id                :: non_neg_integer(), % = 1, 32 bits
         type                   :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_FRIEND_FEEDBACK_TOC_PB_H').
-define('M_FRIEND_FEEDBACK_TOC_PB_H', true).
-record(m_friend_feedback_toc,
        {to_self                :: boolean() | 0 | 1, % = 1
         base                   :: pb_1126_friend:p_role_base() | undefined, % = 2
         type                   :: integer() | undefined % = 3, 32 bits
        }).
-endif.

-ifndef('M_FRIEND_ONLINE_TOC_PB_H').
-define('M_FRIEND_ONLINE_TOC_PB_H', true).
-record(m_friend_online_toc,
        {role_id                :: non_neg_integer(), % = 1, 32 bits
         name                   :: iolist(),        % = 2
         is_online              :: boolean() | 0 | 1 % = 3
        }).
-endif.

-ifndef('M_FRIEND_SEND_FLOWER_TOS_PB_H').
-define('M_FRIEND_SEND_FLOWER_TOS_PB_H', true).
-record(m_friend_send_flower_tos,
        {role_id                :: non_neg_integer(), % = 1, 32 bits
         item_id                :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_FRIEND_SEND_FLOWER_TOC_PB_H').
-define('M_FRIEND_SEND_FLOWER_TOC_PB_H', true).
-record(m_friend_send_flower_toc,
        {
        }).
-endif.

-ifndef('M_FRIEND_FLOWER_TOC_PB_H').
-define('M_FRIEND_FLOWER_TOC_PB_H', true).
-record(m_friend_flower_toc,
        {flower                 :: integer()        % = 1, 32 bits
        }).
-endif.
...
-record(p_friend,
        {base                   :: pb_1126_friend:p_role_base(), % = 1
         is_online              :: boolean() | 0 | 1, % = 2
         relation               :: integer(),       % = 3, 32 bits
         is_enemy               :: boolean() | 0 | 1, % = 4
         login                  :: integer(),       % = 5, 32 bits
         logout                 :: integer(),       % = 6, 32 bits
         last_chat_time         :: integer() | undefined, % = 7, 32 bits
         intimacy               :: integer() | undefined % = 8, 32 bits
        }).
-endif.
...
-record(p_role_base,
        {id                     :: non_neg_integer(), % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1126_friend:p_aspect()} | undefined, % = 8
         ...
         icon                   :: pb_1126_friend:p_icon() | undefined, % = 17
...
-record(p_item,
        {uid                    :: integer(),       % = 1, 32 bits
         ...
         gender                 :: integer(),       % = 7, 32 bits
         score                  :: integer() | undefined, % = 8, 32 bits
         equip                  :: pb_1126_friend:p_equip() | undefined, % = 9
         pet                    :: pb_1126_friend:p_pet() | undefined, % = 10
...
-record(p_equip,
        {base                   :: pb_1126_friend:p_attr(), % = 1
         rare1                  :: pb_1126_friend:p_attr() | undefined, % = 2
         rare2                  :: pb_1126_friend:p_attr() | undefined, % = 3
         rare3                  :: pb_1126_friend:p_attr() | undefined, % = 4
         marriage               :: pb_1126_friend:p_marriage() | undefined, % = 5
         ...
         refine = []            :: [pb_1126_friend:p_refine()] | undefined, % = 11
         suite = #{}            :: #{integer() := integer()} | undefined, % = 12
         combine = []           :: [pb_1126_friend:p_item()] | undefined % = 13
        }).
-endif.
...
-record(p_marriage,
        {husband_id             :: non_neg_integer() | undefined, % = 1, 32 bits
         ...
         rare                   :: pb_1126_friend:p_attr() | undefined % = 5
        }).
-endif.
...
-record(p_actor,
        {uid                    :: non_neg_integer(), % = 1, 32 bits
         ...
         coord                  :: pb_1126_friend:p_coord(), % = 4
         state                  :: integer(),       % = 5, 32 bits
         stargs = #{}           :: #{integer() := iolist()} | undefined, % = 6
         role                   :: pb_1126_friend:p_role() | undefined, % = 7
         creep                  :: pb_1126_friend:p_creep() | undefined, % = 8
         drop                   :: pb_1126_friend:p_drop() | undefined % = 9
        }).
-endif.
...
-record(p_role,
        {career                 :: integer(),       % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1126_friend:p_aspect()} | undefined, % = 5
         ...
         icon                   :: pb_1126_friend:p_icon() | undefined % = 25
        }).
-endif.
...
-record(p_creep,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         buffs = []             :: [pb_1126_friend:p_buff()] | undefined, % = 6
         dir                    :: integer(),       % = 7, 32 bits
         dest                   :: pb_1126_friend:p_coord(), % = 8
...
-record(p_npc,
        {id                     :: integer(),       % = 1, 32 bits
         coord                  :: pb_1126_friend:p_coord() % = 2
        }).
-endif.
...
-record(p_drop,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         coord                  :: pb_1126_friend:p_coord() | undefined, % = 5
...
-record(p_ranking,
        {base                   :: pb_1126_friend:p_role_base() | undefined, % = 1
