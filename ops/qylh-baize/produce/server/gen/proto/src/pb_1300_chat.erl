...
%% message types
-type m_chat_channel_tos() :: #m_chat_channel_tos{}.

-type m_chat_channel_toc() :: #m_chat_channel_toc{}.

-type m_chat_item_tos() :: #m_chat_item_tos{}.

-type m_chat_item_toc() :: #m_chat_item_toc{}.

-type m_chat_off_msg_tos() :: #m_chat_off_msg_tos{}.
...
-export_type(['m_chat_channel_tos'/0, 'm_chat_channel_toc'/0, 'm_chat_item_tos'/0, 'm_chat_item_toc'/0, 'm_chat_off_msg_tos'/0, 'p_role_base'/0, 'p_aspect'/0, 'p_attr'/0, 'p_item_base'/0, 'p_item'/0, 'p_equip'/0, 'p_pet'/0, 'p_marriage'/0, 'p_refine'/0, 'p_actor'/0, 'p_role'/0, 'p_creep'/0, 'p_npc'/0, 'p_drop'/0, 'p_buff'/0, 'p_coord'/0, 'p_icon'/0, 'p_ranking'/0, 'p_dropped'/0]).

-spec encode_msg(#m_chat_channel_tos{} | #m_chat_channel_toc{} | #m_chat_item_tos{} | #m_chat_item_toc{} | #m_chat_off_msg_tos{} | #p_role_base{} | #p_aspect{} | #p_attr{} | #p_item_base{} | #p_item{} | #p_equip{} | #p_pet{} | #p_marriage{} | #p_refine{} | #p_actor{} | #p_role{} | #p_creep{} | #p_npc{} | #p_drop{} | #p_buff{} | #p_coord{} | #p_icon{} | #p_ranking{} | #p_dropped{}) -> binary().
encode_msg(Msg) when tuple_size(Msg) >= 1 ->
    encode_msg(Msg, element(1, Msg), []).

-spec encode_msg(#m_chat_channel_tos{} | #m_chat_channel_toc{} | #m_chat_item_tos{} | #m_chat_item_toc{} | #m_chat_off_msg_tos{} | #p_role_base{} | #p_aspect{} | #p_attr{} | #p_item_base{} | #p_item{} | #p_equip{} | #p_pet{} | #p_marriage{} | #p_refine{} | #p_actor{} | #p_role{} | #p_creep{} | #p_npc{} | #p_drop{} | #p_buff{} | #p_coord{} | #p_icon{} | #p_ranking{} | #p_dropped{}, atom() | list()) -> binary().
...
encode_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
      m_chat_channel_tos ->
	  encode_msg_m_chat_channel_tos(id(Msg, TrUserData),
					TrUserData);
      m_chat_channel_toc ->
	  encode_msg_m_chat_channel_toc(id(Msg, TrUserData),
					TrUserData);
      m_chat_item_tos ->
	  encode_msg_m_chat_item_tos(id(Msg, TrUserData),
				     TrUserData);
      m_chat_item_toc ->
	  encode_msg_m_chat_item_toc(id(Msg, TrUserData),
				     TrUserData);
      m_chat_off_msg_tos ->
	  encode_msg_m_chat_off_msg_tos(id(Msg, TrUserData),
					TrUserData);
      p_role_base ->
...
encode_msg_m_chat_channel_tos(Msg, TrUserData) ->
    encode_msg_m_chat_channel_tos(Msg, <<>>, TrUserData).


encode_msg_m_chat_channel_tos(#m_chat_channel_tos{channel_id
						      = F1,
						  type_id = F2, content = F3,
						  to_role_id = F4, uids = F5},
			      Bin, TrUserData) ->
    B1 = begin
    ...
    begin
      ...
      if TrF5 == [] -> B4;
	 true ->
	     e_field_m_chat_channel_tos_uids(TrF5, B4, TrUserData)
      end
    end.

encode_msg_m_chat_channel_toc(Msg, TrUserData) ->
    encode_msg_m_chat_channel_toc(Msg, <<>>, TrUserData).


encode_msg_m_chat_channel_toc(#m_chat_channel_toc{channel_id
						      = F1,
						  type_id = F2, content = F3,
						  sender = F4, to_role_id = F5,
						  ids = F6, show_type = F7,
						  scene = F8},
			      Bin, TrUserData) ->
    B1 = begin
    ...
    B4 = if F4 == undefined -> B3;
		...
		begin
		  TrF4 = id(F4, TrUserData),
		  e_mfield_m_chat_channel_toc_sender(TrF4,
						     <<B3/binary, 34>>,
						     TrUserData)
		end
	 end,
    ...
    B6 = begin
	   TrF6 = 'tr_encode_m_chat_channel_toc.ids'(F6,
						     TrUserData),
	   if TrF6 == [] -> B5;
	      true ->
		  e_field_m_chat_channel_toc_ids(TrF6, B5, TrUserData)
	   end
	 end,
...
encode_msg_m_chat_item_tos(Msg, TrUserData) ->
    encode_msg_m_chat_item_tos(Msg, <<>>, TrUserData).


encode_msg_m_chat_item_tos(#m_chat_item_tos{id = F1},
			   Bin, TrUserData) ->
    begin
      TrF1 = id(F1, TrUserData),
      e_type_int32(TrF1, <<Bin/binary, 8>>, TrUserData)
...
encode_msg_m_chat_item_toc(Msg, TrUserData) ->
    encode_msg_m_chat_item_toc(Msg, <<>>, TrUserData).


encode_msg_m_chat_item_toc(#m_chat_item_toc{item = F1},
			   Bin, TrUserData) ->
    begin
      TrF1 = id(F1, TrUserData),
      e_mfield_m_chat_item_toc_item(TrF1, <<Bin/binary, 10>>,
				    TrUserData)
    end.

encode_msg_m_chat_off_msg_tos(_Msg, _TrUserData) ->
    <<>>.
...
e_field_m_chat_channel_tos_uids([Elem | Rest], Bin,
				TrUserData) ->
    Bin2 = <<Bin/binary, 40>>,
    Bin3 = e_type_int32(id(Elem, TrUserData), Bin2,
			TrUserData),
    e_field_m_chat_channel_tos_uids(Rest, Bin3, TrUserData);
e_field_m_chat_channel_tos_uids([], Bin, _TrUserData) ->
    Bin.

e_mfield_m_chat_channel_toc_sender(Msg, Bin,
				   TrUserData) ->
    SubBin = encode_msg_p_role_base(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

e_mfield_m_chat_channel_toc_ids(Msg, Bin, TrUserData) ->
    SubBin = 'encode_msg_map<int32,int32>'(Msg, <<>>,
					   TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

e_field_m_chat_channel_toc_ids([Elem | Rest], Bin,
			       TrUserData) ->
    Bin2 = <<Bin/binary, 50>>,
    Bin3 =
	e_mfield_m_chat_channel_toc_ids('tr_encode_m_chat_channel_toc.ids[x]'(Elem,
									      TrUserData),
					Bin2, TrUserData),
    e_field_m_chat_channel_toc_ids(Rest, Bin3, TrUserData);
e_field_m_chat_channel_toc_ids([], Bin, _TrUserData) ->
    Bin.

e_mfield_m_chat_item_toc_item(Msg, Bin, TrUserData) ->
...
decode_msg_2_doit(m_chat_channel_tos, Bin,
		  TrUserData) ->
    id(decode_msg_m_chat_channel_tos(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_chat_channel_toc, Bin,
		  TrUserData) ->
    id(decode_msg_m_chat_channel_toc(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_chat_item_tos, Bin, TrUserData) ->
    id(decode_msg_m_chat_item_tos(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_chat_item_toc, Bin, TrUserData) ->
    id(decode_msg_m_chat_item_toc(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_chat_off_msg_tos, Bin,
		  TrUserData) ->
    id(decode_msg_m_chat_off_msg_tos(Bin, TrUserData),
       TrUserData);
...
decode_msg_m_chat_channel_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_chat_channel_tos(Bin, 0, 0,
...
dfp_read_field_def_m_chat_channel_tos(<<8,
					Rest/binary>>,
				      Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
				      TrUserData) ->
    d_field_m_chat_channel_tos_channel_id(Rest, Z1, Z2,
					  F@_1, F@_2, F@_3, F@_4, F@_5,
					  TrUserData);
dfp_read_field_def_m_chat_channel_tos(<<16,
					Rest/binary>>,
				      Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
				      TrUserData) ->
    d_field_m_chat_channel_tos_type_id(Rest, Z1, Z2, F@_1,
				       F@_2, F@_3, F@_4, F@_5, TrUserData);
dfp_read_field_def_m_chat_channel_tos(<<26,
					Rest/binary>>,
				      Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
				      TrUserData) ->
    d_field_m_chat_channel_tos_content(Rest, Z1, Z2, F@_1,
				       F@_2, F@_3, F@_4, F@_5, TrUserData);
dfp_read_field_def_m_chat_channel_tos(<<33,
					Rest/binary>>,
				      Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
				      TrUserData) ->
    d_field_m_chat_channel_tos_to_role_id(Rest, Z1, Z2,
					  F@_1, F@_2, F@_3, F@_4, F@_5,
					  TrUserData);
dfp_read_field_def_m_chat_channel_tos(<<42,
					Rest/binary>>,
				      Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
				      TrUserData) ->
    d_pfield_m_chat_channel_tos_uids(Rest, Z1, Z2, F@_1,
				     F@_2, F@_3, F@_4, F@_5, TrUserData);
dfp_read_field_def_m_chat_channel_tos(<<40,
					Rest/binary>>,
				      Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
				      TrUserData) ->
    d_field_m_chat_channel_tos_uids(Rest, Z1, Z2, F@_1,
				    F@_2, F@_3, F@_4, F@_5, TrUserData);
dfp_read_field_def_m_chat_channel_tos(<<>>, 0, 0, F@_1,
				      F@_2, F@_3, F@_4, R1, TrUserData) ->
    #m_chat_channel_tos{channel_id = F@_1, type_id = F@_2,
			content = F@_3, to_role_id = F@_4,
			uids = lists_reverse(R1, TrUserData)};
dfp_read_field_def_m_chat_channel_tos(Other, Z1, Z2,
				      F@_1, F@_2, F@_3, F@_4, F@_5,
				      TrUserData) ->
    dg_read_field_def_m_chat_channel_tos(Other, Z1, Z2,
					 F@_1, F@_2, F@_3, F@_4, F@_5,
					 TrUserData).

dg_read_field_def_m_chat_channel_tos(<<1:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
				     TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_chat_channel_tos(Rest, N + 7,
					 X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
					 F@_5, TrUserData);
dg_read_field_def_m_chat_channel_tos(<<0:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
				     TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_chat_channel_tos_channel_id(Rest, 0, 0, F@_1,
						F@_2, F@_3, F@_4, F@_5,
						TrUserData);
      16 ->
	  d_field_m_chat_channel_tos_type_id(Rest, 0, 0, F@_1,
					     F@_2, F@_3, F@_4, F@_5,
					     TrUserData);
      26 ->
	  d_field_m_chat_channel_tos_content(Rest, 0, 0, F@_1,
					     F@_2, F@_3, F@_4, F@_5,
					     TrUserData);
      33 ->
	  d_field_m_chat_channel_tos_to_role_id(Rest, 0, 0, F@_1,
						F@_2, F@_3, F@_4, F@_5,
						TrUserData);
      42 ->
	  d_pfield_m_chat_channel_tos_uids(Rest, 0, 0, F@_1, F@_2,
					   F@_3, F@_4, F@_5, TrUserData);
      40 ->
	  d_field_m_chat_channel_tos_uids(Rest, 0, 0, F@_1, F@_2,
					  F@_3, F@_4, F@_5, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_chat_channel_tos(Rest, 0, 0, F@_1, F@_2,
					       F@_3, F@_4, F@_5, TrUserData);
	    1 ->
		skip_64_m_chat_channel_tos(Rest, 0, 0, F@_1, F@_2, F@_3,
					   F@_4, F@_5, TrUserData);
	    2 ->
		skip_length_delimited_m_chat_channel_tos(Rest, 0, 0,
							 F@_1, F@_2, F@_3, F@_4,
							 F@_5, TrUserData);
	    3 ->
		skip_group_m_chat_channel_tos(Rest, Key bsr 3, 0, F@_1,
					      F@_2, F@_3, F@_4, F@_5,
					      TrUserData);
	    5 ->
		skip_32_m_chat_channel_tos(Rest, 0, 0, F@_1, F@_2, F@_3,
					   F@_4, F@_5, TrUserData)
	  end
    end;
dg_read_field_def_m_chat_channel_tos(<<>>, 0, 0, F@_1,
				     F@_2, F@_3, F@_4, R1, TrUserData) ->
    #m_chat_channel_tos{channel_id = F@_1, type_id = F@_2,
			content = F@_3, to_role_id = F@_4,
			uids = lists_reverse(R1, TrUserData)}.

d_field_m_chat_channel_tos_channel_id(<<1:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
				      TrUserData)
    when N < 57 ->
    d_field_m_chat_channel_tos_channel_id(Rest, N + 7,
					  X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
					  F@_5, TrUserData);
d_field_m_chat_channel_tos_channel_id(<<0:1, X:7,
					Rest/binary>>,
    ...
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    dfp_read_field_def_m_chat_channel_tos(RestF, 0, 0,
					  NewFValue, F@_2, F@_3, F@_4, F@_5,
					  TrUserData).

d_field_m_chat_channel_tos_type_id(<<1:1, X:7,
				     Rest/binary>>,
				   N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
				   TrUserData)
    when N < 57 ->
    d_field_m_chat_channel_tos_type_id(Rest, N + 7,
				       X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
				       F@_5, TrUserData);
d_field_m_chat_channel_tos_type_id(<<0:1, X:7,
				     Rest/binary>>,
    ...
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    dfp_read_field_def_m_chat_channel_tos(RestF, 0, 0, F@_1,
					  NewFValue, F@_3, F@_4, F@_5,
					  TrUserData).

d_field_m_chat_channel_tos_content(<<1:1, X:7,
				     Rest/binary>>,
				   N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
				   TrUserData)
    when N < 57 ->
    d_field_m_chat_channel_tos_content(Rest, N + 7,
				       X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
				       F@_5, TrUserData);
d_field_m_chat_channel_tos_content(<<0:1, X:7,
				     Rest/binary>>,
...
d_field_m_chat_channel_tos_to_role_id(<<Value:64/little,
					Rest/binary>>,
				      Z1, Z2, F@_1, F@_2, F@_3, _, F@_5,
				      TrUserData) ->
    dfp_read_field_def_m_chat_channel_tos(Rest, Z1, Z2,
					  F@_1, F@_2, F@_3,
					  id(Value, TrUserData), F@_5,
					  TrUserData).

d_field_m_chat_channel_tos_uids(<<1:1, X:7,
				  Rest/binary>>,
				N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
				TrUserData)
    when N < 57 ->
    d_field_m_chat_channel_tos_uids(Rest, N + 7,
				    X bsl N + Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
				    TrUserData);
d_field_m_chat_channel_tos_uids(<<0:1, X:7,
				  Rest/binary>>,
...
d_pfield_m_chat_channel_tos_uids(<<1:1, X:7,
				   Rest/binary>>,
				 N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
				 TrUserData)
    when N < 57 ->
    d_pfield_m_chat_channel_tos_uids(Rest, N + 7,
				     X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
				     F@_5, TrUserData);
d_pfield_m_chat_channel_tos_uids(<<0:1, X:7,
				   Rest/binary>>,
    ...
    NewSeq =
	d_packed_field_m_chat_channel_tos_uids(PackedBytes, 0,
					       0, E, TrUserData),
    dfp_read_field_def_m_chat_channel_tos(Rest2, 0, 0, F@_1,
					  F@_2, F@_3, F@_4, NewSeq, TrUserData).

d_packed_field_m_chat_channel_tos_uids(<<1:1, X:7,
					 Rest/binary>>,
				       N, Acc, AccSeq, TrUserData)
    when N < 57 ->
    d_packed_field_m_chat_channel_tos_uids(Rest, N + 7,
					   X bsl N + Acc, AccSeq, TrUserData);
d_packed_field_m_chat_channel_tos_uids(<<0:1, X:7,
					 Rest/binary>>,
				       N, Acc, AccSeq, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    d_packed_field_m_chat_channel_tos_uids(RestF, 0, 0,
					   [NewFValue | AccSeq], TrUserData);
d_packed_field_m_chat_channel_tos_uids(<<>>, 0, 0,
				       AccSeq, _) ->
    AccSeq.

skip_varint_m_chat_channel_tos(<<1:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
			       TrUserData) ->
    skip_varint_m_chat_channel_tos(Rest, Z1, Z2, F@_1, F@_2,
				   F@_3, F@_4, F@_5, TrUserData);
skip_varint_m_chat_channel_tos(<<0:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
			       TrUserData) ->
    dfp_read_field_def_m_chat_channel_tos(Rest, Z1, Z2,
...
skip_length_delimited_m_chat_channel_tos(<<1:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
					 TrUserData)
    when N < 57 ->
    skip_length_delimited_m_chat_channel_tos(Rest, N + 7,
					     X bsl N + Acc, F@_1, F@_2, F@_3,
					     F@_4, F@_5, TrUserData);
skip_length_delimited_m_chat_channel_tos(<<0:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
					 TrUserData) ->
    Length = X bsl N + Acc,
...
skip_group_m_chat_channel_tos(Bin, FNum, Z2, F@_1, F@_2,
			      F@_3, F@_4, F@_5, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_chat_channel_tos(Rest, 0, Z2, F@_1,
					  F@_2, F@_3, F@_4, F@_5, TrUserData).

skip_32_m_chat_channel_tos(<<_:32, Rest/binary>>, Z1,
			   Z2, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) ->
    dfp_read_field_def_m_chat_channel_tos(Rest, Z1, Z2,
					  F@_1, F@_2, F@_3, F@_4, F@_5,
					  TrUserData).

skip_64_m_chat_channel_tos(<<_:64, Rest/binary>>, Z1,
			   Z2, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) ->
    dfp_read_field_def_m_chat_channel_tos(Rest, Z1, Z2,
					  F@_1, F@_2, F@_3, F@_4, F@_5,
					  TrUserData).

decode_msg_m_chat_channel_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_chat_channel_toc(Bin, 0, 0,
					  id(undefined, TrUserData),
					  id(undefined, TrUserData),
					  id(undefined, TrUserData),
					  id(undefined, TrUserData),
					  id(undefined, TrUserData),
					  'tr_decode_init_default_m_chat_channel_toc.ids'([],
											  TrUserData),
					  id(undefined, TrUserData),
					  id(undefined, TrUserData),
					  TrUserData).

dfp_read_field_def_m_chat_channel_toc(<<8,
					Rest/binary>>,
				      Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
				      F@_6, F@_7, F@_8, TrUserData) ->
    d_field_m_chat_channel_toc_channel_id(Rest, Z1, Z2,
					  F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
					  F@_7, F@_8, TrUserData);
dfp_read_field_def_m_chat_channel_toc(<<16,
					Rest/binary>>,
				      Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
				      F@_6, F@_7, F@_8, TrUserData) ->
    d_field_m_chat_channel_toc_type_id(Rest, Z1, Z2, F@_1,
				       F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8,
				       TrUserData);
dfp_read_field_def_m_chat_channel_toc(<<26,
					Rest/binary>>,
				      Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
				      F@_6, F@_7, F@_8, TrUserData) ->
    d_field_m_chat_channel_toc_content(Rest, Z1, Z2, F@_1,
				       F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8,
				       TrUserData);
dfp_read_field_def_m_chat_channel_toc(<<34,
					Rest/binary>>,
				      Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
				      F@_6, F@_7, F@_8, TrUserData) ->
    d_field_m_chat_channel_toc_sender(Rest, Z1, Z2, F@_1,
				      F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8,
				      TrUserData);
dfp_read_field_def_m_chat_channel_toc(<<41,
					Rest/binary>>,
				      Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
				      F@_6, F@_7, F@_8, TrUserData) ->
    d_field_m_chat_channel_toc_to_role_id(Rest, Z1, Z2,
					  F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
					  F@_7, F@_8, TrUserData);
dfp_read_field_def_m_chat_channel_toc(<<50,
					Rest/binary>>,
				      Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
				      F@_6, F@_7, F@_8, TrUserData) ->
    d_field_m_chat_channel_toc_ids(Rest, Z1, Z2, F@_1, F@_2,
				   F@_3, F@_4, F@_5, F@_6, F@_7, F@_8,
				   TrUserData);
dfp_read_field_def_m_chat_channel_toc(<<56,
					Rest/binary>>,
				      Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
				      F@_6, F@_7, F@_8, TrUserData) ->
    d_field_m_chat_channel_toc_show_type(Rest, Z1, Z2, F@_1,
					 F@_2, F@_3, F@_4, F@_5, F@_6, F@_7,
					 F@_8, TrUserData);
dfp_read_field_def_m_chat_channel_toc(<<64,
					Rest/binary>>,
				      Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
				      F@_6, F@_7, F@_8, TrUserData) ->
    d_field_m_chat_channel_toc_scene(Rest, Z1, Z2, F@_1,
				     F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8,
				     TrUserData);
dfp_read_field_def_m_chat_channel_toc(<<>>, 0, 0, F@_1,
				      F@_2, F@_3, F@_4, F@_5, R1, F@_7, F@_8,
				      TrUserData) ->
    #m_chat_channel_toc{channel_id = F@_1, type_id = F@_2,
			content = F@_3, sender = F@_4, to_role_id = F@_5,
			ids =
			    'tr_decode_repeated_finalize_m_chat_channel_toc.ids'(R1,
										 TrUserData),
			show_type = F@_7, scene = F@_8};
dfp_read_field_def_m_chat_channel_toc(Other, Z1, Z2,
				      F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7,
				      F@_8, TrUserData) ->
    dg_read_field_def_m_chat_channel_toc(Other, Z1, Z2,
					 F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
					 F@_7, F@_8, TrUserData).

dg_read_field_def_m_chat_channel_toc(<<1:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
				     F@_7, F@_8, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_chat_channel_toc(Rest, N + 7,
					 X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
					 F@_5, F@_6, F@_7, F@_8, TrUserData);
dg_read_field_def_m_chat_channel_toc(<<0:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
				     F@_7, F@_8, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_chat_channel_toc_channel_id(Rest, 0, 0, F@_1,
						F@_2, F@_3, F@_4, F@_5, F@_6,
						F@_7, F@_8, TrUserData);
      16 ->
	  d_field_m_chat_channel_toc_type_id(Rest, 0, 0, F@_1,
					     F@_2, F@_3, F@_4, F@_5, F@_6, F@_7,
					     F@_8, TrUserData);
      26 ->
	  d_field_m_chat_channel_toc_content(Rest, 0, 0, F@_1,
					     F@_2, F@_3, F@_4, F@_5, F@_6, F@_7,
					     F@_8, TrUserData);
      34 ->
	  d_field_m_chat_channel_toc_sender(Rest, 0, 0, F@_1,
					    F@_2, F@_3, F@_4, F@_5, F@_6, F@_7,
					    F@_8, TrUserData);
      41 ->
	  d_field_m_chat_channel_toc_to_role_id(Rest, 0, 0, F@_1,
						F@_2, F@_3, F@_4, F@_5, F@_6,
						F@_7, F@_8, TrUserData);
      50 ->
	  d_field_m_chat_channel_toc_ids(Rest, 0, 0, F@_1, F@_2,
					 F@_3, F@_4, F@_5, F@_6, F@_7, F@_8,
					 TrUserData);
      56 ->
	  d_field_m_chat_channel_toc_show_type(Rest, 0, 0, F@_1,
					       F@_2, F@_3, F@_4, F@_5, F@_6,
					       F@_7, F@_8, TrUserData);
      64 ->
	  d_field_m_chat_channel_toc_scene(Rest, 0, 0, F@_1, F@_2,
					   F@_3, F@_4, F@_5, F@_6, F@_7, F@_8,
					   TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_chat_channel_toc(Rest, 0, 0, F@_1, F@_2,
					       F@_3, F@_4, F@_5, F@_6, F@_7,
					       F@_8, TrUserData);
	    1 ->
		skip_64_m_chat_channel_toc(Rest, 0, 0, F@_1, F@_2, F@_3,
					   F@_4, F@_5, F@_6, F@_7, F@_8,
					   TrUserData);
	    2 ->
		skip_length_delimited_m_chat_channel_toc(Rest, 0, 0,
							 F@_1, F@_2, F@_3, F@_4,
							 F@_5, F@_6, F@_7, F@_8,
							 TrUserData);
	    3 ->
		skip_group_m_chat_channel_toc(Rest, Key bsr 3, 0, F@_1,
					      F@_2, F@_3, F@_4, F@_5, F@_6,
					      F@_7, F@_8, TrUserData);
	    5 ->
		skip_32_m_chat_channel_toc(Rest, 0, 0, F@_1, F@_2, F@_3,
					   F@_4, F@_5, F@_6, F@_7, F@_8,
					   TrUserData)
	  end
    end;
dg_read_field_def_m_chat_channel_toc(<<>>, 0, 0, F@_1,
				     F@_2, F@_3, F@_4, F@_5, R1, F@_7, F@_8,
				     TrUserData) ->
    #m_chat_channel_toc{channel_id = F@_1, type_id = F@_2,
			content = F@_3, sender = F@_4, to_role_id = F@_5,
...
d_field_m_chat_channel_toc_channel_id(<<1:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
				      F@_6, F@_7, F@_8, TrUserData)
    when N < 57 ->
    d_field_m_chat_channel_toc_channel_id(Rest, N + 7,
					  X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
					  F@_5, F@_6, F@_7, F@_8, TrUserData);
d_field_m_chat_channel_toc_channel_id(<<0:1, X:7,
					Rest/binary>>,
    ...
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    dfp_read_field_def_m_chat_channel_toc(RestF, 0, 0,
					  NewFValue, F@_2, F@_3, F@_4, F@_5,
					  F@_6, F@_7, F@_8, TrUserData).

d_field_m_chat_channel_toc_type_id(<<1:1, X:7,
				     Rest/binary>>,
				   N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
				   F@_7, F@_8, TrUserData)
    when N < 57 ->
    d_field_m_chat_channel_toc_type_id(Rest, N + 7,
				       X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
				       F@_5, F@_6, F@_7, F@_8, TrUserData);
d_field_m_chat_channel_toc_type_id(<<0:1, X:7,
				     Rest/binary>>,
    ...
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    dfp_read_field_def_m_chat_channel_toc(RestF, 0, 0, F@_1,
					  NewFValue, F@_3, F@_4, F@_5, F@_6,
					  F@_7, F@_8, TrUserData).

d_field_m_chat_channel_toc_content(<<1:1, X:7,
				     Rest/binary>>,
				   N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
				   F@_7, F@_8, TrUserData)
    when N < 57 ->
    d_field_m_chat_channel_toc_content(Rest, N + 7,
				       X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
				       F@_5, F@_6, F@_7, F@_8, TrUserData);
d_field_m_chat_channel_toc_content(<<0:1, X:7,
				     Rest/binary>>,
...
d_field_m_chat_channel_toc_sender(<<1:1, X:7,
				    Rest/binary>>,
				  N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
				  F@_7, F@_8, TrUserData)
    when N < 57 ->
    d_field_m_chat_channel_toc_sender(Rest, N + 7,
				      X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
				      F@_5, F@_6, F@_7, F@_8, TrUserData);
d_field_m_chat_channel_toc_sender(<<0:1, X:7,
				    Rest/binary>>,
...
d_field_m_chat_channel_toc_to_role_id(<<Value:64/little,
					Rest/binary>>,
				      Z1, Z2, F@_1, F@_2, F@_3, F@_4, _, F@_6,
				      F@_7, F@_8, TrUserData) ->
    dfp_read_field_def_m_chat_channel_toc(Rest, Z1, Z2,
					  F@_1, F@_2, F@_3, F@_4,
					  id(Value, TrUserData), F@_6, F@_7,
					  F@_8, TrUserData).

d_field_m_chat_channel_toc_ids(<<1:1, X:7,
				 Rest/binary>>,
			       N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7,
			       F@_8, TrUserData)
    when N < 57 ->
    d_field_m_chat_channel_toc_ids(Rest, N + 7,
				   X bsl N + Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
				   F@_6, F@_7, F@_8, TrUserData);
d_field_m_chat_channel_toc_ids(<<0:1, X:7,
				 Rest/binary>>,
    ...
    dfp_read_field_def_m_chat_channel_toc(RestF, 0, 0, F@_1,
					  F@_2, F@_3, F@_4, F@_5,
					  'tr_decode_repeated_add_elem_m_chat_channel_toc.ids'(NewFValue,
											       Prev,
											       TrUserData),
					  F@_7, F@_8, TrUserData).

d_field_m_chat_channel_toc_show_type(<<1:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
				     F@_7, F@_8, TrUserData)
    when N < 57 ->
    d_field_m_chat_channel_toc_show_type(Rest, N + 7,
					 X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
					 F@_5, F@_6, F@_7, F@_8, TrUserData);
d_field_m_chat_channel_toc_show_type(<<0:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
				     _, F@_8, TrUserData) ->
    {NewFValue, RestF} = {begin
...
d_field_m_chat_channel_toc_scene(<<1:1, X:7,
				   Rest/binary>>,
				 N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
				 F@_7, F@_8, TrUserData)
    when N < 57 ->
    d_field_m_chat_channel_toc_scene(Rest, N + 7,
				     X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
				     F@_5, F@_6, F@_7, F@_8, TrUserData);
d_field_m_chat_channel_toc_scene(<<0:1, X:7,
				   Rest/binary>>,
				 N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
				 F@_7, _, TrUserData) ->
    {NewFValue, RestF} = {begin
...
skip_varint_m_chat_channel_toc(<<1:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7,
			       F@_8, TrUserData) ->
    skip_varint_m_chat_channel_toc(Rest, Z1, Z2, F@_1, F@_2,
				   F@_3, F@_4, F@_5, F@_6, F@_7, F@_8,
				   TrUserData);
skip_varint_m_chat_channel_toc(<<0:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7,
			       F@_8, TrUserData) ->
    dfp_read_field_def_m_chat_channel_toc(Rest, Z1, Z2,
...
skip_length_delimited_m_chat_channel_toc(<<1:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
					 F@_6, F@_7, F@_8, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_chat_channel_toc(Rest, N + 7,
					     X bsl N + Acc, F@_1, F@_2, F@_3,
					     F@_4, F@_5, F@_6, F@_7, F@_8,
					     TrUserData);
skip_length_delimited_m_chat_channel_toc(<<0:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
					 F@_6, F@_7, F@_8, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_chat_channel_toc(Rest2, 0, 0, F@_1,
					  F@_2, F@_3, F@_4, F@_5, F@_6, F@_7,
					  F@_8, TrUserData).

skip_group_m_chat_channel_toc(Bin, FNum, Z2, F@_1, F@_2,
			      F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_chat_channel_toc(Rest, 0, Z2, F@_1,
					  F@_2, F@_3, F@_4, F@_5, F@_6, F@_7,
					  F@_8, TrUserData).

skip_32_m_chat_channel_toc(<<_:32, Rest/binary>>, Z1,
...
skip_64_m_chat_channel_toc(<<_:64, Rest/binary>>, Z1,
			   Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8,
			   TrUserData) ->
    dfp_read_field_def_m_chat_channel_toc(Rest, Z1, Z2,
					  F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
...
decode_msg_m_chat_item_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_chat_item_tos(Bin, 0, 0,
				       id(undefined, TrUserData), TrUserData).

dfp_read_field_def_m_chat_item_tos(<<8, Rest/binary>>,
				   Z1, Z2, F@_1, TrUserData) ->
    d_field_m_chat_item_tos_id(Rest, Z1, Z2, F@_1,
			       TrUserData);
dfp_read_field_def_m_chat_item_tos(<<>>, 0, 0, F@_1,
				   _) ->
    #m_chat_item_tos{id = F@_1};
dfp_read_field_def_m_chat_item_tos(Other, Z1, Z2, F@_1,
				   TrUserData) ->
    dg_read_field_def_m_chat_item_tos(Other, Z1, Z2, F@_1,
				      TrUserData).

dg_read_field_def_m_chat_item_tos(<<1:1, X:7,
				    Rest/binary>>,
				  N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_chat_item_tos(Rest, N + 7,
				      X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_m_chat_item_tos(<<0:1, X:7,
				    Rest/binary>>,
				  N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_chat_item_tos_id(Rest, 0, 0, F@_1,
				     TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_chat_item_tos(Rest, 0, 0, F@_1,
					    TrUserData);
	    1 ->
		skip_64_m_chat_item_tos(Rest, 0, 0, F@_1, TrUserData);
	    2 ->
		skip_length_delimited_m_chat_item_tos(Rest, 0, 0, F@_1,
						      TrUserData);
	    3 ->
		skip_group_m_chat_item_tos(Rest, Key bsr 3, 0, F@_1,
					   TrUserData);
	    5 ->
		skip_32_m_chat_item_tos(Rest, 0, 0, F@_1, TrUserData)
	  end
    end;
dg_read_field_def_m_chat_item_tos(<<>>, 0, 0, F@_1,
				  _) ->
    #m_chat_item_tos{id = F@_1}.

d_field_m_chat_item_tos_id(<<1:1, X:7, Rest/binary>>, N,
			   Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_m_chat_item_tos_id(Rest, N + 7, X bsl N + Acc,
			       F@_1, TrUserData);
d_field_m_chat_item_tos_id(<<0:1, X:7, Rest/binary>>, N,
			   Acc, _, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
							    Acc):32/unsigned-native>>,
			  ...
			  Rest},
    dfp_read_field_def_m_chat_item_tos(RestF, 0, 0,
				       NewFValue, TrUserData).

skip_varint_m_chat_item_tos(<<1:1, _:7, Rest/binary>>,
			    Z1, Z2, F@_1, TrUserData) ->
    skip_varint_m_chat_item_tos(Rest, Z1, Z2, F@_1,
				TrUserData);
skip_varint_m_chat_item_tos(<<0:1, _:7, Rest/binary>>,
			    Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_chat_item_tos(Rest, Z1, Z2, F@_1,
				       TrUserData).

skip_length_delimited_m_chat_item_tos(<<1:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_chat_item_tos(Rest, N + 7,
					  X bsl N + Acc, F@_1, TrUserData);
skip_length_delimited_m_chat_item_tos(<<0:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_chat_item_tos(Rest2, 0, 0, F@_1,
				       TrUserData).

skip_group_m_chat_item_tos(Bin, FNum, Z2, F@_1,
			   TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_chat_item_tos(Rest, 0, Z2, F@_1,
				       TrUserData).

skip_32_m_chat_item_tos(<<_:32, Rest/binary>>, Z1, Z2,
			F@_1, TrUserData) ->
    dfp_read_field_def_m_chat_item_tos(Rest, Z1, Z2, F@_1,
				       TrUserData).

skip_64_m_chat_item_tos(<<_:64, Rest/binary>>, Z1, Z2,
			F@_1, TrUserData) ->
    dfp_read_field_def_m_chat_item_tos(Rest, Z1, Z2, F@_1,
				       TrUserData).

decode_msg_m_chat_item_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_chat_item_toc(Bin, 0, 0,
				       id(undefined, TrUserData), TrUserData).

dfp_read_field_def_m_chat_item_toc(<<10, Rest/binary>>,
				   Z1, Z2, F@_1, TrUserData) ->
    d_field_m_chat_item_toc_item(Rest, Z1, Z2, F@_1,
				 TrUserData);
dfp_read_field_def_m_chat_item_toc(<<>>, 0, 0, F@_1,
				   _) ->
    #m_chat_item_toc{item = F@_1};
dfp_read_field_def_m_chat_item_toc(Other, Z1, Z2, F@_1,
				   TrUserData) ->
    dg_read_field_def_m_chat_item_toc(Other, Z1, Z2, F@_1,
				      TrUserData).

dg_read_field_def_m_chat_item_toc(<<1:1, X:7,
				    Rest/binary>>,
				  N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_chat_item_toc(Rest, N + 7,
				      X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_m_chat_item_toc(<<0:1, X:7,
				    Rest/binary>>,
				  N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      10 ->
	  d_field_m_chat_item_toc_item(Rest, 0, 0, F@_1,
				       TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_chat_item_toc(Rest, 0, 0, F@_1,
					    TrUserData);
	    1 ->
		skip_64_m_chat_item_toc(Rest, 0, 0, F@_1, TrUserData);
	    2 ->
		skip_length_delimited_m_chat_item_toc(Rest, 0, 0, F@_1,
						      TrUserData);
	    3 ->
		skip_group_m_chat_item_toc(Rest, Key bsr 3, 0, F@_1,
					   TrUserData);
	    5 ->
		skip_32_m_chat_item_toc(Rest, 0, 0, F@_1, TrUserData)
	  end
    end;
dg_read_field_def_m_chat_item_toc(<<>>, 0, 0, F@_1,
				  _) ->
    #m_chat_item_toc{item = F@_1}.

d_field_m_chat_item_toc_item(<<1:1, X:7, Rest/binary>>,
			     N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_m_chat_item_toc_item(Rest, N + 7, X bsl N + Acc,
				 F@_1, TrUserData);
d_field_m_chat_item_toc_item(<<0:1, X:7, Rest/binary>>,
    ...
    dfp_read_field_def_m_chat_item_toc(RestF, 0, 0,
				       if Prev == undefined -> NewFValue;
					  true ->
...
skip_varint_m_chat_item_toc(<<1:1, _:7, Rest/binary>>,
			    Z1, Z2, F@_1, TrUserData) ->
    skip_varint_m_chat_item_toc(Rest, Z1, Z2, F@_1,
				TrUserData);
skip_varint_m_chat_item_toc(<<0:1, _:7, Rest/binary>>,
			    Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_chat_item_toc(Rest, Z1, Z2, F@_1,
				       TrUserData).

skip_length_delimited_m_chat_item_toc(<<1:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_chat_item_toc(Rest, N + 7,
					  X bsl N + Acc, F@_1, TrUserData);
skip_length_delimited_m_chat_item_toc(<<0:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_chat_item_toc(Rest2, 0, 0, F@_1,
				       TrUserData).

skip_group_m_chat_item_toc(Bin, FNum, Z2, F@_1,
			   TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_chat_item_toc(Rest, 0, Z2, F@_1,
				       TrUserData).

skip_32_m_chat_item_toc(<<_:32, Rest/binary>>, Z1, Z2,
			F@_1, TrUserData) ->
    dfp_read_field_def_m_chat_item_toc(Rest, Z1, Z2, F@_1,
				       TrUserData).

skip_64_m_chat_item_toc(<<_:64, Rest/binary>>, Z1, Z2,
			F@_1, TrUserData) ->
    dfp_read_field_def_m_chat_item_toc(Rest, Z1, Z2, F@_1,
				       TrUserData).

decode_msg_m_chat_off_msg_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_chat_off_msg_tos(Bin, 0, 0,
					  TrUserData).

dfp_read_field_def_m_chat_off_msg_tos(<<>>, 0, 0, _) ->
    #m_chat_off_msg_tos{};
dfp_read_field_def_m_chat_off_msg_tos(Other, Z1, Z2,
				      TrUserData) ->
    dg_read_field_def_m_chat_off_msg_tos(Other, Z1, Z2,
					 TrUserData).

dg_read_field_def_m_chat_off_msg_tos(<<1:1, X:7,
				       Rest/binary>>,
				     N, Acc, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_chat_off_msg_tos(Rest, N + 7,
					 X bsl N + Acc, TrUserData);
dg_read_field_def_m_chat_off_msg_tos(<<0:1, X:7,
				       Rest/binary>>,
				     N, Acc, TrUserData) ->
    Key = X bsl N + Acc,
    case Key band 7 of
      0 ->
	  skip_varint_m_chat_off_msg_tos(Rest, 0, 0, TrUserData);
      1 -> skip_64_m_chat_off_msg_tos(Rest, 0, 0, TrUserData);
      2 ->
	  skip_length_delimited_m_chat_off_msg_tos(Rest, 0, 0,
						   TrUserData);
      3 ->
	  skip_group_m_chat_off_msg_tos(Rest, Key bsr 3, 0,
					TrUserData);
      5 -> skip_32_m_chat_off_msg_tos(Rest, 0, 0, TrUserData)
    end;
dg_read_field_def_m_chat_off_msg_tos(<<>>, 0, 0, _) ->
    #m_chat_off_msg_tos{}.

skip_varint_m_chat_off_msg_tos(<<1:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, TrUserData) ->
    skip_varint_m_chat_off_msg_tos(Rest, Z1, Z2,
				   TrUserData);
skip_varint_m_chat_off_msg_tos(<<0:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, TrUserData) ->
    dfp_read_field_def_m_chat_off_msg_tos(Rest, Z1, Z2,
					  TrUserData).

skip_length_delimited_m_chat_off_msg_tos(<<1:1, X:7,
					   Rest/binary>>,
					 N, Acc, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_chat_off_msg_tos(Rest, N + 7,
					     X bsl N + Acc, TrUserData);
skip_length_delimited_m_chat_off_msg_tos(<<0:1, X:7,
					   Rest/binary>>,
					 N, Acc, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_chat_off_msg_tos(Rest2, 0, 0,
					  TrUserData).

skip_group_m_chat_off_msg_tos(Bin, FNum, Z2,
			      TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_chat_off_msg_tos(Rest, 0, Z2,
					  TrUserData).

skip_32_m_chat_off_msg_tos(<<_:32, Rest/binary>>, Z1,
			   Z2, TrUserData) ->
    dfp_read_field_def_m_chat_off_msg_tos(Rest, Z1, Z2,
					  TrUserData).

skip_64_m_chat_off_msg_tos(<<_:64, Rest/binary>>, Z1,
			   Z2, TrUserData) ->
    dfp_read_field_def_m_chat_off_msg_tos(Rest, Z1, Z2,
					  TrUserData).
...
merge_msgs(Prev, New, MsgName, Opts) ->
    ...
    case MsgName of
      m_chat_channel_tos ->
	  merge_msg_m_chat_channel_tos(Prev, New, TrUserData);
      m_chat_channel_toc ->
	  merge_msg_m_chat_channel_toc(Prev, New, TrUserData);
      m_chat_item_tos ->
	  merge_msg_m_chat_item_tos(Prev, New, TrUserData);
      m_chat_item_toc ->
	  merge_msg_m_chat_item_toc(Prev, New, TrUserData);
      m_chat_off_msg_tos ->
	  merge_msg_m_chat_off_msg_tos(Prev, New, TrUserData);
      p_role_base ->
...
-compile({nowarn_unused_function,merge_msg_m_chat_channel_tos/3}).
merge_msg_m_chat_channel_tos(#m_chat_channel_tos{to_role_id
						     = PFto_role_id,
						 uids = PFuids},
			     #m_chat_channel_tos{channel_id = NFchannel_id,
						 type_id = NFtype_id,
						 content = NFcontent,
						 to_role_id = NFto_role_id,
						 uids = NFuids},
			     TrUserData) ->
    #m_chat_channel_tos{channel_id = NFchannel_id,
			type_id = NFtype_id, content = NFcontent,
			to_role_id =
			    if NFto_role_id =:= undefined -> PFto_role_id;
			       true -> NFto_role_id
			    end,
			uids =
...
-compile({nowarn_unused_function,merge_msg_m_chat_channel_toc/3}).
merge_msg_m_chat_channel_toc(#m_chat_channel_toc{type_id
						     = PFtype_id,
						 sender = PFsender,
						 to_role_id = PFto_role_id,
						 ids = PFids,
						 show_type = PFshow_type,
						 scene = PFscene},
			     #m_chat_channel_toc{channel_id = NFchannel_id,
						 type_id = NFtype_id,
						 content = NFcontent,
						 sender = NFsender,
						 to_role_id = NFto_role_id,
						 ids = NFids,
						 show_type = NFshow_type,
						 scene = NFscene},
			     TrUserData) ->
    #m_chat_channel_toc{channel_id = NFchannel_id,
			type_id =
			    if NFtype_id =:= undefined -> PFtype_id;
			       true -> NFtype_id
			    end,
			content = NFcontent,
			sender =
			    if PFsender /= undefined, NFsender /= undefined ->
				   merge_msg_p_role_base(PFsender, NFsender,
							 TrUserData);
			       PFsender == undefined -> NFsender;
			       NFsender == undefined -> PFsender
			    end,
			to_role_id =
			    if NFto_role_id =:= undefined -> PFto_role_id;
			       true -> NFto_role_id
			...
			ids =
			    if PFids /= undefined, NFids /= undefined ->
				   'tr_merge_m_chat_channel_toc.ids'(PFids,
								     NFids,
								     TrUserData);
			...
			show_type =
			    if NFshow_type =:= undefined -> PFshow_type;
			       true -> NFshow_type
			    end,
			scene =
			    if NFscene =:= undefined -> PFscene;
			       true -> NFscene
			    end}.

-compile({nowarn_unused_function,merge_msg_m_chat_item_tos/3}).
merge_msg_m_chat_item_tos(#m_chat_item_tos{},
			  #m_chat_item_tos{id = NFid}, _) ->
    #m_chat_item_tos{id = NFid}.

-compile({nowarn_unused_function,merge_msg_m_chat_item_toc/3}).
merge_msg_m_chat_item_toc(#m_chat_item_toc{item =
					       PFitem},
			  #m_chat_item_toc{item = NFitem}, TrUserData) ->
    #m_chat_item_toc{item =
			 merge_msg_p_item(PFitem, NFitem, TrUserData)}.

-compile({nowarn_unused_function,merge_msg_m_chat_off_msg_tos/3}).
merge_msg_m_chat_off_msg_tos(_Prev, New, _TrUserData) ->
    New.
...
verify_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
      m_chat_channel_tos ->
	  v_msg_m_chat_channel_tos(Msg, [MsgName], TrUserData);
      m_chat_channel_toc ->
	  v_msg_m_chat_channel_toc(Msg, [MsgName], TrUserData);
      m_chat_item_tos ->
	  v_msg_m_chat_item_tos(Msg, [MsgName], TrUserData);
      m_chat_item_toc ->
	  v_msg_m_chat_item_toc(Msg, [MsgName], TrUserData);
      m_chat_off_msg_tos ->
	  v_msg_m_chat_off_msg_tos(Msg, [MsgName], TrUserData);
      p_role_base ->
...
-compile({nowarn_unused_function,v_msg_m_chat_channel_tos/3}).
-dialyzer({nowarn_function,v_msg_m_chat_channel_tos/3}).
v_msg_m_chat_channel_tos(#m_chat_channel_tos{channel_id
						 = F1,
					     type_id = F2, content = F3,
					     to_role_id = F4, uids = F5},
			 Path, TrUserData) ->
    v_type_int32(F1, [channel_id | Path], TrUserData),
    v_type_int32(F2, [type_id | Path], TrUserData),
    v_type_string(F3, [content | Path], TrUserData),
    if F4 == undefined -> ok;
       true ->
	   v_type_fixed64(F4, [to_role_id | Path], TrUserData)
    end,
    if is_list(F5) ->
    ...
    ok;
v_msg_m_chat_channel_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_chat_channel_tos}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_chat_channel_toc/3}).
-dialyzer({nowarn_function,v_msg_m_chat_channel_toc/3}).
v_msg_m_chat_channel_toc(#m_chat_channel_toc{channel_id
						 = F1,
					     type_id = F2, content = F3,
					     sender = F4, to_role_id = F5,
					     ids = F6, show_type = F7,
    ...
    v_type_int32(F1, [channel_id | Path], TrUserData),
    if F2 == undefined -> ok;
       true -> v_type_int32(F2, [type_id | Path], TrUserData)
    end,
    v_type_string(F3, [content | Path], TrUserData),
    if F4 == undefined -> ok;
       true ->
	   v_msg_p_role_base(F4, [sender | Path], TrUserData)
    end,
    if F5 == undefined -> ok;
       true ->
	   v_type_fixed64(F5, [to_role_id | Path], TrUserData)
    end,
    'v_map<int32,int32>'(F6, [ids | Path], TrUserData),
    if F7 == undefined -> ok;
       true -> v_type_int32(F7, [show_type | Path], TrUserData)
    end,
    if F8 == undefined -> ok;
       true -> v_type_int32(F8, [scene | Path], TrUserData)
    end,
    ok;
v_msg_m_chat_channel_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_chat_channel_toc}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_chat_item_tos/3}).
-dialyzer({nowarn_function,v_msg_m_chat_item_tos/3}).
v_msg_m_chat_item_tos(#m_chat_item_tos{id = F1}, Path,
		      TrUserData) ->
    v_type_int32(F1, [id | Path], TrUserData), ok;
v_msg_m_chat_item_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_chat_item_tos}, X, Path).

-compile({nowarn_unused_function,v_msg_m_chat_item_toc/3}).
-dialyzer({nowarn_function,v_msg_m_chat_item_toc/3}).
v_msg_m_chat_item_toc(#m_chat_item_toc{item = F1}, Path,
		      TrUserData) ->
    v_msg_p_item(F1, [item | Path], TrUserData), ok;
v_msg_m_chat_item_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_chat_item_toc}, X, Path).

-compile({nowarn_unused_function,v_msg_m_chat_off_msg_tos/3}).
-dialyzer({nowarn_function,v_msg_m_chat_off_msg_tos/3}).
v_msg_m_chat_off_msg_tos(#m_chat_off_msg_tos{}, _Path,
			 _) ->
    ok;
v_msg_m_chat_off_msg_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_chat_off_msg_tos}, X,
		  Path).
...
-compile({inline,'tr_encode_m_chat_channel_toc.ids[x]'/2}).
'tr_encode_m_chat_channel_toc.ids[x]'(X, _) ->
...
-compile({inline,'tr_decode_init_default_m_chat_channel_toc.ids'/2}).
'tr_decode_init_default_m_chat_channel_toc.ids'(_, _) ->
    mt_empty_map_m().

-compile({inline,'tr_merge_m_chat_channel_toc.ids'/3}).
'tr_merge_m_chat_channel_toc.ids'(X1, X2, _) ->
    mt_merge_maps_m(X1, X2).

-compile({inline,'tr_decode_repeated_finalize_m_chat_channel_toc.ids'/2}).
'tr_decode_repeated_finalize_m_chat_channel_toc.ids'(L,
						     TrUserData) ->
    id(L, TrUserData).

-compile({inline,'tr_encode_m_chat_channel_toc.ids'/2}).
'tr_encode_m_chat_channel_toc.ids'(X, _) ->
    mt_map_to_list_m(X).

-compile({inline,'tr_decode_repeated_add_elem_m_chat_channel_toc.ids'/3}).
'tr_decode_repeated_add_elem_m_chat_channel_toc.ids'(Elem,
						     L, _) ->
    mt_add_item_m(Elem, L).
...
get_msg_defs() ->
    [{{msg, m_chat_channel_tos},
      [#field{name = channel_id, fnum = 1, rnum = 2,
       ...
       #field{name = to_role_id, fnum = 4, rnum = 5,
	      type = fixed64, occurrence = optional, opts = []},
       #field{name = uids, fnum = 5, rnum = 6, type = int32,
	      occurrence = repeated, opts = []}]},
     {{msg, m_chat_channel_toc},
      [#field{name = channel_id, fnum = 1, rnum = 2,
	      type = int32, occurrence = required, opts = []},
       #field{name = type_id, fnum = 2, rnum = 3, type = int32,
       ...
       #field{name = content, fnum = 3, rnum = 4,
	      type = string, occurrence = required, opts = []},
       #field{name = sender, fnum = 4, rnum = 5,
	      type = {msg, p_role_base}, occurrence = optional,
	      opts = []},
       #field{name = to_role_id, fnum = 5, rnum = 6,
	      type = fixed64, occurrence = optional, opts = []},
       #field{name = ids, fnum = 6, rnum = 7,
	      type = {map, int32, int32}, occurrence = repeated,
	      opts = []},
       #field{name = show_type, fnum = 7, rnum = 8,
	      type = int32, occurrence = optional, opts = []},
       #field{name = scene, fnum = 8, rnum = 9, type = int32,
	      occurrence = optional, opts = []}]},
     {{msg, m_chat_item_tos},
...
get_msg_names() ->
    [m_chat_channel_tos, m_chat_channel_toc,
     m_chat_item_tos, m_chat_item_toc, m_chat_off_msg_tos,
...
find_msg_def(m_chat_channel_tos) ->
    [#field{name = channel_id, fnum = 1, rnum = 2,
	    type = int32, occurrence = required, opts = []},
     #field{name = type_id, fnum = 2, rnum = 3, type = int32,
	    occurrence = required, opts = []},
     ...
     #field{name = uids, fnum = 5, rnum = 6, type = int32,
	    occurrence = repeated, opts = []}];
find_msg_def(m_chat_channel_toc) ->
    [#field{name = channel_id, fnum = 1, rnum = 2,
	    type = int32, occurrence = required, opts = []},
     #field{name = type_id, fnum = 2, rnum = 3, type = int32,
	    occurrence = optional, opts = []},
     ...
     #field{name = scene, fnum = 8, rnum = 9, type = int32,
	    occurrence = optional, opts = []}];
find_msg_def(m_chat_item_tos) ->
    [#field{name = id, fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []}];
find_msg_def(m_chat_item_toc) ->
    [#field{name = item, fnum = 1, rnum = 2,
	    type = {msg, p_item}, occurrence = required,
	    opts = []}];
find_msg_def(m_chat_off_msg_tos) -> [];
