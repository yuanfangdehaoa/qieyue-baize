...
-define(pb_comm_gpb_version, "4.5.1").
...
-record(p_role_base,
        {id                     :: non_neg_integer(), % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_comm:p_aspect()} | undefined, % = 8
         ...
         icon                   :: pb_comm:p_icon() | undefined, % = 17
...
-record(p_item,
        {uid                    :: integer(),       % = 1, 32 bits
         ...
         gender                 :: integer(),       % = 7, 32 bits
         score                  :: integer() | undefined, % = 8, 32 bits
         equip                  :: pb_comm:p_equip() | undefined, % = 9
         pet                    :: pb_comm:p_pet() | undefined, % = 10
...
-record(p_equip,
        {base                   :: pb_comm:p_attr(), % = 1
         rare1                  :: pb_comm:p_attr() | undefined, % = 2
         rare2                  :: pb_comm:p_attr() | undefined, % = 3
         rare3                  :: pb_comm:p_attr() | undefined, % = 4
         marriage               :: pb_comm:p_marriage() | undefined, % = 5
         ...
         refine = []            :: [pb_comm:p_refine()] | undefined, % = 11
         suite = #{}            :: #{integer() := integer()} | undefined, % = 12
         combine = []           :: [pb_comm:p_item()] | undefined % = 13
        }).
-endif.
...
-record(p_marriage,
        {husband_id             :: non_neg_integer() | undefined, % = 1, 32 bits
         ...
         rare                   :: pb_comm:p_attr() | undefined % = 5
        }).
-endif.
...
-record(p_actor,
        {uid                    :: non_neg_integer(), % = 1, 32 bits
         ...
         coord                  :: pb_comm:p_coord(), % = 4
         state                  :: integer(),       % = 5, 32 bits
         stargs = #{}           :: #{integer() := iolist()} | undefined, % = 6
         role                   :: pb_comm:p_role() | undefined, % = 7
         creep                  :: pb_comm:p_creep() | undefined, % = 8
         drop                   :: pb_comm:p_drop() | undefined % = 9
        }).
-endif.
...
-record(p_role,
        {career                 :: integer(),       % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_comm:p_aspect()} | undefined, % = 5
         ...
         icon                   :: pb_comm:p_icon() | undefined % = 25
        }).
-endif.
...
-record(p_creep,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         buffs = []             :: [pb_comm:p_buff()] | undefined, % = 6
         dir                    :: integer(),       % = 7, 32 bits
         dest                   :: pb_comm:p_coord(), % = 8
...
-record(p_drop,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         coord                  :: pb_comm:p_coord() | undefined, % = 5
...
-record(p_ranking,
        {base                   :: pb_comm:p_role_base() | undefined, % = 1
