...
-ifndef(pb_1200_scene).
-define(pb_1200_scene, true).

-define(pb_1200_scene_gpb_version, "4.5.1").

-ifndef('M_SCENE_CHANGE_TOS_PB_H').
-define('M_SCENE_CHANGE_TOS_PB_H', true).
-record(m_scene_change_tos,
        {scene                  :: integer(),       % = 1, 32 bits
         type                   :: integer(),       % = 2, 32 bits
         coord                  :: pb_1200_scene:p_coord() | undefined, % = 3
         portal                 :: integer() | undefined, % = 4, 32 bits
         act_id                 :: integer() | undefined % = 5, 32 bits
        }).
-endif.

-ifndef('M_SCENE_CHANGE_TOC_PB_H').
-define('M_SCENE_CHANGE_TOC_PB_H', true).
-record(m_scene_change_toc,
        {scene                  :: integer(),       % = 1, 32 bits
         line                   :: integer(),       % = 2, 32 bits
         actor                  :: pb_1200_scene:p_actor(), % = 3
         actors = []            :: [pb_1200_scene:p_actor()] | undefined, % = 4
         lines = []             :: [pb_1200_scene:p_line()] | undefined, % = 5
         type                   :: integer(),       % = 6, 32 bits
         relogin                :: boolean() | 0 | 1 % = 7
        }).
-endif.

-ifndef('M_SCENE_LEAVE_TOS_PB_H').
-define('M_SCENE_LEAVE_TOS_PB_H', true).
-record(m_scene_leave_tos,
        {mchunt = false         :: boolean() | 0 | 1 | undefined % = 1
        }).
-endif.

-ifndef('M_SCENE_LEAVE_TOC_PB_H').
-define('M_SCENE_LEAVE_TOC_PB_H', true).
-record(m_scene_leave_toc,
        {scene                  :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_SCENE_SWITCH_TOS_PB_H').
-define('M_SCENE_SWITCH_TOS_PB_H', true).
-record(m_scene_switch_tos,
        {line                   :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_SCENE_SWITCH_TOC_PB_H').
-define('M_SCENE_SWITCH_TOC_PB_H', true).
-record(m_scene_switch_toc,
        {line                   :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_SCENE_DEST_TOS_PB_H').
-define('M_SCENE_DEST_TOS_PB_H', true).
-record(m_scene_dest_tos,
        {dest                   :: pb_1200_scene:p_coord(), % = 1
         dir                    :: integer(),       % = 2, 32 bits
         state                  :: integer()        % = 3, 32 bits
        }).
-endif.

-ifndef('M_SCENE_DEST_TOC_PB_H').
-define('M_SCENE_DEST_TOC_PB_H', true).
-record(m_scene_dest_toc,
        {uid                    :: non_neg_integer(), % = 1, 32 bits
         dest                   :: pb_1200_scene:p_coord(), % = 2
         dir                    :: integer(),       % = 3, 32 bits
         state                  :: integer()        % = 4, 32 bits
        }).
-endif.

-ifndef('M_SCENE_MOVE_TOS_PB_H').
-define('M_SCENE_MOVE_TOS_PB_H', true).
-record(m_scene_move_tos,
        {x                      :: float() | integer() | infinity | '-infinity' | nan, % = 1
         y                      :: float() | integer() | infinity | '-infinity' | nan % = 2
        }).
-endif.

-ifndef('M_SCENE_MOVE_TOC_PB_H').
-define('M_SCENE_MOVE_TOC_PB_H', true).
-record(m_scene_move_toc,
        {x                      :: float() | integer() | infinity | '-infinity' | nan, % = 1
         y                      :: float() | integer() | infinity | '-infinity' | nan % = 2
        }).
-endif.

-ifndef('M_SCENE_TELEPORT_TOS_PB_H').
-define('M_SCENE_TELEPORT_TOS_PB_H', true).
-record(m_scene_teleport_tos,
        {type                   :: integer(),       % = 1, 32 bits
         dest                   :: pb_1200_scene:p_coord() % = 2
        }).
-endif.

-ifndef('M_SCENE_TELEPORT_TOC_PB_H').
-define('M_SCENE_TELEPORT_TOC_PB_H', true).
-record(m_scene_teleport_toc,
        {uid                    :: non_neg_integer(), % = 1, 32 bits
         type                   :: integer(),       % = 2, 32 bits
         dest                   :: pb_1200_scene:p_coord() % = 3
        }).
-endif.

-ifndef('M_SCENE_UPDATE_TOC_PB_H').
-define('M_SCENE_UPDATE_TOC_PB_H', true).
-record(m_scene_update_toc,
        {add = []               :: [pb_1200_scene:p_actor()] | undefined, % = 1
         del = []               :: [non_neg_integer()] | undefined % = 2, 32 bits
        }).
-endif.

-ifndef('M_ACTOR_UPDATE_TOC_PB_H').
-define('M_ACTOR_UPDATE_TOC_PB_H', true).
-record(m_actor_update_toc,
        {uid                    :: non_neg_integer(), % = 1, 32 bits
         upint = #{}            :: #{iolist() := integer()} | undefined, % = 2
         upstr = #{}            :: #{iolist() := iolist()} | undefined, % = 3
         aspect = #{}           :: #{iolist() := pb_1200_scene:p_aspect()} | undefined, % = 4
         icon                   :: pb_1200_scene:p_icon() | undefined % = 5
        }).
-endif.

-ifndef('M_BUFF_UPDATE_TOC_PB_H').
-define('M_BUFF_UPDATE_TOC_PB_H', true).
-record(m_buff_update_toc,
        {uid                    :: non_neg_integer(), % = 1, 32 bits
         add = []               :: [pb_1200_scene:p_buff()] | undefined, % = 2
         del = []               :: [integer()] | undefined, % = 3, 32 bits
         chg = []               :: [pb_1200_scene:p_buff()] | undefined % = 4
        }).
-endif.

-ifndef('M_SCENE_RUSH_TOS_PB_H').
-define('M_SCENE_RUSH_TOS_PB_H', true).
-record(m_scene_rush_tos,
        {coord                  :: pb_1200_scene:p_coord() % = 1
        }).
-endif.

-ifndef('M_SCENE_RUSH_TOC_PB_H').
-define('M_SCENE_RUSH_TOC_PB_H', true).
-record(m_scene_rush_toc,
        {uid                    :: non_neg_integer(), % = 1, 32 bits
         coord                  :: pb_1200_scene:p_coord() % = 2
        }).
-endif.

-ifndef('M_SCENE_TALK_TOS_PB_H').
-define('M_SCENE_TALK_TOS_PB_H', true).
-record(m_scene_talk_tos,
        {npc_id                 :: integer(),       % = 1, 32 bits
         task_id                :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_SCENE_TALK_TOC_PB_H').
-define('M_SCENE_TALK_TOC_PB_H', true).
-record(m_scene_talk_toc,
        {npc_id                 :: integer(),       % = 1, 32 bits
         task_id                :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_SCENE_DROP_TOC_PB_H').
-define('M_SCENE_DROP_TOC_PB_H', true).
-record(m_scene_drop_toc,
        {drops = []             :: [pb_1200_scene:p_drop()] | undefined % = 1
        }).
-endif.

-ifndef('M_SCENE_JUMP_TOS_PB_H').
-define('M_SCENE_JUMP_TOS_PB_H', true).
-record(m_scene_jump_tos,
        {start                  :: pb_1200_scene:p_coord(), % = 1
         dest                   :: pb_1200_scene:p_coord(), % = 2
         type                   :: integer()        % = 3, 32 bits
        }).
-endif.

-ifndef('M_SCENE_JUMP_TOC_PB_H').
-define('M_SCENE_JUMP_TOC_PB_H', true).
-record(m_scene_jump_toc,
        {start                  :: pb_1200_scene:p_coord(), % = 1
         dest                   :: pb_1200_scene:p_coord(), % = 2
         type                   :: integer(),       % = 3, 32 bits
         uid                    :: non_neg_integer() % = 4, 32 bits
        }).
-endif.

-ifndef('M_ACTOR_CHPOS_TOC_PB_H').
-define('M_ACTOR_CHPOS_TOC_PB_H', true).
-record(m_actor_chpos_toc,
        {uid                    :: non_neg_integer(), % = 1, 32 bits
         dest                   :: pb_1200_scene:p_coord() % = 2
        }).
-endif.

-ifndef('M_ACTOR_UPDATEHP_TOC_PB_H').
-define('M_ACTOR_UPDATEHP_TOC_PB_H', true).
-record(m_actor_updatehp_toc,
        {uid                    :: non_neg_integer(), % = 1, 32 bits
         hp                     :: integer(),       % = 2, 32 bits
         hpmax                  :: integer()        % = 3, 32 bits
        }).
-endif.

-ifndef('M_ACTOR_HEAL_TOC_PB_H').
-define('M_ACTOR_HEAL_TOC_PB_H', true).
-record(m_actor_heal_toc,
        {uid                    :: non_neg_integer(), % = 1, 32 bits
         hp                     :: integer(),       % = 2, 32 bits
         heal                   :: integer(),       % = 3, 32 bits
         type                   :: integer()        % = 4, 32 bits
        }).
-endif.

-ifndef('M_SCENE_ENTER_TOC_PB_H').
-define('M_SCENE_ENTER_TOC_PB_H', true).
-record(m_scene_enter_toc,
        {scene                  :: integer(),       % = 1, 32 bits
         line                   :: integer(),       % = 2, 32 bits
         actor                  :: pb_1200_scene:p_actor(), % = 3
         actors = []            :: [pb_1200_scene:p_actor()] | undefined, % = 4
...
-ifndef('M_ACTOR_ADD_BUFF_TOS_PB_H').
-define('M_ACTOR_ADD_BUFF_TOS_PB_H', true).
-record(m_actor_add_buff_tos,
        {id                     :: integer(),       % = 1, 32 bits
         uid                    :: integer() | undefined % = 2, 32 bits
        }).
-endif.

-ifndef('M_ACTOR_DEL_BUFF_TOS_PB_H').
-define('M_ACTOR_DEL_BUFF_TOS_PB_H', true).
-record(m_actor_del_buff_tos,
        {id                     :: integer(),       % = 1, 32 bits
         uid                    :: integer() | undefined % = 2, 32 bits
        }).
-endif.
...
-record(p_role_base,
        {id                     :: non_neg_integer(), % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1200_scene:p_aspect()} | undefined, % = 8
         ...
         icon                   :: pb_1200_scene:p_icon() | undefined, % = 17
...
-record(p_item,
        {uid                    :: integer(),       % = 1, 32 bits
         ...
         gender                 :: integer(),       % = 7, 32 bits
         score                  :: integer() | undefined, % = 8, 32 bits
         equip                  :: pb_1200_scene:p_equip() | undefined, % = 9
         pet                    :: pb_1200_scene:p_pet() | undefined, % = 10
...
-record(p_equip,
        {base                   :: pb_1200_scene:p_attr(), % = 1
         rare1                  :: pb_1200_scene:p_attr() | undefined, % = 2
         rare2                  :: pb_1200_scene:p_attr() | undefined, % = 3
         rare3                  :: pb_1200_scene:p_attr() | undefined, % = 4
         marriage               :: pb_1200_scene:p_marriage() | undefined, % = 5
         ...
         refine = []            :: [pb_1200_scene:p_refine()] | undefined, % = 11
         suite = #{}            :: #{integer() := integer()} | undefined, % = 12
         combine = []           :: [pb_1200_scene:p_item()] | undefined % = 13
        }).
-endif.
...
-record(p_marriage,
        {husband_id             :: non_neg_integer() | undefined, % = 1, 32 bits
         ...
         rare                   :: pb_1200_scene:p_attr() | undefined % = 5
        }).
-endif.
...
-record(p_actor,
        {uid                    :: non_neg_integer(), % = 1, 32 bits
         name                   :: iolist(),        % = 2
         type                   :: integer(),       % = 3, 32 bits
         coord                  :: pb_1200_scene:p_coord(), % = 4
         state                  :: integer(),       % = 5, 32 bits
         stargs = #{}           :: #{integer() := iolist()} | undefined, % = 6
         role                   :: pb_1200_scene:p_role() | undefined, % = 7
         creep                  :: pb_1200_scene:p_creep() | undefined, % = 8
         drop                   :: pb_1200_scene:p_drop() | undefined % = 9
        }).
-endif.
...
-record(p_role,
        {career                 :: integer(),       % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1200_scene:p_aspect()} | undefined, % = 5
         ...
         icon                   :: pb_1200_scene:p_icon() | undefined % = 25
        }).
-endif.
...
-record(p_creep,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         buffs = []             :: [pb_1200_scene:p_buff()] | undefined, % = 6
         dir                    :: integer(),       % = 7, 32 bits
         dest                   :: pb_1200_scene:p_coord(), % = 8
...
-record(p_drop,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         coord                  :: pb_1200_scene:p_coord() | undefined, % = 5
...
-record(p_ranking,
        {base                   :: pb_1200_scene:p_role_base() | undefined, % = 1
