...
-ifndef(pb_1300_chat).
-define(pb_1300_chat, true).

-define(pb_1300_chat_gpb_version, "4.5.1").

-ifndef('M_CHAT_CHANNEL_TOS_PB_H').
-define('M_CHAT_CHANNEL_TOS_PB_H', true).
-record(m_chat_channel_tos,
        {channel_id             :: integer(),       % = 1, 32 bits
         type_id                :: integer(),       % = 2, 32 bits
         content                :: iolist(),        % = 3
         to_role_id             :: non_neg_integer() | undefined, % = 4, 32 bits
         uids = []              :: [integer()] | undefined % = 5, 32 bits
        }).
-endif.

-ifndef('M_CHAT_CHANNEL_TOC_PB_H').
-define('M_CHAT_CHANNEL_TOC_PB_H', true).
-record(m_chat_channel_toc,
        {channel_id             :: integer(),       % = 1, 32 bits
         type_id                :: integer() | undefined, % = 2, 32 bits
         content                :: iolist(),        % = 3
         sender                 :: pb_1300_chat:p_role_base() | undefined, % = 4
         to_role_id             :: non_neg_integer() | undefined, % = 5, 32 bits
         ids = #{}              :: #{integer() := integer()} | undefined, % = 6
         show_type              :: integer() | undefined, % = 7, 32 bits
         scene                  :: integer() | undefined % = 8, 32 bits
        }).
-endif.

-ifndef('M_CHAT_ITEM_TOS_PB_H').
-define('M_CHAT_ITEM_TOS_PB_H', true).
-record(m_chat_item_tos,
        {id                     :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_CHAT_ITEM_TOC_PB_H').
-define('M_CHAT_ITEM_TOC_PB_H', true).
-record(m_chat_item_toc,
        {item                   :: pb_1300_chat:p_item() % = 1
        }).
-endif.

-ifndef('M_CHAT_OFF_MSG_TOS_PB_H').
-define('M_CHAT_OFF_MSG_TOS_PB_H', true).
-record(m_chat_off_msg_tos,
        {
        }).
-endif.
...
-record(p_role_base,
        {id                     :: non_neg_integer(), % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1300_chat:p_aspect()} | undefined, % = 8
         ...
         icon                   :: pb_1300_chat:p_icon() | undefined, % = 17
...
-record(p_item,
        {uid                    :: integer(),       % = 1, 32 bits
         ...
         gender                 :: integer(),       % = 7, 32 bits
         score                  :: integer() | undefined, % = 8, 32 bits
         equip                  :: pb_1300_chat:p_equip() | undefined, % = 9
         pet                    :: pb_1300_chat:p_pet() | undefined, % = 10
...
-record(p_equip,
        {base                   :: pb_1300_chat:p_attr(), % = 1
         rare1                  :: pb_1300_chat:p_attr() | undefined, % = 2
         rare2                  :: pb_1300_chat:p_attr() | undefined, % = 3
         rare3                  :: pb_1300_chat:p_attr() | undefined, % = 4
         marriage               :: pb_1300_chat:p_marriage() | undefined, % = 5
         ...
         refine = []            :: [pb_1300_chat:p_refine()] | undefined, % = 11
         suite = #{}            :: #{integer() := integer()} | undefined, % = 12
         combine = []           :: [pb_1300_chat:p_item()] | undefined % = 13
        }).
-endif.
...
-record(p_marriage,
        {husband_id             :: non_neg_integer() | undefined, % = 1, 32 bits
         ...
         rare                   :: pb_1300_chat:p_attr() | undefined % = 5
        }).
-endif.
...
-record(p_actor,
        {uid                    :: non_neg_integer(), % = 1, 32 bits
         ...
         coord                  :: pb_1300_chat:p_coord(), % = 4
         state                  :: integer(),       % = 5, 32 bits
         stargs = #{}           :: #{integer() := iolist()} | undefined, % = 6
         role                   :: pb_1300_chat:p_role() | undefined, % = 7
         creep                  :: pb_1300_chat:p_creep() | undefined, % = 8
         drop                   :: pb_1300_chat:p_drop() | undefined % = 9
        }).
-endif.
...
-record(p_role,
        {career                 :: integer(),       % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1300_chat:p_aspect()} | undefined, % = 5
         ...
         icon                   :: pb_1300_chat:p_icon() | undefined % = 25
        }).
-endif.
...
-record(p_creep,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         buffs = []             :: [pb_1300_chat:p_buff()] | undefined, % = 6
         dir                    :: integer(),       % = 7, 32 bits
         dest                   :: pb_1300_chat:p_coord(), % = 8
...
-record(p_drop,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         coord                  :: pb_1300_chat:p_coord() | undefined, % = 5
...
-record(p_ranking,
        {base                   :: pb_1300_chat:p_role_base() | undefined, % = 1
