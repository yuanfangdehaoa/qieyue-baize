...
-ifndef(pb_1102_item).
-define(pb_1102_item, true).

-define(pb_1102_item_gpb_version, "4.5.1").

-ifndef('M_ITEM_DETAIL_TOS_PB_H').
-define('M_ITEM_DETAIL_TOS_PB_H', true).
-record(m_item_detail_tos,
        {pos                    :: integer(),       % = 1, 32 bits
         id                     :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_ITEM_DETAIL_TOC_PB_H').
-define('M_ITEM_DETAIL_TOC_PB_H', true).
-record(m_item_detail_toc,
        {item                   :: pb_1102_item:p_item(), % = 1
         pos                    :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_ITEM_USE_TOS_PB_H').
-define('M_ITEM_USE_TOS_PB_H', true).
-record(m_item_use_tos,
        {uid                    :: integer(),       % = 1, 32 bits
         num                    :: integer(),       % = 2, 32 bits
         args = []              :: [integer()] | undefined % = 3, 32 bits
        }).
-endif.

-ifndef('M_ITEM_USE_TOC_PB_H').
-define('M_ITEM_USE_TOC_PB_H', true).
-record(m_item_use_toc,
        {uid                    :: integer(),       % = 1, 32 bits
         id                     :: integer(),       % = 2, 32 bits
         num                    :: integer(),       % = 3, 32 bits
         items = #{}            :: #{integer() := integer()} | undefined % = 4
        }).
-endif.

-ifndef('M_ITEM_CHUCK_TOS_PB_H').
-define('M_ITEM_CHUCK_TOS_PB_H', true).
-record(m_item_chuck_tos,
        {uid                    :: integer(),       % = 1, 32 bits
         num                    :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_ITEM_CHUCK_TOC_PB_H').
-define('M_ITEM_CHUCK_TOC_PB_H', true).
-record(m_item_chuck_toc,
        {uid                    :: integer(),       % = 1, 32 bits
         num                    :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_ITEM_SELL_TOS_PB_H').
-define('M_ITEM_SELL_TOS_PB_H', true).
-record(m_item_sell_tos,
        {items = #{}            :: #{integer() := integer()} | undefined % = 1
        }).
-endif.

-ifndef('M_ITEM_SELL_TOC_PB_H').
-define('M_ITEM_SELL_TOC_PB_H', true).
-record(m_item_sell_toc,
        {gain = #{}             :: #{integer() := integer()} | undefined, % = 1
         cost = #{}             :: #{integer() := integer()} | undefined % = 2
        }).
-endif.

-ifndef('M_ITEM_COMPOSE_TOS_PB_H').
-define('M_ITEM_COMPOSE_TOS_PB_H', true).
-record(m_item_compose_tos,
        {formula                :: integer(),       % = 1, 32 bits
         materials = #{}        :: #{integer() := integer()} | undefined % = 2
        }).
-endif.

-ifndef('M_ITEM_COMPOSE_TOC_PB_H').
-define('M_ITEM_COMPOSE_TOC_PB_H', true).
-record(m_item_compose_toc,
        {type_id                :: integer(),       % = 1, 32 bits
         num                    :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_ITEM_RESOLVE_TOS_PB_H').
-define('M_ITEM_RESOLVE_TOS_PB_H', true).
-record(m_item_resolve_tos,
        {uid                    :: integer(),       % = 1, 32 bits
         num                    :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_ITEM_RESOLVE_TOC_PB_H').
-define('M_ITEM_RESOLVE_TOC_PB_H', true).
-record(m_item_resolve_toc,
        {uid                    :: integer(),       % = 1, 32 bits
         num                    :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_ITEM_STORE_TOS_PB_H').
-define('M_ITEM_STORE_TOS_PB_H', true).
-record(m_item_store_tos,
        {uid                    :: integer(),       % = 1, 32 bits
         num                    :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_ITEM_STORE_TOC_PB_H').
-define('M_ITEM_STORE_TOC_PB_H', true).
-record(m_item_store_toc,
        {uid                    :: integer(),       % = 1, 32 bits
         num                    :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_ITEM_FETCH_TOS_PB_H').
-define('M_ITEM_FETCH_TOS_PB_H', true).
-record(m_item_fetch_tos,
        {uid                    :: integer(),       % = 1, 32 bits
         num                    :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_ITEM_FETCH_TOC_PB_H').
-define('M_ITEM_FETCH_TOC_PB_H', true).
-record(m_item_fetch_toc,
        {uid                    :: integer(),       % = 1, 32 bits
         num                    :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_ITEM_QUERY_TOS_PB_H').
-define('M_ITEM_QUERY_TOS_PB_H', true).
-record(m_item_query_tos,
        {id                     :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_ITEM_QUERY_TOC_PB_H').
-define('M_ITEM_QUERY_TOC_PB_H', true).
-record(m_item_query_toc,
        {item                   :: pb_1102_item:p_item() % = 1
        }).
-endif.
...
-record(p_role_base,
        {id                     :: non_neg_integer(), % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1102_item:p_aspect()} | undefined, % = 8
         ...
         icon                   :: pb_1102_item:p_icon() | undefined, % = 17
...
-record(p_item,
        {uid                    :: integer(),       % = 1, 32 bits
         ...
         gender                 :: integer(),       % = 7, 32 bits
         score                  :: integer() | undefined, % = 8, 32 bits
         equip                  :: pb_1102_item:p_equip() | undefined, % = 9
         pet                    :: pb_1102_item:p_pet() | undefined, % = 10
...
-record(p_equip,
        {base                   :: pb_1102_item:p_attr(), % = 1
         rare1                  :: pb_1102_item:p_attr() | undefined, % = 2
         rare2                  :: pb_1102_item:p_attr() | undefined, % = 3
         rare3                  :: pb_1102_item:p_attr() | undefined, % = 4
         marriage               :: pb_1102_item:p_marriage() | undefined, % = 5
         ...
         refine = []            :: [pb_1102_item:p_refine()] | undefined, % = 11
         suite = #{}            :: #{integer() := integer()} | undefined, % = 12
         combine = []           :: [pb_1102_item:p_item()] | undefined % = 13
        }).
-endif.
...
-record(p_marriage,
        {husband_id             :: non_neg_integer() | undefined, % = 1, 32 bits
         ...
         rare                   :: pb_1102_item:p_attr() | undefined % = 5
        }).
-endif.
...
-record(p_actor,
        {uid                    :: non_neg_integer(), % = 1, 32 bits
         ...
         coord                  :: pb_1102_item:p_coord(), % = 4
         state                  :: integer(),       % = 5, 32 bits
         stargs = #{}           :: #{integer() := iolist()} | undefined, % = 6
         role                   :: pb_1102_item:p_role() | undefined, % = 7
         creep                  :: pb_1102_item:p_creep() | undefined, % = 8
         drop                   :: pb_1102_item:p_drop() | undefined % = 9
        }).
-endif.
...
-record(p_role,
        {career                 :: integer(),       % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1102_item:p_aspect()} | undefined, % = 5
         ...
         icon                   :: pb_1102_item:p_icon() | undefined % = 25
        }).
-endif.
...
-record(p_creep,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         buffs = []             :: [pb_1102_item:p_buff()] | undefined, % = 6
         dir                    :: integer(),       % = 7, 32 bits
         dest                   :: pb_1102_item:p_coord(), % = 8
...
-record(p_drop,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         coord                  :: pb_1102_item:p_coord() | undefined, % = 5
...
-record(p_ranking,
        {base                   :: pb_1102_item:p_role_base() | undefined, % = 1
