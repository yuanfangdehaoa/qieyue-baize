...
%% message types
-type m_login_verify_tos() :: #m_login_verify_tos{}.

-type m_login_verify_toc() :: #m_login_verify_toc{}.

-type m_login_create_tos() :: #m_login_create_tos{}.

-type m_login_create_toc() :: #m_login_create_toc{}.

-type m_login_enter_tos() :: #m_login_enter_tos{}.

-type m_login_enter_toc() :: #m_login_enter_toc{}.

-type m_login_name_tos() :: #m_login_name_tos{}.

-type m_login_name_toc() :: #m_login_name_toc{}.

-type m_login_reconn_tos() :: #m_login_reconn_tos{}.

-type m_login_reconn_toc() :: #m_login_reconn_toc{}.

-type m_login_leave_tos() :: #m_login_leave_tos{}.

-type m_login_leave_toc() :: #m_login_leave_toc{}.
...
-export_type(['m_login_verify_tos'/0, 'm_login_verify_toc'/0, 'm_login_create_tos'/0, 'm_login_create_toc'/0, 'm_login_enter_tos'/0, 'm_login_enter_toc'/0, 'm_login_name_tos'/0, 'm_login_name_toc'/0, 'm_login_reconn_tos'/0, 'm_login_reconn_toc'/0, 'm_login_leave_tos'/0, 'm_login_leave_toc'/0, 'p_role_base'/0, 'p_aspect'/0, 'p_attr'/0, 'p_item_base'/0, 'p_item'/0, 'p_equip'/0, 'p_pet'/0, 'p_marriage'/0, 'p_refine'/0, 'p_actor'/0, 'p_role'/0, 'p_creep'/0, 'p_npc'/0, 'p_drop'/0, 'p_buff'/0, 'p_coord'/0, 'p_icon'/0, 'p_ranking'/0, 'p_dropped'/0]).

-spec encode_msg(#m_login_verify_tos{} | #m_login_verify_toc{} | #m_login_create_tos{} | #m_login_create_toc{} | #m_login_enter_tos{} | #m_login_enter_toc{} | #m_login_name_tos{} | #m_login_name_toc{} | #m_login_reconn_tos{} | #m_login_reconn_toc{} | #m_login_leave_tos{} | #m_login_leave_toc{} | #p_role_base{} | #p_aspect{} | #p_attr{} | #p_item_base{} | #p_item{} | #p_equip{} | #p_pet{} | #p_marriage{} | #p_refine{} | #p_actor{} | #p_role{} | #p_creep{} | #p_npc{} | #p_drop{} | #p_buff{} | #p_coord{} | #p_icon{} | #p_ranking{} | #p_dropped{}) -> binary().
...
encode_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
      m_login_verify_tos ->
	  encode_msg_m_login_verify_tos(id(Msg, TrUserData),
					TrUserData);
      m_login_verify_toc ->
	  encode_msg_m_login_verify_toc(id(Msg, TrUserData),
					TrUserData);
      m_login_create_tos ->
	  encode_msg_m_login_create_tos(id(Msg, TrUserData),
					TrUserData);
      m_login_create_toc ->
	  encode_msg_m_login_create_toc(id(Msg, TrUserData),
					TrUserData);
      m_login_enter_tos ->
	  encode_msg_m_login_enter_tos(id(Msg, TrUserData),
				       TrUserData);
      m_login_enter_toc ->
	  encode_msg_m_login_enter_toc(id(Msg, TrUserData),
				       TrUserData);
      m_login_name_tos ->
	  encode_msg_m_login_name_tos(id(Msg, TrUserData),
				      TrUserData);
      m_login_name_toc ->
	  encode_msg_m_login_name_toc(id(Msg, TrUserData),
				      TrUserData);
      m_login_reconn_tos ->
	  encode_msg_m_login_reconn_tos(id(Msg, TrUserData),
					TrUserData);
      m_login_reconn_toc ->
	  encode_msg_m_login_reconn_toc(id(Msg, TrUserData),
					TrUserData);
      m_login_leave_tos ->
	  encode_msg_m_login_leave_tos(id(Msg, TrUserData),
				       TrUserData);
      m_login_leave_toc ->
	  encode_msg_m_login_leave_toc(id(Msg, TrUserData),
				       TrUserData);
      p_role_base ->
...
encode_msg_m_login_verify_tos(Msg, TrUserData) ->
    encode_msg_m_login_verify_tos(Msg, <<>>, TrUserData).


encode_msg_m_login_verify_tos(#m_login_verify_tos{platform
						      = F1,
						  gamechan = F2, account = F3,
						  token = F4, args = F5},
			      Bin, TrUserData) ->
    B1 = begin
    ...
    begin
      TrF5 = 'tr_encode_m_login_verify_tos.args'(F5,
						 TrUserData),
      if TrF5 == [] -> B4;
	 true ->
	     e_field_m_login_verify_tos_args(TrF5, B4, TrUserData)
      end
    end.

encode_msg_m_login_verify_toc(Msg, TrUserData) ->
    encode_msg_m_login_verify_toc(Msg, <<>>, TrUserData).


encode_msg_m_login_verify_toc(#m_login_verify_toc{career
						      = F1,
						  roles = F2},
			      Bin, TrUserData) ->
    B1 = begin
    ...
    begin
      ...
      if TrF2 == [] -> B1;
	 true ->
	     e_field_m_login_verify_toc_roles(TrF2, B1, TrUserData)
      end
    end.

encode_msg_m_login_create_tos(Msg, TrUserData) ->
    encode_msg_m_login_create_tos(Msg, <<>>, TrUserData).


encode_msg_m_login_create_tos(#m_login_create_tos{career
						      = F1,
						  gender = F2, name = F3},
			      Bin, TrUserData) ->
    B1 = begin
...
encode_msg_m_login_create_toc(Msg, TrUserData) ->
    encode_msg_m_login_create_toc(Msg, <<>>, TrUserData).


encode_msg_m_login_create_toc(#m_login_create_toc{role_id
						      = F1},
			      Bin, TrUserData) ->
    begin
      TrF1 = id(F1, TrUserData),
...
encode_msg_m_login_enter_tos(Msg, TrUserData) ->
    encode_msg_m_login_enter_tos(Msg, <<>>, TrUserData).


encode_msg_m_login_enter_tos(#m_login_enter_tos{role_id
						    = F1},
			     Bin, TrUserData) ->
    begin
      TrF1 = id(F1, TrUserData),
...
encode_msg_m_login_enter_toc(Msg, TrUserData) ->
    encode_msg_m_login_enter_toc(Msg, <<>>, TrUserData).


encode_msg_m_login_enter_toc(#m_login_enter_toc{suids =
						    F1,
						open = F2, merge = F3,
						token = F4},
			     Bin, TrUserData) ->
    B1 = begin
	   ...
	   if TrF1 == [] -> Bin;
	      true ->
		  e_field_m_login_enter_toc_suids(TrF1, Bin, TrUserData)
	   end
	 end,
    B2 = begin
	   TrF2 = id(F2, TrUserData),
...
encode_msg_m_login_name_tos(Msg, TrUserData) ->
    encode_msg_m_login_name_tos(Msg, <<>>, TrUserData).


encode_msg_m_login_name_tos(#m_login_name_tos{gender =
						  F1},
			    Bin, TrUserData) ->
    begin
      TrF1 = id(F1, TrUserData),
...
encode_msg_m_login_name_toc(Msg, TrUserData) ->
    encode_msg_m_login_name_toc(Msg, <<>>, TrUserData).


encode_msg_m_login_name_toc(#m_login_name_toc{name =
						  F1},
			    Bin, TrUserData) ->
    begin
      TrF1 = id(F1, TrUserData),
...
encode_msg_m_login_reconn_tos(Msg, TrUserData) ->
    encode_msg_m_login_reconn_tos(Msg, <<>>, TrUserData).


encode_msg_m_login_reconn_tos(#m_login_reconn_tos{role_id
						      = F1,
						  token = F2},
			      Bin, TrUserData) ->
    B1 = begin
...
encode_msg_m_login_reconn_toc(_Msg, _TrUserData) ->
    <<>>.

encode_msg_m_login_leave_tos(_Msg, _TrUserData) -> <<>>.

encode_msg_m_login_leave_toc(_Msg, _TrUserData) -> <<>>.
...
e_mfield_m_login_verify_tos_args(Msg, Bin,
				 TrUserData) ->
...
e_field_m_login_verify_tos_args([Elem | Rest], Bin,
				TrUserData) ->
    Bin2 = <<Bin/binary, 42>>,
    Bin3 =
	e_mfield_m_login_verify_tos_args('tr_encode_m_login_verify_tos.args[x]'(Elem,
										TrUserData),
					 Bin2, TrUserData),
    e_field_m_login_verify_tos_args(Rest, Bin3, TrUserData);
e_field_m_login_verify_tos_args([], Bin, _TrUserData) ->
    Bin.

e_mfield_m_login_verify_toc_roles(Msg, Bin,
				  TrUserData) ->
    SubBin = encode_msg_p_role_base(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

e_field_m_login_verify_toc_roles([Elem | Rest], Bin,
				 TrUserData) ->
    Bin2 = <<Bin/binary, 18>>,
    Bin3 = e_mfield_m_login_verify_toc_roles(id(Elem,
						TrUserData),
					     Bin2, TrUserData),
    e_field_m_login_verify_toc_roles(Rest, Bin3,
				     TrUserData);
e_field_m_login_verify_toc_roles([], Bin,
				 _TrUserData) ->
    Bin.

e_field_m_login_enter_toc_suids([Elem | Rest], Bin,
				TrUserData) ->
    Bin2 = <<Bin/binary, 8>>,
    Bin3 = e_type_int32(id(Elem, TrUserData), Bin2,
			TrUserData),
    e_field_m_login_enter_toc_suids(Rest, Bin3, TrUserData);
e_field_m_login_enter_toc_suids([], Bin, _TrUserData) ->
    Bin.
...
decode_msg_2_doit(m_login_verify_tos, Bin,
		  TrUserData) ->
    id(decode_msg_m_login_verify_tos(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_login_verify_toc, Bin,
		  TrUserData) ->
    id(decode_msg_m_login_verify_toc(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_login_create_tos, Bin,
		  TrUserData) ->
    id(decode_msg_m_login_create_tos(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_login_create_toc, Bin,
		  TrUserData) ->
    id(decode_msg_m_login_create_toc(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_login_enter_tos, Bin, TrUserData) ->
    id(decode_msg_m_login_enter_tos(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_login_enter_toc, Bin, TrUserData) ->
    id(decode_msg_m_login_enter_toc(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_login_name_tos, Bin, TrUserData) ->
    id(decode_msg_m_login_name_tos(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_login_name_toc, Bin, TrUserData) ->
    id(decode_msg_m_login_name_toc(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_login_reconn_tos, Bin,
		  TrUserData) ->
    id(decode_msg_m_login_reconn_tos(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_login_reconn_toc, Bin,
		  TrUserData) ->
    id(decode_msg_m_login_reconn_toc(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_login_leave_tos, Bin, TrUserData) ->
    id(decode_msg_m_login_leave_tos(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_login_leave_toc, Bin, TrUserData) ->
    id(decode_msg_m_login_leave_toc(Bin, TrUserData),
       TrUserData);
...
decode_msg_m_login_verify_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_login_verify_tos(Bin, 0, 0,
					  id(undefined, TrUserData),
					  id(undefined, TrUserData),
					  id(undefined, TrUserData),
					  id(undefined, TrUserData),
					  'tr_decode_init_default_m_login_verify_tos.args'([],
											   TrUserData),
					  TrUserData).

dfp_read_field_def_m_login_verify_tos(<<10,
					Rest/binary>>,
				      Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
				      TrUserData) ->
    d_field_m_login_verify_tos_platform(Rest, Z1, Z2, F@_1,
					F@_2, F@_3, F@_4, F@_5, TrUserData);
dfp_read_field_def_m_login_verify_tos(<<18,
					Rest/binary>>,
				      Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
				      TrUserData) ->
    d_field_m_login_verify_tos_gamechan(Rest, Z1, Z2, F@_1,
					F@_2, F@_3, F@_4, F@_5, TrUserData);
dfp_read_field_def_m_login_verify_tos(<<26,
					Rest/binary>>,
				      Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
				      TrUserData) ->
    d_field_m_login_verify_tos_account(Rest, Z1, Z2, F@_1,
				       F@_2, F@_3, F@_4, F@_5, TrUserData);
dfp_read_field_def_m_login_verify_tos(<<34,
					Rest/binary>>,
				      Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
				      TrUserData) ->
    d_field_m_login_verify_tos_token(Rest, Z1, Z2, F@_1,
				     F@_2, F@_3, F@_4, F@_5, TrUserData);
dfp_read_field_def_m_login_verify_tos(<<42,
					Rest/binary>>,
				      Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
				      TrUserData) ->
    d_field_m_login_verify_tos_args(Rest, Z1, Z2, F@_1,
				    F@_2, F@_3, F@_4, F@_5, TrUserData);
dfp_read_field_def_m_login_verify_tos(<<>>, 0, 0, F@_1,
				      F@_2, F@_3, F@_4, R1, TrUserData) ->
    #m_login_verify_tos{platform = F@_1, gamechan = F@_2,
			account = F@_3, token = F@_4,
			args =
			    'tr_decode_repeated_finalize_m_login_verify_tos.args'(R1,
										  TrUserData)};
dfp_read_field_def_m_login_verify_tos(Other, Z1, Z2,
				      F@_1, F@_2, F@_3, F@_4, F@_5,
				      TrUserData) ->
    dg_read_field_def_m_login_verify_tos(Other, Z1, Z2,
					 F@_1, F@_2, F@_3, F@_4, F@_5,
					 TrUserData).

dg_read_field_def_m_login_verify_tos(<<1:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
				     TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_login_verify_tos(Rest, N + 7,
					 X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
					 F@_5, TrUserData);
dg_read_field_def_m_login_verify_tos(<<0:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
				     TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      10 ->
	  d_field_m_login_verify_tos_platform(Rest, 0, 0, F@_1,
					      F@_2, F@_3, F@_4, F@_5,
					      TrUserData);
      18 ->
	  d_field_m_login_verify_tos_gamechan(Rest, 0, 0, F@_1,
					      F@_2, F@_3, F@_4, F@_5,
					      TrUserData);
      26 ->
	  d_field_m_login_verify_tos_account(Rest, 0, 0, F@_1,
					     F@_2, F@_3, F@_4, F@_5,
					     TrUserData);
      34 ->
	  d_field_m_login_verify_tos_token(Rest, 0, 0, F@_1, F@_2,
					   F@_3, F@_4, F@_5, TrUserData);
      42 ->
	  d_field_m_login_verify_tos_args(Rest, 0, 0, F@_1, F@_2,
					  F@_3, F@_4, F@_5, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_login_verify_tos(Rest, 0, 0, F@_1, F@_2,
					       F@_3, F@_4, F@_5, TrUserData);
	    1 ->
		skip_64_m_login_verify_tos(Rest, 0, 0, F@_1, F@_2, F@_3,
					   F@_4, F@_5, TrUserData);
	    2 ->
		skip_length_delimited_m_login_verify_tos(Rest, 0, 0,
							 F@_1, F@_2, F@_3, F@_4,
							 F@_5, TrUserData);
	    3 ->
		skip_group_m_login_verify_tos(Rest, Key bsr 3, 0, F@_1,
					      F@_2, F@_3, F@_4, F@_5,
					      TrUserData);
	    5 ->
		skip_32_m_login_verify_tos(Rest, 0, 0, F@_1, F@_2, F@_3,
					   F@_4, F@_5, TrUserData)
	  end
    end;
dg_read_field_def_m_login_verify_tos(<<>>, 0, 0, F@_1,
				     F@_2, F@_3, F@_4, R1, TrUserData) ->
    #m_login_verify_tos{platform = F@_1, gamechan = F@_2,
			account = F@_3, token = F@_4,
			args =
...
d_field_m_login_verify_tos_platform(<<1:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
				    TrUserData)
    when N < 57 ->
    d_field_m_login_verify_tos_platform(Rest, N + 7,
					X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
					F@_5, TrUserData);
d_field_m_login_verify_tos_platform(<<0:1, X:7,
				      Rest/binary>>,
    ...
    dfp_read_field_def_m_login_verify_tos(RestF, 0, 0,
					  NewFValue, F@_2, F@_3, F@_4, F@_5,
					  TrUserData).

d_field_m_login_verify_tos_gamechan(<<1:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
				    TrUserData)
    when N < 57 ->
    d_field_m_login_verify_tos_gamechan(Rest, N + 7,
					X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
					F@_5, TrUserData);
d_field_m_login_verify_tos_gamechan(<<0:1, X:7,
				      Rest/binary>>,
    ...
    dfp_read_field_def_m_login_verify_tos(RestF, 0, 0, F@_1,
					  NewFValue, F@_3, F@_4, F@_5,
					  TrUserData).

d_field_m_login_verify_tos_account(<<1:1, X:7,
				     Rest/binary>>,
				   N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
				   TrUserData)
    when N < 57 ->
    d_field_m_login_verify_tos_account(Rest, N + 7,
				       X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
				       F@_5, TrUserData);
d_field_m_login_verify_tos_account(<<0:1, X:7,
				     Rest/binary>>,
...
d_field_m_login_verify_tos_token(<<1:1, X:7,
				   Rest/binary>>,
				 N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
				 TrUserData)
    when N < 57 ->
    d_field_m_login_verify_tos_token(Rest, N + 7,
				     X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
				     F@_5, TrUserData);
d_field_m_login_verify_tos_token(<<0:1, X:7,
				   Rest/binary>>,
...
d_field_m_login_verify_tos_args(<<1:1, X:7,
				  Rest/binary>>,
				N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
				TrUserData)
    when N < 57 ->
    d_field_m_login_verify_tos_args(Rest, N + 7,
				    X bsl N + Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
				    TrUserData);
d_field_m_login_verify_tos_args(<<0:1, X:7,
				  Rest/binary>>,
    ...
    dfp_read_field_def_m_login_verify_tos(RestF, 0, 0, F@_1,
					  F@_2, F@_3, F@_4,
					  'tr_decode_repeated_add_elem_m_login_verify_tos.args'(NewFValue,
												Prev,
												TrUserData),
					  TrUserData).

skip_varint_m_login_verify_tos(<<1:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
			       TrUserData) ->
    skip_varint_m_login_verify_tos(Rest, Z1, Z2, F@_1, F@_2,
				   F@_3, F@_4, F@_5, TrUserData);
skip_varint_m_login_verify_tos(<<0:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
			       TrUserData) ->
    dfp_read_field_def_m_login_verify_tos(Rest, Z1, Z2,
					  F@_1, F@_2, F@_3, F@_4, F@_5,
					  TrUserData).

skip_length_delimited_m_login_verify_tos(<<1:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
					 TrUserData)
    when N < 57 ->
    skip_length_delimited_m_login_verify_tos(Rest, N + 7,
					     X bsl N + Acc, F@_1, F@_2, F@_3,
					     F@_4, F@_5, TrUserData);
skip_length_delimited_m_login_verify_tos(<<0:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
					 TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_login_verify_tos(Rest2, 0, 0, F@_1,
					  F@_2, F@_3, F@_4, F@_5, TrUserData).

skip_group_m_login_verify_tos(Bin, FNum, Z2, F@_1, F@_2,
			      F@_3, F@_4, F@_5, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_login_verify_tos(Rest, 0, Z2, F@_1,
					  F@_2, F@_3, F@_4, F@_5, TrUserData).

skip_32_m_login_verify_tos(<<_:32, Rest/binary>>, Z1,
			   Z2, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) ->
    dfp_read_field_def_m_login_verify_tos(Rest, Z1, Z2,
					  F@_1, F@_2, F@_3, F@_4, F@_5,
					  TrUserData).

skip_64_m_login_verify_tos(<<_:64, Rest/binary>>, Z1,
			   Z2, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) ->
    dfp_read_field_def_m_login_verify_tos(Rest, Z1, Z2,
					  F@_1, F@_2, F@_3, F@_4, F@_5,
					  TrUserData).

decode_msg_m_login_verify_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_login_verify_toc(Bin, 0, 0,
					  id(undefined, TrUserData),
					  id([], TrUserData), TrUserData).

dfp_read_field_def_m_login_verify_toc(<<8,
					Rest/binary>>,
				      Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_login_verify_toc_career(Rest, Z1, Z2, F@_1,
				      F@_2, TrUserData);
dfp_read_field_def_m_login_verify_toc(<<18,
					Rest/binary>>,
				      Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_login_verify_toc_roles(Rest, Z1, Z2, F@_1,
				     F@_2, TrUserData);
dfp_read_field_def_m_login_verify_toc(<<>>, 0, 0, F@_1,
				      R1, TrUserData) ->
    #m_login_verify_toc{career = F@_1,
			roles = lists_reverse(R1, TrUserData)};
dfp_read_field_def_m_login_verify_toc(Other, Z1, Z2,
				      F@_1, F@_2, TrUserData) ->
    dg_read_field_def_m_login_verify_toc(Other, Z1, Z2,
					 F@_1, F@_2, TrUserData).

dg_read_field_def_m_login_verify_toc(<<1:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, F@_2, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_login_verify_toc(Rest, N + 7,
					 X bsl N + Acc, F@_1, F@_2, TrUserData);
dg_read_field_def_m_login_verify_toc(<<0:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, F@_2, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_login_verify_toc_career(Rest, 0, 0, F@_1,
					    F@_2, TrUserData);
      18 ->
	  d_field_m_login_verify_toc_roles(Rest, 0, 0, F@_1, F@_2,
					   TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_login_verify_toc(Rest, 0, 0, F@_1, F@_2,
					       TrUserData);
	    1 ->
		skip_64_m_login_verify_toc(Rest, 0, 0, F@_1, F@_2,
					   TrUserData);
	    2 ->
		skip_length_delimited_m_login_verify_toc(Rest, 0, 0,
							 F@_1, F@_2,
							 TrUserData);
	    3 ->
		skip_group_m_login_verify_toc(Rest, Key bsr 3, 0, F@_1,
					      F@_2, TrUserData);
	    5 ->
		skip_32_m_login_verify_toc(Rest, 0, 0, F@_1, F@_2,
					   TrUserData)
	  end
    end;
dg_read_field_def_m_login_verify_toc(<<>>, 0, 0, F@_1,
				     R1, TrUserData) ->
    #m_login_verify_toc{career = F@_1,
			roles = lists_reverse(R1, TrUserData)}.

d_field_m_login_verify_toc_career(<<1:1, X:7,
				    Rest/binary>>,
				  N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_login_verify_toc_career(Rest, N + 7,
				      X bsl N + Acc, F@_1, F@_2, TrUserData);
d_field_m_login_verify_toc_career(<<0:1, X:7,
				    Rest/binary>>,
    ...
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    dfp_read_field_def_m_login_verify_toc(RestF, 0, 0,
					  NewFValue, F@_2, TrUserData).

d_field_m_login_verify_toc_roles(<<1:1, X:7,
				   Rest/binary>>,
				 N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_login_verify_toc_roles(Rest, N + 7,
				     X bsl N + Acc, F@_1, F@_2, TrUserData);
d_field_m_login_verify_toc_roles(<<0:1, X:7,
				   Rest/binary>>,
    ...
    dfp_read_field_def_m_login_verify_toc(RestF, 0, 0, F@_1,
					  cons(NewFValue, Prev, TrUserData),
					  TrUserData).

skip_varint_m_login_verify_toc(<<1:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, F@_1, F@_2, TrUserData) ->
    skip_varint_m_login_verify_toc(Rest, Z1, Z2, F@_1, F@_2,
				   TrUserData);
skip_varint_m_login_verify_toc(<<0:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_login_verify_toc(Rest, Z1, Z2,
					  F@_1, F@_2, TrUserData).

skip_length_delimited_m_login_verify_toc(<<1:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_login_verify_toc(Rest, N + 7,
					     X bsl N + Acc, F@_1, F@_2,
					     TrUserData);
skip_length_delimited_m_login_verify_toc(<<0:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, F@_2, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_login_verify_toc(Rest2, 0, 0, F@_1,
					  F@_2, TrUserData).

skip_group_m_login_verify_toc(Bin, FNum, Z2, F@_1, F@_2,
			      TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_login_verify_toc(Rest, 0, Z2, F@_1,
					  F@_2, TrUserData).

skip_32_m_login_verify_toc(<<_:32, Rest/binary>>, Z1,
			   Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_login_verify_toc(Rest, Z1, Z2,
					  F@_1, F@_2, TrUserData).

skip_64_m_login_verify_toc(<<_:64, Rest/binary>>, Z1,
			   Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_login_verify_toc(Rest, Z1, Z2,
					  F@_1, F@_2, TrUserData).

decode_msg_m_login_create_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_login_create_tos(Bin, 0, 0,
					  id(undefined, TrUserData),
					  id(undefined, TrUserData),
					  id(undefined, TrUserData),
					  TrUserData).

dfp_read_field_def_m_login_create_tos(<<8,
					Rest/binary>>,
				      Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
    d_field_m_login_create_tos_career(Rest, Z1, Z2, F@_1,
				      F@_2, F@_3, TrUserData);
dfp_read_field_def_m_login_create_tos(<<16,
					Rest/binary>>,
				      Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
    d_field_m_login_create_tos_gender(Rest, Z1, Z2, F@_1,
				      F@_2, F@_3, TrUserData);
dfp_read_field_def_m_login_create_tos(<<26,
					Rest/binary>>,
				      Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
    d_field_m_login_create_tos_name(Rest, Z1, Z2, F@_1,
				    F@_2, F@_3, TrUserData);
dfp_read_field_def_m_login_create_tos(<<>>, 0, 0, F@_1,
				      F@_2, F@_3, _) ->
    #m_login_create_tos{career = F@_1, gender = F@_2,
			name = F@_3};
dfp_read_field_def_m_login_create_tos(Other, Z1, Z2,
				      F@_1, F@_2, F@_3, TrUserData) ->
    dg_read_field_def_m_login_create_tos(Other, Z1, Z2,
					 F@_1, F@_2, F@_3, TrUserData).

dg_read_field_def_m_login_create_tos(<<1:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_login_create_tos(Rest, N + 7,
					 X bsl N + Acc, F@_1, F@_2, F@_3,
					 TrUserData);
dg_read_field_def_m_login_create_tos(<<0:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, F@_2, F@_3, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_login_create_tos_career(Rest, 0, 0, F@_1,
					    F@_2, F@_3, TrUserData);
      16 ->
	  d_field_m_login_create_tos_gender(Rest, 0, 0, F@_1,
					    F@_2, F@_3, TrUserData);
      26 ->
	  d_field_m_login_create_tos_name(Rest, 0, 0, F@_1, F@_2,
					  F@_3, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_login_create_tos(Rest, 0, 0, F@_1, F@_2,
					       F@_3, TrUserData);
	    1 ->
		skip_64_m_login_create_tos(Rest, 0, 0, F@_1, F@_2, F@_3,
					   TrUserData);
	    2 ->
		skip_length_delimited_m_login_create_tos(Rest, 0, 0,
							 F@_1, F@_2, F@_3,
							 TrUserData);
	    3 ->
		skip_group_m_login_create_tos(Rest, Key bsr 3, 0, F@_1,
					      F@_2, F@_3, TrUserData);
	    5 ->
		skip_32_m_login_create_tos(Rest, 0, 0, F@_1, F@_2, F@_3,
					   TrUserData)
	  end
    end;
dg_read_field_def_m_login_create_tos(<<>>, 0, 0, F@_1,
				     F@_2, F@_3, _) ->
    #m_login_create_tos{career = F@_1, gender = F@_2,
			name = F@_3}.

d_field_m_login_create_tos_career(<<1:1, X:7,
				    Rest/binary>>,
				  N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    d_field_m_login_create_tos_career(Rest, N + 7,
				      X bsl N + Acc, F@_1, F@_2, F@_3,
				      TrUserData);
d_field_m_login_create_tos_career(<<0:1, X:7,
				    Rest/binary>>,
    ...
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    dfp_read_field_def_m_login_create_tos(RestF, 0, 0,
					  NewFValue, F@_2, F@_3, TrUserData).

d_field_m_login_create_tos_gender(<<1:1, X:7,
				    Rest/binary>>,
				  N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    d_field_m_login_create_tos_gender(Rest, N + 7,
				      X bsl N + Acc, F@_1, F@_2, F@_3,
				      TrUserData);
d_field_m_login_create_tos_gender(<<0:1, X:7,
				    Rest/binary>>,
    ...
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    dfp_read_field_def_m_login_create_tos(RestF, 0, 0, F@_1,
					  NewFValue, F@_3, TrUserData).

d_field_m_login_create_tos_name(<<1:1, X:7,
				  Rest/binary>>,
				N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    d_field_m_login_create_tos_name(Rest, N + 7,
				    X bsl N + Acc, F@_1, F@_2, F@_3,
				    TrUserData);
d_field_m_login_create_tos_name(<<0:1, X:7,
				  Rest/binary>>,
...
skip_varint_m_login_create_tos(<<1:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
    skip_varint_m_login_create_tos(Rest, Z1, Z2, F@_1, F@_2,
				   F@_3, TrUserData);
skip_varint_m_login_create_tos(<<0:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
    dfp_read_field_def_m_login_create_tos(Rest, Z1, Z2,
					  F@_1, F@_2, F@_3, TrUserData).

skip_length_delimited_m_login_create_tos(<<1:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_login_create_tos(Rest, N + 7,
					     X bsl N + Acc, F@_1, F@_2, F@_3,
					     TrUserData);
skip_length_delimited_m_login_create_tos(<<0:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, F@_2, F@_3,
					 TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_login_create_tos(Rest2, 0, 0, F@_1,
					  F@_2, F@_3, TrUserData).

skip_group_m_login_create_tos(Bin, FNum, Z2, F@_1, F@_2,
			      F@_3, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_login_create_tos(Rest, 0, Z2, F@_1,
					  F@_2, F@_3, TrUserData).

skip_32_m_login_create_tos(<<_:32, Rest/binary>>, Z1,
			   Z2, F@_1, F@_2, F@_3, TrUserData) ->
    dfp_read_field_def_m_login_create_tos(Rest, Z1, Z2,
					  F@_1, F@_2, F@_3, TrUserData).

skip_64_m_login_create_tos(<<_:64, Rest/binary>>, Z1,
			   Z2, F@_1, F@_2, F@_3, TrUserData) ->
    dfp_read_field_def_m_login_create_tos(Rest, Z1, Z2,
					  F@_1, F@_2, F@_3, TrUserData).

decode_msg_m_login_create_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_login_create_toc(Bin, 0, 0,
					  id(undefined, TrUserData),
					  TrUserData).

dfp_read_field_def_m_login_create_toc(<<9,
					Rest/binary>>,
				      Z1, Z2, F@_1, TrUserData) ->
    d_field_m_login_create_toc_role_id(Rest, Z1, Z2, F@_1,
				       TrUserData);
dfp_read_field_def_m_login_create_toc(<<>>, 0, 0, F@_1,
				      _) ->
    #m_login_create_toc{role_id = F@_1};
dfp_read_field_def_m_login_create_toc(Other, Z1, Z2,
				      F@_1, TrUserData) ->
    dg_read_field_def_m_login_create_toc(Other, Z1, Z2,
					 F@_1, TrUserData).

dg_read_field_def_m_login_create_toc(<<1:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_login_create_toc(Rest, N + 7,
					 X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_m_login_create_toc(<<0:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      9 ->
	  d_field_m_login_create_toc_role_id(Rest, 0, 0, F@_1,
					     TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_login_create_toc(Rest, 0, 0, F@_1,
					       TrUserData);
	    1 ->
		skip_64_m_login_create_toc(Rest, 0, 0, F@_1,
					   TrUserData);
	    2 ->
		skip_length_delimited_m_login_create_toc(Rest, 0, 0,
							 F@_1, TrUserData);
	    3 ->
		skip_group_m_login_create_toc(Rest, Key bsr 3, 0, F@_1,
					      TrUserData);
	    5 ->
		skip_32_m_login_create_toc(Rest, 0, 0, F@_1, TrUserData)
	  end
    end;
dg_read_field_def_m_login_create_toc(<<>>, 0, 0, F@_1,
				     _) ->
    #m_login_create_toc{role_id = F@_1}.

d_field_m_login_create_toc_role_id(<<Value:64/little,
				     Rest/binary>>,
				   Z1, Z2, _, TrUserData) ->
    dfp_read_field_def_m_login_create_toc(Rest, Z1, Z2,
					  id(Value, TrUserData), TrUserData).

skip_varint_m_login_create_toc(<<1:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, F@_1, TrUserData) ->
    skip_varint_m_login_create_toc(Rest, Z1, Z2, F@_1,
				   TrUserData);
skip_varint_m_login_create_toc(<<0:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_login_create_toc(Rest, Z1, Z2,
					  F@_1, TrUserData).

skip_length_delimited_m_login_create_toc(<<1:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_login_create_toc(Rest, N + 7,
					     X bsl N + Acc, F@_1, TrUserData);
skip_length_delimited_m_login_create_toc(<<0:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_login_create_toc(Rest2, 0, 0, F@_1,
					  TrUserData).

skip_group_m_login_create_toc(Bin, FNum, Z2, F@_1,
			      TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_login_create_toc(Rest, 0, Z2, F@_1,
					  TrUserData).

skip_32_m_login_create_toc(<<_:32, Rest/binary>>, Z1,
			   Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_login_create_toc(Rest, Z1, Z2,
					  F@_1, TrUserData).

skip_64_m_login_create_toc(<<_:64, Rest/binary>>, Z1,
			   Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_login_create_toc(Rest, Z1, Z2,
					  F@_1, TrUserData).

decode_msg_m_login_enter_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_login_enter_tos(Bin, 0, 0,
					 id(undefined, TrUserData), TrUserData).

dfp_read_field_def_m_login_enter_tos(<<9, Rest/binary>>,
				     Z1, Z2, F@_1, TrUserData) ->
    d_field_m_login_enter_tos_role_id(Rest, Z1, Z2, F@_1,
				      TrUserData);
dfp_read_field_def_m_login_enter_tos(<<>>, 0, 0, F@_1,
				     _) ->
    #m_login_enter_tos{role_id = F@_1};
dfp_read_field_def_m_login_enter_tos(Other, Z1, Z2,
				     F@_1, TrUserData) ->
    dg_read_field_def_m_login_enter_tos(Other, Z1, Z2, F@_1,
					TrUserData).

dg_read_field_def_m_login_enter_tos(<<1:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_login_enter_tos(Rest, N + 7,
					X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_m_login_enter_tos(<<0:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      9 ->
	  d_field_m_login_enter_tos_role_id(Rest, 0, 0, F@_1,
					    TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_login_enter_tos(Rest, 0, 0, F@_1,
					      TrUserData);
	    1 ->
		skip_64_m_login_enter_tos(Rest, 0, 0, F@_1, TrUserData);
	    2 ->
		skip_length_delimited_m_login_enter_tos(Rest, 0, 0,
							F@_1, TrUserData);
	    3 ->
		skip_group_m_login_enter_tos(Rest, Key bsr 3, 0, F@_1,
					     TrUserData);
	    5 ->
		skip_32_m_login_enter_tos(Rest, 0, 0, F@_1, TrUserData)
	  end
    end;
dg_read_field_def_m_login_enter_tos(<<>>, 0, 0, F@_1,
				    _) ->
    #m_login_enter_tos{role_id = F@_1}.

d_field_m_login_enter_tos_role_id(<<Value:64/little,
				    Rest/binary>>,
				  Z1, Z2, _, TrUserData) ->
    dfp_read_field_def_m_login_enter_tos(Rest, Z1, Z2,
					 id(Value, TrUserData), TrUserData).

skip_varint_m_login_enter_tos(<<1:1, _:7, Rest/binary>>,
			      Z1, Z2, F@_1, TrUserData) ->
    skip_varint_m_login_enter_tos(Rest, Z1, Z2, F@_1,
				  TrUserData);
skip_varint_m_login_enter_tos(<<0:1, _:7, Rest/binary>>,
			      Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_login_enter_tos(Rest, Z1, Z2, F@_1,
					 TrUserData).

skip_length_delimited_m_login_enter_tos(<<1:1, X:7,
					  Rest/binary>>,
					N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_login_enter_tos(Rest, N + 7,
					    X bsl N + Acc, F@_1, TrUserData);
skip_length_delimited_m_login_enter_tos(<<0:1, X:7,
					  Rest/binary>>,
					N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_login_enter_tos(Rest2, 0, 0, F@_1,
					 TrUserData).

skip_group_m_login_enter_tos(Bin, FNum, Z2, F@_1,
			     TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_login_enter_tos(Rest, 0, Z2, F@_1,
					 TrUserData).

skip_32_m_login_enter_tos(<<_:32, Rest/binary>>, Z1, Z2,
			  F@_1, TrUserData) ->
    dfp_read_field_def_m_login_enter_tos(Rest, Z1, Z2, F@_1,
					 TrUserData).

skip_64_m_login_enter_tos(<<_:64, Rest/binary>>, Z1, Z2,
			  F@_1, TrUserData) ->
    dfp_read_field_def_m_login_enter_tos(Rest, Z1, Z2, F@_1,
					 TrUserData).

decode_msg_m_login_enter_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_login_enter_toc(Bin, 0, 0,
					 id([], TrUserData),
					 id(undefined, TrUserData),
					 id(undefined, TrUserData),
					 id(undefined, TrUserData), TrUserData).

dfp_read_field_def_m_login_enter_toc(<<10,
				       Rest/binary>>,
				     Z1, Z2, F@_1, F@_2, F@_3, F@_4,
				     TrUserData) ->
    d_pfield_m_login_enter_toc_suids(Rest, Z1, Z2, F@_1,
				     F@_2, F@_3, F@_4, TrUserData);
dfp_read_field_def_m_login_enter_toc(<<8, Rest/binary>>,
				     Z1, Z2, F@_1, F@_2, F@_3, F@_4,
				     TrUserData) ->
    d_field_m_login_enter_toc_suids(Rest, Z1, Z2, F@_1,
				    F@_2, F@_3, F@_4, TrUserData);
dfp_read_field_def_m_login_enter_toc(<<16,
				       Rest/binary>>,
				     Z1, Z2, F@_1, F@_2, F@_3, F@_4,
				     TrUserData) ->
    d_field_m_login_enter_toc_open(Rest, Z1, Z2, F@_1, F@_2,
				   F@_3, F@_4, TrUserData);
dfp_read_field_def_m_login_enter_toc(<<24,
				       Rest/binary>>,
				     Z1, Z2, F@_1, F@_2, F@_3, F@_4,
				     TrUserData) ->
    d_field_m_login_enter_toc_merge(Rest, Z1, Z2, F@_1,
				    F@_2, F@_3, F@_4, TrUserData);
dfp_read_field_def_m_login_enter_toc(<<34,
				       Rest/binary>>,
				     Z1, Z2, F@_1, F@_2, F@_3, F@_4,
				     TrUserData) ->
    d_field_m_login_enter_toc_token(Rest, Z1, Z2, F@_1,
				    F@_2, F@_3, F@_4, TrUserData);
dfp_read_field_def_m_login_enter_toc(<<>>, 0, 0, R1,
				     F@_2, F@_3, F@_4, TrUserData) ->
    #m_login_enter_toc{suids =
			   lists_reverse(R1, TrUserData),
		       open = F@_2, merge = F@_3, token = F@_4};
dfp_read_field_def_m_login_enter_toc(Other, Z1, Z2,
				     F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    dg_read_field_def_m_login_enter_toc(Other, Z1, Z2, F@_1,
					F@_2, F@_3, F@_4, TrUserData).

dg_read_field_def_m_login_enter_toc(<<1:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_login_enter_toc(Rest, N + 7,
					X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
					TrUserData);
dg_read_field_def_m_login_enter_toc(<<0:1, X:7,
				      Rest/binary>>,
    ...
    case Key of
      10 ->
	  d_pfield_m_login_enter_toc_suids(Rest, 0, 0, F@_1, F@_2,
					   F@_3, F@_4, TrUserData);
      8 ->
	  d_field_m_login_enter_toc_suids(Rest, 0, 0, F@_1, F@_2,
					  F@_3, F@_4, TrUserData);
      16 ->
	  d_field_m_login_enter_toc_open(Rest, 0, 0, F@_1, F@_2,
					 F@_3, F@_4, TrUserData);
      24 ->
	  d_field_m_login_enter_toc_merge(Rest, 0, 0, F@_1, F@_2,
					  F@_3, F@_4, TrUserData);
      34 ->
	  d_field_m_login_enter_toc_token(Rest, 0, 0, F@_1, F@_2,
					  F@_3, F@_4, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_login_enter_toc(Rest, 0, 0, F@_1, F@_2,
					      F@_3, F@_4, TrUserData);
	    1 ->
		skip_64_m_login_enter_toc(Rest, 0, 0, F@_1, F@_2, F@_3,
					  F@_4, TrUserData);
	    2 ->
		skip_length_delimited_m_login_enter_toc(Rest, 0, 0,
							F@_1, F@_2, F@_3, F@_4,
							TrUserData);
	    3 ->
		skip_group_m_login_enter_toc(Rest, Key bsr 3, 0, F@_1,
					     F@_2, F@_3, F@_4, TrUserData);
	    5 ->
		skip_32_m_login_enter_toc(Rest, 0, 0, F@_1, F@_2, F@_3,
					  F@_4, TrUserData)
	  end
    end;
dg_read_field_def_m_login_enter_toc(<<>>, 0, 0, R1,
				    F@_2, F@_3, F@_4, TrUserData) ->
    #m_login_enter_toc{suids =
			   lists_reverse(R1, TrUserData),
		       open = F@_2, merge = F@_3, token = F@_4}.

d_field_m_login_enter_toc_suids(<<1:1, X:7,
				  Rest/binary>>,
				N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData)
    when N < 57 ->
    d_field_m_login_enter_toc_suids(Rest, N + 7,
				    X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
				    TrUserData);
d_field_m_login_enter_toc_suids(<<0:1, X:7,
				  Rest/binary>>,
    ...
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    dfp_read_field_def_m_login_enter_toc(RestF, 0, 0,
					 cons(NewFValue, Prev, TrUserData),
					 F@_2, F@_3, F@_4, TrUserData).

d_pfield_m_login_enter_toc_suids(<<1:1, X:7,
				   Rest/binary>>,
				 N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData)
    when N < 57 ->
    d_pfield_m_login_enter_toc_suids(Rest, N + 7,
				     X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
				     TrUserData);
d_pfield_m_login_enter_toc_suids(<<0:1, X:7,
				   Rest/binary>>,
				 N, Acc, E, F@_2, F@_3, F@_4, TrUserData) ->
    Len = X bsl N + Acc,
    <<PackedBytes:Len/binary, Rest2/binary>> = Rest,
    NewSeq =
	d_packed_field_m_login_enter_toc_suids(PackedBytes, 0,
					       0, E, TrUserData),
    dfp_read_field_def_m_login_enter_toc(Rest2, 0, 0,
					 NewSeq, F@_2, F@_3, F@_4, TrUserData).

d_packed_field_m_login_enter_toc_suids(<<1:1, X:7,
					 Rest/binary>>,
				       N, Acc, AccSeq, TrUserData)
    when N < 57 ->
    d_packed_field_m_login_enter_toc_suids(Rest, N + 7,
					   X bsl N + Acc, AccSeq, TrUserData);
d_packed_field_m_login_enter_toc_suids(<<0:1, X:7,
					 Rest/binary>>,
				       N, Acc, AccSeq, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    d_packed_field_m_login_enter_toc_suids(RestF, 0, 0,
					   [NewFValue | AccSeq], TrUserData);
d_packed_field_m_login_enter_toc_suids(<<>>, 0, 0,
				       AccSeq, _) ->
    AccSeq.

d_field_m_login_enter_toc_open(<<1:1, X:7,
				 Rest/binary>>,
			       N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData)
    when N < 57 ->
    d_field_m_login_enter_toc_open(Rest, N + 7,
				   X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
				   TrUserData);
d_field_m_login_enter_toc_open(<<0:1, X:7,
				 Rest/binary>>,
    ...
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    dfp_read_field_def_m_login_enter_toc(RestF, 0, 0, F@_1,
					 NewFValue, F@_3, F@_4, TrUserData).

d_field_m_login_enter_toc_merge(<<1:1, X:7,
				  Rest/binary>>,
				N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData)
    when N < 57 ->
    d_field_m_login_enter_toc_merge(Rest, N + 7,
				    X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
				    TrUserData);
d_field_m_login_enter_toc_merge(<<0:1, X:7,
				  Rest/binary>>,
...
d_field_m_login_enter_toc_token(<<1:1, X:7,
				  Rest/binary>>,
				N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData)
    when N < 57 ->
    d_field_m_login_enter_toc_token(Rest, N + 7,
				    X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
				    TrUserData);
d_field_m_login_enter_toc_token(<<0:1, X:7,
				  Rest/binary>>,
...
skip_varint_m_login_enter_toc(<<1:1, _:7, Rest/binary>>,
			      Z1, Z2, F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    skip_varint_m_login_enter_toc(Rest, Z1, Z2, F@_1, F@_2,
				  F@_3, F@_4, TrUserData);
skip_varint_m_login_enter_toc(<<0:1, _:7, Rest/binary>>,
			      Z1, Z2, F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    dfp_read_field_def_m_login_enter_toc(Rest, Z1, Z2, F@_1,
					 F@_2, F@_3, F@_4, TrUserData).

skip_length_delimited_m_login_enter_toc(<<1:1, X:7,
					  Rest/binary>>,
					N, Acc, F@_1, F@_2, F@_3, F@_4,
					TrUserData)
    when N < 57 ->
    skip_length_delimited_m_login_enter_toc(Rest, N + 7,
					    X bsl N + Acc, F@_1, F@_2, F@_3,
					    F@_4, TrUserData);
skip_length_delimited_m_login_enter_toc(<<0:1, X:7,
					  Rest/binary>>,
					N, Acc, F@_1, F@_2, F@_3, F@_4,
					TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_login_enter_toc(Rest2, 0, 0, F@_1,
					 F@_2, F@_3, F@_4, TrUserData).

skip_group_m_login_enter_toc(Bin, FNum, Z2, F@_1, F@_2,
			     F@_3, F@_4, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_login_enter_toc(Rest, 0, Z2, F@_1,
					 F@_2, F@_3, F@_4, TrUserData).

skip_32_m_login_enter_toc(<<_:32, Rest/binary>>, Z1, Z2,
			  F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    dfp_read_field_def_m_login_enter_toc(Rest, Z1, Z2, F@_1,
					 F@_2, F@_3, F@_4, TrUserData).

skip_64_m_login_enter_toc(<<_:64, Rest/binary>>, Z1, Z2,
			  F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    dfp_read_field_def_m_login_enter_toc(Rest, Z1, Z2, F@_1,
					 F@_2, F@_3, F@_4, TrUserData).

decode_msg_m_login_name_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_login_name_tos(Bin, 0, 0,
					id(undefined, TrUserData), TrUserData).

dfp_read_field_def_m_login_name_tos(<<8, Rest/binary>>,
				    Z1, Z2, F@_1, TrUserData) ->
    d_field_m_login_name_tos_gender(Rest, Z1, Z2, F@_1,
				    TrUserData);
dfp_read_field_def_m_login_name_tos(<<>>, 0, 0, F@_1,
				    _) ->
    #m_login_name_tos{gender = F@_1};
dfp_read_field_def_m_login_name_tos(Other, Z1, Z2, F@_1,
				    TrUserData) ->
    dg_read_field_def_m_login_name_tos(Other, Z1, Z2, F@_1,
				       TrUserData).

dg_read_field_def_m_login_name_tos(<<1:1, X:7,
				     Rest/binary>>,
				   N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_login_name_tos(Rest, N + 7,
				       X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_m_login_name_tos(<<0:1, X:7,
				     Rest/binary>>,
				   N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_login_name_tos_gender(Rest, 0, 0, F@_1,
					  TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_login_name_tos(Rest, 0, 0, F@_1,
					     TrUserData);
	    1 ->
		skip_64_m_login_name_tos(Rest, 0, 0, F@_1, TrUserData);
	    2 ->
		skip_length_delimited_m_login_name_tos(Rest, 0, 0, F@_1,
						       TrUserData);
	    3 ->
		skip_group_m_login_name_tos(Rest, Key bsr 3, 0, F@_1,
					    TrUserData);
	    5 ->
		skip_32_m_login_name_tos(Rest, 0, 0, F@_1, TrUserData)
	  end
    end;
dg_read_field_def_m_login_name_tos(<<>>, 0, 0, F@_1,
				   _) ->
    #m_login_name_tos{gender = F@_1}.

d_field_m_login_name_tos_gender(<<1:1, X:7,
				  Rest/binary>>,
				N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_m_login_name_tos_gender(Rest, N + 7,
				    X bsl N + Acc, F@_1, TrUserData);
d_field_m_login_name_tos_gender(<<0:1, X:7,
				  Rest/binary>>,
				N, Acc, _, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    dfp_read_field_def_m_login_name_tos(RestF, 0, 0,
					NewFValue, TrUserData).

skip_varint_m_login_name_tos(<<1:1, _:7, Rest/binary>>,
			     Z1, Z2, F@_1, TrUserData) ->
    skip_varint_m_login_name_tos(Rest, Z1, Z2, F@_1,
				 TrUserData);
skip_varint_m_login_name_tos(<<0:1, _:7, Rest/binary>>,
			     Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_login_name_tos(Rest, Z1, Z2, F@_1,
					TrUserData).

skip_length_delimited_m_login_name_tos(<<1:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_login_name_tos(Rest, N + 7,
					   X bsl N + Acc, F@_1, TrUserData);
skip_length_delimited_m_login_name_tos(<<0:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_login_name_tos(Rest2, 0, 0, F@_1,
					TrUserData).

skip_group_m_login_name_tos(Bin, FNum, Z2, F@_1,
			    TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_login_name_tos(Rest, 0, Z2, F@_1,
					TrUserData).

skip_32_m_login_name_tos(<<_:32, Rest/binary>>, Z1, Z2,
			 F@_1, TrUserData) ->
    dfp_read_field_def_m_login_name_tos(Rest, Z1, Z2, F@_1,
					TrUserData).

skip_64_m_login_name_tos(<<_:64, Rest/binary>>, Z1, Z2,
			 F@_1, TrUserData) ->
    dfp_read_field_def_m_login_name_tos(Rest, Z1, Z2, F@_1,
					TrUserData).

decode_msg_m_login_name_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_login_name_toc(Bin, 0, 0,
					id(undefined, TrUserData), TrUserData).

dfp_read_field_def_m_login_name_toc(<<10, Rest/binary>>,
				    Z1, Z2, F@_1, TrUserData) ->
    d_field_m_login_name_toc_name(Rest, Z1, Z2, F@_1,
				  TrUserData);
dfp_read_field_def_m_login_name_toc(<<>>, 0, 0, F@_1,
				    _) ->
    #m_login_name_toc{name = F@_1};
dfp_read_field_def_m_login_name_toc(Other, Z1, Z2, F@_1,
				    TrUserData) ->
    dg_read_field_def_m_login_name_toc(Other, Z1, Z2, F@_1,
				       TrUserData).

dg_read_field_def_m_login_name_toc(<<1:1, X:7,
				     Rest/binary>>,
				   N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_login_name_toc(Rest, N + 7,
				       X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_m_login_name_toc(<<0:1, X:7,
				     Rest/binary>>,
				   N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      10 ->
	  d_field_m_login_name_toc_name(Rest, 0, 0, F@_1,
					TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_login_name_toc(Rest, 0, 0, F@_1,
					     TrUserData);
	    1 ->
		skip_64_m_login_name_toc(Rest, 0, 0, F@_1, TrUserData);
	    2 ->
		skip_length_delimited_m_login_name_toc(Rest, 0, 0, F@_1,
						       TrUserData);
	    3 ->
		skip_group_m_login_name_toc(Rest, Key bsr 3, 0, F@_1,
					    TrUserData);
	    5 ->
		skip_32_m_login_name_toc(Rest, 0, 0, F@_1, TrUserData)
	  end
    end;
dg_read_field_def_m_login_name_toc(<<>>, 0, 0, F@_1,
				   _) ->
    #m_login_name_toc{name = F@_1}.

d_field_m_login_name_toc_name(<<1:1, X:7, Rest/binary>>,
			      N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_m_login_name_toc_name(Rest, N + 7,
				  X bsl N + Acc, F@_1, TrUserData);
d_field_m_login_name_toc_name(<<0:1, X:7, Rest/binary>>,
			      N, Acc, _, TrUserData) ->
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
			   <<Utf8:Len/binary, Rest2/binary>> = Rest,
    ...
    dfp_read_field_def_m_login_name_toc(RestF, 0, 0,
					NewFValue, TrUserData).

skip_varint_m_login_name_toc(<<1:1, _:7, Rest/binary>>,
			     Z1, Z2, F@_1, TrUserData) ->
    skip_varint_m_login_name_toc(Rest, Z1, Z2, F@_1,
				 TrUserData);
skip_varint_m_login_name_toc(<<0:1, _:7, Rest/binary>>,
			     Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_login_name_toc(Rest, Z1, Z2, F@_1,
					TrUserData).

skip_length_delimited_m_login_name_toc(<<1:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_login_name_toc(Rest, N + 7,
					   X bsl N + Acc, F@_1, TrUserData);
skip_length_delimited_m_login_name_toc(<<0:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_login_name_toc(Rest2, 0, 0, F@_1,
					TrUserData).

skip_group_m_login_name_toc(Bin, FNum, Z2, F@_1,
			    TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_login_name_toc(Rest, 0, Z2, F@_1,
					TrUserData).

skip_32_m_login_name_toc(<<_:32, Rest/binary>>, Z1, Z2,
			 F@_1, TrUserData) ->
    dfp_read_field_def_m_login_name_toc(Rest, Z1, Z2, F@_1,
					TrUserData).

skip_64_m_login_name_toc(<<_:64, Rest/binary>>, Z1, Z2,
			 F@_1, TrUserData) ->
    dfp_read_field_def_m_login_name_toc(Rest, Z1, Z2, F@_1,
					TrUserData).

decode_msg_m_login_reconn_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_login_reconn_tos(Bin, 0, 0,
					  id(undefined, TrUserData),
					  id(undefined, TrUserData),
					  TrUserData).

dfp_read_field_def_m_login_reconn_tos(<<9,
					Rest/binary>>,
				      Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_login_reconn_tos_role_id(Rest, Z1, Z2, F@_1,
				       F@_2, TrUserData);
dfp_read_field_def_m_login_reconn_tos(<<18,
					Rest/binary>>,
				      Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_login_reconn_tos_token(Rest, Z1, Z2, F@_1,
				     F@_2, TrUserData);
dfp_read_field_def_m_login_reconn_tos(<<>>, 0, 0, F@_1,
				      F@_2, _) ->
    #m_login_reconn_tos{role_id = F@_1, token = F@_2};
dfp_read_field_def_m_login_reconn_tos(Other, Z1, Z2,
				      F@_1, F@_2, TrUserData) ->
    dg_read_field_def_m_login_reconn_tos(Other, Z1, Z2,
					 F@_1, F@_2, TrUserData).

dg_read_field_def_m_login_reconn_tos(<<1:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, F@_2, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_login_reconn_tos(Rest, N + 7,
					 X bsl N + Acc, F@_1, F@_2, TrUserData);
dg_read_field_def_m_login_reconn_tos(<<0:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, F@_2, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      9 ->
	  d_field_m_login_reconn_tos_role_id(Rest, 0, 0, F@_1,
					     F@_2, TrUserData);
      18 ->
	  d_field_m_login_reconn_tos_token(Rest, 0, 0, F@_1, F@_2,
					   TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_login_reconn_tos(Rest, 0, 0, F@_1, F@_2,
					       TrUserData);
	    1 ->
		skip_64_m_login_reconn_tos(Rest, 0, 0, F@_1, F@_2,
					   TrUserData);
	    2 ->
		skip_length_delimited_m_login_reconn_tos(Rest, 0, 0,
							 F@_1, F@_2,
							 TrUserData);
	    3 ->
		skip_group_m_login_reconn_tos(Rest, Key bsr 3, 0, F@_1,
					      F@_2, TrUserData);
	    5 ->
		skip_32_m_login_reconn_tos(Rest, 0, 0, F@_1, F@_2,
					   TrUserData)
	  end
    end;
dg_read_field_def_m_login_reconn_tos(<<>>, 0, 0, F@_1,
				     F@_2, _) ->
    #m_login_reconn_tos{role_id = F@_1, token = F@_2}.

d_field_m_login_reconn_tos_role_id(<<Value:64/little,
				     Rest/binary>>,
				   Z1, Z2, _, F@_2, TrUserData) ->
    dfp_read_field_def_m_login_reconn_tos(Rest, Z1, Z2,
					  id(Value, TrUserData), F@_2,
					  TrUserData).

d_field_m_login_reconn_tos_token(<<1:1, X:7,
				   Rest/binary>>,
				 N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_login_reconn_tos_token(Rest, N + 7,
				     X bsl N + Acc, F@_1, F@_2, TrUserData);
d_field_m_login_reconn_tos_token(<<0:1, X:7,
				   Rest/binary>>,
    ...
    dfp_read_field_def_m_login_reconn_tos(RestF, 0, 0, F@_1,
					  NewFValue, TrUserData).

skip_varint_m_login_reconn_tos(<<1:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, F@_1, F@_2, TrUserData) ->
    skip_varint_m_login_reconn_tos(Rest, Z1, Z2, F@_1, F@_2,
				   TrUserData);
skip_varint_m_login_reconn_tos(<<0:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_login_reconn_tos(Rest, Z1, Z2,
					  F@_1, F@_2, TrUserData).

skip_length_delimited_m_login_reconn_tos(<<1:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_login_reconn_tos(Rest, N + 7,
					     X bsl N + Acc, F@_1, F@_2,
					     TrUserData);
skip_length_delimited_m_login_reconn_tos(<<0:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, F@_2, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_login_reconn_tos(Rest2, 0, 0, F@_1,
					  F@_2, TrUserData).

skip_group_m_login_reconn_tos(Bin, FNum, Z2, F@_1, F@_2,
			      TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_login_reconn_tos(Rest, 0, Z2, F@_1,
					  F@_2, TrUserData).

skip_32_m_login_reconn_tos(<<_:32, Rest/binary>>, Z1,
			   Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_login_reconn_tos(Rest, Z1, Z2,
					  F@_1, F@_2, TrUserData).

skip_64_m_login_reconn_tos(<<_:64, Rest/binary>>, Z1,
			   Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_login_reconn_tos(Rest, Z1, Z2,
					  F@_1, F@_2, TrUserData).

decode_msg_m_login_reconn_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_login_reconn_toc(Bin, 0, 0,
					  TrUserData).

dfp_read_field_def_m_login_reconn_toc(<<>>, 0, 0, _) ->
    #m_login_reconn_toc{};
dfp_read_field_def_m_login_reconn_toc(Other, Z1, Z2,
				      TrUserData) ->
    dg_read_field_def_m_login_reconn_toc(Other, Z1, Z2,
					 TrUserData).

dg_read_field_def_m_login_reconn_toc(<<1:1, X:7,
				       Rest/binary>>,
				     N, Acc, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_login_reconn_toc(Rest, N + 7,
					 X bsl N + Acc, TrUserData);
dg_read_field_def_m_login_reconn_toc(<<0:1, X:7,
				       Rest/binary>>,
				     N, Acc, TrUserData) ->
    Key = X bsl N + Acc,
    case Key band 7 of
      0 ->
	  skip_varint_m_login_reconn_toc(Rest, 0, 0, TrUserData);
      1 -> skip_64_m_login_reconn_toc(Rest, 0, 0, TrUserData);
      2 ->
	  skip_length_delimited_m_login_reconn_toc(Rest, 0, 0,
						   TrUserData);
      3 ->
	  skip_group_m_login_reconn_toc(Rest, Key bsr 3, 0,
					TrUserData);
      5 -> skip_32_m_login_reconn_toc(Rest, 0, 0, TrUserData)
    end;
dg_read_field_def_m_login_reconn_toc(<<>>, 0, 0, _) ->
    #m_login_reconn_toc{}.

skip_varint_m_login_reconn_toc(<<1:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, TrUserData) ->
    skip_varint_m_login_reconn_toc(Rest, Z1, Z2,
				   TrUserData);
skip_varint_m_login_reconn_toc(<<0:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, TrUserData) ->
    dfp_read_field_def_m_login_reconn_toc(Rest, Z1, Z2,
					  TrUserData).

skip_length_delimited_m_login_reconn_toc(<<1:1, X:7,
					   Rest/binary>>,
					 N, Acc, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_login_reconn_toc(Rest, N + 7,
					     X bsl N + Acc, TrUserData);
skip_length_delimited_m_login_reconn_toc(<<0:1, X:7,
					   Rest/binary>>,
					 N, Acc, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_login_reconn_toc(Rest2, 0, 0,
					  TrUserData).

skip_group_m_login_reconn_toc(Bin, FNum, Z2,
			      TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_login_reconn_toc(Rest, 0, Z2,
					  TrUserData).

skip_32_m_login_reconn_toc(<<_:32, Rest/binary>>, Z1,
			   Z2, TrUserData) ->
    dfp_read_field_def_m_login_reconn_toc(Rest, Z1, Z2,
					  TrUserData).

skip_64_m_login_reconn_toc(<<_:64, Rest/binary>>, Z1,
			   Z2, TrUserData) ->
    dfp_read_field_def_m_login_reconn_toc(Rest, Z1, Z2,
					  TrUserData).

decode_msg_m_login_leave_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_login_leave_tos(Bin, 0, 0,
					 TrUserData).

dfp_read_field_def_m_login_leave_tos(<<>>, 0, 0, _) ->
    #m_login_leave_tos{};
dfp_read_field_def_m_login_leave_tos(Other, Z1, Z2,
				     TrUserData) ->
    dg_read_field_def_m_login_leave_tos(Other, Z1, Z2,
					TrUserData).

dg_read_field_def_m_login_leave_tos(<<1:1, X:7,
				      Rest/binary>>,
				    N, Acc, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_login_leave_tos(Rest, N + 7,
					X bsl N + Acc, TrUserData);
dg_read_field_def_m_login_leave_tos(<<0:1, X:7,
				      Rest/binary>>,
				    N, Acc, TrUserData) ->
    Key = X bsl N + Acc,
    case Key band 7 of
      0 ->
	  skip_varint_m_login_leave_tos(Rest, 0, 0, TrUserData);
      1 -> skip_64_m_login_leave_tos(Rest, 0, 0, TrUserData);
      2 ->
	  skip_length_delimited_m_login_leave_tos(Rest, 0, 0,
						  TrUserData);
      3 ->
	  skip_group_m_login_leave_tos(Rest, Key bsr 3, 0,
				       TrUserData);
      5 -> skip_32_m_login_leave_tos(Rest, 0, 0, TrUserData)
    end;
dg_read_field_def_m_login_leave_tos(<<>>, 0, 0, _) ->
    #m_login_leave_tos{}.

skip_varint_m_login_leave_tos(<<1:1, _:7, Rest/binary>>,
			      Z1, Z2, TrUserData) ->
    skip_varint_m_login_leave_tos(Rest, Z1, Z2, TrUserData);
skip_varint_m_login_leave_tos(<<0:1, _:7, Rest/binary>>,
			      Z1, Z2, TrUserData) ->
    dfp_read_field_def_m_login_leave_tos(Rest, Z1, Z2,
					 TrUserData).

skip_length_delimited_m_login_leave_tos(<<1:1, X:7,
					  Rest/binary>>,
					N, Acc, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_login_leave_tos(Rest, N + 7,
					    X bsl N + Acc, TrUserData);
skip_length_delimited_m_login_leave_tos(<<0:1, X:7,
					  Rest/binary>>,
					N, Acc, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_login_leave_tos(Rest2, 0, 0,
					 TrUserData).

skip_group_m_login_leave_tos(Bin, FNum, Z2,
			     TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_login_leave_tos(Rest, 0, Z2,
					 TrUserData).

skip_32_m_login_leave_tos(<<_:32, Rest/binary>>, Z1, Z2,
			  TrUserData) ->
    dfp_read_field_def_m_login_leave_tos(Rest, Z1, Z2,
					 TrUserData).

skip_64_m_login_leave_tos(<<_:64, Rest/binary>>, Z1, Z2,
			  TrUserData) ->
    dfp_read_field_def_m_login_leave_tos(Rest, Z1, Z2,
					 TrUserData).

decode_msg_m_login_leave_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_login_leave_toc(Bin, 0, 0,
					 TrUserData).

dfp_read_field_def_m_login_leave_toc(<<>>, 0, 0, _) ->
    #m_login_leave_toc{};
dfp_read_field_def_m_login_leave_toc(Other, Z1, Z2,
				     TrUserData) ->
    dg_read_field_def_m_login_leave_toc(Other, Z1, Z2,
					TrUserData).

dg_read_field_def_m_login_leave_toc(<<1:1, X:7,
				      Rest/binary>>,
				    N, Acc, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_login_leave_toc(Rest, N + 7,
					X bsl N + Acc, TrUserData);
dg_read_field_def_m_login_leave_toc(<<0:1, X:7,
				      Rest/binary>>,
				    N, Acc, TrUserData) ->
    Key = X bsl N + Acc,
    case Key band 7 of
      0 ->
	  skip_varint_m_login_leave_toc(Rest, 0, 0, TrUserData);
      1 -> skip_64_m_login_leave_toc(Rest, 0, 0, TrUserData);
      2 ->
	  skip_length_delimited_m_login_leave_toc(Rest, 0, 0,
						  TrUserData);
      3 ->
	  skip_group_m_login_leave_toc(Rest, Key bsr 3, 0,
				       TrUserData);
      5 -> skip_32_m_login_leave_toc(Rest, 0, 0, TrUserData)
    end;
dg_read_field_def_m_login_leave_toc(<<>>, 0, 0, _) ->
    #m_login_leave_toc{}.

skip_varint_m_login_leave_toc(<<1:1, _:7, Rest/binary>>,
			      Z1, Z2, TrUserData) ->
    skip_varint_m_login_leave_toc(Rest, Z1, Z2, TrUserData);
skip_varint_m_login_leave_toc(<<0:1, _:7, Rest/binary>>,
			      Z1, Z2, TrUserData) ->
    dfp_read_field_def_m_login_leave_toc(Rest, Z1, Z2,
					 TrUserData).

skip_length_delimited_m_login_leave_toc(<<1:1, X:7,
					  Rest/binary>>,
					N, Acc, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_login_leave_toc(Rest, N + 7,
					    X bsl N + Acc, TrUserData);
skip_length_delimited_m_login_leave_toc(<<0:1, X:7,
					  Rest/binary>>,
					N, Acc, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_login_leave_toc(Rest2, 0, 0,
					 TrUserData).

skip_group_m_login_leave_toc(Bin, FNum, Z2,
			     TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_login_leave_toc(Rest, 0, Z2,
					 TrUserData).

skip_32_m_login_leave_toc(<<_:32, Rest/binary>>, Z1, Z2,
			  TrUserData) ->
    dfp_read_field_def_m_login_leave_toc(Rest, Z1, Z2,
					 TrUserData).

skip_64_m_login_leave_toc(<<_:64, Rest/binary>>, Z1, Z2,
			  TrUserData) ->
    dfp_read_field_def_m_login_leave_toc(Rest, Z1, Z2,
					 TrUserData).
...
merge_msgs(Prev, New, MsgName, Opts) ->
    ...
    case MsgName of
      m_login_verify_tos ->
	  merge_msg_m_login_verify_tos(Prev, New, TrUserData);
      m_login_verify_toc ->
	  merge_msg_m_login_verify_toc(Prev, New, TrUserData);
      m_login_create_tos ->
	  merge_msg_m_login_create_tos(Prev, New, TrUserData);
      m_login_create_toc ->
	  merge_msg_m_login_create_toc(Prev, New, TrUserData);
      m_login_enter_tos ->
	  merge_msg_m_login_enter_tos(Prev, New, TrUserData);
      m_login_enter_toc ->
	  merge_msg_m_login_enter_toc(Prev, New, TrUserData);
      m_login_name_tos ->
	  merge_msg_m_login_name_tos(Prev, New, TrUserData);
      m_login_name_toc ->
	  merge_msg_m_login_name_toc(Prev, New, TrUserData);
      m_login_reconn_tos ->
	  merge_msg_m_login_reconn_tos(Prev, New, TrUserData);
      m_login_reconn_toc ->
	  merge_msg_m_login_reconn_toc(Prev, New, TrUserData);
      m_login_leave_tos ->
	  merge_msg_m_login_leave_tos(Prev, New, TrUserData);
      m_login_leave_toc ->
	  merge_msg_m_login_leave_toc(Prev, New, TrUserData);
      p_role_base ->
...
-compile({nowarn_unused_function,merge_msg_m_login_verify_tos/3}).
merge_msg_m_login_verify_tos(#m_login_verify_tos{args =
						     PFargs},
			     #m_login_verify_tos{platform = NFplatform,
						 gamechan = NFgamechan,
						 account = NFaccount,
						 token = NFtoken,
						 args = NFargs},
			     TrUserData) ->
    #m_login_verify_tos{platform = NFplatform,
			gamechan = NFgamechan, account = NFaccount,
			token = NFtoken,
			args =
			    if PFargs /= undefined, NFargs /= undefined ->
				   'tr_merge_m_login_verify_tos.args'(PFargs,
								      NFargs,
								      TrUserData);
...
-compile({nowarn_unused_function,merge_msg_m_login_verify_toc/3}).
merge_msg_m_login_verify_toc(#m_login_verify_toc{roles =
						     PFroles},
			     #m_login_verify_toc{career = NFcareer,
						 roles = NFroles},
			     TrUserData) ->
    #m_login_verify_toc{career = NFcareer,
			roles =
...
-compile({nowarn_unused_function,merge_msg_m_login_create_tos/3}).
merge_msg_m_login_create_tos(#m_login_create_tos{},
			     #m_login_create_tos{career = NFcareer,
						 gender = NFgender,
						 name = NFname},
			     _) ->
    #m_login_create_tos{career = NFcareer,
			gender = NFgender, name = NFname}.

-compile({nowarn_unused_function,merge_msg_m_login_create_toc/3}).
merge_msg_m_login_create_toc(#m_login_create_toc{},
			     #m_login_create_toc{role_id = NFrole_id}, _) ->
    #m_login_create_toc{role_id = NFrole_id}.

-compile({nowarn_unused_function,merge_msg_m_login_enter_tos/3}).
merge_msg_m_login_enter_tos(#m_login_enter_tos{},
			    #m_login_enter_tos{role_id = NFrole_id}, _) ->
    #m_login_enter_tos{role_id = NFrole_id}.

-compile({nowarn_unused_function,merge_msg_m_login_enter_toc/3}).
merge_msg_m_login_enter_toc(#m_login_enter_toc{suids =
						   PFsuids},
			    #m_login_enter_toc{suids = NFsuids, open = NFopen,
					       merge = NFmerge,
					       token = NFtoken},
			    TrUserData) ->
    #m_login_enter_toc{suids =
			   if PFsuids /= undefined, NFsuids /= undefined ->
				  'erlang_++'(PFsuids, NFsuids, TrUserData);
			      PFsuids == undefined -> NFsuids;
			      NFsuids == undefined -> PFsuids
			   end,
		       open = NFopen, merge = NFmerge, token = NFtoken}.

-compile({nowarn_unused_function,merge_msg_m_login_name_tos/3}).
merge_msg_m_login_name_tos(#m_login_name_tos{},
			   #m_login_name_tos{gender = NFgender}, _) ->
    #m_login_name_tos{gender = NFgender}.

-compile({nowarn_unused_function,merge_msg_m_login_name_toc/3}).
merge_msg_m_login_name_toc(#m_login_name_toc{},
			   #m_login_name_toc{name = NFname}, _) ->
    #m_login_name_toc{name = NFname}.

-compile({nowarn_unused_function,merge_msg_m_login_reconn_tos/3}).
merge_msg_m_login_reconn_tos(#m_login_reconn_tos{},
			     #m_login_reconn_tos{role_id = NFrole_id,
						 token = NFtoken},
			     _) ->
    #m_login_reconn_tos{role_id = NFrole_id,
			token = NFtoken}.

-compile({nowarn_unused_function,merge_msg_m_login_reconn_toc/3}).
merge_msg_m_login_reconn_toc(_Prev, New, _TrUserData) ->
    New.

-compile({nowarn_unused_function,merge_msg_m_login_leave_tos/3}).
merge_msg_m_login_leave_tos(_Prev, New, _TrUserData) ->
    New.

-compile({nowarn_unused_function,merge_msg_m_login_leave_toc/3}).
merge_msg_m_login_leave_toc(_Prev, New, _TrUserData) ->
    New.
...
verify_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
      m_login_verify_tos ->
	  v_msg_m_login_verify_tos(Msg, [MsgName], TrUserData);
      m_login_verify_toc ->
	  v_msg_m_login_verify_toc(Msg, [MsgName], TrUserData);
      m_login_create_tos ->
	  v_msg_m_login_create_tos(Msg, [MsgName], TrUserData);
      m_login_create_toc ->
	  v_msg_m_login_create_toc(Msg, [MsgName], TrUserData);
      m_login_enter_tos ->
	  v_msg_m_login_enter_tos(Msg, [MsgName], TrUserData);
      m_login_enter_toc ->
	  v_msg_m_login_enter_toc(Msg, [MsgName], TrUserData);
      m_login_name_tos ->
	  v_msg_m_login_name_tos(Msg, [MsgName], TrUserData);
      m_login_name_toc ->
	  v_msg_m_login_name_toc(Msg, [MsgName], TrUserData);
      m_login_reconn_tos ->
	  v_msg_m_login_reconn_tos(Msg, [MsgName], TrUserData);
      m_login_reconn_toc ->
	  v_msg_m_login_reconn_toc(Msg, [MsgName], TrUserData);
      m_login_leave_tos ->
	  v_msg_m_login_leave_tos(Msg, [MsgName], TrUserData);
      m_login_leave_toc ->
	  v_msg_m_login_leave_toc(Msg, [MsgName], TrUserData);
      p_role_base ->
...
-compile({nowarn_unused_function,v_msg_m_login_verify_tos/3}).
-dialyzer({nowarn_function,v_msg_m_login_verify_tos/3}).
v_msg_m_login_verify_tos(#m_login_verify_tos{platform =
						 F1,
					     gamechan = F2, account = F3,
					     token = F4, args = F5},
			 Path, TrUserData) ->
    v_type_string(F1, [platform | Path], TrUserData),
    v_type_string(F2, [gamechan | Path], TrUserData),
    v_type_string(F3, [account | Path], TrUserData),
    v_type_string(F4, [token | Path], TrUserData),
    'v_map<string,string>'(F5, [args | Path], TrUserData),
    ok;
v_msg_m_login_verify_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_login_verify_tos}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_login_verify_toc/3}).
-dialyzer({nowarn_function,v_msg_m_login_verify_toc/3}).
v_msg_m_login_verify_toc(#m_login_verify_toc{career =
						 F1,
					     roles = F2},
			 Path, TrUserData) ->
    ...
    if is_list(F2) ->
	   ...
	   ok;
       true ->
	   mk_type_error({invalid_list_of, {msg, p_role_base}}, F2,
			 [roles | Path])
    end,
    ok;
v_msg_m_login_verify_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_login_verify_toc}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_login_create_tos/3}).
-dialyzer({nowarn_function,v_msg_m_login_create_tos/3}).
v_msg_m_login_create_tos(#m_login_create_tos{career =
						 F1,
					     gender = F2, name = F3},
			 Path, TrUserData) ->
    v_type_int32(F1, [career | Path], TrUserData),
    ...
    ok;
v_msg_m_login_create_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_login_create_tos}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_login_create_toc/3}).
-dialyzer({nowarn_function,v_msg_m_login_create_toc/3}).
v_msg_m_login_create_toc(#m_login_create_toc{role_id =
						 F1},
			 Path, TrUserData) ->
    v_type_fixed64(F1, [role_id | Path], TrUserData), ok;
v_msg_m_login_create_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_login_create_toc}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_login_enter_tos/3}).
-dialyzer({nowarn_function,v_msg_m_login_enter_tos/3}).
v_msg_m_login_enter_tos(#m_login_enter_tos{role_id =
					       F1},
			Path, TrUserData) ->
    v_type_fixed64(F1, [role_id | Path], TrUserData), ok;
v_msg_m_login_enter_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_login_enter_tos}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_login_enter_toc/3}).
-dialyzer({nowarn_function,v_msg_m_login_enter_toc/3}).
v_msg_m_login_enter_toc(#m_login_enter_toc{suids = F1,
					   open = F2, merge = F3, token = F4},
			Path, TrUserData) ->
    if is_list(F1) ->
    ...
    v_type_int32(F2, [open | Path], TrUserData),
    v_type_int32(F3, [merge | Path], TrUserData),
    v_type_string(F4, [token | Path], TrUserData),
    ok;
v_msg_m_login_enter_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_login_enter_toc}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_login_name_tos/3}).
-dialyzer({nowarn_function,v_msg_m_login_name_tos/3}).
v_msg_m_login_name_tos(#m_login_name_tos{gender = F1},
		       Path, TrUserData) ->
    v_type_int32(F1, [gender | Path], TrUserData), ok;
v_msg_m_login_name_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_login_name_tos}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_login_name_toc/3}).
-dialyzer({nowarn_function,v_msg_m_login_name_toc/3}).
v_msg_m_login_name_toc(#m_login_name_toc{name = F1},
		       Path, TrUserData) ->
    v_type_string(F1, [name | Path], TrUserData), ok;
v_msg_m_login_name_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_login_name_toc}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_login_reconn_tos/3}).
-dialyzer({nowarn_function,v_msg_m_login_reconn_tos/3}).
v_msg_m_login_reconn_tos(#m_login_reconn_tos{role_id =
						 F1,
					     token = F2},
			 Path, TrUserData) ->
    ...
    ok;
v_msg_m_login_reconn_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_login_reconn_tos}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_login_reconn_toc/3}).
-dialyzer({nowarn_function,v_msg_m_login_reconn_toc/3}).
v_msg_m_login_reconn_toc(#m_login_reconn_toc{}, _Path,
			 _) ->
    ok;
v_msg_m_login_reconn_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_login_reconn_toc}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_login_leave_tos/3}).
-dialyzer({nowarn_function,v_msg_m_login_leave_tos/3}).
v_msg_m_login_leave_tos(#m_login_leave_tos{}, _Path,
			_) ->
    ok;
v_msg_m_login_leave_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_login_leave_tos}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_login_leave_toc/3}).
-dialyzer({nowarn_function,v_msg_m_login_leave_toc/3}).
v_msg_m_login_leave_toc(#m_login_leave_toc{}, _Path,
			_) ->
    ok;
v_msg_m_login_leave_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_login_leave_toc}, X,
		  Path).
...
-compile({inline,'tr_encode_m_login_verify_tos.args[x]'/2}).
'tr_encode_m_login_verify_tos.args[x]'(X, _) ->
...
-compile({inline,'tr_decode_init_default_m_login_verify_tos.args'/2}).
'tr_decode_init_default_m_login_verify_tos.args'(_,
						 _) ->
    mt_empty_map_m().

-compile({inline,'tr_merge_m_login_verify_tos.args'/3}).
'tr_merge_m_login_verify_tos.args'(X1, X2, _) ->
    mt_merge_maps_m(X1, X2).

-compile({inline,'tr_decode_repeated_finalize_m_login_verify_tos.args'/2}).
'tr_decode_repeated_finalize_m_login_verify_tos.args'(L,
						      TrUserData) ->
    id(L, TrUserData).

-compile({inline,'tr_encode_m_login_verify_tos.args'/2}).
'tr_encode_m_login_verify_tos.args'(X, _) ->
    mt_map_to_list_m(X).

-compile({inline,'tr_decode_repeated_add_elem_m_login_verify_tos.args'/3}).
'tr_decode_repeated_add_elem_m_login_verify_tos.args'(Elem,
						      L, _) ->
    mt_add_item_m(Elem, L).
...
get_msg_defs() ->
    [{{msg, m_login_verify_tos},
      [#field{name = platform, fnum = 1, rnum = 2,
	      type = string, occurrence = required, opts = []},
       #field{name = gamechan, fnum = 2, rnum = 3,
	      type = string, occurrence = required, opts = []},
       #field{name = account, fnum = 3, rnum = 4,
	      type = string, occurrence = required, opts = []},
       #field{name = token, fnum = 4, rnum = 5, type = string,
	      occurrence = required, opts = []},
       #field{name = args, fnum = 5, rnum = 6,
	      type = {map, string, string}, occurrence = repeated,
	      opts = []}]},
     {{msg, m_login_verify_toc},
      [#field{name = career, fnum = 1, rnum = 2, type = int32,
	      occurrence = required, opts = []},
       #field{name = roles, fnum = 2, rnum = 3,
	      type = {msg, p_role_base}, occurrence = repeated,
	      opts = []}]},
     {{msg, m_login_create_tos},
      [#field{name = career, fnum = 1, rnum = 2, type = int32,
	      occurrence = required, opts = []},
       ...
       #field{name = name, fnum = 3, rnum = 4, type = string,
	      occurrence = required, opts = []}]},
     {{msg, m_login_create_toc},
      [#field{name = role_id, fnum = 1, rnum = 2,
	      type = fixed64, occurrence = required, opts = []}]},
     {{msg, m_login_enter_tos},
      [#field{name = role_id, fnum = 1, rnum = 2,
	      type = fixed64, occurrence = required, opts = []}]},
     {{msg, m_login_enter_toc},
      [#field{name = suids, fnum = 1, rnum = 2, type = int32,
	      occurrence = repeated, opts = []},
       #field{name = open, fnum = 2, rnum = 3, type = int32,
	      occurrence = required, opts = []},
       #field{name = merge, fnum = 3, rnum = 4, type = int32,
	      occurrence = required, opts = []},
       #field{name = token, fnum = 4, rnum = 5, type = string,
	      occurrence = required, opts = []}]},
     {{msg, m_login_name_tos},
      [#field{name = gender, fnum = 1, rnum = 2, type = int32,
	      occurrence = required, opts = []}]},
     {{msg, m_login_name_toc},
      [#field{name = name, fnum = 1, rnum = 2, type = string,
	      occurrence = required, opts = []}]},
     {{msg, m_login_reconn_tos},
      [#field{name = role_id, fnum = 1, rnum = 2,
	      type = fixed64, occurrence = required, opts = []},
       #field{name = token, fnum = 2, rnum = 3, type = string,
	      occurrence = required, opts = []}]},
     {{msg, m_login_reconn_toc}, []},
     {{msg, m_login_leave_tos}, []},
     {{msg, m_login_leave_toc}, []},
     {{msg, p_role_base},
...
get_msg_names() ->
    [m_login_verify_tos, m_login_verify_toc,
     m_login_create_tos, m_login_create_toc,
     m_login_enter_tos, m_login_enter_toc, m_login_name_tos,
     m_login_name_toc, m_login_reconn_tos,
     m_login_reconn_toc, m_login_leave_tos,
     m_login_leave_toc, p_role_base, p_aspect, p_attr,
...
find_msg_def(m_login_verify_tos) ->
    [#field{name = platform, fnum = 1, rnum = 2,
	    type = string, occurrence = required, opts = []},
     #field{name = gamechan, fnum = 2, rnum = 3,
	    type = string, occurrence = required, opts = []},
     ...
     #field{name = args, fnum = 5, rnum = 6,
	    type = {map, string, string}, occurrence = repeated,
	    opts = []}];
find_msg_def(m_login_verify_toc) ->
    [#field{name = career, fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []},
     #field{name = roles, fnum = 2, rnum = 3,
	    type = {msg, p_role_base}, occurrence = repeated,
	    opts = []}];
find_msg_def(m_login_create_tos) ->
    [#field{name = career, fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []},
     #field{name = gender, fnum = 2, rnum = 3, type = int32,
	    occurrence = required, opts = []},
     #field{name = name, fnum = 3, rnum = 4, type = string,
	    occurrence = required, opts = []}];
find_msg_def(m_login_create_toc) ->
    [#field{name = role_id, fnum = 1, rnum = 2,
	    type = fixed64, occurrence = required, opts = []}];
find_msg_def(m_login_enter_tos) ->
    [#field{name = role_id, fnum = 1, rnum = 2,
	    type = fixed64, occurrence = required, opts = []}];
find_msg_def(m_login_enter_toc) ->
    [#field{name = suids, fnum = 1, rnum = 2, type = int32,
	    occurrence = repeated, opts = []},
     #field{name = open, fnum = 2, rnum = 3, type = int32,
	    occurrence = required, opts = []},
     ...
     #field{name = token, fnum = 4, rnum = 5, type = string,
	    occurrence = required, opts = []}];
find_msg_def(m_login_name_tos) ->
    [#field{name = gender, fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []}];
find_msg_def(m_login_name_toc) ->
    [#field{name = name, fnum = 1, rnum = 2, type = string,
	    occurrence = required, opts = []}];
find_msg_def(m_login_reconn_tos) ->
    [#field{name = role_id, fnum = 1, rnum = 2,
	    type = fixed64, occurrence = required, opts = []},
     #field{name = token, fnum = 2, rnum = 3, type = string,
	    occurrence = required, opts = []}];
find_msg_def(m_login_reconn_toc) -> [];
find_msg_def(m_login_leave_tos) -> [];
find_msg_def(m_login_leave_toc) -> [];
