...
-ifndef(pb_1140_soul).
-define(pb_1140_soul, true).

-define(pb_1140_soul_gpb_version, "4.5.1").

-ifndef('M_SOUL_LIST_TOS_PB_H').
-define('M_SOUL_LIST_TOS_PB_H', true).
-record(m_soul_list_tos,
        {
        }).
-endif.

-ifndef('M_SOUL_LIST_TOC_PB_H').
-define('M_SOUL_LIST_TOC_PB_H', true).
-record(m_soul_list_toc,
        {souls = #{}            :: #{integer() := pb_1140_soul:p_item()} | undefined % = 1
        }).
-endif.

-ifndef('M_SOUL_PUTON_TOS_PB_H').
-define('M_SOUL_PUTON_TOS_PB_H', true).
-record(m_soul_puton_tos,
        {pos                    :: integer(),       % = 1, 32 bits
         uid                    :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_SOUL_PUTON_TOC_PB_H').
-define('M_SOUL_PUTON_TOC_PB_H', true).
-record(m_soul_puton_toc,
        {
        }).
-endif.

-ifndef('M_SOUL_PUTOFF_TOS_PB_H').
-define('M_SOUL_PUTOFF_TOS_PB_H', true).
-record(m_soul_putoff_tos,
        {pos                    :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_SOUL_PUTOFF_TOC_PB_H').
-define('M_SOUL_PUTOFF_TOC_PB_H', true).
-record(m_soul_putoff_toc,
        {pos = []               :: [integer()] | undefined % = 1, 32 bits
        }).
-endif.

-ifndef('M_SOUL_UPLEVEL_TOS_PB_H').
-define('M_SOUL_UPLEVEL_TOS_PB_H', true).
-record(m_soul_uplevel_tos,
        {pos                    :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_SOUL_UPLEVEL_TOC_PB_H').
-define('M_SOUL_UPLEVEL_TOC_PB_H', true).
-record(m_soul_uplevel_toc,
        {pos                    :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_SOUL_DECOMPOSE_TOS_PB_H').
-define('M_SOUL_DECOMPOSE_TOS_PB_H', true).
-record(m_soul_decompose_tos,
        {uid = []               :: [integer()] | undefined % = 1, 32 bits
        }).
-endif.

-ifndef('M_SOUL_DECOMPOSE_TOC_PB_H').
-define('M_SOUL_DECOMPOSE_TOC_PB_H', true).
-record(m_soul_decompose_toc,
        {
        }).
-endif.

-ifndef('M_SOUL_GET_SET_TOS_PB_H').
-define('M_SOUL_GET_SET_TOS_PB_H', true).
-record(m_soul_get_set_tos,
        {
        }).
-endif.

-ifndef('M_SOUL_GET_SET_TOC_PB_H').
-define('M_SOUL_GET_SET_TOC_PB_H', true).
-record(m_soul_get_set_toc,
        {auto                   :: integer() | undefined, % = 1, 32 bits
         color                  :: integer() | undefined % = 2, 32 bits
        }).
-endif.

-ifndef('M_SOUL_DECOMPOSE_SET_TOS_PB_H').
-define('M_SOUL_DECOMPOSE_SET_TOS_PB_H', true).
-record(m_soul_decompose_set_tos,
        {auto                   :: integer() | undefined, % = 1, 32 bits
         color                  :: integer() | undefined % = 2, 32 bits
        }).
-endif.

-ifndef('M_SOUL_DECOMPOSE_SET_TOC_PB_H').
-define('M_SOUL_DECOMPOSE_SET_TOC_PB_H', true).
-record(m_soul_decompose_set_toc,
        {
        }).
-endif.

-ifndef('M_SOUL_COMBINE_TOS_PB_H').
-define('M_SOUL_COMBINE_TOS_PB_H', true).
-record(m_soul_combine_tos,
        {r_item_id              :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_SOUL_COMBINE_TOC_PB_H').
-define('M_SOUL_COMBINE_TOC_PB_H', true).
-record(m_soul_combine_toc,
        {
        }).
-endif.
...
-record(p_role_base,
        {id                     :: non_neg_integer(), % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1140_soul:p_aspect()} | undefined, % = 8
         ...
         icon                   :: pb_1140_soul:p_icon() | undefined, % = 17
...
-record(p_item,
        {uid                    :: integer(),       % = 1, 32 bits
         ...
         gender                 :: integer(),       % = 7, 32 bits
         score                  :: integer() | undefined, % = 8, 32 bits
         equip                  :: pb_1140_soul:p_equip() | undefined, % = 9
         pet                    :: pb_1140_soul:p_pet() | undefined, % = 10
...
-record(p_equip,
        {base                   :: pb_1140_soul:p_attr(), % = 1
         rare1                  :: pb_1140_soul:p_attr() | undefined, % = 2
         rare2                  :: pb_1140_soul:p_attr() | undefined, % = 3
         rare3                  :: pb_1140_soul:p_attr() | undefined, % = 4
         marriage               :: pb_1140_soul:p_marriage() | undefined, % = 5
         ...
         refine = []            :: [pb_1140_soul:p_refine()] | undefined, % = 11
         suite = #{}            :: #{integer() := integer()} | undefined, % = 12
         combine = []           :: [pb_1140_soul:p_item()] | undefined % = 13
        }).
-endif.
...
-record(p_marriage,
        {husband_id             :: non_neg_integer() | undefined, % = 1, 32 bits
         ...
         rare                   :: pb_1140_soul:p_attr() | undefined % = 5
        }).
-endif.
...
-record(p_actor,
        {uid                    :: non_neg_integer(), % = 1, 32 bits
         ...
         coord                  :: pb_1140_soul:p_coord(), % = 4
         state                  :: integer(),       % = 5, 32 bits
         stargs = #{}           :: #{integer() := iolist()} | undefined, % = 6
         role                   :: pb_1140_soul:p_role() | undefined, % = 7
         creep                  :: pb_1140_soul:p_creep() | undefined, % = 8
         drop                   :: pb_1140_soul:p_drop() | undefined % = 9
        }).
-endif.
...
-record(p_role,
        {career                 :: integer(),       % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1140_soul:p_aspect()} | undefined, % = 5
         ...
         icon                   :: pb_1140_soul:p_icon() | undefined % = 25
        }).
-endif.
...
-record(p_creep,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         buffs = []             :: [pb_1140_soul:p_buff()] | undefined, % = 6
         dir                    :: integer(),       % = 7, 32 bits
         dest                   :: pb_1140_soul:p_coord(), % = 8
...
-record(p_drop,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         coord                  :: pb_1140_soul:p_coord() | undefined, % = 5
...
-record(p_ranking,
        {base                   :: pb_1140_soul:p_role_base() | undefined, % = 1
