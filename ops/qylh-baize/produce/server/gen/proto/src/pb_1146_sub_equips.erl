...
%% message types
-type m_sub_equip_tos() :: #m_sub_equip_tos{}.

-type m_sub_equip_toc() :: #m_sub_equip_toc{}.

-type m_sub_equip_puton_tos() :: #m_sub_equip_puton_tos{}.

-type m_sub_equip_puton_toc() :: #m_sub_equip_puton_toc{}.

-type m_sub_equip_uplevel_tos() :: #m_sub_equip_uplevel_tos{}.

-type m_sub_equip_uplevel_toc() :: #m_sub_equip_uplevel_toc{}.

-type m_sub_equip_decompose_tos() :: #m_sub_equip_decompose_tos{}.

-type m_sub_equip_decompose_toc() :: #m_sub_equip_decompose_toc{}.
...
-export_type(['m_sub_equip_tos'/0, 'm_sub_equip_toc'/0, 'm_sub_equip_puton_tos'/0, 'm_sub_equip_puton_toc'/0, 'm_sub_equip_uplevel_tos'/0, 'm_sub_equip_uplevel_toc'/0, 'm_sub_equip_decompose_tos'/0, 'm_sub_equip_decompose_toc'/0, 'p_role_base'/0, 'p_aspect'/0, 'p_attr'/0, 'p_item_base'/0, 'p_item'/0, 'p_equip'/0, 'p_pet'/0, 'p_marriage'/0, 'p_refine'/0, 'p_actor'/0, 'p_role'/0, 'p_creep'/0, 'p_npc'/0, 'p_drop'/0, 'p_buff'/0, 'p_coord'/0, 'p_icon'/0, 'p_ranking'/0, 'p_dropped'/0]).

-spec encode_msg(#m_sub_equip_tos{} | #m_sub_equip_toc{} | #m_sub_equip_puton_tos{} | #m_sub_equip_puton_toc{} | #m_sub_equip_uplevel_tos{} | #m_sub_equip_uplevel_toc{} | #m_sub_equip_decompose_tos{} | #m_sub_equip_decompose_toc{} | #p_role_base{} | #p_aspect{} | #p_attr{} | #p_item_base{} | #p_item{} | #p_equip{} | #p_pet{} | #p_marriage{} | #p_refine{} | #p_actor{} | #p_role{} | #p_creep{} | #p_npc{} | #p_drop{} | #p_buff{} | #p_coord{} | #p_icon{} | #p_ranking{} | #p_dropped{}) -> binary().
encode_msg(Msg) when tuple_size(Msg) >= 1 ->
    encode_msg(Msg, element(1, Msg), []).

-spec encode_msg(#m_sub_equip_tos{} | #m_sub_equip_toc{} | #m_sub_equip_puton_tos{} | #m_sub_equip_puton_toc{} | #m_sub_equip_uplevel_tos{} | #m_sub_equip_uplevel_toc{} | #m_sub_equip_decompose_tos{} | #m_sub_equip_decompose_toc{} | #p_role_base{} | #p_aspect{} | #p_attr{} | #p_item_base{} | #p_item{} | #p_equip{} | #p_pet{} | #p_marriage{} | #p_refine{} | #p_actor{} | #p_role{} | #p_creep{} | #p_npc{} | #p_drop{} | #p_buff{} | #p_coord{} | #p_icon{} | #p_ranking{} | #p_dropped{}, atom() | list()) -> binary().
...
encode_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
      m_sub_equip_tos ->
	  encode_msg_m_sub_equip_tos(id(Msg, TrUserData),
				     TrUserData);
      m_sub_equip_toc ->
	  encode_msg_m_sub_equip_toc(id(Msg, TrUserData),
				     TrUserData);
      m_sub_equip_puton_tos ->
	  encode_msg_m_sub_equip_puton_tos(id(Msg, TrUserData),
					   TrUserData);
      m_sub_equip_puton_toc ->
	  encode_msg_m_sub_equip_puton_toc(id(Msg, TrUserData),
					   TrUserData);
      m_sub_equip_uplevel_tos ->
	  encode_msg_m_sub_equip_uplevel_tos(id(Msg, TrUserData),
					     TrUserData);
      m_sub_equip_uplevel_toc ->
	  encode_msg_m_sub_equip_uplevel_toc(id(Msg, TrUserData),
					     TrUserData);
      m_sub_equip_decompose_tos ->
	  encode_msg_m_sub_equip_decompose_tos(id(Msg,
						  TrUserData),
					       TrUserData);
      m_sub_equip_decompose_toc ->
	  encode_msg_m_sub_equip_decompose_toc(id(Msg,
						  TrUserData),
					       TrUserData);
      p_role_base ->
...
encode_msg_m_sub_equip_tos(Msg, TrUserData) ->
    encode_msg_m_sub_equip_tos(Msg, <<>>, TrUserData).


encode_msg_m_sub_equip_tos(#m_sub_equip_tos{stype = F1},
			   Bin, TrUserData) ->
    begin
...
encode_msg_m_sub_equip_toc(Msg, TrUserData) ->
    encode_msg_m_sub_equip_toc(Msg, <<>>, TrUserData).


encode_msg_m_sub_equip_toc(#m_sub_equip_toc{equips = F1,
					    slots = F2, stype = F3},
			   Bin, TrUserData) ->
    B1 = begin
	   TrF1 = id(F1, TrUserData),
	   if TrF1 == [] -> Bin;
	      true ->
		  e_field_m_sub_equip_toc_equips(TrF1, Bin, TrUserData)
	   end
	 end,
    B2 = begin
	   TrF2 = 'tr_encode_m_sub_equip_toc.slots'(F2,
						    TrUserData),
	   if TrF2 == [] -> B1;
	      true ->
		  e_field_m_sub_equip_toc_slots(TrF2, B1, TrUserData)
	   end
	 end,
    begin
...
encode_msg_m_sub_equip_puton_tos(Msg, TrUserData) ->
    encode_msg_m_sub_equip_puton_tos(Msg, <<>>, TrUserData).


encode_msg_m_sub_equip_puton_tos(#m_sub_equip_puton_tos{uid
							    = F1},
				 Bin, TrUserData) ->
    begin
      TrF1 = id(F1, TrUserData),
...
encode_msg_m_sub_equip_puton_toc(Msg, TrUserData) ->
    encode_msg_m_sub_equip_puton_toc(Msg, <<>>, TrUserData).


encode_msg_m_sub_equip_puton_toc(#m_sub_equip_puton_toc{slot
							    = F1,
							stype = F2},
				 Bin, TrUserData) ->
    B1 = begin
...
encode_msg_m_sub_equip_uplevel_tos(Msg, TrUserData) ->
    encode_msg_m_sub_equip_uplevel_tos(Msg, <<>>,
				       TrUserData).


encode_msg_m_sub_equip_uplevel_tos(#m_sub_equip_uplevel_tos{slot
								= F1,
							    stype = F2},
				   Bin, TrUserData) ->
    B1 = begin
...
encode_msg_m_sub_equip_uplevel_toc(Msg, TrUserData) ->
    encode_msg_m_sub_equip_uplevel_toc(Msg, <<>>,
				       TrUserData).


encode_msg_m_sub_equip_uplevel_toc(#m_sub_equip_uplevel_toc{slot
								= F1,
							    stype = F2},
				   Bin, TrUserData) ->
    B1 = begin
...
encode_msg_m_sub_equip_decompose_tos(Msg, TrUserData) ->
    encode_msg_m_sub_equip_decompose_tos(Msg, <<>>,
					 TrUserData).


encode_msg_m_sub_equip_decompose_tos(#m_sub_equip_decompose_tos{uid
								    = F1},
				     Bin, TrUserData) ->
    begin
      TrF1 = id(F1, TrUserData),
      if TrF1 == [] -> Bin;
	 true ->
	     e_field_m_sub_equip_decompose_tos_uid(TrF1, Bin,
						   TrUserData)
      end
    end.

encode_msg_m_sub_equip_decompose_toc(_Msg,
				     _TrUserData) ->
    <<>>.
...
e_mfield_m_sub_equip_toc_equips(Msg, Bin, TrUserData) ->
    SubBin = encode_msg_p_item(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

e_field_m_sub_equip_toc_equips([Elem | Rest], Bin,
			       TrUserData) ->
    Bin2 = <<Bin/binary, 10>>,
    Bin3 = e_mfield_m_sub_equip_toc_equips(id(Elem,
					      TrUserData),
					   Bin2, TrUserData),
    e_field_m_sub_equip_toc_equips(Rest, Bin3, TrUserData);
e_field_m_sub_equip_toc_equips([], Bin, _TrUserData) ->
    Bin.

e_mfield_m_sub_equip_toc_slots(Msg, Bin, TrUserData) ->
    SubBin = 'encode_msg_map<int32,int32>'(Msg, <<>>,
					   TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

e_field_m_sub_equip_toc_slots([Elem | Rest], Bin,
			      TrUserData) ->
    Bin2 = <<Bin/binary, 18>>,
    Bin3 =
	e_mfield_m_sub_equip_toc_slots('tr_encode_m_sub_equip_toc.slots[x]'(Elem,
									    TrUserData),
				       Bin2, TrUserData),
    e_field_m_sub_equip_toc_slots(Rest, Bin3, TrUserData);
e_field_m_sub_equip_toc_slots([], Bin, _TrUserData) ->
    Bin.

e_field_m_sub_equip_decompose_tos_uid([Elem | Rest],
				      Bin, TrUserData) ->
    Bin2 = <<Bin/binary, 8>>,
    Bin3 = e_type_int32(id(Elem, TrUserData), Bin2,
			TrUserData),
    e_field_m_sub_equip_decompose_tos_uid(Rest, Bin3,
					  TrUserData);
e_field_m_sub_equip_decompose_tos_uid([], Bin,
				      _TrUserData) ->
    Bin.
...
decode_msg_2_doit(m_sub_equip_tos, Bin, TrUserData) ->
    id(decode_msg_m_sub_equip_tos(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_sub_equip_toc, Bin, TrUserData) ->
    id(decode_msg_m_sub_equip_toc(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_sub_equip_puton_tos, Bin,
		  TrUserData) ->
    id(decode_msg_m_sub_equip_puton_tos(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_sub_equip_puton_toc, Bin,
		  TrUserData) ->
    id(decode_msg_m_sub_equip_puton_toc(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_sub_equip_uplevel_tos, Bin,
		  TrUserData) ->
    id(decode_msg_m_sub_equip_uplevel_tos(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_sub_equip_uplevel_toc, Bin,
		  TrUserData) ->
    id(decode_msg_m_sub_equip_uplevel_toc(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_sub_equip_decompose_tos, Bin,
		  TrUserData) ->
    id(decode_msg_m_sub_equip_decompose_tos(Bin,
					    TrUserData),
       TrUserData);
decode_msg_2_doit(m_sub_equip_decompose_toc, Bin,
		  TrUserData) ->
    id(decode_msg_m_sub_equip_decompose_toc(Bin,
					    TrUserData),
       TrUserData);
...
decode_msg_m_sub_equip_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_sub_equip_tos(Bin, 0, 0,
				       id(undefined, TrUserData), TrUserData).

dfp_read_field_def_m_sub_equip_tos(<<8, Rest/binary>>,
				   Z1, Z2, F@_1, TrUserData) ->
    d_field_m_sub_equip_tos_stype(Rest, Z1, Z2, F@_1,
				  TrUserData);
dfp_read_field_def_m_sub_equip_tos(<<>>, 0, 0, F@_1,
				   _) ->
    #m_sub_equip_tos{stype = F@_1};
dfp_read_field_def_m_sub_equip_tos(Other, Z1, Z2, F@_1,
				   TrUserData) ->
    dg_read_field_def_m_sub_equip_tos(Other, Z1, Z2, F@_1,
				      TrUserData).

dg_read_field_def_m_sub_equip_tos(<<1:1, X:7,
				    Rest/binary>>,
				  N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_sub_equip_tos(Rest, N + 7,
				      X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_m_sub_equip_tos(<<0:1, X:7,
				    Rest/binary>>,
				  N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_sub_equip_tos_stype(Rest, 0, 0, F@_1,
					TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_sub_equip_tos(Rest, 0, 0, F@_1,
					    TrUserData);
	    1 ->
		skip_64_m_sub_equip_tos(Rest, 0, 0, F@_1, TrUserData);
	    2 ->
		skip_length_delimited_m_sub_equip_tos(Rest, 0, 0, F@_1,
						      TrUserData);
	    3 ->
		skip_group_m_sub_equip_tos(Rest, Key bsr 3, 0, F@_1,
					   TrUserData);
	    5 ->
		skip_32_m_sub_equip_tos(Rest, 0, 0, F@_1, TrUserData)
	  end
    end;
dg_read_field_def_m_sub_equip_tos(<<>>, 0, 0, F@_1,
				  _) ->
    #m_sub_equip_tos{stype = F@_1}.

d_field_m_sub_equip_tos_stype(<<1:1, X:7, Rest/binary>>,
			      N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_m_sub_equip_tos_stype(Rest, N + 7,
				  X bsl N + Acc, F@_1, TrUserData);
d_field_m_sub_equip_tos_stype(<<0:1, X:7, Rest/binary>>,
			      N, Acc, _, TrUserData) ->
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    dfp_read_field_def_m_sub_equip_tos(RestF, 0, 0,
				       NewFValue, TrUserData).

skip_varint_m_sub_equip_tos(<<1:1, _:7, Rest/binary>>,
			    Z1, Z2, F@_1, TrUserData) ->
    skip_varint_m_sub_equip_tos(Rest, Z1, Z2, F@_1,
				TrUserData);
skip_varint_m_sub_equip_tos(<<0:1, _:7, Rest/binary>>,
			    Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_sub_equip_tos(Rest, Z1, Z2, F@_1,
				       TrUserData).

skip_length_delimited_m_sub_equip_tos(<<1:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_sub_equip_tos(Rest, N + 7,
					  X bsl N + Acc, F@_1, TrUserData);
skip_length_delimited_m_sub_equip_tos(<<0:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_sub_equip_tos(Rest2, 0, 0, F@_1,
				       TrUserData).

skip_group_m_sub_equip_tos(Bin, FNum, Z2, F@_1,
			   TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_sub_equip_tos(Rest, 0, Z2, F@_1,
				       TrUserData).

skip_32_m_sub_equip_tos(<<_:32, Rest/binary>>, Z1, Z2,
			F@_1, TrUserData) ->
    dfp_read_field_def_m_sub_equip_tos(Rest, Z1, Z2, F@_1,
				       TrUserData).

skip_64_m_sub_equip_tos(<<_:64, Rest/binary>>, Z1, Z2,
			F@_1, TrUserData) ->
    dfp_read_field_def_m_sub_equip_tos(Rest, Z1, Z2, F@_1,
				       TrUserData).

decode_msg_m_sub_equip_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_sub_equip_toc(Bin, 0, 0,
				       id([], TrUserData),
				       'tr_decode_init_default_m_sub_equip_toc.slots'([],
										      TrUserData),
				       id(undefined, TrUserData), TrUserData).

dfp_read_field_def_m_sub_equip_toc(<<10, Rest/binary>>,
				   Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
    d_field_m_sub_equip_toc_equips(Rest, Z1, Z2, F@_1, F@_2,
				   F@_3, TrUserData);
dfp_read_field_def_m_sub_equip_toc(<<18, Rest/binary>>,
				   Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
    d_field_m_sub_equip_toc_slots(Rest, Z1, Z2, F@_1, F@_2,
				  F@_3, TrUserData);
dfp_read_field_def_m_sub_equip_toc(<<24, Rest/binary>>,
				   Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
    d_field_m_sub_equip_toc_stype(Rest, Z1, Z2, F@_1, F@_2,
				  F@_3, TrUserData);
dfp_read_field_def_m_sub_equip_toc(<<>>, 0, 0, R1, R2,
				   F@_3, TrUserData) ->
    #m_sub_equip_toc{equips = lists_reverse(R1, TrUserData),
		     slots =
			 'tr_decode_repeated_finalize_m_sub_equip_toc.slots'(R2,
									     TrUserData),
		     stype = F@_3};
dfp_read_field_def_m_sub_equip_toc(Other, Z1, Z2, F@_1,
				   F@_2, F@_3, TrUserData) ->
    dg_read_field_def_m_sub_equip_toc(Other, Z1, Z2, F@_1,
				      F@_2, F@_3, TrUserData).

dg_read_field_def_m_sub_equip_toc(<<1:1, X:7,
				    Rest/binary>>,
				  N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_sub_equip_toc(Rest, N + 7,
				      X bsl N + Acc, F@_1, F@_2, F@_3,
				      TrUserData);
dg_read_field_def_m_sub_equip_toc(<<0:1, X:7,
				    Rest/binary>>,
				  N, Acc, F@_1, F@_2, F@_3, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      10 ->
	  d_field_m_sub_equip_toc_equips(Rest, 0, 0, F@_1, F@_2,
					 F@_3, TrUserData);
      18 ->
	  d_field_m_sub_equip_toc_slots(Rest, 0, 0, F@_1, F@_2,
					F@_3, TrUserData);
      24 ->
	  d_field_m_sub_equip_toc_stype(Rest, 0, 0, F@_1, F@_2,
					F@_3, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_sub_equip_toc(Rest, 0, 0, F@_1, F@_2,
					    F@_3, TrUserData);
	    1 ->
		skip_64_m_sub_equip_toc(Rest, 0, 0, F@_1, F@_2, F@_3,
					TrUserData);
	    2 ->
		skip_length_delimited_m_sub_equip_toc(Rest, 0, 0, F@_1,
						      F@_2, F@_3, TrUserData);
	    3 ->
		skip_group_m_sub_equip_toc(Rest, Key bsr 3, 0, F@_1,
					   F@_2, F@_3, TrUserData);
	    5 ->
		skip_32_m_sub_equip_toc(Rest, 0, 0, F@_1, F@_2, F@_3,
					TrUserData)
	  end
    end;
dg_read_field_def_m_sub_equip_toc(<<>>, 0, 0, R1, R2,
				  F@_3, TrUserData) ->
    #m_sub_equip_toc{equips = lists_reverse(R1, TrUserData),
		     slots =
			 'tr_decode_repeated_finalize_m_sub_equip_toc.slots'(R2,
...
d_field_m_sub_equip_toc_equips(<<1:1, X:7,
				 Rest/binary>>,
			       N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    d_field_m_sub_equip_toc_equips(Rest, N + 7,
				   X bsl N + Acc, F@_1, F@_2, F@_3, TrUserData);
d_field_m_sub_equip_toc_equips(<<0:1, X:7,
				 Rest/binary>>,
    ...
    dfp_read_field_def_m_sub_equip_toc(RestF, 0, 0,
				       cons(NewFValue, Prev, TrUserData), F@_2,
				       F@_3, TrUserData).

d_field_m_sub_equip_toc_slots(<<1:1, X:7, Rest/binary>>,
			      N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    d_field_m_sub_equip_toc_slots(Rest, N + 7,
				  X bsl N + Acc, F@_1, F@_2, F@_3, TrUserData);
d_field_m_sub_equip_toc_slots(<<0:1, X:7, Rest/binary>>,
    ...
    dfp_read_field_def_m_sub_equip_toc(RestF, 0, 0, F@_1,
				       'tr_decode_repeated_add_elem_m_sub_equip_toc.slots'(NewFValue,
											   Prev,
											   TrUserData),
				       F@_3, TrUserData).

d_field_m_sub_equip_toc_stype(<<1:1, X:7, Rest/binary>>,
			      N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    d_field_m_sub_equip_toc_stype(Rest, N + 7,
				  X bsl N + Acc, F@_1, F@_2, F@_3, TrUserData);
d_field_m_sub_equip_toc_stype(<<0:1, X:7, Rest/binary>>,
...
skip_varint_m_sub_equip_toc(<<1:1, _:7, Rest/binary>>,
			    Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
    skip_varint_m_sub_equip_toc(Rest, Z1, Z2, F@_1, F@_2,
				F@_3, TrUserData);
skip_varint_m_sub_equip_toc(<<0:1, _:7, Rest/binary>>,
			    Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
    dfp_read_field_def_m_sub_equip_toc(Rest, Z1, Z2, F@_1,
				       F@_2, F@_3, TrUserData).

skip_length_delimited_m_sub_equip_toc(<<1:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_sub_equip_toc(Rest, N + 7,
					  X bsl N + Acc, F@_1, F@_2, F@_3,
					  TrUserData);
skip_length_delimited_m_sub_equip_toc(<<0:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, F@_2, F@_3, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_sub_equip_toc(Rest2, 0, 0, F@_1,
				       F@_2, F@_3, TrUserData).

skip_group_m_sub_equip_toc(Bin, FNum, Z2, F@_1, F@_2,
			   F@_3, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_sub_equip_toc(Rest, 0, Z2, F@_1,
				       F@_2, F@_3, TrUserData).

skip_32_m_sub_equip_toc(<<_:32, Rest/binary>>, Z1, Z2,
			F@_1, F@_2, F@_3, TrUserData) ->
    dfp_read_field_def_m_sub_equip_toc(Rest, Z1, Z2, F@_1,
				       F@_2, F@_3, TrUserData).

skip_64_m_sub_equip_toc(<<_:64, Rest/binary>>, Z1, Z2,
			F@_1, F@_2, F@_3, TrUserData) ->
    dfp_read_field_def_m_sub_equip_toc(Rest, Z1, Z2, F@_1,
				       F@_2, F@_3, TrUserData).

decode_msg_m_sub_equip_puton_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_sub_equip_puton_tos(Bin, 0, 0,
					     id(undefined, TrUserData),
					     TrUserData).

dfp_read_field_def_m_sub_equip_puton_tos(<<8,
					   Rest/binary>>,
					 Z1, Z2, F@_1, TrUserData) ->
    d_field_m_sub_equip_puton_tos_uid(Rest, Z1, Z2, F@_1,
				      TrUserData);
dfp_read_field_def_m_sub_equip_puton_tos(<<>>, 0, 0,
					 F@_1, _) ->
    #m_sub_equip_puton_tos{uid = F@_1};
dfp_read_field_def_m_sub_equip_puton_tos(Other, Z1, Z2,
					 F@_1, TrUserData) ->
    dg_read_field_def_m_sub_equip_puton_tos(Other, Z1, Z2,
					    F@_1, TrUserData).

dg_read_field_def_m_sub_equip_puton_tos(<<1:1, X:7,
					  Rest/binary>>,
					N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_sub_equip_puton_tos(Rest, N + 7,
					    X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_m_sub_equip_puton_tos(<<0:1, X:7,
					  Rest/binary>>,
					N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_sub_equip_puton_tos_uid(Rest, 0, 0, F@_1,
					    TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_sub_equip_puton_tos(Rest, 0, 0, F@_1,
						  TrUserData);
	    1 ->
		skip_64_m_sub_equip_puton_tos(Rest, 0, 0, F@_1,
					      TrUserData);
	    2 ->
		skip_length_delimited_m_sub_equip_puton_tos(Rest, 0, 0,
							    F@_1, TrUserData);
	    3 ->
		skip_group_m_sub_equip_puton_tos(Rest, Key bsr 3, 0,
						 F@_1, TrUserData);
	    5 ->
		skip_32_m_sub_equip_puton_tos(Rest, 0, 0, F@_1,
					      TrUserData)
	  end
    end;
dg_read_field_def_m_sub_equip_puton_tos(<<>>, 0, 0,
					F@_1, _) ->
    #m_sub_equip_puton_tos{uid = F@_1}.

d_field_m_sub_equip_puton_tos_uid(<<1:1, X:7,
				    Rest/binary>>,
				  N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_m_sub_equip_puton_tos_uid(Rest, N + 7,
				      X bsl N + Acc, F@_1, TrUserData);
d_field_m_sub_equip_puton_tos_uid(<<0:1, X:7,
				    Rest/binary>>,
				  N, Acc, _, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    dfp_read_field_def_m_sub_equip_puton_tos(RestF, 0, 0,
					     NewFValue, TrUserData).

skip_varint_m_sub_equip_puton_tos(<<1:1, _:7,
				    Rest/binary>>,
				  Z1, Z2, F@_1, TrUserData) ->
    skip_varint_m_sub_equip_puton_tos(Rest, Z1, Z2, F@_1,
				      TrUserData);
skip_varint_m_sub_equip_puton_tos(<<0:1, _:7,
				    Rest/binary>>,
				  Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_sub_equip_puton_tos(Rest, Z1, Z2,
					     F@_1, TrUserData).

skip_length_delimited_m_sub_equip_puton_tos(<<1:1, X:7,
					      Rest/binary>>,
					    N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_sub_equip_puton_tos(Rest, N + 7,
						X bsl N + Acc, F@_1,
						TrUserData);
skip_length_delimited_m_sub_equip_puton_tos(<<0:1, X:7,
					      Rest/binary>>,
					    N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_sub_equip_puton_tos(Rest2, 0, 0,
					     F@_1, TrUserData).

skip_group_m_sub_equip_puton_tos(Bin, FNum, Z2, F@_1,
				 TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_sub_equip_puton_tos(Rest, 0, Z2,
					     F@_1, TrUserData).

skip_32_m_sub_equip_puton_tos(<<_:32, Rest/binary>>, Z1,
			      Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_sub_equip_puton_tos(Rest, Z1, Z2,
					     F@_1, TrUserData).

skip_64_m_sub_equip_puton_tos(<<_:64, Rest/binary>>, Z1,
			      Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_sub_equip_puton_tos(Rest, Z1, Z2,
					     F@_1, TrUserData).

decode_msg_m_sub_equip_puton_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_sub_equip_puton_toc(Bin, 0, 0,
					     id(undefined, TrUserData),
					     id(undefined, TrUserData),
					     TrUserData).

dfp_read_field_def_m_sub_equip_puton_toc(<<8,
					   Rest/binary>>,
					 Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_sub_equip_puton_toc_slot(Rest, Z1, Z2, F@_1,
				       F@_2, TrUserData);
dfp_read_field_def_m_sub_equip_puton_toc(<<16,
					   Rest/binary>>,
					 Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_sub_equip_puton_toc_stype(Rest, Z1, Z2, F@_1,
					F@_2, TrUserData);
dfp_read_field_def_m_sub_equip_puton_toc(<<>>, 0, 0,
					 F@_1, F@_2, _) ->
    #m_sub_equip_puton_toc{slot = F@_1, stype = F@_2};
dfp_read_field_def_m_sub_equip_puton_toc(Other, Z1, Z2,
					 F@_1, F@_2, TrUserData) ->
    dg_read_field_def_m_sub_equip_puton_toc(Other, Z1, Z2,
					    F@_1, F@_2, TrUserData).

dg_read_field_def_m_sub_equip_puton_toc(<<1:1, X:7,
					  Rest/binary>>,
					N, Acc, F@_1, F@_2, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_sub_equip_puton_toc(Rest, N + 7,
					    X bsl N + Acc, F@_1, F@_2,
					    TrUserData);
dg_read_field_def_m_sub_equip_puton_toc(<<0:1, X:7,
					  Rest/binary>>,
					N, Acc, F@_1, F@_2, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_sub_equip_puton_toc_slot(Rest, 0, 0, F@_1,
					     F@_2, TrUserData);
      16 ->
	  d_field_m_sub_equip_puton_toc_stype(Rest, 0, 0, F@_1,
					      F@_2, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_sub_equip_puton_toc(Rest, 0, 0, F@_1,
						  F@_2, TrUserData);
	    1 ->
		skip_64_m_sub_equip_puton_toc(Rest, 0, 0, F@_1, F@_2,
					      TrUserData);
	    2 ->
		skip_length_delimited_m_sub_equip_puton_toc(Rest, 0, 0,
							    F@_1, F@_2,
							    TrUserData);
	    3 ->
		skip_group_m_sub_equip_puton_toc(Rest, Key bsr 3, 0,
						 F@_1, F@_2, TrUserData);
	    5 ->
		skip_32_m_sub_equip_puton_toc(Rest, 0, 0, F@_1, F@_2,
					      TrUserData)
	  end
    end;
dg_read_field_def_m_sub_equip_puton_toc(<<>>, 0, 0,
					F@_1, F@_2, _) ->
    #m_sub_equip_puton_toc{slot = F@_1, stype = F@_2}.

d_field_m_sub_equip_puton_toc_slot(<<1:1, X:7,
				     Rest/binary>>,
				   N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_sub_equip_puton_toc_slot(Rest, N + 7,
				       X bsl N + Acc, F@_1, F@_2, TrUserData);
d_field_m_sub_equip_puton_toc_slot(<<0:1, X:7,
				     Rest/binary>>,
    ...
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    dfp_read_field_def_m_sub_equip_puton_toc(RestF, 0, 0,
					     NewFValue, F@_2, TrUserData).

d_field_m_sub_equip_puton_toc_stype(<<1:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_sub_equip_puton_toc_stype(Rest, N + 7,
					X bsl N + Acc, F@_1, F@_2, TrUserData);
d_field_m_sub_equip_puton_toc_stype(<<0:1, X:7,
				      Rest/binary>>,
...
skip_varint_m_sub_equip_puton_toc(<<1:1, _:7,
				    Rest/binary>>,
				  Z1, Z2, F@_1, F@_2, TrUserData) ->
    skip_varint_m_sub_equip_puton_toc(Rest, Z1, Z2, F@_1,
				      F@_2, TrUserData);
skip_varint_m_sub_equip_puton_toc(<<0:1, _:7,
				    Rest/binary>>,
				  Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_sub_equip_puton_toc(Rest, Z1, Z2,
					     F@_1, F@_2, TrUserData).

skip_length_delimited_m_sub_equip_puton_toc(<<1:1, X:7,
					      Rest/binary>>,
					    N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_sub_equip_puton_toc(Rest, N + 7,
						X bsl N + Acc, F@_1, F@_2,
						TrUserData);
skip_length_delimited_m_sub_equip_puton_toc(<<0:1, X:7,
					      Rest/binary>>,
					    N, Acc, F@_1, F@_2, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_sub_equip_puton_toc(Rest2, 0, 0,
					     F@_1, F@_2, TrUserData).

skip_group_m_sub_equip_puton_toc(Bin, FNum, Z2, F@_1,
				 F@_2, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_sub_equip_puton_toc(Rest, 0, Z2,
					     F@_1, F@_2, TrUserData).

skip_32_m_sub_equip_puton_toc(<<_:32, Rest/binary>>, Z1,
			      Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_sub_equip_puton_toc(Rest, Z1, Z2,
					     F@_1, F@_2, TrUserData).

skip_64_m_sub_equip_puton_toc(<<_:64, Rest/binary>>, Z1,
			      Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_sub_equip_puton_toc(Rest, Z1, Z2,
					     F@_1, F@_2, TrUserData).

decode_msg_m_sub_equip_uplevel_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_sub_equip_uplevel_tos(Bin, 0, 0,
					       id(undefined, TrUserData),
					       id(undefined, TrUserData),
					       TrUserData).

dfp_read_field_def_m_sub_equip_uplevel_tos(<<8,
					     Rest/binary>>,
					   Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_sub_equip_uplevel_tos_slot(Rest, Z1, Z2, F@_1,
					 F@_2, TrUserData);
dfp_read_field_def_m_sub_equip_uplevel_tos(<<16,
					     Rest/binary>>,
					   Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_sub_equip_uplevel_tos_stype(Rest, Z1, Z2,
					  F@_1, F@_2, TrUserData);
dfp_read_field_def_m_sub_equip_uplevel_tos(<<>>, 0, 0,
					   F@_1, F@_2, _) ->
    #m_sub_equip_uplevel_tos{slot = F@_1, stype = F@_2};
dfp_read_field_def_m_sub_equip_uplevel_tos(Other, Z1,
					   Z2, F@_1, F@_2, TrUserData) ->
    dg_read_field_def_m_sub_equip_uplevel_tos(Other, Z1, Z2,
					      F@_1, F@_2, TrUserData).

dg_read_field_def_m_sub_equip_uplevel_tos(<<1:1, X:7,
					    Rest/binary>>,
					  N, Acc, F@_1, F@_2, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_sub_equip_uplevel_tos(Rest, N + 7,
					      X bsl N + Acc, F@_1, F@_2,
					      TrUserData);
dg_read_field_def_m_sub_equip_uplevel_tos(<<0:1, X:7,
					    Rest/binary>>,
					  N, Acc, F@_1, F@_2, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_sub_equip_uplevel_tos_slot(Rest, 0, 0, F@_1,
					       F@_2, TrUserData);
      16 ->
	  d_field_m_sub_equip_uplevel_tos_stype(Rest, 0, 0, F@_1,
						F@_2, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_sub_equip_uplevel_tos(Rest, 0, 0, F@_1,
						    F@_2, TrUserData);
	    1 ->
		skip_64_m_sub_equip_uplevel_tos(Rest, 0, 0, F@_1, F@_2,
						TrUserData);
	    2 ->
		skip_length_delimited_m_sub_equip_uplevel_tos(Rest, 0,
							      0, F@_1, F@_2,
							      TrUserData);
	    3 ->
		skip_group_m_sub_equip_uplevel_tos(Rest, Key bsr 3, 0,
						   F@_1, F@_2, TrUserData);
	    5 ->
		skip_32_m_sub_equip_uplevel_tos(Rest, 0, 0, F@_1, F@_2,
						TrUserData)
	  end
    end;
dg_read_field_def_m_sub_equip_uplevel_tos(<<>>, 0, 0,
					  F@_1, F@_2, _) ->
    #m_sub_equip_uplevel_tos{slot = F@_1, stype = F@_2}.

d_field_m_sub_equip_uplevel_tos_slot(<<1:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_sub_equip_uplevel_tos_slot(Rest, N + 7,
					 X bsl N + Acc, F@_1, F@_2, TrUserData);
d_field_m_sub_equip_uplevel_tos_slot(<<0:1, X:7,
				       Rest/binary>>,
				     N, Acc, _, F@_2, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    dfp_read_field_def_m_sub_equip_uplevel_tos(RestF, 0, 0,
					       NewFValue, F@_2, TrUserData).

d_field_m_sub_equip_uplevel_tos_stype(<<1:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_sub_equip_uplevel_tos_stype(Rest, N + 7,
					  X bsl N + Acc, F@_1, F@_2,
					  TrUserData);
d_field_m_sub_equip_uplevel_tos_stype(<<0:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, _, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
...
skip_varint_m_sub_equip_uplevel_tos(<<1:1, _:7,
				      Rest/binary>>,
				    Z1, Z2, F@_1, F@_2, TrUserData) ->
    skip_varint_m_sub_equip_uplevel_tos(Rest, Z1, Z2, F@_1,
					F@_2, TrUserData);
skip_varint_m_sub_equip_uplevel_tos(<<0:1, _:7,
				      Rest/binary>>,
				    Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_sub_equip_uplevel_tos(Rest, Z1, Z2,
					       F@_1, F@_2, TrUserData).

skip_length_delimited_m_sub_equip_uplevel_tos(<<1:1,
						X:7, Rest/binary>>,
					      N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_sub_equip_uplevel_tos(Rest,
						  N + 7, X bsl N + Acc, F@_1,
						  F@_2, TrUserData);
skip_length_delimited_m_sub_equip_uplevel_tos(<<0:1,
						X:7, Rest/binary>>,
					      N, Acc, F@_1, F@_2, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_sub_equip_uplevel_tos(Rest2, 0, 0,
					       F@_1, F@_2, TrUserData).

skip_group_m_sub_equip_uplevel_tos(Bin, FNum, Z2, F@_1,
				   F@_2, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_sub_equip_uplevel_tos(Rest, 0, Z2,
					       F@_1, F@_2, TrUserData).

skip_32_m_sub_equip_uplevel_tos(<<_:32, Rest/binary>>,
				Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_sub_equip_uplevel_tos(Rest, Z1, Z2,
					       F@_1, F@_2, TrUserData).

skip_64_m_sub_equip_uplevel_tos(<<_:64, Rest/binary>>,
				Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_sub_equip_uplevel_tos(Rest, Z1, Z2,
					       F@_1, F@_2, TrUserData).

decode_msg_m_sub_equip_uplevel_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_sub_equip_uplevel_toc(Bin, 0, 0,
					       id(undefined, TrUserData),
					       id(undefined, TrUserData),
					       TrUserData).

dfp_read_field_def_m_sub_equip_uplevel_toc(<<8,
					     Rest/binary>>,
					   Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_sub_equip_uplevel_toc_slot(Rest, Z1, Z2, F@_1,
					 F@_2, TrUserData);
dfp_read_field_def_m_sub_equip_uplevel_toc(<<16,
					     Rest/binary>>,
					   Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_sub_equip_uplevel_toc_stype(Rest, Z1, Z2,
					  F@_1, F@_2, TrUserData);
dfp_read_field_def_m_sub_equip_uplevel_toc(<<>>, 0, 0,
					   F@_1, F@_2, _) ->
    #m_sub_equip_uplevel_toc{slot = F@_1, stype = F@_2};
dfp_read_field_def_m_sub_equip_uplevel_toc(Other, Z1,
					   Z2, F@_1, F@_2, TrUserData) ->
    dg_read_field_def_m_sub_equip_uplevel_toc(Other, Z1, Z2,
					      F@_1, F@_2, TrUserData).

dg_read_field_def_m_sub_equip_uplevel_toc(<<1:1, X:7,
					    Rest/binary>>,
					  N, Acc, F@_1, F@_2, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_sub_equip_uplevel_toc(Rest, N + 7,
					      X bsl N + Acc, F@_1, F@_2,
					      TrUserData);
dg_read_field_def_m_sub_equip_uplevel_toc(<<0:1, X:7,
					    Rest/binary>>,
					  N, Acc, F@_1, F@_2, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_sub_equip_uplevel_toc_slot(Rest, 0, 0, F@_1,
					       F@_2, TrUserData);
      16 ->
	  d_field_m_sub_equip_uplevel_toc_stype(Rest, 0, 0, F@_1,
						F@_2, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_sub_equip_uplevel_toc(Rest, 0, 0, F@_1,
						    F@_2, TrUserData);
	    1 ->
		skip_64_m_sub_equip_uplevel_toc(Rest, 0, 0, F@_1, F@_2,
						TrUserData);
	    2 ->
		skip_length_delimited_m_sub_equip_uplevel_toc(Rest, 0,
							      0, F@_1, F@_2,
							      TrUserData);
	    3 ->
		skip_group_m_sub_equip_uplevel_toc(Rest, Key bsr 3, 0,
						   F@_1, F@_2, TrUserData);
	    5 ->
		skip_32_m_sub_equip_uplevel_toc(Rest, 0, 0, F@_1, F@_2,
						TrUserData)
	  end
    end;
dg_read_field_def_m_sub_equip_uplevel_toc(<<>>, 0, 0,
					  F@_1, F@_2, _) ->
    #m_sub_equip_uplevel_toc{slot = F@_1, stype = F@_2}.

d_field_m_sub_equip_uplevel_toc_slot(<<1:1, X:7,
				       Rest/binary>>,
				     N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_sub_equip_uplevel_toc_slot(Rest, N + 7,
					 X bsl N + Acc, F@_1, F@_2, TrUserData);
d_field_m_sub_equip_uplevel_toc_slot(<<0:1, X:7,
				       Rest/binary>>,
				     N, Acc, _, F@_2, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    dfp_read_field_def_m_sub_equip_uplevel_toc(RestF, 0, 0,
					       NewFValue, F@_2, TrUserData).

d_field_m_sub_equip_uplevel_toc_stype(<<1:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_sub_equip_uplevel_toc_stype(Rest, N + 7,
					  X bsl N + Acc, F@_1, F@_2,
					  TrUserData);
d_field_m_sub_equip_uplevel_toc_stype(<<0:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, _, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
...
skip_varint_m_sub_equip_uplevel_toc(<<1:1, _:7,
				      Rest/binary>>,
				    Z1, Z2, F@_1, F@_2, TrUserData) ->
    skip_varint_m_sub_equip_uplevel_toc(Rest, Z1, Z2, F@_1,
					F@_2, TrUserData);
skip_varint_m_sub_equip_uplevel_toc(<<0:1, _:7,
				      Rest/binary>>,
				    Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_sub_equip_uplevel_toc(Rest, Z1, Z2,
					       F@_1, F@_2, TrUserData).

skip_length_delimited_m_sub_equip_uplevel_toc(<<1:1,
						X:7, Rest/binary>>,
					      N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_sub_equip_uplevel_toc(Rest,
						  N + 7, X bsl N + Acc, F@_1,
						  F@_2, TrUserData);
skip_length_delimited_m_sub_equip_uplevel_toc(<<0:1,
						X:7, Rest/binary>>,
					      N, Acc, F@_1, F@_2, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_sub_equip_uplevel_toc(Rest2, 0, 0,
					       F@_1, F@_2, TrUserData).

skip_group_m_sub_equip_uplevel_toc(Bin, FNum, Z2, F@_1,
				   F@_2, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_sub_equip_uplevel_toc(Rest, 0, Z2,
					       F@_1, F@_2, TrUserData).

skip_32_m_sub_equip_uplevel_toc(<<_:32, Rest/binary>>,
				Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_sub_equip_uplevel_toc(Rest, Z1, Z2,
					       F@_1, F@_2, TrUserData).

skip_64_m_sub_equip_uplevel_toc(<<_:64, Rest/binary>>,
				Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_sub_equip_uplevel_toc(Rest, Z1, Z2,
					       F@_1, F@_2, TrUserData).

decode_msg_m_sub_equip_decompose_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_sub_equip_decompose_tos(Bin, 0, 0,
						 id([], TrUserData),
						 TrUserData).

dfp_read_field_def_m_sub_equip_decompose_tos(<<10,
					       Rest/binary>>,
					     Z1, Z2, F@_1, TrUserData) ->
    d_pfield_m_sub_equip_decompose_tos_uid(Rest, Z1, Z2,
					   F@_1, TrUserData);
dfp_read_field_def_m_sub_equip_decompose_tos(<<8,
					       Rest/binary>>,
					     Z1, Z2, F@_1, TrUserData) ->
    d_field_m_sub_equip_decompose_tos_uid(Rest, Z1, Z2,
					  F@_1, TrUserData);
dfp_read_field_def_m_sub_equip_decompose_tos(<<>>, 0, 0,
					     R1, TrUserData) ->
    #m_sub_equip_decompose_tos{uid =
				   lists_reverse(R1, TrUserData)};
dfp_read_field_def_m_sub_equip_decompose_tos(Other, Z1,
					     Z2, F@_1, TrUserData) ->
    dg_read_field_def_m_sub_equip_decompose_tos(Other, Z1,
						Z2, F@_1, TrUserData).

dg_read_field_def_m_sub_equip_decompose_tos(<<1:1, X:7,
					      Rest/binary>>,
					    N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_sub_equip_decompose_tos(Rest, N + 7,
						X bsl N + Acc, F@_1,
						TrUserData);
dg_read_field_def_m_sub_equip_decompose_tos(<<0:1, X:7,
					      Rest/binary>>,
					    N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      10 ->
	  d_pfield_m_sub_equip_decompose_tos_uid(Rest, 0, 0, F@_1,
						 TrUserData);
      8 ->
	  d_field_m_sub_equip_decompose_tos_uid(Rest, 0, 0, F@_1,
						TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_sub_equip_decompose_tos(Rest, 0, 0, F@_1,
						      TrUserData);
	    1 ->
		skip_64_m_sub_equip_decompose_tos(Rest, 0, 0, F@_1,
						  TrUserData);
	    2 ->
		skip_length_delimited_m_sub_equip_decompose_tos(Rest, 0,
								0, F@_1,
								TrUserData);
	    3 ->
		skip_group_m_sub_equip_decompose_tos(Rest, Key bsr 3, 0,
						     F@_1, TrUserData);
	    5 ->
		skip_32_m_sub_equip_decompose_tos(Rest, 0, 0, F@_1,
						  TrUserData)
	  end
    end;
dg_read_field_def_m_sub_equip_decompose_tos(<<>>, 0, 0,
					    R1, TrUserData) ->
    #m_sub_equip_decompose_tos{uid =
				   lists_reverse(R1, TrUserData)}.

d_field_m_sub_equip_decompose_tos_uid(<<1:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_m_sub_equip_decompose_tos_uid(Rest, N + 7,
					  X bsl N + Acc, F@_1, TrUserData);
d_field_m_sub_equip_decompose_tos_uid(<<0:1, X:7,
					Rest/binary>>,
    ...
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    dfp_read_field_def_m_sub_equip_decompose_tos(RestF, 0,
						 0,
						 cons(NewFValue, Prev,
						      TrUserData),
						 TrUserData).

d_pfield_m_sub_equip_decompose_tos_uid(<<1:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_pfield_m_sub_equip_decompose_tos_uid(Rest, N + 7,
					   X bsl N + Acc, F@_1, TrUserData);
d_pfield_m_sub_equip_decompose_tos_uid(<<0:1, X:7,
					 Rest/binary>>,
				       N, Acc, E, TrUserData) ->
    Len = X bsl N + Acc,
    <<PackedBytes:Len/binary, Rest2/binary>> = Rest,
    NewSeq =
	d_packed_field_m_sub_equip_decompose_tos_uid(PackedBytes,
						     0, 0, E, TrUserData),
    dfp_read_field_def_m_sub_equip_decompose_tos(Rest2, 0,
						 0, NewSeq, TrUserData).

d_packed_field_m_sub_equip_decompose_tos_uid(<<1:1, X:7,
					       Rest/binary>>,
					     N, Acc, AccSeq, TrUserData)
    when N < 57 ->
    d_packed_field_m_sub_equip_decompose_tos_uid(Rest,
						 N + 7, X bsl N + Acc, AccSeq,
						 TrUserData);
d_packed_field_m_sub_equip_decompose_tos_uid(<<0:1, X:7,
					       Rest/binary>>,
					     N, Acc, AccSeq, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    d_packed_field_m_sub_equip_decompose_tos_uid(RestF, 0,
						 0, [NewFValue | AccSeq],
						 TrUserData);
d_packed_field_m_sub_equip_decompose_tos_uid(<<>>, 0, 0,
					     AccSeq, _) ->
    AccSeq.

skip_varint_m_sub_equip_decompose_tos(<<1:1, _:7,
					Rest/binary>>,
				      Z1, Z2, F@_1, TrUserData) ->
    skip_varint_m_sub_equip_decompose_tos(Rest, Z1, Z2,
					  F@_1, TrUserData);
skip_varint_m_sub_equip_decompose_tos(<<0:1, _:7,
					Rest/binary>>,
				      Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_sub_equip_decompose_tos(Rest, Z1,
						 Z2, F@_1, TrUserData).

skip_length_delimited_m_sub_equip_decompose_tos(<<1:1,
						  X:7, Rest/binary>>,
						N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_sub_equip_decompose_tos(Rest,
						    N + 7, X bsl N + Acc, F@_1,
						    TrUserData);
skip_length_delimited_m_sub_equip_decompose_tos(<<0:1,
						  X:7, Rest/binary>>,
						N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
...
skip_group_m_sub_equip_decompose_tos(Bin, FNum, Z2,
				     F@_1, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_sub_equip_decompose_tos(Rest, 0,
						 Z2, F@_1, TrUserData).

skip_32_m_sub_equip_decompose_tos(<<_:32, Rest/binary>>,
				  Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_sub_equip_decompose_tos(Rest, Z1,
						 Z2, F@_1, TrUserData).

skip_64_m_sub_equip_decompose_tos(<<_:64, Rest/binary>>,
				  Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_m_sub_equip_decompose_tos(Rest, Z1,
						 Z2, F@_1, TrUserData).

decode_msg_m_sub_equip_decompose_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_sub_equip_decompose_toc(Bin, 0, 0,
						 TrUserData).

dfp_read_field_def_m_sub_equip_decompose_toc(<<>>, 0, 0,
					     _) ->
    #m_sub_equip_decompose_toc{};
dfp_read_field_def_m_sub_equip_decompose_toc(Other, Z1,
					     Z2, TrUserData) ->
    dg_read_field_def_m_sub_equip_decompose_toc(Other, Z1,
						Z2, TrUserData).

dg_read_field_def_m_sub_equip_decompose_toc(<<1:1, X:7,
					      Rest/binary>>,
					    N, Acc, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_sub_equip_decompose_toc(Rest, N + 7,
						X bsl N + Acc, TrUserData);
dg_read_field_def_m_sub_equip_decompose_toc(<<0:1, X:7,
					      Rest/binary>>,
					    N, Acc, TrUserData) ->
    Key = X bsl N + Acc,
    case Key band 7 of
      0 ->
	  skip_varint_m_sub_equip_decompose_toc(Rest, 0, 0,
						TrUserData);
      1 ->
	  skip_64_m_sub_equip_decompose_toc(Rest, 0, 0,
					    TrUserData);
      2 ->
	  skip_length_delimited_m_sub_equip_decompose_toc(Rest, 0,
							  0, TrUserData);
      3 ->
	  skip_group_m_sub_equip_decompose_toc(Rest, Key bsr 3, 0,
					       TrUserData);
      5 ->
	  skip_32_m_sub_equip_decompose_toc(Rest, 0, 0,
					    TrUserData)
    end;
dg_read_field_def_m_sub_equip_decompose_toc(<<>>, 0, 0,
					    _) ->
    #m_sub_equip_decompose_toc{}.

skip_varint_m_sub_equip_decompose_toc(<<1:1, _:7,
					Rest/binary>>,
				      Z1, Z2, TrUserData) ->
    skip_varint_m_sub_equip_decompose_toc(Rest, Z1, Z2,
					  TrUserData);
skip_varint_m_sub_equip_decompose_toc(<<0:1, _:7,
					Rest/binary>>,
				      Z1, Z2, TrUserData) ->
    dfp_read_field_def_m_sub_equip_decompose_toc(Rest, Z1,
						 Z2, TrUserData).

skip_length_delimited_m_sub_equip_decompose_toc(<<1:1,
						  X:7, Rest/binary>>,
						N, Acc, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_sub_equip_decompose_toc(Rest,
						    N + 7, X bsl N + Acc,
						    TrUserData);
skip_length_delimited_m_sub_equip_decompose_toc(<<0:1,
						  X:7, Rest/binary>>,
						N, Acc, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_sub_equip_decompose_toc(Rest2, 0,
						 0, TrUserData).

skip_group_m_sub_equip_decompose_toc(Bin, FNum, Z2,
				     TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_sub_equip_decompose_toc(Rest, 0,
						 Z2, TrUserData).

skip_32_m_sub_equip_decompose_toc(<<_:32, Rest/binary>>,
				  Z1, Z2, TrUserData) ->
    dfp_read_field_def_m_sub_equip_decompose_toc(Rest, Z1,
						 Z2, TrUserData).

skip_64_m_sub_equip_decompose_toc(<<_:64, Rest/binary>>,
				  Z1, Z2, TrUserData) ->
    dfp_read_field_def_m_sub_equip_decompose_toc(Rest, Z1,
						 Z2, TrUserData).
...
merge_msgs(Prev, New, MsgName, Opts) ->
    ...
    case MsgName of
      m_sub_equip_tos ->
	  merge_msg_m_sub_equip_tos(Prev, New, TrUserData);
      m_sub_equip_toc ->
	  merge_msg_m_sub_equip_toc(Prev, New, TrUserData);
      m_sub_equip_puton_tos ->
	  merge_msg_m_sub_equip_puton_tos(Prev, New, TrUserData);
      m_sub_equip_puton_toc ->
	  merge_msg_m_sub_equip_puton_toc(Prev, New, TrUserData);
      m_sub_equip_uplevel_tos ->
	  merge_msg_m_sub_equip_uplevel_tos(Prev, New,
					    TrUserData);
      m_sub_equip_uplevel_toc ->
	  merge_msg_m_sub_equip_uplevel_toc(Prev, New,
					    TrUserData);
      m_sub_equip_decompose_tos ->
	  merge_msg_m_sub_equip_decompose_tos(Prev, New,
					      TrUserData);
      m_sub_equip_decompose_toc ->
	  merge_msg_m_sub_equip_decompose_toc(Prev, New,
					      TrUserData);
      p_role_base ->
...
-compile({nowarn_unused_function,merge_msg_m_sub_equip_tos/3}).
merge_msg_m_sub_equip_tos(#m_sub_equip_tos{},
			  #m_sub_equip_tos{stype = NFstype}, _) ->
    #m_sub_equip_tos{stype = NFstype}.

-compile({nowarn_unused_function,merge_msg_m_sub_equip_toc/3}).
merge_msg_m_sub_equip_toc(#m_sub_equip_toc{equips =
					       PFequips,
					   slots = PFslots},
			  #m_sub_equip_toc{equips = NFequips, slots = NFslots,
					   stype = NFstype},
			  TrUserData) ->
    #m_sub_equip_toc{equips =
			 ...
			 if PFslots /= undefined, NFslots /= undefined ->
				'tr_merge_m_sub_equip_toc.slots'(PFslots,
								 NFslots,
								 TrUserData);
...
-compile({nowarn_unused_function,merge_msg_m_sub_equip_puton_tos/3}).
merge_msg_m_sub_equip_puton_tos(#m_sub_equip_puton_tos{},
				#m_sub_equip_puton_tos{uid = NFuid}, _) ->
    #m_sub_equip_puton_tos{uid = NFuid}.

-compile({nowarn_unused_function,merge_msg_m_sub_equip_puton_toc/3}).
merge_msg_m_sub_equip_puton_toc(#m_sub_equip_puton_toc{},
				#m_sub_equip_puton_toc{slot = NFslot,
						       stype = NFstype},
				_) ->
    #m_sub_equip_puton_toc{slot = NFslot, stype = NFstype}.

-compile({nowarn_unused_function,merge_msg_m_sub_equip_uplevel_tos/3}).
merge_msg_m_sub_equip_uplevel_tos(#m_sub_equip_uplevel_tos{},
				  #m_sub_equip_uplevel_tos{slot = NFslot,
							   stype = NFstype},
				  _) ->
    #m_sub_equip_uplevel_tos{slot = NFslot,
			     stype = NFstype}.

-compile({nowarn_unused_function,merge_msg_m_sub_equip_uplevel_toc/3}).
merge_msg_m_sub_equip_uplevel_toc(#m_sub_equip_uplevel_toc{},
				  #m_sub_equip_uplevel_toc{slot = NFslot,
							   stype = NFstype},
				  _) ->
    #m_sub_equip_uplevel_toc{slot = NFslot,
			     stype = NFstype}.

-compile({nowarn_unused_function,merge_msg_m_sub_equip_decompose_tos/3}).
merge_msg_m_sub_equip_decompose_tos(#m_sub_equip_decompose_tos{uid
								   = PFuid},
				    #m_sub_equip_decompose_tos{uid = NFuid},
				    TrUserData) ->
    #m_sub_equip_decompose_tos{uid =
...
-compile({nowarn_unused_function,merge_msg_m_sub_equip_decompose_toc/3}).
merge_msg_m_sub_equip_decompose_toc(_Prev, New,
				    _TrUserData) ->
    New.
...
verify_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
      m_sub_equip_tos ->
	  v_msg_m_sub_equip_tos(Msg, [MsgName], TrUserData);
      m_sub_equip_toc ->
	  v_msg_m_sub_equip_toc(Msg, [MsgName], TrUserData);
      m_sub_equip_puton_tos ->
	  v_msg_m_sub_equip_puton_tos(Msg, [MsgName], TrUserData);
      m_sub_equip_puton_toc ->
	  v_msg_m_sub_equip_puton_toc(Msg, [MsgName], TrUserData);
      m_sub_equip_uplevel_tos ->
	  v_msg_m_sub_equip_uplevel_tos(Msg, [MsgName],
					TrUserData);
      m_sub_equip_uplevel_toc ->
	  v_msg_m_sub_equip_uplevel_toc(Msg, [MsgName],
					TrUserData);
      m_sub_equip_decompose_tos ->
	  v_msg_m_sub_equip_decompose_tos(Msg, [MsgName],
					  TrUserData);
      m_sub_equip_decompose_toc ->
	  v_msg_m_sub_equip_decompose_toc(Msg, [MsgName],
					  TrUserData);
      p_role_base ->
...
-compile({nowarn_unused_function,v_msg_m_sub_equip_tos/3}).
-dialyzer({nowarn_function,v_msg_m_sub_equip_tos/3}).
v_msg_m_sub_equip_tos(#m_sub_equip_tos{stype = F1},
		      Path, TrUserData) ->
    v_type_int32(F1, [stype | Path], TrUserData), ok;
v_msg_m_sub_equip_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_sub_equip_tos}, X, Path).

-compile({nowarn_unused_function,v_msg_m_sub_equip_toc/3}).
-dialyzer({nowarn_function,v_msg_m_sub_equip_toc/3}).
v_msg_m_sub_equip_toc(#m_sub_equip_toc{equips = F1,
				       slots = F2, stype = F3},
		      Path, TrUserData) ->
    if is_list(F1) ->
    ...
    v_type_int32(F3, [stype | Path], TrUserData),
    ok;
v_msg_m_sub_equip_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_sub_equip_toc}, X, Path).

-compile({nowarn_unused_function,v_msg_m_sub_equip_puton_tos/3}).
-dialyzer({nowarn_function,v_msg_m_sub_equip_puton_tos/3}).
v_msg_m_sub_equip_puton_tos(#m_sub_equip_puton_tos{uid =
						       F1},
			    Path, TrUserData) ->
    v_type_int32(F1, [uid | Path], TrUserData), ok;
v_msg_m_sub_equip_puton_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_sub_equip_puton_tos}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_sub_equip_puton_toc/3}).
-dialyzer({nowarn_function,v_msg_m_sub_equip_puton_toc/3}).
v_msg_m_sub_equip_puton_toc(#m_sub_equip_puton_toc{slot
						       = F1,
						   stype = F2},
			    Path, TrUserData) ->
    v_type_int32(F1, [slot | Path], TrUserData),
    v_type_int32(F2, [stype | Path], TrUserData),
    ok;
v_msg_m_sub_equip_puton_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_sub_equip_puton_toc}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_sub_equip_uplevel_tos/3}).
-dialyzer({nowarn_function,v_msg_m_sub_equip_uplevel_tos/3}).
v_msg_m_sub_equip_uplevel_tos(#m_sub_equip_uplevel_tos{slot
							   = F1,
						       stype = F2},
			      Path, TrUserData) ->
    v_type_int32(F1, [slot | Path], TrUserData),
    v_type_int32(F2, [stype | Path], TrUserData),
    ok;
v_msg_m_sub_equip_uplevel_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_sub_equip_uplevel_tos},
		  X, Path).

-compile({nowarn_unused_function,v_msg_m_sub_equip_uplevel_toc/3}).
-dialyzer({nowarn_function,v_msg_m_sub_equip_uplevel_toc/3}).
v_msg_m_sub_equip_uplevel_toc(#m_sub_equip_uplevel_toc{slot
							   = F1,
						       stype = F2},
			      Path, TrUserData) ->
    v_type_int32(F1, [slot | Path], TrUserData),
    v_type_int32(F2, [stype | Path], TrUserData),
    ok;
v_msg_m_sub_equip_uplevel_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_sub_equip_uplevel_toc},
		  X, Path).

-compile({nowarn_unused_function,v_msg_m_sub_equip_decompose_tos/3}).
-dialyzer({nowarn_function,v_msg_m_sub_equip_decompose_tos/3}).
v_msg_m_sub_equip_decompose_tos(#m_sub_equip_decompose_tos{uid
							       = F1},
				Path, TrUserData) ->
    if is_list(F1) ->
    ...
    ok;
v_msg_m_sub_equip_decompose_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_sub_equip_decompose_tos},
		  X, Path).

-compile({nowarn_unused_function,v_msg_m_sub_equip_decompose_toc/3}).
-dialyzer({nowarn_function,v_msg_m_sub_equip_decompose_toc/3}).
v_msg_m_sub_equip_decompose_toc(#m_sub_equip_decompose_toc{},
				_Path, _) ->
    ok;
v_msg_m_sub_equip_decompose_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_sub_equip_decompose_toc},
		  X, Path).
...
-compile({inline,'tr_encode_m_sub_equip_toc.slots[x]'/2}).
'tr_encode_m_sub_equip_toc.slots[x]'(X, _) ->
...
-compile({inline,'tr_decode_init_default_m_sub_equip_toc.slots'/2}).
'tr_decode_init_default_m_sub_equip_toc.slots'(_, _) ->
    mt_empty_map_m().

-compile({inline,'tr_merge_m_sub_equip_toc.slots'/3}).
'tr_merge_m_sub_equip_toc.slots'(X1, X2, _) ->
    mt_merge_maps_m(X1, X2).

-compile({inline,'tr_decode_repeated_finalize_m_sub_equip_toc.slots'/2}).
'tr_decode_repeated_finalize_m_sub_equip_toc.slots'(L,
						    TrUserData) ->
    id(L, TrUserData).

-compile({inline,'tr_encode_m_sub_equip_toc.slots'/2}).
'tr_encode_m_sub_equip_toc.slots'(X, _) ->
    mt_map_to_list_m(X).

-compile({inline,'tr_decode_repeated_add_elem_m_sub_equip_toc.slots'/3}).
'tr_decode_repeated_add_elem_m_sub_equip_toc.slots'(Elem,
						    L, _) ->
    mt_add_item_m(Elem, L).
...
get_msg_defs() ->
    [{{msg, m_sub_equip_tos},
      [#field{name = stype, fnum = 1, rnum = 2, type = int32,
     ...
     {{msg, m_sub_equip_toc},
      [#field{name = equips, fnum = 1, rnum = 2,
       ...
       #field{name = slots, fnum = 2, rnum = 3,
	      ...
	      opts = []},
       #field{name = stype, fnum = 3, rnum = 4, type = int32,
	      occurrence = required, opts = []}]},
     {{msg, m_sub_equip_puton_tos},
      [#field{name = uid, fnum = 1, rnum = 2, type = int32,
	      occurrence = required, opts = []}]},
     {{msg, m_sub_equip_puton_toc},
      [#field{name = slot, fnum = 1, rnum = 2, type = int32,
	      occurrence = required, opts = []},
       #field{name = stype, fnum = 2, rnum = 3, type = int32,
	      occurrence = required, opts = []}]},
     {{msg, m_sub_equip_uplevel_tos},
      [#field{name = slot, fnum = 1, rnum = 2, type = int32,
	      occurrence = required, opts = []},
       #field{name = stype, fnum = 2, rnum = 3, type = int32,
	      occurrence = required, opts = []}]},
     {{msg, m_sub_equip_uplevel_toc},
      [#field{name = slot, fnum = 1, rnum = 2, type = int32,
	      occurrence = required, opts = []},
       #field{name = stype, fnum = 2, rnum = 3, type = int32,
	      occurrence = required, opts = []}]},
     {{msg, m_sub_equip_decompose_tos},
      [#field{name = uid, fnum = 1, rnum = 2, type = int32,
	      occurrence = repeated, opts = []}]},
     {{msg, m_sub_equip_decompose_toc}, []},
     {{msg, p_role_base},
...
get_msg_names() ->
    [m_sub_equip_tos, m_sub_equip_toc,
     m_sub_equip_puton_tos, m_sub_equip_puton_toc,
     m_sub_equip_uplevel_tos, m_sub_equip_uplevel_toc,
     m_sub_equip_decompose_tos, m_sub_equip_decompose_toc,
...
find_msg_def(m_sub_equip_tos) ->
    [#field{name = stype, fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []}];
find_msg_def(m_sub_equip_toc) ->
    [#field{name = equips, fnum = 1, rnum = 2,
	    type = {msg, p_item}, occurrence = repeated, opts = []},
     #field{name = slots, fnum = 2, rnum = 3,
	    type = {map, int32, int32}, occurrence = repeated,
     ...
     #field{name = stype, fnum = 3, rnum = 4, type = int32,
	    occurrence = required, opts = []}];
find_msg_def(m_sub_equip_puton_tos) ->
    [#field{name = uid, fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []}];
find_msg_def(m_sub_equip_puton_toc) ->
    [#field{name = slot, fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []},
     #field{name = stype, fnum = 2, rnum = 3, type = int32,
	    occurrence = required, opts = []}];
find_msg_def(m_sub_equip_uplevel_tos) ->
    [#field{name = slot, fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []},
     #field{name = stype, fnum = 2, rnum = 3, type = int32,
	    occurrence = required, opts = []}];
find_msg_def(m_sub_equip_uplevel_toc) ->
    [#field{name = slot, fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []},
     #field{name = stype, fnum = 2, rnum = 3, type = int32,
	    occurrence = required, opts = []}];
find_msg_def(m_sub_equip_decompose_tos) ->
    [#field{name = uid, fnum = 1, rnum = 2, type = int32,
	    occurrence = repeated, opts = []}];
find_msg_def(m_sub_equip_decompose_toc) -> [];
