...
%% message types
-type m_icon_setpic_tos() :: #m_icon_setpic_tos{}.

-type m_icon_setpic_toc() :: #m_icon_setpic_toc{}.

-type m_icon_update_toc() :: #m_icon_update_toc{}.
...
-export_type(['m_icon_setpic_tos'/0, 'm_icon_setpic_toc'/0, 'm_icon_update_toc'/0, 'p_role_base'/0, 'p_aspect'/0, 'p_attr'/0, 'p_item_base'/0, 'p_item'/0, 'p_equip'/0, 'p_pet'/0, 'p_marriage'/0, 'p_refine'/0, 'p_actor'/0, 'p_role'/0, 'p_creep'/0, 'p_npc'/0, 'p_drop'/0, 'p_buff'/0, 'p_coord'/0, 'p_icon'/0, 'p_ranking'/0, 'p_dropped'/0]).

-spec encode_msg(#m_icon_setpic_tos{} | #m_icon_setpic_toc{} | #m_icon_update_toc{} | #p_role_base{} | #p_aspect{} | #p_attr{} | #p_item_base{} | #p_item{} | #p_equip{} | #p_pet{} | #p_marriage{} | #p_refine{} | #p_actor{} | #p_role{} | #p_creep{} | #p_npc{} | #p_drop{} | #p_buff{} | #p_coord{} | #p_icon{} | #p_ranking{} | #p_dropped{}) -> binary().
encode_msg(Msg) when tuple_size(Msg) >= 1 ->
    encode_msg(Msg, element(1, Msg), []).

-spec encode_msg(#m_icon_setpic_tos{} | #m_icon_setpic_toc{} | #m_icon_update_toc{} | #p_role_base{} | #p_aspect{} | #p_attr{} | #p_item_base{} | #p_item{} | #p_equip{} | #p_pet{} | #p_marriage{} | #p_refine{} | #p_actor{} | #p_role{} | #p_creep{} | #p_npc{} | #p_drop{} | #p_buff{} | #p_coord{} | #p_icon{} | #p_ranking{} | #p_dropped{}, atom() | list()) -> binary().
...
encode_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
      m_icon_setpic_tos ->
	  encode_msg_m_icon_setpic_tos(id(Msg, TrUserData),
				       TrUserData);
      m_icon_setpic_toc ->
	  encode_msg_m_icon_setpic_toc(id(Msg, TrUserData),
				       TrUserData);
      m_icon_update_toc ->
	  encode_msg_m_icon_update_toc(id(Msg, TrUserData),
				       TrUserData);
      p_role_base ->
...
encode_msg_m_icon_setpic_tos(Msg, TrUserData) ->
    encode_msg_m_icon_setpic_tos(Msg, <<>>, TrUserData).


encode_msg_m_icon_setpic_tos(#m_icon_setpic_tos{pic =
						    F1,
						md5 = F2},
			     Bin, TrUserData) ->
    B1 = begin
...
encode_msg_m_icon_setpic_toc(Msg, TrUserData) ->
    encode_msg_m_icon_setpic_toc(Msg, <<>>, TrUserData).


encode_msg_m_icon_setpic_toc(#m_icon_setpic_toc{pic =
						    F1,
						md5 = F2},
			     Bin, TrUserData) ->
    B1 = begin
...
encode_msg_m_icon_update_toc(Msg, TrUserData) ->
    encode_msg_m_icon_update_toc(Msg, <<>>, TrUserData).


encode_msg_m_icon_update_toc(#m_icon_update_toc{frame =
						    F1,
						bubble = F2},
			     Bin, TrUserData) ->
...
decode_msg_2_doit(m_icon_setpic_tos, Bin, TrUserData) ->
    id(decode_msg_m_icon_setpic_tos(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_icon_setpic_toc, Bin, TrUserData) ->
    id(decode_msg_m_icon_setpic_toc(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_icon_update_toc, Bin, TrUserData) ->
    id(decode_msg_m_icon_update_toc(Bin, TrUserData),
       TrUserData);
...
decode_msg_m_icon_setpic_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_icon_setpic_tos(Bin, 0, 0,
					 id(undefined, TrUserData),
					 id(undefined, TrUserData), TrUserData).

dfp_read_field_def_m_icon_setpic_tos(<<10,
				       Rest/binary>>,
				     Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_icon_setpic_tos_pic(Rest, Z1, Z2, F@_1, F@_2,
				  TrUserData);
dfp_read_field_def_m_icon_setpic_tos(<<18,
				       Rest/binary>>,
				     Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_icon_setpic_tos_md5(Rest, Z1, Z2, F@_1, F@_2,
				  TrUserData);
dfp_read_field_def_m_icon_setpic_tos(<<>>, 0, 0, F@_1,
				     F@_2, _) ->
    #m_icon_setpic_tos{pic = F@_1, md5 = F@_2};
dfp_read_field_def_m_icon_setpic_tos(Other, Z1, Z2,
				     F@_1, F@_2, TrUserData) ->
    dg_read_field_def_m_icon_setpic_tos(Other, Z1, Z2, F@_1,
					F@_2, TrUserData).

dg_read_field_def_m_icon_setpic_tos(<<1:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, F@_2, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_icon_setpic_tos(Rest, N + 7,
					X bsl N + Acc, F@_1, F@_2, TrUserData);
dg_read_field_def_m_icon_setpic_tos(<<0:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, F@_2, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      10 ->
	  d_field_m_icon_setpic_tos_pic(Rest, 0, 0, F@_1, F@_2,
					TrUserData);
      18 ->
	  d_field_m_icon_setpic_tos_md5(Rest, 0, 0, F@_1, F@_2,
					TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_icon_setpic_tos(Rest, 0, 0, F@_1, F@_2,
					      TrUserData);
	    1 ->
		skip_64_m_icon_setpic_tos(Rest, 0, 0, F@_1, F@_2,
					  TrUserData);
	    2 ->
		skip_length_delimited_m_icon_setpic_tos(Rest, 0, 0,
							F@_1, F@_2, TrUserData);
	    3 ->
		skip_group_m_icon_setpic_tos(Rest, Key bsr 3, 0, F@_1,
					     F@_2, TrUserData);
	    5 ->
		skip_32_m_icon_setpic_tos(Rest, 0, 0, F@_1, F@_2,
					  TrUserData)
	  end
    end;
dg_read_field_def_m_icon_setpic_tos(<<>>, 0, 0, F@_1,
				    F@_2, _) ->
    #m_icon_setpic_tos{pic = F@_1, md5 = F@_2}.

d_field_m_icon_setpic_tos_pic(<<1:1, X:7, Rest/binary>>,
			      N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_icon_setpic_tos_pic(Rest, N + 7,
				  X bsl N + Acc, F@_1, F@_2, TrUserData);
d_field_m_icon_setpic_tos_pic(<<0:1, X:7, Rest/binary>>,
    ...
    dfp_read_field_def_m_icon_setpic_tos(RestF, 0, 0,
					 NewFValue, F@_2, TrUserData).

d_field_m_icon_setpic_tos_md5(<<1:1, X:7, Rest/binary>>,
			      N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_icon_setpic_tos_md5(Rest, N + 7,
				  X bsl N + Acc, F@_1, F@_2, TrUserData);
d_field_m_icon_setpic_tos_md5(<<0:1, X:7, Rest/binary>>,
    ...
    dfp_read_field_def_m_icon_setpic_tos(RestF, 0, 0, F@_1,
					 NewFValue, TrUserData).

skip_varint_m_icon_setpic_tos(<<1:1, _:7, Rest/binary>>,
			      Z1, Z2, F@_1, F@_2, TrUserData) ->
    skip_varint_m_icon_setpic_tos(Rest, Z1, Z2, F@_1, F@_2,
				  TrUserData);
skip_varint_m_icon_setpic_tos(<<0:1, _:7, Rest/binary>>,
			      Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_icon_setpic_tos(Rest, Z1, Z2, F@_1,
					 F@_2, TrUserData).

skip_length_delimited_m_icon_setpic_tos(<<1:1, X:7,
					  Rest/binary>>,
					N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_icon_setpic_tos(Rest, N + 7,
					    X bsl N + Acc, F@_1, F@_2,
					    TrUserData);
skip_length_delimited_m_icon_setpic_tos(<<0:1, X:7,
					  Rest/binary>>,
					N, Acc, F@_1, F@_2, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_icon_setpic_tos(Rest2, 0, 0, F@_1,
					 F@_2, TrUserData).

skip_group_m_icon_setpic_tos(Bin, FNum, Z2, F@_1, F@_2,
			     TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_icon_setpic_tos(Rest, 0, Z2, F@_1,
					 F@_2, TrUserData).

skip_32_m_icon_setpic_tos(<<_:32, Rest/binary>>, Z1, Z2,
			  F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_icon_setpic_tos(Rest, Z1, Z2, F@_1,
					 F@_2, TrUserData).

skip_64_m_icon_setpic_tos(<<_:64, Rest/binary>>, Z1, Z2,
			  F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_icon_setpic_tos(Rest, Z1, Z2, F@_1,
					 F@_2, TrUserData).

decode_msg_m_icon_setpic_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_icon_setpic_toc(Bin, 0, 0,
					 id(undefined, TrUserData),
					 id(undefined, TrUserData), TrUserData).

dfp_read_field_def_m_icon_setpic_toc(<<10,
				       Rest/binary>>,
				     Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_icon_setpic_toc_pic(Rest, Z1, Z2, F@_1, F@_2,
				  TrUserData);
dfp_read_field_def_m_icon_setpic_toc(<<18,
				       Rest/binary>>,
				     Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_icon_setpic_toc_md5(Rest, Z1, Z2, F@_1, F@_2,
				  TrUserData);
dfp_read_field_def_m_icon_setpic_toc(<<>>, 0, 0, F@_1,
				     F@_2, _) ->
    #m_icon_setpic_toc{pic = F@_1, md5 = F@_2};
dfp_read_field_def_m_icon_setpic_toc(Other, Z1, Z2,
				     F@_1, F@_2, TrUserData) ->
    dg_read_field_def_m_icon_setpic_toc(Other, Z1, Z2, F@_1,
					F@_2, TrUserData).

dg_read_field_def_m_icon_setpic_toc(<<1:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, F@_2, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_icon_setpic_toc(Rest, N + 7,
					X bsl N + Acc, F@_1, F@_2, TrUserData);
dg_read_field_def_m_icon_setpic_toc(<<0:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, F@_2, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      10 ->
	  d_field_m_icon_setpic_toc_pic(Rest, 0, 0, F@_1, F@_2,
					TrUserData);
      18 ->
	  d_field_m_icon_setpic_toc_md5(Rest, 0, 0, F@_1, F@_2,
					TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_icon_setpic_toc(Rest, 0, 0, F@_1, F@_2,
					      TrUserData);
	    1 ->
		skip_64_m_icon_setpic_toc(Rest, 0, 0, F@_1, F@_2,
					  TrUserData);
	    2 ->
		skip_length_delimited_m_icon_setpic_toc(Rest, 0, 0,
							F@_1, F@_2, TrUserData);
	    3 ->
		skip_group_m_icon_setpic_toc(Rest, Key bsr 3, 0, F@_1,
					     F@_2, TrUserData);
	    5 ->
		skip_32_m_icon_setpic_toc(Rest, 0, 0, F@_1, F@_2,
					  TrUserData)
	  end
    end;
dg_read_field_def_m_icon_setpic_toc(<<>>, 0, 0, F@_1,
				    F@_2, _) ->
    #m_icon_setpic_toc{pic = F@_1, md5 = F@_2}.

d_field_m_icon_setpic_toc_pic(<<1:1, X:7, Rest/binary>>,
			      N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_icon_setpic_toc_pic(Rest, N + 7,
				  X bsl N + Acc, F@_1, F@_2, TrUserData);
d_field_m_icon_setpic_toc_pic(<<0:1, X:7, Rest/binary>>,
			      N, Acc, _, F@_2, TrUserData) ->
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
			   <<Utf8:Len/binary, Rest2/binary>> = Rest,
    ...
    dfp_read_field_def_m_icon_setpic_toc(RestF, 0, 0,
					 NewFValue, F@_2, TrUserData).

d_field_m_icon_setpic_toc_md5(<<1:1, X:7, Rest/binary>>,
			      N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_icon_setpic_toc_md5(Rest, N + 7,
				  X bsl N + Acc, F@_1, F@_2, TrUserData);
d_field_m_icon_setpic_toc_md5(<<0:1, X:7, Rest/binary>>,
			      N, Acc, F@_1, _, TrUserData) ->
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
			   <<Utf8:Len/binary, Rest2/binary>> = Rest,
    ...
    dfp_read_field_def_m_icon_setpic_toc(RestF, 0, 0, F@_1,
					 NewFValue, TrUserData).

skip_varint_m_icon_setpic_toc(<<1:1, _:7, Rest/binary>>,
			      Z1, Z2, F@_1, F@_2, TrUserData) ->
    skip_varint_m_icon_setpic_toc(Rest, Z1, Z2, F@_1, F@_2,
				  TrUserData);
skip_varint_m_icon_setpic_toc(<<0:1, _:7, Rest/binary>>,
			      Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_icon_setpic_toc(Rest, Z1, Z2, F@_1,
					 F@_2, TrUserData).

skip_length_delimited_m_icon_setpic_toc(<<1:1, X:7,
					  Rest/binary>>,
					N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_icon_setpic_toc(Rest, N + 7,
					    X bsl N + Acc, F@_1, F@_2,
					    TrUserData);
skip_length_delimited_m_icon_setpic_toc(<<0:1, X:7,
					  Rest/binary>>,
					N, Acc, F@_1, F@_2, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_icon_setpic_toc(Rest2, 0, 0, F@_1,
					 F@_2, TrUserData).

skip_group_m_icon_setpic_toc(Bin, FNum, Z2, F@_1, F@_2,
			     TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_icon_setpic_toc(Rest, 0, Z2, F@_1,
					 F@_2, TrUserData).

skip_32_m_icon_setpic_toc(<<_:32, Rest/binary>>, Z1, Z2,
			  F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_icon_setpic_toc(Rest, Z1, Z2, F@_1,
					 F@_2, TrUserData).

skip_64_m_icon_setpic_toc(<<_:64, Rest/binary>>, Z1, Z2,
			  F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_icon_setpic_toc(Rest, Z1, Z2, F@_1,
					 F@_2, TrUserData).

decode_msg_m_icon_update_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_icon_update_toc(Bin, 0, 0,
					 id(undefined, TrUserData),
					 id(undefined, TrUserData), TrUserData).

dfp_read_field_def_m_icon_update_toc(<<8, Rest/binary>>,
				     Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_icon_update_toc_frame(Rest, Z1, Z2, F@_1,
				    F@_2, TrUserData);
dfp_read_field_def_m_icon_update_toc(<<16,
				       Rest/binary>>,
				     Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_icon_update_toc_bubble(Rest, Z1, Z2, F@_1,
				     F@_2, TrUserData);
dfp_read_field_def_m_icon_update_toc(<<>>, 0, 0, F@_1,
				     F@_2, _) ->
    #m_icon_update_toc{frame = F@_1, bubble = F@_2};
dfp_read_field_def_m_icon_update_toc(Other, Z1, Z2,
				     F@_1, F@_2, TrUserData) ->
    dg_read_field_def_m_icon_update_toc(Other, Z1, Z2, F@_1,
					F@_2, TrUserData).

dg_read_field_def_m_icon_update_toc(<<1:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, F@_2, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_icon_update_toc(Rest, N + 7,
					X bsl N + Acc, F@_1, F@_2, TrUserData);
dg_read_field_def_m_icon_update_toc(<<0:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, F@_2, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_icon_update_toc_frame(Rest, 0, 0, F@_1, F@_2,
					  TrUserData);
      16 ->
	  d_field_m_icon_update_toc_bubble(Rest, 0, 0, F@_1, F@_2,
					   TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_icon_update_toc(Rest, 0, 0, F@_1, F@_2,
					      TrUserData);
	    1 ->
		skip_64_m_icon_update_toc(Rest, 0, 0, F@_1, F@_2,
					  TrUserData);
	    2 ->
		skip_length_delimited_m_icon_update_toc(Rest, 0, 0,
							F@_1, F@_2, TrUserData);
	    3 ->
		skip_group_m_icon_update_toc(Rest, Key bsr 3, 0, F@_1,
					     F@_2, TrUserData);
	    5 ->
		skip_32_m_icon_update_toc(Rest, 0, 0, F@_1, F@_2,
					  TrUserData)
	  end
    end;
dg_read_field_def_m_icon_update_toc(<<>>, 0, 0, F@_1,
				    F@_2, _) ->
    #m_icon_update_toc{frame = F@_1, bubble = F@_2}.

d_field_m_icon_update_toc_frame(<<1:1, X:7,
				  Rest/binary>>,
				N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_icon_update_toc_frame(Rest, N + 7,
				    X bsl N + Acc, F@_1, F@_2, TrUserData);
d_field_m_icon_update_toc_frame(<<0:1, X:7,
				  Rest/binary>>,
				N, Acc, _, F@_2, TrUserData) ->
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    dfp_read_field_def_m_icon_update_toc(RestF, 0, 0,
					 NewFValue, F@_2, TrUserData).

d_field_m_icon_update_toc_bubble(<<1:1, X:7,
				   Rest/binary>>,
				 N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_icon_update_toc_bubble(Rest, N + 7,
				     X bsl N + Acc, F@_1, F@_2, TrUserData);
d_field_m_icon_update_toc_bubble(<<0:1, X:7,
				   Rest/binary>>,
				 N, Acc, F@_1, _, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:32/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    dfp_read_field_def_m_icon_update_toc(RestF, 0, 0, F@_1,
					 NewFValue, TrUserData).

skip_varint_m_icon_update_toc(<<1:1, _:7, Rest/binary>>,
			      Z1, Z2, F@_1, F@_2, TrUserData) ->
    skip_varint_m_icon_update_toc(Rest, Z1, Z2, F@_1, F@_2,
				  TrUserData);
skip_varint_m_icon_update_toc(<<0:1, _:7, Rest/binary>>,
			      Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_icon_update_toc(Rest, Z1, Z2, F@_1,
					 F@_2, TrUserData).

skip_length_delimited_m_icon_update_toc(<<1:1, X:7,
					  Rest/binary>>,
					N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_icon_update_toc(Rest, N + 7,
					    X bsl N + Acc, F@_1, F@_2,
					    TrUserData);
skip_length_delimited_m_icon_update_toc(<<0:1, X:7,
					  Rest/binary>>,
					N, Acc, F@_1, F@_2, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_icon_update_toc(Rest2, 0, 0, F@_1,
					 F@_2, TrUserData).

skip_group_m_icon_update_toc(Bin, FNum, Z2, F@_1, F@_2,
			     TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_icon_update_toc(Rest, 0, Z2, F@_1,
					 F@_2, TrUserData).

skip_32_m_icon_update_toc(<<_:32, Rest/binary>>, Z1, Z2,
			  F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_icon_update_toc(Rest, Z1, Z2, F@_1,
					 F@_2, TrUserData).

skip_64_m_icon_update_toc(<<_:64, Rest/binary>>, Z1, Z2,
			  F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_icon_update_toc(Rest, Z1, Z2, F@_1,
					 F@_2, TrUserData).
...
merge_msgs(Prev, New, MsgName, Opts) ->
    ...
    case MsgName of
      m_icon_setpic_tos ->
	  merge_msg_m_icon_setpic_tos(Prev, New, TrUserData);
      m_icon_setpic_toc ->
	  merge_msg_m_icon_setpic_toc(Prev, New, TrUserData);
      m_icon_update_toc ->
	  merge_msg_m_icon_update_toc(Prev, New, TrUserData);
      p_role_base ->
...
-compile({nowarn_unused_function,merge_msg_m_icon_setpic_tos/3}).
merge_msg_m_icon_setpic_tos(#m_icon_setpic_tos{},
			    #m_icon_setpic_tos{pic = NFpic, md5 = NFmd5}, _) ->
    #m_icon_setpic_tos{pic = NFpic, md5 = NFmd5}.

-compile({nowarn_unused_function,merge_msg_m_icon_setpic_toc/3}).
merge_msg_m_icon_setpic_toc(#m_icon_setpic_toc{},
			    #m_icon_setpic_toc{pic = NFpic, md5 = NFmd5}, _) ->
    #m_icon_setpic_toc{pic = NFpic, md5 = NFmd5}.

-compile({nowarn_unused_function,merge_msg_m_icon_update_toc/3}).
merge_msg_m_icon_update_toc(#m_icon_update_toc{frame =
						   PFframe,
					       bubble = PFbubble},
			    #m_icon_update_toc{frame = NFframe,
					       bubble = NFbubble},
			    _) ->
    #m_icon_update_toc{frame =
			   if NFframe =:= undefined -> PFframe;
			      true -> NFframe
			   end,
		       bubble =
			   if NFbubble =:= undefined -> PFbubble;
			      true -> NFbubble
			   end}.
...
verify_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
      m_icon_setpic_tos ->
	  v_msg_m_icon_setpic_tos(Msg, [MsgName], TrUserData);
      m_icon_setpic_toc ->
	  v_msg_m_icon_setpic_toc(Msg, [MsgName], TrUserData);
      m_icon_update_toc ->
	  v_msg_m_icon_update_toc(Msg, [MsgName], TrUserData);
      p_role_base ->
...
-compile({nowarn_unused_function,v_msg_m_icon_setpic_tos/3}).
-dialyzer({nowarn_function,v_msg_m_icon_setpic_tos/3}).
v_msg_m_icon_setpic_tos(#m_icon_setpic_tos{pic = F1,
					   md5 = F2},
			Path, TrUserData) ->
    v_type_string(F1, [pic | Path], TrUserData),
    v_type_string(F2, [md5 | Path], TrUserData),
    ok;
v_msg_m_icon_setpic_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_icon_setpic_tos}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_icon_setpic_toc/3}).
-dialyzer({nowarn_function,v_msg_m_icon_setpic_toc/3}).
v_msg_m_icon_setpic_toc(#m_icon_setpic_toc{pic = F1,
					   md5 = F2},
			Path, TrUserData) ->
    v_type_string(F1, [pic | Path], TrUserData),
    v_type_string(F2, [md5 | Path], TrUserData),
    ok;
v_msg_m_icon_setpic_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_icon_setpic_toc}, X,
		  Path).

-compile({nowarn_unused_function,v_msg_m_icon_update_toc/3}).
-dialyzer({nowarn_function,v_msg_m_icon_update_toc/3}).
v_msg_m_icon_update_toc(#m_icon_update_toc{frame = F1,
					   bubble = F2},
			Path, TrUserData) ->
    if F1 == undefined -> ok;
       true -> v_type_int32(F1, [frame | Path], TrUserData)
    end,
    if F2 == undefined -> ok;
       true -> v_type_int32(F2, [bubble | Path], TrUserData)
    end,
    ok;
v_msg_m_icon_update_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_icon_update_toc}, X,
		  Path).
...
get_msg_defs() ->
    [{{msg, m_icon_setpic_tos},
      [#field{name = pic, fnum = 1, rnum = 2, type = string,
	      occurrence = required, opts = []},
       #field{name = md5, fnum = 2, rnum = 3, type = string,
	      occurrence = required, opts = []}]},
     {{msg, m_icon_setpic_toc},
      [#field{name = pic, fnum = 1, rnum = 2, type = string,
	      occurrence = required, opts = []},
       #field{name = md5, fnum = 2, rnum = 3, type = string,
	      occurrence = required, opts = []}]},
     {{msg, m_icon_update_toc},
      [#field{name = frame, fnum = 1, rnum = 2, type = int32,
	      occurrence = optional, opts = []},
       #field{name = bubble, fnum = 2, rnum = 3, type = int32,
	      occurrence = optional, opts = []}]},
     {{msg, p_role_base},
...
get_msg_names() ->
    [m_icon_setpic_tos, m_icon_setpic_toc,
     m_icon_update_toc, p_role_base, p_aspect, p_attr,
...
find_msg_def(m_icon_setpic_tos) ->
    [#field{name = pic, fnum = 1, rnum = 2, type = string,
	    occurrence = required, opts = []},
     #field{name = md5, fnum = 2, rnum = 3, type = string,
	    occurrence = required, opts = []}];
find_msg_def(m_icon_setpic_toc) ->
    [#field{name = pic, fnum = 1, rnum = 2, type = string,
	    occurrence = required, opts = []},
     #field{name = md5, fnum = 2, rnum = 3, type = string,
	    occurrence = required, opts = []}];
find_msg_def(m_icon_update_toc) ->
    [#field{name = frame, fnum = 1, rnum = 2, type = int32,
	    occurrence = optional, opts = []},
     #field{name = bubble, fnum = 2, rnum = 3, type = int32,
	    occurrence = optional, opts = []}];
