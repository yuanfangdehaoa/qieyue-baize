...
-ifndef(pb_1146_sub_equips).
-define(pb_1146_sub_equips, true).

-define(pb_1146_sub_equips_gpb_version, "4.5.1").

-ifndef('M_SUB_EQUIP_TOS_PB_H').
-define('M_SUB_EQUIP_TOS_PB_H', true).
-record(m_sub_equip_tos,
        {stype                  :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_SUB_EQUIP_TOC_PB_H').
-define('M_SUB_EQUIP_TOC_PB_H', true).
-record(m_sub_equip_toc,
        {equips = []            :: [pb_1146_sub_equips:p_item()] | undefined, % = 1
         slots = #{}            :: #{integer() := integer()} | undefined, % = 2
         stype                  :: integer()        % = 3, 32 bits
        }).
-endif.

-ifndef('M_SUB_EQUIP_PUTON_TOS_PB_H').
-define('M_SUB_EQUIP_PUTON_TOS_PB_H', true).
-record(m_sub_equip_puton_tos,
        {uid                    :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_SUB_EQUIP_PUTON_TOC_PB_H').
-define('M_SUB_EQUIP_PUTON_TOC_PB_H', true).
-record(m_sub_equip_puton_toc,
        {slot                   :: integer(),       % = 1, 32 bits
         stype                  :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_SUB_EQUIP_UPLEVEL_TOS_PB_H').
-define('M_SUB_EQUIP_UPLEVEL_TOS_PB_H', true).
-record(m_sub_equip_uplevel_tos,
        {slot                   :: integer(),       % = 1, 32 bits
         stype                  :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_SUB_EQUIP_UPLEVEL_TOC_PB_H').
-define('M_SUB_EQUIP_UPLEVEL_TOC_PB_H', true).
-record(m_sub_equip_uplevel_toc,
        {slot                   :: integer(),       % = 1, 32 bits
         stype                  :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_SUB_EQUIP_DECOMPOSE_TOS_PB_H').
-define('M_SUB_EQUIP_DECOMPOSE_TOS_PB_H', true).
-record(m_sub_equip_decompose_tos,
        {uid = []               :: [integer()] | undefined % = 1, 32 bits
        }).
-endif.

-ifndef('M_SUB_EQUIP_DECOMPOSE_TOC_PB_H').
-define('M_SUB_EQUIP_DECOMPOSE_TOC_PB_H', true).
-record(m_sub_equip_decompose_toc,
        {
        }).
-endif.
...
-record(p_role_base,
        {id                     :: non_neg_integer(), % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1146_sub_equips:p_aspect()} | undefined, % = 8
         ...
         icon                   :: pb_1146_sub_equips:p_icon() | undefined, % = 17
...
-record(p_item,
        {uid                    :: integer(),       % = 1, 32 bits
         ...
         gender                 :: integer(),       % = 7, 32 bits
         score                  :: integer() | undefined, % = 8, 32 bits
         equip                  :: pb_1146_sub_equips:p_equip() | undefined, % = 9
         pet                    :: pb_1146_sub_equips:p_pet() | undefined, % = 10
...
-record(p_equip,
        {base                   :: pb_1146_sub_equips:p_attr(), % = 1
         rare1                  :: pb_1146_sub_equips:p_attr() | undefined, % = 2
         rare2                  :: pb_1146_sub_equips:p_attr() | undefined, % = 3
         rare3                  :: pb_1146_sub_equips:p_attr() | undefined, % = 4
         marriage               :: pb_1146_sub_equips:p_marriage() | undefined, % = 5
         ...
         refine = []            :: [pb_1146_sub_equips:p_refine()] | undefined, % = 11
         suite = #{}            :: #{integer() := integer()} | undefined, % = 12
         combine = []           :: [pb_1146_sub_equips:p_item()] | undefined % = 13
        }).
-endif.
...
-record(p_marriage,
        {husband_id             :: non_neg_integer() | undefined, % = 1, 32 bits
         ...
         rare                   :: pb_1146_sub_equips:p_attr() | undefined % = 5
        }).
-endif.
...
-record(p_actor,
        {uid                    :: non_neg_integer(), % = 1, 32 bits
         ...
         coord                  :: pb_1146_sub_equips:p_coord(), % = 4
         state                  :: integer(),       % = 5, 32 bits
         stargs = #{}           :: #{integer() := iolist()} | undefined, % = 6
         role                   :: pb_1146_sub_equips:p_role() | undefined, % = 7
         creep                  :: pb_1146_sub_equips:p_creep() | undefined, % = 8
         drop                   :: pb_1146_sub_equips:p_drop() | undefined % = 9
        }).
-endif.
...
-record(p_role,
        {career                 :: integer(),       % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1146_sub_equips:p_aspect()} | undefined, % = 5
         ...
         icon                   :: pb_1146_sub_equips:p_icon() | undefined % = 25
        }).
-endif.
...
-record(p_creep,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         buffs = []             :: [pb_1146_sub_equips:p_buff()] | undefined, % = 6
         dir                    :: integer(),       % = 7, 32 bits
         dest                   :: pb_1146_sub_equips:p_coord(), % = 8
...
-record(p_npc,
        {id                     :: integer(),       % = 1, 32 bits
         coord                  :: pb_1146_sub_equips:p_coord() % = 2
        }).
-endif.
...
-record(p_drop,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         coord                  :: pb_1146_sub_equips:p_coord() | undefined, % = 5
...
-record(p_ranking,
        {base                   :: pb_1146_sub_equips:p_role_base() | undefined, % = 1
