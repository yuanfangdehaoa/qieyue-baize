...
-ifndef(pb_1800_totem).
-define(pb_1800_totem, true).

-define(pb_1800_totem_gpb_version, "4.5.1").

-ifndef('M_TOTEM_LIST_TOS_PB_H').
-define('M_TOTEM_LIST_TOS_PB_H', true).
-record(m_totem_list_tos,
        {
        }).
-endif.

-ifndef('M_TOTEM_LIST_TOC_PB_H').
-define('M_TOTEM_LIST_TOC_PB_H', true).
-record(m_totem_list_toc,
        {max_summon             :: integer(),       % = 1, 32 bits
         list = []              :: [pb_1800_totem:p_totem()] | undefined % = 2
        }).
-endif.

-ifndef('M_TOTEM_ADDSUMMON_TOS_PB_H').
-define('M_TOTEM_ADDSUMMON_TOS_PB_H', true).
-record(m_totem_addsummon_tos,
        {
        }).
-endif.

-ifndef('M_TOTEM_ADDSUMMON_TOC_PB_H').
-define('M_TOTEM_ADDSUMMON_TOC_PB_H', true).
-record(m_totem_addsummon_toc,
        {max_summon             :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_TOTEM_EQUIP_LOAD_TOS_PB_H').
-define('M_TOTEM_EQUIP_LOAD_TOS_PB_H', true).
-record(m_totem_equip_load_tos,
        {id                     :: integer(),       % = 1, 32 bits
         uid                    :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_TOTEM_EQUIP_LOAD_TOC_PB_H').
-define('M_TOTEM_EQUIP_LOAD_TOC_PB_H', true).
-record(m_totem_equip_load_toc,
        {id                     :: integer(),       % = 1, 32 bits
         equip                  :: pb_1800_totem:p_item() % = 2
        }).
-endif.

-ifndef('M_TOTEM_EQUIP_UNLOAD_TOS_PB_H').
-define('M_TOTEM_EQUIP_UNLOAD_TOS_PB_H', true).
-record(m_totem_equip_unload_tos,
        {id                     :: integer(),       % = 1, 32 bits
         slot                   :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_TOTEM_EQUIP_UNLOAD_TOC_PB_H').
-define('M_TOTEM_EQUIP_UNLOAD_TOC_PB_H', true).
-record(m_totem_equip_unload_toc,
        {id                     :: integer(),       % = 1, 32 bits
         slot                   :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_TOTEM_SUMMON_TOS_PB_H').
-define('M_TOTEM_SUMMON_TOS_PB_H', true).
-record(m_totem_summon_tos,
        {id                     :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_TOTEM_SUMMON_TOC_PB_H').
-define('M_TOTEM_SUMMON_TOC_PB_H', true).
-record(m_totem_summon_toc,
        {id                     :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_TOTEM_UNSUMMON_TOS_PB_H').
-define('M_TOTEM_UNSUMMON_TOS_PB_H', true).
-record(m_totem_unsummon_tos,
        {id                     :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_TOTEM_UNSUMMON_TOC_PB_H').
-define('M_TOTEM_UNSUMMON_TOC_PB_H', true).
-record(m_totem_unsummon_toc,
        {id                     :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_TOTEM_EQUIP_REINFORCE_TOS_PB_H').
-define('M_TOTEM_EQUIP_REINFORCE_TOS_PB_H', true).
-record(m_totem_equip_reinforce_tos,
        {id                     :: integer(),       % = 1, 32 bits
         uid                    :: integer(),       % = 2, 32 bits
         cellids = []           :: [integer()] | undefined, % = 3, 32 bits
         use_gold               :: boolean() | 0 | 1 % = 4
        }).
-endif.

-ifndef('M_TOTEM_EQUIP_REINFORCE_TOC_PB_H').
-define('M_TOTEM_EQUIP_REINFORCE_TOC_PB_H', true).
-record(m_totem_equip_reinforce_toc,
        {id                     :: integer(),       % = 1, 32 bits
         equip                  :: pb_1800_totem:p_item() % = 2
        }).
-endif.
...
-ifndef('P_TOTEM_PB_H').
-define('P_TOTEM_PB_H', true).
-record(p_totem,
        {id                     :: integer(),       % = 1, 32 bits
         equips = []            :: [pb_1800_totem:p_item()] | undefined, % = 2
         summon                 :: boolean() | 0 | 1 % = 3
        }).
-endif.
...
-record(p_role_base,
        {id                     :: non_neg_integer(), % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1800_totem:p_aspect()} | undefined, % = 8
         ...
         icon                   :: pb_1800_totem:p_icon() | undefined, % = 17
...
-record(p_item,
        {uid                    :: integer(),       % = 1, 32 bits
         ...
         gender                 :: integer(),       % = 7, 32 bits
         score                  :: integer() | undefined, % = 8, 32 bits
         equip                  :: pb_1800_totem:p_equip() | undefined, % = 9
         pet                    :: pb_1800_totem:p_pet() | undefined, % = 10
...
-record(p_equip,
        {base                   :: pb_1800_totem:p_attr(), % = 1
         rare1                  :: pb_1800_totem:p_attr() | undefined, % = 2
         rare2                  :: pb_1800_totem:p_attr() | undefined, % = 3
         rare3                  :: pb_1800_totem:p_attr() | undefined, % = 4
         marriage               :: pb_1800_totem:p_marriage() | undefined, % = 5
         ...
         refine = []            :: [pb_1800_totem:p_refine()] | undefined, % = 11
         suite = #{}            :: #{integer() := integer()} | undefined, % = 12
         combine = []           :: [pb_1800_totem:p_item()] | undefined % = 13
        }).
-endif.
...
-record(p_marriage,
        {husband_id             :: non_neg_integer() | undefined, % = 1, 32 bits
         ...
         rare                   :: pb_1800_totem:p_attr() | undefined % = 5
        }).
-endif.
...
-record(p_actor,
        {uid                    :: non_neg_integer(), % = 1, 32 bits
         ...
         coord                  :: pb_1800_totem:p_coord(), % = 4
         state                  :: integer(),       % = 5, 32 bits
         stargs = #{}           :: #{integer() := iolist()} | undefined, % = 6
         role                   :: pb_1800_totem:p_role() | undefined, % = 7
         creep                  :: pb_1800_totem:p_creep() | undefined, % = 8
         drop                   :: pb_1800_totem:p_drop() | undefined % = 9
        }).
-endif.
...
-record(p_role,
        {career                 :: integer(),       % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1800_totem:p_aspect()} | undefined, % = 5
         ...
         icon                   :: pb_1800_totem:p_icon() | undefined % = 25
        }).
-endif.
...
-record(p_creep,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         buffs = []             :: [pb_1800_totem:p_buff()] | undefined, % = 6
         dir                    :: integer(),       % = 7, 32 bits
         dest                   :: pb_1800_totem:p_coord(), % = 8
...
-record(p_drop,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         coord                  :: pb_1800_totem:p_coord() | undefined, % = 5
...
-record(p_ranking,
        {base                   :: pb_1800_totem:p_role_base() | undefined, % = 1
