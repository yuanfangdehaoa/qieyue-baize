...
-ifndef(pb_1135_wedding).
-define(pb_1135_wedding, true).

-define(pb_1135_wedding_gpb_version, "4.5.1").

-ifndef('M_WEDDING_APPOINTMENT_INFO_TOS_PB_H').
-define('M_WEDDING_APPOINTMENT_INFO_TOS_PB_H', true).
-record(m_wedding_appointment_info_tos,
        {
        }).
-endif.

-ifndef('M_WEDDING_APPOINTMENT_INFO_TOC_PB_H').
-define('M_WEDDING_APPOINTMENT_INFO_TOC_PB_H', true).
-record(m_wedding_appointment_info_toc,
        {appointments = []      :: [pb_1135_wedding:p_wedding_appointment()] | undefined, % = 1
         remain_times           :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_WEDDING_APPOINTMENT_BOOK_TOS_PB_H').
-define('M_WEDDING_APPOINTMENT_BOOK_TOS_PB_H', true).
-record(m_wedding_appointment_book_tos,
        {start_time             :: integer(),       % = 1, 32 bits
         end_time               :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_WEDDING_APPOINTMENT_BOOK_TOC_PB_H').
-define('M_WEDDING_APPOINTMENT_BOOK_TOC_PB_H', true).
-record(m_wedding_appointment_book_toc,
        {
        }).
-endif.

-ifndef('M_WEDDING_GUEST_LIST_TOS_PB_H').
-define('M_WEDDING_GUEST_LIST_TOS_PB_H', true).
-record(m_wedding_guest_list_tos,
        {
        }).
-endif.

-ifndef('M_WEDDING_GUEST_LIST_TOC_PB_H').
-define('M_WEDDING_GUEST_LIST_TOC_PB_H', true).
-record(m_wedding_guest_list_toc,
        {guests = []            :: [pb_1135_wedding:p_role_base()] | undefined, % = 1
         max_invite             :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_WEDDING_GUEST_INVITE_TOS_PB_H').
-define('M_WEDDING_GUEST_INVITE_TOS_PB_H', true).
-record(m_wedding_guest_invite_tos,
        {id                     :: non_neg_integer() % = 1, 32 bits
        }).
-endif.

-ifndef('M_WEDDING_GUEST_INVITE_TOC_PB_H').
-define('M_WEDDING_GUEST_INVITE_TOC_PB_H', true).
-record(m_wedding_guest_invite_toc,
        {guest                  :: pb_1135_wedding:p_role_base() % = 1
        }).
-endif.

-ifndef('M_WEDDING_NOTICE_TOS_PB_H').
-define('M_WEDDING_NOTICE_TOS_PB_H', true).
-record(m_wedding_notice_tos,
        {
        }).
-endif.

-ifndef('M_WEDDING_NOTICE_TOC_PB_H').
-define('M_WEDDING_NOTICE_TOC_PB_H', true).
-record(m_wedding_notice_toc,
        {wedding                :: pb_1135_wedding:p_wedding() % = 1
        }).
-endif.

-ifndef('M_WEDDING_INVITATION_REQUEST_TOS_PB_H').
-define('M_WEDDING_INVITATION_REQUEST_TOS_PB_H', true).
-record(m_wedding_invitation_request_tos,
        {start_time             :: integer(),       % = 1, 32 bits
         end_time               :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_WEDDING_INVITATION_REQUEST_TOC_PB_H').
-define('M_WEDDING_INVITATION_REQUEST_TOC_PB_H', true).
-record(m_wedding_invitation_request_toc,
        {
        }).
-endif.

-ifndef('M_WEDDING_INVITATION_APPLY_TOC_PB_H').
-define('M_WEDDING_INVITATION_APPLY_TOC_PB_H', true).
-record(m_wedding_invitation_apply_toc,
        {guest                  :: pb_1135_wedding:p_role_base() % = 1
        }).
-endif.

-ifndef('M_WEDDING_INVITATION_REQUEST_LIST_TOS_PB_H').
-define('M_WEDDING_INVITATION_REQUEST_LIST_TOS_PB_H', true).
-record(m_wedding_invitation_request_list_tos,
        {
        }).
-endif.

-ifndef('M_WEDDING_INVITATION_REQUEST_LIST_TOC_PB_H').
-define('M_WEDDING_INVITATION_REQUEST_LIST_TOC_PB_H', true).
-record(m_wedding_invitation_request_list_toc,
        {guests = []            :: [pb_1135_wedding:p_role_base()] | undefined, % = 1
         remain_invite          :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_WEDDING_INVITATION_REQUEST_ACCEPT_TOS_PB_H').
-define('M_WEDDING_INVITATION_REQUEST_ACCEPT_TOS_PB_H', true).
-record(m_wedding_invitation_request_accept_tos,
        {ids = []               :: [non_neg_integer()] | undefined % = 1, 32 bits
        }).
-endif.

-ifndef('M_WEDDING_INVITATION_REQUEST_ACCEPT_TOC_PB_H').
-define('M_WEDDING_INVITATION_REQUEST_ACCEPT_TOC_PB_H', true).
-record(m_wedding_invitation_request_accept_toc,
        {ids = []               :: [non_neg_integer()] | undefined % = 1, 32 bits
        }).
-endif.

-ifndef('M_WEDDING_INVITATION_REQUEST_REFUSE_TOS_PB_H').
-define('M_WEDDING_INVITATION_REQUEST_REFUSE_TOS_PB_H', true).
-record(m_wedding_invitation_request_refuse_tos,
        {id                     :: non_neg_integer() % = 1, 32 bits
        }).
-endif.

-ifndef('M_WEDDING_INVITATION_REQUEST_REFUSE_TOC_PB_H').
-define('M_WEDDING_INVITATION_REQUEST_REFUSE_TOC_PB_H', true).
-record(m_wedding_invitation_request_refuse_toc,
        {id                     :: non_neg_integer() % = 1, 32 bits
        }).
-endif.

-ifndef('M_WEDDING_INVITATION_ADD_TOS_PB_H').
-define('M_WEDDING_INVITATION_ADD_TOS_PB_H', true).
-record(m_wedding_invitation_add_tos,
        {
        }).
-endif.

-ifndef('M_WEDDING_INVITATION_ADD_TOC_PB_H').
-define('M_WEDDING_INVITATION_ADD_TOC_PB_H', true).
-record(m_wedding_invitation_add_toc,
        {max_invite             :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_WEDDING_PARTY_INFO_TOS_PB_H').
-define('M_WEDDING_PARTY_INFO_TOS_PB_H', true).
-record(m_wedding_party_info_tos,
        {
        }).
-endif.

-ifndef('M_WEDDING_PARTY_INFO_TOC_PB_H').
-define('M_WEDDING_PARTY_INFO_TOC_PB_H', true).
-record(m_wedding_party_info_toc,
        {etime                  :: integer(),       % = 1, 32 bits
         exp                    :: non_neg_integer(), % = 2, 32 bits
         food                   :: integer(),       % = 3, 32 bits
         candy                  :: integer(),       % = 4, 32 bits
         hot                    :: integer(),       % = 5, 32 bits
         fetch = []             :: [integer()] | undefined, % = 6, 32 bits
         refresh                :: boolean() | 0 | 1 % = 7
        }).
-endif.

-ifndef('M_WEDDING_PARTY_EXP_TOS_PB_H').
-define('M_WEDDING_PARTY_EXP_TOS_PB_H', true).
-record(m_wedding_party_exp_tos,
        {
        }).
-endif.

-ifndef('M_WEDDING_PARTY_EXP_TOC_PB_H').
-define('M_WEDDING_PARTY_EXP_TOC_PB_H', true).
-record(m_wedding_party_exp_toc,
        {exp                    :: non_neg_integer() % = 1, 32 bits
        }).
-endif.

-ifndef('M_WEDDING_PARTY_HOT_TOC_PB_H').
-define('M_WEDDING_PARTY_HOT_TOC_PB_H', true).
-record(m_wedding_party_hot_toc,
        {hot                    :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_WEDDING_PARTY_FETCH_TOS_PB_H').
-define('M_WEDDING_PARTY_FETCH_TOS_PB_H', true).
-record(m_wedding_party_fetch_tos,
        {hot                    :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_WEDDING_PARTY_FETCH_TOC_PB_H').
-define('M_WEDDING_PARTY_FETCH_TOC_PB_H', true).
-record(m_wedding_party_fetch_toc,
        {fetch = []             :: [integer()] | undefined % = 5, 32 bits
        }).
-endif.

-ifndef('M_WEDDING_INFO_TOS_PB_H').
-define('M_WEDDING_INFO_TOS_PB_H', true).
-record(m_wedding_info_tos,
        {
        }).
-endif.

-ifndef('M_WEDDING_INFO_TOC_PB_H').
-define('M_WEDDING_INFO_TOC_PB_H', true).
-record(m_wedding_info_toc,
        {appointment            :: pb_1135_wedding:p_wedding_appointment() | undefined, % = 1
         has_request            :: boolean() | 0 | 1 % = 2
        }).
-endif.

-ifndef('P_WEDDING_APPOINTMENT_PB_H').
-define('P_WEDDING_APPOINTMENT_PB_H', true).
-record(p_wedding_appointment,
        {start_time             :: integer(),       % = 1, 32 bits
         end_time               :: integer(),       % = 2, 32 bits
         couple = []            :: [pb_1135_wedding:p_role_base()] | undefined % = 3
        }).
-endif.

-ifndef('P_WEDDING_PB_H').
-define('P_WEDDING_PB_H', true).
-record(p_wedding,
        {start_time             :: integer(),       % = 1, 32 bits
         end_time               :: integer(),       % = 2, 32 bits
         couple = []            :: [pb_1135_wedding:p_role_base()] | undefined % = 3
...
-record(p_role_base,
        {id                     :: non_neg_integer(), % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1135_wedding:p_aspect()} | undefined, % = 8
         ...
         icon                   :: pb_1135_wedding:p_icon() | undefined, % = 17
...
-record(p_item,
        {uid                    :: integer(),       % = 1, 32 bits
         ...
         gender                 :: integer(),       % = 7, 32 bits
         score                  :: integer() | undefined, % = 8, 32 bits
         equip                  :: pb_1135_wedding:p_equip() | undefined, % = 9
         pet                    :: pb_1135_wedding:p_pet() | undefined, % = 10
...
-record(p_equip,
        {base                   :: pb_1135_wedding:p_attr(), % = 1
         rare1                  :: pb_1135_wedding:p_attr() | undefined, % = 2
         rare2                  :: pb_1135_wedding:p_attr() | undefined, % = 3
         rare3                  :: pb_1135_wedding:p_attr() | undefined, % = 4
         marriage               :: pb_1135_wedding:p_marriage() | undefined, % = 5
         ...
         refine = []            :: [pb_1135_wedding:p_refine()] | undefined, % = 11
         suite = #{}            :: #{integer() := integer()} | undefined, % = 12
         combine = []           :: [pb_1135_wedding:p_item()] | undefined % = 13
        }).
-endif.
...
-record(p_marriage,
        {husband_id             :: non_neg_integer() | undefined, % = 1, 32 bits
         ...
         rare                   :: pb_1135_wedding:p_attr() | undefined % = 5
        }).
-endif.
...
-record(p_actor,
        {uid                    :: non_neg_integer(), % = 1, 32 bits
         ...
         coord                  :: pb_1135_wedding:p_coord(), % = 4
         state                  :: integer(),       % = 5, 32 bits
         stargs = #{}           :: #{integer() := iolist()} | undefined, % = 6
         role                   :: pb_1135_wedding:p_role() | undefined, % = 7
         creep                  :: pb_1135_wedding:p_creep() | undefined, % = 8
         drop                   :: pb_1135_wedding:p_drop() | undefined % = 9
        }).
-endif.
...
-record(p_role,
        {career                 :: integer(),       % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1135_wedding:p_aspect()} | undefined, % = 5
         ...
         icon                   :: pb_1135_wedding:p_icon() | undefined % = 25
        }).
-endif.
...
-record(p_creep,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         buffs = []             :: [pb_1135_wedding:p_buff()] | undefined, % = 6
         dir                    :: integer(),       % = 7, 32 bits
         dest                   :: pb_1135_wedding:p_coord(), % = 8
...
-record(p_npc,
        {id                     :: integer(),       % = 1, 32 bits
         coord                  :: pb_1135_wedding:p_coord() % = 2
        }).
-endif.
...
-record(p_drop,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         coord                  :: pb_1135_wedding:p_coord() | undefined, % = 5
...
-record(p_ranking,
        {base                   :: pb_1135_wedding:p_role_base() | undefined, % = 1
