...
-export_type(['p_role_base'/0, 'p_aspect'/0, 'p_attr'/0, 'p_item_base'/0, 'p_item'/0, 'p_equip'/0, 'p_pet'/0, 'p_marriage'/0, 'p_refine'/0, 'p_actor'/0, 'p_role'/0, 'p_creep'/0, 'p_npc'/0, 'p_drop'/0, 'p_buff'/0, 'p_coord'/0, 'p_icon'/0, 'p_ranking'/0, 'p_dropped'/0]).

-spec encode_msg(#p_role_base{} | #p_aspect{} | #p_attr{} | #p_item_base{} | #p_item{} | #p_equip{} | #p_pet{} | #p_marriage{} | #p_refine{} | #p_actor{} | #p_role{} | #p_creep{} | #p_npc{} | #p_drop{} | #p_buff{} | #p_coord{} | #p_icon{} | #p_ranking{} | #p_dropped{}) -> binary().
encode_msg(Msg) when tuple_size(Msg) >= 1 ->
    encode_msg(Msg, element(1, Msg), []).

-spec encode_msg(#p_role_base{} | #p_aspect{} | #p_attr{} | #p_item_base{} | #p_item{} | #p_equip{} | #p_pet{} | #p_marriage{} | #p_refine{} | #p_actor{} | #p_role{} | #p_creep{} | #p_npc{} | #p_drop{} | #p_buff{} | #p_coord{} | #p_icon{} | #p_ranking{} | #p_dropped{}, atom() | list()) -> binary().
