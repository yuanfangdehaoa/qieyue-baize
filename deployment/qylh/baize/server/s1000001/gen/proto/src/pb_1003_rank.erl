...
%% message types
-type m_rank_list_tos() :: #m_rank_list_tos{}.

-type m_rank_list_toc() :: #m_rank_list_toc{}.
...
-export_type(['m_rank_list_tos'/0, 'm_rank_list_toc'/0, 'p_role_base'/0, 'p_aspect'/0, 'p_attr'/0, 'p_item_base'/0, 'p_item'/0, 'p_equip'/0, 'p_pet'/0, 'p_marriage'/0, 'p_refine'/0, 'p_actor'/0, 'p_role'/0, 'p_creep'/0, 'p_npc'/0, 'p_drop'/0, 'p_buff'/0, 'p_coord'/0, 'p_icon'/0, 'p_ranking'/0, 'p_dropped'/0]).

-spec encode_msg(#m_rank_list_tos{} | #m_rank_list_toc{} | #p_role_base{} | #p_aspect{} | #p_attr{} | #p_item_base{} | #p_item{} | #p_equip{} | #p_pet{} | #p_marriage{} | #p_refine{} | #p_actor{} | #p_role{} | #p_creep{} | #p_npc{} | #p_drop{} | #p_buff{} | #p_coord{} | #p_icon{} | #p_ranking{} | #p_dropped{}) -> binary().
encode_msg(Msg) when tuple_size(Msg) >= 1 ->
    encode_msg(Msg, element(1, Msg), []).

-spec encode_msg(#m_rank_list_tos{} | #m_rank_list_toc{} | #p_role_base{} | #p_aspect{} | #p_attr{} | #p_item_base{} | #p_item{} | #p_equip{} | #p_pet{} | #p_marriage{} | #p_refine{} | #p_actor{} | #p_role{} | #p_creep{} | #p_npc{} | #p_drop{} | #p_buff{} | #p_coord{} | #p_icon{} | #p_ranking{} | #p_dropped{}, atom() | list()) -> binary().
...
encode_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
      m_rank_list_tos ->
	  encode_msg_m_rank_list_tos(id(Msg, TrUserData),
				     TrUserData);
      m_rank_list_toc ->
	  encode_msg_m_rank_list_toc(id(Msg, TrUserData),
				     TrUserData);
      p_role_base ->
...
encode_msg_m_rank_list_tos(Msg, TrUserData) ->
    encode_msg_m_rank_list_tos(Msg, <<>>, TrUserData).


encode_msg_m_rank_list_tos(#m_rank_list_tos{id = F1,
					    page = F2},
			   Bin, TrUserData) ->
    B1 = begin
...
encode_msg_m_rank_list_toc(Msg, TrUserData) ->
    encode_msg_m_rank_list_toc(Msg, <<>>, TrUserData).


encode_msg_m_rank_list_toc(#m_rank_list_toc{id = F1,
					    total = F2, page = F3, list = F4,
					    mine = F5},
			   Bin, TrUserData) ->
    B1 = begin
	   TrF1 = id(F1, TrUserData),
    ...
    B4 = begin
	   ...
	   if TrF4 == [] -> B3;
	      true ->
		  e_field_m_rank_list_toc_list(TrF4, B3, TrUserData)
	   end
	 end,
    begin
      TrF5 = id(F5, TrUserData),
      e_mfield_m_rank_list_toc_mine(TrF5, <<B4/binary, 42>>,
				    TrUserData)
    end.
...
e_mfield_m_rank_list_toc_list(Msg, Bin, TrUserData) ->
    SubBin = encode_msg_p_ranking(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

e_field_m_rank_list_toc_list([Elem | Rest], Bin,
			     TrUserData) ->
    Bin2 = <<Bin/binary, 34>>,
    Bin3 = e_mfield_m_rank_list_toc_list(id(Elem,
					    TrUserData),
					 Bin2, TrUserData),
    e_field_m_rank_list_toc_list(Rest, Bin3, TrUserData);
e_field_m_rank_list_toc_list([], Bin, _TrUserData) ->
    Bin.

e_mfield_m_rank_list_toc_mine(Msg, Bin, TrUserData) ->
    SubBin = encode_msg_p_ranking(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.
...
decode_msg_2_doit(m_rank_list_tos, Bin, TrUserData) ->
    id(decode_msg_m_rank_list_tos(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(m_rank_list_toc, Bin, TrUserData) ->
    id(decode_msg_m_rank_list_toc(Bin, TrUserData),
       TrUserData);
...
decode_msg_m_rank_list_tos(Bin, TrUserData) ->
    dfp_read_field_def_m_rank_list_tos(Bin, 0, 0,
				       id(undefined, TrUserData),
				       id(undefined, TrUserData), TrUserData).

dfp_read_field_def_m_rank_list_tos(<<8, Rest/binary>>,
				   Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_rank_list_tos_id(Rest, Z1, Z2, F@_1, F@_2,
			       TrUserData);
dfp_read_field_def_m_rank_list_tos(<<16, Rest/binary>>,
				   Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_m_rank_list_tos_page(Rest, Z1, Z2, F@_1, F@_2,
				 TrUserData);
dfp_read_field_def_m_rank_list_tos(<<>>, 0, 0, F@_1,
				   F@_2, _) ->
    #m_rank_list_tos{id = F@_1, page = F@_2};
dfp_read_field_def_m_rank_list_tos(Other, Z1, Z2, F@_1,
				   F@_2, TrUserData) ->
    dg_read_field_def_m_rank_list_tos(Other, Z1, Z2, F@_1,
				      F@_2, TrUserData).

dg_read_field_def_m_rank_list_tos(<<1:1, X:7,
				    Rest/binary>>,
				  N, Acc, F@_1, F@_2, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_rank_list_tos(Rest, N + 7,
				      X bsl N + Acc, F@_1, F@_2, TrUserData);
dg_read_field_def_m_rank_list_tos(<<0:1, X:7,
				    Rest/binary>>,
				  N, Acc, F@_1, F@_2, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_rank_list_tos_id(Rest, 0, 0, F@_1, F@_2,
				     TrUserData);
      16 ->
	  d_field_m_rank_list_tos_page(Rest, 0, 0, F@_1, F@_2,
				       TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_rank_list_tos(Rest, 0, 0, F@_1, F@_2,
					    TrUserData);
	    1 ->
		skip_64_m_rank_list_tos(Rest, 0, 0, F@_1, F@_2,
					TrUserData);
	    2 ->
		skip_length_delimited_m_rank_list_tos(Rest, 0, 0, F@_1,
						      F@_2, TrUserData);
	    3 ->
		skip_group_m_rank_list_tos(Rest, Key bsr 3, 0, F@_1,
					   F@_2, TrUserData);
	    5 ->
		skip_32_m_rank_list_tos(Rest, 0, 0, F@_1, F@_2,
					TrUserData)
	  end
    end;
dg_read_field_def_m_rank_list_tos(<<>>, 0, 0, F@_1,
				  F@_2, _) ->
    #m_rank_list_tos{id = F@_1, page = F@_2}.

d_field_m_rank_list_tos_id(<<1:1, X:7, Rest/binary>>, N,
			   Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_rank_list_tos_id(Rest, N + 7, X bsl N + Acc,
			       F@_1, F@_2, TrUserData);
d_field_m_rank_list_tos_id(<<0:1, X:7, Rest/binary>>, N,
    ...
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    dfp_read_field_def_m_rank_list_tos(RestF, 0, 0,
				       NewFValue, F@_2, TrUserData).

d_field_m_rank_list_tos_page(<<1:1, X:7, Rest/binary>>,
			     N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_m_rank_list_tos_page(Rest, N + 7, X bsl N + Acc,
				 F@_1, F@_2, TrUserData);
d_field_m_rank_list_tos_page(<<0:1, X:7, Rest/binary>>,
    ...
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    dfp_read_field_def_m_rank_list_tos(RestF, 0, 0, F@_1,
				       NewFValue, TrUserData).

skip_varint_m_rank_list_tos(<<1:1, _:7, Rest/binary>>,
			    Z1, Z2, F@_1, F@_2, TrUserData) ->
    skip_varint_m_rank_list_tos(Rest, Z1, Z2, F@_1, F@_2,
				TrUserData);
skip_varint_m_rank_list_tos(<<0:1, _:7, Rest/binary>>,
			    Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_rank_list_tos(Rest, Z1, Z2, F@_1,
				       F@_2, TrUserData).

skip_length_delimited_m_rank_list_tos(<<1:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    skip_length_delimited_m_rank_list_tos(Rest, N + 7,
					  X bsl N + Acc, F@_1, F@_2,
					  TrUserData);
skip_length_delimited_m_rank_list_tos(<<0:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, F@_2, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_rank_list_tos(Rest2, 0, 0, F@_1,
				       F@_2, TrUserData).

skip_group_m_rank_list_tos(Bin, FNum, Z2, F@_1, F@_2,
			   TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_rank_list_tos(Rest, 0, Z2, F@_1,
				       F@_2, TrUserData).

skip_32_m_rank_list_tos(<<_:32, Rest/binary>>, Z1, Z2,
			F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_rank_list_tos(Rest, Z1, Z2, F@_1,
				       F@_2, TrUserData).

skip_64_m_rank_list_tos(<<_:64, Rest/binary>>, Z1, Z2,
			F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_m_rank_list_tos(Rest, Z1, Z2, F@_1,
				       F@_2, TrUserData).

decode_msg_m_rank_list_toc(Bin, TrUserData) ->
    dfp_read_field_def_m_rank_list_toc(Bin, 0, 0,
				       id(undefined, TrUserData),
				       id(undefined, TrUserData),
				       id(undefined, TrUserData),
				       id([], TrUserData),
...
dfp_read_field_def_m_rank_list_toc(<<8, Rest/binary>>,
				   Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
				   TrUserData) ->
    d_field_m_rank_list_toc_id(Rest, Z1, Z2, F@_1, F@_2,
			       F@_3, F@_4, F@_5, TrUserData);
dfp_read_field_def_m_rank_list_toc(<<16, Rest/binary>>,
				   Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
				   TrUserData) ->
    d_field_m_rank_list_toc_total(Rest, Z1, Z2, F@_1, F@_2,
				  F@_3, F@_4, F@_5, TrUserData);
dfp_read_field_def_m_rank_list_toc(<<24, Rest/binary>>,
				   Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
				   TrUserData) ->
    d_field_m_rank_list_toc_page(Rest, Z1, Z2, F@_1, F@_2,
				 F@_3, F@_4, F@_5, TrUserData);
dfp_read_field_def_m_rank_list_toc(<<34, Rest/binary>>,
				   Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
				   TrUserData) ->
    d_field_m_rank_list_toc_list(Rest, Z1, Z2, F@_1, F@_2,
				 F@_3, F@_4, F@_5, TrUserData);
dfp_read_field_def_m_rank_list_toc(<<42, Rest/binary>>,
				   Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
				   TrUserData) ->
    d_field_m_rank_list_toc_mine(Rest, Z1, Z2, F@_1, F@_2,
				 F@_3, F@_4, F@_5, TrUserData);
dfp_read_field_def_m_rank_list_toc(<<>>, 0, 0, F@_1,
				   F@_2, F@_3, R1, F@_5, TrUserData) ->
    #m_rank_list_toc{id = F@_1, total = F@_2, page = F@_3,
		     list = lists_reverse(R1, TrUserData), mine = F@_5};
dfp_read_field_def_m_rank_list_toc(Other, Z1, Z2, F@_1,
				   F@_2, F@_3, F@_4, F@_5, TrUserData) ->
    dg_read_field_def_m_rank_list_toc(Other, Z1, Z2, F@_1,
				      F@_2, F@_3, F@_4, F@_5, TrUserData).

dg_read_field_def_m_rank_list_toc(<<1:1, X:7,
				    Rest/binary>>,
				  N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
				  TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_m_rank_list_toc(Rest, N + 7,
				      X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
				      F@_5, TrUserData);
dg_read_field_def_m_rank_list_toc(<<0:1, X:7,
				    Rest/binary>>,
				  N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
				  TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_m_rank_list_toc_id(Rest, 0, 0, F@_1, F@_2, F@_3,
				     F@_4, F@_5, TrUserData);
      16 ->
	  d_field_m_rank_list_toc_total(Rest, 0, 0, F@_1, F@_2,
					F@_3, F@_4, F@_5, TrUserData);
      24 ->
	  d_field_m_rank_list_toc_page(Rest, 0, 0, F@_1, F@_2,
				       F@_3, F@_4, F@_5, TrUserData);
      34 ->
	  d_field_m_rank_list_toc_list(Rest, 0, 0, F@_1, F@_2,
				       F@_3, F@_4, F@_5, TrUserData);
      42 ->
	  d_field_m_rank_list_toc_mine(Rest, 0, 0, F@_1, F@_2,
				       F@_3, F@_4, F@_5, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_m_rank_list_toc(Rest, 0, 0, F@_1, F@_2,
					    F@_3, F@_4, F@_5, TrUserData);
	    1 ->
		skip_64_m_rank_list_toc(Rest, 0, 0, F@_1, F@_2, F@_3,
					F@_4, F@_5, TrUserData);
	    2 ->
		skip_length_delimited_m_rank_list_toc(Rest, 0, 0, F@_1,
						      F@_2, F@_3, F@_4, F@_5,
						      TrUserData);
	    3 ->
		skip_group_m_rank_list_toc(Rest, Key bsr 3, 0, F@_1,
					   F@_2, F@_3, F@_4, F@_5, TrUserData);
	    5 ->
		skip_32_m_rank_list_toc(Rest, 0, 0, F@_1, F@_2, F@_3,
					F@_4, F@_5, TrUserData)
	  end
    end;
dg_read_field_def_m_rank_list_toc(<<>>, 0, 0, F@_1,
				  F@_2, F@_3, R1, F@_5, TrUserData) ->
    #m_rank_list_toc{id = F@_1, total = F@_2, page = F@_3,
		     list = lists_reverse(R1, TrUserData), mine = F@_5}.

d_field_m_rank_list_toc_id(<<1:1, X:7, Rest/binary>>, N,
			   Acc, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData)
    when N < 57 ->
    d_field_m_rank_list_toc_id(Rest, N + 7, X bsl N + Acc,
			       F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData);
d_field_m_rank_list_toc_id(<<0:1, X:7, Rest/binary>>, N,
    ...
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    dfp_read_field_def_m_rank_list_toc(RestF, 0, 0,
				       NewFValue, F@_2, F@_3, F@_4, F@_5,
				       TrUserData).

d_field_m_rank_list_toc_total(<<1:1, X:7, Rest/binary>>,
			      N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData)
    when N < 57 ->
    d_field_m_rank_list_toc_total(Rest, N + 7,
				  X bsl N + Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
				  TrUserData);
d_field_m_rank_list_toc_total(<<0:1, X:7, Rest/binary>>,
    ...
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    dfp_read_field_def_m_rank_list_toc(RestF, 0, 0, F@_1,
				       NewFValue, F@_3, F@_4, F@_5, TrUserData).

d_field_m_rank_list_toc_page(<<1:1, X:7, Rest/binary>>,
			     N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData)
    when N < 57 ->
    d_field_m_rank_list_toc_page(Rest, N + 7, X bsl N + Acc,
				 F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData);
d_field_m_rank_list_toc_page(<<0:1, X:7, Rest/binary>>,
...
d_field_m_rank_list_toc_list(<<1:1, X:7, Rest/binary>>,
			     N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData)
    when N < 57 ->
    d_field_m_rank_list_toc_list(Rest, N + 7, X bsl N + Acc,
				 F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData);
d_field_m_rank_list_toc_list(<<0:1, X:7, Rest/binary>>,
...
d_field_m_rank_list_toc_mine(<<1:1, X:7, Rest/binary>>,
			     N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData)
    when N < 57 ->
    d_field_m_rank_list_toc_mine(Rest, N + 7, X bsl N + Acc,
				 F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData);
d_field_m_rank_list_toc_mine(<<0:1, X:7, Rest/binary>>,
...
skip_varint_m_rank_list_toc(<<1:1, _:7, Rest/binary>>,
			    Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) ->
    skip_varint_m_rank_list_toc(Rest, Z1, Z2, F@_1, F@_2,
				F@_3, F@_4, F@_5, TrUserData);
skip_varint_m_rank_list_toc(<<0:1, _:7, Rest/binary>>,
			    Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) ->
    dfp_read_field_def_m_rank_list_toc(Rest, Z1, Z2, F@_1,
				       F@_2, F@_3, F@_4, F@_5, TrUserData).

skip_length_delimited_m_rank_list_toc(<<1:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
				      TrUserData)
    when N < 57 ->
    skip_length_delimited_m_rank_list_toc(Rest, N + 7,
					  X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
					  F@_5, TrUserData);
skip_length_delimited_m_rank_list_toc(<<0:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
				      TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_m_rank_list_toc(Rest2, 0, 0, F@_1,
				       F@_2, F@_3, F@_4, F@_5, TrUserData).

skip_group_m_rank_list_toc(Bin, FNum, Z2, F@_1, F@_2,
			   F@_3, F@_4, F@_5, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_m_rank_list_toc(Rest, 0, Z2, F@_1,
				       F@_2, F@_3, F@_4, F@_5, TrUserData).

skip_32_m_rank_list_toc(<<_:32, Rest/binary>>, Z1, Z2,
			F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) ->
    dfp_read_field_def_m_rank_list_toc(Rest, Z1, Z2, F@_1,
				       F@_2, F@_3, F@_4, F@_5, TrUserData).

skip_64_m_rank_list_toc(<<_:64, Rest/binary>>, Z1, Z2,
			F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) ->
    dfp_read_field_def_m_rank_list_toc(Rest, Z1, Z2, F@_1,
				       F@_2, F@_3, F@_4, F@_5, TrUserData).
...
merge_msgs(Prev, New, MsgName, Opts) ->
    ...
    case MsgName of
      m_rank_list_tos ->
	  merge_msg_m_rank_list_tos(Prev, New, TrUserData);
      m_rank_list_toc ->
	  merge_msg_m_rank_list_toc(Prev, New, TrUserData);
      p_role_base ->
...
-compile({nowarn_unused_function,merge_msg_m_rank_list_tos/3}).
merge_msg_m_rank_list_tos(#m_rank_list_tos{},
			  #m_rank_list_tos{id = NFid, page = NFpage}, _) ->
    #m_rank_list_tos{id = NFid, page = NFpage}.

-compile({nowarn_unused_function,merge_msg_m_rank_list_toc/3}).
merge_msg_m_rank_list_toc(#m_rank_list_toc{list =
					       PFlist,
					   mine = PFmine},
			  #m_rank_list_toc{id = NFid, total = NFtotal,
					   page = NFpage, list = NFlist,
					   mine = NFmine},
			  TrUserData) ->
    #m_rank_list_toc{id = NFid, total = NFtotal,
		     page = NFpage,
...
verify_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
      m_rank_list_tos ->
	  v_msg_m_rank_list_tos(Msg, [MsgName], TrUserData);
      m_rank_list_toc ->
	  v_msg_m_rank_list_toc(Msg, [MsgName], TrUserData);
      p_role_base ->
...
-compile({nowarn_unused_function,v_msg_m_rank_list_tos/3}).
-dialyzer({nowarn_function,v_msg_m_rank_list_tos/3}).
v_msg_m_rank_list_tos(#m_rank_list_tos{id = F1,
				       page = F2},
		      Path, TrUserData) ->
    v_type_int32(F1, [id | Path], TrUserData),
    v_type_int32(F2, [page | Path], TrUserData),
    ok;
v_msg_m_rank_list_tos(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_rank_list_tos}, X, Path).

-compile({nowarn_unused_function,v_msg_m_rank_list_toc/3}).
-dialyzer({nowarn_function,v_msg_m_rank_list_toc/3}).
v_msg_m_rank_list_toc(#m_rank_list_toc{id = F1,
				       total = F2, page = F3, list = F4,
				       mine = F5},
		      Path, TrUserData) ->
    v_type_int32(F1, [id | Path], TrUserData),
    ...
    if is_list(F4) ->
	   ...
	   ok;
       true ->
	   mk_type_error({invalid_list_of, {msg, p_ranking}}, F4,
			 [list | Path])
    end,
    v_msg_p_ranking(F5, [mine | Path], TrUserData),
    ok;
v_msg_m_rank_list_toc(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, m_rank_list_toc}, X, Path).
...
get_msg_defs() ->
    [{{msg, m_rank_list_tos},
      [#field{name = id, fnum = 1, rnum = 2, type = int32,
       ...
       #field{name = page, fnum = 2, rnum = 3, type = int32,
	      occurrence = required, opts = []}]},
     {{msg, m_rank_list_toc},
      [#field{name = id, fnum = 1, rnum = 2, type = int32,
	      occurrence = required, opts = []},
       ...
       #field{name = page, fnum = 3, rnum = 4, type = int32,
	      occurrence = required, opts = []},
       #field{name = list, fnum = 4, rnum = 5,
	      type = {msg, p_ranking}, occurrence = repeated,
	      opts = []},
       #field{name = mine, fnum = 5, rnum = 6,
...
get_msg_names() ->
    [m_rank_list_tos, m_rank_list_toc, p_role_base,
...
find_msg_def(m_rank_list_tos) ->
    [#field{name = id, fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []},
     #field{name = page, fnum = 2, rnum = 3, type = int32,
	    occurrence = required, opts = []}];
find_msg_def(m_rank_list_toc) ->
    [#field{name = id, fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []},
     #field{name = total, fnum = 2, rnum = 3, type = int32,
	    occurrence = required, opts = []},
