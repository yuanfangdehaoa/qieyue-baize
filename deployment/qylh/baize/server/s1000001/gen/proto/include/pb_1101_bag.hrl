...
-ifndef(pb_1101_bag).
-define(pb_1101_bag, true).

-define(pb_1101_bag_gpb_version, "4.5.1").

-ifndef('M_BAG_INFO_TOS_PB_H').
-define('M_BAG_INFO_TOS_PB_H', true).
-record(m_bag_info_tos,
        {bag_id                 :: integer()        % = 1, 32 bits
        }).
-endif.

-ifndef('M_BAG_INFO_TOC_PB_H').
-define('M_BAG_INFO_TOC_PB_H', true).
-record(m_bag_info_toc,
        {bag_id                 :: integer(),       % = 1, 32 bits
         opened                 :: integer(),       % = 2, 32 bits
         items = []             :: [pb_1101_bag:p_item_base()] | undefined % = 3
        }).
-endif.

-ifndef('M_BAG_OPEN_TOS_PB_H').
-define('M_BAG_OPEN_TOS_PB_H', true).
-record(m_bag_open_tos,
        {bag_id                 :: integer(),       % = 1, 32 bits
         num                    :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_BAG_OPEN_TOC_PB_H').
-define('M_BAG_OPEN_TOC_PB_H', true).
-record(m_bag_open_toc,
        {bag_id                 :: integer(),       % = 1, 32 bits
         num                    :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_BAG_UPDATE_TOC_PB_H').
-define('M_BAG_UPDATE_TOC_PB_H', true).
-record(m_bag_update_toc,
        {add = []               :: [pb_1101_bag:p_item_base()] | undefined, % = 1
         del = []               :: [integer()] | undefined, % = 2, 32 bits
         chg = #{}              :: #{integer() := integer()} | undefined, % = 3
         way                    :: integer()        % = 4, 32 bits
        }).
-endif.
...
-record(p_role_base,
        {id                     :: non_neg_integer(), % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1101_bag:p_aspect()} | undefined, % = 8
         ...
         icon                   :: pb_1101_bag:p_icon() | undefined, % = 17
...
-record(p_item,
        {uid                    :: integer(),       % = 1, 32 bits
         ...
         gender                 :: integer(),       % = 7, 32 bits
         score                  :: integer() | undefined, % = 8, 32 bits
         equip                  :: pb_1101_bag:p_equip() | undefined, % = 9
         pet                    :: pb_1101_bag:p_pet() | undefined, % = 10
...
-record(p_equip,
        {base                   :: pb_1101_bag:p_attr(), % = 1
         rare1                  :: pb_1101_bag:p_attr() | undefined, % = 2
         rare2                  :: pb_1101_bag:p_attr() | undefined, % = 3
         rare3                  :: pb_1101_bag:p_attr() | undefined, % = 4
         marriage               :: pb_1101_bag:p_marriage() | undefined, % = 5
         ...
         refine = []            :: [pb_1101_bag:p_refine()] | undefined, % = 11
         suite = #{}            :: #{integer() := integer()} | undefined, % = 12
         combine = []           :: [pb_1101_bag:p_item()] | undefined % = 13
        }).
-endif.
...
-record(p_marriage,
        {husband_id             :: non_neg_integer() | undefined, % = 1, 32 bits
         ...
         rare                   :: pb_1101_bag:p_attr() | undefined % = 5
        }).
-endif.
...
-record(p_actor,
        {uid                    :: non_neg_integer(), % = 1, 32 bits
         ...
         coord                  :: pb_1101_bag:p_coord(), % = 4
         state                  :: integer(),       % = 5, 32 bits
         stargs = #{}           :: #{integer() := iolist()} | undefined, % = 6
         role                   :: pb_1101_bag:p_role() | undefined, % = 7
         creep                  :: pb_1101_bag:p_creep() | undefined, % = 8
         drop                   :: pb_1101_bag:p_drop() | undefined % = 9
        }).
-endif.
...
-record(p_role,
        {career                 :: integer(),       % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1101_bag:p_aspect()} | undefined, % = 5
         ...
         icon                   :: pb_1101_bag:p_icon() | undefined % = 25
        }).
-endif.
...
-record(p_creep,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         buffs = []             :: [pb_1101_bag:p_buff()] | undefined, % = 6
         dir                    :: integer(),       % = 7, 32 bits
         dest                   :: pb_1101_bag:p_coord(), % = 8
...
-record(p_drop,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         coord                  :: pb_1101_bag:p_coord() | undefined, % = 5
...
-record(p_ranking,
        {base                   :: pb_1101_bag:p_role_base() | undefined, % = 1
