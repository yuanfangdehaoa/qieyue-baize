...
-ifndef(pb_1602_guild_war).
-define(pb_1602_guild_war, true).

-define(pb_1602_guild_war_gpb_version, "4.5.1").

-ifndef('M_GUILD_WAR_FIELDS_TOS_PB_H').
-define('M_GUILD_WAR_FIELDS_TOS_PB_H', true).
-record(m_guild_war_fields_tos,
        {
        }).
-endif.

-ifndef('M_GUILD_WAR_FIELDS_TOC_PB_H').
-define('M_GUILD_WAR_FIELDS_TOC_PB_H', true).
-record(m_guild_war_fields_toc,
        {fields = []            :: [pb_1602_guild_war:p_gw_field()] | undefined, % = 1
         role                   :: pb_1602_guild_war:p_role_base() | undefined % = 2
        }).
-endif.

-ifndef('M_GUILD_WAR_BATTLE_TOC_PB_H').
-define('M_GUILD_WAR_BATTLE_TOC_PB_H', true).
-record(m_guild_war_battle_toc,
        {battle = []            :: [pb_1602_guild_war:p_gw_battle()] | undefined % = 1
        }).
-endif.

-ifndef('M_GUILD_WAR_RANKLIST_TOS_PB_H').
-define('M_GUILD_WAR_RANKLIST_TOS_PB_H', true).
-record(m_guild_war_ranklist_tos,
        {
        }).
-endif.

-ifndef('M_GUILD_WAR_RANKLIST_TOC_PB_H').
-define('M_GUILD_WAR_RANKLIST_TOC_PB_H', true).
-record(m_guild_war_ranklist_toc,
        {is_win                 :: boolean() | 0 | 1, % = 1
         ranklist = []          :: [pb_1602_guild_war:p_gw_ranking()] | undefined, % = 2
         my_rank                :: pb_1602_guild_war:p_gw_ranking() | undefined % = 3
        }).
-endif.

-ifndef('M_GUILD_WAR_WINNER_TOS_PB_H').
-define('M_GUILD_WAR_WINNER_TOS_PB_H', true).
-record(m_guild_war_winner_tos,
        {
        }).
-endif.

-ifndef('M_GUILD_WAR_WINNER_TOC_PB_H').
-define('M_GUILD_WAR_WINNER_TOC_PB_H', true).
-record(m_guild_war_winner_toc,
        {guild                  :: non_neg_integer(), % = 1, 32 bits
         victory                :: integer(),       % = 2, 32 bits
         breakup                :: integer(),       % = 3, 32 bits
         roles = []             :: [pb_1602_guild_war:p_role_base()] | undefined, % = 4
         fetch                  :: boolean() | 0 | 1, % = 5
         v_allot                :: boolean() | 0 | 1, % = 6
         b_allot                :: boolean() | 0 | 1 % = 7
        }).
-endif.

-ifndef('M_GUILD_WAR_ALLOT_TOS_PB_H').
-define('M_GUILD_WAR_ALLOT_TOS_PB_H', true).
-record(m_guild_war_allot_tos,
        {role                   :: non_neg_integer(), % = 1, 32 bits
         type                   :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_GUILD_WAR_ALLOT_TOC_PB_H').
-define('M_GUILD_WAR_ALLOT_TOC_PB_H', true).
-record(m_guild_war_allot_toc,
        {role                   :: non_neg_integer(), % = 1, 32 bits
         type                   :: integer()        % = 2, 32 bits
        }).
-endif.

-ifndef('M_GUILD_WAR_FETCH_TOS_PB_H').
-define('M_GUILD_WAR_FETCH_TOS_PB_H', true).
-record(m_guild_war_fetch_tos,
        {
        }).
-endif.

-ifndef('M_GUILD_WAR_FETCH_TOC_PB_H').
-define('M_GUILD_WAR_FETCH_TOC_PB_H', true).
-record(m_guild_war_fetch_toc,
        {reward = #{}           :: #{integer() := integer()} | undefined % = 1
        }).
-endif.

-ifndef('P_GW_FIELD_PB_H').
-define('P_GW_FIELD_PB_H', true).
-record(p_gw_field,
        {id                     :: integer(),       % = 1, 32 bits
         vs = []                :: [pb_1602_guild_war:p_gw_versus()] | undefined % = 2
        }).
-endif.

-ifndef('P_GW_VERSUS_PB_H').
-define('P_GW_VERSUS_PB_H', true).
-record(p_gw_versus,
        {guilds = []            :: [pb_1602_guild_war:p_gw_guild()] | undefined, % = 1
         winner                 :: non_neg_integer() % = 2, 32 bits
        }).
-endif.

-ifndef('P_GW_GUILD_PB_H').
-define('P_GW_GUILD_PB_H', true).
-record(p_gw_guild,
...
-ifndef('P_GW_BATTLE_PB_H').
-define('P_GW_BATTLE_PB_H', true).
-record(p_gw_battle,
        {guild                  :: non_neg_integer(), % = 1, 32 bits
         group                  :: integer(),       % = 2, 32 bits
         role                   :: integer(),       % = 3, 32 bits
         score                  :: integer(),       % = 4, 32 bits
         crysts = []            :: [integer()] | undefined, % = 5, 32 bits
         coord                  :: pb_1602_guild_war:p_coord() | undefined % = 6
        }).
-endif.

-ifndef('P_GW_RANKING_PB_H').
-define('P_GW_RANKING_PB_H', true).
-record(p_gw_ranking,
        {rank                   :: integer(),       % = 1, 32 bits
         role_id                :: non_neg_integer(), % = 2, 32 bits
         role_name              :: iolist(),        % = 3
         gname                  :: iolist(),        % = 4
         kill                   :: integer(),       % = 5, 32 bits
         occupy                 :: integer(),       % = 6, 32 bits
         contrib                :: integer()        % = 7, 32 bits
        }).
-endif.
...
-record(p_role_base,
        {id                     :: non_neg_integer(), % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1602_guild_war:p_aspect()} | undefined, % = 8
         ...
         icon                   :: pb_1602_guild_war:p_icon() | undefined, % = 17
...
-record(p_item,
        {uid                    :: integer(),       % = 1, 32 bits
         ...
         gender                 :: integer(),       % = 7, 32 bits
         score                  :: integer() | undefined, % = 8, 32 bits
         equip                  :: pb_1602_guild_war:p_equip() | undefined, % = 9
         pet                    :: pb_1602_guild_war:p_pet() | undefined, % = 10
...
-record(p_equip,
        {base                   :: pb_1602_guild_war:p_attr(), % = 1
         rare1                  :: pb_1602_guild_war:p_attr() | undefined, % = 2
         rare2                  :: pb_1602_guild_war:p_attr() | undefined, % = 3
         rare3                  :: pb_1602_guild_war:p_attr() | undefined, % = 4
         marriage               :: pb_1602_guild_war:p_marriage() | undefined, % = 5
         ...
         refine = []            :: [pb_1602_guild_war:p_refine()] | undefined, % = 11
         suite = #{}            :: #{integer() := integer()} | undefined, % = 12
         combine = []           :: [pb_1602_guild_war:p_item()] | undefined % = 13
        }).
-endif.
...
-record(p_marriage,
        {husband_id             :: non_neg_integer() | undefined, % = 1, 32 bits
         ...
         rare                   :: pb_1602_guild_war:p_attr() | undefined % = 5
        }).
-endif.
...
-record(p_actor,
        {uid                    :: non_neg_integer(), % = 1, 32 bits
         ...
         coord                  :: pb_1602_guild_war:p_coord(), % = 4
         state                  :: integer(),       % = 5, 32 bits
         stargs = #{}           :: #{integer() := iolist()} | undefined, % = 6
         role                   :: pb_1602_guild_war:p_role() | undefined, % = 7
         creep                  :: pb_1602_guild_war:p_creep() | undefined, % = 8
         drop                   :: pb_1602_guild_war:p_drop() | undefined % = 9
        }).
-endif.
...
-record(p_role,
        {career                 :: integer(),       % = 1, 32 bits
         ...
         figure = #{}           :: #{iolist() := pb_1602_guild_war:p_aspect()} | undefined, % = 5
         ...
         icon                   :: pb_1602_guild_war:p_icon() | undefined % = 25
        }).
-endif.
...
-record(p_creep,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         buffs = []             :: [pb_1602_guild_war:p_buff()] | undefined, % = 6
         dir                    :: integer(),       % = 7, 32 bits
         dest                   :: pb_1602_guild_war:p_coord(), % = 8
...
-record(p_npc,
        {id                     :: integer(),       % = 1, 32 bits
         coord                  :: pb_1602_guild_war:p_coord() % = 2
        }).
-endif.
...
-record(p_drop,
        {id                     :: integer(),       % = 1, 32 bits
         ...
         coord                  :: pb_1602_guild_war:p_coord() | undefined, % = 5
...
-record(p_ranking,
        {base                   :: pb_1602_guild_war:p_role_base() | undefined, % = 1
